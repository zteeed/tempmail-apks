...
abstract class ParameterHandler<T> {
    ...
    static final class Body<T> extends ParameterHandler<T> {
        private final Converter<T, h0> converter;
        private final Method method;
        private final int p;

        Body(Method method2, int i, Converter<T, h0> converter2) {
            this.method = method2;
            this.p = i;
    ...
    static final class Headers extends ParameterHandler<y> {
        private final Method method;
        private final int p;
        ...
        /* access modifiers changed from: package-private */
        public void apply(RequestBuilder requestBuilder, @Nullable y yVar) {
            if (yVar != null) {
    ...
    static final class Part<T> extends ParameterHandler<T> {
        ...
        Part(Method method2, int i, y yVar, Converter<T, h0> converter2) {
            this.method = method2;
            this.p = i;
            this.headers = yVar;
            this.converter = converter2;
    ...
    static final class PartMap<T> extends ParameterHandler<Map<String, T>> {
        ...
        private final Converter<T, h0> valueConverter;

        PartMap(Method method2, int i, Converter<T, h0> converter, String str) {
            this.method = method2;
            this.p = i;
            this.valueConverter = converter;
            ...
            if (map != null) {
                for (Map.Entry next : map.entrySet()) {
                    ...
                    if (str != null) {
                        Object value = next.getValue();
                        if (value != null) {
                            requestBuilder.addPart(y.g("Content-Disposition", "form-data; name=\"" + str + "\"", "Content-Transfer-Encoding", this.transferEncoding), this.valueConverter.convert(value));
                        } else {
                            Method method2 = this.method;
                            int i = this.p;
    ...
    static final class RawPart extends ParameterHandler<c0.b> {
        ...
        /* access modifiers changed from: package-private */
        public void apply(RequestBuilder requestBuilder, @Nullable c0.b bVar) {
            if (bVar != null) {
