...
public final class f extends e.j implements n {
    ...
    public final g f14277b;

    /* renamed from: c  reason: collision with root package name */
    private final k0 f14278c;

    /* renamed from: d  reason: collision with root package name */
    private Socket f14279d;

    /* renamed from: e  reason: collision with root package name */
    private Socket f14280e;
    ...
    private void f(int i2, int i3, j jVar, v vVar) throws IOException {
        Socket socket;
        Proxy b2 = this.f14278c.b();
        e.e a2 = this.f14278c.a();
        ...
        this.f14279d = socket;
        vVar.f(jVar, this.f14278c.d(), b2);
        this.f14279d.setSoTimeout(i3);
        try {
            e.m0.j.f.j().h(this.f14279d, this.f14278c.d(), i2);
            try {
                this.i = Okio.buffer(Okio.source(this.f14279d));
                this.j = Okio.buffer(Okio.sink(this.f14279d));
            ...
            ConnectException connectException = new ConnectException("Failed to connect to " + this.f14278c.d());
    ...
    private void g(okhttp3.internal.connection.c r8) throws java.io.IOException {
        /*
            ...
            r2 = 0
            java.net.Socket r3 = r7.f14279d     // Catch:{ AssertionError -> 0x0130 }
        ...
        L_0x00f9:
            r7.f14280e = r1     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            ...
            java.net.Socket r8 = r7.f14280e     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
            ...
            r7.f14281f = r4     // Catch:{ AssertionError -> 0x012b, all -> 0x0128 }
    ...
    private void h(int i2, int i3, int i4, j jVar, v vVar) throws IOException {
        ...
        while (i6 < 21) {
            ...
            j2 = i(i3, i4, j2, i5);
            if (j2 != null) {
                e.m0.e.g(this.f14279d);
                this.f14279d = null;
                this.j = null;
                this.i = null;
                vVar.d(jVar, this.f14278c.d(), this.f14278c.b(), (e0) null);
                i6++;
            } else {
                return;
            }
    ...
    private g0 i(int i2, int i3, g0 g0Var, z zVar) throws IOException {
        ...
        while (true) {
            ...
            if (d2 != 200) {
                if (d2 == 407) {
                    g0 a2 = this.f14278c.a().h().a(this.f14278c, c2);
                    if (a2 == null) {
    ...
    private g0 j() throws IOException {
        g0.a aVar = new g0.a();
        aVar.i(this.f14278c.a().l());
        aVar.e("CONNECT", (h0) null);
        aVar.c("Host", e.m0.e.r(this.f14278c.a().l(), true));
        ...
        aVar2.b(e.m0.e.f14107d);
        aVar2.r(-1);
        aVar2.p(-1);
        aVar2.i("Proxy-Authenticate", "OkHttp-Preemptive");
        g0 a3 = this.f14278c.a().h().a(this.f14278c, aVar2.c());
        return a3 != null ? a3 : a2;
    }

    private void k(c cVar, int i2, j jVar, v vVar) throws IOException {
        if (this.f14278c.a().k() != null) {
            vVar.x(jVar);
            g(cVar);
            vVar.w(jVar, this.f14281f);
            if (this.g == e0.HTTP_2) {
                u(i2);
            }
        } else if (this.f14278c.a().f().contains(e0.H2_PRIOR_KNOWLEDGE)) {
    ...
    private boolean s(List<k0> list) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (k0Var.b().type() == Proxy.Type.DIRECT && this.f14278c.b().type() == Proxy.Type.DIRECT && this.f14278c.d().equals(k0Var.d())) {
                return true;
            }
        }
        return false;
    ...
    private void u(int i2) throws IOException {
        this.f14280e.setSoTimeout(0);
        e.h hVar = new e.h(true);
        hVar.d(this.f14280e, this.f14278c.a().l().m(), this.i, this.j);
        hVar.b(this);
        hVar.c(i2);
        e a2 = hVar.a();
        this.h = a2;
    ...
    public void e(int r17, int r18, int r19, int r20, boolean r21, e.j r22, e.v r23) {
        ...
        L_0x0086:
            ...
            r12 = r11
        L_0x0088:
            e.k0 r0 = r7.f14278c     // Catch:{ IOException -> 0x00f9 }
            ...
            java.net.Socket r0 = r7.f14279d     // Catch:{ IOException -> 0x00f9 }
        ...
        L_0x00b0:
            ...
            e.k0 r0 = r7.f14278c     // Catch:{ IOException -> 0x00f5 }
            java.net.InetSocketAddress r0 = r0.d()     // Catch:{ IOException -> 0x00f5 }
            e.k0 r1 = r7.f14278c     // Catch:{ IOException -> 0x00f5 }
        ...
        L_0x00e0:
            ...
            okhttp3.internal.connection.g r1 = r7.f14277b
            monitor-enter(r1)
        ...
        L_0x00fe:
            r15 = r20
        L_0x0100:
            java.net.Socket r1 = r7.f14280e
            e.m0.e.g(r1)
            java.net.Socket r1 = r7.f14279d
            e.m0.e.g(r1)
            r7.f14280e = r11
            r7.f14279d = r11
            r7.i = r11
    ...
    public boolean m(e.e eVar, @Nullable List<k0> list) {
        if (this.p.size() >= this.o || this.k || !c.f14102a.e(this.f14278c.a(), eVar)) {
            return false;
        }
        if (eVar.l().m().equals(r().a().l().m())) {
            return true;
        }
        if (this.h == null || list == null || !s(list) || eVar.e() != d.f14431a || !v(eVar.l())) {
            return false;
        }
        try {
    ...
    public boolean n(boolean z) {
        int soTimeout;
        if (this.f14280e.isClosed() || this.f14280e.isInputShutdown() || this.f14280e.isOutputShutdown()) {
            return false;
        }
        e eVar = this.h;
        if (eVar != null) {
        ...
        if (z) {
            try {
                soTimeout = this.f14280e.getSoTimeout();
                this.f14280e.setSoTimeout(1);
                if (this.i.exhausted()) {
                    this.f14280e.setSoTimeout(soTimeout);
                    return false;
                }
                this.f14280e.setSoTimeout(soTimeout);
                return true;
    ...
    public e.m0.h.c p(d0 d0Var, a0.a aVar) throws SocketException {
        ...
        this.f14280e.setSoTimeout(aVar.b());
    ...
    public String toString() {
        ...
        sb.append(this.f14278c.a().l().m());
        sb.append(":");
        sb.append(this.f14278c.a().l().z());
        sb.append(", proxy=");
        sb.append(this.f14278c.b());
        sb.append(" hostAddress=");
        sb.append(this.f14278c.d());
    ...
    public boolean v(z zVar) {
        if (zVar.z() != this.f14278c.a().l().z()) {
            return false;
        }
        if (zVar.m().equals(this.f14278c.a().l().m())) {
            return true;
        }
        if (this.f14281f == null || !d.f14431a.c(zVar.m(), (X509Certificate) this.f14281f.d().get(0))) {
            return false;
        }
        return true;
    }
    ...
    public void w(@Nullable IOException iOException) {
        synchronized (this.f14277b) {
            if (iOException instanceof StreamResetException) {
                okhttp3.internal.http2.a aVar = ((StreamResetException) iOException).f14305b;
                ...
                if (this.m == 0) {
                    if (iOException != null) {
                        this.f14277b.b(this.f14278c, iOException);
                    }
                    this.l++;
                }
            }
