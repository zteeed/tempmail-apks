...
public final class g {
    ...
    private final Runnable f14284c = new a(this);

    /* renamed from: d  reason: collision with root package name */
    private final Deque<f> f14285d = new ArrayDeque();

    /* renamed from: e  reason: collision with root package name */
    final h f14286e = new h();
    ...
    public g(int i, long j, TimeUnit timeUnit) {
        this.f14282a = i;
        this.f14283b = timeUnit.toNanos(j);
        if (j <= 0) {
    ...
    private int e(f fVar, long j) {
        ...
        while (i < list.size()) {
            ...
            if (reference.get() != null) {
                ...
                f.j().q("A connection to " + fVar.r().a().l() + " was leaked. Did you forget to close a response body?", ((j.b) reference).f14304a);
                list.remove(i);
                fVar.k = true;
                if (list.isEmpty()) {
                    fVar.q = j - this.f14283b;
                    return 0;
                }
            }
        }
    ...
    public void b(k0 k0Var, IOException iOException) {
        ...
        this.f14286e.b(k0Var);
    }

    /* access modifiers changed from: package-private */
    public boolean c(f fVar) {
        if (fVar.k || this.f14282a == 0) {
            this.f14285d.remove(fVar);
            return true;
        }
        notifyAll();
    ...
    public void f(f fVar) {
        if (!this.f14287f) {
            this.f14287f = true;
            g.execute(this.f14284c);
        }
        this.f14285d.add(fVar);
    }
