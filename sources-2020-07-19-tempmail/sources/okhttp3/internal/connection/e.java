...
final class e {
    ...
    private final e.e f14272b;

    /* renamed from: c  reason: collision with root package name */
    private final g f14273c;

    /* renamed from: d  reason: collision with root package name */
    private final j f14274d;

    /* renamed from: e  reason: collision with root package name */
    private final v f14275e;
    ...
    e(j jVar, g gVar, e.e eVar, j jVar2, v vVar) {
        ...
        this.f14274d = jVar2;
        this.f14275e = vVar;
        this.g = new i(eVar, gVar.f14286e, jVar2, vVar);
    }
    ...
    private f c(int i2, int i3, int i4, int i5, boolean z) throws IOException {
        ...
        synchronized (this.f14273c) {
            if (!this.f14271a.i()) {
                this.i = false;
                f fVar3 = this.f14271a.i;
                socket = null;
                n = (this.f14271a.i == null || !this.f14271a.i.k) ? null : this.f14271a.n();
                if (this.f14271a.i != null) {
                    fVar2 = this.f14271a.i;
                    fVar = null;
                } else {
                    fVar = fVar3;
                    fVar2 = null;
                ...
                if (fVar2 == null) {
                    if (this.f14273c.g(this.f14272b, this.f14271a, (List<k0>) null, false)) {
                        fVar2 = this.f14271a.i;
                        k0Var = null;
                        z2 = true;
                    } else {
        ...
        e.m0.e.g(n);
        if (fVar != null) {
            this.f14275e.h(this.f14274d, fVar);
        }
        if (z2) {
            this.f14275e.g(this.f14274d, fVar2);
        }
        if (fVar2 != null) {
            return fVar2;
        }
        if (k0Var != null || ((aVar = this.f14276f) != null && aVar.b())) {
            z3 = false;
        } else {
            this.f14276f = this.g.d();
            z3 = true;
        }
        synchronized (this.f14273c) {
            if (!this.f14271a.i()) {
                if (z3) {
                    list = this.f14276f.a();
                    if (this.f14273c.g(this.f14272b, this.f14271a, list, false)) {
                        fVar2 = this.f14271a.i;
                        z2 = true;
                    }
                } else {
                ...
                if (!z2) {
                    if (k0Var == null) {
                        k0Var = this.f14276f.c();
                    }
                    fVar2 = new f(this.f14273c, k0Var);
                    this.h = fVar2;
                }
            } else {
                throw new IOException("Canceled");
        ...
        fVar2.e(i2, i3, i4, i5, z, this.f14274d, this.f14275e);
        this.f14273c.f14286e.a(fVar2.r());
        synchronized (this.f14273c) {
            this.h = null;
            if (this.f14273c.g(this.f14272b, this.f14271a, list, true)) {
                fVar2.k = true;
                socket = fVar2.t();
                fVar2 = this.f14271a.i;
                this.j = k0Var;
            } else {
                this.f14273c.f(fVar2);
                this.f14271a.a(fVar2);
            }
        }
        e.m0.e.g(socket);
        this.f14275e.g(this.f14274d, fVar2);
    ...
    private okhttp3.internal.connection.f d(int r4, int r5, int r6, int r7, boolean r8, boolean r9) throws java.io.IOException {
        ...
        L_0x0000:
            ...
            okhttp3.internal.connection.g r1 = r3.f14273c
            monitor-enter(r1)
    ...
    private boolean g() {
        f fVar = this.f14271a.i;
        return fVar != null && fVar.l == 0 && e.m0.e.D(fVar.r().a().l(), this.f14272b.l());
    }
    ...
    public boolean e() {
        /*
            r3 = this;
            okhttp3.internal.connection.g r0 = r3.f14273c
            monitor-enter(r0)
        ...
        L_0x000a:
            ...
            okhttp3.internal.connection.j r1 = r3.f14271a     // Catch:{ all -> 0x0034 }
            ...
            return r2
        L_0x001c:
            okhttp3.internal.connection.i$a r1 = r3.f14276f     // Catch:{ all -> 0x0034 }
