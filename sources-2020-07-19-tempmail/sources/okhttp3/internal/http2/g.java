...
final class g implements Closeable {
    ...
    static final Logger f14387f = Logger.getLogger(d.class.getName());

    /* renamed from: b  reason: collision with root package name */
    private final BufferedSource f14388b;
    ...
    static final class a implements Source {
        ...
        /* renamed from: b  reason: collision with root package name */
        private final BufferedSource f14392b;
        ...
        a(BufferedSource bufferedSource) {
            this.f14392b = bufferedSource;
        }

        private void a() throws IOException {
            int i = this.f14395e;
            int k = g.k(this.f14392b);
            this.f14396f = k;
            this.f14393c = k;
            byte readByte = (byte) (this.f14392b.readByte() & 255);
            this.f14394d = (byte) (this.f14392b.readByte() & 255);
            if (g.f14387f.isLoggable(Level.FINE)) {
                g.f14387f.fine(d.b(true, this.f14395e, this.f14393c, readByte, this.f14394d));
            }
            int readInt = this.f14392b.readInt() & Integer.MAX_VALUE;
            this.f14395e = readInt;
            if (readByte != 9) {
        ...
        public long read(Buffer buffer, long j) throws IOException {
            while (true) {
                ...
                if (i == 0) {
                    ...
                    long read = this.f14392b.read(buffer, Math.min(j, (long) i));
                    if (read == -1) {
                        return -1;
                    }
                    this.f14396f = (int) (((long) this.f14396f) - read);
                    return read;
                }
            }
        }
    ...
    g(BufferedSource bufferedSource, boolean z) {
        this.f14388b = bufferedSource;
        this.f14390d = z;
        a aVar = new a(bufferedSource);
        this.f14389c = aVar;
        this.f14391e = new c.a(CodedOutputStream.DEFAULT_BUFFER_SIZE, aVar);
    }
    ...
    private void e(b bVar, int i, byte b2, int i2) throws IOException {
        ...
        if (i2 != 0) {
            ...
            if (!z) {
                if ((b2 & 8) != 0) {
                    s = (short) (this.f14388b.readByte() & 255);
                }
                bVar.e(z2, i2, this.f14388b, a(i, b2, s));
                this.f14388b.skip((long) s);
                return;
            }
    ...
    private void f(b bVar, int i, byte b2, int i2) throws IOException {
        if (i < 8) {
            ...
            int readInt = this.f14388b.readInt();
            int readInt2 = this.f14388b.readInt();
            int i3 = i - 8;
            a f2 = a.f(readInt2);
            if (f2 != null) {
                ByteString byteString = ByteString.EMPTY;
                if (i3 > 0) {
                    byteString = this.f14388b.readByteString((long) i3);
                }
    ...
    private void n(b bVar, int i) throws IOException {
        int readInt = this.f14388b.readInt();
        bVar.g(i, readInt & Integer.MAX_VALUE, (this.f14388b.readByte() & 255) + 1, (Integer.MIN_VALUE & readInt) != 0);
    }
    ...
    private void p(b bVar, int i, byte b2, int i2) throws IOException {
        ...
        if (i2 != 0) {
            ...
            bVar.i(i2, this.f14388b.readInt() & Integer.MAX_VALUE, g(a(i - 4, b2, s), s, b2, i2));
            return;
        }
    ...
    private void r(b bVar, int i, byte b2, int i2) throws IOException {
        if (i2 != 0) {
            ...
            for (int i3 = 0; i3 < i; i3 += 6) {
                short readShort = this.f14388b.readShort() & 65535;
                int readInt = this.f14388b.readInt();
                if (readShort != 2) {
                    if (readShort == 3) {
                        readShort = 4;
    ...
    private void t(b bVar, int i, byte b2, int i2) throws IOException {
        if (i == 4) {
            long readInt = ((long) this.f14388b.readInt()) & 2147483647L;
            if (readInt != 0) {
                bVar.d(i2, readInt);
                return;
            }
    ...
    public boolean b(boolean z, b bVar) throws IOException {
        try {
            this.f14388b.require(9);
            int k = k(this.f14388b);
            if (k < 0 || k > 16384) {
                d.d("FRAME_SIZE_ERROR: %s", Integer.valueOf(k));
                throw null;
            }
            byte readByte = (byte) (this.f14388b.readByte() & 255);
            if (!z || readByte == 4) {
                byte readByte2 = (byte) (this.f14388b.readByte() & 255);
                int readInt = this.f14388b.readInt() & Integer.MAX_VALUE;
                if (f14387f.isLoggable(Level.FINE)) {
                    f14387f.fine(d.b(true, readInt, k, readByte, readByte2));
                }
                switch (readByte) {
                    case 0:
    ...
    public void d(b bVar) throws IOException {
        if (!this.f14390d) {
            ByteString readByteString = this.f14388b.readByteString((long) d.f14331a.size());
            if (f14387f.isLoggable(Level.FINE)) {
                f14387f.fine(e.p("<< CONNECTION %s", readByteString.hex()));
            }
            if (!d.f14331a.equals(readByteString)) {
