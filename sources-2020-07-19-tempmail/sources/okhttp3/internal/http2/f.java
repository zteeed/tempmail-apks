...
public final class f implements c {
    ...
    private final a0.a f14381a;

    /* renamed from: b  reason: collision with root package name */
    private final okhttp3.internal.connection.f f14382b;

    /* renamed from: c  reason: collision with root package name */
    private final e f14383c;

    /* renamed from: d  reason: collision with root package name */
    private volatile h f14384d;

    /* renamed from: e  reason: collision with root package name */
    private final e0 f14385e;

    /* renamed from: f  reason: collision with root package name */
    private volatile boolean f14386f;
    ...
    public static List<b> i(g0 g0Var) {
        ...
        arrayList.add(new b(b.f14313f, g0Var.f()));
    ...
    public static i0.a j(y yVar, e0 e0Var) throws IOException {
        ...
        for (int i = 0; i < h2; i++) {
            ...
            if (e2.equals(":status")) {
                ...
                e.m0.c.f14102a.b(aVar, e2, i2);
            }
        }
        if (kVar != null) {
            i0.a aVar2 = new i0.a();
            aVar2.o(e0Var);
            aVar2.g(kVar.f14139b);
            aVar2.l(kVar.f14140c);
            aVar2.j(aVar.f());
            return aVar2;
        }
    ...
    public void b() throws IOException {
        this.f14384d.h().close();
    }

    public void c(g0 g0Var) throws IOException {
        if (this.f14384d == null) {
            this.f14384d = this.f14383c.x(i(g0Var), g0Var.a() != null);
            if (!this.f14386f) {
                this.f14384d.l().timeout((long) this.f14381a.b(), TimeUnit.MILLISECONDS);
                this.f14384d.r().timeout((long) this.f14381a.c(), TimeUnit.MILLISECONDS);
                return;
            }
            this.f14384d.f(a.CANCEL);
    ...
    public Source d(i0 i0Var) {
        return this.f14384d.i();
    }

    public i0.a e(boolean z) throws IOException {
        i0.a j = j(this.f14384d.p(), this.f14385e);
        if (!z || e.m0.c.f14102a.d(j) != 100) {
            return j;
        }
        return null;
    }
