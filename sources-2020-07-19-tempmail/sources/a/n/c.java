...
final class c {
    ...
    static long a(RandomAccessFile randomAccessFile, a aVar) throws IOException {
        ...
        long j = aVar.f484b;
        randomAccessFile.seek(aVar.f483a);
        ...
        if (length >= 0) {
            ...
            do {
                ...
                if (randomAccessFile.readInt() == reverseBytes) {
                    ...
                    randomAccessFile.skipBytes(2);
                    a aVar = new a();
                    aVar.f484b = ((long) Integer.reverseBytes(randomAccessFile.readInt())) & 4294967295L;
                    aVar.f483a = ((long) Integer.reverseBytes(randomAccessFile.readInt())) & 4294967295L;
                    return aVar;
                }
                length--;
            } while (length >= j);
