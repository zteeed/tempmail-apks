...
public abstract class m implements Cloneable {
    ...
    private String f559b = getClass().getName();
    ...
    private TimeInterpolator f562e = null;

    /* renamed from: f  reason: collision with root package name */
    ArrayList<Integer> f563f = new ArrayList<>();
    ...
    private static boolean T(s sVar, s sVar2, String str) {
        Object obj = sVar.f584a.get(str);
        Object obj2 = sVar2.f584a.get(str);
    ...
    private void V(a.e.a<View, s> aVar, a.e.a<View, s> aVar2) {
        ...
        for (int size = aVar.size() - 1; size >= 0; size--) {
            View i2 = aVar.i(size);
            if (!(i2 == null || !S(i2) || (remove = aVar2.remove(i2)) == null || (view = remove.f585b) == null || !S(view))) {
    ...
    private void Y(t tVar, t tVar2) {
        a.e.a aVar = new a.e.a((g) tVar.f587a);
        a.e.a aVar2 = new a.e.a((g) tVar2.f587a);
        int i2 = 0;
        while (true) {
            int[] iArr = this.t;
            if (i2 < iArr.length) {
                ...
                if (i3 == 1) {
                    ...
                    X(aVar, aVar2, tVar.f590d, tVar2.f590d);
                } else if (i3 == 3) {
                    U(aVar, aVar2, tVar.f588b, tVar2.f588b);
                } else if (i3 == 4) {
                    W(aVar, aVar2, tVar.f589c, tVar2.f589c);
                }
                i2++;
            } else {
                d(aVar, aVar2);
    ...
    private static void e(t tVar, View view, s sVar) {
        tVar.f587a.put(view, sVar);
        int id = view.getId();
        if (id >= 0) {
            if (tVar.f588b.indexOfKey(id) >= 0) {
                tVar.f588b.put(id, (Object) null);
            } else {
                tVar.f588b.put(id, view);
            }
        }
        String z2 = t.z(view);
        if (z2 != null) {
            if (tVar.f590d.containsKey(z2)) {
                tVar.f590d.put(z2, null);
            } else {
                tVar.f590d.put(z2, view);
            }
        }
        if (view.getParent() instanceof ListView) {
            ...
            if (listView.getAdapter().hasStableIds()) {
                ...
                if (tVar.f589c.k(itemIdAtPosition) >= 0) {
                    View i2 = tVar.f589c.i(itemIdAtPosition);
                    if (i2 != null) {
                        t.h0(i2, false);
                        tVar.f589c.n(itemIdAtPosition, null);
                        return;
                    }
                    return;
                }
                t.h0(view, true);
                tVar.f589c.n(itemIdAtPosition, view);
            }
        }
    }
    ...
    public s Q(View view, boolean z2) {
        ...
        return (z2 ? this.q : this.r).f587a.get(view);
    }
    ...
    public boolean R(s sVar, s sVar2) {
        ...
        for (String T : sVar.f584a.keySet()) {
            if (T(sVar, sVar2, T)) {
            }
        }
        return false;
    ...
    public boolean S(View view) {
        ...
        if (this.m != null && t.z(view) != null && this.m.contains(t.z(view))) {
            return false;
        }
        if ((this.f563f.size() == 0 && this.g.size() == 0 && (((arrayList = this.i) == null || arrayList.isEmpty()) && ((arrayList2 = this.h) == null || arrayList2.isEmpty()))) || this.f563f.contains(Integer.valueOf(id)) || this.g.contains(view)) {
            return true;
        }
        ArrayList<String> arrayList6 = this.h;
        if (arrayList6 != null && arrayList6.contains(t.z(view))) {
            return true;
        }
        if (this.i != null) {
    ...
    public void Z(View view) {
        if (!this.A) {
            ...
            for (int i2 = size - 1; i2 >= 0; i2--) {
                d m2 = E2.m(i2);
                if (m2.f567a != null && e2.equals(m2.f570d)) {
                    a.b(E2.i(i2));
                }
            }
    ...
    public void a0(ViewGroup viewGroup) {
        ...
        for (int i2 = size - 1; i2 >= 0; i2--) {
            Animator i3 = E2.i(i2);
            if (!(i3 == null || (dVar = E2.get(i3)) == null || dVar.f567a == null || !e2.equals(dVar.f570d))) {
                s sVar = dVar.f569c;
                View view = dVar.f567a;
                s Q = Q(view, true);
                s y2 = y(view, true);
                if (!(Q == null && y2 == null) && dVar.f571e.R(sVar, y2)) {
    ...
    public void j(s sVar) {
        String[] b2;
        if (this.D != null && !sVar.f584a.isEmpty() && (b2 = this.D.b()) != null) {
            boolean z2 = false;
            int i2 = 0;
            while (true) {
                if (i2 >= b2.length) {
                    z2 = true;
                    break;
                } else if (!sVar.f584a.containsKey(b2[i2])) {
                    break;
                } else {
                    i2++;
                }
    ...
    public void l(ViewGroup viewGroup, boolean z2) {
        ...
        n(z2);
        if ((this.f563f.size() > 0 || this.g.size() > 0) && (((arrayList = this.h) == null || arrayList.isEmpty()) && ((arrayList2 = this.i) == null || arrayList2.isEmpty()))) {
            for (int i2 = 0; i2 < this.f563f.size(); i2++) {
                View findViewById = viewGroup.findViewById(this.f563f.get(i2).intValue());
                if (findViewById != null) {
                    s sVar = new s();
                    sVar.f585b = findViewById;
                    if (z2) {
                        k(sVar);
                    } else {
                        g(sVar);
        ...
        if (!z2 && (aVar = this.F) != null) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                arrayList3.add(this.q.f590d.remove(this.F.i(i4)));
            }
            for (int i5 = 0; i5 < size; i5++) {
                View view2 = (View) arrayList3.get(i5);
                if (view2 != null) {
                    this.q.f590d.put(this.F.m(i5), view2);
                }
            }
        }
    }
    ...
    public String n0(String str) {
        ...
        if (this.f561d != -1) {
            str2 = str2 + "dur(" + this.f561d + ") ";
        }
        if (this.f560c != -1) {
            str2 = str2 + "dly(" + this.f560c + ") ";
        }
        if (this.f562e != null) {
            str2 = str2 + "interp(" + this.f562e + ") ";
        }
        if (this.f563f.size() <= 0 && this.g.size() <= 0) {
            return str2;
        }
    ...
    public void r(ViewGroup viewGroup, t tVar, t tVar2, ArrayList<s> arrayList, ArrayList<s> arrayList2) {
        ...
        while (i4 < size) {
            ...
            if (sVar3 != null && !sVar3.f586c.contains(this)) {
                sVar3 = null;
            }
            if (sVar4 != null && !sVar4.f586c.contains(this)) {
                sVar4 = null;
            }
                ...
                if ((sVar3 == null || sVar4 == null || R(sVar3, sVar4)) && (p2 = p(viewGroup2, sVar3, sVar4)) != null) {
                    if (sVar4 != null) {
                        ...
                        if (view != null && P != null && P.length > 0) {
                            ...
                            i3 = size;
                            s sVar5 = tVar2.f587a.get(view);
                            if (sVar5 != null) {
                                int i5 = 0;
                                while (i5 < P.length) {
                                    sVar2.f584a.put(P[i5], sVar5.f584a.get(P[i5]));
                                    i5++;
                            ...
                            while (true) {
                                ...
                                if (dVar.f569c != null && dVar.f567a == view && dVar.f568b.equals(z()) && dVar.f569c.equals(sVar2)) {
                                    animator2 = null;
                                    break;
                                }
                                i6++;
    ...
    public void s() {
        ...
        if (i2 == 0) {
            ...
            for (int i4 = 0; i4 < this.q.f589c.r(); i4++) {
                View s2 = this.q.f589c.s(i4);
                if (s2 != null) {
                    t.h0(s2, false);
                }
            }
            for (int i5 = 0; i5 < this.r.f589c.r(); i5++) {
                View s3 = this.r.f589c.s(i5);
                if (s3 != null) {
                    t.h0(s3, false);
                }
            }
