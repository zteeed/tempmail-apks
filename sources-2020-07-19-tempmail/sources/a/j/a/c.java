...
public class c {
    ...
    private c(Context context, ViewGroup viewGroup, C0019c cVar) {
        if (viewGroup == null) {
            ...
            this.f451b = viewConfiguration.getScaledTouchSlop();
    ...
    private void G() {
        ...
        q(h(this.l.getXVelocity(this.f452c), this.n, this.m), h(this.l.getYVelocity(this.f452c), this.n, this.m));
    }
    ...
    private boolean d(float f2, float f3, int i2, int i3) {
        ...
        if (abs < abs2 * 0.5f && this.r.g(i3)) {
            ...
            iArr[i2] = iArr[i2] | i3;
            return false;
        } else if ((this.i[i2] & i3) != 0 || abs <= ((float) this.f451b)) {
            return false;
        } else {
            return true;
        }
    ...
    private boolean g(View view, float f2, float f3) {
        ...
        if (z && z2) {
            ...
            if (Math.abs(f2) > ((float) this.f451b)) {
                return true;
            }
            return false;
        } else if (!z2 || Math.abs(f3) <= ((float) this.f451b)) {
            return false;
        } else {
            return true;
        }
    ...
    private void j() {
        ...
        if (fArr != null) {
            ...
            Arrays.fill(this.f454e, 0.0f);
            Arrays.fill(this.f455f, 0.0f);
    ...
    public static c o(ViewGroup viewGroup, float f2, C0019c cVar) {
        ...
        p2.f451b = (int) (((float) p2.f451b) * (1.0f / f2));
        return p2;
    }
    ...
    private void t(int i2) {
        ...
        if (fArr == null || fArr.length <= i2) {
            ...
            float[] fArr6 = this.f453d;
            if (fArr6 != null) {
                System.arraycopy(fArr6, 0, fArr2, 0, fArr6.length);
                float[] fArr7 = this.f454e;
                System.arraycopy(fArr7, 0, fArr3, 0, fArr7.length);
                float[] fArr8 = this.f455f;
    ...
    public void F(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (actionMasked == 3) {
                ...
                if (this.f450a == 1 && pointerId3 == this.f452c) {
                    int pointerCount = motionEvent.getPointerCount();
                    while (true) {
                        if (i3 >= pointerCount) {
                            i2 = -1;
            ...
            while (i3 < pointerCount2) {
                ...
                if (D(pointerId5)) {
                    ...
                    float f2 = x3 - this.f453d[pointerId5];
                    float f3 = y3 - this.f454e[pointerId5];
                    H(f2, f3, pointerId5);
                    if (this.f450a != 1) {
            ...
            J(motionEvent);
        } else if (D(this.f452c)) {
            int findPointerIndex = motionEvent.findPointerIndex(this.f452c);
            float x4 = motionEvent.getX(findPointerIndex);
            float y4 = motionEvent.getY(findPointerIndex);
            float[] fArr = this.f455f;
            int i8 = this.f452c;
    ...
    public boolean N(int i2, int i3) {
        if (this.t) {
            return v(i2, i3, (int) this.l.getXVelocity(this.f452c), (int) this.l.getYVelocity(this.f452c));
        }
    ...
    public boolean P(View view, int i2, int i3) {
        ...
        if (!v2 && this.f450a == 0 && this.s != null) {
            this.s = null;
        }
        return v2;
    }
    ...
    public boolean f(int i2, int i3) {
        ...
        boolean z = (i2 & 1) == 1;
        boolean z2 = (i2 & 2) == 2;
        float f2 = this.f455f[i3] - this.f453d[i3];
        float f3 = this.g[i3] - this.f454e[i3];
        if (z && z2) {
            int i4 = this.f451b;
