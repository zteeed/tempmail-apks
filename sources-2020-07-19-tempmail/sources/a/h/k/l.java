...
public class l {
    ...
    private ViewParent f400a;

    /* renamed from: b  reason: collision with root package name */
    private ViewParent f401b;
    ...
    private boolean h(int i, int i2, int i3, int i4, int[] iArr, int i5, int[] iArr2) {
        ...
        if (iArr4 != null) {
            this.f402c.getLocationInWindow(iArr4);
            i8 = iArr4[0];
            i7 = iArr4[1];
        } else {
            i8 = 0;
        ...
        w.d(i6, this.f402c, i, i2, i3, i4, i5, iArr3);
        if (iArr4 != null) {
            this.f402c.getLocationInWindow(iArr4);
            iArr4[0] = iArr4[0] - i8;
            iArr4[1] = iArr4[1] - i7;
    ...
    private void o(int i, ViewParent viewParent) {
        if (i == 0) {
            this.f400a = viewParent;
        } else if (i == 1) {
            this.f401b = viewParent;
        }
    }
    ...
    public boolean a(float f2, float f3, boolean z) {
        ...
        return w.a(i, this.f402c, f2, f3, z);
    }
    ...
    public boolean d(int i, int i2, int[] iArr, int[] iArr2, int i3) {
        ...
        if (i != 0 || i2 != 0) {
            if (iArr2 != null) {
                this.f402c.getLocationInWindow(iArr2);
                i6 = iArr2[0];
                i5 = iArr2[1];
            } else {
                i6 = 0;
            ...
            iArr[0] = 0;
            iArr[1] = 0;
            w.c(i4, this.f402c, i, i2, iArr, i3);
            if (iArr2 != null) {
                this.f402c.getLocationInWindow(iArr2);
                iArr2[0] = iArr2[0] - i6;
                iArr2[1] = iArr2[1] - i5;
    ...
    public boolean q(int i, int i2) {
        ...
        for (ViewParent parent = this.f402c.getParent(); parent != null; parent = parent.getParent()) {
            if (w.f(parent, view, this.f402c, i, i2)) {
                o(i2, parent);
                w.e(parent, view, this.f402c, i, i2);
                return true;
            }
