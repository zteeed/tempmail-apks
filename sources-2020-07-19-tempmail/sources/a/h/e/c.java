...
public class c {
    ...
    private static final h f255a;

    /* renamed from: b  reason: collision with root package name */
    private static final e<String, Typeface> f256b = new e<>(16);
    ...
    public static Typeface a(Context context, CancellationSignal cancellationSignal, b.f[] fVarArr, int i) {
        return f255a.c(context, cancellationSignal, fVarArr, i);
    }
    ...
    public static Typeface b(Context context, c.a aVar, Resources resources, int i, int i2, f.a aVar2, Handler handler, boolean z) {
        ...
        if (aVar instanceof c.d) {
            ...
            typeface = f255a.b(context, (c.b) aVar, resources, i2);
            if (aVar2 != null) {
                if (typeface != null) {
        ...
        if (typeface != null) {
            f256b.e(d(resources, i, i2), typeface);
        }
        return typeface;
    }

    public static Typeface c(Context context, Resources resources, int i, String str, int i2) {
        Typeface e2 = f255a.e(context, resources, i, str, i2);
        if (e2 != null) {
            f256b.e(d(resources, i, i2), e2);
        }
        return e2;
    }
    ...
    public static Typeface e(Resources resources, int i, int i2) {
        return f256b.d(d(resources, i, i2));
    }
}
