...
class d extends h {
    ...
    private static Class f257b = null;

    /* renamed from: c  reason: collision with root package name */
    private static Constructor f258c = null;

    /* renamed from: d  reason: collision with root package name */
    private static Method f259d = null;

    /* renamed from: e  reason: collision with root package name */
    private static Method f260e = null;

    /* renamed from: f  reason: collision with root package name */
    private static boolean f261f = false;
    ...
    private static boolean j(Object obj, String str, int i, boolean z) {
        m();
        try {
            return ((Boolean) f259d.invoke(obj, new Object[]{str, Integer.valueOf(i), Boolean.valueOf(z)})).booleanValue();
    ...
    private static Typeface k(Object obj) {
        m();
        try {
            Object newInstance = Array.newInstance(f257b, 1);
            Array.set(newInstance, 0, obj);
            return (Typeface) f260e.invoke((Object) null, new Object[]{newInstance});
        } catch (IllegalAccessException | InvocationTargetException e2) {
            throw new RuntimeException(e2);
        }
    }
    ...
    private static Object n() {
        m();
        try {
            return f258c.newInstance(new Object[0]);
