...
public class e {
    ...
    public int d() {
        ...
        if (this.f199f <= -1 || (eVar = this.f197d) == null || eVar.f195b.C() != 8) {
            return this.f198e;
        }
        return this.f199f;
    }
        ...
        if (j != dVar) {
            switch (a.f200a[dVar.ordinal()]) {
                ...
                case 9:
                    return false;
                default:
                    throw new AssertionError(this.f196c.name());
            }
    ...
    public String toString() {
        return this.f195b.n() + ":" + this.f196c.toString();
    }
}
