...
class KeyframeParser {
    ...
    static JsonReader.Options NAMES = JsonReader.Options.of("t", "s", "e", "o", i.f12574a, "h", "to", "ti");
    private static h<WeakReference<Interpolator>> pathInterpolatorCache;
    ...
    private static WeakReference<Interpolator> getInterpolator(int i) {
        ...
        synchronized (KeyframeParser.class) {
            f2 = pathInterpolatorCache().f(i);
        }
        return f2;
    }

    static <T> Keyframe<T> parse(JsonReader jsonReader, LottieComposition lottieComposition, float f2, ValueParser<T> valueParser, boolean z) throws IOException {
        if (z) {
    ...
    private static <T> com.airbnb.lottie.value.Keyframe<T> parseKeyframe(com.airbnb.lottie.LottieComposition r16, com.airbnb.lottie.parser.moshi.JsonReader r17, float r18, com.airbnb.lottie.parser.ValueParser<T> r19) throws java.io.IOException {
        ...
        L_0x00a5:
            ...
            android.view.animation.Interpolator r0 = a.h.k.d0.b.a(r1, r5, r0, r3)     // Catch:{ IllegalArgumentException -> 0x00c2 }
            goto L_0x00eb
        L_0x00c2:
            r0 = move-exception
            ...
            float r4 = r8.y
            android.view.animation.Interpolator r0 = a.h.k.d0.b.a(r0, r1, r3, r4)
            goto L_0x00eb
        L_0x00e6:
    ...
    private static void putInterpolator(int i, WeakReference<Interpolator> weakReference) {
        synchronized (KeyframeParser.class) {
            pathInterpolatorCache.l(i, weakReference);
        }
    }
}
