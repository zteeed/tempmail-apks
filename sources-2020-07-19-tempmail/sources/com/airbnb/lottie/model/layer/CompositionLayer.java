...
public class CompositionLayer extends BaseLayer {
    ...
    public CompositionLayer(LottieDrawable lottieDrawable, Layer layer, List<Layer> list, LottieComposition lottieComposition) {
        ...
        d dVar = new d(lottieComposition.getLayers().size());
        ...
        while (true) {
            ...
            if (forModel != null) {
                dVar.n(forModel.getLayerModel().getId(), forModel);
                if (baseLayer2 != null) {
        ...
        for (i = 0; i < dVar.r(); i++) {
            BaseLayer baseLayer3 = (BaseLayer) dVar.i(dVar.l(i));
            if (!(baseLayer3 == null || (baseLayer = (BaseLayer) dVar.i(baseLayer3.getLayerModel().getParentId())) == null)) {
