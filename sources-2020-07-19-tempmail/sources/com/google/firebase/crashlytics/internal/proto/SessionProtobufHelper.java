...
public class SessionProtobufHelper {
    ...
    private static int getEventAppExecutionExceptionSize(TrimmedThrowableData trimmedThrowableData, int i, int i2) {
        ...
        for (StackTraceElement frameSize : trimmedThrowableData.stacktrace) {
            ...
            computeBytesSize += CodedOutputStream.computeTagSize(4) + CodedOutputStream.computeRawVarint32Size(frameSize2) + frameSize2;
        }
    ...
    private static int getEventDeviceSize(Float f2, int i, boolean z, int i2, long j, long j2) {
        int i3 = 0;
        if (f2 != null) {
            i3 = 0 + CodedOutputStream.computeFloatSize(1, f2.floatValue());
        }
    ...
    private static int getSessionEventSize(long j, String str, TrimmedThrowableData trimmedThrowableData, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, int i, Map<String, String> map, ActivityManager.RunningAppProcessInfo runningAppProcessInfo, int i2, ByteString byteString, ByteString byteString2, Float f2, int i3, boolean z, long j2, long j3, ByteString byteString3) {
        ...
        int eventDeviceSize = getEventDeviceSize(f2, i3, z, i2, j2, j3);
    ...
    public static void writeSessionEvent(CodedOutputStream codedOutputStream, long j, String str, TrimmedThrowableData trimmedThrowableData, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, int i, Map<String, String> map, byte[] bArr, ActivityManager.RunningAppProcessInfo runningAppProcessInfo, int i2, String str2, String str3, Float f2, int i3, boolean z, long j2, long j3) throws Exception {
        ...
        codedOutputStream2.writeRawVarint32(getSessionEventSize(j, str, trimmedThrowableData, thread, stackTraceElementArr, threadArr, list, i, map, runningAppProcessInfo, i2, copyFromUtf8, byteString, f2, i3, z, j2, j3, byteString3));
        ...
        writeSessionEventDevice(codedOutputStream, f2, i3, z, i2, j2, j3);
    ...
    private static void writeSessionEventDevice(CodedOutputStream codedOutputStream, Float f2, int i, boolean z, int i2, long j, long j2) throws Exception {
        codedOutputStream.writeTag(5, 2);
