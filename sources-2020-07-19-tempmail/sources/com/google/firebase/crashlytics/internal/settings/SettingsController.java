...
public class SettingsController implements SettingsDataProvider {
    ...
    public Task<Void> loadSettingsData(SettingsCacheBehavior settingsCacheBehavior, Executor executor) {
        ...
        if (buildInstanceIdentifierChanged() || (cachedSettingsData = getCachedSettingsData(settingsCacheBehavior)) == null) {
            ...
            return this.dataCollectionArbiter.waitForDataCollectionPermission().t(executor, new SuccessContinuation<Void, Void>() {
                public Task<Void> then(Void voidR) throws Exception {
                    ...
                    if (invoke != null) {
                        ...
                        ((TaskCompletionSource) SettingsController.this.appSettingsData.get()).e(parseSettingsJson.getAppSettingsData());
                        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
                        taskCompletionSource.e(parseSettingsJson.getAppSettingsData());
