...
public class CrashlyticsCore {
    ...
    public CrashlyticsCore(c cVar, IdManager idManager2, CrashlyticsNativeComponent crashlyticsNativeComponent, DataCollectionArbiter dataCollectionArbiter2, a aVar) {
        this(cVar, idManager2, crashlyticsNativeComponent, dataCollectionArbiter2, aVar, ExecutorUtils.buildSingleThreadExecutorService("Crashlytics Exception Handler"));
    }
    ...
    public Task<Void> doBackgroundInitialization(SettingsDataProvider settingsDataProvider) {
        ...
        try {
            ...
            Task<Void> submitAllReports = this.controller.submitAllReports(CLS_DEFAULT_PROCESS_DELAY, settingsDataProvider.getAppSettings());
    ...
    public boolean onPreExecute(SettingsDataProvider settingsDataProvider) {
        ...
        if (isBuildIdValid(mappingFileId, CommonUtils.getBooleanResourceValue(this.context, CRASHLYTICS_REQUIRE_BUILD_ID, CRASHLYTICS_REQUIRE_BUILD_ID_DEFAULT))) {
            ...
            try {
                ...
                AppData create = AppData.create(this.context, this.idManager, c2, mappingFileId);
    ...
    CrashlyticsCore(c cVar, IdManager idManager2, CrashlyticsNativeComponent crashlyticsNativeComponent, DataCollectionArbiter dataCollectionArbiter2, a aVar, ExecutorService executorService) {
        this.app = cVar;
