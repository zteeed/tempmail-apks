...
class CrashlyticsController {
    ...
    private static class BlockingCrashEventListener implements AnalyticsReceiver.CrashlyticsOriginEventListener {
        ...
        public void onCrashlyticsOriginEvent(int i, Bundle bundle) {
            if ("_ae".equals(bundle.getString(AnalyticsConnectorReceiver.EVENT_NAME_KEY))) {
        ...
        return Tasks.c(new ScheduledThreadPoolExecutor(1), new Callable<Void>() {
            public Void call() throws Exception {
                if (CrashlyticsController.this.firebaseCrashExists()) {
                    ...
                    CrashlyticsController.this.analyticsConnector.Q(CrashlyticsController.FIREBASE_ANALYTICS_ORIGIN_CRASHLYTICS, "_ae", bundle);
                ...
                public Task<Void> call() throws Exception {
                    ...
                    return settingsDataProvider2.getAppSettings().t(executor, new SuccessContinuation<AppSettingsData, Void>() {
                        public Task<Void> then(AppSettingsData appSettingsData) throws Exception {
                            ...
                            return Tasks.g(CrashlyticsController.this.reportingCoordinator.sendReports(executor, DataTransportState.getState(appSettingsData)), recordFatalFirebaseEvent);
                        }
                    });
                }
            }));
    ...
    public void registerAnalyticsListener() {
        ...
        Logger logger = Logger.getLogger();
        logger.d("Registered Firebase Analytics event listener for breadcrumbs: " + register);
    }
