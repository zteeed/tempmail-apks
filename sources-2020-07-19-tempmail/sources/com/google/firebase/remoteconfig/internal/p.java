...
public class p {
    ...
    private static final Charset f11520d = Charset.forName("UTF-8");

    /* renamed from: e  reason: collision with root package name */
    static final ThreadLocal<DateFormat> f11521e = new a();
    ...
    private final SharedPreferences f11524c;
    ...
    public p(Context context, String str) {
        ...
        this.f11523b = str;
        this.f11524c = context.getSharedPreferences("com.google.firebase.remoteconfig_legacy_settings", 0);
    }
    ...
    private Map<String, String> b(List<c> list) {
        HashMap hashMap = new HashMap();
        for (c next : list) {
            hashMap.put(next.C(), next.D().z(f11520d));
        }
        return hashMap;
    }
    ...
    private JSONObject c(c.a.a.c cVar) throws JSONException {
        ...
        jSONObject.put("experimentStartTime", f11521e.get().format(new Date(cVar.D())));
    ...
    private com.google.firebase.remoteconfig.l.f h() {
        /*
            ...
            android.content.Context r2 = r7.f11522a
            r3 = 0
    ...
    public e f(String str, String str2) {
        return j.c(this.f11522a, this.f11523b, str, str2);
    }

    public boolean j() {
        if (!this.f11524c.getBoolean("save_legacy_configs", true)) {
            return false;
        }
        i(g());
        this.f11524c.edit().putBoolean("save_legacy_configs", false).commit();
        return true;
    }
}
