...
public class k {
    ...
    private final FirebaseInstanceId f11497a;

    /* renamed from: b  reason: collision with root package name */
    private final com.google.firebase.analytics.a.a f11498b;
    ...
    private final Random f11501e;

    /* renamed from: f  reason: collision with root package name */
    private final e f11502f;
    ...
    private a e(com.google.firebase.iid.a aVar, Date date) throws FirebaseRemoteConfigException {
        try {
            a fetch = this.g.fetch(this.g.c(), aVar.g(), aVar.a(), j(), this.h.c(), this.i, date);
            if (fetch.e() != null) {
                this.h.i(fetch.e());
            }
            this.h.f();
    ...
    private Task<a> f(com.google.firebase.iid.a aVar, Date date) {
        try {
            ...
            return this.f11502f.i(e2.d()).t(this.f11499c, j.a(e2));
    ...
    public Task<a> g(Task<f> task, long j2) {
        ...
        Date date = new Date(this.f11500d.a());
        if (task.r() && a(j2, date)) {
        ...
        if (h2 != null) {
            ...
            task2 = this.f11497a.c().l(this.f11499c, h.a(this, date));
        }
        return task2.l(this.f11499c, i.a(this, date));
    }
    ...
    private long i(int i2) {
        ...
        return (millis / 2) + ((long) this.f11501e.nextInt((int) millis));
    }

    private Map<String, String> j() {
        HashMap hashMap = new HashMap();
        com.google.firebase.analytics.a.a aVar = this.f11498b;
        if (aVar == null) {
            return hashMap;
        }
    ...
    public Task<a> d(long j2) {
        ...
        return this.f11502f.c().l(this.f11499c, g.a(this, j2));
    }
}
