...
public final class k0 implements ServiceConnection {
    ...
    private final Intent f11213b;

    /* renamed from: c  reason: collision with root package name */
    private final ScheduledExecutorService f11214c;

    /* renamed from: d  reason: collision with root package name */
    private final Queue<j0> f11215d;
    ...
    private final synchronized void b() {
        ...
        L_0x0011:
            java.util.Queue<com.google.firebase.iid.j0> r0 = r6.f11215d     // Catch:{ all -> 0x00ab }
            ...
            android.util.Log.d(r0, r2)     // Catch:{ all -> 0x00ab }
        L_0x0028:
            com.google.firebase.iid.f0 r0 = r6.f11216e     // Catch:{ all -> 0x00ab }
        ...
        L_0x0043:
            ...
            com.google.firebase.iid.f0 r2 = r6.f11216e     // Catch:{ all -> 0x00ab }
        ...
        L_0x0051:
            ...
            java.lang.String r0 = "FirebaseInstanceId"
            boolean r3 = r6.f11217f     // Catch:{ all -> 0x00ab }
        ...
        L_0x007a:
            boolean r0 = r6.f11217f     // Catch:{ all -> 0x00ab }
            if (r0 != 0) goto L_0x00a7
            r6.f11217f = r2     // Catch:{ all -> 0x00ab }
            ...
            android.content.Context r2 = r6.f11212a     // Catch:{ SecurityException -> 0x009a }
            android.content.Intent r3 = r6.f11213b     // Catch:{ SecurityException -> 0x009a }
            r4 = 65
        ...
        L_0x00a2:
            r6.f11217f = r1     // Catch:{ all -> 0x00ab }
    ...
    private k0(Context context, String str, ScheduledExecutorService scheduledExecutorService) {
        this.f11215d = new ArrayDeque();
        this.f11217f = false;
        this.f11212a = context.getApplicationContext();
        this.f11213b = new Intent(str).setPackage(this.f11212a.getPackageName());
        this.f11214c = scheduledExecutorService;
    }
}
