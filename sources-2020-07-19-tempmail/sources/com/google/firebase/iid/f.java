...
final class f implements ServiceConnection {
    ...
    final Queue<p<?>> f11193d;
    @GuardedBy("this")

    /* renamed from: e  reason: collision with root package name */
    final SparseArray<p<?>> f11194e;

    /* renamed from: f  reason: collision with root package name */
    final /* synthetic */ e f11195f;

    private f(e eVar) {
        this.f11195f = eVar;
        this.f11190a = 0;
        this.f11191b = new Messenger(new zze(Looper.getMainLooper(), new i(this)));
        this.f11193d = new ArrayDeque();
        this.f11194e = new SparseArray<>();
    }

    /* access modifiers changed from: package-private */
    public final void a() {
        this.f11195f.f11184b.execute(new j(this));
    }

    /* access modifiers changed from: package-private */
    public final synchronized void b(int i) {
        p pVar = this.f11194e.get(i);
        if (pVar != null) {
            StringBuilder sb = new StringBuilder(31);
            sb.append("Timing out request: ");
            sb.append(i);
            Log.w("MessengerIpcClient", sb.toString());
            this.f11194e.remove(i);
    ...
    public final synchronized void c(int i, String str) {
        ...
        if (i2 == 0) {
            ...
            this.f11190a = 4;
            ConnectionTracker.b().c(this.f11195f.f11183a, this);
            zzam zzam = new zzam(i, str);
            for (p b2 : this.f11193d) {
                b2.b(zzam);
            }
            this.f11193d.clear();
            for (int i3 = 0; i3 < this.f11194e.size(); i3++) {
                this.f11194e.valueAt(i3).b(zzam);
            }
            this.f11194e.clear();
        } else if (i2 == 3) {
            this.f11190a = 4;
    ...
    public final boolean d(android.os.Message r5) {
        ...
        L_0x0023:
            monitor-enter(r4)
            android.util.SparseArray<com.google.firebase.iid.p<?>> r1 = r4.f11194e     // Catch:{ all -> 0x006f }
            ...
            return r2
        L_0x0049:
            android.util.SparseArray<com.google.firebase.iid.p<?>> r3 = r4.f11194e     // Catch:{ all -> 0x006f }
    ...
    public final synchronized boolean e(com.google.firebase.iid.p<?> r6) {
        /*
            r5 = this;
            monitor-enter(r5)
            int r0 = r5.f11190a     // Catch:{ all -> 0x0097 }
            r1 = 2
            r2 = 0
            r3 = 1
        ...
        L_0x002e:
            ...
            return r2
        L_0x0030:
            java.util.Queue<com.google.firebase.iid.p<?>> r0 = r5.f11193d     // Catch:{ all -> 0x0097 }
        ...
        L_0x0041:
            java.util.Queue<com.google.firebase.iid.p<?>> r0 = r5.f11193d     // Catch:{ all -> 0x0097 }
            r0.add(r6)     // Catch:{ all -> 0x0097 }
            int r6 = r5.f11190a     // Catch:{ all -> 0x0097 }
        ...
        L_0x005f:
            r5.f11190a = r3     // Catch:{ all -> 0x0097 }
            ...
            com.google.firebase.iid.e r1 = r5.f11195f     // Catch:{ all -> 0x0097 }
            android.content.Context r1 = r1.f11183a     // Catch:{ all -> 0x0097 }
            ...
            goto L_0x0095
        L_0x0083:
            com.google.firebase.iid.e r6 = r5.f11195f     // Catch:{ all -> 0x0097 }
            java.util.concurrent.ScheduledExecutorService r6 = r6.f11184b     // Catch:{ all -> 0x0097 }
    ...
    public final synchronized void f() {
        if (this.f11190a == 2 && this.f11193d.isEmpty() && this.f11194e.size() == 0) {
            if (Log.isLoggable("MessengerIpcClient", 2)) {
    ...
    public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        this.f11195f.f11184b.execute(new k(this, iBinder));
    }
    ...
    public final void onServiceDisconnected(ComponentName componentName) {
        ...
        this.f11195f.f11184b.execute(new m(this));
    }
}
