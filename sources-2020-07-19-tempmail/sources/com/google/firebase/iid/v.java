...
final class v {
    ...
    private final Executor f11249a;
    @GuardedBy("this")

    /* renamed from: b  reason: collision with root package name */
    private final Map<Pair<String, String>, Task<a>> f11250b = new a();
    ...
    public final synchronized com.google.android.gms.tasks.Task<com.google.firebase.iid.a> b(java.lang.String r4, java.lang.String r5, com.google.firebase.iid.x r6) {
        /*
            r3 = this;
            monitor-enter(r3)
            android.util.Pair r0 = new android.util.Pair     // Catch:{ all -> 0x0081 }
            r0.<init>(r4, r5)     // Catch:{ all -> 0x0081 }
            java.util.Map<android.util.Pair<java.lang.String, java.lang.String>, com.google.android.gms.tasks.Task<com.google.firebase.iid.a>> r4 = r3.f11250b     // Catch:{ all -> 0x0081 }
        ...
        L_0x006b:
            ...
            java.util.concurrent.Executor r5 = r3.f11249a     // Catch:{ all -> 0x0081 }
            com.google.firebase.iid.u r6 = new com.google.firebase.iid.u     // Catch:{ all -> 0x0081 }
            r6.<init>(r3, r0)     // Catch:{ all -> 0x0081 }
            com.google.android.gms.tasks.Task r4 = r4.l(r5, r6)     // Catch:{ all -> 0x0081 }
            java.util.Map<android.util.Pair<java.lang.String, java.lang.String>, com.google.android.gms.tasks.Task<com.google.firebase.iid.a>> r5 = r3.f11250b     // Catch:{ all -> 0x0081 }
        ...
        L_0x0081:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.iid.v.b(java.lang.String, java.lang.String, com.google.firebase.iid.x):com.google.android.gms.tasks.Task");
    }
}
