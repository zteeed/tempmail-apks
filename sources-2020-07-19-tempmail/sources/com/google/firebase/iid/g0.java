...
public final class g0 {
    ...
    private static final long f11198a = TimeUnit.MINUTES.toMillis(1);
    ...
    private static WakeLock f11200c;
    ...
    public static android.content.ComponentName a(android.content.Context r4, android.content.Intent r5) {
        /*
            java.lang.Object r0 = f11199b
            monitor-enter(r0)
            com.google.android.gms.stats.WakeLock r1 = f11200c     // Catch:{ all -> 0x0032 }
            r2 = 1
        ...
        L_0x0027:
            ...
            com.google.android.gms.stats.WakeLock r5 = f11200c     // Catch:{ all -> 0x0032 }
            long r1 = f11198a     // Catch:{ all -> 0x0032 }
    ...
    public static void b(Intent intent) {
        synchronized (f11199b) {
            if (f11200c != null && intent.getBooleanExtra("com.google.firebase.iid.WakeLockHolder.wakefulintent", false)) {
                c(intent, false);
                f11200c.b();
            }
        }
