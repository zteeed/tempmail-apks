...
final /* synthetic */ class j implements Runnable {
    ...
    public final void run() {
        /*
            r8 = this;
            com.google.firebase.iid.f r0 = r8.f11206b
        L_0x0002:
            monitor-enter(r0)
            int r1 = r0.f11190a     // Catch:{ all -> 0x00ae }
            r2 = 2
            if (r1 == r2) goto L_0x000a
            monitor-exit(r0)     // Catch:{ all -> 0x00ae }
            return
        L_0x000a:
            java.util.Queue<com.google.firebase.iid.p<?>> r1 = r0.f11193d     // Catch:{ all -> 0x00ae }
        ...
        L_0x0017:
            ...
            android.util.SparseArray<com.google.firebase.iid.p<?>> r3 = r0.f11194e     // Catch:{ all -> 0x00ae }
            int r4 = r1.f11229a     // Catch:{ all -> 0x00ae }
            r3.put(r4, r1)     // Catch:{ all -> 0x00ae }
            com.google.firebase.iid.e r3 = r0.f11195f     // Catch:{ all -> 0x00ae }
            java.util.concurrent.ScheduledExecutorService r3 = r3.f11184b     // Catch:{ all -> 0x00ae }
        ...
        L_0x0066:
            com.google.firebase.iid.e r3 = r0.f11195f
            android.content.Context r3 = r3.f11183a
            android.os.Messenger r4 = r0.f11191b
            ...
            android.os.Bundle r1 = r1.f11232d
            r4.putBundle(r3, r1)
            r5.setData(r4)
            com.google.firebase.iid.o r1 = r0.f11192c     // Catch:{ RemoteException -> 0x00a4 }
