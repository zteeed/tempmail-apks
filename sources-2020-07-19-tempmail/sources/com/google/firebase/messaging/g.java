...
public final class g {
    ...
    private static final AtomicInteger f11413a = new AtomicInteger((int) SystemClock.elapsedRealtime());
    ...
    private static PendingIntent b(Context context, Intent intent) {
        return PendingIntent.getBroadcast(context, f11413a.incrementAndGet(), new Intent("com.google.firebase.MESSAGING_EVENT").setComponent(new ComponentName(context, "com.google.firebase.iid.FirebaseInstanceIdReceiver")).putExtra("wrapped_intent", intent), 1073741824);
    }
    ...
    static com.google.firebase.messaging.b d(android.content.Context r9, com.google.firebase.messaging.w r10) {
        ...
        L_0x00f7:
            ...
            r3.putExtras(r2)
            java.util.concurrent.atomic.AtomicInteger r2 = f11413a
