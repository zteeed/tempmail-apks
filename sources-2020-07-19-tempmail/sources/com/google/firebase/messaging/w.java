...
public final class w {
    ...
    private final Bundle f11438a;

    public w(Bundle bundle) {
        if (bundle != null) {
            this.f11438a = new Bundle(bundle);
            return;
        }
    ...
    public final String c(String str) {
        Bundle bundle = this.f11438a;
        if (!bundle.containsKey(str) && str.startsWith("gcm.n.")) {
            String r = r(str);
            if (this.f11438a.containsKey(r)) {
                str = r;
            }
        }
    ...
    public final Bundle l() {
        Bundle bundle = new Bundle(this.f11438a);
