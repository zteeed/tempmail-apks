...
final class d {
    ...
    private final FirebaseInstanceId f11400a;

    /* renamed from: b  reason: collision with root package name */
    private final Context f11401b;

    /* renamed from: c  reason: collision with root package name */
    private final q f11402c;

    /* renamed from: d  reason: collision with root package name */
    private final d1 f11403d;

    /* renamed from: e  reason: collision with root package name */
    private final Map<String, ArrayDeque<TaskCompletionSource<Void>>> f11404e = new a();

    /* renamed from: f  reason: collision with root package name */
    private final ScheduledExecutorService f11405f;
    ...
    private d(FirebaseInstanceId firebaseInstanceId, q qVar, b0 b0Var, d1 d1Var, Context context, ScheduledExecutorService scheduledExecutorService) {
        this.f11400a = firebaseInstanceId;
        this.f11402c = qVar;
        this.h = b0Var;
        this.f11403d = d1Var;
        this.f11401b = context;
        this.f11405f = scheduledExecutorService;
    }

    static Task<d> a(c cVar, FirebaseInstanceId firebaseInstanceId, q qVar, h hVar, com.google.firebase.g.c cVar2, com.google.firebase.installations.h hVar2, Context context, Executor executor, ScheduledExecutorService scheduledExecutorService) {
        return Tasks.c(scheduledExecutorService, new c(context, scheduledExecutorService, firebaseInstanceId, qVar, new d1(cVar, qVar, executor, hVar, cVar2, hVar2)));
    }
    ...
    private final boolean i(c0 c0Var) throws IOException {
        try {
            ...
            if (c2 == 0) {
                String a2 = c0Var.a();
                com.google.firebase.iid.a aVar = (com.google.firebase.iid.a) c(this.f11400a.c());
                c(this.f11403d.h(aVar.g(), aVar.a(), a2));
                if (k()) {
                    String a3 = c0Var.a();
                ...
                String a4 = c0Var.a();
                com.google.firebase.iid.a aVar2 = (com.google.firebase.iid.a) c(this.f11400a.c());
                c(this.f11403d.i(aVar2.g(), aVar2.a(), a4));
                if (k()) {
                    String a5 = c0Var.a();
    ...
    public final void e(long j) {
        f(new f(this, this.f11401b, this.f11402c, Math.min(Math.max(30, j << 1), i)), j);
        g(true);
    }

    /* access modifiers changed from: package-private */
    public final void f(Runnable runnable, long j) {
        this.f11405f.schedule(runnable, j, TimeUnit.SECONDS);
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0034, code lost:
        if (r5.f11404e.containsKey(r0) != false) goto L_0x0038;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:19:0x0036, code lost:
        monitor-exit(r1);
     */
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x0038, code lost:
        r2 = r5.f11404e.get(r0);
    ...
    public final boolean h() throws java.io.IOException {
        ...
        L_0x0022:
            ...
            r1.d(r0)
            java.util.Map<java.lang.String, java.util.ArrayDeque<com.google.android.gms.tasks.TaskCompletionSource<java.lang.Void>>> r1 = r5.f11404e
            monitor-enter(r1)
            java.lang.String r0 = r0.d()     // Catch:{ all -> 0x0059 }
            java.util.Map<java.lang.String, java.util.ArrayDeque<com.google.android.gms.tasks.TaskCompletionSource<java.lang.Void>>> r2 = r5.f11404e     // Catch:{ all -> 0x0059 }
