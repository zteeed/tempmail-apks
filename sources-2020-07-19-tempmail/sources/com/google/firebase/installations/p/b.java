...
public class b {
    ...
    private static final String[] f11321c = {"*", "FCM", "GCM", ""};

    /* renamed from: a  reason: collision with root package name */
    private final SharedPreferences f11322a;

    /* renamed from: b  reason: collision with root package name */
    private final String f11323b;

    public b(c cVar) {
        this.f11322a = cVar.g().getSharedPreferences("com.google.android.gms.appid", 0);
        this.f11323b = b(cVar);
    }
    ...
    private String g() {
        ...
        synchronized (this.f11322a) {
            string = this.f11322a.getString("|S|id", (String) null);
        }
        return string;
    }
    ...
    private String h() {
        synchronized (this.f11322a) {
            String string = this.f11322a.getString("|S||P|", (String) null);
            if (string == null) {
                return null;
            }
    ...
    public java.lang.String i() {
        /*
            r7 = this;
            android.content.SharedPreferences r0 = r7.f11322a
            monitor-enter(r0)
            java.lang.String[] r1 = f11321c     // Catch:{ all -> 0x0033 }
        ...
        L_0x0007:
            ...
            java.lang.String r6 = r7.f11323b     // Catch:{ all -> 0x0033 }
            java.lang.String r5 = r7.a(r6, r5)     // Catch:{ all -> 0x0033 }
            android.content.SharedPreferences r6 = r7.f11322a     // Catch:{ all -> 0x0033 }
        ...
        L_0x0033:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.installations.p.b.i():java.lang.String");
    }
}
