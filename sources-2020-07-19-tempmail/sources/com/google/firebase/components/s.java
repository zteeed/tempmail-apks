...
final class s extends a {
    ...
    private final Set<Class<?>> f11079a;

    /* renamed from: b  reason: collision with root package name */
    private final Set<Class<?>> f11080b;

    /* renamed from: c  reason: collision with root package name */
    private final Set<Class<?>> f11081c;

    /* renamed from: d  reason: collision with root package name */
    private final Set<Class<?>> f11082d;

    /* renamed from: e  reason: collision with root package name */
    private final Set<Class<?>> f11083e;

    /* renamed from: f  reason: collision with root package name */
    private final e f11084f;
    ...
    s(d<?> dVar, e eVar) {
        ...
        this.f11079a = Collections.unmodifiableSet(hashSet);
        this.f11080b = Collections.unmodifiableSet(hashSet2);
        this.f11081c = Collections.unmodifiableSet(hashSet3);
        this.f11082d = Collections.unmodifiableSet(hashSet4);
        this.f11083e = dVar.f();
        this.f11084f = eVar;
    }

    public <T> T a(Class<T> cls) {
        if (this.f11079a.contains(cls)) {
            T a2 = this.f11084f.a(cls);
            if (!cls.equals(c.class)) {
                return a2;
            }
            return new a(this.f11083e, (c) a2);
        }
    ...
    public <T> com.google.firebase.h.a<T> b(Class<T> cls) {
        if (this.f11080b.contains(cls)) {
            return this.f11084f.b(cls);
        }
    ...
    public <T> com.google.firebase.h.a<Set<T>> c(Class<T> cls) {
        if (this.f11082d.contains(cls)) {
            return this.f11084f.c(cls);
        }
    ...
    public <T> Set<T> d(Class<T> cls) {
        if (this.f11081c.contains(cls)) {
            return this.f11084f.d(cls);
        }
