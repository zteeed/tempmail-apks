...
public final class f<T> {
    ...
    private final T f11051a;

    /* renamed from: b  reason: collision with root package name */
    private final c<T> f11052b;

    /* compiled from: com.google.firebase:firebase-components@@16.0.0 */
    private static class b implements c<Context> {

        /* renamed from: a  reason: collision with root package name */
        private final Class<? extends Service> f11053a;
        ...
        private Bundle b(Context context) {
            try {
                ...
                ServiceInfo serviceInfo = packageManager.getServiceInfo(new ComponentName(context, this.f11053a), 128);
                if (serviceInfo != null) {
                    return serviceInfo.metaData;
                }
                Log.w("ComponentDiscovery", this.f11053a + " has no service info.");
                return null;
    ...
    public List<h> a() {
        return c(this.f11052b.a(this.f11051a));
    }
}
