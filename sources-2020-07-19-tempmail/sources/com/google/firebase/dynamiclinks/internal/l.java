...
public abstract class l extends zza implements i {
    ...
    public final boolean y(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        if (i == 1) {
            l2((Status) zzd.a(parcel, Status.CREATOR), (DynamicLinkData) zzd.a(parcel, DynamicLinkData.CREATOR));
            return true;
        } else if (i != 2) {
            return false;
        } else {
            r2((Status) zzd.a(parcel, Status.CREATOR), (zzo) zzd.a(parcel, zzo.CREATOR));
            throw null;
        }
    }
}
