...
final class f {
    ...
    f(a aVar, c cVar) {
        ...
        this.f12005d = a2;
        this.f12004c = cVar;
        this.f12003b = new g[(a2 + 2)];
    }

    private void a(g gVar) {
        if (gVar != null) {
            ((h) gVar).g(this.f12002a);
        }
    }
    ...
    private int d() {
        ...
        for (int i = 1; i < this.f12005d + 1; i++) {
            d[] d2 = this.f12003b[i].d();
    ...
    private void e(int i, int i2, d[] dVarArr) {
        d dVar = dVarArr[i2];
        d[] d2 = this.f12003b[i - 1].d();
        g[] gVarArr = this.f12003b;
        int i3 = i + 1;
    ...
    private void g() {
        g[] gVarArr = this.f12003b;
        if (gVarArr[0] != null && gVarArr[this.f12005d + 1] != null) {
            d[] d2 = gVarArr[0].d();
            d[] d3 = this.f12003b[this.f12005d + 1].d();
            for (int i = 0; i < d2.length; i++) {
                if (!(d2[i] == null || d3[i] == null || d2[i].c() != d3[i].c())) {
                    for (int i2 = 1; i2 <= this.f12005d; i2++) {
                        d dVar = this.f12003b[i2].d()[i];
                        if (dVar != null) {
                            dVar.i(d2[i].c());
                            if (!dVar.g()) {
                                this.f12003b[i2].d()[i] = null;
                            }
                        }
                    }
                }
    ...
    private int h() {
        ...
        for (int i2 = 0; i2 < d2.length; i2++) {
            if (d2[i2] != null) {
                int c2 = d2[i2].c();
                int i3 = 0;
                for (int i4 = 1; i4 < this.f12005d + 1 && i3 < 2; i4++) {
                    d dVar = this.f12003b[i4].d()[i2];
                    if (dVar != null) {
                        i3 = c(c2, i3, dVar);
                        if (!dVar.g()) {
                            i++;
    ...
    private int i() {
        ...
        for (int i3 = 0; i3 < d2.length; i3++) {
            if (d2[i3] != null) {
                int c2 = d2[i3].c();
                int i4 = 0;
                for (int i5 = this.f12005d + 1; i5 > 0 && i4 < 2; i5--) {
                    d dVar = this.f12003b[i5].d()[i3];
                    if (dVar != null) {
                        i4 = c(c2, i4, dVar);
                        if (!dVar.g()) {
                            i2++;
    ...
    public java.lang.String toString() {
        /*
            r10 = this;
            com.google.zxing.x.e.g[] r0 = r10.f12003b
            r1 = 0
            r2 = r0[r1]
            r3 = 1
        ...
        L_0x0013:
            ...
            r5 = 0
        L_0x0028:
            int r6 = r10.f12005d     // Catch:{ all -> 0x007e }
            r7 = 2
            int r6 = r6 + r7
            if (r5 >= r6) goto L_0x006c
            com.google.zxing.x.e.g[] r6 = r10.f12003b     // Catch:{ all -> 0x007e }
