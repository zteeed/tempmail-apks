...
final class e {
    ...
    private static final char[] f11993a = ";<>@[\\]_`~!\r\t,:\n-.$/\"|*()?{}'".toCharArray();

    /* renamed from: b  reason: collision with root package name */
    private static final char[] f11994b = "0123456789&\r\t,:#-.$/+%*=^".toCharArray();

    /* renamed from: c  reason: collision with root package name */
    private static final BigInteger[] f11995c;
    ...
    static {
        ...
        f11995c = bigIntegerArr;
        bigIntegerArr[0] = BigInteger.ONE;
        BigInteger valueOf = BigInteger.valueOf(900);
        f11995c[1] = valueOf;
        int i = 2;
        while (true) {
            BigInteger[] bigIntegerArr2 = f11995c;
    ...
    private static String c(int[] iArr, int i) throws FormatException {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            bigInteger = bigInteger.add(f11995c[(i - i2) - 1].multiply(BigInteger.valueOf((long) iArr[i2])));
        }
    ...
    private static void e(int[] r12, int[] r13, int r14, java.lang.StringBuilder r15) {
        ...
        L_0x0005:
            ...
            r4 = r12[r3]
            int[] r5 = com.google.zxing.x.e.e.a.f11996a
            int r6 = r0.ordinal()
            r5 = r5[r6]
            r6 = 32
            r7 = 29
