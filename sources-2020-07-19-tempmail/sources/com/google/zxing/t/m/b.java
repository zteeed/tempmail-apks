...
public final class b {
    ...
    private final com.google.zxing.t.b f11803a;
    ...
    public b(com.google.zxing.t.b bVar, int i, int i2, int i3) throws NotFoundException {
        ...
        int i8 = i3 + i4;
        this.f11808f = i8;
        if (i7 < 0 || i5 < 0 || i8 >= this.f11804b || i6 >= n) {
            throw NotFoundException.a();
        }
    }
}
