...
final class b {
    ...
    static b[] b(byte[] bArr, e eVar) {
        ...
        int length = bVarArr[0].f11815b.length - d2.b();
        int i4 = length - 1;
        int i5 = 0;
        for (int i6 = 0; i6 < i4; i6++) {
            int i7 = 0;
            while (i7 < i2) {
                bVarArr[i7].f11815b[i6] = bArr[i5];
                i7++;
                i5++;
            }
        }
        ...
        int i9 = 0;
        while (i9 < i8) {
            bVarArr[i9].f11815b[i4] = bArr[i5];
            i9++;
            i5++;
        }
        int length2 = bVarArr[0].f11815b.length;
        while (length < length2) {
            int i10 = 0;
            while (i10 < i2) {
                int i11 = z ? (i10 + 8) % i2 : i10;
                bVarArr[i11].f11815b[(!z || i11 <= 7) ? length : length - 1] = bArr[i5];
                i10++;
                i5++;
            }
            length++;
