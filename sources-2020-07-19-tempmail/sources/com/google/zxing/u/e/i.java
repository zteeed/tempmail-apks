        ...
        if (str.length() == kVar.a()) {
            ...
            if (f2 == 1) {
                ...
                for (int i3 = 0; i3 < f2; i3++) {
                    ...
                    for (int i4 = i3; i4 < kVar.a(); i4 += f2) {
                        sb2.append(str.charAt(i4));
                    }
                    String a2 = a(sb2.toString(), iArr2[i3]);
                    int i5 = i3;
                    int i6 = 0;
                    while (i5 < iArr2[i3] * f2) {
