...
public final class a {
    ...
    private final com.google.zxing.t.b f11838a;

    /* renamed from: b  reason: collision with root package name */
    private final com.google.zxing.t.m.b f11839b;

    /* compiled from: Detector */
    private static final class b {

        /* renamed from: a  reason: collision with root package name */
        private final o f11840a;

        /* renamed from: b  reason: collision with root package name */
        private final o f11841b;
        ...
        public String toString() {
            return this.f11840a + "/" + this.f11841b + '/' + this.f11842c;
        }
    ...
    public a(com.google.zxing.t.b bVar) throws NotFoundException {
        this.f11838a = bVar;
        this.f11839b = new com.google.zxing.t.m.b(bVar);
    }
    ...
    private boolean f(o oVar) {
        return oVar.c() >= 0.0f && oVar.c() < ((float) this.f11838a.n()) && oVar.d() > 0.0f && oVar.d() < ((float) this.f11838a.j());
    }
    ...
    private b h(o oVar, o oVar2) {
        ...
        boolean f2 = this.f11838a.f(z ? d2 : c2, z ? c2 : d2);
        while (c2 != c3) {
            boolean f3 = this.f11838a.f(z ? d2 : c2, z ? c2 : d2);
            if (f3 != f2) {
                i++;
                f2 = f3;
            }
    ...
    public g c() throws NotFoundException {
        ...
        if (i * 4 >= i2 * 7 || i2 * 4 >= i * 7) {
            ...
            bVar = g(this.f11838a, oVar2, oVar12, oVar11, oVar, i3, c6);
        } else {
            ...
            int i4 = max;
            bVar = g(this.f11838a, oVar13, oVar12, oVar11, oVar, i4, i4);
            oVar2 = oVar13;
        }
