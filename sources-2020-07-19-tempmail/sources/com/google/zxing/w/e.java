...
public final class e extends r {
    ...
    static final int[] f11935e = {52, 289, 97, 352, 49, 304, 112, 37, 292, 100, 265, 73, 328, 25, 280, 88, 13, 268, 76, 28, 259, 67, 322, 19, 274, 82, 7, 262, 70, 22, 385, 193, 448, 145, 400, 208, 133, 388, 196, 168, 162, 138, 42};
    ...
    private final StringBuilder f11938c;
    ...
    public m d(int i, a aVar, Map<d, ?> map) throws NotFoundException, ChecksumException, FormatException {
        String str;
        int[] iArr = this.f11939d;
        Arrays.fill(iArr, 0);
        StringBuilder sb = this.f11938c;
        sb.setLength(0);
        int[] j = j(aVar, iArr);
        int k = aVar.k(j[1]);
        int n = aVar.n();
                    ...
                    if (k3 == n || (i6 << 1) >= i4) {
                        if (this.f11936a) {
                            ...
                            for (int i8 = 0; i8 < length; i8++) {
                                i7 += "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%".indexOf(this.f11938c.charAt(i8));
                            }
    ...
    public e(boolean z, boolean z2) {
        this.f11936a = z;
        this.f11937b = z2;
        this.f11938c = new StringBuilder(20);
        this.f11939d = new int[9];
    }
}
