    ...
    public boolean[] c(String str) {
        ...
        if (length <= 80) {
            ...
            for (int i3 = 0; i3 < length; i3++) {
                f(e.f11935e["0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%".indexOf(str.charAt(i3))], iArr);
            ...
            for (int i5 = 0; i5 < length; i5++) {
                f(e.f11935e["0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%".indexOf(str.charAt(i5))], iArr);
