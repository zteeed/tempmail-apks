...
public final class a {
    ...
    private o[] f(C0113a aVar) throws NotFoundException {
        ...
        C0113a aVar5 = aVar4;
        boolean z = true;
        while (this.f11718e < 9) {
            C0113a j = j(aVar2, z, 1, -1);
            C0113a j2 = j(aVar3, z, 1, 1);
            C0113a j3 = j(aVar4, z, -1, 1);
            C0113a j4 = j(aVar5, z, -1, -1);
            if (this.f11718e > 2) {
                double c2 = (double) ((c(j4, j) * ((float) this.f11718e)) / (c(aVar5, aVar2) * ((float) (this.f11718e + 2))));
    ...
    private int g(C0113a aVar, C0113a aVar2) {
        ...
        boolean f2 = this.f11714a.f(aVar.a(), aVar.b());
        ...
        for (int i2 = 0; i2 < ceil; i2++) {
            a3 += a2;
            b3 += b2;
            if (this.f11714a.f(com.google.zxing.t.m.a.c(a3), com.google.zxing.t.m.a.c(b3)) != f2) {
                i++;
            }
        }
        float f3 = ((float) i) / c2;
    ...
    private C0113a j(C0113a aVar, boolean z, int i, int i2) {
        ...
        while (true) {
            b2 += i2;
            if (!n(a2, b2) || this.f11714a.f(a2, b2) != z) {
                int i3 = a2 - i;
                int i4 = b2 - i2;
            } else {
                a2 += i;
        ...
        int i32 = a2 - i;
        int i42 = b2 - i2;
        while (n(i32, i42) && this.f11714a.f(i32, i42) == z) {
            i32 += i;
        }
        int i5 = i32 - i;
        while (n(i5, i42) && this.f11714a.f(i5, i42) == z) {
            i42 += i2;
        }
    ...
    private C0113a k() {
        ...
        o oVar8;
        try {
            o[] c2 = new com.google.zxing.t.m.b(this.f11714a).c();
            oVar3 = c2[0];
            oVar2 = c2[1];
            oVar = c2[2];
            oVar4 = c2[3];
        } catch (NotFoundException unused) {
            int n = this.f11714a.n() / 2;
            int j = this.f11714a.j() / 2;
            int i = n + 7;
            int i2 = j - 7;
        ...
        try {
            o[] c8 = new com.google.zxing.t.m.b(this.f11714a, 15, c6, c7).c();
            oVar6 = c8[0];
            oVar5 = c8[1];
            oVar7 = c8[2];
            oVar8 = c8[3];
    ...
    private o[] l(o[] oVarArr) {
        return d(oVarArr, this.f11718e * 2, i());
    }
    ...
    private boolean n(int i, int i2) {
        return i >= 0 && i < this.f11714a.n() && i2 > 0 && i2 < this.f11714a.j();
    }
    ...
    private int r(o oVar, o oVar2, int i) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            float f3 = (float) i3;
            if (this.f11714a.f(com.google.zxing.t.m.a.c((f3 * c3) + c2), com.google.zxing.t.m.a.c((f3 * d3) + d2))) {
                i2 |= 1 << ((i - i3) - 1);
            }
        }
        return i2;
    ...
    public com.google.zxing.r.a a(boolean z) throws NotFoundException {
        ...
        b bVar = this.f11714a;
        int i = this.f11719f;
        return new com.google.zxing.r.a(q(bVar, f2[i % 4], f2[(i + 1) % 4], f2[(i + 2) % 4], f2[(i + 3) % 4]), l(f2), this.f11715b, this.f11717d, this.f11716c);
    }
}
