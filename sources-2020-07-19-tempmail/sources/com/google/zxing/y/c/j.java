...
public final class j {
    ...
    private static final int[] f12084e = {31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017};

    /* renamed from: f  reason: collision with root package name */
    private static final j[] f12085f = b();
    ...
    public static final class b {
        ...
        /* renamed from: b  reason: collision with root package name */
        private final a[] f12093b;

        b(int i, a... aVarArr) {
            this.f12092a = i;
            this.f12093b = aVarArr;
        }
    ...
    public com.google.zxing.t.b a() {
        ...
        bVar.r(i, 0, 8, 9);
        bVar.r(0, i, 9, 8);
        int length = this.f12087b.length;
        for (int i2 = 0; i2 < length; i2++) {
            int i3 = this.f12087b[i2] - 2;
            for (int i4 = 0; i4 < length; i4++) {
                if (!((i2 == 0 && (i4 == 0 || i4 == length - 1)) || (i2 == length - 1 && i4 == 0))) {
                    bVar.r(this.f12087b[i4] - 2, i3, 5, 5);
                }
            }
        }
        int i5 = e2 - 17;
    ...
    public int e() {
        return (this.f12086a * 4) + 17;
    }

    public b f(f fVar) {
        return this.f12088c[fVar.ordinal()];
    }
    ...
    public String toString() {
        return String.valueOf(this.f12086a);
    }
}
