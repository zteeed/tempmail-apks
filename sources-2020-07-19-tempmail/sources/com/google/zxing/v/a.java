...
public final class a implements l {
    ...
    private static final o[] f11867b = new o[0];

    /* renamed from: a  reason: collision with root package name */
    private final c f11868a = new c();
    ...
    public m b(com.google.zxing.c cVar, Map<d, ?> map) throws NotFoundException, ChecksumException, FormatException {
        ...
        e b2 = this.f11868a.b(d(cVar.a()), map);
        m mVar = new m(b2.h(), b2.e(), f11867b, com.google.zxing.a.MAXICODE);
        String b3 = b2.b();
        if (b3 != null) {
