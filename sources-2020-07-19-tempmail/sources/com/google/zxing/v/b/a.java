...
final class a {
    ...
    public byte[] a() {
        ...
        int n = this.f11870a.n();
        for (int i = 0; i < j; i++) {
            int[] iArr = f11869b[i];
            for (int i2 = 0; i2 < n; i2++) {
                int i3 = iArr[i2];
                if (i3 >= 0 && this.f11870a.f(i2, i)) {
                    int i4 = i3 / 6;
