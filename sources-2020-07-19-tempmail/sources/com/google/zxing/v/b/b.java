...
final class b {
    ...
    private static final String[] f11871a = {"\nABCDEFGHIJKLMNOPQRSTUVWXYZ￺\u001c\u001d\u001e￻ ￼\"#$%&'()*+,-./0123456789:￱￲￳￴￸", "`abcdefghijklmnopqrstuvwxyz￺\u001c\u001d\u001e￻{￼}~;<=>?[\\]^_ ,./:@!|￼￵￶￼￰￲￳￴￷", "ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚ￺\u001c\u001d\u001eÛÜÝÞßª¬±²³µ¹º¼½¾￷ ￹￳￴￸", "àáâãäåæçèéêëìíîïðñòóôõö÷øùú￺\u001c\u001d\u001e￻ûüýþÿ¡¨«¯°´·¸»¿￷ ￲￹￴￸", "\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\b\t\n\u000b\f\r\u000e\u000f\u0010\u0011\u0012\u0013\u0014\u0015\u0016\u0017\u0018\u0019\u001a￺￼￼\u001b￻\u001c\u001d\u001e\u001f ¢£¤¥¦§©­®¶￷ ￲￳￹￸", "\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\b\t\n\u000b\f\r\u000e\u000f\u0010\u0011\u0012\u0013\u0014\u0015\u0016\u0017\u0018\u0019\u001a\u001b\u001c\u001d\u001e\u001f !\"#$%&'()*+,-./0123456789:;<=>?"};
    ...
    private static java.lang.String e(byte[] r12, int r13, int r14) {
        ...
        L_0x0084:
            ...
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.v.b.b.e(byte[], int, int):java.lang.String");
    }
    ...
    private static String h(byte[] bArr) {
        return String.valueOf(new char[]{f11871a[0].charAt(d(bArr, new byte[]{39, 40, 41, 42, 31, 32})), f11871a[0].charAt(d(bArr, new byte[]{33, 34, 35, 36, 25, 26})), f11871a[0].charAt(d(bArr, new byte[]{27, 28, 29, 30, 19, 20})), f11871a[0].charAt(d(bArr, new byte[]{21, 22, 23, 24, 13, 14})), f11871a[0].charAt(d(bArr, new byte[]{15, 16, 17, 18, 7, 8})), f11871a[0].charAt(d(bArr, new byte[]{9, 10, 11, 12, 1, 2}))});
    }
