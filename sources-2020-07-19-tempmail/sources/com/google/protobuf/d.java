...
public abstract class d implements Iterable<Byte>, Serializable {
    ...
    public static final d f11556c = new g(j.f11596b);

    /* renamed from: d  reason: collision with root package name */
    private static final C0108d f11557d;
    ...
    class a implements e {
        ...
        /* renamed from: c  reason: collision with root package name */
        private final int f11560c = d.this.size();
        ...
        public boolean hasNext() {
            return this.f11559b < this.f11560c;
        }
    ...
    private static final class c extends g {
        ...
        public byte c(int i) {
            d.h(i, size());
            return this.f11563e[this.f11562f + i];
        }

        /* access modifiers changed from: protected */
        public void m(byte[] bArr, int i, int i2, int i3) {
            System.arraycopy(this.f11563e, G() + i, bArr, i2, i3);
        }
    ...
    private static class g extends f {
        ...
        public final String A(Charset charset) {
            return new String(this.f11563e, G(), size(), charset);
        }
        ...
        /* access modifiers changed from: protected */
        public void m(byte[] bArr, int i, int i2, int i3) {
            System.arraycopy(this.f11563e, i, bArr, i2, i3);
        }

        public final e s() {
            return e.f(this.f11563e, G(), size(), true);
        }

        public int size() {
            return this.f11563e.length;
        }

        /* access modifiers changed from: protected */
        public final int u(int i, int i2, int i3) {
            return j.c(i, this.f11563e, G() + i2, i3);
        }
        ...
        public final d w(int i, int i2) {
            ...
            return new c(this.f11563e, G() + i, i3);
        }
    }
    ...
    static {
        ...
        f11557d = z ? new h((a) null) : new b((a) null);
    }
    ...
    public static d j(byte[] bArr, int i, int i2) {
        return new g(f11557d.a(bArr, i, i2));
    }

    public static d l(String str) {
        return new g(str.getBytes(j.f11595a));
    }
