...
public final class e {
    ...
    private final InputStream f11569f;
    private int g;
    ...
    private void A() {
        int i2 = this.f11566c + this.f11567d;
        this.f11566c = i2;
        int i3 = this.i + i2;
        int i4 = this.j;
        if (i3 > i4) {
    ...
    private boolean I(int i2) throws IOException {
        ...
        if (i3 + i2 <= this.f11566c) {
            ...
            if (this.f11569f != null) {
                ...
                byte[] bArr2 = this.f11564a;
                int i6 = this.f11566c;
                int read = inputStream.read(bArr2, i6, bArr2.length - i6);
                if (read == 0 || read < -1 || read > this.f11564a.length) {
                ...
                if (i5 <= i6) {
                    ...
                    if (inputStream != null) {
                        ...
                        if (i9 < 4096 || i9 <= inputStream.available()) {
                            ...
                            System.arraycopy(this.f11564a, i4, bArr, 0, i8);
                            while (i8 < i2) {
                                int read = this.f11569f.read(bArr, i8, i2 - i8);
                                if (read != -1) {
                                    this.i += read;
                                    i8 += read;
                                } else {
                        ...
                        while (i9 > 0) {
                            ...
                            int i10 = 0;
                            while (i10 < min) {
                                int read2 = this.f11569f.read(bArr2, i10, min - i10);
                                if (read2 != -1) {
                                    this.i += read2;
                                    i10 += read2;
                                } else {
                        ...
                        System.arraycopy(this.f11564a, i4, bArr3, 0, i8);
    ...
    public boolean b() throws IOException {
        return this.f11568e == this.f11566c && !I(1);
    }
    ...
    public d j() throws IOException {
        ...
        int i3 = this.f11568e;
        if (u <= i2 - i3 && u > 0) {
            if (!this.f11565b || !this.h) {
                dVar = d.j(this.f11564a, this.f11568e, u);
            } else {
                dVar = d.C(this.f11564a, i3, u);
            }
            this.f11568e += u;
            return dVar;
        } else if (u == 0) {
    ...
    public String x() throws IOException {
        int u = u();
        if (u <= this.f11566c - this.f11568e && u > 0) {
            String str = new String(this.f11564a, this.f11568e, u, j.f11595a);
            this.f11568e += u;
            return str;
        } else if (u == 0) {
            return "";
            ...
            if (u > this.f11566c) {
                return new String(r(u), j.f11595a);
            }
            B(u);
            String str2 = new String(this.f11564a, this.f11568e, u, j.f11595a);
            this.f11568e += u;
            return str2;
        }
    }
    ...
    public String y() throws IOException {
        ...
        if (v.i(bArr, i2, i2 + u)) {
            return new String(bArr, i2, u, j.f11595a);
        }
