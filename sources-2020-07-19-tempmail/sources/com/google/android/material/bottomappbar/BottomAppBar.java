...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.b {
    ...
    static class SavedState extends AbsSavedState {
        ...
        public void writeToParcel(Parcel parcel, int i) {
            ...
            parcel.writeInt(this.f10685e ? 1 : 0);
        }

        public SavedState(Parcel parcel, ClassLoader classLoader) {
            super(parcel, classLoader);
            this.f10684d = parcel.readInt();
            this.f10685e = parcel.readInt() != 0;
        }
    }
    ...
    class d extends AnimatorListenerAdapter {
        ...
        final /* synthetic */ ActionMenuView f10690b;
        ...
        public void onAnimationEnd(Animator animator) {
            if (!this.f10689a) {
                BottomAppBar.this.p0(this.f10690b, this.f10691c, this.f10692d);
            }
        }
    }
    ...
    public void p0(ActionMenuView actionMenuView, int i, boolean z) {
        ...
        for (int i3 = 0; i3 < getChildCount(); i3++) {
            ...
            if ((childAt.getLayoutParams() instanceof Toolbar.e) && (((Toolbar.e) childAt.getLayoutParams()).f699a & 8388615) == 8388611) {
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        this.W = savedState.f10684d;
        this.b0 = savedState.f10685e;
    }

    /* access modifiers changed from: protected */
    public Parcelable onSaveInstanceState() {
        SavedState savedState = new SavedState(super.onSaveInstanceState());
        savedState.f10684d = this.W;
        savedState.f10685e = this.b0;
        return savedState;
    }
    ...
    public static class Behavior extends HideBottomViewOnScrollBehavior<BottomAppBar> {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final Rect f10683d = new Rect();

        public Behavior() {
        }

        private boolean L(FloatingActionButton floatingActionButton, BottomAppBar bottomAppBar) {
            ((CoordinatorLayout.f) floatingActionButton.getLayoutParams()).f1246d = 17;
        ...
        public boolean l(CoordinatorLayout coordinatorLayout, BottomAppBar bottomAppBar, int i) {
            ...
            if (M != null) {
                L(M, bottomAppBar);
                M.i(this.f10683d);
                bottomAppBar.setFabDiameter(this.f10683d.height());
            }
            if (!bottomAppBar.i0()) {
                bottomAppBar.o0();
            }
        ...
        public void F(BottomAppBar bottomAppBar) {
            ...
            if (M != null) {
                M.h(this.f10683d);
                M.clearAnimation();
                M.animate().translationY(((float) (-M.getPaddingBottom())) + ((float) (M.getMeasuredHeight() - this.f10683d.height()))).setInterpolator(b.c.a.d.l.a.f2267c).setDuration(175);
            }
        }
        ...
        public void G(BottomAppBar bottomAppBar) {
            ...
            if (M != null) {
                M.clearAnimation();
                M.animate().translationY(bottomAppBar.getFabTranslationY()).setInterpolator(b.c.a.d.l.a.f2268d).setDuration(225);
            }
        }
