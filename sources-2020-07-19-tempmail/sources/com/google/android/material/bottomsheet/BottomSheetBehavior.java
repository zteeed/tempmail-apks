...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.c<V> {
    ...
    private class c implements Runnable {
        ...
        public void run() {
            ...
            if (cVar == null || !cVar.n(true)) {
                BottomSheetBehavior.this.P(this.f10734c);
            } else {
                t.V(this.f10733b, this);
            }
        }
    }
    ...
    private void F() {
        if (this.f10725a) {
            this.i = Math.max(this.q - this.f10730f, this.g);
        } else {
            this.i = this.q - this.f10730f;
        }
    }
    ...
    private float J() {
        ...
        velocityTracker.computeCurrentVelocity(1000, this.f10726b);
                    ...
                    if (childAt != this.r.get()) {
                        if (!z2) {
                            ...
                            if (map != null && map.containsKey(childAt)) {
                                t.i0(childAt, this.y.get(childAt).intValue());
                            }
                        } else {
    ...
    public void L(boolean z2) {
        if (this.f10725a != z2) {
            ...
            P((!this.f10725a || this.l != 6) ? this.l : 3);
        }
    }
    ...
    public final void N(int r4) {
        /*
            ...
            boolean r4 = r3.f10728d
            if (r4 != 0) goto L_0x0015
            r3.f10728d = r0
            goto L_0x0024
        L_0x000c:
            boolean r2 = r3.f10728d
    ...
    public boolean Q(View view, float f2) {
        ...
        if (view.getTop() >= this.i && Math.abs((((float) view.getTop()) + (f2 * 0.1f)) - ((float) this.i)) / ((float) this.f10727c) > 0.5f) {
            return true;
        }
        return false;
    }
    ...
    public boolean l(CoordinatorLayout coordinatorLayout, V v2, int i2) {
        if (t.q(coordinatorLayout) && !t.q(v2)) {
        ...
        if (this.f10728d) {
            if (this.f10729e == 0) {
                this.f10729e = coordinatorLayout.getResources().getDimensionPixelSize(d.design_bottom_sheet_peek_height_min);
            }
            this.f10730f = Math.max(this.f10729e, this.q - ((coordinatorLayout.getWidth() * 9) / 16));
        } else {
            this.f10730f = this.f10727c;
        }
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        this.f10726b = (float) ViewConfiguration.get(context).getScaledMaximumFlingVelocity();
    }
}
