...
public class AppBarLayout extends LinearLayout {
    ...
    public static class ScrollingViewBehavior extends b {
        ...
        private void Q(View view, View view2) {
            ...
            if (f2 instanceof BaseBehavior) {
                t.O(view, (((view2.getBottom() - view.getTop()) + ((BaseBehavior) f2).k) + L()) - H(view2));
            }
        }
    ...
    public final int getMinimumHeightForVisibleOverlappingContent() {
        ...
        if (u == 0) {
            int childCount = getChildCount();
            u = childCount >= 1 ? t.u(getChildAt(childCount - 1)) : 0;
            if (u == 0) {
                return getHeight() / 3;
            }
        }
    ...
    protected static class BaseBehavior<T extends AppBarLayout> extends a<T> {
        ...
        class a implements ValueAnimator.AnimatorUpdateListener {
            ...
            final /* synthetic */ CoordinatorLayout f10633a;

            /* renamed from: b  reason: collision with root package name */
            final /* synthetic */ AppBarLayout f10634b;

            a(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout) {
                this.f10633a = coordinatorLayout;
                this.f10634b = appBarLayout;
            }

            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                BaseBehavior.this.O(this.f10633a, this.f10634b, ((Integer) valueAnimator.getAnimatedValue()).intValue());
            }
        }
        ...
        private void S(CoordinatorLayout coordinatorLayout, T t, int i, int i2) {
            ...
            if (valueAnimator2 == null) {
                ...
                valueAnimator3.setInterpolator(b.c.a.d.l.a.f2269e);
        ...
        public void w(CoordinatorLayout coordinatorLayout, T t, Parcelable parcelable) {
            if (parcelable instanceof SavedState) {
                ...
                this.n = savedState.f10630d;
                this.p = savedState.f10631e;
                this.o = savedState.f10632f;
                return;
            }
        ...
        public Parcelable x(CoordinatorLayout coordinatorLayout, T t) {
            ...
            while (i < childCount) {
                ...
                if (childAt.getTop() + D > 0 || bottom < 0) {
                    ...
                    savedState.f10630d = i;
                    if (bottom == t.u(childAt) + t.getTopInset()) {
                        z = true;
                    }
                    savedState.f10632f = z;
                    savedState.f10631e = ((float) bottom) / ((float) childAt.getHeight());
                    return savedState;
                }
            }
            return x;
        ...
        protected static class SavedState extends AbsSavedState {
            ...
            public SavedState(Parcel parcel, ClassLoader classLoader) {
                ...
                this.f10631e = parcel.readFloat();
                this.f10632f = parcel.readByte() != 0;
            }

            public void writeToParcel(Parcel parcel, int i) {
                super.writeToParcel(parcel, i);
                parcel.writeInt(this.f10630d);
                parcel.writeFloat(this.f10631e);
                parcel.writeByte(this.f10632f ? (byte) 1 : 0);
            }
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        ...
        t.b0(this, h2.getDrawable(k.AppBarLayout_android_background));
    ...
    public static class c extends LinearLayout.LayoutParams {
        ...
        /* renamed from: b  reason: collision with root package name */
        Interpolator f10638b;

        public c(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, k.AppBarLayout_Layout);
            this.f10637a = obtainStyledAttributes.getInt(k.AppBarLayout_Layout_layout_scrollFlags, 0);
            if (obtainStyledAttributes.hasValue(k.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.f10638b = AnimationUtils.loadInterpolator(context, obtainStyledAttributes.getResourceId(k.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
            obtainStyledAttributes.recycle();
        }
