...
public class FlowLayout extends ViewGroup {
    ...
    private void c(Context context, AttributeSet attributeSet) {
        ...
        this.f10817b = obtainStyledAttributes.getDimensionPixelSize(k.FlowLayout_lineSpacing, 0);
        this.f10818c = obtainStyledAttributes.getDimensionPixelSize(k.FlowLayout_itemSpacing, 0);
        ...
        if (getChildCount() != 0) {
            ...
            for (int i10 = 0; i10 < getChildCount(); i10++) {
                ...
                if (childAt.getVisibility() != 8) {
                    ...
                    if (!this.f10819d && measuredWidth > i7) {
                        i9 = this.f10817b + paddingTop;
                        i8 = paddingRight;
                    }
                    int i11 = i8 + i5;
                    ...
                    i8 += i5 + i6 + childAt.getMeasuredWidth() + this.f10818c;
    ...
    public void onMeasure(int i, int i2) {
        ...
        for (int i9 = 0; i9 < getChildCount(); i9++) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                paddingLeft = i5 + i4 + i3 + childAt.getMeasuredWidth() + this.f10818c;
                paddingTop = measuredHeight;
            }
        }
