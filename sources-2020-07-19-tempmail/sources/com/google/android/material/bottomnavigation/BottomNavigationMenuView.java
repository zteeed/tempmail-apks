...
public class BottomNavigationMenuView extends ViewGroup implements p {
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (!g(this.k, size2) || !this.j) {
            int min = Math.min(size / (size2 == 0 ? 1 : size2), this.f10710e);
            ...
            int i6 = this.f10711f;
            if (childAt.getVisibility() != 8) {
                childAt.measure(View.MeasureSpec.makeMeasureSpec(this.f10710e, Integer.MIN_VALUE), makeMeasureSpec);
                i6 = Math.max(i6, childAt.getMeasuredWidth());
            }
            int i7 = size2 - (childAt.getVisibility() != 8 ? 1 : 0);
            int min2 = Math.min(size - (this.f10709d * i7), Math.min(i6, this.f10710e));
            int i8 = size - min2;
            int min3 = Math.min(i8 / (i7 == 0 ? 1 : i7), this.f10708c);
            int i9 = i8 - (i7 * min3);
            int i10 = 0;
    ...
    public BottomNavigationMenuView(Context context, AttributeSet attributeSet) {
        ...
        this.f10708c = resources.getDimensionPixelSize(d.design_bottom_navigation_item_max_width);
        this.f10709d = resources.getDimensionPixelSize(d.design_bottom_navigation_item_min_width);
        this.f10710e = resources.getDimensionPixelSize(d.design_bottom_navigation_active_item_max_width);
        this.f10711f = resources.getDimensionPixelSize(d.design_bottom_navigation_active_item_min_width);
        ...
        bVar.x0(0);
        this.f10707b.v0(115);
        this.f10707b.i0(new a.k.a.a.b());
        this.f10707b.q0(new com.google.android.material.internal.j());
        this.h = new a();
        this.w = new int[5];
    }
}
