...
public class Chip extends AppCompatCheckBox implements a.b {
    ...
    private RippleDrawable f10749e;
    ...
    class b extends ViewOutlineProvider {
        ...
        public void getOutline(View view, Outline outline) {
            if (Chip.this.f10748d != null) {
                Chip.this.f10748d.getOutline(outline);
            } else {
    ...
    private class c extends a.j.a.a {
        ...
        public void K(d dVar) {
            dVar.X(Chip.this.f10748d != null && Chip.this.f10748d.c0());
    ...
    private float h(a aVar) {
        ...
        return t.t(this) == 0 ? chipStartPadding : -chipStartPadding;
    }
    ...
    private boolean k(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 10) {
            try {
                Field declaredField = cls.getDeclaredField(m.f12494f);
    ...
    private void q() {
        a aVar;
        if (!TextUtils.isEmpty(getText()) && (aVar = this.f10748d) != null) {
            float E = aVar.E() + this.f10748d.z() + this.f10748d.Y() + this.f10748d.X();
            if ((this.f10748d.e0() && this.f10748d.A() != null) || (this.f10748d.w() != null && this.f10748d.d0() && isChecked())) {
                E += this.f10748d.S() + this.f10748d.R() + this.f10748d.B();
            }
            if (this.f10748d.g0() && this.f10748d.H() != null) {
                E += this.f10748d.L() + this.f10748d.J() + this.f10748d.K();
            }
            if (((float) t.w(this)) != E) {
                t.m0(this, t.x(this), getPaddingTop(), (int) E, getPaddingBottom());
            }
        }
    }
    ...
    private void r(b.c.a.d.q.b bVar) {
        ...
        paint.drawableState = this.f10748d.getState();
    ...
    public void drawableStateChanged() {
        ...
        a aVar = this.f10748d;
        if ((aVar == null || !aVar.f0()) ? false : this.f10748d.Y0(i())) {
            invalidate();
        }
    }
    ...
    public boolean o() {
        boolean z;
        playSoundEffect(0);
        View.OnClickListener onClickListener = this.f10750f;
    ...
    public void onDraw(Canvas canvas) {
        a aVar;
        if (TextUtils.isEmpty(getText()) || (aVar = this.f10748d) == null || aVar.z1()) {
            super.onDraw(canvas);
            return;
        }
        int save = canvas.save();
        canvas.translate(h(this.f10748d), 0.0f);
        super.onDraw(canvas);
    ...
    public void setBackground(Drawable drawable) {
        if (drawable == this.f10748d || drawable == this.f10749e) {
    ...
    public void setChipDrawable(a aVar) {
        a aVar2 = this.f10748d;
        if (aVar2 != aVar) {
            p(aVar2);
            this.f10748d = aVar;
            g(aVar);
            if (b.c.a.d.r.a.f2300a) {
                this.f10749e = new RippleDrawable(b.c.a.d.r.a.a(this.f10748d.T()), this.f10748d, (Drawable) null);
                this.f10748d.y1(false);
                t.b0(this, this.f10749e);
                return;
            }
            this.f10748d.y1(true);
            t.b0(this, this.f10748d);
        }
    }
