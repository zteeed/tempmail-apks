...
public class a extends Drawable implements androidx.core.graphics.drawable.b, Drawable.Callback {
    ...
    private ColorStateList f10758b;
    ...
    private ColorStateList f10761e;
    private float e0;
    ...
    private final f.a k = new C0094a();
    private boolean l;
    private Drawable m;
    ...
    private static boolean j0(b.c.a.d.q.b r0) {
        /*
            ...
            android.content.res.ColorStateList r0 = r0.f2291b
            if (r0 == 0) goto L_0x000e
    ...
    private boolean m0(int[] r6, int[] r7) {
        /*
            ...
            android.content.res.ColorStateList r1 = r5.f10758b
            r2 = 0
        ...
        L_0x0011:
            ...
            r0 = 1
        L_0x0019:
            android.content.res.ColorStateList r1 = r5.f10761e
        ...
        L_0x0043:
            ...
            android.content.res.ColorStateList r1 = r1.f2291b
            if (r1 == 0) goto L_0x0052
            int r3 = r5.R
            int r1 = r1.getColorForState(r6, r3)
            goto L_0x0053
    ...
    public void L0(ColorStateList colorStateList) {
        if (this.f10761e != colorStateList) {
            this.f10761e = colorStateList;
            onStateChange(getState());
        }
    }
    ...
    public void getOutline(Outline outline) {
        Rect bounds = getBounds();
        if (!bounds.isEmpty()) {
            outline.setRoundRect(bounds, this.f10760d);
        } else {
            outline.setRoundRect(0, 0, getIntrinsicWidth(), getIntrinsicHeight(), this.f10760d);
        }
    ...
    public boolean isStateful() {
        return h0(this.f10758b) || h0(this.f10761e) || (this.a0 && h0(this.b0)) || j0(this.j) || m() || i0(this.m) || i0(this.w) || h0(this.X);
    }
    ...
    public void t0(ColorStateList colorStateList) {
        if (this.f10758b != colorStateList) {
