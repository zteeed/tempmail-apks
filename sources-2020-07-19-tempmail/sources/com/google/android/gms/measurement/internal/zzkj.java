...
public class zzkj implements r4 {
    ...
    private zzfs f10503a;

    /* renamed from: b  reason: collision with root package name */
    private zzfb f10504b;
    ...
    class a implements e {
        ...
        public final boolean b(long j, zzcb.zzc zzc) {
            ...
            if (this.f10511c.size() > 0 && c(this.f10511c.get(0)) != c(zzc)) {
                return false;
            }
            long i = this.f10512d + ((long) zzc.i());
            if (i >= ((long) Math.max(0, zzaq.i.a(null).intValue()))) {
                return false;
            }
            this.f10512d = i;
            this.f10511c.add(zzc);
            this.f10510b.add(Long.valueOf(j));
            if (this.f10511c.size() >= Math.max(1, zzaq.j.a(null).intValue())) {
                return false;
            }
            return true;
        }
    ...
    private final boolean E(java.lang.String r44, long r45) {
        ...
        L_0x023c:
            ...
            r5.close()     // Catch:{ all -> 0x0f39 }
        L_0x0252:
            java.util.List<com.google.android.gms.internal.measurement.zzcb$zzc> r5 = r4.f10511c     // Catch:{ all -> 0x0f39 }
        ...
        L_0x0262:
            ...
            com.google.android.gms.internal.measurement.zzcb$zzg r5 = r4.f10509a     // Catch:{ all -> 0x0f39 }
            ...
            com.google.android.gms.internal.measurement.zzcb$zzg r7 = r4.f10509a     // Catch:{ all -> 0x0f39 }
            ...
            r15 = 0
        L_0x028a:
            java.util.List<com.google.android.gms.internal.measurement.zzcb$zzc> r9 = r4.f10511c     // Catch:{ all -> 0x0f39 }
            ...
            com.google.android.gms.internal.measurement.zzcb$zzg r15 = r4.f10509a     // Catch:{ all -> 0x0f39 }
            ...
            com.google.android.gms.internal.measurement.zzcb$zzg r12 = r4.f10509a     // Catch:{ all -> 0x0f39 }
            ...
            com.google.android.gms.internal.measurement.zzcb$zzg r3 = r4.f10509a     // Catch:{ all -> 0x0f39 }
        ...
        L_0x0313:
            ...
            com.google.android.gms.internal.measurement.zzcb$zzg r2 = r4.f10509a     // Catch:{ all -> 0x0f39 }
        ...
        L_0x0496:
            ...
            long r7 = r2.f10365e     // Catch:{ all -> 0x0f39 }
            com.google.android.gms.measurement.internal.zzfy r2 = r1.i     // Catch:{ all -> 0x0f39 }
            com.google.android.gms.measurement.internal.zzy r2 = r2.x()     // Catch:{ all -> 0x0f39 }
            com.google.android.gms.internal.measurement.zzcb$zzg r10 = r4.f10509a     // Catch:{ all -> 0x0f39 }
        ...
        L_0x04d0:
            ...
            r40 = 0
            com.google.android.gms.measurement.internal.zzac r2 = r32.C(r33, r35, r36, r37, r38, r39, r40)     // Catch:{ all -> 0x0f39 }
            long r2 = r2.f10363c     // Catch:{ all -> 0x0f39 }
        ...
        L_0x0aef:
            ...
            com.google.android.gms.internal.measurement.zzcb$zzg r11 = r4.f10509a     // Catch:{ all -> 0x0d74 }
        ...
        L_0x0b7d:
            ...
            com.google.android.gms.internal.measurement.zzcb$zzg r11 = r4.f10509a     // Catch:{ all -> 0x0f39 }
        ...
        L_0x0bbc:
            ...
            com.google.android.gms.internal.measurement.zzcb$zzg r12 = r4.f10509a     // Catch:{ all -> 0x0d74 }
            ...
            com.google.android.gms.internal.measurement.zzcb$zzg r15 = r4.f10509a     // Catch:{ all -> 0x0d74 }
            ...
            com.google.android.gms.internal.measurement.zzcb$zzg r1 = r4.f10509a     // Catch:{ all -> 0x0d74 }
        ...
        L_0x0d93:
            r2 = r44
            com.google.android.gms.internal.measurement.zzcb$zzg r3 = r2.f10509a     // Catch:{ all -> 0x0f39 }
            java.lang.String r3 = r3.I2()     // Catch:{ all -> 0x0f39 }
            ...
            com.google.android.gms.internal.measurement.zzcb$zzg r7 = r2.f10509a     // Catch:{ all -> 0x0f39 }
            java.lang.String r7 = r7.I2()     // Catch:{ all -> 0x0f39 }
        ...
        L_0x0e1a:
            ...
            com.google.android.gms.internal.measurement.zzcb$zzg r6 = r2.f10509a     // Catch:{ all -> 0x0f39 }
        ...
        L_0x0e3c:
            ...
            goto L_0x0e6f
        L_0x0e44:
            com.google.android.gms.internal.measurement.zzcb$zzg r4 = r2.f10509a     // Catch:{ all -> 0x0f39 }
        ...
        L_0x0e80:
            com.google.android.gms.measurement.internal.c r4 = r43.V()     // Catch:{ all -> 0x0f39 }
            java.util.List<java.lang.Long> r2 = r2.f10510b     // Catch:{ all -> 0x0f39 }
    ...
    private final void K(zzao zzao, zzn zzn) {
        if (zzlr.b() && this.i.x().t(zzaq.O0)) {
            zzey b2 = zzey.b(zzao);
            this.i.G().M(b2.f10413d, V().B0(zzn.f10523b));
            this.i.G().V(b2, this.i.x().o(zzn.f10523b));
            zzao = b2.a();
        }
        p(zzao, zzn);
    }
    ...
    private final void S(com.google.android.gms.measurement.internal.zzao r27, com.google.android.gms.measurement.internal.zzn r28) {
        ...
        L_0x002e:
            ...
            java.lang.String r8 = r2.f10377b
            ...
            java.lang.String r6 = r2.f10377b
        ...
        L_0x0173:
            ...
            java.lang.String r11 = r2.f10377b     // Catch:{ all -> 0x093d }
        ...
        L_0x0183:
            ...
            com.google.android.gms.measurement.internal.zzan r9 = r2.f10378c     // Catch:{ all -> 0x093d }
            java.lang.String r11 = "currency"
            java.lang.String r9 = r9.K(r11)     // Catch:{ all -> 0x093d }
            java.lang.String r11 = "value"
            if (r7 == 0) goto L_0x0200
            com.google.android.gms.measurement.internal.zzan r7 = r2.f10378c     // Catch:{ all -> 0x093d }
        ...
        L_0x0234:
            ...
            java.lang.Object r9 = r7.f10242e     // Catch:{ all -> 0x093d }
            boolean r9 = r9 instanceof java.lang.Long     // Catch:{ all -> 0x093d }
            if (r9 != 0) goto L_0x0246
            goto L_0x0270
        L_0x0246:
            java.lang.Object r7 = r7.f10242e     // Catch:{ all -> 0x093d }
            ...
            java.lang.String r9 = r2.f10379d     // Catch:{ all -> 0x093d }
        ...
        L_0x02d7:
            ...
            java.lang.String r11 = r6.f10240c     // Catch:{ all -> 0x093d }
            java.lang.String r10 = r10.A(r11)     // Catch:{ all -> 0x093d }
            java.lang.Object r6 = r6.f10242e     // Catch:{ all -> 0x093d }
        ...
        L_0x0327:
            ...
            r5 = 0
        L_0x032a:
            java.lang.String r6 = r2.f10377b     // Catch:{ all -> 0x093d }
            ...
            com.google.android.gms.measurement.internal.zzfy r7 = r1.i     // Catch:{ all -> 0x093d }
            com.google.android.gms.measurement.internal.zzy r7 = r7.x()     // Catch:{ all -> 0x093d }
            java.lang.String r8 = r3.f10523b     // Catch:{ all -> 0x093d }
        ...
        L_0x035f:
            ...
            long r8 = r7.f10362b     // Catch:{ all -> 0x093d }
            ...
            long r5 = r7.f10362b     // Catch:{ all -> 0x093d }
        ...
        L_0x03be:
            ...
            long r8 = r7.f10361a     // Catch:{ all -> 0x093d }
            ...
            long r6 = r7.f10361a     // Catch:{ all -> 0x093d }
        ...
        L_0x0413:
            ...
            long r8 = r7.f10364d     // Catch:{ all -> 0x093d }
            com.google.android.gms.measurement.internal.zzfy r10 = r1.i     // Catch:{ all -> 0x093d }
            com.google.android.gms.measurement.internal.zzy r10 = r10.x()     // Catch:{ all -> 0x093d }
            java.lang.String r11 = r3.f10523b     // Catch:{ all -> 0x093d }
            ...
            java.lang.Object r4 = com.google.android.gms.measurement.internal.zzeu.x(r27)     // Catch:{ all -> 0x093d }
            long r5 = r7.f10364d     // Catch:{ all -> 0x093d }
            java.lang.Long r5 = java.lang.Long.valueOf(r5)     // Catch:{ all -> 0x093d }
            r2.c(r3, r4, r5)     // Catch:{ all -> 0x093d }
        L_0x0453:
            com.google.android.gms.measurement.internal.c r2 = r26.V()     // Catch:{ all -> 0x093d }
        ...
        L_0x04a1:
            ...
            java.lang.String r8 = r2.f10377b     // Catch:{ all -> 0x093d }
            ...
            if (r7 == 0) goto L_0x04c8
            java.lang.Object r8 = r7.f10242e     // Catch:{ all -> 0x093d }
        ...
        L_0x04eb:
            ...
            java.lang.String r9 = r2.f10379d     // Catch:{ all -> 0x093d }
            java.lang.String r10 = r2.f10377b     // Catch:{ all -> 0x093d }
            long r12 = r2.f10380e     // Catch:{ all -> 0x093d }
            r18 = 0
            r7 = r4
            r2 = r10
            r10 = r15
            ...
            com.google.android.gms.measurement.internal.c r7 = r26.V()     // Catch:{ all -> 0x093d }
            java.lang.String r8 = r4.f10371b     // Catch:{ all -> 0x093d }
            ...
            java.lang.String r4 = r4.f10371b     // Catch:{ all -> 0x093d }
        ...
        L_0x056f:
            ...
            java.lang.String r9 = r4.f10371b     // Catch:{ all -> 0x093d }
            r10 = 0
            r12 = 0
            long r14 = r4.f10373d     // Catch:{ all -> 0x093d }
            r16 = 0
            r18 = 0
            r19 = 0
            r20 = 0
        ...
        L_0x0597:
            ...
            java.lang.String r2 = r4.f10370a     // Catch:{ all -> 0x093d }
            com.google.android.gms.common.internal.Preconditions.g(r2)     // Catch:{ all -> 0x093d }
            java.lang.String r2 = r4.f10370a     // Catch:{ all -> 0x093d }
            java.lang.String r6 = r3.f10523b     // Catch:{ all -> 0x093d }
        ...
        L_0x05fd:
            long r7 = r3.f10527f     // Catch:{ all -> 0x093d }
            r2.n0(r7)     // Catch:{ all -> 0x093d }
            java.lang.String r7 = r3.f10524c     // Catch:{ all -> 0x093d }
            boolean r7 = android.text.TextUtils.isEmpty(r7)     // Catch:{ all -> 0x093d }
        ...
        L_0x0799:
            ...
            java.lang.String r8 = r3.f10524c     // Catch:{ all -> 0x093d }
            ...
            java.lang.String r8 = r3.f10525d     // Catch:{ all -> 0x093d }
            r7.I(r8)     // Catch:{ all -> 0x093d }
            long r11 = r3.k     // Catch:{ all -> 0x093d }
            r7.u(r11)     // Catch:{ all -> 0x093d }
            java.lang.String r8 = r3.f10526e     // Catch:{ all -> 0x093d }
            r7.L(r8)     // Catch:{ all -> 0x093d }
            long r11 = r3.f10527f     // Catch:{ all -> 0x093d }
        ...
        L_0x083c:
            com.google.android.gms.measurement.internal.c r7 = r26.V()     // Catch:{ all -> 0x093d }
            java.lang.String r3 = r3.f10523b     // Catch:{ all -> 0x093d }
        ...
        L_0x0847:
            ...
            java.lang.String r8 = r8.f10240c     // Catch:{ all -> 0x093d }
            r7.F(r8)     // Catch:{ all -> 0x093d }
            java.lang.Object r8 = r3.get(r11)     // Catch:{ all -> 0x093d }
            com.google.android.gms.measurement.internal.s7 r8 = (com.google.android.gms.measurement.internal.s7) r8     // Catch:{ all -> 0x093d }
            long r12 = r8.f10241d     // Catch:{ all -> 0x093d }
            ...
            java.lang.Object r12 = r12.f10242e     // Catch:{ all -> 0x093d }
        ...
        L_0x087c:
            ...
            com.google.android.gms.measurement.internal.c r7 = r26.V()     // Catch:{ all -> 0x093d }
            com.google.android.gms.measurement.internal.zzan r8 = r4.f10375f     // Catch:{ all -> 0x093d }
        ...
        L_0x08ae:
            ...
            java.lang.String r8 = r4.f10370a     // Catch:{ all -> 0x093d }
            java.lang.String r11 = r4.f10371b     // Catch:{ all -> 0x093d }
            ...
            java.lang.String r14 = r4.f10370a     // Catch:{ all -> 0x093d }
            r15 = 0
            r16 = 0
            r17 = 0
            r18 = 0
            ...
            long r11 = r8.f10365e     // Catch:{ all -> 0x093d }
    ...
    private final boolean W(zzn zzn) {
        return (!zzlm.b() || !this.i.x().C(zzn.f10523b, zzaq.o0)) ? !TextUtils.isEmpty(zzn.f10524c) || !TextUtils.isEmpty(zzn.s) : !TextUtils.isEmpty(zzn.f10524c) || !TextUtils.isEmpty(zzn.w) || !TextUtils.isEmpty(zzn.s);
    }
    ...
    private final com.google.android.gms.measurement.internal.k3 b(com.google.android.gms.measurement.internal.zzn r9, com.google.android.gms.measurement.internal.k3 r10, java.lang.String r11) {
        /*
            ...
            java.lang.String r2 = r9.f10523b
            r10.<init>(r1, r2)
            com.google.android.gms.measurement.internal.zzfy r1 = r8.i
        ...
        L_0x0039:
            r11 = 0
        L_0x003a:
            java.lang.String r1 = r9.f10524c
            java.lang.String r2 = r10.A()
            boolean r1 = android.text.TextUtils.equals(r1, r2)
            if (r1 != 0) goto L_0x004c
            java.lang.String r11 = r9.f10524c
            r10.r(r11)
            r11 = 1
        L_0x004c:
        ...
        L_0x00a2:
            ...
            r11 = 1
        L_0x00b8:
            java.lang.String r1 = r9.f10525d
            boolean r1 = android.text.TextUtils.isEmpty(r1)
            ...
            boolean r1 = r1.equals(r2)
            if (r1 != 0) goto L_0x00d2
            java.lang.String r11 = r9.f10525d
            r10.I(r11)
            r11 = 1
        L_0x00d2:
            long r1 = r9.k
            ...
            r11 = 1
        L_0x00e2:
            java.lang.String r1 = r9.f10526e
            if (r1 == 0) goto L_0x00f6
            java.lang.String r2 = r10.X()
            boolean r1 = r1.equals(r2)
            if (r1 != 0) goto L_0x00f6
            java.lang.String r11 = r9.f10526e
            r10.L(r11)
            r11 = 1
        L_0x00f6:
            long r1 = r9.g
    ...
    private final void m0() {
        ...
        L_0x00dc:
            ...
            com.google.android.gms.measurement.internal.zzfk r12 = r12.f10189e
            long r12 = r12.a()
            com.google.android.gms.measurement.internal.zzfy r14 = r0.i
            com.google.android.gms.measurement.internal.q3 r14 = r14.A()
            com.google.android.gms.measurement.internal.zzfk r14 = r14.f10190f
            long r14 = r14.a()
        ...
        L_0x01fe:
            ...
            com.google.android.gms.measurement.internal.zzfy r1 = r0.i
            com.google.android.gms.measurement.internal.q3 r1 = r1.A()
            com.google.android.gms.measurement.internal.zzfk r1 = r1.f10189e
    ...
    private final void o(zzcb.zzg.zza zza, long j2, boolean z) {
        ...
        if (o0 == null || o0.f10242e == null) {
            s7Var = new s7(zza.D0(), "auto", str, this.i.n().a(), Long.valueOf(j2));
        } else {
            s7Var = new s7(zza.D0(), "auto", str, this.i.n().a(), Long.valueOf(((Long) o0.f10242e).longValue() + j2));
        }
        zzcb.zzk.zza a0 = zzcb.zzk.a0();
        a0.F(str);
        a0.E(this.i.n().a());
        a0.I(((Long) s7Var.f10242e).longValue());
        ...
        if (j2 > 0) {
            V().S(s7Var);
            this.i.h().O().c("Updated engagement user property. scope, value", z ? "session-scoped" : "lifetime", s7Var.f10242e);
        }
    }
    ...
    public final void A(java.lang.String r7, int r8, java.lang.Throwable r9, byte[] r10, java.util.Map<java.lang.String, java.util.List<java.lang.String>> r11) {
        ...
        L_0x0061:
            ...
            com.google.android.gms.measurement.internal.zzfk r7 = r7.f10190f     // Catch:{ all -> 0x018d }
    ...
    public final void M(zzkq zzkq, zzn zzn) {
        ...
        if (W(zzn)) {
            if (!zzn.i) {
                Q(zzn);
            } else if (!"_npa".equals(zzkq.f10515c) || zzn.t == null) {
                this.i.h().N().b("Removing user property", this.i.H().A(zzkq.f10515c));
                V().v0();
                try {
                    Q(zzn);
                    V().l0(zzn.f10523b, zzkq.f10515c);
                    V().v();
                    this.i.h().N().b("User property removed", this.i.H().A(zzkq.f10515c));
                } finally {
                    V().A0();
                }
            } else {
    ...
    public final void N(com.google.android.gms.measurement.internal.zzn r22) {
        /*
            ...
            java.lang.String r7 = r2.f10523b
            com.google.android.gms.common.internal.Preconditions.g(r7)
        ...
        L_0x0023:
            ...
            java.lang.String r8 = r2.f10523b
            ...
            java.lang.String r10 = r2.f10524c
            boolean r10 = android.text.TextUtils.isEmpty(r10)
            if (r10 != 0) goto L_0x0056
            r7.K(r8)
            ...
            java.lang.String r10 = r2.f10523b
            r7.F(r10)
        L_0x0056:
            boolean r7 = r2.i
        ...
        L_0x006e:
            ...
            java.lang.String r13 = r2.f10523b
        ...
        L_0x0098:
            ...
            java.lang.String r13 = r2.f10523b     // Catch:{ all -> 0x04b8 }
            java.lang.String r14 = "_npa"
            com.google.android.gms.measurement.internal.s7 r14 = r12.o0(r13, r14)     // Catch:{ all -> 0x04b8 }
            if (r14 == 0) goto L_0x00bc
            java.lang.String r12 = "auto"
            java.lang.String r13 = r14.f10239b     // Catch:{ all -> 0x04b8 }
        ...
        L_0x00d1:
            ...
            java.lang.Object r9 = r9.f10242e     // Catch:{ all -> 0x04b8 }
            java.lang.Long r12 = r8.f10517e     // Catch:{ all -> 0x04b8 }
        ...
        L_0x010f:
            ...
            java.lang.String r9 = r2.f10523b     // Catch:{ all -> 0x04b8 }
            ...
            java.lang.String r12 = r2.f10524c     // Catch:{ all -> 0x04b8 }
        ...
        L_0x01e5:
            ...
            java.lang.String r3 = r8.T()     // Catch:{ all -> 0x04b8 }
            java.lang.String r4 = r2.f10525d     // Catch:{ all -> 0x04b8 }
        ...
        L_0x0229:
            ...
            java.lang.String r3 = r2.f10523b     // Catch:{ all -> 0x04b8 }
        ...
        L_0x024c:
            ...
            java.lang.String r12 = r2.f10523b     // Catch:{ all -> 0x04b8 }
        ...
        L_0x0293:
            ...
            java.lang.String r4 = r2.f10523b     // Catch:{ all -> 0x04b8 }
        ...
        L_0x030f:
            ...
            java.lang.String r12 = r2.f10523b     // Catch:{ NameNotFoundException -> 0x0321 }
            r13 = 0
        ...
        L_0x0321:
            ...
            java.lang.String r15 = r2.f10523b     // Catch:{ all -> 0x04b8 }
        ...
        L_0x038b:
            ...
            java.lang.String r12 = r2.f10523b     // Catch:{ NameNotFoundException -> 0x039d }
            r13 = 0
        ...
        L_0x039d:
            ...
            java.lang.String r14 = r2.f10523b     // Catch:{ all -> 0x04b8 }
            java.lang.Object r14 = com.google.android.gms.measurement.internal.zzeu.x(r14)     // Catch:{ all -> 0x04b8 }
    ...
    public final void P(zzw zzw, zzn zzn) {
        Preconditions.k(zzw);
        Preconditions.g(zzw.f10529b);
        Preconditions.k(zzw.f10531d);
        Preconditions.g(zzw.f10531d.f10515c);
        j0();
        c0();
        if (W(zzn)) {
            if (!zzn.i) {
            ...
            try {
                Q(zzn);
                zzw p0 = V().p0(zzw.f10529b, zzw.f10531d.f10515c);
                if (p0 != null) {
                    this.i.h().N().c("Removing conditional user property", zzw.f10529b, this.i.H().A(zzw.f10531d.f10515c));
                    V().r0(zzw.f10529b, zzw.f10531d.f10515c);
                    if (p0.f10533f) {
                        V().l0(zzw.f10529b, zzw.f10531d.f10515c);
                    }
                    if (zzw.l != null) {
                        Bundle bundle = null;
                        if (zzw.l.f10378c != null) {
                            bundle = zzw.l.f10378c.B();
                        }
                        Bundle bundle2 = bundle;
                        S(this.i.G().E(zzw.f10529b, zzw.l.f10377b, bundle2, p0.f10530c, zzw.l.f10380e, true, false), zzn);
                    }
                } else {
                    this.i.h().J().c("Conditional user property doesn't exist", zzeu.x(zzw.f10529b), this.i.H().A(zzw.f10531d.f10515c));
                }
                V().v();
            } finally {
                V().A0();
    ...
    public final k3 Q(zzn zzn) {
        ...
        k3 j0 = V().j0(zzn.f10523b);
        String x2 = this.i.A().x(zzn.f10523b);
        if (!zzkz.b() || !this.i.x().t(zzaq.u0)) {
            return b(zzn, j0, x2);
        }
        if (j0 == null) {
            j0 = new k3(this.i, zzn.f10523b);
            j0.c(this.i.G().N0());
            j0.C(x2);
        ...
        if (!TextUtils.isEmpty(zzn.f10525d)) {
            j0.I(zzn.f10525d);
        }
        j0.u(zzn.k);
        String str = zzn.f10526e;
        if (str != null) {
            j0.L(str);
        }
        j0.B(zzn.g);
    ...
    public final String U(zzn zzn) {
        try {
            ...
            this.i.h().G().c("Failed to get app instance id. appId", zzeu.x(zzn.f10523b), e2);
            return null;
        }
    }
    ...
    public final void d0() {
        ...
        L_0x00ca:
            ...
            com.google.android.gms.measurement.internal.zzfk r7 = r7.f10189e     // Catch:{ all -> 0x0308 }
        ...
        L_0x0275:
            ...
            com.google.android.gms.measurement.internal.zzfk r10 = r10.f10190f     // Catch:{ MalformedURLException -> 0x02cc }
    ...
    public final void e() {
        this.i.g().c();
        V().D0();
        if (this.i.A().f10189e.a() == 0) {
            this.i.A().f10189e.b(this.i.n().a());
        }
        m0();
    }
    ...
    public final void p(zzao zzao, zzn zzn) {
        ...
        zzn zzn2 = zzn;
        Preconditions.k(zzn);
        Preconditions.g(zzn2.f10523b);
        j0();
        c0();
        String str = zzn2.f10523b;
        long j2 = zzao2.f10380e;
        Z();
        if (zzkn.S(zzao, zzn)) {
            if (!zzn2.i) {
                Q(zzn2);
            ...
            if (this.i.x().C(str, zzaq.c0) && (list4 = zzn2.v) != null) {
                if (list4.contains(zzao2.f10377b)) {
                    Bundle B = zzao2.f10378c.B();
                    B.putLong("ga_safelisted", 1);
                    zzao2 = new zzao(zzao2.f10377b, new zzan(B), zzao2.f10379d, zzao2.f10380e);
                } else {
                    this.i.h().N().d("Dropping non-safelisted event. appId, event name, origin", str, zzao2.f10377b, zzao2.f10379d);
                    return;
                }
            }
            V().v0();
            try {
                ...
                for (zzw next : list) {
                    if (next != null) {
                        this.i.h().O().d("User property timed out", next.f10529b, this.i.H().A(next.f10531d.f10515c), next.f10531d.u());
                        if (next.h != null) {
                            S(new zzao(next.h, j2), zzn2);
                        }
                        V().r0(str, next.f10531d.f10515c);
                    }
                }
                c V2 = V();
                Preconditions.g(str);
                ...
                for (zzw next2 : list2) {
                    if (next2 != null) {
                        this.i.h().O().d("User property expired", next2.f10529b, this.i.H().A(next2.f10531d.f10515c), next2.f10531d.u());
                        V().l0(str, next2.f10531d.f10515c);
                        if (next2.l != null) {
                            arrayList.add(next2.l);
                        }
                        V().r0(str, next2.f10531d.f10515c);
                    }
                }
                ...
                for (zzw next3 : list3) {
                    if (next3 != null) {
                        zzkq zzkq = next3.f10531d;
                        s7 s7Var = r4;
                        s7 s7Var2 = new s7(next3.f10529b, next3.f10530c, zzkq.f10515c, j2, zzkq.u());
                        if (V().S(s7Var)) {
                            this.i.h().O().d("User property triggered", next3.f10529b, this.i.H().A(s7Var.f10240c), s7Var.f10242e);
                        } else {
                            this.i.h().G().d("Too many active user properties, ignoring", zzeu.x(next3.f10529b), this.i.H().A(s7Var.f10240c), s7Var.f10242e);
                        }
                        if (next3.j != null) {
                            arrayList2.add(next3.j);
                        }
                        next3.f10531d = new zzkq(s7Var);
                        next3.f10533f = true;
                        V().T(next3);
                    }
                }
    ...
    public final void v(zzkq zzkq, zzn zzn) {
        ...
        if (W(zzn)) {
            ...
            int x0 = this.i.G().x0(zzkq.f10515c);
            if (x0 != 0) {
                this.i.G();
                String H = zzkr.H(zzkq.f10515c, 24, true);
                String str = zzkq.f10515c;
                this.i.G().W(zzn.f10523b, x0, "_ev", H, str != null ? str.length() : 0);
                return;
            }
            int p0 = this.i.G().p0(zzkq.f10515c, zzkq.u());
            if (p0 != 0) {
                this.i.G();
                String H2 = zzkr.H(zzkq.f10515c, 24, true);
                Object u2 = zzkq.u();
                this.i.G().W(zzn.f10523b, p0, "_ev", H2, (u2 == null || (!(u2 instanceof String) && !(u2 instanceof CharSequence))) ? 0 : String.valueOf(u2).length());
                return;
            }
            Object y0 = this.i.G().y0(zzkq.f10515c, zzkq.u());
            if (y0 != null) {
                if ("_sid".equals(zzkq.f10515c)) {
                    long j2 = zzkq.f10516d;
                    String str2 = zzkq.g;
                    long j3 = 0;
                    s7 o0 = V().o0(zzn.f10523b, "_sno");
                    if (o0 != null) {
                        Object obj = o0.f10242e;
                    ...
                    if (o0 != null) {
                        this.i.h().J().b("Retrieved last session number from database does not contain a valid (long) value", o0.f10242e);
                    }
                    h D = V().D(zzn.f10523b, "_s");
                    if (D != null) {
                        j3 = D.f10028c;
                ...
                s7 s7Var = new s7(zzn.f10523b, zzkq.g, zzkq.f10515c, zzkq.f10516d, y0);
                this.i.h().O().c("Setting user property", this.i.H().A(s7Var.f10240c), y0);
                V().v0();
                try {
                    Q(zzn);
                    boolean S = V().S(s7Var);
                    V().v();
                    if (!S) {
                        this.i.h().G().c("Too many unique user properties are set. Ignoring user property", this.i.H().A(s7Var.f10240c), s7Var.f10242e);
                        this.i.G().W(zzn.f10523b, 9, (String) null, (String) null, 0);
                    }
                } finally {
                    V().A0();
                }
    ...
    public final void y(zzw zzw, zzn zzn) {
        ...
        if (W(zzn)) {
            ...
            V().v0();
            try {
                zzw p0 = V().p0(zzw2.f10529b, zzw2.f10531d.f10515c);
                if (p0 != null && !p0.f10530c.equals(zzw2.f10530c)) {
                    this.i.h().J().d("Updating a conditional user property with different origin. name, origin, origin (from DB)", this.i.H().A(zzw2.f10531d.f10515c), zzw2.f10530c, p0.f10530c);
                }
                if (p0 != null && p0.f10533f) {
                    zzw2.f10530c = p0.f10530c;
                    zzw2.f10532e = p0.f10532e;
                    zzw2.i = p0.i;
                    zzw2.g = p0.g;
                    zzw2.j = p0.j;
                    zzw2.f10533f = p0.f10533f;
                    zzw2.f10531d = new zzkq(zzw2.f10531d.f10515c, p0.f10531d.f10516d, zzw2.f10531d.u(), p0.f10531d.g);
                } else if (TextUtils.isEmpty(zzw2.g)) {
                    zzw2.f10531d = new zzkq(zzw2.f10531d.f10515c, zzw2.f10532e, zzw2.f10531d.u(), zzw2.f10531d.g);
                    zzw2.f10533f = true;
                    z = true;
                }
                if (zzw2.f10533f) {
                    zzkq zzkq = zzw2.f10531d;
                    s7 s7Var = new s7(zzw2.f10529b, zzw2.f10530c, zzkq.f10515c, zzkq.f10516d, zzkq.u());
                    if (V().S(s7Var)) {
                        this.i.h().N().d("User property updated immediately", zzw2.f10529b, this.i.H().A(s7Var.f10240c), s7Var.f10242e);
                    } else {
                        this.i.h().G().d("(2)Too many active user properties, ignoring", zzeu.x(zzw2.f10529b), this.i.H().A(s7Var.f10240c), s7Var.f10242e);
                    }
                    if (z && zzw2.j != null) {
                        S(new zzao(zzw2.j, zzw2.f10532e), zzn);
                    }
                }
                if (V().T(zzw2)) {
                    this.i.h().N().d("Conditional property added", zzw2.f10529b, this.i.H().A(zzw2.f10531d.f10515c), zzw2.f10531d.u());
                } else {
                    this.i.h().G().d("Too many conditional properties, ignoring", zzeu.x(zzw2.f10529b), this.i.H().A(zzw2.f10531d.f10515c), zzw2.f10531d.u());
                }
                V().v();
            } finally {
                V().A0();
    ...
    private zzkj(zzko zzko, zzfy zzfy) {
        ...
        this.i = zzfy.a(zzko.f10513a, (zzae) null, (Long) null);
        this.w = -1;
