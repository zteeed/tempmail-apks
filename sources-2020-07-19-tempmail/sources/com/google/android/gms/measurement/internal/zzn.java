...
public final class zzn extends AbstractSafeParcelable {
    ...
    zzn(String str, String str2, String str3, long j2, String str4, long j3, long j4, String str5, boolean z, boolean z2, String str6, long j5, long j6, int i2, boolean z3, boolean z4, boolean z5, String str7, Boolean bool, long j7, List<String> list, String str8) {
        Preconditions.g(str);
        this.f10523b = str;
        this.f10524c = TextUtils.isEmpty(str2) ? null : str2;
        this.f10525d = str3;
        this.k = j2;
        this.f10526e = str4;
        this.f10527f = j3;
    ...
    public final void writeToParcel(Parcel parcel, int i2) {
        ...
        SafeParcelWriter.t(parcel, 2, this.f10523b, false);
        SafeParcelWriter.t(parcel, 3, this.f10524c, false);
        SafeParcelWriter.t(parcel, 4, this.f10525d, false);
        SafeParcelWriter.t(parcel, 5, this.f10526e, false);
        SafeParcelWriter.o(parcel, 6, this.f10527f);
