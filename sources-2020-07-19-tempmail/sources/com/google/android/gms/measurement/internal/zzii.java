...
public final class zzii extends x3 {
    ...
    private volatile zzij f10479c;

    /* renamed from: d  reason: collision with root package name */
    private zzij f10480d;
    @VisibleForTesting

    /* renamed from: e  reason: collision with root package name */
    protected zzij f10481e;

    /* renamed from: f  reason: collision with root package name */
    private final Map<Activity, zzij> f10482f = new ConcurrentHashMap();
    private Activity g;
    ...
    private final void I(Activity activity, zzij zzij, boolean z) {
        zzij zzij2;
        zzij zzij3 = this.f10479c == null ? this.f10480d : this.f10479c;
        if (zzij.f10484b == null) {
            zzij2 = new zzij(zzij.f10483a, activity != null ? F(activity.getClass().getCanonicalName()) : null, zzij.f10485c, zzij.f10487e);
        } else {
            zzij2 = zzij;
        }
    ...
    public static void P(zzij zzij, Bundle bundle, boolean z) {
        if (bundle != null && zzij != null && (!bundle.containsKey("_sc") || z)) {
            String str = zzij.f10483a;
            if (str != null) {
                bundle.putString("_sn", str);
            } else {
                bundle.remove("_sn");
            }
            String str2 = zzij.f10484b;
            if (str2 != null) {
                bundle.putString("_sc", str2);
            } else {
                bundle.remove("_sc");
            }
            bundle.putLong("_si", zzij.f10485c);
    ...
    public final void Q(zzij zzij, zzij zzij2, long j2, boolean z, Bundle bundle) {
        ...
        boolean z3 = false;
        if (l().t(zzaq.U)) {
            z2 = z && this.f10481e != null;
            if (z2) {
                R(this.f10481e, true, j2);
            }
        } else {
            if (z && (zzij3 = this.f10481e) != null) {
                R(zzij3, true, j2);
            }
            z2 = false;
        }
        if (zzij2 == null || zzij2.f10485c != zzij.f10485c || !zzkr.A0(zzij2.f10484b, zzij.f10484b) || !zzkr.A0(zzij2.f10483a, zzij.f10483a)) {
            z3 = true;
        }
        if (z3) {
            ...
            P(zzij, bundle2, true);
            if (zzij2 != null) {
                String str = zzij2.f10483a;
                if (str != null) {
                    bundle2.putString("_pn", str);
                }
                String str2 = zzij2.f10484b;
                if (str2 != null) {
                    bundle2.putString("_pc", str2);
                }
                bundle2.putLong("_pi", zzij2.f10485c);
            }
            if (l().t(zzaq.U) && z2) {
    ...
    public final void R(zzij zzij, boolean z, long j2) {
        p().w(n().b());
        if (v().F(zzij != null && zzij.f10486d, z, j2) && zzij != null) {
            zzij.f10486d = false;
        }
    }
    ...
    public final void H(Activity activity, Bundle bundle) {
        ...
        if (l().L().booleanValue() && bundle != null && (bundle2 = bundle.getBundle("com.google.app_measurement.screen_service")) != null) {
            this.f10482f.put(activity, new zzij(bundle2.getString(AnalyticsConnectorReceiver.EVENT_NAME_KEY), bundle2.getString("referrer_name"), bundle2.getLong("id")));
        }
    }
    ...
    public final void J(Activity activity, String str, String str2) {
        if (!l().L().booleanValue()) {
            ...
            boolean A0 = zzkr.A0(this.f10479c.f10484b, str2);
            boolean A02 = zzkr.A0(this.f10479c.f10483a, str);
            if (A0 && A02) {
                ...
                this.f10482f.put(activity, zzij);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:58:0x00f2, code lost:
        if (r13.f10479c != null) goto L_0x00f7;
     */
    ...
    public final void K(android.os.Bundle r14) {
        ...
        L_0x00a7:
            ...
            com.google.android.gms.measurement.internal.zzij r1 = r13.f10479c     // Catch:{ all -> 0x0127 }
            if (r1 == 0) goto L_0x00d6
            r1 = 0
            r13.h = r1     // Catch:{ all -> 0x0127 }
            com.google.android.gms.measurement.internal.zzij r1 = r13.f10479c     // Catch:{ all -> 0x0127 }
            java.lang.String r1 = r1.f10484b     // Catch:{ all -> 0x0127 }
            boolean r1 = com.google.android.gms.measurement.internal.zzkr.A0(r1, r4)     // Catch:{ all -> 0x0127 }
            com.google.android.gms.measurement.internal.zzij r2 = r13.f10479c     // Catch:{ all -> 0x0127 }
            java.lang.String r2 = r2.f10483a     // Catch:{ all -> 0x0127 }
        ...
        L_0x00ed:
            r0.c(r1, r2, r5)
            com.google.android.gms.measurement.internal.zzij r0 = r13.f10479c
            if (r0 != 0) goto L_0x00f7
            com.google.android.gms.measurement.internal.zzij r0 = r13.f10480d
            goto L_0x00f9
        L_0x00f7:
            com.google.android.gms.measurement.internal.zzij r0 = r13.f10479c
        L_0x00f9:
    ...
    public final void V(Activity activity, Bundle bundle) {
        zzij zzij;
        if (l().L().booleanValue() && bundle != null && (zzij = this.f10482f.get(activity)) != null) {
            Bundle bundle2 = new Bundle();
            bundle2.putLong("id", zzij.f10485c);
            bundle2.putString(AnalyticsConnectorReceiver.EVENT_NAME_KEY, zzij.f10483a);
            bundle2.putString("referrer_name", zzij.f10484b);
