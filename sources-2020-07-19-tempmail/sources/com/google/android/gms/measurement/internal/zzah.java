...
public final class zzah {
    ...
    private static boolean d(zzeu zzeu, SQLiteDatabase sQLiteDatabase, String str) {
        if (zzeu != null) {
            Cursor cursor = null;
            try {
                Cursor query = sQLiteDatabase.query("SQLITE_MASTER", new String[]{AnalyticsConnectorReceiver.EVENT_NAME_KEY}, "name=?", new String[]{str}, (String) null, (String) null, (String) null);
