...
final class c extends m7 {
    ...
    public static final String[] f9934f = {"last_bundled_timestamp", "ALTER TABLE events ADD COLUMN last_bundled_timestamp INTEGER;", "last_bundled_day", "ALTER TABLE events ADD COLUMN last_bundled_day INTEGER;", "last_sampled_complex_event_id", "ALTER TABLE events ADD COLUMN last_sampled_complex_event_id INTEGER;", "last_sampling_rate", "ALTER TABLE events ADD COLUMN last_sampling_rate INTEGER;", "last_exempt_from_sampling", "ALTER TABLE events ADD COLUMN last_exempt_from_sampling INTEGER;", "current_session_count", "ALTER TABLE events ADD COLUMN current_session_count INTEGER;"};
    /* access modifiers changed from: private */
    ...
    private final d f9935d = new d(this, f(), "google_app_measurement.db");
    /* access modifiers changed from: private */

    /* renamed from: e  reason: collision with root package name */
    public final j7 f9936e = new j7(n());
    ...
    public final zzac B(long j2, String str, long j3, boolean z, boolean z2, boolean z3, boolean z4, boolean z5) {
        ...
        try {
            ...
            if (cursor.getLong(0) == j2) {
                zzac.f10362b = cursor.getLong(1);
                zzac.f10361a = cursor.getLong(2);
                zzac.f10363c = cursor.getLong(3);
                zzac.f10364d = cursor.getLong(4);
                zzac.f10365e = cursor.getLong(5);
            }
            if (z) {
                zzac.f10362b += j3;
            }
            ...
            contentValues.put("daily_public_events_count", Long.valueOf(zzac.f10361a));
            contentValues.put("daily_events_count", Long.valueOf(zzac.f10362b));
            contentValues.put("daily_conversions_count", Long.valueOf(zzac.f10363c));
            contentValues.put("daily_error_events_count", Long.valueOf(zzac.f10364d));
            contentValues.put("daily_realtime_events_count", Long.valueOf(zzac.f10365e));
    ...
    public final void M(h hVar) {
        ...
        s();
        ContentValues contentValues = new ContentValues();
        contentValues.put("app_id", hVar.f10026a);
        contentValues.put(AnalyticsConnectorReceiver.EVENT_NAME_KEY, hVar.f10027b);
        contentValues.put("lifetime_count", Long.valueOf(hVar.f10028c));
        contentValues.put("current_bundle_count", Long.valueOf(hVar.f10029d));
        contentValues.put("last_fire_timestamp", Long.valueOf(hVar.f10031f));
        ...
        contentValues.put("current_session_count", Long.valueOf(hVar.f10030e));
        Boolean bool = hVar.k;
        contentValues.put("last_exempt_from_sampling", (bool == null || !bool.booleanValue()) ? null : 1L);
        try {
            if (w().insertWithOnConflict("events", (String) null, contentValues, 5) == -1) {
                h().G().b("Failed to insert/update event aggregates (got -1). appId", zzeu.x(hVar.f10026a));
            }
        } catch (SQLiteException e2) {
            h().G().c("Error storing event aggregates. appId", zzeu.x(hVar.f10026a), e2);
        }
    }
    ...
    public final void O(String str, List<zzbt.zza> list) {
        ...
        for (int i2 = 0; i2 < list.size(); i2++) {
            zzbt.zza.C0090zza zza = (zzbt.zza.C0090zza) list2.get(i2).x();
            if (zza.H() != 0) {
    ...
    public final boolean R(zzal zzal, long j2, boolean z) {
        ...
        Preconditions.g(zzal.f10370a);
        byte[] j3 = o().y(zzal).j();
        ContentValues contentValues = new ContentValues();
        contentValues.put("app_id", zzal.f10370a);
        contentValues.put(AnalyticsConnectorReceiver.EVENT_NAME_KEY, zzal.f10371b);
        contentValues.put("timestamp", Long.valueOf(zzal.f10373d));
        ...
        try {
            ...
            h().G().b("Failed to insert raw event (got -1). appId", zzeu.x(zzal.f10370a));
            return false;
        } catch (SQLiteException e2) {
            h().G().c("Error storing raw event. appId", zzeu.x(zzal.f10370a), e2);
            return false;
        }
    }
    ...
    public final boolean S(s7 s7Var) {
        ...
        c();
        s();
        if (o0(s7Var.f10238a, s7Var.f10240c) == null) {
            if (zzkr.d0(s7Var.f10240c)) {
                if (i0("select count(1) from user_attributes where app_id=? and name not like '!_%' escape '!'", new String[]{s7Var.f10238a}) >= ((long) l().y(s7Var.f10238a))) {
                    return false;
                }
            } else if (!"_npa".equals(s7Var.f10240c)) {
                if (i0("select count(1) from user_attributes where app_id=? and origin=? AND name like '!_%' escape '!'", new String[]{s7Var.f10238a, s7Var.f10239b}) >= 25) {
                    return false;
                }
            }
        }
        ContentValues contentValues = new ContentValues();
        contentValues.put("app_id", s7Var.f10238a);
        contentValues.put("origin", s7Var.f10239b);
        contentValues.put(AnalyticsConnectorReceiver.EVENT_NAME_KEY, s7Var.f10240c);
        contentValues.put("set_timestamp", Long.valueOf(s7Var.f10241d));
        L(contentValues, "value", s7Var.f10242e);
        try {
            if (w().insertWithOnConflict("user_attributes", (String) null, contentValues, 5) == -1) {
                h().G().b("Failed to insert/update user property (got -1). appId", zzeu.x(s7Var.f10238a));
            }
        } catch (SQLiteException e2) {
            h().G().c("Error storing user property. appId", zzeu.x(s7Var.f10238a), e2);
        }
        return true;
    }
    ...
    public final boolean T(zzw zzw) {
        ...
        c();
        s();
        if (o0(zzw.f10529b, zzw.f10531d.f10515c) == null) {
            if (i0("SELECT COUNT(1) FROM conditional_properties WHERE app_id=?", new String[]{zzw.f10529b}) >= 1000) {
                return false;
            }
        }
        ContentValues contentValues = new ContentValues();
        contentValues.put("app_id", zzw.f10529b);
        contentValues.put("origin", zzw.f10530c);
        contentValues.put(AnalyticsConnectorReceiver.EVENT_NAME_KEY, zzw.f10531d.f10515c);
        L(contentValues, "value", zzw.f10531d.u());
        contentValues.put("active", Boolean.valueOf(zzw.f10533f));
        ...
        contentValues.put("creation_timestamp", Long.valueOf(zzw.f10532e));
        j();
        contentValues.put("triggered_event", zzkr.n0(zzw.j));
        contentValues.put("triggered_timestamp", Long.valueOf(zzw.f10531d.f10516d));
        ...
        try {
            if (w().insertWithOnConflict("conditional_properties", (String) null, contentValues, 5) == -1) {
                h().G().b("Failed to insert/update conditional user property (got -1)", zzeu.x(zzw.f10529b));
            }
        } catch (SQLiteException e2) {
            h().G().c("Error storing conditional user property", zzeu.x(zzw.f10529b), e2);
        }
        return true;
    }
    ...
    public final boolean W(String str, Bundle bundle) {
        c();
        s();
        byte[] j2 = o().y(new zzal(this.f10171a, "", str, "dep", 0, 0, bundle)).j();
    ...
    public final com.google.android.gms.measurement.internal.k3 j0(java.lang.String r35) {
        ...
        L_0x006b:
            ...
            r5 = r34
            com.google.android.gms.measurement.internal.zzkj r6 = r5.f10143b     // Catch:{ SQLiteException -> 0x0200 }
    ...
    public final SQLiteDatabase w() {
        c();
        try {
            return this.f9935d.getWritableDatabase();
        } catch (SQLiteException e2) {
