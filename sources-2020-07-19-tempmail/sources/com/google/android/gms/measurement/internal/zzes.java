...
public final class zzes extends s4 {
    ...
    private static final AtomicReference<String[]> f10399c = new AtomicReference<>();

    /* renamed from: d  reason: collision with root package name */
    private static final AtomicReference<String[]> f10400d = new AtomicReference<>();

    /* renamed from: e  reason: collision with root package name */
    private static final AtomicReference<String[]> f10401e = new AtomicReference<>();
    ...
    private final boolean B() {
        m();
        return this.f10171a.J() && this.f10171a.h().C(3);
    }
    ...
    public final String A(String str) {
        ...
        if (!str.startsWith("_exp_")) {
            return x(str, zzgy.f10463b, zzgy.f10462a, f10401e);
        }
    ...
    public final String v(zzao zzao) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("origin=");
        sb.append(zzao.f10379d);
        sb.append(",name=");
        sb.append(w(zzao.f10377b));
        sb.append(",params=");
        zzan zzan = zzao.f10378c;
        if (zzan != null) {
            if (!B()) {
                str = zzan.toString();
            } else {
    ...
    public final String w(String str) {
        ...
        return x(str, zzgw.f10460b, zzgw.f10459a, f10399c);
    }
    ...
    public final String z(String str) {
        ...
        return x(str, zzgz.f10465b, zzgz.f10464a, f10400d);
    }
}
