...
public final class zzfv extends s4 {
    ...
    private final PriorityBlockingQueue<u3<?>> f10448e = new PriorityBlockingQueue<>();

    /* renamed from: f  reason: collision with root package name */
    private final BlockingQueue<u3<?>> f10449f = new LinkedBlockingQueue();
    ...
    private final void y(u3<?> u3Var) {
        synchronized (this.i) {
            this.f10448e.add(u3Var);
            if (this.f10446c == null) {
                w3 w3Var = new w3(this, "Measurement Worker", this.f10448e);
                this.f10446c = w3Var;
    ...
    public final <V> Future<V> B(Callable<V> callable) throws IllegalStateException {
        ...
        if (Thread.currentThread() == this.f10446c) {
            u3Var.run();
        } else {
            y(u3Var);
        }
    ...
    public final void C(Runnable runnable) throws IllegalStateException {
        ...
        synchronized (this.i) {
            this.f10449f.add(u3Var);
            if (this.f10447d == null) {
                w3 w3Var = new w3(this, "Measurement Network", this.f10449f);
                this.f10447d = w3Var;
    ...
    public final boolean H() {
        return Thread.currentThread() == this.f10446c;
    }

    public final void b() {
        if (Thread.currentThread() != this.f10447d) {
