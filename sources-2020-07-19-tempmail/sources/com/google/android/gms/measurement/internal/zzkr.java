...
public final class zzkr extends s4 {
    ...
    private SecureRandom f10519c;

    /* renamed from: d  reason: collision with root package name */
    private final AtomicLong f10520d = new AtomicLong(0);

    /* renamed from: e  reason: collision with root package name */
    private int f10521e;

    /* renamed from: f  reason: collision with root package name */
    private Integer f10522f = null;
    ...
    public static Bundle D(List<zzkq> list) {
        ...
        for (zzkq next : list) {
            String str = next.f10518f;
            if (str != null) {
                bundle.putString(next.f10515c, str);
            } else {
                Long l = next.f10517e;
                if (l != null) {
                    bundle.putLong(next.f10515c, l.longValue());
                } else {
                    Double d2 = next.h;
                    if (d2 != null) {
                        bundle.putDouble(next.f10515c, d2.doubleValue());
                    }
                }
            }
        }
            ...
            for (String str7 : new TreeSet(bundle.keySet())) {
                ...
                if (i2 != 0) {
                    ...
                    if (i3 != 0 && !"_ev".equals(str4)) {
                        ...
                        bundle2.remove(str4);
                    } else if (d0(str4) && (!t || !k0(str4, zzgz.f10467d))) {
                        int i5 = i4 + 1;
                        if (i5 > i) {
                            if (t) {
    ...
    public static ArrayList<Bundle> r0(List<zzw> list) {
        ...
        for (zzw next : list) {
            Bundle bundle = new Bundle();
            bundle.putString("app_id", next.f10529b);
            bundle.putString("origin", next.f10530c);
            bundle.putLong("creation_timestamp", next.f10532e);
            bundle.putString(AnalyticsConnectorReceiver.EVENT_NAME_KEY, next.f10531d.f10515c);
            zzgx.b(bundle, next.f10531d.u());
            bundle.putBoolean("active", next.f10533f);
            String str = next.g;
            if (str != null) {
            ...
            zzao zzao = next.h;
            if (zzao != null) {
                bundle.putString("timed_out_event_name", zzao.f10377b);
                zzan zzan = next.h.f10378c;
                if (zzan != null) {
            ...
            zzao zzao2 = next.j;
            if (zzao2 != null) {
                bundle.putString("triggered_event_name", zzao2.f10377b);
                zzan zzan2 = next.j.f10378c;
                if (zzan2 != null) {
                    bundle.putBundle("triggered_event_params", zzan2.B());
                }
            }
            bundle.putLong("triggered_timestamp", next.f10531d.f10516d);
            bundle.putLong("time_to_live", next.k);
            zzao zzao3 = next.l;
            if (zzao3 != null) {
                bundle.putString("expired_event_name", zzao3.f10377b);
                zzan zzan3 = next.l.f10378c;
                if (zzan3 != null) {
    ...
    private final int v(java.lang.String r18, java.lang.String r19, java.lang.String r20, java.lang.Object r21, android.os.Bundle r22, java.util.List<java.lang.String> r23, boolean r24, boolean r25) {
        /*
            ...
            java.lang.String[] r2 = com.google.android.gms.measurement.internal.zzgz.f10466c
            boolean r2 = k0(r8, r2)
            if (r2 != 0) goto L_0x0035
            r0 = 20
            return r0
        L_0x0035:
            com.google.android.gms.measurement.internal.zzfy r2 = r7.f10171a
    ...
    public final android.os.Bundle C(java.lang.String r20, java.lang.String r21, android.os.Bundle r22, java.util.List<java.lang.String> r23, boolean r24, boolean r25) {
        ...
        L_0x001e:
            ...
            java.lang.String[] r0 = com.google.android.gms.measurement.internal.zzgw.f10461c
    ...
    public final long E0() {
        ...
        synchronized (this.f10520d) {
            this.f10520d.compareAndSet(-1, 1);
            andIncrement = this.f10520d.getAndIncrement();
        }
        return andIncrement;
    }
    ...
    public final int K0() {
        if (this.f10522f == null) {
            this.f10522f = Integer.valueOf(GoogleApiAvailabilityLight.h().b(f()) / 1000);
        }
        return this.f10522f.intValue();
    }
    ...
    public final void O(zzw zzw, int i) {
        ...
        try {
            ...
            this.f10171a.h().J().b("Error returning int value to wrapper", e2);
        }
    }
    ...
    public final void P(zzw zzw, long j) {
        ...
        try {
            ...
            this.f10171a.h().J().b("Error returning long value to wrapper", e2);
        }
    }
    ...
    public final void Q(zzw zzw, Bundle bundle) {
        try {
            ...
            this.f10171a.h().J().b("Error returning bundle value to wrapper", e2);
        }
    }
    ...
    public final void R(zzw zzw, String str) {
        ...
        try {
            ...
            this.f10171a.h().J().b("Error returning string value to wrapper", e2);
        }
    }
    ...
    public final void S(zzw zzw, ArrayList<Bundle> arrayList) {
        ...
        try {
            ...
            this.f10171a.h().J().b("Error returning bundle list to wrapper", e2);
        }
    }
    ...
    public final void T(zzw zzw, boolean z) {
        ...
        try {
            ...
            this.f10171a.h().J().b("Error returning boolean value to wrapper", e2);
        }
    }
    ...
    public final void U(zzw zzw, byte[] bArr) {
        ...
        try {
            ...
            this.f10171a.h().J().b("Error returning byte array to wrapper", e2);
        }
    }
    ...
    public final void V(zzey zzey, int i) {
        int i2 = 0;
        for (String str : new TreeSet(zzey.f10413d.keySet())) {
            if (d0(str) && (i2 = i2 + 1) > i) {
                StringBuilder sb = new StringBuilder(48);
                sb.append("Event can't contain more than ");
                sb.append(i);
                sb.append(" params");
                h().I().c(sb.toString(), e().w(zzey.f10410a), e().u(zzey.f10413d));
                t0(zzey.f10413d, 5);
                zzey.f10413d.remove(str);
            }
        }
    }
    ...
    public final void W(String str, int i, String str2, String str3, int i2) {
        ...
        this.f10171a.m();
        this.f10171a.F().R("auto", "_err", bundle);
    }
    ...
    public final int x0(String str) {
        ...
        if (!l0("user property", zzgy.f10462a, str)) {
            return 15;
        }
