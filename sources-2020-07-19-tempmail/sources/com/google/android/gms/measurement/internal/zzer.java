...
public final class zzer extends x3 {
    ...
    public final zzn C(String str) {
        ...
        String E = E();
        y();
        String str3 = this.f10396d;
        long H = (long) H();
        y();
        String str4 = this.f10398f;
        long D2 = l().D();
        y();
        c();
        if (this.g == 0) {
            this.g = this.f10171a.G().x(f(), f().getPackageName());
        }
        long j3 = this.g;
        boolean p = this.f10171a.p();
        boolean z2 = !k().v;
        c();
        a();
        if (!this.f10171a.p()) {
    ...
    public final void w() {
        ...
        L_0x00ae:
            r6 = 0
        L_0x00af:
            com.google.android.gms.measurement.internal.zzfy r7 = r11.f10171a
        ...
        L_0x00f8:
            ...
            com.google.android.gms.measurement.internal.zzfy r2 = r11.f10171a
            int r2 = r2.q()
            switch(r2) {
        ...
        L_0x0193:
            ...
            com.google.android.gms.measurement.internal.zzfy r6 = r11.f10171a
        ...
        L_0x022c:
            ...
            java.lang.String r6 = r11.f10395c     // Catch:{ IllegalStateException -> 0x024b }
