...
public final class zzfl {
    ...
    private final Bundle f10426b = new Bundle();

    /* renamed from: c  reason: collision with root package name */
    private boolean f10427c;

    /* renamed from: d  reason: collision with root package name */
    private Bundle f10428d;

    /* renamed from: e  reason: collision with root package name */
    private final /* synthetic */ q3 f10429e;
            ...
            if (obj != null) {
                try {
                    ...
                    if (obj instanceof String) {
                        ...
                        this.f10429e.h().G().b("Cannot serialize bundle value to SharedPreferences. Type", obj.getClass());
                    }
                    jSONArray.put(jSONObject);
                } catch (JSONException e2) {
                    this.f10429e.h().G().b("Cannot serialize bundle value to SharedPreferences", e2);
                }
            }
        }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:35:?, code lost:
        r12.f10429e.h().G().a("Error reading value from SharedPreferences. Value dropped");
     */
    ...
    public final android.os.Bundle a() {
        /*
            r12 = this;
            boolean r0 = r12.f10427c
            if (r0 != 0) goto L_0x00cd
            r0 = 1
            r12.f10427c = r0
            com.google.android.gms.measurement.internal.q3 r1 = r12.f10429e
            android.content.SharedPreferences r1 = r1.C()
            java.lang.String r2 = r12.f10425a
            r3 = 0
        ...
        L_0x0068:
            ...
            com.google.android.gms.measurement.internal.q3 r5 = r12.f10429e     // Catch:{ NumberFormatException | JSONException -> 0x00a0 }
        ...
        L_0x0098:
            ...
            goto L_0x00af
        L_0x00a0:
            com.google.android.gms.measurement.internal.q3 r5 = r12.f10429e     // Catch:{ JSONException -> 0x00b6 }
        ...
        L_0x00af:
            ...
            goto L_0x0022
        L_0x00b3:
            r12.f10428d = r2     // Catch:{ JSONException -> 0x00b6 }
            goto L_0x00c5
        L_0x00b6:
            com.google.android.gms.measurement.internal.q3 r0 = r12.f10429e
            ...
            r0.a(r1)
        L_0x00c5:
            android.os.Bundle r0 = r12.f10428d
            if (r0 != 0) goto L_0x00cd
            android.os.Bundle r0 = r12.f10426b
            r12.f10428d = r0
        L_0x00cd:
            android.os.Bundle r0 = r12.f10428d
            return r0
    ...
    public final void b(Bundle bundle) {
        ...
        SharedPreferences.Editor edit = this.f10429e.C().edit();
        if (bundle.size() == 0) {
            edit.remove(this.f10425a);
        } else {
            edit.putString(this.f10425a, c(bundle));
        }
        edit.apply();
        this.f10428d = bundle;
    }
