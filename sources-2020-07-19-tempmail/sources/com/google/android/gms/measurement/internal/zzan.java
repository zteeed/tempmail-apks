...
public final class zzan extends AbstractSafeParcelable implements Iterable<String> {
    ...
    public final Object A(String str) {
        return this.f10376b.get(str);
    }

    public final Bundle B() {
        return new Bundle(this.f10376b);
    }

    /* access modifiers changed from: package-private */
    public final Long G(String str) {
        return Long.valueOf(this.f10376b.getLong(str));
    }

    /* access modifiers changed from: package-private */
    public final Double J(String str) {
        return Double.valueOf(this.f10376b.getDouble(str));
    }

    /* access modifiers changed from: package-private */
    public final String K(String str) {
        return this.f10376b.getString(str);
    }
