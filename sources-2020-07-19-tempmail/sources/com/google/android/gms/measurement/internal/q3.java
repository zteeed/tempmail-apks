...
final class q3 extends s4 {
    ...
    private SharedPreferences f10187c;

    /* renamed from: d  reason: collision with root package name */
    public zzfn f10188d;

    /* renamed from: e  reason: collision with root package name */
    public final zzfk f10189e = new zzfk(this, "last_upload", 0);

    /* renamed from: f  reason: collision with root package name */
    public final zzfk f10190f = new zzfk(this, "last_upload_attempt", 0);
    ...
    public final boolean J() {
        return this.f10187c.contains("deferred_analytics_collection");
    }

    /* access modifiers changed from: protected */
    public final void o() {
        SharedPreferences sharedPreferences = f().getSharedPreferences("com.google.android.gms.measurement.prefs", 0);
        this.f10187c = sharedPreferences;
        boolean z2 = sharedPreferences.getBoolean("has_been_opened", false);
        this.v = z2;
        if (!z2) {
            SharedPreferences.Editor edit = this.f10187c.edit();
            edit.putBoolean("has_been_opened", true);
            edit.apply();
        }
        this.f10188d = new zzfn(this, "health_monitor", Math.max(0, zzaq.f10383c.a(null).longValue()));
    }
    ...
    public final Pair<String, Boolean> u(String str) {
        ...
        this.o = b2 + l().q(str, zzaq.f10382b);
