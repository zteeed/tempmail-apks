...
public class zzfy implements r4 {
    ...
    private zzfy(zzhd zzhd) {
        ...
        zzx zzx = new zzx(zzhd.f10472a);
        this.f10455f = zzx;
        f3.f9992a = zzx;
        this.f10450a = zzhd.f10472a;
        this.f10451b = zzhd.f10473b;
        this.f10452c = zzhd.f10474c;
        this.f10453d = zzhd.f10475d;
        this.f10454e = zzhd.h;
        this.A = zzhd.f10476e;
        zzae zzae = zzhd.g;
        ...
        this.j = zzfv;
        zzae zzae2 = zzhd.g;
        if (!(zzae2 == null || zzae2.f9543c == 0)) {
            z2 = true;
        }
        boolean z3 = !z2;
        if (this.f10450a.getApplicationContext() instanceof Application) {
            zzhc F2 = F();
            if (F2.f().getApplicationContext() instanceof Application) {
                Application application = (Application) F2.f().getApplicationContext();
                if (F2.f10468c == null) {
                    F2.f10468c = new n5(F2, (x4) null);
                }
                if (z3) {
                    application.unregisterActivityLifecycleCallbacks(F2.f10468c);
                    application.registerActivityLifecycleCallbacks(F2.f10468c);
    ...
    public static zzfy a(Context context, zzae zzae, Long l2) {
        Bundle bundle;
        if (zzae != null && (zzae.f9546f == null || zzae.g == null)) {
            zzae = new zzae(zzae.f9542b, zzae.f9543c, zzae.f9544d, zzae.f9545e, (String) null, (String) null, zzae.h);
        }
    ...
    public final void j(zzhd zzhd) {
        ...
        zzai.q();
        this.u = zzai;
        zzer zzer = new zzer(this, zzhd.f10477f);
        zzer.z();
        this.v = zzer;
    ...
    public final boolean J() {
        return TextUtils.isEmpty(this.f10451b);
    }
    ...
    public final void b() {
        ...
        if (u()) {
            ...
            if (!Wrappers.a(this.f10450a).g() && !this.g.R()) {
                if (!zzfq.b(this.f10450a)) {
                    h().G().a("AppMeasurementReceiver not registered/enabled");
                }
                if (!zzkr.Y(this.f10450a, false)) {
    ...
    public final boolean u() {
        if (this.x) {
            ...
            if (bool == null || this.z == 0 || (bool != null && !bool.booleanValue() && Math.abs(this.n.b() - this.z) > 1000)) {
                this.z = this.n.b();
                boolean z2 = true;
                Boolean valueOf = Boolean.valueOf(G().B0("android.permission.INTERNET") && G().B0("android.permission.ACCESS_NETWORK_STATE") && (Wrappers.a(this.f10450a).g() || this.g.R() || (zzfq.b(this.f10450a) && zzkr.Y(this.f10450a, false))));
                this.y = valueOf;
