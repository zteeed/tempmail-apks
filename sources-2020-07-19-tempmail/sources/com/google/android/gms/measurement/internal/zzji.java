...
public final class zzji implements ServiceConnection, BaseGmsClient.BaseConnectionCallbacks, BaseGmsClient.BaseOnConnectionFailedListener {
    ...
    public volatile boolean f10492a;

    /* renamed from: b  reason: collision with root package name */
    private volatile zzev f10493b;

    /* renamed from: c  reason: collision with root package name */
    final /* synthetic */ zzir f10494c;
    ...
    public final void E(Bundle bundle) {
        ...
        synchronized (this) {
            try {
                this.f10494c.g().z(new w6(this, (zzem) this.f10493b.getService()));
    ...
    public final void a() {
        if (this.f10493b != null && (this.f10493b.isConnected() || this.f10493b.isConnecting())) {
            this.f10493b.disconnect();
        }
        this.f10493b = null;
    }
    ...
    public final void b(Intent intent) {
        this.f10494c.c();
        Context f2 = this.f10494c.f();
        ConnectionTracker b2 = ConnectionTracker.b();
        synchronized (this) {
            if (this.f10492a) {
                this.f10494c.h().O().a("Connection attempt already in progress");
                return;
            }
            this.f10494c.h().O().a("Using local app measurement service");
            this.f10492a = true;
            b2.a(f2, intent, this.f10494c.f10488c, 129);
        }
    }

    public final void b0(ConnectionResult connectionResult) {
        Preconditions.f("MeasurementServiceConnection.onConnectionFailed");
        zzeu B = this.f10494c.f10171a.B();
        if (B != null) {
    ...
    public final void d() {
        ...
        synchronized (this) {
            if (this.f10492a) {
                this.f10494c.h().O().a("Connection attempt already in progress");
            } else if (this.f10493b == null || (!this.f10493b.isConnecting() && !this.f10493b.isConnected())) {
                this.f10493b = new zzev(f2, Looper.getMainLooper(), this, this);
                this.f10494c.h().O().a("Connecting to remote service");
                this.f10492a = true;
                this.f10493b.checkAvailabilityAndConnect();
            } else {
                this.f10494c.h().O().a("Already awaiting connection attempt");
            }
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:23:?, code lost:
        r3.f10494c.h().G().a("Service connect failed to get IMeasurementService");
     */
    ...
    public final void onServiceConnected(android.content.ComponentName r4, android.os.IBinder r5) {
        /*
            ...
            r3.f10492a = r4     // Catch:{ all -> 0x001c }
            com.google.android.gms.measurement.internal.zzir r4 = r3.f10494c     // Catch:{ all -> 0x001c }
        ...
        L_0x0041:
            r0 = r1
        L_0x0042:
            com.google.android.gms.measurement.internal.zzir r5 = r3.f10494c     // Catch:{ RemoteException -> 0x0062 }
        ...
        L_0x0052:
            ...
            goto L_0x0071
        L_0x0062:
            com.google.android.gms.measurement.internal.zzir r5 = r3.f10494c     // Catch:{ all -> 0x001c }
        ...
        L_0x0071:
            ...
            com.google.android.gms.measurement.internal.zzir r5 = r3.f10494c     // Catch:{ IllegalArgumentException -> 0x0097 }
            android.content.Context r5 = r5.f()     // Catch:{ IllegalArgumentException -> 0x0097 }
            com.google.android.gms.measurement.internal.zzir r0 = r3.f10494c     // Catch:{ IllegalArgumentException -> 0x0097 }
            com.google.android.gms.measurement.internal.zzji r0 = r0.f10488c     // Catch:{ IllegalArgumentException -> 0x0097 }
    ...
    public final void onServiceDisconnected(ComponentName componentName) {
        ...
        this.f10494c.h().N().a("Service disconnected");
        this.f10494c.g().z(new t6(this, componentName));
    }

    public final void y(int i) {
        Preconditions.f("MeasurementServiceConnection.onConnectionSuspended");
        this.f10494c.h().N().a("Service connection suspended");
        this.f10494c.g().z(new v6(this));
    }
}
