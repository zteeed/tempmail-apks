...
public class WakeLock {
    ...
    private final PowerManager.WakeLock f10561b;

    /* renamed from: c  reason: collision with root package name */
    private WorkSource f10562c;
    ...
    private final String d(String str) {
        if (this.h) {
            return !TextUtils.isEmpty(str) ? str : this.f10565f;
        }
        return this.f10565f;
    }

    private final List<String> e() {
        return WorkSourceUtil.b(this.f10562c);
    }

    /* access modifiers changed from: private */
    public final void f(int i2) {
        if (this.f10561b.isHeld()) {
            try {
                this.f10561b.release();
            } catch (RuntimeException e2) {
                if (e2.getClass().equals(RuntimeException.class)) {
                    Log.e("WakeLock", String.valueOf(this.f10564e).concat(" was already released!"), e2);
                } else {
                    throw e2;
                }
            }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x005e, code lost:
        com.google.android.gms.common.stats.WakeLockTracker.a().c(r13.g, com.google.android.gms.common.stats.StatsUtils.a(r13.f10561b, r6), 7, r13.f10564e, r6, (java.lang.String) null, r13.f10563d, e(), r14);
        r13.j++;
     */
    ...
    public void a(long r14) {
        /*
            ...
            java.lang.Object r0 = r13.f10560a
            monitor-enter(r0)
        ...
        L_0x001a:
            android.os.PowerManager$WakeLock r1 = r13.f10561b     // Catch:{ all -> 0x0096 }
        ...
        L_0x005e:
            ...
            android.os.PowerManager$WakeLock r3 = r13.f10561b     // Catch:{ all -> 0x0096 }
            java.lang.String r3 = com.google.android.gms.common.stats.StatsUtils.a(r3, r6)     // Catch:{ all -> 0x0096 }
            r4 = 7
            java.lang.String r5 = r13.f10564e     // Catch:{ all -> 0x0096 }
            r7 = 0
            int r8 = r13.f10563d     // Catch:{ all -> 0x0096 }
        ...
        L_0x007d:
            ...
            android.os.PowerManager$WakeLock r0 = r13.f10561b
            r0.acquire()
            r0 = 0
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x005a, code lost:
        com.google.android.gms.common.stats.WakeLockTracker.a().b(r12.g, com.google.android.gms.common.stats.StatsUtils.a(r12.f10561b, r6), 8, r12.f10564e, r6, (java.lang.String) null, r12.f10563d, e());
        r12.j--;
     */
    @com.google.android.gms.common.annotation.KeepForSdk
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void b() {
        /*
            ...
            java.lang.String r1 = r12.f10564e
        ...
        L_0x0019:
            ...
            java.lang.Object r0 = r12.f10560a
            monitor-enter(r0)
        ...
        L_0x005a:
            ...
            android.os.PowerManager$WakeLock r3 = r12.f10561b     // Catch:{ all -> 0x007e }
            java.lang.String r3 = com.google.android.gms.common.stats.StatsUtils.a(r3, r6)     // Catch:{ all -> 0x007e }
            r4 = 8
            java.lang.String r5 = r12.f10564e     // Catch:{ all -> 0x007e }
            r7 = 0
            int r8 = r12.f10563d     // Catch:{ all -> 0x007e }
    ...
    public void c(boolean z) {
        this.f10561b.setReferenceCounted(z);
        this.h = z;
    }
    ...
    private WakeLock(Context context, int i2, String str, String str2, String str3, String str4) {
        ...
        if (!"com.google.android.gms".equals(context.getPackageName())) {
            ...
            this.f10564e = valueOf.length() != 0 ? "*gcore*:".concat(valueOf) : new String("*gcore*:");
        } else {
            this.f10564e = str;
        }
        this.f10561b = ((PowerManager) context.getSystemService("power")).newWakeLock(i2, str);
        if (WorkSourceUtil.c(context)) {
            ...
            if (a2 != null && WorkSourceUtil.c(this.g)) {
                WorkSource workSource = this.f10562c;
                if (workSource != null) {
                    workSource.add(a2);
                } else {
                    this.f10562c = a2;
                ...
                try {
                    this.f10561b.setWorkSource(this.f10562c);
