...
final class zzo {
    ...
    public final void zza(zzve zzve, zzbbd zzbbd) {
        this.zzbpi = zzve.k.f9276b;
        Bundle bundle = zzve.n;
        Bundle bundle2 = bundle != null ? bundle.getBundle(AdMobAdapter.class.getName()) : null;
        if (bundle2 != null) {
            String a2 = zzacb.f5571c.a();
            ...
            this.zzbph.put("SDKVersion", zzbbd.f6131b);
            if (zzacb.f5569a.a().booleanValue()) {
                try {
                    Bundle a3 = zzddt.a(this.zzvr, new JSONArray(zzacb.f5570b.a()));
