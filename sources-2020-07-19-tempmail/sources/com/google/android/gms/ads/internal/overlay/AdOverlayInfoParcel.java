...
public final class AdOverlayInfoParcel extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        SafeParcelWriter.k(parcel, 3, ObjectWrapper.b0(this.zzcgl).asBinder(), false);
        SafeParcelWriter.k(parcel, 4, ObjectWrapper.b0(this.zzdoe).asBinder(), false);
        SafeParcelWriter.k(parcel, 5, ObjectWrapper.b0(this.zzdfp).asBinder(), false);
        SafeParcelWriter.k(parcel, 6, ObjectWrapper.b0(this.zzddj).asBinder(), false);
        ...
        SafeParcelWriter.k(parcel, 10, ObjectWrapper.b0(this.zzdoi).asBinder(), false);
        ...
        SafeParcelWriter.k(parcel, 18, ObjectWrapper.b0(this.zzddi).asBinder(), false);
    ...
    AdOverlayInfoParcel(@SafeParcelable.Param(id = 2) zzd zzd, @SafeParcelable.Param(id = 3) IBinder iBinder, @SafeParcelable.Param(id = 4) IBinder iBinder2, @SafeParcelable.Param(id = 5) IBinder iBinder3, @SafeParcelable.Param(id = 6) IBinder iBinder4, @SafeParcelable.Param(id = 7) String str, @SafeParcelable.Param(id = 8) boolean z, @SafeParcelable.Param(id = 9) String str2, @SafeParcelable.Param(id = 10) IBinder iBinder5, @SafeParcelable.Param(id = 11) int i, @SafeParcelable.Param(id = 12) int i2, @SafeParcelable.Param(id = 13) String str3, @SafeParcelable.Param(id = 14) zzbbd zzbbd, @SafeParcelable.Param(id = 16) String str4, @SafeParcelable.Param(id = 17) zzg zzg, @SafeParcelable.Param(id = 18) IBinder iBinder6) {
        this.zzdod = zzd;
        this.zzcgl = (zzuu) ObjectWrapper.P(IObjectWrapper.Stub.E(iBinder));
        this.zzdoe = (zzo) ObjectWrapper.P(IObjectWrapper.Stub.E(iBinder2));
        this.zzdfp = (zzbfn) ObjectWrapper.P(IObjectWrapper.Stub.E(iBinder3));
        this.zzddi = (zzagi) ObjectWrapper.P(IObjectWrapper.Stub.E(iBinder6));
        this.zzddj = (zzagk) ObjectWrapper.P(IObjectWrapper.Stub.E(iBinder4));
        this.zzdof = str;
        this.zzdog = z;
        this.zzdoh = str2;
        this.zzdoi = (zzt) ObjectWrapper.P(IObjectWrapper.Stub.E(iBinder5));
        this.orientation = i;
        this.zzdoj = i2;
        this.url = str3;
        this.zzboy = zzbbd;
