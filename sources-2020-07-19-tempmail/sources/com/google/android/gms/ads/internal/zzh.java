...
public final class zzh implements zzdw, Runnable {
    ...
    public zzh(Context context, zzbbd zzbbd) {
        ...
        if (intValue == 1) {
            this.zzxn = zzcw.f7622b;
        } else if (intValue != 2) {
            this.zzxn = zzcw.f7621a;
        } else {
            this.zzxn = zzcw.f7623c;
        }
        if (((Boolean) zzwg.e().c(zzaav.k1)).booleanValue()) {
            zzbbf.f6137a.execute(this);
            return;
        }
        zzwg.a();
        if (zzbaq.y()) {
    ...
    public final void run() {
        boolean z = false;
        try {
            boolean z2 = this.zzbov.f6134e;
            if (!((Boolean) zzwg.e().c(zzaav.u0)).booleanValue() && z2) {
                z = true;
            }
            if (this.zzxn != zzcw.f7622b) {
                this.zzbot.set(zzed.s(this.zzbov.f6131b, zze(this.zzvr), z, this.zzxn));
            }
            if (this.zzxn != zzcw.f7621a) {
                this.zzbou.set(zzdp.c(this.zzbov.f6131b, zze(this.zzvr), z));
            }
        } finally {
    ...
    public final String zzb(Context context) {
        ...
        int i = this.zzxn;
        if (i == zzcw.f7622b || i == zzcw.f7623c) {
            zzdw = this.zzbou.get();
        } else {
            zzdw = this.zzbot.get();
        }
