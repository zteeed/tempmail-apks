...
public final class NativeAppInstallAdView extends NativeAdView {
    ...
    public final View getBodyView() {
        return super.zzbm(NativeAppInstallAd.ASSET_BODY);
    }

    public final View getCallToActionView() {
        return super.zzbm(NativeAppInstallAd.ASSET_CALL_TO_ACTION);
    }

    public final View getHeadlineView() {
        return super.zzbm(NativeAppInstallAd.ASSET_HEADLINE);
    }

    public final View getIconView() {
        return super.zzbm(NativeAppInstallAd.ASSET_ICON);
    }

    public final View getImageView() {
        return super.zzbm(NativeAppInstallAd.ASSET_IMAGE);
    }

    public final MediaView getMediaView() {
        View zzbm = super.zzbm(NativeAppInstallAd.ASSET_MEDIA_VIDEO);
    ...
    public final View getPriceView() {
        return super.zzbm(NativeAppInstallAd.ASSET_PRICE);
    }

    public final View getStarRatingView() {
        return super.zzbm(NativeAppInstallAd.ASSET_STAR_RATING);
    }

    public final View getStoreView() {
        return super.zzbm(NativeAppInstallAd.ASSET_STORE);
    }
