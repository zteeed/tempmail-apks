...
public final class UnifiedNativeAdView extends FrameLayout {
    ...
    public final void setClickConfirmingView(View view) {
        try {
            this.zzbnn.I(ObjectWrapper.b0(view));
        } catch (RemoteException e2) {
    ...
    public final void setNativeAd(UnifiedNativeAd unifiedNativeAd) {
        try {
            this.zzbnn.z((IObjectWrapper) unifiedNativeAd.zzjr());
        } catch (RemoteException e2) {
    ...
    public final /* synthetic */ void zza(ImageView.ScaleType scaleType) {
        if (scaleType != null) {
            try {
                this.zzbnn.b3(ObjectWrapper.b0(scaleType));
            } catch (RemoteException e2) {
    ...
    public final /* synthetic */ void zza(MediaContent mediaContent) {
        try {
            if (mediaContent instanceof zzzc) {
                this.zzbnn.j6(((zzzc) mediaContent).a());
            } else if (mediaContent == null) {
                this.zzbnn.j6((zzado) null);
            } else {
