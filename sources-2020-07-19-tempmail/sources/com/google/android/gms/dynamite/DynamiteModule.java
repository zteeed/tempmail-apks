...
public final class DynamiteModule {
    ...
    private static Boolean f3200b = null;
    @GuardedBy("DynamiteModule.class")

    /* renamed from: c  reason: collision with root package name */
    private static zzi f3201c = null;
    @GuardedBy("DynamiteModule.class")

    /* renamed from: d  reason: collision with root package name */
    private static zzk f3202d = null;
    @GuardedBy("DynamiteModule.class")

    /* renamed from: e  reason: collision with root package name */
    private static String f3203e = null;
    @GuardedBy("DynamiteModule.class")

    /* renamed from: f  reason: collision with root package name */
    private static int f3204f = -1;
    ...
    public static DynamiteModule e(Context context, VersionPolicy versionPolicy, String str) throws LoadingException {
        ...
        try {
            ...
            if (a2.f3208c == 0 || ((a2.f3208c == -1 && a2.f3206a == 0) || (a2.f3208c == 1 && a2.f3207b == 0))) {
                int i4 = a2.f3206a;
                int i5 = a2.f3207b;
                ...
                DynamiteModule g2 = g(context, str, a2.f3207b);
                Cursor cursor2 = aVar2.f3209a;
                if (cursor2 != null) {
                    cursor2.close();
                }
                g.set(aVar);
    ...
    public static int f(android.content.Context r8, java.lang.String r9, boolean r10) {
        /*
            ...
            java.lang.Boolean r1 = f3200b     // Catch:{ all -> 0x00ed }
        ...
        L_0x0052:
            ...
            java.lang.String r5 = f3203e     // Catch:{ LoadingException -> 0x007e }
        ...
        L_0x0063:
            ...
            java.lang.String r6 = f3203e     // Catch:{ LoadingException -> 0x007e }
            ...
            f3200b = r5     // Catch:{ LoadingException -> 0x007e }
    ...
    private static DynamiteModule g(Context context, String str, int i2) throws LoadingException {
        ...
        try {
            ...
            if (bool == null) {
                ...
                if (n != null) {
                    if (n.Y5() >= 2) {
                        iObjectWrapper = n.L4(ObjectWrapper.b0(context), str, i2);
                    } else {
                        Log.w("DynamiteModule", "Dynamite loader version < 2, falling back to createModuleContext");
                        iObjectWrapper = n.m2(ObjectWrapper.b0(context), str, i2);
                    }
                    if (ObjectWrapper.P(iObjectWrapper) != null) {
                        return new DynamiteModule((Context) ObjectWrapper.P(iObjectWrapper));
                    }
    ...
    private static Boolean i() {
        Boolean valueOf;
        synchronized (DynamiteModule.class) {
            valueOf = Boolean.valueOf(f3204f >= 2);
        }
        return valueOf;
    }
    ...
    private static int j(Context context, String str, boolean z) {
        ...
        try {
            if (n.Y5() >= 2) {
                return n.A3(ObjectWrapper.b0(context), str, z);
            }
            Log.w("DynamiteModule", "IDynamite loader version < 2, falling back to getModuleVersion2");
            return n.u4(ObjectWrapper.b0(context), str, z);
        } catch (RemoteException e2) {
            String valueOf = String.valueOf(e2.getMessage());
    ...
    private static DynamiteModule k(Context context, String str, int i2) throws LoadingException, RemoteException {
        ...
        if (zzk != null) {
            ...
            Cursor cursor = aVar.f3209a;
            ObjectWrapper.b0(null);
            if (i().booleanValue()) {
                Log.v("DynamiteModule", "Dynamite loader version >= 2, using loadModule2NoCrashUtils");
                iObjectWrapper = zzk.c1(ObjectWrapper.b0(applicationContext), str, i2, ObjectWrapper.b0(cursor));
            } else {
                Log.w("DynamiteModule", "Dynamite loader version < 2, falling back to loadModule2");
                iObjectWrapper = zzk.W0(ObjectWrapper.b0(applicationContext), str, i2, ObjectWrapper.b0(cursor));
            }
            Context context2 = (Context) ObjectWrapper.P(iObjectWrapper);
            if (context2 != null) {
    ...
    private static int l(android.content.Context r8, java.lang.String r9, boolean r10) throws com.google.android.gms.dynamite.DynamiteModule.LoadingException {
        ...
        L_0x0067:
            ...
            android.database.Cursor r1 = r10.f3209a     // Catch:{ Exception -> 0x0096, all -> 0x0092 }
            if (r1 != 0) goto L_0x007c
            r10.f3209a = r8     // Catch:{ Exception -> 0x0096, all -> 0x0092 }
            goto L_0x007d
        L_0x0079:
            r9 = move-exception
            monitor-exit(r10)     // Catch:{ all -> 0x0079 }
    ...
    public final IBinder d(String str) throws LoadingException {
        try {
            return (IBinder) this.f3205a.getClassLoader().loadClass(str).newInstance();
