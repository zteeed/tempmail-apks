...
public class zzaf {
    ...
    private Map<String, Object> f3301b = new a();

    /* renamed from: c  reason: collision with root package name */
    private Messenger f3302c;

    /* renamed from: d  reason: collision with root package name */
    private Messenger f3303d;

    /* renamed from: e  reason: collision with root package name */
    private MessengerCompat f3304e;

    /* renamed from: f  reason: collision with root package name */
    private PendingIntent f3305f;
    ...
    private final void c(String str, Object obj) {
        synchronized (zzaf.class) {
            Object obj2 = this.f3301b.get(str);
            this.f3301b.put(str, obj);
            b(obj2, obj);
        }
    }
    ...
    private final synchronized void g(Intent intent) {
        if (this.f3305f == null) {
            ...
            this.f3305f = PendingIntent.getBroadcast(this.f3300a, 0, intent2, 0);
        }
        intent.putExtra("app", this.f3305f);
    }
    ...
    private final android.os.Bundle k(android.os.Bundle r10) throws java.io.IOException {
        /*
            ...
            monitor-enter(r0)
            java.util.Map<java.lang.String, java.lang.Object> r3 = r9.f3301b     // Catch:{ all -> 0x01d6 }
            r3.put(r2, r1)     // Catch:{ all -> 0x01d6 }
            monitor-exit(r0)     // Catch:{ all -> 0x01d6 }
            android.os.Messenger r3 = r9.f3302c
            if (r3 != 0) goto L_0x002b
            android.content.Context r3 = r9.f3300a
            l(r3)
        ...
        L_0x00d9:
            android.os.Messenger r4 = r9.f3303d
            if (r4 == 0) goto L_0x0101
            java.lang.String r4 = "google.messenger"
            android.os.Messenger r6 = r9.f3302c
            r3.putExtra(r4, r6)
            android.os.Message r4 = android.os.Message.obtain()
            r4.obj = r3
            android.os.Messenger r6 = r9.f3303d     // Catch:{ RemoteException -> 0x00f1 }
        ...
        L_0x011e:
            ...
            android.content.Context r4 = r9.f3300a     // Catch:{ all -> 0x013f }
        ...
        L_0x0138:
            ...
            android.content.Context r10 = r9.f3300a
        ...
        L_0x0142:
            ...
            android.os.Messenger r4 = r9.f3302c
            r3.putExtra(r10, r4)
            java.lang.String r10 = "messenger2"
            java.lang.String r4 = "1"
            r3.putExtra(r10, r4)
            com.google.android.gms.iid.MessengerCompat r10 = r9.f3304e
            if (r10 == 0) goto L_0x0170
            android.os.Message r10 = android.os.Message.obtain()
            r10.obj = r3
            com.google.android.gms.iid.MessengerCompat r4 = r9.f3304e     // Catch:{ RemoteException -> 0x0160 }
        ...
        L_0x017f:
            ...
            r1.block(r3)
            monitor-enter(r0)
            java.util.Map<java.lang.String, java.lang.Object> r10 = r9.f3301b     // Catch:{ all -> 0x01cb }
    ...
    public final Bundle a(Bundle bundle, KeyPair keyPair) throws IOException {
        ...
        bundle.putString("app_ver", Integer.toString(InstanceID.h(this.f3300a)));
        bundle.putString("app_ver_name", InstanceID.i(this.f3300a));
        ...
        try {
            return (Bundle) Tasks.a(new zzr(this.f3300a).b(1, bundle));
            ...
            if (obj instanceof Intent) {
                ...
                if (intent.hasExtra("google.messenger")) {
                    ...
                    if (parcelableExtra instanceof MessengerCompat) {
                        this.f3304e = (MessengerCompat) parcelableExtra;
                    }
                    if (parcelableExtra instanceof Messenger) {
                        this.f3303d = (Messenger) parcelableExtra;
                    }
                }
        ...
        if (intent != null) {
            ...
            if ("com.google.android.c2dm.intent.REGISTRATION".equals(action) || "com.google.android.gms.iid.InstanceID".equals(action)) {
                ...
                if (stringExtra == null) {
                    ...
                    if (str2 == null) {
                        synchronized (zzaf.class) {
                            for (String next : this.f3301b.keySet()) {
                                Object obj = this.f3301b.get(next);
                                this.f3301b.put(next, stringExtra2);
                                b(obj, stringExtra2);
                            }
                        }
                        return;
