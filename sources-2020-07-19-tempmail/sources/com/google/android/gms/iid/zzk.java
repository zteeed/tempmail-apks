...
public final class zzk implements ServiceConnection {
    ...
    private final Intent f3318b;

    /* renamed from: c  reason: collision with root package name */
    private final ScheduledExecutorService f3319c;

    /* renamed from: d  reason: collision with root package name */
    private final Queue<h> f3320d;
    ...
    private final synchronized void b() {
        ...
        L_0x0011:
            java.util.Queue<com.google.android.gms.iid.h> r0 = r6.f3320d     // Catch:{ all -> 0x00ab }
            ...
            android.util.Log.d(r0, r2)     // Catch:{ all -> 0x00ab }
        L_0x0028:
            com.google.android.gms.iid.zzi r0 = r6.f3321e     // Catch:{ all -> 0x00ab }
        ...
        L_0x0043:
            ...
            com.google.android.gms.iid.zzi r2 = r6.f3321e     // Catch:{ all -> 0x00ab }
        ...
        L_0x0051:
            ...
            java.lang.String r0 = "EnhancedIntentService"
            boolean r3 = r6.f3322f     // Catch:{ all -> 0x00ab }
        ...
        L_0x007a:
            boolean r0 = r6.f3322f     // Catch:{ all -> 0x00ab }
            if (r0 != 0) goto L_0x00a7
            r6.f3322f = r2     // Catch:{ all -> 0x00ab }
            ...
            android.content.Context r2 = r6.f3317a     // Catch:{ SecurityException -> 0x009a }
            android.content.Intent r3 = r6.f3318b     // Catch:{ SecurityException -> 0x009a }
            r4 = 65
    ...
    public final synchronized void a(Intent intent, BroadcastReceiver.PendingResult pendingResult) {
        ...
        this.f3320d.add(new h(intent, pendingResult, this.f3319c));
        b();
    }
    ...
    private zzk(Context context, String str, ScheduledExecutorService scheduledExecutorService) {
        this.f3320d = new ArrayDeque();
        this.f3322f = false;
        this.f3317a = context.getApplicationContext();
        this.f3318b = new Intent(str).setPackage(this.f3317a.getPackageName());
        this.f3319c = scheduledExecutorService;
    }
}
