...
public final class zzak {
    ...
    private SharedPreferences f3307a;
    ...
    private final Map<String, l> f3310d;
    ...
    public final synchronized String a(String str) {
        return this.f3307a.getString(str, (String) null);
    }

    public final boolean b() {
        return this.f3307a.getAll().isEmpty();
    }
    ...
    public final synchronized String f(String str, String str2, String str3) {
        return this.f3307a.getString(c(str, str2, str3), (String) null);
    }

    /* access modifiers changed from: package-private */
    public final synchronized long g(String str, String str2, String str3) {
        return this.f3307a.getLong(e(str, str2, str3), -1);
    }

    public final synchronized void i(String str) {
        SharedPreferences.Editor edit = this.f3307a.edit();
        for (String next : this.f3307a.getAll().keySet()) {
    ...
    public final synchronized l j(String str) {
        l lVar;
        l lVar2 = this.f3310d.get(str);
        if (lVar2 != null) {
            return lVar2;
        }
        try {
            lVar = this.f3309c.g(this.f3308b, str);
        } catch (m unused) {
            Log.w("InstanceID/Store", "Stored data is corrupt, generating new identity");
            InstanceIDListenerService.d(this.f3308b, this);
            lVar = this.f3309c.i(this.f3308b, str);
        }
        this.f3310d.put(str, lVar);
        return lVar;
    }
    ...
    private zzak(Context context, k kVar) {
        this.f3310d = new a();
        this.f3308b = context;
        this.f3307a = context.getSharedPreferences("com.google.android.gms.appid", 0);
        this.f3309c = kVar;
        File file = new File(androidx.core.content.a.i(this.f3308b), "com.google.android.gms.appid-no-backup");
        if (!file.exists()) {
            try {
