...
public class InstanceID {
    ...
    private static final zzaj<Boolean> f3258c = zzai.b().a("gcm_check_for_different_iid_in_token", true);

    /* renamed from: d  reason: collision with root package name */
    private static Map<String, InstanceID> f3259d = new a();

    /* renamed from: e  reason: collision with root package name */
    private static final long f3260e = TimeUnit.DAYS.toMillis(7);

    /* renamed from: f  reason: collision with root package name */
    private static zzak f3261f;
    ...
    public String e(String str, String str2, Bundle bundle) throws IOException {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            String str3 = null;
            String a2 = f3261f.a("appVersion");
            boolean z = true;
            if (a2 != null && a2.equals(h)) {
                long g2 = f3261f.g(this.f3263b, str, str2);
                if (g2 >= 0 && System.currentTimeMillis() - g2 < f3260e) {
                    z = false;
                }
            }
            if (!z) {
                str3 = f3261f.f(this.f3263b, str, str2);
            }
            if (str3 != null) {
                return str3;
            }
            ...
            if (!f3258c.get().booleanValue() || !g3.contains(":") || g3.startsWith(String.valueOf(a()).concat(":"))) {
                if (g3 != null) {
                    f3261f.d(this.f3263b, str, str2, g3, h);
                }
                return g3;
            }
            InstanceIDListenerService.d(this.f3262a, f3261f);
    ...
    public final String g(String str, String str2, Bundle bundle) throws IOException {
        ...
        String str3 = "".equals(this.f3263b) ? str : this.f3263b;
