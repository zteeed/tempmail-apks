...
final class p implements ServiceConnection {
    ...
    final Queue<w<?>> f3285d;
    @GuardedBy("this")

    /* renamed from: e  reason: collision with root package name */
    final SparseArray<w<?>> f3286e;

    /* renamed from: f  reason: collision with root package name */
    final /* synthetic */ zzr f3287f;

    private p(zzr zzr) {
        this.f3287f = zzr;
        this.f3282a = 0;
        this.f3283b = new Messenger(new zzj(Looper.getMainLooper(), new q(this)));
        this.f3285d = new ArrayDeque();
        this.f3286e = new SparseArray<>();
    }

    private final void e() {
        this.f3287f.f3324b.execute(new t(this));
    }
    ...
    public final synchronized void a(int i, String str) {
        ...
        if (i2 == 0) {
            ...
            this.f3282a = 4;
            ConnectionTracker.b().c(this.f3287f.f3323a, this);
            zzaa zzaa = new zzaa(i, str);
            for (w a2 : this.f3285d) {
                a2.a(zzaa);
            }
            this.f3285d.clear();
            for (int i3 = 0; i3 < this.f3286e.size(); i3++) {
                this.f3286e.valueAt(i3).a(zzaa);
            }
            this.f3286e.clear();
        } else if (i2 == 3) {
            this.f3282a = 4;
    ...
    public final boolean b(android.os.Message r5) {
        ...
        L_0x0023:
            monitor-enter(r4)
            android.util.SparseArray<com.google.android.gms.iid.w<?>> r1 = r4.f3286e     // Catch:{ all -> 0x006f }
            ...
            return r2
        L_0x0049:
            android.util.SparseArray<com.google.android.gms.iid.w<?>> r3 = r4.f3286e     // Catch:{ all -> 0x006f }
    ...
    public final synchronized boolean c(com.google.android.gms.iid.w r6) {
        /*
            r5 = this;
            monitor-enter(r5)
            int r0 = r5.f3282a     // Catch:{ all -> 0x0097 }
            r1 = 2
            r2 = 0
            r3 = 1
        ...
        L_0x002e:
            ...
            return r2
        L_0x0030:
            java.util.Queue<com.google.android.gms.iid.w<?>> r0 = r5.f3285d     // Catch:{ all -> 0x0097 }
        ...
        L_0x0041:
            java.util.Queue<com.google.android.gms.iid.w<?>> r0 = r5.f3285d     // Catch:{ all -> 0x0097 }
            r0.add(r6)     // Catch:{ all -> 0x0097 }
            int r6 = r5.f3282a     // Catch:{ all -> 0x0097 }
        ...
        L_0x005f:
            ...
            com.google.android.gms.iid.zzr r1 = r5.f3287f     // Catch:{ all -> 0x0097 }
            android.content.Context r1 = r1.f3323a     // Catch:{ all -> 0x0097 }
            ...
            goto L_0x0095
        L_0x0083:
            com.google.android.gms.iid.zzr r6 = r5.f3287f     // Catch:{ all -> 0x0097 }
            java.util.concurrent.ScheduledExecutorService r6 = r6.f3324b     // Catch:{ all -> 0x0097 }
    ...
    public final synchronized void d(int i) {
        w wVar = this.f3286e.get(i);
        if (wVar != null) {
            StringBuilder sb = new StringBuilder(31);
            sb.append("Timing out request: ");
            sb.append(i);
            Log.w("MessengerIpcClient", sb.toString());
            this.f3286e.remove(i);
    ...
    public final synchronized void f() {
        if (this.f3282a == 2 && this.f3285d.isEmpty() && this.f3286e.size() == 0) {
            if (Log.isLoggable("MessengerIpcClient", 2)) {
