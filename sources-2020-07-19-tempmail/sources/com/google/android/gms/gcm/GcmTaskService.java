...
public abstract class GcmTaskService extends Service {
    ...
    private ExecutorService f3218d;

    /* renamed from: e  reason: collision with root package name */
    private Messenger f3219e;
    /* access modifiers changed from: private */

    /* renamed from: f  reason: collision with root package name */
    public ComponentName f3220f;
    /* access modifiers changed from: private */
    ...
    private final void d(int i) {
        synchronized (this.f3216b) {
            this.f3217c = i;
            if (!this.g.j(this.f3220f.getClassName())) {
                stopSelf(this.f3217c);
            }
        }
    }
    ...
    public final boolean k(String str) {
        boolean z;
        synchronized (this.f3216b) {
            z = !this.g.f(str, this.f3220f.getClassName());
            if (z) {
    ...
    public IBinder onBind(Intent intent) {
        ...
        return this.f3219e.getBinder();
    }

    public void onCreate() {
        super.onCreate();
        this.g = GcmNetworkManager.b(this);
        this.f3218d = zzg.a().a(10, new b(this), 10);
        this.f3219e = new Messenger(new a(Looper.getMainLooper()));
        this.f3220f = new ComponentName(this, getClass());
        zzm.a();
        getClass();
        this.h = zzm.f9311a;
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        List<Runnable> shutdownNow = this.f3218d.shutdownNow();
        ...
        try {
            ...
            if ("com.google.android.gms.gcm.ACTION_TASK_READY".equals(action)) {
                ...
                if (!(parcelableExtra instanceof PendingCallback)) {
                    ...
                    e(new b(stringExtra, ((PendingCallback) parcelableExtra).f3230b, bundleExtra, longExtra, (List<Uri>) parcelableArrayListExtra));
                }
    ...
    class b implements Runnable {
        ...
        /* renamed from: c  reason: collision with root package name */
        private final Bundle f3223c;

        /* renamed from: d  reason: collision with root package name */
        private final List<Uri> f3224d;

        /* renamed from: e  reason: collision with root package name */
        private final long f3225e;

        /* renamed from: f  reason: collision with root package name */
        private final zzg f3226f;
        ...
        public final void c(int r6) {
            /*
                ...
                java.lang.String r2 = r5.f3222b     // Catch:{ RemoteException -> 0x00d0 }
                com.google.android.gms.gcm.GcmTaskService r3 = com.google.android.gms.gcm.GcmTaskService.this     // Catch:{ RemoteException -> 0x00d0 }
                android.content.ComponentName r3 = r3.f3220f     // Catch:{ RemoteException -> 0x00d0 }
                ...
                android.content.ComponentName r1 = r1.f3220f     // Catch:{ all -> 0x0169 }
                java.lang.String r1 = r1.getClassName()     // Catch:{ all -> 0x0169 }
                boolean r6 = r6.j(r1)     // Catch:{ all -> 0x0169 }
                if (r6 != 0) goto L_0x005b
                com.google.android.gms.gcm.GcmTaskService r6 = com.google.android.gms.gcm.GcmTaskService.this     // Catch:{ all -> 0x0169 }
                com.google.android.gms.gcm.GcmTaskService r1 = com.google.android.gms.gcm.GcmTaskService.this     // Catch:{ all -> 0x0169 }
                int r1 = r1.f3217c     // Catch:{ all -> 0x0169 }
            ...
            L_0x005d:
                ...
                android.content.ComponentName r4 = r4.f3220f     // Catch:{ RemoteException -> 0x00d0 }
                r6.putParcelable(r3, r4)     // Catch:{ RemoteException -> 0x00d0 }
                java.lang.String r3 = "tag"
                java.lang.String r4 = r5.f3222b     // Catch:{ RemoteException -> 0x00d0 }
                ...
                goto L_0x0091
            L_0x008c:
                com.google.android.gms.gcm.zzg r1 = r5.f3226f     // Catch:{ RemoteException -> 0x00d0 }
                r1.K1(r6)     // Catch:{ RemoteException -> 0x00d0 }
            L_0x0091:
                com.google.android.gms.gcm.GcmTaskService r6 = com.google.android.gms.gcm.GcmTaskService.this     // Catch:{ all -> 0x0169 }
                com.google.android.gms.gcm.GcmNetworkManager r6 = r6.g     // Catch:{ all -> 0x0169 }
                java.lang.String r1 = r5.f3222b     // Catch:{ all -> 0x0169 }
            ...
            L_0x00d0:
                ...
                java.lang.String r2 = r5.f3222b     // Catch:{ all -> 0x00ce }
            ...
            L_0x012c:
                ...
                com.google.android.gms.gcm.GcmTaskService r1 = com.google.android.gms.gcm.GcmTaskService.this     // Catch:{ all -> 0x0169 }
                com.google.android.gms.gcm.GcmTaskService r2 = com.google.android.gms.gcm.GcmTaskService.this     // Catch:{ all -> 0x0169 }
                int r2 = r2.f3217c     // Catch:{ all -> 0x0169 }
        ...
        public final void run() {
            ...
            L_0x001a:
                ...
                java.lang.String r3 = r8.f3222b     // Catch:{ all -> 0x004a }
                android.os.Bundle r4 = r8.f3223c     // Catch:{ all -> 0x004a }
                long r5 = r8.f3225e     // Catch:{ all -> 0x004a }
                java.util.List<android.net.Uri> r7 = r8.f3224d     // Catch:{ all -> 0x004a }
                r2 = r1
                ...
                int r4 = com.google.android.gms.internal.gcm.zzp.f9314a     // Catch:{ all -> 0x004a }
