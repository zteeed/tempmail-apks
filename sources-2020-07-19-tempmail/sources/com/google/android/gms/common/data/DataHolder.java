...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    private Bundle f2936d;
    @SafeParcelable.Field

    /* renamed from: e  reason: collision with root package name */
    private final CursorWindow[] f2937e;
    @SafeParcelable.Field
    ...
    DataHolder(@SafeParcelable.Param(id = 1000) int i2, @SafeParcelable.Param(id = 1) String[] strArr, @SafeParcelable.Param(id = 2) CursorWindow[] cursorWindowArr, @SafeParcelable.Param(id = 3) int i3, @SafeParcelable.Param(id = 4) Bundle bundle) {
        this.f2934b = i2;
        this.f2935c = strArr;
        this.f2937e = cursorWindowArr;
        this.f2938f = i3;
        this.g = bundle;
    }

    private final void J(String str, int i2) {
        Bundle bundle = this.f2936d;
    ...
    public final String B(String str, int i2, int i3) {
        J(str, i2);
        return this.f2937e[i3].getString(i2, this.f2936d.getInt(str));
    }
    ...
    public final void K() {
        ...
        int i3 = 0;
        while (true) {
            String[] strArr = this.f2935c;
            if (i3 >= strArr.length) {
                break;
            }
            this.f2936d.putInt(strArr[i3], i3);
            i3++;
        }
        this.h = new int[this.f2937e.length];
        int i4 = 0;
        while (true) {
            CursorWindow[] cursorWindowArr = this.f2937e;
            if (i2 < cursorWindowArr.length) {
                this.h[i2] = i4;
                i4 += this.f2937e[i2].getNumRows() - (i4 - cursorWindowArr[i2].getStartPosition());
                i2++;
            } else {
                this.i = i4;
                return;
    ...
    public final void close() {
        synchronized (this) {
            if (!this.j) {
                this.j = true;
                for (CursorWindow close : this.f2937e) {
                    close.close();
                }
            }
        }
    ...
    public final void finalize() throws Throwable {
        try {
            if (this.k && this.f2937e.length > 0 && !isClosed()) {
                close();
                String obj = toString();
    ...
    public final byte[] u(String str, int i2, int i3) {
        J(str, i2);
        return this.f2937e[i3].getBlob(i2, this.f2936d.getInt(str));
    }
    ...
    public final void writeToParcel(Parcel parcel, int i2) {
        ...
        SafeParcelWriter.u(parcel, 1, this.f2935c, false);
        SafeParcelWriter.w(parcel, 2, this.f2937e, i2, false);
        SafeParcelWriter.l(parcel, 3, A());
        SafeParcelWriter.e(parcel, 4, v(), false);
        SafeParcelWriter.l(parcel, 1000, this.f2934b);
