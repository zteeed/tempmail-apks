...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    private static final GoogleApiAvailability f2664e = new GoogleApiAvailability();
    ...
    private class a extends zap {
        ...
        public final void handleMessage(Message message) {
            ...
            int i2 = GoogleApiAvailability.this.i(this.f2666a);
            if (GoogleApiAvailability.this.m(i2)) {
                GoogleApiAvailability.this.s(this.f2666a, i2);
            }
        }
    }
    ...
    static void w(Activity activity, Dialog dialog, String str, DialogInterface.OnCancelListener onCancelListener) {
        if (activity instanceof c) {
            SupportErrorDialogFragment.s2(dialog, onCancelListener).r2(((c) activity).k0(), str);
            return;
        }
