...
public final class GmsClientEventManager implements Handler.Callback {
    ...
    private final GmsClientEventState f2999b;

    /* renamed from: c  reason: collision with root package name */
    private final ArrayList<GoogleApiClient.ConnectionCallbacks> f3000c;
    @VisibleForTesting

    /* renamed from: d  reason: collision with root package name */
    private final ArrayList<GoogleApiClient.ConnectionCallbacks> f3001d;

    /* renamed from: e  reason: collision with root package name */
    private final ArrayList<GoogleApiClient.OnConnectionFailedListener> f3002e;
    ...
    public final void c(com.google.android.gms.common.ConnectionResult r8) {
        /*
            ...
            java.util.ArrayList<com.google.android.gms.common.api.GoogleApiClient$OnConnectionFailedListener> r2 = r7.f3002e     // Catch:{ all -> 0x0049 }
        ...
        L_0x0022:
            ...
            boolean r6 = r7.f3003f     // Catch:{ all -> 0x0049 }
            ...
            goto L_0x0045
        L_0x0039:
            java.util.ArrayList<com.google.android.gms.common.api.GoogleApiClient$OnConnectionFailedListener> r6 = r7.f3002e     // Catch:{ all -> 0x0049 }
            boolean r6 = r6.contains(r5)     // Catch:{ all -> 0x0049 }
            if (r6 == 0) goto L_0x0022
            r5.b0(r8)     // Catch:{ all -> 0x0049 }
            goto L_0x0022
        L_0x0045:
    ...
    public final void d(Bundle bundle) {
        ...
        synchronized (this.j) {
            ...
            while (i3 < size) {
                ...
                if (!this.f3003f || !this.f2999b.isConnected() || this.g.get() != i2) {
                    break;
                } else if (!this.f3001d.contains(connectionCallbacks)) {
    ...
    public final void e(int i2) {
        ...
        synchronized (this.j) {
            ...
            while (i4 < size) {
                ...
                i4++;
                GoogleApiClient.ConnectionCallbacks connectionCallbacks = (GoogleApiClient.ConnectionCallbacks) obj;
                if (!this.f3003f || this.g.get() != i3) {
                    break;
                } else if (this.f3000c.contains(connectionCallbacks)) {
    ...
    public final void f(GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
        ...
        synchronized (this.j) {
            if (!this.f3002e.remove(onConnectionFailedListener)) {
    ...
    public final boolean handleMessage(Message message) {
        ...
        if (i2 == 1) {
            ...
            synchronized (this.j) {
                if (this.f3003f && this.f2999b.isConnected() && this.f3000c.contains(connectionCallbacks)) {
                    connectionCallbacks.E(this.f2999b.getConnectionHint());
                }
            }
            return true;
        }
