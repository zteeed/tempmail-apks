...
public abstract class BaseGmsClient<T extends IInterface> {
    ...
    protected class LegacyClientCallbackAdapter implements ConnectionProgressReportCallbacks {
        ...
        public void a(ConnectionResult connectionResult) {
            if (connectionResult.G()) {
                ...
                BaseGmsClient.this.zzcl.b0(connectionResult);
            }
        }
    }
    ...
    private abstract class a extends zzc<Boolean> {
        ...
        public final /* synthetic */ void c(java.lang.Object r5) {
            ...
            L_0x000c:
                ...
                com.google.android.gms.common.internal.BaseGmsClient r5 = com.google.android.gms.common.internal.BaseGmsClient.this
                r5.zza((int) r0, null)
                android.os.Bundle r5 = r4.f2965e
    ...
    protected abstract class zzc<TListener> {
        ...
        private TListener f2968a;

        /* renamed from: b  reason: collision with root package name */
        private boolean f2969b = false;

        public zzc(TListener tlistener) {
            this.f2968a = tlistener;
        }
    ...
    public static final class zzd extends IGmsCallbacks.zza {
        ...
        /* renamed from: b  reason: collision with root package name */
        private BaseGmsClient f2971b;

        /* renamed from: c  reason: collision with root package name */
        private final int f2972c;

        public zzd(BaseGmsClient baseGmsClient, int i) {
            this.f2971b = baseGmsClient;
            this.f2972c = i;
        }

        public final void J2(int i, IBinder iBinder, zzb zzb) {
            Preconditions.l(this.f2971b, "onPostInitCompleteWithConnectionInfo can be called only once per call togetRemoteService");
            Preconditions.k(zzb);
            this.f2971b.zza(zzb);
            x3(i, iBinder, zzb.f3061b);
        }
        ...
        public final void x3(int i, IBinder iBinder, Bundle bundle) {
            Preconditions.l(this.f2971b, "onPostInitComplete can be called only once per call to getRemoteService");
            this.f2971b.onPostInitHandler(i, iBinder, bundle, this.f2972c);
            this.f2971b = null;
        }
    }
    ...
    public final class zze implements ServiceConnection {
        ...
        public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            BaseGmsClient.this.zza(0, (Bundle) null, this.f2973a);
        }
        ...
        public final void onServiceDisconnected(ComponentName componentName) {
            ...
            handler.sendMessage(handler.obtainMessage(6, this.f2973a, 1));
        }
    }
    ...
    protected final class zzf extends a {
        ...
        public final boolean g() {
            try {
                ...
                BaseGmsClient.this.zzck.E(connectionHint);
                return true;
    ...
    protected final class zzg extends a {
        ...
        /* access modifiers changed from: protected */
        public final boolean g() {
            BaseGmsClient.this.zzcf.a(ConnectionResult.f2653f);
            return true;
        }
    }
    ...
    public int getMinApkVersion() {
        return GoogleApiAvailabilityLight.f2668a;
    }
    ...
    public void getRemoteService(IAccountAccessor iAccountAccessor, Set<Scope> set) {
        ...
        getServiceRequest.f2995e = this.mContext.getPackageName();
        ...
        if (requiresSignIn()) {
            ...
            if (iAccountAccessor != null) {
                getServiceRequest.f2996f = iAccountAccessor.asBinder();
            }
        ...
        try {
            synchronized (this.zzcd) {
                if (this.zzce != null) {
                    this.zzce.w1(new zzd(this, this.zzcr.get()), getServiceRequest);
                } else {
