...
public final class SignInButtonCreator extends RemoteCreator<ISignInButtonCreator> {
    ...
    private static final SignInButtonCreator f3035c = new SignInButtonCreator();
    ...
    private final View e(Context context, int i, int i2) throws RemoteCreator.RemoteCreatorException {
        try {
            ...
            return (View) ObjectWrapper.P(((ISignInButtonCreator) b(context)).Q2(ObjectWrapper.b0(context), signInButtonConfig));
        } catch (Exception e2) {
