...
public class GooglePlayServicesUtilLight {
    ...
    public static void ensurePlayServicesAvailable(Context context, int i) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
        ...
        if (j != 0) {
            Intent d2 = GoogleApiAvailabilityLight.h().d(context, j, "e");
            ...
            throw new GooglePlayServicesRepairableException(j, "Google Play Services not available", d2);
        }
    }
    ...
    public static Intent getGooglePlayServicesAvailabilityRecoveryIntent(int i) {
        return GoogleApiAvailabilityLight.h().d((Context) null, i, (String) null);
    }
    ...
    public static boolean honorsDebugCertificates(Context context) {
        if (!zzak) {
            try {
                ...
                if (e2 == null || GoogleSignatureVerifier.f(e2, false) || !GoogleSignatureVerifier.f(e2, true)) {
                    zzaj = false;
                } else {
                    zzaj = true;
                }
    ...
    public static boolean isRestrictedUserProfile(android.content.Context r1) {
        /*
            boolean r0 = com.google.android.gms.common.util.PlatformVersion.e()
    ...
    private static int zza(Context context, boolean z, int i) {
        ...
        try {
            ...
            if (!GoogleSignatureVerifier.f(packageInfo2, true)) {
                ...
                return 9;
            } else if (z && (!GoogleSignatureVerifier.f(packageInfo, true) || !packageInfo.signatures[0].equals(packageInfo2.signatures[0]))) {
                Log.w("GooglePlayServicesUtil", "Google Play Store signature invalid.");
                return 9;
            } else if (zzb.a(packageInfo2.versionCode) < zzb.a(i)) {
    ...
    public static int isGooglePlayServicesAvailable(Context context, int i) {
        ...
        if (!"com.google.android.gms".equals(context.getPackageName()) && !zzal.get()) {
            ...
            } else if (b2 != GOOGLE_PLAY_SERVICES_VERSION_CODE) {
        ...
        return zza(context, !DeviceProperties.e(context) && !DeviceProperties.f(context), i);
    }
}
