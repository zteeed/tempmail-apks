...
public abstract class zal extends LifecycleCallback implements DialogInterface.OnCancelListener {
    ...
    protected volatile boolean f2901c;

    /* renamed from: d  reason: collision with root package name */
    protected final AtomicReference<j0> f2902d;

    /* renamed from: e  reason: collision with root package name */
    private final Handler f2903e;

    /* renamed from: f  reason: collision with root package name */
    protected final GoogleApiAvailability f2904f;
    ...
    public void e(int r4, int r5, android.content.Intent r6) {
        /*
            r3 = this;
            java.util.concurrent.atomic.AtomicReference<com.google.android.gms.common.api.internal.j0> r0 = r3.f2902d
            ...
            goto L_0x0055
        L_0x0010:
            com.google.android.gms.common.GoogleApiAvailability r4 = r3.f2904f
        ...
        L_0x0040:
            ...
            int r4 = l(r0)
            r5.<init>(r6, r4)
            java.util.concurrent.atomic.AtomicReference<com.google.android.gms.common.api.internal.j0> r4 = r3.f2902d
            r4.set(r5)
            r0 = r5
        L_0x0055:
            r1 = 0
    ...
    public void f(Bundle bundle) {
        super.f(bundle);
        if (bundle != null) {
            this.f2902d.set(bundle.getBoolean("resolving_error", false) ? new j0(new ConnectionResult(bundle.getInt("failed_status"), (PendingIntent) bundle.getParcelable("failed_resolution")), bundle.getInt("failed_client_id", -1)) : null);
        }
    }

    public void i(Bundle bundle) {
        super.i(bundle);
        j0 j0Var = this.f2902d.get();
        if (j0Var != null) {
    ...
    public final void n(ConnectionResult connectionResult, int i) {
        ...
        if (this.f2902d.compareAndSet((Object) null, j0Var)) {
            this.f2903e.post(new k0(this, j0Var));
        }
    }
    ...
    public void onCancel(DialogInterface dialogInterface) {
        m(new ConnectionResult(13, (PendingIntent) null), l(this.f2902d.get()));
        p();
    }

    /* access modifiers changed from: protected */
    public final void p() {
        this.f2902d.set((Object) null);
        o();
    }
}
