...
final class n0 implements zabs {
    ...
    private final zaaw f2807c;
    /* access modifiers changed from: private */

    /* renamed from: d  reason: collision with root package name */
    public final zabe f2808d;
    /* access modifiers changed from: private */

    /* renamed from: e  reason: collision with root package name */
    public final zabe f2809e;

    /* renamed from: f  reason: collision with root package name */
    private final Map<Api.AnyClientKey<?>, zabe> f2810f;
    ...
    private n0(Context context, zaaw zaaw, Lock lock, Looper looper, GoogleApiAvailabilityLight googleApiAvailabilityLight, Map<Api.AnyClientKey<?>, Api.Client> map, Map<Api.AnyClientKey<?>, Api.Client> map2, ClientSettings clientSettings, Api.AbstractClientBuilder<? extends zad, SignInOptions> abstractClientBuilder, Api.Client client, ArrayList<zaq> arrayList, ArrayList<zaq> arrayList2, Map<Api<?>, Boolean> map3, Map<Api<?>, Boolean> map4) {
        ...
        this.f2808d = zabe;
        this.f2809e = new zabe(context2, this.f2807c, lock2, looper2, googleApiAvailabilityLight2, map, clientSettings, map3, abstractClientBuilder, arrayList, new q0(this, (o0) null));
        a aVar = new a();
        for (Api.AnyClientKey<?> put : map2.keySet()) {
            aVar.put(put, this.f2808d);
        }
        for (Api.AnyClientKey<?> put2 : map.keySet()) {
            aVar.put(put2, this.f2809e);
        }
        this.f2810f = Collections.unmodifiableMap(aVar);
    }
    ...
    public static n0 c(Context context, zaaw zaaw, Lock lock, Looper looper, GoogleApiAvailabilityLight googleApiAvailabilityLight, Map<Api.AnyClientKey<?>, Api.Client> map, ClientSettings clientSettings, Map<Api<?>, Boolean> map2, Api.AbstractClientBuilder<? extends zad, SignInOptions> abstractClientBuilder, ArrayList<zaq> arrayList) {
        ...
        while (i2 < size) {
            ...
            i2++;
            zaq zaq2 = zaq;
            if (aVar3.containsKey(zaq2.f2905b)) {
                arrayList2.add(zaq2);
            } else if (aVar4.containsKey(zaq2.f2905b)) {
                arrayList3.add(zaq2);
            } else {
    ...
    private final void g(ConnectionResult connectionResult) {
        ...
        if (i2 != 1) {
            ...
            this.f2807c.a(connectionResult);
        }
        u();
        this.n = 0;
    }
    ...
    private final boolean j(BaseImplementation.ApiMethodImpl<? extends Result, ? extends Api.AnyClient> apiMethodImpl) {
        ...
        Preconditions.b(this.f2810f.containsKey(t), "GoogleApiClient is not configured to use the API required for this call.");
        return this.f2810f.get(t).equals(this.f2809e);
    }
    ...
    private final PendingIntent l() {
        ...
        return PendingIntent.getActivity(this.f2806b, System.identityHashCode(this.f2807c), this.h.getSignInIntent(), 134217728);
    }
    ...
    public final void t() {
        ...
        if (o(this.j)) {
            ...
            if (connectionResult3 != null && (connectionResult = this.k) != null) {
                if (this.f2809e.n < this.f2808d.n) {
                    connectionResult3 = connectionResult;
                }
                g(connectionResult3);
            }
        } else {
            this.f2809e.disconnect();
            g(this.j);
        }
    }
    ...
    public final <A extends Api.AnyClient, T extends BaseImplementation.ApiMethodImpl<? extends Result, A>> T Q(T t) {
        if (!j(t)) {
            return this.f2808d.Q(t);
        }
        if (!v()) {
            return this.f2809e.Q(t);
        }
    ...
    public final void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        this.f2809e.dump(String.valueOf(str).concat("  "), fileDescriptor, printWriter, strArr);
        printWriter.append(str).append("anonClient").println(":");
        this.f2808d.dump(String.valueOf(str).concat("  "), fileDescriptor, printWriter, strArr);
    }
}
