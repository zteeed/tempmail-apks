...
public final class Api<O extends ApiOptions> {
    ...
    private final AbstractClientBuilder<?, O> f2679a;

    /* renamed from: b  reason: collision with root package name */
    private final ClientKey<?> f2680b;
    ...
    public <C extends Client> Api(String str, AbstractClientBuilder<C, O> abstractClientBuilder, ClientKey<C> clientKey) {
        ...
        this.f2681c = str;
        this.f2679a = abstractClientBuilder;
        this.f2680b = clientKey;
    }

    public final AnyClientKey<?> a() {
        ClientKey<?> clientKey = this.f2680b;
        if (clientKey != null) {
            return clientKey;
        }
    ...
    public final AbstractClientBuilder<?, O> d() {
        Preconditions.o(this.f2679a != null, "This API was constructed with a SimpleClientBuilder. Use getSimpleClientBuilder");
        return this.f2679a;
    }
}
