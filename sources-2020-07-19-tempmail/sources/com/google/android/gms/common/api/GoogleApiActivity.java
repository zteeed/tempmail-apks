...
public class GoogleApiActivity extends Activity implements DialogInterface.OnCancelListener {
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i == 1) {
            ...
            setResult(i2, intent);
            if (booleanExtra) {
                GoogleApiManager j = GoogleApiManager.j(this);
                if (i2 == -1) {
                    j.z();
                } else if (i2 == 0) {
                    j.d(new ConnectionResult(13, (PendingIntent) null), getIntent().getIntExtra("failing_client_id", -1));
                }
            }
        } else if (i == 2) {
            this.f2698b = 0;
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (bundle != null) {
            this.f2698b = bundle.getInt("resolution");
        }
        if (this.f2698b != 1) {
            ...
            if (pendingIntent == null && num == null) {
                ...
                GoogleApiAvailability.q().r(this, num.intValue(), 2, this);
                this.f2698b = 1;
            }
        }
    }
    ...
    public void onSaveInstanceState(Bundle bundle) {
        bundle.putInt("resolution", this.f2698b);
