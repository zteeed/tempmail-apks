...
public final class zax implements zabs {
    ...
    public final Map<Api.AnyClientKey<?>, zaw<?>> f2908b = new HashMap();

    /* renamed from: c  reason: collision with root package name */
    private final Map<Api.AnyClientKey<?>, zaw<?>> f2909c = new HashMap();

    /* renamed from: d  reason: collision with root package name */
    private final Map<Api<?>, Boolean> f2910d;

    /* renamed from: e  reason: collision with root package name */
    private final GoogleApiManager f2911e;
    /* access modifiers changed from: private */

    /* renamed from: f  reason: collision with root package name */
    public final zaaw f2912f;
    /* access modifiers changed from: private */
    public final Lock g;
    ...
    public zax(Context context, Lock lock, Looper looper, GoogleApiAvailabilityLight googleApiAvailabilityLight, Map<Api.AnyClientKey<?>, Api.Client> map, ClientSettings clientSettings, Map<Api<?>, Boolean> map2, Api.AbstractClientBuilder<? extends zad, SignInOptions> abstractClientBuilder, ArrayList<zaq> arrayList, zaaw zaaw, boolean z) {
        ...
        for (Map.Entry next2 : map.entrySet()) {
            ...
            if (client.requiresGooglePlayServices()) {
                z3 = z6;
                if (!this.f2910d.get(api).booleanValue()) {
                    z4 = true;
                    z2 = true;
                } else {
                    z2 = z7;
            ...
            this.f2908b.put((Api.AnyClientKey) next2.getKey(), zaw);
            if (client.requiresSignIn()) {
                this.f2909c.put((Api.AnyClientKey) next2.getKey(), zaw);
            }
            z5 = z4;
            z6 = z3;
            z7 = z2;
        ...
        this.m = z5 && !z6 && !z7;
        this.f2911e = GoogleApiManager.m();
    }

    private final ConnectionResult c(Api.AnyClientKey<?> anyClientKey) {
        this.g.lock();
        try {
            zaw zaw = this.f2908b.get(anyClientKey);
    ...
    public final boolean g(zaw<?> zaw, ConnectionResult connectionResult) {
        return !connectionResult.G() && !connectionResult.B() && this.f2910d.get(zaw.d()).booleanValue() && zaw.k().requiresGooglePlayServices() && this.i.m(connectionResult.u());
    }
    ...
    public final void j() {
        if (this.k == null) {
            this.f2912f.p = Collections.emptySet();
            return;
        }
    ...
    public final ConnectionResult l() {
        ...
        int i3 = 0;
        for (zaw next : this.f2908b.values()) {
            Api d2 = next.d();
            ConnectionResult connectionResult3 = this.p.get(next.j());
            if (!connectionResult3.G() && (!this.f2910d.get(d2).booleanValue() || connectionResult3.B() || this.i.m(connectionResult3.u()))) {
    ...
    private final <T extends BaseImplementation.ApiMethodImpl<? extends Result, ? extends Api.AnyClient>> boolean m(T t) {
        ...
        t.x(new Status(4, (String) null, this.f2911e.a(this.f2908b.get(t2).j(), System.identityHashCode(this.f2912f))));
        return true;
    }
    ...
    public final void connect() {
        ...
        try {
            if (!this.o) {
                ...
                this.s = null;
                this.f2911e.z();
                this.f2911e.c(this.f2908b.values()).d(new HandlerExecutor(this.h), new s0(this));
                this.g.unlock();
            }
        } finally {
            this.g.unlock();
