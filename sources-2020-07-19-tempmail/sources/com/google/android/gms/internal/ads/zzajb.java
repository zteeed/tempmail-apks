...
public final class zzajb extends InstreamAd {
    ...
    private final zzaiq f5739a;

    /* renamed from: b  reason: collision with root package name */
    private VideoController f5740b = a();

    /* renamed from: c  reason: collision with root package name */
    private MediaContent f5741c = b();
    ...
    private final VideoController a() {
        ...
        try {
            videoController.zza(this.f5739a.getVideoController());
    ...
    private final MediaContent b() {
        try {
            if (this.f5739a.f0() != null) {
                return new zzzc(this.f5739a.f0());
            }
            return null;
        } catch (RemoteException e2) {
            zzbba.e("#007 Could not call remote method.", e2);
    ...
    public final float getAspectRatio() {
        VideoController videoController = this.f5740b;
    ...
    public final void zza(InstreamAdView instreamAdView) {
        ...
        try {
            this.f5739a.x4(ObjectWrapper.b0(instreamAdView));
        } catch (RemoteException e2) {
            zzbba.e("#007 Could not call remote method.", e2);
        }
    }
