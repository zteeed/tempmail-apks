...
final class l70<T> implements z70<T> {
    ...
    private final zzehl f4272a;

    /* renamed from: b  reason: collision with root package name */
    private final r80<?, ?> f4273b;

    /* renamed from: c  reason: collision with root package name */
    private final boolean f4274c;

    /* renamed from: d  reason: collision with root package name */
    private final h60<?> f4275d;

    private l70(r80<?, ?> r80, h60<?> h60, zzehl zzehl) {
        this.f4273b = r80;
        this.f4274c = h60.j(zzehl);
        this.f4275d = h60;
        this.f4272a = zzehl;
    }
    ...
    public final void a(T t, T t2) {
        b80.h(this.f4273b, t, t2);
        if (this.f4274c) {
            b80.f(this.f4275d, t, t2);
        }
    }
    ...
    public final int c(T t) {
        ...
        return this.f4274c ? l + this.f4275d.g(t).q() : l;
    }

    public final void d(T t, j90 j90) throws IOException {
        Iterator<Map.Entry<?, Object>> d2 = this.f4275d.g(t).d();
        while (d2.hasNext()) {
    ...
    public final void e(T r10, byte[] r11, int r12, int r13, com.google.android.gms.internal.ads.n50 r14) throws java.io.IOException {
        ...
        L_0x0018:
            ...
            com.google.android.gms.internal.ads.h60<?> r12 = r9.f4275d
            com.google.android.gms.internal.ads.zzefo r0 = r14.f4452d
            com.google.android.gms.internal.ads.zzehl r3 = r9.f4272a
            int r5 = r2 >>> 3
        ...
        L_0x0065:
            ...
            java.lang.Object r2 = r14.f4451c
        ...
        L_0x007b:
            ...
            int r4 = com.google.android.gms.internal.ads.o50.h(r11, r4, r14)
            int r12 = r14.f4449a
            com.google.android.gms.internal.ads.h60<?> r0 = r9.f4275d
            com.google.android.gms.internal.ads.zzefo r5 = r14.f4452d
            com.google.android.gms.internal.ads.zzehl r6 = r9.f4272a
    ...
    public final boolean f(T t, T t2) {
        if (!this.f4273b.j(t).equals(this.f4273b.j(t2))) {
            return false;
        }
        if (this.f4274c) {
            return this.f4275d.g(t).equals(this.f4275d.g(t2));
        }
        return true;
    }

    public final T g() {
        return this.f4272a.c().K();
    }

    public final boolean h(T t) {
        return this.f4275d.g(t).c();
    }

    public final int i(T t) {
        int hashCode = this.f4273b.j(t).hashCode();
        return this.f4274c ? (hashCode * 53) + this.f4275d.g(t).hashCode() : hashCode;
    }
        ...
        do {
            try {
                ...
                if (tag == 11) {
                    ...
                    Object b2 = h60.b(zzefo, this.f4272a, tag >>> 3);
                    if (b2 == null) {
                        z = r80.f(k, t70);
                        continue;
                    } else {
