...
public final class zzcqi {
    ...
    private final zzbrq f7366b;

    /* renamed from: c  reason: collision with root package name */
    private final TelephonyManager f7367c;

    /* renamed from: d  reason: collision with root package name */
    private final zzcqf f7368d;
    /* access modifiers changed from: private */

    /* renamed from: e  reason: collision with root package name */
    public final zzcpz f7369e;
    ...
    zzcqi(Context context, zzbrq zzbrq, zzcqf zzcqf, zzcpz zzcpz) {
        ...
        this.f7368d = zzcqf;
        this.f7369e = zzcpz;
        this.f7367c = (TelephonyManager) context.getSystemService("phone");
    }

    /* access modifiers changed from: private */
    public final byte[] d(boolean z, ArrayList<zzty.zzc.zza> arrayList, zzty.zzm zzm, zzty.zzo.zzc zzc) {
        zzty.zzo.zza.C0089zza k0 = zzty.zzo.zza.k0();
        k0.F(arrayList);
        boolean z2 = true;
        k0.I(f(zzq.zzky().k(this.f7365a.getContentResolver()) != 0));
        k0.L(zzq.zzky().g(this.f7365a, this.f7367c));
        k0.C(this.f7368d.b());
        k0.D(this.f7368d.d());
        k0.y(this.f7368d.a());
        k0.x(zzc);
        ...
        k0.E(f(z));
        k0.z(zzq.zzld().a());
        if (zzq.zzky().c(this.f7365a.getContentResolver()) == 0) {
            z2 = false;
        }
        k0.H(f(z2));
    ...
    public final zzty.zzm i(Bundle bundle) {
        ...
        if (i == -1) {
            this.f7370f = zzui.ENUM_TRUE;
        } else {
            this.f7370f = zzui.ENUM_FALSE;
            if (i == 0) {
    ...
    public final void g(boolean z) {
        zzdux.f(this.f7366b.a(), new en(this, z), zzbbf.f6142f);
    }
}
