...
public final class zzazy {
    public static String a(zzazz zzazz) {
        return p(zzazz);
    }
    ...
    private static void f(JsonWriter jsonWriter, Object obj) throws IOException {
        ...
        } else if (obj instanceof zzazz) {
            ((zzazz) obj).a(jsonWriter);
                ...
                if (opt instanceof Boolean) {
                    ...
                    if (!(jSONArray == null || jSONArray.length() == 0)) {
                        ...
                        if (obj == null) {
                            ...
                            zzbba.i(valueOf.length() != 0 ? "Expected JSONArray with at least 1 non-null element for key:".concat(valueOf) : new String("Expected JSONArray with at least 1 non-null element for key:"));
                        } else if (obj instanceof JSONObject) {
                            ...
                            zzbba.i(String.format("JSONArray with unsupported type %s for key:%s", new Object[]{obj.getClass().getCanonicalName(), next}));
                        }
                    }
                    ...
                    zzbba.i(valueOf2.length() != 0 ? "Unsupported type for key:".concat(valueOf2) : new String("Unsupported type for key:"));
                }
            }
        }
        return bundle;
    ...
    private static String p(Object obj) {
        ...
        try {
            ...
            zzbba.c("Error when writing JSON.", e2);
            return null;
        }
    }
}
