...
public final class zzcof extends zzcny {
    ...
    public final void E(Bundle bundle) {
        synchronized (this.f7300b) {
            if (!this.f7302d) {
                ...
                try {
                    if (this.h == yl.f5401b) {
                        this.f7304f.e().G1(this.f7303e, new zzcob(this));
                    } else if (this.h == yl.f5402c) {
                        this.f7304f.e().X3(this.g, new zzcob(this));
                    } else {
    ...
    public final zzdvf<InputStream> b(String str) {
        synchronized (this.f7300b) {
            if (this.h != yl.f5400a && this.h != yl.f5402c) {
                zzdvf<InputStream> a2 = zzdux.a(new zzcop(zzdls.f8181b));
                return a2;
            } else if (this.f7301c) {
                ...
                this.f7299a.f(new zl(this), zzbbf.f6142f);
    ...
    public final zzdvf<InputStream> c(zzasm zzasm) {
        synchronized (this.f7300b) {
            if (this.h != yl.f5400a && this.h != yl.f5401b) {
                zzdvf<InputStream> a2 = zzdux.a(new zzcop(zzdls.f8181b));
                return a2;
            } else if (this.f7301c) {
                zzbbn<InputStream> zzbbn = this.f7299a;
                ...
                this.f7303e = zzasm;
                this.f7304f.checkAvailabilityAndConnect();
                this.f7299a.f(new xl(this), zzbbf.f6142f);
                zzbbn<InputStream> zzbbn2 = this.f7299a;
                return zzbbn2;
            }
        }
