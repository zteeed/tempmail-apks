...
public final class zzri extends Thread {
    ...
    private final Object f9060d;

    /* renamed from: e  reason: collision with root package name */
    private final zzrf f9061e;
    ...
    public final void d(View view) {
        try {
            ...
            ve0 b3 = b(view, zzrc);
            zzrc.p();
            if (b3.f5140a != 0 || b3.f5141b != 0) {
                if (b3.f5141b != 0 || zzrc.q() != 0) {
                    if (b3.f5141b != 0 || !this.f9061e.a(zzrc)) {
                        this.f9061e.c(zzrc);
                    }
                }
            }
    ...
    public final void run() {
        ...
        L_0x005a:
            ...
            r4.h()     // Catch:{ InterruptedException -> 0x007b, Exception -> 0x006b }
        L_0x0062:
            int r0 = r4.f9062f     // Catch:{ InterruptedException -> 0x007b, Exception -> 0x006b }
            int r0 = r0 * 1000
        ...
        L_0x007b:
            ...
            com.google.android.gms.internal.ads.zzbba.c(r1, r0)
        L_0x0081:
            java.lang.Object r0 = r4.f9060d
            monitor-enter(r0)
        L_0x0084:
            boolean r1 = r4.f9059c     // Catch:{ all -> 0x0096 }
            if (r1 == 0) goto L_0x0093
            java.lang.String r1 = "ContentFetchTask: waiting"
            com.google.android.gms.internal.ads.zzbba.f(r1)     // Catch:{ InterruptedException -> 0x0084 }
            java.lang.Object r1 = r4.f9060d     // Catch:{ InterruptedException -> 0x0084 }
    ...
    private zzri(zzrf zzrf) {
        ...
        this.g = zzacf.f5580d.a().intValue();
        this.h = zzacf.f5577a.a().intValue();
        this.i = zzacf.f5581e.a().intValue();
        this.j = zzacf.f5579c.a().intValue();
        this.k = ((Integer) zzwg.e().c(zzaav.J)).intValue();
        this.l = ((Integer) zzwg.e().c(zzaav.K)).intValue();
        this.m = ((Integer) zzwg.e().c(zzaav.L)).intValue();
        this.f9062f = zzacf.f5582f.a().intValue();
