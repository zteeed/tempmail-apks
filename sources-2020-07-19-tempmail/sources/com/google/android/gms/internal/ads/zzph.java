...
public final class zzph {
    ...
    public static final byte[] f8976a = {0, 0, 0, 1};

    /* renamed from: b  reason: collision with root package name */
    private static final float[] f8977b = {1.0f, 1.0f, 1.0909091f, 0.90909094f, 1.4545455f, 1.2121212f, 2.1818182f, 1.8181819f, 2.909091f, 2.4242425f, 1.6363636f, 1.3636364f, 1.939394f, 1.6161616f, 1.3333334f, 1.5f, 2.0f};

    /* renamed from: c  reason: collision with root package name */
    private static final Object f8978c = new Object();

    /* renamed from: d  reason: collision with root package name */
    private static int[] f8979d = new int[10];
    ...
    public static int b(byte[] bArr, int i) {
        ...
        synchronized (f8978c) {
            ...
            while (i3 < i) {
                ...
                if (i3 < i) {
                    if (f8979d.length <= i4) {
                        f8979d = Arrays.copyOf(f8979d, f8979d.length << 1);
                    }
                    f8979d[i4] = i3;
                    i3 += 3;
                    i4++;
