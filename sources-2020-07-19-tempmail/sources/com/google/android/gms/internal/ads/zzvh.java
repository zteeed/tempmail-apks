...
public final class zzvh extends AbstractSafeParcelable {
    ...
    public final AdSize N() {
        return zzb.zza(this.f9193f, this.f9190c, this.f9189b);
    }

    public final void writeToParcel(Parcel parcel, int i2) {
        int a2 = SafeParcelWriter.a(parcel);
        SafeParcelWriter.t(parcel, 2, this.f9189b, false);
        SafeParcelWriter.l(parcel, 3, this.f9190c);
        SafeParcelWriter.l(parcel, 4, this.f9191d);
        SafeParcelWriter.c(parcel, 5, this.f9192e);
        SafeParcelWriter.l(parcel, 6, this.f9193f);
