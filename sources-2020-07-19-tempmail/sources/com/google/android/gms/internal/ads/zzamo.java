...
public final class zzamo extends zzamq {
    ...
    private Map<Class<? extends NetworkExtras>, NetworkExtras> f5794b;

    static {
        new zzapd();
    }

    private final <NetworkExtrasT extends com.google.ads.mediation.NetworkExtras, ServerParametersT extends MediationServerParameters> zzams A6(String str) throws RemoteException {
        try {
            ...
            if (MediationAdapter.class.isAssignableFrom(cls)) {
                ...
                return new zzanv(mediationAdapter, (com.google.ads.mediation.NetworkExtras) this.f5794b.get(mediationAdapter.getAdditionalParametersType()));
    ...
    private final zzams B6(String str) throws RemoteException {
        try {
            ...
            if ("com.google.ads.mediation.customevent.CustomEventAdapter".equals(str)) {
                ...
                return new zzanv(customEventAdapter, (CustomEventExtras) this.f5794b.get(customEventAdapter.getAdditionalParametersType()));
            }
            throw new RemoteException();
        } catch (Throwable th) {
    ...
    public final void C6(Map<Class<? extends NetworkExtras>, NetworkExtras> map) {
        this.f5794b = map;
    }
    ...
    public final zzams m6(String str) throws RemoteException {
        return A6(str);
    }
}
