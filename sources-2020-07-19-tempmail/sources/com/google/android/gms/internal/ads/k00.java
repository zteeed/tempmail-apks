...
abstract class k00<OutputT> extends zzdtu.k<OutputT> {
    ...
    static final class a extends b {
        ...
        private final AtomicReferenceFieldUpdater<k00, Set<Throwable>> f4172a;

        /* renamed from: b  reason: collision with root package name */
        private final AtomicIntegerFieldUpdater<k00> f4173b;

        a(AtomicReferenceFieldUpdater atomicReferenceFieldUpdater, AtomicIntegerFieldUpdater atomicIntegerFieldUpdater) {
            super();
            this.f4172a = atomicReferenceFieldUpdater;
            this.f4173b = atomicIntegerFieldUpdater;
        }

        /* access modifiers changed from: package-private */
        public final void a(k00 k00, Set<Throwable> set, Set<Throwable> set2) {
            this.f4172a.compareAndSet(k00, (Object) null, set2);
        }

        /* access modifiers changed from: package-private */
        public final int b(k00 k00) {
            return this.f4173b.decrementAndGet(k00);
        }
    }
    ...
    static {
        ...
        b bVar;
        try {
            bVar = new a(AtomicReferenceFieldUpdater.newUpdater(k00.class, Set.class, i.f12574a), AtomicIntegerFieldUpdater.newUpdater(k00.class, j.g));
            th = null;
        } catch (Throwable th2) {
            th = th2;
            bVar = new c();
