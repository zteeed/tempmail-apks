...
public final class zzqo implements Application.ActivityLifecycleCallbacks, View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    private Application f9035c;

    /* renamed from: d  reason: collision with root package name */
    private final WindowManager f9036d;

    /* renamed from: e  reason: collision with root package name */
    private final PowerManager f9037e;

    /* renamed from: f  reason: collision with root package name */
    private final KeyguardManager f9038f;
    @VisibleForTesting
    ...
    public zzqo(Context context, View view) {
        ...
        this.f9036d = (WindowManager) context.getSystemService("window");
        this.f9037e = (PowerManager) this.f9034b.getSystemService("power");
        this.f9038f = (KeyguardManager) context.getSystemService("keyguard");
        Context context2 = this.f9034b;
        if (context2 instanceof Application) {
            this.f9035c = (Application) context2;
            this.j = new ke0((Application) context2, this);
        }
        this.o = context.getResources().getDisplayMetrics();
        Rect rect = new Rect();
        this.p = rect;
        rect.right = this.f9036d.getDefaultDisplay().getWidth();
        this.p.bottom = this.f9036d.getDefaultDisplay().getHeight();
    ...
    public final void f(int i2) {
        ...
        if (this.n.size() != 0 && (weakReference = this.i) != null) {
            ...
            boolean z5 = !z4 && zzq.zzkw().r(view, this.f9037e, this.f9038f) && z2 && z && windowVisibility == 0;
            if (z3 && !this.k.a() && z5 == this.l) {
                return;
            }
            if (z5 || this.l || i3 != 1) {
                zzqt zzqt = new zzqt(zzq.zzld().b(), this.f9037e.isScreenOn(), view != null && zzq.zzky().b(view), view != null ? view.getWindowVisibility() : 8, a(this.p), a(rect), a(rect2), z2, a(rect3), z, a(rect4), this.o.density, z5, list2);
    ...
    private final void j(View view) {
        ...
        if (this.g == null) {
            ...
            this.g = new he0(this);
            zzq.zzlr().c(this.f9034b, this.g, intentFilter);
        }
        Application application = this.f9035c;
        if (application != null) {
            try {
