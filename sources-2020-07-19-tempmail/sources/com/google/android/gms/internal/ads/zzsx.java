...
public final class zzsx extends AbstractSafeParcelable {
    ...
    private ParcelFileDescriptor f9098b;
    ...
    public final synchronized InputStream v() {
        ...
        ParcelFileDescriptor.AutoCloseInputStream autoCloseInputStream = new ParcelFileDescriptor.AutoCloseInputStream(this.f9098b);
        this.f9098b = null;
    ...
    public zzsx(@SafeParcelable.Param(id = 2) ParcelFileDescriptor parcelFileDescriptor) {
        this.f9098b = parcelFileDescriptor;
    }
}
