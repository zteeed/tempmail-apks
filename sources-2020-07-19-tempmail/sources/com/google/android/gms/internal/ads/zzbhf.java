...
public final class zzbhf extends zzbhs implements zzbgz {
    ...
    protected zzbfn f6246d;

    /* renamed from: e  reason: collision with root package name */
    private final zzajt<zzbfn> f6247e = new zzajt<>();
    ...
    private final void J() {
        if (this.z != null) {
            this.f6246d.getView().removeOnAttachStateChangeListener(this.z);
        }
    }
    ...
    private final WebResourceResponse Q(zzbhr zzbhr) throws IOException {
        ...
        while (true) {
            ...
            if (i2 <= 20) {
                ...
                for (Map.Entry next : zzbhr.f6254c.entrySet()) {
                    openConnection.addRequestProperty((String) next.getKey(), (String) next.getValue());
                }
                if (openConnection instanceof HttpURLConnection) {
                    httpURLConnection = (HttpURLConnection) openConnection;
                    zzq.zzkw().m(this.f6246d.getContext(), this.f6246d.a().f6131b, false, httpURLConnection);
    ...
    private final void x(AdOverlayInfoParcel adOverlayInfoParcel) {
        ...
        zzq.zzkv();
        zzn.zza(this.f6246d.getContext(), adOverlayInfoParcel, !l2);
        if (this.u != null) {
    ...
    public final void B(String str, Predicate<zzahc<? super zzbfn>> predicate) {
        this.f6247e.v(str, predicate);
    }

    public final void C(String str, zzahc<? super zzbfn> zzahc) {
        this.f6247e.c(str, zzahc);
    }

    public final void D(boolean z2, int i2, String str) {
        ca caVar;
        boolean h2 = this.f6246d.h();
        zzuu zzuu = (!h2 || this.f6246d.o().e()) ? this.g : null;
        if (h2) {
            caVar = null;
        } else {
            caVar = new ca(this.f6246d, this.h);
        }
        zzagi zzagi = this.k;
        zzagk zzagk = this.l;
        zzt zzt = this.q;
        zzbfn zzbfn = this.f6246d;
    ...
    public final void P(boolean z2, int i2) {
        zzuu zzuu = (!this.f6246d.h() || this.f6246d.o().e()) ? this.g : null;
        zzo zzo = this.h;
        zzt zzt = this.q;
        zzbfn zzbfn = this.f6246d;
    ...
    public final void f(zzuu zzuu, zzagi zzagi, zzo zzo, zzagk zzagk, zzt zzt, boolean z2, zzahf zzahf, zzc zzc, zzaqc zzaqc, zzavr zzavr) {
        if (zzc == null) {
            zzc = new zzc(this.f6246d.getContext(), zzavr, (zzarx) null);
        }
        this.t = new zzapt(this.f6246d, zzaqc);
        this.u = zzavr;
        ...
        C("/refresh", zzagm.l);
        C("/canOpenApp", zzagm.f5691b);
        C("/canOpenURLs", zzagm.f5690a);
        C("/canOpenIntents", zzagm.f5692c);
        C("/click", zzagm.f5693d);
        C("/close", zzagm.f5694e);
        C("/customClose", zzagm.f5695f);
        ...
        C("/video", zzagm.m);
        C("/videoMeta", zzagm.n);
        if (zzq.zzlu().l(this.f6246d.getContext())) {
            C("/logScionEvent", new zzahe(this.f6246d.getContext()));
        }
        this.g = zzuu;
        this.h = zzo;
        this.k = zzagi;
    ...
    public final void j() {
        zzavr zzavr = this.u;
        if (zzavr != null) {
            WebView webView = this.f6246d.getWebView();
            if (t.H(webView)) {
                w(webView, zzavr, 10);
                return;
            }
            ...
            this.f6246d.getView().addOnAttachStateChangeListener(this.z);
        }
    }
    ...
    public final void m() {
        synchronized (this.f6248f) {
            this.m = false;
            this.n = true;
            zzbbf.f6141e.execute(new ba(this));
        }
    }
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        return this.f6246d.w(renderProcessGoneDetail.didCrash(), renderProcessGoneDetail.rendererPriorityAtExit());
    }
    ...
    public final boolean t(zzbhr zzbhr) {
        ...
        if (!this.f6246d.getWebView().willNotDraw()) {
            try {
                zzeg d2 = this.f6246d.d();
                if (d2 != null && d2.f(uri)) {
                    uri = d2.b(uri, this.f6246d.getContext(), this.f6246d.getView(), this.f6246d.b());
                }
            } catch (zzef unused) {
                String valueOf2 = String.valueOf(zzbhr.f6252a);
            ...
            if (zzc == null || zzc.zzjy()) {
                ...
                this.s.zzbn(zzbhr.f6252a);
            }
        } else {
            String valueOf3 = String.valueOf(zzbhr.f6252a);
    ...
    public final WebResourceResponse u(zzbhr zzbhr) {
        ...
        zzavr zzavr = this.u;
        if (zzavr != null) {
            zzavr.a(zzbhr.f6252a, zzbhr.f6254c, 1);
        }
        if (!"mraid.js".equalsIgnoreCase(new File(zzbhr.f6252a).getName())) {
            webResourceResponse = null;
        } else {
            m();
            if (this.f6246d.o().e()) {
                str = (String) zzwg.e().c(zzaav.F);
            } else if (this.f6246d.h()) {
                str = (String) zzwg.e().c(zzaav.E);
            } else {
                str = (String) zzwg.e().c(zzaav.D);
            }
            zzq.zzkw();
            webResourceResponse = zzaye.P(this.f6246d.getContext(), this.f6246d.a().f6131b, str);
        }
        if (webResourceResponse != null) {
            return webResourceResponse;
        }
        try {
            if (!zzawn.d(zzbhr.f6252a, this.f6246d.getContext(), this.y).equals(zzbhr.f6252a)) {
                return Q(zzbhr);
            }
            zzsy u2 = zzsy.u(zzbhr.f6252a);
            if (u2 != null && (d2 = zzq.zzlc().d(u2)) != null && d2.u()) {
                return new WebResourceResponse("", "", d2.v());
            }
            if (!zzbau.a() || !zzacg.f5584b.a().booleanValue()) {
                return null;
            }
            return Q(zzbhr);
    ...
    public final void y(zzd zzd) {
        ...
        x(new AdOverlayInfoParcel(zzd, zzuu, zzo, this.q, this.f6246d.a()));
    }
