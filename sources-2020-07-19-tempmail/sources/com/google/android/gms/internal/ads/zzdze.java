...
public final class zzdze extends zzegb<zzdze, zza> implements zzehn {
    ...
    static {
        ...
        zzhsc = zzdze;
        zzegb.x(zzdze.class, zzdze);
    }

    private zzdze() {
    }

    public static zzdze L(zzeer zzeer, zzefo zzefo) throws zzegl {
        return (zzdze) zzegb.m(zzhsc, zzeer, zzefo);
    }
    ...
    public final Object t(int i, Object obj, Object obj2) {
        switch (g30.f3847a[i - 1]) {
            case 1:
                return new zzdze();
            case 2:
                return new zza((g30) null);
            case 3:
                return zzegb.u(zzhsc, "\u0000\u0002\u0000\u0000\u0001\u0002\u0002\u0000\u0000\u0000\u0001\u000b\u0002\t", new Object[]{"zzhsb", "zzhrz"});
            case 4:
                return zzhsc;
            case 5:
