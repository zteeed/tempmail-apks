...
public final class zzbde {
    ...
    private final zzbbd f6178c;

    /* renamed from: d  reason: collision with root package name */
    private final zzabg f6179d;

    /* renamed from: e  reason: collision with root package name */
    private final zzabi f6180e;

    /* renamed from: f  reason: collision with root package name */
    private final zzazm f6181f;
    ...
    public final void a() {
        if (zzacx.f5619a.a().booleanValue() && !this.o) {
            Bundle bundle = new Bundle();
            bundle.putString("type", "native-player-metrics");
            bundle.putString("request", this.f6177b);
            bundle.putString("player", this.n.r());
            for (zzazo next : this.f6181f.c()) {
                String valueOf = String.valueOf(next.f6081a);
                bundle.putString(valueOf.length() != 0 ? "fps_c_".concat(valueOf) : new String("fps_c_"), Integer.toString(next.f6085e));
                String valueOf2 = String.valueOf(next.f6081a);
                bundle.putString(valueOf2.length() != 0 ? "fps_p_".concat(valueOf2) : new String("fps_p_"), Double.toString(next.f6084d));
            }
            int i2 = 0;
            while (true) {
                long[] jArr = this.g;
                if (i2 < jArr.length) {
                    ...
                    zzq.zzkw().l(this.f6176a, this.f6178c.f6131b, "gmob-apps", bundle, true);
                    this.o = true;
                    return;
                }
            }
    ...
    public final void b(zzbcm zzbcm) {
        zzabd.a(this.f6180e, this.f6179d, "vpc2");
        this.i = true;
        zzabi zzabi = this.f6180e;
        if (zzabi != null) {
            zzabi.d("vpn", zzbcm.r());
        }
        this.n = zzbcm;
    ...
    public final void c(zzbcm zzbcm) {
        if (this.k && !this.l) {
            ...
            zzabd.a(this.f6180e, this.f6179d, "vff2");
            this.l = true;
        }
        long c2 = zzq.zzld().c();
        if (this.m && this.p && this.q != -1) {
            this.f6181f.a(((double) TimeUnit.SECONDS.toNanos(1)) / ((double) (c2 - this.q)));
        }
        this.p = this.m;
        this.q = c2;
    ...
    public final void d() {
        if (this.i && !this.j) {
            zzabd.a(this.f6180e, this.f6179d, "vfr2");
            this.j = true;
        }
    }
    ...
    public final void e() {
        this.m = true;
        if (this.j && !this.k) {
            zzabd.a(this.f6180e, this.f6179d, "vfp2");
            this.k = true;
        }
    }
