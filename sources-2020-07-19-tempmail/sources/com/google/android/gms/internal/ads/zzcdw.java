...
public final class zzcdw {
    ...
    private final zzchw f6900a;

    /* renamed from: b  reason: collision with root package name */
    private final zzcgr f6901b;

    /* renamed from: c  reason: collision with root package name */
    private ViewTreeObserver.OnScrollChangedListener f6902c = null;

    /* renamed from: d  reason: collision with root package name */
    private int f6903d = ((Integer) zzwg.e().c(zzaav.Q3)).intValue();

    /* renamed from: e  reason: collision with root package name */
    private int f6904e = ((Integer) zzwg.e().c(zzaav.R3)).intValue();

    /* renamed from: f  reason: collision with root package name */
    private float f6905f = ((Float) zzwg.e().c(zzaav.S3)).floatValue();
    ...
    public final View a(zzdkk zzdkk, View view, WindowManager windowManager) throws zzbfz {
        zzbfn a2 = this.f6900a.a(zzvh.B(), false);
        ...
        this.f6901b.f(new WeakReference(a2), "/loadNativeAdPolicyViolations", new th(this, view, windowManager, zzdkk));
        this.f6901b.f(new WeakReference(a2), "/showValidatorOverlay", sh.f4913a);
        return a2.getView();
    }
    ...
    public final /* synthetic */ void b(android.view.View r17, android.view.WindowManager r18, com.google.android.gms.internal.ads.zzdkk r19, com.google.android.gms.internal.ads.zzbfn r20, java.util.Map r21) {
        /*
            ...
            r0.f6905f = r2     // Catch:{ NumberFormatException -> 0x0031 }
            goto L_0x0032
        L_0x0031:
        L_0x0032:
            ...
            float r3 = r0.f6905f     // Catch:{ NumberFormatException -> 0x0076 }
            float r2 = r2 * r3
            int r2 = java.lang.Math.round(r2)     // Catch:{ NumberFormatException -> 0x0076 }
            r0.f6903d = r2     // Catch:{ NumberFormatException -> 0x0076 }
            goto L_0x0077
        L_0x0076:
        L_0x0077:
            ...
            float r3 = r0.f6905f     // Catch:{ NumberFormatException -> 0x00b8 }
            float r2 = r2 * r3
            int r2 = java.lang.Math.round(r2)     // Catch:{ NumberFormatException -> 0x00b8 }
            r0.f6904e = r2     // Catch:{ NumberFormatException -> 0x00b8 }
        L_0x00b8:
            int r2 = r0.f6903d
            int r3 = r0.f6904e
        ...
        L_0x01d0:
            ...
            android.view.ViewTreeObserver$OnScrollChangedListener r2 = r0.f6902c
    ...
    public final /* synthetic */ void c(WindowManager windowManager, View view, zzbfn zzbfn, Map map) {
        ...
        if (this.f6902c != null && viewTreeObserver != null && viewTreeObserver.isAlive()) {
            viewTreeObserver.removeOnScrollChangedListener(this.f6902c);
        }
    }
    ...
    public final /* synthetic */ void d(Map map, boolean z) {
        ...
        this.f6901b.e("sendMessageToNativeJs", hashMap);
    }

    /* access modifiers changed from: package-private */
    public final /* synthetic */ void e(zzbfn zzbfn, Map map) {
        this.f6901b.e("sendMessageToNativeJs", map);
    }
}
