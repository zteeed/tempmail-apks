...
public final class zzamm {
    ...
    public final List<zzamn> f5790a;
    ...
    public zzamm(JSONObject jSONObject) throws JSONException {
        ...
        for (int i2 = 0; i2 < jSONArray.length(); i2++) {
            try {
                ...
                boolean equalsIgnoreCase = "banner".equalsIgnoreCase(zzamn.f5793c);
                arrayList.add(zzamn);
                if (i < 0) {
                    Iterator<String> it = zzamn.f5791a.iterator();
                    while (true) {
                        if (it.hasNext()) {
        ...
        jSONArray.length();
        this.f5790a = Collections.unmodifiableList(arrayList);
