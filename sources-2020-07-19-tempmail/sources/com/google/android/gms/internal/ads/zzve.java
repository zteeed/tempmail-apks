...
public final class zzve extends AbstractSafeParcelable {
    ...
    public final List<String> f9187f;
    @SafeParcelable.Field
    ...
    public final boolean equals(Object obj) {
        ...
        zzve zzve = (zzve) obj;
        if (this.f9183b != zzve.f9183b || this.f9184c != zzve.f9184c || !Objects.a(this.f9185d, zzve.f9185d) || this.f9186e != zzve.f9186e || !Objects.a(this.f9187f, zzve.f9187f) || this.g != zzve.g || this.h != zzve.h || this.i != zzve.i || !Objects.a(this.j, zzve.j) || !Objects.a(this.k, zzve.k) || !Objects.a(this.l, zzve.l) || !Objects.a(this.m, zzve.m) || !Objects.a(this.n, zzve.n) || !Objects.a(this.o, zzve.o) || !Objects.a(this.p, zzve.p) || !Objects.a(this.q, zzve.q) || !Objects.a(this.r, zzve.r) || this.s != zzve.s || this.u != zzve.u || !Objects.a(this.v, zzve.v) || !Objects.a(this.w, zzve.w)) {
            return false;
        }
        return true;
    }
    ...
    public final int hashCode() {
        return Objects.b(Integer.valueOf(this.f9183b), Long.valueOf(this.f9184c), this.f9185d, Integer.valueOf(this.f9186e), this.f9187f, Boolean.valueOf(this.g), Integer.valueOf(this.h), Boolean.valueOf(this.i), this.j, this.k, this.l, this.m, this.n, this.o, this.p, this.q, this.r, Boolean.valueOf(this.s), Integer.valueOf(this.u), this.v, this.w);
    }

    public final void writeToParcel(Parcel parcel, int i2) {
        int a2 = SafeParcelWriter.a(parcel);
        SafeParcelWriter.l(parcel, 1, this.f9183b);
        SafeParcelWriter.o(parcel, 2, this.f9184c);
        SafeParcelWriter.e(parcel, 3, this.f9185d, false);
        SafeParcelWriter.l(parcel, 4, this.f9186e);
        SafeParcelWriter.v(parcel, 5, this.f9187f, false);
