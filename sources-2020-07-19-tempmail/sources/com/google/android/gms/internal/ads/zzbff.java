...
public final class zzbff extends WebChromeClient {
    ...
    private final boolean b(Context context, String str, String str2, String str3, String str4, JsResult jsResult, JsPromptResult jsPromptResult, boolean z) {
        zzc l;
        try {
            if (this.f6224a == null || this.f6224a.q() == null || this.f6224a.q().l() == null || (l = this.f6224a.q().l()) == null || l.zzjy()) {
    ...
    public final boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        ...
        int i = f9.f3770a[consoleMessage.messageLevel().ordinal()];
        if (i == 1) {
            zzbba.g(sb2);
        } else if (i == 2) {
            zzbba.i(sb2);
    ...
    public final boolean onCreateWindow(WebView webView, boolean z, boolean z2, Message message) {
        ...
        if (this.f6224a.q0() != null) {
            webView2.setWebViewClient(this.f6224a.q0());
        }
    ...
    public final void onGeolocationPermissionsShowPrompt(String str, GeolocationPermissions.Callback callback) {
        ...
        if (callback != null) {
            zzq.zzkw();
            if (!zzaye.l0(this.f6224a.getContext(), "android.permission.ACCESS_FINE_LOCATION")) {
                zzq.zzkw();
                if (!zzaye.l0(this.f6224a.getContext(), "android.permission.ACCESS_COARSE_LOCATION")) {
                    z = false;
    ...
    public final void onHideCustomView() {
        com.google.android.gms.ads.internal.overlay.zzc o0 = this.f6224a.o0();
        if (o0 == null) {
    ...
    public final void onPermissionRequest(PermissionRequest permissionRequest) {
        if (!PlatformVersion.h() || zzacw.f5616a.a().booleanValue()) {
            super.onPermissionRequest(permissionRequest);
            return;
        }
        zzbfn zzbfn = this.f6224a;
        if (zzbfn == null || zzbfn.q() == null || this.f6224a.q().p() == null) {
            super.onPermissionRequest(permissionRequest);
            return;
        }
        String[] e2 = this.f6224a.q().p().e(permissionRequest.getResources());
        if (e2.length > 0) {
