...
public final class zzeds implements zzdwp {
    ...
    public final byte[] a(byte[] bArr) throws GeneralSecurityException {
        Mac mac;
        try {
            mac = (Mac) this.f8524a.clone();
        } catch (CloneNotSupportedException unused) {
            mac = zzedf.g.a(this.f8526c);
            mac.init(this.f8527d);
        }
        mac.update(bArr);
        byte[] bArr2 = new byte[this.f8525b];
        System.arraycopy(mac.doFinal(), 0, bArr2, 0, this.f8525b);
        return bArr2;
    }
}
