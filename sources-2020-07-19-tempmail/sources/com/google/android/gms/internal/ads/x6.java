...
final class x6 extends y6 implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private final WeakReference<ViewTreeObserver.OnGlobalLayoutListener> f5284c;

    public x6(View view, ViewTreeObserver.OnGlobalLayoutListener onGlobalLayoutListener) {
        super(view);
        this.f5284c = new WeakReference<>(onGlobalLayoutListener);
    }
    ...
    public final void onGlobalLayout() {
        ViewTreeObserver.OnGlobalLayoutListener onGlobalLayoutListener = (ViewTreeObserver.OnGlobalLayoutListener) this.f5284c.get();
