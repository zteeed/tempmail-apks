...
final class ke0 implements Application.ActivityLifecycleCallbacks {
    ...
    private final Application f4213b;

    /* renamed from: c  reason: collision with root package name */
    private final WeakReference<Application.ActivityLifecycleCallbacks> f4214c;
    ...
    public ke0(Application application, Application.ActivityLifecycleCallbacks activityLifecycleCallbacks) {
        this.f4214c = new WeakReference<>(activityLifecycleCallbacks);
        this.f4213b = application;
    }

    private final void a(zzrd zzrd) {
        try {
            Application.ActivityLifecycleCallbacks activityLifecycleCallbacks = (Application.ActivityLifecycleCallbacks) this.f4214c.get();
            if (activityLifecycleCallbacks != null) {
                zzrd.a(activityLifecycleCallbacks);
            } else if (!this.f4215d) {
                this.f4213b.unregisterActivityLifecycleCallbacks(this);
                this.f4215d = true;
            }
        } catch (Exception e2) {
