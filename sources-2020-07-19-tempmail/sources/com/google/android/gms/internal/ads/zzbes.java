...
public abstract class zzbes implements Releasable {
    ...
    protected Context f6215b;

    /* renamed from: c  reason: collision with root package name */
    protected String f6216c;

    /* renamed from: d  reason: collision with root package name */
    protected WeakReference<zzbdb> f6217d;

    public zzbes(zzbdb zzbdb) {
        this.f6215b = zzbdb.getContext();
        this.f6216c = zzq.zzkw().m0(this.f6215b, zzbdb.a().f6131b);
        this.f6217d = new WeakReference<>(zzbdb);
    }
