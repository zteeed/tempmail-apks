...
public final class zzclh {
    ...
    private List<Map<String, String>> f7198a = new ArrayList();
    ...
    private final Map<String, String> c() {
        Map<String, String> a2 = this.f7202e.a();
        a2.put("tms", Long.toString(zzq.zzld().b(), 10));
        a2.put("tid", this.f7201d);
        return a2;
    }
    ...
    public final synchronized void a() {
        /*
            ...
            return
        L_0x0015:
            boolean r0 = r3.f7199b     // Catch:{ all -> 0x002e }
            if (r0 != 0) goto L_0x002c
            java.util.Map r0 = r3.c()     // Catch:{ all -> 0x002e }
            java.lang.String r1 = "action"
            java.lang.String r2 = "init_started"
            r0.put(r1, r2)     // Catch:{ all -> 0x002e }
            java.util.List<java.util.Map<java.lang.String, java.lang.String>> r1 = r3.f7198a     // Catch:{ all -> 0x002e }
            r1.add(r0)     // Catch:{ all -> 0x002e }
            r0 = 1
            r3.f7199b = r0     // Catch:{ all -> 0x002e }
        L_0x002c:
            monitor-exit(r3)
            return
        L_0x002e:
    ...
    public final synchronized void b() {
        /*
            ...
            return
        L_0x0015:
            boolean r0 = r3.f7200c     // Catch:{ all -> 0x0046 }
            if (r0 != 0) goto L_0x0044
            java.util.Map r0 = r3.c()     // Catch:{ all -> 0x0046 }
            java.lang.String r1 = "action"
            java.lang.String r2 = "init_finished"
            r0.put(r1, r2)     // Catch:{ all -> 0x0046 }
            java.util.List<java.util.Map<java.lang.String, java.lang.String>> r1 = r3.f7198a     // Catch:{ all -> 0x0046 }
            r1.add(r0)     // Catch:{ all -> 0x0046 }
            java.util.List<java.util.Map<java.lang.String, java.lang.String>> r0 = r3.f7198a     // Catch:{ all -> 0x0046 }
        ...
        L_0x002f:
            ...
            com.google.android.gms.internal.ads.zzclc r2 = r3.f7202e     // Catch:{ all -> 0x0046 }
            r2.d(r1)     // Catch:{ all -> 0x0046 }
            goto L_0x002f
        L_0x0041:
            r0 = 1
            r3.f7200c = r0     // Catch:{ all -> 0x0046 }
        L_0x0044:
            monitor-exit(r3)
            return
        L_0x0046:
