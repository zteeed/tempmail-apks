...
final class bq {
    ...
    public static MessageDigest f3493b;

    /* renamed from: c  reason: collision with root package name */
    private static final Object f3494c = new Object();

    /* renamed from: d  reason: collision with root package name */
    private static final Object f3495d = new Object();

    /* renamed from: e  reason: collision with root package name */
    static CountDownLatch f3496e = new CountDownLatch(1);
    ...
    private static MessageDigest g() {
        ...
        f();
        try {
            z = f3496e.await(2, TimeUnit.SECONDS);
        } catch (InterruptedException unused) {
            z = false;
        }
        if (z && (messageDigest = f3493b) != null) {
    ...
    static String h(zzcf.zza zza, String str) throws GeneralSecurityException, UnsupportedEncodingException {
        ...
        } else if (ha0.f3948a != null) {
            byte[] a2 = ha0.f3948a.a(g, str != null ? str.getBytes() : new byte[0]);
