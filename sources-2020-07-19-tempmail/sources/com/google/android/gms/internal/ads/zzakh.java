...
public final class zzakh {
    ...
    private final zzbbd f5755d;
    /* access modifiers changed from: private */

    /* renamed from: e  reason: collision with root package name */
    public zzazj<zzaju> f5756e;

    /* renamed from: f  reason: collision with root package name */
    private zzazj<zzaju> f5757f;
    /* access modifiers changed from: private */
    public zzaky g;
    /* access modifiers changed from: private */
    public int h;
    ...
    public zzakh(Context context, zzbbd zzbbd, String str) {
        ...
        this.f5755d = zzbbd;
        this.f5756e = new zzakv();
        this.f5757f = new zzakv();
    }

    /* access modifiers changed from: protected */
    public final zzaky c(zzeg zzeg) {
        zzaky zzaky = new zzaky(this.f5757f);
        zzbbf.f6141e.execute(new i1(this, zzeg, zzaky));
    ...
    public final /* synthetic */ void f(com.google.android.gms.internal.ads.zzaky r4, com.google.android.gms.internal.ads.zzaju r5) {
        ...
        L_0x0012:
            ...
            com.google.android.gms.internal.ads.zzdvi r4 = com.google.android.gms.internal.ads.zzbbf.f6141e     // Catch:{ all -> 0x002a }
    ...
    public final /* synthetic */ void g(zzeg zzeg, zzaky zzaky) {
        ...
        try {
            ...
            zzbbd zzbbd = this.f5755d;
            if (zzacw.f5618c.a().booleanValue()) {
            ...
            if (this.f5754c.endsWith(".js")) {
                zzaju.L(this.f5754c);
            } else if (this.f5754c.startsWith("<html>")) {
                zzaju.Q(this.f5754c);
            } else {
                zzaju.g0(this.f5754c);
            }
            zzaye.h.postDelayed(new p1(this, zzaky, zzaju), (long) t1.f4943a);
        } catch (Throwable th) {
        ...
        synchronized (this.f5752a) {
            synchronized (this.f5752a) {
                if (this.g != null && this.h == 0) {
                    this.g.d(new k1(this), j1.f4090a);
                }
            }
            if (this.g != null) {
                if (this.g.a() != -1) {
