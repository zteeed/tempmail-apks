...
public class zzex {
    ...
    protected Context f8669a;

    /* renamed from: b  reason: collision with root package name */
    private ExecutorService f8670b;

    /* renamed from: c  reason: collision with root package name */
    private DexClassLoader f8671c;
    ...
    private volatile AdvertisingIdClient f8674f = null;
    ...
    private zzex(Context context) {
        ...
        this.i = z;
        this.f8669a = z ? applicationContext : context;
        this.o = new HashMap();
        if (this.q == null) {
            this.q = new zzev(this.f8669a);
        }
    }
    ...
    public final void B() {
        try {
            if (this.f8674f == null && this.i) {
                AdvertisingIdClient advertisingIdClient = new AdvertisingIdClient(this.f8669a);
                advertisingIdClient.start();
                this.f8674f = advertisingIdClient;
            }
    ...
    private final zzcf.zza C() {
        try {
            return zzdpt.a(this.f8669a, this.f8669a.getPackageName(), Integer.toString(this.f8669a.getPackageManager().getPackageInfo(this.f8669a.getPackageName(), 0).versionCode));
    ...
    public static com.google.android.gms.internal.ads.zzex d(android.content.Context r9, java.lang.String r10, java.lang.String r11, boolean r12) {
        /*
            ...
            r1.f8670b = r9     // Catch:{ zzeu -> 0x0136 }
            r1.g = r12     // Catch:{ zzeu -> 0x0136 }
            if (r12 == 0) goto L_0x0023
            java.util.concurrent.ExecutorService r9 = r1.f8670b     // Catch:{ zzeu -> 0x0136 }
        ...
        L_0x0023:
            ...
            android.content.Context r3 = r1.f8669a     // Catch:{ all -> 0x004d }
        ...
        L_0x0071:
            ...
            r1.f8672d = r2     // Catch:{ zzeu -> 0x0136 }
            byte[] r10 = r2.c(r10)     // Catch:{ zzeh -> 0x012f }
            r1.f8673e = r10     // Catch:{ zzeh -> 0x012f }
            android.content.Context r10 = r1.f8669a     // Catch:{ FileNotFoundException -> 0x0128, IOException -> 0x0121, zzeh -> 0x011a, NullPointerException -> 0x0113 }
        ...
        L_0x0098:
            ...
            com.google.android.gms.internal.ads.zzei r5 = r1.f8672d     // Catch:{ FileNotFoundException -> 0x0128, IOException -> 0x0121, zzeh -> 0x011a, NullPointerException -> 0x0113 }
            byte[] r7 = r1.f8673e     // Catch:{ FileNotFoundException -> 0x0128, IOException -> 0x0121, zzeh -> 0x011a, NullPointerException -> 0x0113 }
    ...
    private final void h(java.io.File r10, java.lang.String r11) {
        ...
        L_0x0056:
            ...
            com.google.android.gms.internal.ads.zzei r11 = r9.f8672d     // Catch:{ zzeh | IOException | NoSuchAlgorithmException -> 0x00ca, all -> 0x00c6 }
            byte[] r6 = r9.f8673e     // Catch:{ zzeh | IOException | NoSuchAlgorithmException -> 0x00ca, all -> 0x00c6 }
    ...
    private final boolean n(java.io.File r10, java.lang.String r11) {
        ...
        L_0x005e:
            ...
            goto L_0x00d2
        L_0x00a8:
            com.google.android.gms.internal.ads.zzei r11 = r9.f8672d     // Catch:{ zzeh | IOException | NoSuchAlgorithmException -> 0x00dd, all -> 0x00d9 }
            byte[] r0 = r9.f8673e     // Catch:{ zzeh | IOException | NoSuchAlgorithmException -> 0x00dd, all -> 0x00d9 }
            java.lang.String r6 = new java.lang.String     // Catch:{ zzeh | IOException | NoSuchAlgorithmException -> 0x00dd, all -> 0x00d9 }
    ...
    public final void f(int i2, boolean z) {
        if (this.n) {
            Future<?> submit = this.f8670b.submit(new ga0(this, i2, z));
            if (i2 == 0) {
                this.k = submit;
            }
        }
