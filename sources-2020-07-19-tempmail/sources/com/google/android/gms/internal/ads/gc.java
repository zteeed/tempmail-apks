...
final class gc extends zzbnc {
    ...
    public final void h(ViewGroup viewGroup, zzvh zzvh) {
        ...
        if (viewGroup != null && (zzbfn = this.j) != null) {
            ...
            viewGroup.setMinimumHeight(zzvh.f9191d);
    ...
    public final zzdkj i() {
        ...
        zzdkk zzdkk = this.f6490b;
        if (zzdkk.U) {
            Iterator<String> it = zzdkk.f8131a.iterator();
            while (true) {
                if (!it.hasNext()) {
                    z = false;
                    break;
        ...
        return zzdld.a(this.f6490b.o, this.k);
    }
    ...
    public final int l() {
        return this.f6489a.f8162b.f8157b.f8139c;
    }
