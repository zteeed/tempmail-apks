...
public final class zzehf<K, V> extends LinkedHashMap<K, V> {
    ...
    private static final zzehf f8586c;
    ...
    public final void c(zzehf<K, V> zzehf) {
        i();
        if (!zzehf.isEmpty()) {
            putAll(zzehf);
        }
