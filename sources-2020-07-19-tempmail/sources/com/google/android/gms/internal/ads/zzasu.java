...
public final class zzasu {
    ...
    private final void c(Context context) {
        ...
        if (audioManager != null) {
            try {
                this.f5928a = audioManager.getMode();
                this.f5929b = audioManager.isMusicActive();
                this.f5930c = audioManager.isSpeakerphoneOn();
                this.f5931d = audioManager.getStreamVolume(3);
                this.f5932e = audioManager.getRingerMode();
                this.f5933f = audioManager.getStreamVolume(2);
                return;
            } catch (Throwable th) {
    ...
    public final zzasr d() {
        return new zzasr(this.f5928a, this.q, this.r, this.g, this.s, this.t, this.u, this.v, this.f5929b, this.f5930c, this.w, this.x, this.B, this.f5931d, this.h, this.i, this.j, this.f5932e, this.f5933f, this.y, this.z, this.A, this.m, this.n, this.k, this.l, this.o, this.C, this.p);
    }
