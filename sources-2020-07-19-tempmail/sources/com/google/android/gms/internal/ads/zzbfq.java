...
public class zzbfq extends WebViewClient implements zzbgz {
    ...
    protected zzbfn f6225a;

    /* renamed from: b  reason: collision with root package name */
    private final zztm f6226b;

    /* renamed from: c  reason: collision with root package name */
    private final HashMap<String, List<zzahc<? super zzbfn>>> f6227c;

    /* renamed from: d  reason: collision with root package name */
    private final Object f6228d;
    ...
    private final void F() {
        if (this.x != null) {
            this.f6225a.getView().removeOnAttachStateChangeListener(this.x);
        }
    }
        ...
        while (true) {
            ...
            if (i2 <= 20) {
                ...
                if (openConnection instanceof HttpURLConnection) {
                    ...
                    zzq.zzkw().m(this.f6225a.getContext(), this.f6225a.a().f6131b, false, httpURLConnection);
    ...
    private final void s(AdOverlayInfoParcel adOverlayInfoParcel) {
        ...
        zzq.zzkv();
        zzn.zza(this.f6225a.getContext(), adOverlayInfoParcel, !l2);
        if (this.s != null) {
    ...
    public final void y(Map<String, String> map, List<zzahc<? super zzbfn>> list, String str) {
        ...
        for (zzahc<? super zzbfn> a2 : list) {
            a2.a(this.f6225a, map);
        }
    }

    public final void A(boolean z, int i2, String str, String str2) {
        l9 l9Var;
        boolean h2 = this.f6225a.h();
        zzuu zzuu = (!h2 || this.f6225a.o().e()) ? this.f6229e : null;
        if (h2) {
            l9Var = null;
        } else {
            l9Var = new l9(this.f6225a, this.f6230f);
        }
        zzagi zzagi = this.i;
        zzagk zzagk = this.j;
        zzt zzt = this.o;
        zzbfn zzbfn = this.f6225a;
    ...
    public final void L(boolean z, int i2) {
        zzuu zzuu = (!this.f6225a.h() || this.f6225a.o().e()) ? this.f6229e : null;
        zzo zzo = this.f6230f;
        zzt zzt = this.o;
        zzbfn zzbfn = this.f6225a;
    ...
    public final WebResourceResponse M(String str, Map<String, String> map) {
        zzsx d2;
        try {
            String d3 = zzawn.d(str, this.f6225a.getContext(), this.w);
            if (!d3.equals(str)) {
                return N(d3, map);
            }
            zzsy u2 = zzsy.u(str);
    ...
    public final void a(Uri uri) {
        ...
        List list = this.f6227c.get(path);
        if (list != null) {
            ...
            zzdux.f(zzq.zzkw().c0(uri), new j9(this, list, path), zzbbf.f6142f);
            return;
        }
        ...
        if (((Boolean) zzwg.e().c(zzaav.B3)).booleanValue() && zzq.zzla().l() != null) {
            zzbbf.f6137a.execute(new i9(path));
        }
    }
    ...
    public final void f(zzuu zzuu, zzagi zzagi, zzo zzo, zzagk zzagk, zzt zzt, boolean z, zzahf zzahf, zzc zzc, zzaqc zzaqc, zzavr zzavr) {
        if (zzc == null) {
            zzc = new zzc(this.f6225a.getContext(), zzavr, (zzarx) null);
        }
        this.r = new zzapt(this.f6225a, zzaqc);
        this.s = zzavr;
        ...
        x("/refresh", zzagm.l);
        x("/canOpenApp", zzagm.f5691b);
        x("/canOpenURLs", zzagm.f5690a);
        x("/canOpenIntents", zzagm.f5692c);
        x("/click", zzagm.f5693d);
        x("/close", zzagm.f5694e);
        x("/customClose", zzagm.f5695f);
        ...
        x("/video", zzagm.m);
        x("/videoMeta", zzagm.n);
        if (zzq.zzlu().l(this.f6225a.getContext())) {
            x("/logScionEvent", new zzahe(this.f6225a.getContext()));
        }
        this.f6229e = zzuu;
        this.f6230f = zzo;
        this.i = zzagi;
    ...
    public final void g() {
        zztm zztm = this.f6226b;
        if (zztm != null) {
            zztm.a(zzto.zza.C0085zza.DELAY_PAGE_LOAD_CANCELLED_AD);
        }
        this.u = true;
        G();
    ...
    public final void j() {
        zzavr zzavr = this.s;
        if (zzavr != null) {
            WebView webView = this.f6225a.getWebView();
            if (t.H(webView)) {
                r(webView, zzavr, 10);
                return;
            }
            ...
            this.f6225a.getView().addOnAttachStateChangeListener(this.x);
        }
    }
    ...
    public final void m() {
        synchronized (this.f6228d) {
            this.k = false;
            this.l = true;
            zzbbf.f6141e.execute(new g9(this));
        }
    }
    ...
    public final void onPageFinished(android.webkit.WebView r1, java.lang.String r2) {
        /*
            r0 = this;
            java.lang.Object r1 = r0.f6228d
            monitor-enter(r1)
            com.google.android.gms.internal.ads.zzbfn r2 = r0.f6225a     // Catch:{ all -> 0x0029 }
    ...
    public boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        return this.f6225a.w(renderProcessGoneDetail.didCrash(), renderProcessGoneDetail.rendererPriorityAtExit());
    }
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        ...
        Uri parse = Uri.parse(str);
        if (!"gmsg".equalsIgnoreCase(parse.getScheme()) || !"mobileads.google.com".equalsIgnoreCase(parse.getHost())) {
            if (this.k && webView == this.f6225a.getWebView()) {
                String scheme = parse.getScheme();
                if ("http".equalsIgnoreCase(scheme) || "https".equalsIgnoreCase(scheme)) {
                    zzuu zzuu = this.f6229e;
                    if (zzuu != null) {
                        zzuu.onAdClicked();
                        zzavr zzavr = this.s;
                        if (zzavr != null) {
            ...
            if (!this.f6225a.getWebView().willNotDraw()) {
                try {
                    zzeg d2 = this.f6225a.d();
                    if (d2 != null && d2.f(parse)) {
                        parse = d2.b(parse, this.f6225a.getContext(), this.f6225a.getView(), this.f6225a.b());
                    }
                } catch (zzef unused) {
    ...
    public final void t(zzd zzd) {
        ...
        s(new AdOverlayInfoParcel(zzd, zzuu, zzo, this.o, this.f6225a.a()));
    }

    public final void w(String str, Predicate<zzahc<? super zzbfn>> predicate) {
        synchronized (this.f6228d) {
            List<zzahc> list = this.f6227c.get(str);
            if (list != null) {
