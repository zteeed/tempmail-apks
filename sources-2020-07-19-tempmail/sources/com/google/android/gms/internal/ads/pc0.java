...
final class pc0 {
    ...
    private static final int[] f4634a = {zzpo.l("isom"), zzpo.l("iso2"), zzpo.l("iso3"), zzpo.l("iso4"), zzpo.l("iso5"), zzpo.l("iso6"), zzpo.l("avc1"), zzpo.l("hvc1"), zzpo.l("hev1"), zzpo.l("mp41"), zzpo.l("mp42"), zzpo.l("3g2a"), zzpo.l("3g2b"), zzpo.l("3gr6"), zzpo.l("3gs6"), zzpo.l("3ge6"), zzpo.l("3gg6"), zzpo.l("M4V "), zzpo.l("M4A "), zzpo.l("f4v "), zzpo.l("kddi"), zzpo.l("M4VP"), zzpo.l("qt  "), zzpo.l("MSNV")};
    ...
    private static boolean a(zzjw zzjw, boolean z) throws IOException, InterruptedException {
        ...
        while (true) {
            ...
            zzpi.j(8);
            zzjw2.a(zzpi.f8980a, 0, 8);
            long s = zzpi.s();
            int d2 = zzpi.d();
            int i3 = 16;
            if (s == 1) {
                zzjw2.a(zzpi.f8980a, 8, 8);
                zzpi.k(16);
                s = zzpi.w();
            } else {
                i3 = 8;
