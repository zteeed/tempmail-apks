...
public final class zzash extends AbstractSafeParcelable {
    ...
    private ParcelFileDescriptor f5906b;

    /* renamed from: c  reason: collision with root package name */
    private Parcelable f5907c = null;
    ...
    public zzash(@SafeParcelable.Param(id = 2) ParcelFileDescriptor parcelFileDescriptor) {
        this.f5906b = parcelFileDescriptor;
    }
    ...
    private static <T> ParcelFileDescriptor A(byte[] bArr) {
        ...
        try {
            ...
            try {
                zzbbf.f6137a.execute(new t3(autoCloseOutputStream, bArr));
                return createPipe[0];
    ...
    private final ParcelFileDescriptor B() {
        if (this.f5906b == null) {
            ...
            try {
                this.f5907c.writeToParcel(obtain, 0);
                byte[] marshall = obtain.marshall();
                obtain.recycle();
                this.f5906b = A(marshall);
            } catch (Throwable th) {
                obtain.recycle();
                throw th;
            }
    ...
    public final <T extends SafeParcelable> T u(Parcelable.Creator<T> creator) {
        if (this.f5908d) {
            ...
            DataInputStream dataInputStream = new DataInputStream(new ParcelFileDescriptor.AutoCloseInputStream(this.f5906b));
            try {
                ...
                try {
                    ...
                    this.f5907c = (Parcelable) creator.createFromParcel(obtain);
                    obtain.recycle();
                    this.f5908d = false;
                } catch (Throwable th) {
                    obtain.recycle();
        ...
        return (SafeParcelable) this.f5907c;
    }

    public final void writeToParcel(Parcel parcel, int i) {
        B();
        int a2 = SafeParcelWriter.a(parcel);
        SafeParcelWriter.r(parcel, 2, this.f5906b, i, false);
