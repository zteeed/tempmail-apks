...
public final class zzapn implements MediationInterstitialAdapter {
    ...
    public Activity f5833a;
    /* access modifiers changed from: private */

    /* renamed from: b  reason: collision with root package name */
    public MediationInterstitialListener f5834b;
    ...
    public final void requestInterstitialAd(Context context, MediationInterstitialListener mediationInterstitialListener, Bundle bundle, MediationAdRequest mediationAdRequest, Bundle bundle2) {
        this.f5834b = mediationInterstitialListener;
        if (mediationInterstitialListener == null) {
            ...
            this.f5834b.onAdFailedToLoad(this, 0);
        } else {
            ...
            this.f5833a = (Activity) context;
            this.f5835c = Uri.parse(string);
            this.f5834b.onAdLoaded(this);
        }
    }

    public final void showInterstitial() {
        a a2 = new a.C0004a().a();
        a2.f96a.setData(this.f5835c);
        zzaye.h.post(new e3(this, new AdOverlayInfoParcel(new zzd(a2.f96a), (zzuu) null, new d3(this), (zzt) null, new zzbbd(0, 0, false))));
        zzq.zzla().n();
    }
}
