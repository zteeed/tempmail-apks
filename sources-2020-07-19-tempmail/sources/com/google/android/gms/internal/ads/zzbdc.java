...
public final class zzbdc {
    ...
    public zzbdc(String str) {
        ...
        this.f6170a = a(jSONObject, "aggressive_media_codec_release", zzaav.z);
        this.f6171b = c(jSONObject, "byte_buffer_precache_limit", zzaav.h);
        this.f6172c = c(jSONObject, "exo_cache_buffer_size", zzaav.o);
        this.f6173d = c(jSONObject, "exo_connect_timeout_millis", zzaav.f5533d);
        d(jSONObject, "exo_player_version", zzaav.f5532c);
        this.f6174e = c(jSONObject, "exo_read_timeout_millis", zzaav.f5534e);
        this.f6175f = c(jSONObject, "load_check_interval_bytes", zzaav.f5535f);
