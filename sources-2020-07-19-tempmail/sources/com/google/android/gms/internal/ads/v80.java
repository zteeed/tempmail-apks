...
final class v80 {
    ...
    private static final Logger f5117a = Logger.getLogger(v80.class.getName());

    /* renamed from: b  reason: collision with root package name */
    private static final Unsafe f5118b = o();

    /* renamed from: c  reason: collision with root package name */
    private static final Class<?> f5119c = l50.b();

    /* renamed from: d  reason: collision with root package name */
    private static final boolean f5120d = C(Long.TYPE);

    /* renamed from: e  reason: collision with root package name */
    private static final boolean f5121e = C(Integer.TYPE);

    /* renamed from: f  reason: collision with root package name */
    private static final d f5122f;
    ...
    static final class b extends d {
        ...
        public final void a(Object obj, long j, double d2) {
            this.f5123a.putDouble(obj, j, d2);
        }

        public final void b(Object obj, long j, float f2) {
            this.f5123a.putFloat(obj, j, f2);
        }

        public final void d(Object obj, long j, boolean z) {
            this.f5123a.putBoolean(obj, j, z);
        }

        public final void f(Object obj, long j, byte b2) {
            this.f5123a.putByte(obj, j, b2);
        }

        public final boolean i(Object obj, long j) {
            return this.f5123a.getBoolean(obj, j);
        }

        public final float j(Object obj, long j) {
            return this.f5123a.getFloat(obj, j);
        }

        public final double k(Object obj, long j) {
            return this.f5123a.getDouble(obj, j);
        }

        public final byte l(Object obj, long j) {
            return this.f5123a.getByte(obj, j);
        }
    }
    ...
    static {
        ...
        A(cls);
        Field r = r();
        if (!(r == null || (dVar = f5122f) == null)) {
            dVar.f5123a.objectFieldOffset(r);
        }
    }
    ...
    private static int A(Class<?> cls) {
        if (h) {
            return f5122f.f5123a.arrayIndexScale(cls);
        }
        return -1;
    }

    static long B(Object obj, long j2) {
        return f5122f.h(obj, j2);
    }
    ...
    static boolean D(Object obj, long j2) {
        return f5122f.i(obj, j2);
    }

    static float E(Object obj, long j2) {
        return f5122f.j(obj, j2);
    }

    static double F(Object obj, long j2) {
        return f5122f.k(obj, j2);
    }

    static Object G(Object obj, long j2) {
        return f5122f.f5123a.getObject(obj, j2);
    }
    ...
    static void f(Object obj, long j2, Object obj2) {
        f5122f.f5123a.putObject(obj, j2, obj2);
    }
    ...
    static <T> T x(Class<T> cls) {
        try {
            return f5118b.allocateInstance(cls);
    ...
    private static int y(Class<?> cls) {
        if (h) {
            return f5122f.f5123a.arrayBaseOffset(cls);
        }
        return -1;
    }

    static int z(Object obj, long j2) {
        return f5122f.g(obj, j2);
    }
}
