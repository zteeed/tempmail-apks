...
public final class zzajg extends zzajt<zzalf> implements zzajp, zzaju {
    ...
    public zzajg(Context context, zzbbd zzbbd) throws zzbfz {
        try {
            ...
            this.f5747d.addJavascriptInterface(new y0(this), "GoogleJsInterface");
            zzq.zzkw().k(context, zzbbd.f6131b, this.f5747d.getSettings());
            super.k0(this);
        } catch (Throwable th) {
    ...
    public final /* synthetic */ void F0(String str) {
        this.f5747d.loadUrl(str);
    }

    /* access modifiers changed from: package-private */
    public final /* synthetic */ void G0(String str) {
        this.f5747d.loadData(str, "text/html", "UTF-8");
    }
    ...
    public final void Q(String str) {
        zzbbf.f6141e.execute(new u0(this, str));
    }
    ...
    public final void f(String str) {
        zzbbf.f6141e.execute(new w0(this, str));
    }

    public final void g0(String str) {
        zzbbf.f6141e.execute(new t0(this, str));
    }
