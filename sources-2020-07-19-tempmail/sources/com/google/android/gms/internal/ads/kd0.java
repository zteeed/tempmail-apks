...
final class kd0 implements zzmy, zzmz {
    ...
    public final zzmz[] f4207b;

    /* renamed from: c  reason: collision with root package name */
    private final IdentityHashMap<zznk, Integer> f4208c = new IdentityHashMap<>();
    ...
    public final void c(zzmz zzmz) {
        ...
        if (i <= 0) {
            int i2 = 0;
            for (zzmz q : this.f4207b) {
                i2 += q.q().f8913a;
            }
            zzno[] zznoArr = new zzno[i2];
            int i3 = 0;
            for (zzmz q2 : this.f4207b) {
                zznr q3 = q2.q();
                int i4 = q3.f8913a;
                int i5 = 0;
                while (i5 < i4) {
    ...
    public final long d(zzod[] zzodArr, boolean[] zArr, zznk[] zznkArr, boolean[] zArr2, long j) {
        ...
        for (int i2 = 0; i2 < zzodArr2.length; i2++) {
            if (zznkArr2[i2] == null) {
                ...
                i = this.f4208c.get(zznkArr2[i2]).intValue();
            }
            iArr[i2] = i;
            iArr2[i2] = -1;
            if (zzodArr2[i2] != null) {
        ...
        ArrayList arrayList = new ArrayList(this.f4207b.length);
        long j2 = j;
        int i4 = 0;
        while (i4 < this.f4207b.length) {
            ...
            long d2 = this.f4207b[i4].d(zzodArr3, zArr, zznkArr4, zArr2, j2);
            if (i6 == 0) {
                j2 = d2;
            } else if (d2 != j2) {
            ...
            for (int i7 = 0; i7 < zzodArr2.length; i7++) {
                ...
                if (iArr2[i7] == i6) {
                    ...
                    this.f4208c.put(zznkArr4[i7], Integer.valueOf(i6));
                    z = true;
                } else if (iArr[i7] == i6) {
                    if (zznkArr4[i7] != null) {
                        z2 = false;
            ...
            if (i >= zzmzArr.length) {
                if (m != -9223372036854775807L) {
                    ...
                    while (i2 < length) {
                        ...
                        if (zzmz == this.f4207b[0] || zzmz.j(m) == m) {
                            i2++;
                        } else {
                            throw new IllegalStateException("Children seeked to different positions");
                        }
