...
public final class zzkn implements zzjx {
    ...
    private final ub0 f8815a;

    /* renamed from: b  reason: collision with root package name */
    private final yb0 f8816b;

    /* renamed from: c  reason: collision with root package name */
    private final SparseArray<wb0> f8817c;

    /* renamed from: d  reason: collision with root package name */
    private final boolean f8818d;

    /* renamed from: e  reason: collision with root package name */
    private final zzpi f8819e;

    /* renamed from: f  reason: collision with root package name */
    private final zzpi f8820f;
    ...
    private final void i(zzjw zzjw, wb0 wb0, int i2) throws IOException, InterruptedException {
        int i3;
        if ("S_TEXT/UTF8".equals(wb0.f5217a)) {
            int length = Z.length + i2;
            if (this.k.a() < length) {
                this.k.f8980a = Arrays.copyOf(Z, length + i2);
            }
            zzjw.b(this.k.f8980a, Z.length, i2);
            this.k.l(0);
            this.k.k(length);
            return;
        }
        ...
        if (!this.O) {
            if (wb0.f5221e) {
                ...
                int i4 = 128;
                if (!this.P) {
                    zzjw.b(this.g.f8980a, 0, 1);
                    this.N++;
                    byte[] bArr = this.g.f8980a;
                    if ((bArr[0] & 128) != 128) {
                        this.S = bArr[0];
                        this.P = true;
                    } else {
                ...
                if ((b2 & 1) == 1) {
                    ...
                    this.M |= 1073741824;
                    if (!this.Q) {
                        zzjw.b(this.l.f8980a, 0, 8);
                        this.N += 8;
                        this.Q = true;
                        byte[] bArr2 = this.g.f8980a;
                        if (!z2) {
                            i4 = 0;
                        }
                        bArr2[0] = (byte) (i4 | 8);
        ...
        int c2 = i2 + this.j.c();
        if (!"V_MPEG4/ISO/AVC".equals(wb0.f5217a) && !"V_MPEGH/ISO/HEVC".equals(wb0.f5217a)) {
            while (true) {
                int i10 = this.N;
                if (i10 >= c2) {
                    break;
            ...
            while (this.N < c2) {
                ...
                if (i13 == 0) {
                    ...
                    this.N += i11;
                    this.f8820f.l(0);
                    this.U = this.f8820f.v();
                    this.f8819e.l(0);
                    zzke.a(this.f8819e, 4);
                    this.V += 4;
                } else {
    ...
    private final void o(zzjw zzjw, int i2) throws IOException, InterruptedException {
        if (this.g.c() < i2) {
            ...
            zzpi zzpi2 = this.g;
            zzjw.b(zzpi2.f8980a, zzpi2.c(), i2 - this.g.c());
            this.g.k(i2);
        }
    }
    ...
    public final int c(com.google.android.gms.internal.ads.zzjw r9, com.google.android.gms.internal.ads.zzkd r10) throws java.io.IOException, java.lang.InterruptedException {
        ...
        L_0x0005:
            ...
            com.google.android.gms.internal.ads.ub0 r2 = r8.f8815a
            boolean r2 = r2.c(r9)
    ...
    public final void g(int r22, int r23, com.google.android.gms.internal.ads.zzjw r24) throws java.io.IOException, java.lang.InterruptedException {
        ...
        L_0x008b:
            ...
            com.google.android.gms.internal.ads.yb0 r4 = r0.f8816b
            ...
            r4.i()
        L_0x00b0:
            android.util.SparseArray<com.google.android.gms.internal.ads.wb0> r4 = r0.f8817c
            int r9 = r0.K
    ...
    public final void n(int i2) throws zzht {
        ...
        if (i2 != 160) {
            if (i2 == 174) {
                String str = this.t.f5217a;
                if ("V_VP8".equals(str) || "V_VP9".equals(str) || "V_MPEG2".equals(str) || "V_MPEG4/ISO/SP".equals(str) || "V_MPEG4/ISO/ASP".equals(str) || "V_MPEG4/ISO/AP".equals(str) || "V_MPEG4/ISO/AVC".equals(str) || "V_MPEGH/ISO/HEVC".equals(str) || "V_MS/VFW/FOURCC".equals(str) || "V_THEORA".equals(str) || "A_OPUS".equals(str) || "A_VORBIS".equals(str) || "A_AAC".equals(str) || "A_MPEG/L2".equals(str) || "A_MPEG/L3".equals(str) || "A_AC3".equals(str) || "A_EAC3".equals(str) || "A_TRUEHD".equals(str) || "A_DTS".equals(str) || "A_DTS/EXPRESS".equals(str) || "A_DTS/LOSSLESS".equals(str) || "A_FLAC".equals(str) || "A_MS/ACM".equals(str) || "A_PCM/INT/LIT".equals(str) || "S_TEXT/UTF8".equals(str) || "S_VOBSUB".equals(str) || "S_HDMV/PGS".equals(str) || "S_DVBSUB".equals(str)) {
                    i4 = 1;
                }
                if (i4 != 0) {
                    wb0 wb0 = this.t;
                    wb0.c(this.Y, wb0.f5218b);
                    SparseArray<wb0> sparseArray = this.f8817c;
                    wb0 wb02 = this.t;
                    sparseArray.put(wb02.f5218b, wb02);
                }
                this.t = null;
            } else if (i2 == 19899) {
                int i5 = this.v;
                ...
                if (wb03.g != null) {
                    wb03.i = new zzjl(new zzjl.zza(zzhc.f8720b, "video/webm", this.t.g.f8814b));
                    return;
                }
                throw new zzht("Encrypted Track found but ContentEncKeyID was not found");
            } else if (i2 == 28032) {
                wb0 wb04 = this.t;
                if (wb04.f5221e && wb04.f5222f != null) {
            ...
            j(this.f8817c.get(this.K), this.F);
            this.E = 0;
        }
    }
    ...
    private zzkn(ub0 ub0, int i2) {
        ...
        this.f8818d = true;
        this.f8816b = new yb0();
        this.f8817c = new SparseArray<>();
        this.g = new zzpi(4);
        this.h = new zzpi(ByteBuffer.allocate(4).putInt(-1).array());
        this.i = new zzpi(4);
        this.f8819e = new zzpi(zzph.f8976a);
        this.f8820f = new zzpi(4);
        this.j = new zzpi();
        this.k = new zzpi();
        this.l = new zzpi(8);
        this.m = new zzpi();
