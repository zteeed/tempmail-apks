...
public final class zzbac {
    ...
    private HandlerThread f6089a = null;

    /* renamed from: b  reason: collision with root package name */
    private Handler f6090b = null;
    ...
    public final Looper b() {
        ...
        synchronized (this.f6092d) {
            if (this.f6091c != 0) {
                Preconditions.l(this.f6089a, "Invalid state: mHandlerThread should already been initialized.");
            } else if (this.f6089a == null) {
                zzaxv.m("Starting the looper thread.");
                HandlerThread handlerThread = new HandlerThread("LooperProvider");
                this.f6089a = handlerThread;
                handlerThread.start();
                this.f6090b = new zzdrr(this.f6089a.getLooper());
                zzaxv.m("Looper thread started.");
            } else {
                zzaxv.m("Resuming the looper thread");
                this.f6092d.notifyAll();
            }
            this.f6091c++;
            looper = this.f6089a.getLooper();
        }
        return looper;
    }
}
