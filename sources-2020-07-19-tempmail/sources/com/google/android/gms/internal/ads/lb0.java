...
final class lb0 implements zzig {
    ...
    public lb0() {
        ...
        this.f4291e = byteBuffer;
        this.f4292f = byteBuffer;
    }

    public final void a() {
        flush();
        this.f4291e = zzig.f8760a;
        this.f4288b = -1;
        this.f4289c = -1;
        this.f4290d = 0;
    }
    ...
    public final boolean b() {
        return this.g && this.f4292f == zzig.f8760a;
    }

    public final ByteBuffer c() {
        ByteBuffer byteBuffer = this.f4292f;
        this.f4292f = zzig.f8760a;
        return byteBuffer;
    }
    ...
    public final void d(java.nio.ByteBuffer r8) {
        ...
        L_0x0021:
            int r2 = r2 << 1
        L_0x0023:
            java.nio.ByteBuffer r3 = r7.f4291e
            int r3 = r3.capacity()
            ...
            goto L_0x003f
        L_0x003a:
            java.nio.ByteBuffer r2 = r7.f4291e
            r2.clear()
        L_0x003f:
            int r2 = r7.f4290d
        ...
        L_0x009c:
            int r0 = r8.limit()
            r8.position(r0)
            java.nio.ByteBuffer r8 = r7.f4291e
            r8.flip()
            java.nio.ByteBuffer r8 = r7.f4291e
            r7.f4292f = r8
            return
    ...
    public final boolean f(int i, int i2, int i3) throws zzif {
        ...
        } else if (this.f4288b == i && this.f4289c == i2 && this.f4290d == i3) {
            return false;
        } else {
            this.f4288b = i;
            this.f4289c = i2;
