...
public final class zzys {
    ...
    private final zzamo f9242a;

    /* renamed from: b  reason: collision with root package name */
    private final AtomicBoolean f9243b;
    /* access modifiers changed from: private */

    /* renamed from: c  reason: collision with root package name */
    public final VideoController f9244c;
    @VisibleForTesting

    /* renamed from: d  reason: collision with root package name */
    private final zzwf f9245d;

    /* renamed from: e  reason: collision with root package name */
    private zzuu f9246e;

    /* renamed from: f  reason: collision with root package name */
    private AdListener f9247f;
    private AdSize[] g;
    ...
    public zzys(ViewGroup viewGroup) {
        this(viewGroup, (AttributeSet) null, false, zzvf.f9188a, 0);
    }
    ...
    public final void A(zzyq zzyq) {
        ...
        try {
            if (this.i == null) {
                ...
                if ("search_v2".equals(y.f9189b)) {
                    zzww = (zzww) new ig0(zzwg.b(), context, y, this.l).b(context, false);
                } else {
                    zzww = (zzww) new cg0(zzwg.b(), context, y, this.l, this.f9242a).b(context, false);
                }
                this.i = zzww;
                zzww.zza((zzwj) new zzva(this.f9245d));
                if (this.f9246e != null) {
                    this.i.zza((zzwi) new zzut(this.f9246e));
                }
                if (this.h != null) {
                ...
                try {
                    ...
                    if (zzkf != null) {
                        this.m.addView((View) ObjectWrapper.P(zzkf));
                    }
    ...
    public final boolean C(zzww zzww) {
        ...
        try {
            ...
            if (zzkf == null || ((View) ObjectWrapper.P(zzkf)).getParent() != null) {
                return false;
            }
            this.m.addView((View) ObjectWrapper.P(zzkf));
            this.i = zzww;
    ...
    public final void p(AdListener adListener) {
        this.f9247f = adListener;
        this.f9245d.a(adListener);
    }
    ...
    public zzys(ViewGroup viewGroup, int i2) {
        this(viewGroup, (AttributeSet) null, false, zzvf.f9188a, i2);
    }

    public zzys(ViewGroup viewGroup, AttributeSet attributeSet, boolean z) {
        this(viewGroup, attributeSet, z, zzvf.f9188a, 0);
    }

    public zzys(ViewGroup viewGroup, AttributeSet attributeSet, boolean z, int i2) {
        this(viewGroup, attributeSet, false, zzvf.f9188a, i2);
    }

    @VisibleForTesting
    private zzys(ViewGroup viewGroup, AttributeSet attributeSet, boolean z, zzvf zzvf, zzww zzww, int i2) {
        zzvh zzvh;
        this.f9242a = new zzamo();
        this.f9244c = new VideoController();
        this.f9245d = new pg0(this);
        this.m = viewGroup;
        this.i = null;
        this.f9243b = new AtomicBoolean(false);
        this.n = i2;
