...
public final class zzb {
    ...
    private static java.security.cert.X509Certificate[] f(java.nio.ByteBuffer r22, java.util.Map<java.lang.Integer, byte[]> r23, java.security.cert.CertificateFactory r24) throws java.lang.SecurityException, java.io.IOException {
        /*
            java.nio.ByteBuffer r0 = b(r22)
            java.nio.ByteBuffer r1 = b(r22)
            byte[] r2 = k(r22)
        ...
        L_0x0015:
            ...
            int r8 = r8 + 1
            java.nio.ByteBuffer r10 = b(r1)     // Catch:{ IOException -> 0x00be, BufferUnderflowException -> 0x00bc }
        ...
        L_0x004a:
            ...
            int r11 = a(r6)     // Catch:{ IOException -> 0x00be, BufferUnderflowException -> 0x00bc }
            int r12 = a(r7)     // Catch:{ IOException -> 0x00be, BufferUnderflowException -> 0x00bc }
        ...
        L_0x00ac:
            byte[] r5 = k(r10)     // Catch:{ IOException -> 0x00be, BufferUnderflowException -> 0x00bc }
            r9 = r5
            r7 = r6
            goto L_0x0015
        L_0x00b4:
        ...
        L_0x01d7:
            ...
            int r6 = r6 + r15
            java.nio.ByteBuffer r8 = b(r1)     // Catch:{ IOException -> 0x0204, BufferUnderflowException -> 0x0202 }
            ...
            byte[] r5 = k(r8)     // Catch:{ IOException -> 0x0204, BufferUnderflowException -> 0x0202 }
            goto L_0x01d7
        L_0x01fa:
        ...
        L_0x025b:
            ...
            com.google.android.gms.internal.ads.la0 r7 = new com.google.android.gms.internal.ads.la0
            r7.<init>(r5, r4)
            r1.add(r7)
            goto L_0x025b
        L_0x027c:
        ...
        L_0x02ef:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzb.f(java.nio.ByteBuffer, java.util.Map, java.security.cert.CertificateFactory):java.security.cert.X509Certificate[]");
    }

    private static byte[][] g(int[] iArr, ng[] ngVarArr) throws DigestException {
        long j;
        int[] iArr2 = iArr;
        ng[] ngVarArr2 = ngVarArr;
        int length = ngVarArr2.length;
        long j2 = 0;
        int i = 0;
        long j3 = 0;
        int i2 = 0;
        while (true) {
            ...
            j3 += ((ngVarArr2[i2].size() + PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED) - 1) / PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED;
            i2++;
        }
        if (j3 < 2097151) {
            int i3 = (int) j3;
            ...
            for (int i4 = 0; i4 < iArr2.length; i4++) {
                byte[] bArr2 = new byte[((l(iArr2[i4]) * i3) + 5)];
                bArr2[0] = 90;
                e(i3, bArr2, 1);
                bArr[i4] = bArr2;
            }
            ...
            while (i5 < iArr2.length) {
                String j4 = j(iArr2[i5]);
                try {
                    messageDigestArr[i5] = MessageDigest.getInstance(j4);
                    i5++;
                } catch (NoSuchAlgorithmException e2) {
                    throw new RuntimeException(String.valueOf(j4).concat(" digest not supported"), e2);
                }
            }
            int length3 = ngVarArr2.length;
            int i6 = 0;
            int i7 = 0;
            while (i6 < length3) {
                ng ngVar = ngVarArr2[i6];
                long j5 = j2;
                int i8 = i7;
                int i9 = length3;
                long size = ngVar.size();
                while (size > j2) {
                    ...
                    long j6 = j5;
                    try {
                        ngVar.a(messageDigestArr, j6, min);
                        int i11 = 0;
                        while (i11 < iArr2.length) {
                            ...
                            int i14 = i8;
                            ng ngVar2 = ngVar;
                            int digest = messageDigest.digest(bArr5, (i14 * l) + 5, l);
                            if (digest == l) {
                                i11++;
                                i8 = i14;
                                bArr3 = bArr4;
            ...
            while (i17 < iArr2.length) {
                ...
                String j9 = j(i18);
                try {
                    bArr7[i17] = MessageDigest.getInstance(j9).digest(bArr8);
                    i17++;
                } catch (NoSuchAlgorithmException e4) {
                    throw new RuntimeException(String.valueOf(j9).concat(" digest not supported"), e4);
                }
            }
            return bArr7;
        }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static java.security.cert.X509Certificate[][] h(java.lang.String r18) throws com.google.android.gms.internal.ads.zzh, java.lang.SecurityException, java.io.IOException {
        /*
            java.io.RandomAccessFile r1 = new java.io.RandomAccessFile
            java.lang.String r0 = "r"
            r2 = r18
            r1.<init>(r2, r0)
            android.util.Pair r0 = com.google.android.gms.internal.ads.zzi.a(r1)     // Catch:{ all -> 0x0292 }
        ...
        L_0x0037:
            ...
            long r7 = com.google.android.gms.internal.ads.zzi.e(r11)     // Catch:{ all -> 0x0292 }
            int r2 = (r7 > r9 ? 1 : (r7 == r9 ? 0 : -1))
            if (r2 >= 0) goto L_0x0247
            long r2 = com.google.android.gms.internal.ads.zzi.f(r11)     // Catch:{ all -> 0x0292 }
            long r2 = r2 + r7
            ...
            int r3 = r3 - r5
            r2 = 8
            java.nio.ByteBuffer r3 = d(r4, r2, r3)     // Catch:{ all -> 0x0292 }
        L_0x00fe:
            ...
            int r5 = r5 + -4
            java.nio.ByteBuffer r4 = c(r3, r5)     // Catch:{ all -> 0x0292 }
            com.google.android.gms.internal.ads.r30 r0 = new com.google.android.gms.internal.ads.r30     // Catch:{ all -> 0x0292 }
            r2 = 0
            r3 = r0
            r5 = r12
            r12 = r2
            ...
            java.security.cert.X509Certificate[][] r0 = i(r2, r0)     // Catch:{ all -> 0x0292 }
        ...
        L_0x0296:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzb.h(java.lang.String):java.security.cert.X509Certificate[][]");
    }

    private static X509Certificate[][] i(FileChannel fileChannel, r30 r30) throws SecurityException {
        HashMap hashMap = new HashMap();
        ArrayList arrayList = new ArrayList();
        try {
            CertificateFactory instance = CertificateFactory.getInstance("X.509");
            try {
                ByteBuffer b2 = b(r30.f4775a);
                int i = 0;
                int i2 = 0;
                while (b2.hasRemaining()) {
                    i2++;
                    try {
                        arrayList.add(f(b(b2), hashMap, instance));
                ...
                if (i2 <= 0) {
                    ...
                    long c2 = r30.f4777c;
                    long d2 = r30.f4778d;
                    ByteBuffer e3 = r30.f4779e;
                    if (!hashMap.isEmpty()) {
                        FileChannel fileChannel2 = fileChannel;
                        da0 da0 = new da0(fileChannel2, 0, b3);
                        da0 da02 = new da0(fileChannel2, c2, d2 - c2);
                        ByteBuffer duplicate = e3.duplicate();
                        duplicate.order(ByteOrder.LITTLE_ENDIAN);
                        zzi.c(duplicate, b3);
                        pr prVar = new pr(duplicate);
                        ...
                        try {
                            byte[][] g = g(iArr, new ng[]{da0, da02, prVar});
                            while (i < size) {
                                int i4 = iArr[i];
                                if (MessageDigest.isEqual((byte[]) hashMap.get(Integer.valueOf(i4)), g[i])) {
                                    i++;
                                } else {
                                    throw new SecurityException(String.valueOf(j(i4)).concat(" digest of contents did not verify"));
                                }
                            }
