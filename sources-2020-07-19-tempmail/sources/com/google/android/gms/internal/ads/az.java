...
final class az implements zzdpp {
    ...
    private final zzdrc f3409b;

    /* renamed from: c  reason: collision with root package name */
    private final zzdrl f3410c;

    /* renamed from: d  reason: collision with root package name */
    private final zzdpm f3411d;
    ...
    private final synchronized byte[] i(Map<String, String> map, Map<String, Object> map2) {
        ...
        try {
            ...
            this.f3411d.b(2007, System.currentTimeMillis() - currentTimeMillis, e2);
            return null;
        }
        return (byte[]) this.f3408a.getClass().getDeclaredMethod("xss", new Class[]{Map.class, Map.class}).invoke(this.f3408a, new Object[]{null, map2});
    }
    ...
    public final synchronized void a(String str, MotionEvent motionEvent) throws zzdrj {
        try {
            ...
            this.f3408a.getClass().getDeclaredMethod("he", new Class[]{Map.class}).invoke(this.f3408a, new Object[]{hashMap});
            this.f3411d.h(3003, System.currentTimeMillis() - currentTimeMillis);
        } catch (Exception e2) {
    ...
    public final synchronized void e() throws zzdrj {
        try {
            long currentTimeMillis = System.currentTimeMillis();
            this.f3408a.getClass().getDeclaredMethod("close", new Class[0]).invoke(this.f3408a, new Object[0]);
            this.f3411d.h(3001, System.currentTimeMillis() - currentTimeMillis);
        } catch (Exception e2) {
    ...
    public final synchronized boolean g() throws zzdrj {
        ...
        return ((Boolean) this.f3408a.getClass().getDeclaredMethod("init", new Class[0]).invoke(this.f3408a, new Object[0])).booleanValue();
    }
    ...
    public final synchronized int h() throws zzdrj {
        ...
        return ((Integer) this.f3408a.getClass().getDeclaredMethod("lcs", new Class[0]).invoke(this.f3408a, new Object[0])).intValue();
    }
}
