...
public final class zzsq {
    ...
    private final Runnable f9093a = new bf0(this);
    ...
    public final void a() {
        /*
            r3 = this;
            java.lang.Object r0 = r3.f9094b
            monitor-enter(r0)
            android.content.Context r1 = r3.f9096d     // Catch:{ all -> 0x0023 }
            if (r1 == 0) goto L_0x0021
            com.google.android.gms.internal.ads.zzsz r1 = r3.f9095c     // Catch:{ all -> 0x0023 }
    ...
    public final void b() {
        synchronized (this.f9094b) {
            if (this.f9095c != null) {
                if (this.f9095c.isConnected() || this.f9095c.isConnecting()) {
                    this.f9095c.disconnect();
                }
                this.f9095c = null;
                this.f9097e = null;
    ...
    private final synchronized zzsz e(BaseGmsClient.BaseConnectionCallbacks baseConnectionCallbacks, BaseGmsClient.BaseOnConnectionFailedListener baseOnConnectionFailedListener) {
        return new zzsz(this.f9096d, zzq.zzlk().b(), baseConnectionCallbacks, baseOnConnectionFailedListener);
    }
    ...
    public final void c(android.content.Context r3) {
        /*
            ...
            return
        L_0x0003:
            java.lang.Object r0 = r2.f9094b
            monitor-enter(r0)
            android.content.Context r1 = r2.f9096d     // Catch:{ all -> 0x0048 }
            if (r1 == 0) goto L_0x000c
            monitor-exit(r0)     // Catch:{ all -> 0x0048 }
            return
        L_0x000c:
            android.content.Context r3 = r3.getApplicationContext()     // Catch:{ all -> 0x0048 }
            r2.f9096d = r3     // Catch:{ all -> 0x0048 }
    ...
    public final void l() {
        if (((Boolean) zzwg.e().c(zzaav.M1)).booleanValue()) {
            synchronized (this.f9094b) {
                a();
                zzq.zzkw();
                zzaye.h.removeCallbacks(this.f9093a);
                zzq.zzkw();
                zzaye.h.postDelayed(this.f9093a, ((Long) zzwg.e().c(zzaav.N1)).longValue());
            }
        }
    }
}
