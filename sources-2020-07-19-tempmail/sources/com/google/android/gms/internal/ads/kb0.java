...
final class kb0 {
    ...
    private final void g(int i2) {
        ...
        if (i3 > i4) {
            int i5 = i4 + (i4 / 2) + i2;
            this.g = i5;
            this.h = Arrays.copyOf(this.h, i5 * this.f4200b);
        }
    }

    private final void i(short[] sArr, int i2, int i3) {
        int i4 = this.f4203e / i3;
        int i5 = this.f4200b;
        int i6 = i3 * i5;
        int i7 = i2 * i5;
    ...
    private final void l() {
        ...
        if (d2 > 1.00001d || d2 < 0.99999d) {
            ...
            if (i10 >= this.f4203e) {
                ...
                while (true) {
                    int i12 = this.t;
                    if (i12 > 0) {
                        int min = Math.min(this.f4203e, i12);
                        f(this.h, i11, min);
                        this.t -= min;
                        i11 += min;
                    } else {
                        ...
                        if (this.f4200b == i9 && i14 == i9) {
                            i5 = b(sArr, i11, this.f4201c, this.f4202d);
                        } else {
                            i(sArr, i11, i14);
                            int b2 = b(this.f4204f, 0, this.f4201c / i14, this.f4202d / i14);
                            if (i14 != i9) {
                                int i15 = b2 * i14;
                                int i16 = i14 << 2;
                                int i17 = i15 - i16;
                        ...
                        if (d2 > 1.0d) {
                            ...
                            m(i7);
                            int i23 = i7;
                            d(i7, this.f4200b, this.j, this.r, sArr2, i11, sArr2, i11 + i22);
                            this.r += i23;
                            i11 += i22 + i23;
                        } else {
                            int i24 = i22;
                            ...
                            d(i6, this.f4200b, this.j, this.r + i24, sArr3, i24 + i11, sArr3, i11);
                            this.r += i25;
                            i11 += i6;
                        }
                    }
                    if (this.f4203e + i11 > i10) {
                        break;
                    }
                    i9 = 1;
                }
        ...
        if (f3 != 1.0f && this.r != i8) {
            ...
            if (i32 > i33) {
                ...
                this.k = i34;
                this.l = Arrays.copyOf(this.l, i34 * this.f4200b);
            }
            short[] sArr5 = this.j;
            int i35 = this.f4200b;
    ...
    private final void m(int i2) {
        ...
        if (i3 > i4) {
            int i5 = i4 + (i4 / 2) + i2;
            this.i = i5;
            this.j = Arrays.copyOf(this.j, i5 * this.f4200b);
        }
    }
    ...
    public final void e(ShortBuffer shortBuffer) {
        ...
        int i3 = remaining / i2;
        g(i3);
        shortBuffer.get(this.h, this.q * this.f4200b, ((i2 * i3) << 1) / 2);
        this.q += i3;
        l();
    }

    public final void h(ShortBuffer shortBuffer) {
        int min = Math.min(shortBuffer.remaining() / this.f4200b, this.r);
        shortBuffer.put(this.j, 0, this.f4200b * min);
        int i2 = this.r - min;
        this.r = i2;
        short[] sArr = this.j;
        int i3 = this.f4200b;
