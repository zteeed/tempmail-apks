...
public final class zziq {
    ...
    private final zzid f8763a = null;
    private int a0;

    /* renamed from: b  reason: collision with root package name */
    private final gb0 f8764b;
    private boolean b0;

    /* renamed from: c  reason: collision with root package name */
    private final zzjg f8765c;
    private boolean c0;

    /* renamed from: d  reason: collision with root package name */
    private final zzig[] f8766d;
    private long d0;

    /* renamed from: e  reason: collision with root package name */
    private final zziw f8767e;
    /* access modifiers changed from: private */

    /* renamed from: f  reason: collision with root package name */
    public final ConditionVariable f8768f;
    ...
    public zziq(zzid zzid, zzig[] zzigArr, zziw zziw) {
        this.f8767e = zziw;
        this.f8768f = new ConditionVariable(true);
        if (zzpo.f8995a >= 18) {
            try {
        ...
        this.f8764b = new gb0();
        this.f8765c = new zzjg();
        zzig[] zzigArr2 = new zzig[(zzigArr.length + 3)];
        this.f8766d = zzigArr2;
        zzigArr2[0] = new lb0();
        zzig[] zzigArr3 = this.f8766d;
        zzigArr3[1] = this.f8764b;
        System.arraycopy(zzigArr, 0, zzigArr3, 2, zzigArr.length);
        this.f8766d[zzigArr.length + 2] = this.f8765c;
        this.g = new long[10];
        this.Q = 1.0f;
        this.M = 0;
        this.o = 3;
    ...
    private final boolean n(java.nio.ByteBuffer r9, long r10) throws com.google.android.gms.internal.ads.zziy {
        ...
        L_0x003b:
            int r0 = r9.remaining()
            int r4 = com.google.android.gms.internal.ads.zzpo.f8995a
    ...
    public final long D(boolean z2) {
        ...
        long j6 = this.N;
        while (!this.i.isEmpty() && j2 >= this.i.getFirst().f3782c) {
            fb0 remove = this.i.remove();
            this.t = remove.f3780a;
            this.v = remove.f3782c;
            this.u = remove.f3781b - this.N;
        }
        if (this.t.f8739a == 1.0f) {
            j3 = (j2 + this.u) - this.v;
        } else {
            if (!this.i.isEmpty() || this.f8765c.l() < PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID) {
                j4 = this.u;
                j5 = (long) (((double) this.t.f8739a) * ((double) (j2 - this.v)));
            } else {
                j4 = this.u;
                j5 = zzpo.c(j2 - this.v, this.f8765c.k(), this.f8765c.l());
            }
            j3 = j5 + j4;
        }
        return j6 + j3;
    ...
    public final void i(java.lang.String r8, int r9, int r10, int r11, int r12, int[] r13) throws com.google.android.gms.internal.ads.zziu {
        ...
        L_0x0010:
            ...
            r7.F = r11
            com.google.android.gms.internal.ads.gb0 r11 = r7.f8764b
            r11.i(r13)
            com.google.android.gms.internal.ads.zzig[] r11 = r7.f8766d
            int r13 = r11.length
            r2 = 0
            r3 = 0
        L_0x0023:
        ...
        L_0x0052:
            ...
            throw r8
        L_0x006b:
            int r2 = com.google.android.gms.internal.ads.zzhc.f8719a
            goto L_0x0081
        L_0x006e:
        ...
        L_0x0081:
            ...
            java.lang.String r4 = com.google.android.gms.internal.ads.zzpo.f8996b
            java.lang.String r5 = "foster"
            boolean r4 = r5.equals(r4)
            if (r4 == 0) goto L_0x00a8
            java.lang.String r4 = com.google.android.gms.internal.ads.zzpo.f8997c
            ...
            goto L_0x00a8
        L_0x00a5:
            int r11 = com.google.android.gms.internal.ads.zzhc.f8719a
            goto L_0x00a9
        L_0x00a8:
            r11 = r2
        L_0x00a9:
            int r2 = com.google.android.gms.internal.ads.zzpo.f8995a
            r4 = 25
            if (r2 > r4) goto L_0x00be
            java.lang.String r2 = com.google.android.gms.internal.ads.zzpo.f8996b
    ...
    public final boolean j(String str) {
        zzid zzid = this.f8763a;
        return zzid != null && zzid.a(k(str));
    }

    public final zzhw l(zzhw zzhw) {
        if (this.p) {
            zzhw zzhw2 = zzhw.f8738d;
            this.t = zzhw2;
            return zzhw2;
        }
        float i2 = this.f8765c.i(zzhw.f8739a);
        zzjg zzjg = this.f8765c;
        float f2 = zzhw.f8740b;
        zzjg.j(f2);
        zzhw zzhw3 = new zzhw(i2, f2);
        zzhw zzhw4 = this.s;
        if (zzhw4 == null) {
            if (!this.i.isEmpty()) {
                zzhw4 = this.i.getLast().f3780a;
            } else {
                zzhw4 = this.t;
            }
        }
    ...
    public final boolean m(ByteBuffer byteBuffer, long j2) throws zzit, zziy {
        ...
        if (z2 && !w2 && this.j.getPlayState() != 1) {
            this.f8767e.c(this.q, zzhc.a(this.r), SystemClock.elapsedRealtime() - this.d0);
        }
        if (this.T == null) {
            if (!byteBuffer.hasRemaining()) {
                return true;
