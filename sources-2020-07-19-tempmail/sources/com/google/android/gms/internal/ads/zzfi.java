...
public final class zzfi implements Application.ActivityLifecycleCallbacks, View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    private Application f8687c;

    /* renamed from: d  reason: collision with root package name */
    private final PowerManager f8688d;

    /* renamed from: e  reason: collision with root package name */
    private final KeyguardManager f8689e;
    ...
    public zzfi(Context context, zzev zzev) {
        ...
        this.f8686b = applicationContext;
        this.g = zzev;
        this.f8688d = (PowerManager) applicationContext.getSystemService("power");
        this.f8689e = (KeyguardManager) this.f8686b.getSystemService("keyguard");
        Context context2 = this.f8686b;
        if (context2 instanceof Application) {
            this.f8687c = (Application) context2;
    ...
    public final void f() {
        ...
        L_0x001e:
            ...
            byte r4 = (byte) r4
        L_0x0027:
            android.os.PowerManager r7 = r9.f8688d
        ...
        L_0x0034:
            ...
            android.app.KeyguardManager r7 = r9.f8689e
    ...
    private final void h(View view) {
        ...
        if (this.f8690f == null) {
            ...
            this.f8690f = ja0;
            this.f8686b.registerReceiver(ja0, intentFilter);
        }
        Application application = this.f8687c;
        if (application != null) {
            try {
    ...
    private final void i(android.view.View r4) {
        ...
        L_0x002e:
        L_0x002f:
            android.content.BroadcastReceiver r4 = r3.f8690f
            if (r4 == 0) goto L_0x003a
            android.content.Context r1 = r3.f8686b     // Catch:{ Exception -> 0x0038 }
            r1.unregisterReceiver(r4)     // Catch:{ Exception -> 0x0038 }
        L_0x0038:
            r3.f8690f = r0
        L_0x003a:
            android.app.Application r4 = r3.f8687c
