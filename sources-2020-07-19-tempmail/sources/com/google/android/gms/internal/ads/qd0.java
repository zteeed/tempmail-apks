...
final class qd0 implements s {
    ...
    private final Map<String, List<zzaa<?>>> f4725a = new HashMap();

    /* renamed from: b  reason: collision with root package name */
    private final zzm f4726b;
    ...
    public final synchronized boolean d(com.google.android.gms.internal.ads.zzaa<?> r6) {
        /*
            ...
            java.util.Map<java.lang.String, java.util.List<com.google.android.gms.internal.ads.zzaa<?>>> r1 = r5.f4725a     // Catch:{ all -> 0x0052 }
        ...
        L_0x001e:
            ...
            java.util.Map<java.lang.String, java.util.List<com.google.android.gms.internal.ads.zzaa<?>>> r6 = r5.f4725a     // Catch:{ all -> 0x0052 }
            r6.put(r0, r1)     // Catch:{ all -> 0x0052 }
            boolean r6 = com.google.android.gms.internal.ads.zzaq.f5855b     // Catch:{ all -> 0x0052 }
    ...
    public final synchronized void b(zzaa<?> zzaa) {
        String E = zzaa.E();
        List remove = this.f4725a.remove(E);
        if (remove != null && !remove.isEmpty()) {
            ...
            this.f4725a.put(E, remove);
            zzaa2.p(this);
            try {
                this.f4726b.f8862c.put(zzaa2);
