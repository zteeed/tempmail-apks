...
final class ga extends zzbhu implements ViewTreeObserver.OnGlobalLayoutListener, DownloadListener, zzajp, zzbfn {
    ...
    private final zzbhd f3862e;

    /* renamed from: f  reason: collision with root package name */
    private final zzbhf f3863f;
    ...
    protected ga(zzbhd zzbhd, zzbhf zzbhf, zzbhg zzbhg, String str, boolean z2, boolean z3, zzeg zzeg, zzbbd zzbbd, zzabi zzabi, zzi zzi, zza zza, zztm zztm, zzso zzso, boolean z4) {
        ...
        this.m = zzso;
        this.n = z4;
        this.K = new zzban(this.f3862e.b(), this, this, (ViewTreeObserver.OnScrollChangedListener) null);
        zzq.zzkw().k(zzbhd, zzbbd.f6131b, getSettings());
    ...
    private final boolean I0() {
        ...
        int i3;
        boolean z2 = false;
        if (!this.f3863f.o() && !this.f3863f.F()) {
            return false;
        }
        zzwg.a();
    ...
    public final void J() {
        ...
        hashMap.put("version", this.h.f6131b);
    ...
    public final void b0(Context context) {
        this.f3862e.setBaseContext(context);
        this.K.c(this.f3862e.b());
    }

    public final void c(String str, zzahc<? super zzbfn> zzahc) {
        zzbhf zzbhf = this.f3863f;
        if (zzbhf != null) {
            zzbhf.C(str, zzahc);
        }
    }
    ...
    public final synchronized void onAttachedToWindow() {
        ...
        boolean z2 = this.y;
        if (this.f3863f != null && this.f3863f.F()) {
            if (!this.z) {
                this.f3863f.H();
                this.f3863f.I();
                this.z = true;
    ...
    public final void onDetachedFromWindow() {
        synchronized (this) {
            ...
            if (this.z && this.f3863f != null && this.f3863f.F() && getViewTreeObserver() != null && getViewTreeObserver().isAlive()) {
                this.f3863f.H();
                this.f3863f.I();
                this.z = false;
            }
    ...
    public final synchronized void onMeasure(int r8, int r9) {
        ...
        L_0x011e:
            ...
            int r2 = r2.f6251c     // Catch:{ all -> 0x01f3 }
            r3 = 1
            if (r2 > r0) goto L_0x012e
            com.google.android.gms.internal.ads.zzbhg r2 = r7.p     // Catch:{ all -> 0x01f3 }
            int r2 = r2.f6250b     // Catch:{ all -> 0x01f3 }
        ...
        L_0x012f:
            ...
            int r4 = r4.f6251c     // Catch:{ all -> 0x01f3 }
            ...
            com.google.android.gms.internal.ads.zzbhg r0 = r7.p     // Catch:{ all -> 0x01f3 }
            int r0 = r0.f6250b     // Catch:{ all -> 0x01f3 }
            float r0 = (float) r0     // Catch:{ all -> 0x01f3 }
        ...
        L_0x016e:
            ...
            int r3 = r3.f6250b     // Catch:{ all -> 0x01f3 }
        ...
        L_0x01e1:
            ...
            int r8 = r8.f6251c     // Catch:{ all -> 0x01f3 }
            com.google.android.gms.internal.ads.zzbhg r9 = r7.p     // Catch:{ all -> 0x01f3 }
            int r9 = r9.f6250b     // Catch:{ all -> 0x01f3 }
            r7.setMeasuredDimension(r8, r9)     // Catch:{ all -> 0x01f3 }
            monitor-exit(r7)
            return
        L_0x01ee:
    ...
    public final boolean onTouchEvent(MotionEvent motionEvent) {
        if (!this.f3863f.F() || this.f3863f.G()) {
            zzeg zzeg = this.g;
            if (zzeg != null) {
                zzeg.d(motionEvent);
            }
    ...
    public final boolean w(boolean z2, int i2) {
        ...
        this.l.a(zzto.zza.C0085zza.ANDROID_WEBVIEW_CRASH);
        return true;
    }
