...
final class md0 {
    ...
    private int f4382a = 1000;

    /* renamed from: b  reason: collision with root package name */
    private int[] f4383b = new int[1000];

    /* renamed from: c  reason: collision with root package name */
    private long[] f4384c = new long[1000];

    /* renamed from: d  reason: collision with root package name */
    private int[] f4385d = new int[1000];

    /* renamed from: e  reason: collision with root package name */
    private int[] f4386e = new int[1000];

    /* renamed from: f  reason: collision with root package name */
    private long[] f4387f = new long[1000];
    ...
    public final synchronized int a(com.google.android.gms.internal.ads.zzhs r5, com.google.android.gms.internal.ads.zzjm r6, boolean r7, boolean r8, com.google.android.gms.internal.ads.zzhq r9, com.google.android.gms.internal.ads.zzng r10) {
        ...
        L_0x0024:
            ...
            goto L_0x009a
        L_0x002f:
            java.nio.ByteBuffer r5 = r6.f8796c     // Catch:{ all -> 0x00a4 }
            r7 = 0
            r8 = 1
        ...
        L_0x0038:
            ...
            return r2
        L_0x003c:
            long[] r5 = r4.f4387f     // Catch:{ all -> 0x00a4 }
            int r9 = r4.k     // Catch:{ all -> 0x00a4 }
            r0 = r5[r9]     // Catch:{ all -> 0x00a4 }
            r6.f8797d = r0     // Catch:{ all -> 0x00a4 }
            int[] r5 = r4.f4386e     // Catch:{ all -> 0x00a4 }
            int r9 = r4.k     // Catch:{ all -> 0x00a4 }
            r5 = r5[r9]     // Catch:{ all -> 0x00a4 }
            r6.b(r5)     // Catch:{ all -> 0x00a4 }
            int[] r5 = r4.f4385d     // Catch:{ all -> 0x00a4 }
            int r9 = r4.k     // Catch:{ all -> 0x00a4 }
            r5 = r5[r9]     // Catch:{ all -> 0x00a4 }
            r10.f8894a = r5     // Catch:{ all -> 0x00a4 }
            long[] r5 = r4.f4384c     // Catch:{ all -> 0x00a4 }
            int r9 = r4.k     // Catch:{ all -> 0x00a4 }
            r0 = r5[r9]     // Catch:{ all -> 0x00a4 }
            r10.f8895b = r0     // Catch:{ all -> 0x00a4 }
            com.google.android.gms.internal.ads.zzkh[] r5 = r4.g     // Catch:{ all -> 0x00a4 }
            int r9 = r4.k     // Catch:{ all -> 0x00a4 }
            r5 = r5[r9]     // Catch:{ all -> 0x00a4 }
            r10.f8897d = r5     // Catch:{ all -> 0x00a4 }
            long r0 = r4.m     // Catch:{ all -> 0x00a4 }
            long r5 = r6.f8797d     // Catch:{ all -> 0x00a4 }
            ...
            int r6 = r4.f4382a     // Catch:{ all -> 0x00a4 }
        ...
        L_0x0084:
            ...
            goto L_0x0096
        L_0x008f:
            long r5 = r10.f8895b     // Catch:{ all -> 0x00a4 }
            int r7 = r10.f8894a     // Catch:{ all -> 0x00a4 }
            long r7 = (long) r7     // Catch:{ all -> 0x00a4 }
            long r6 = r5 + r7
        L_0x0096:
            r10.f8896c = r6     // Catch:{ all -> 0x00a4 }
            monitor-exit(r4)
            return r3
        L_0x009a:
    ...
    public final synchronized void b(long r6, int r8, long r9, int r11, com.google.android.gms.internal.ads.zzkh r12) {
        ...
        L_0x0016:
            ...
            long[] r0 = r5.f4387f     // Catch:{ all -> 0x00e7 }
            int r3 = r5.l     // Catch:{ all -> 0x00e7 }
            r0[r3] = r6     // Catch:{ all -> 0x00e7 }
            long[] r6 = r5.f4384c     // Catch:{ all -> 0x00e7 }
            int r7 = r5.l     // Catch:{ all -> 0x00e7 }
            r6[r7] = r9     // Catch:{ all -> 0x00e7 }
            int[] r6 = r5.f4385d     // Catch:{ all -> 0x00e7 }
            int r7 = r5.l     // Catch:{ all -> 0x00e7 }
            r6[r7] = r11     // Catch:{ all -> 0x00e7 }
            int[] r6 = r5.f4386e     // Catch:{ all -> 0x00e7 }
            int r7 = r5.l     // Catch:{ all -> 0x00e7 }
            ...
            r6[r7] = r8     // Catch:{ all -> 0x00e7 }
            int[] r6 = r5.f4383b     // Catch:{ all -> 0x00e7 }
            int r7 = r5.l     // Catch:{ all -> 0x00e7 }
            r6[r7] = r1     // Catch:{ all -> 0x00e7 }
            int r6 = r5.i     // Catch:{ all -> 0x00e7 }
            int r6 = r6 + r2
            r5.i = r6     // Catch:{ all -> 0x00e7 }
            int r7 = r5.f4382a     // Catch:{ all -> 0x00e7 }
            if (r6 != r7) goto L_0x00da
            int r6 = r5.f4382a     // Catch:{ all -> 0x00e7 }
            int r6 = r6 + 1000
            ...
            int[] r4 = r5.f4383b     // Catch:{ all -> 0x00e7 }
            java.lang.System.arraycopy(r4, r1, r7, r2, r3)     // Catch:{ all -> 0x00e7 }
            r5.f4384c = r8     // Catch:{ all -> 0x00e7 }
            r5.f4387f = r9     // Catch:{ all -> 0x00e7 }
            r5.f4386e = r10     // Catch:{ all -> 0x00e7 }
            r5.f4385d = r11     // Catch:{ all -> 0x00e7 }
            r5.g = r12     // Catch:{ all -> 0x00e7 }
            r5.h = r0     // Catch:{ all -> 0x00e7 }
            r5.f4383b = r7     // Catch:{ all -> 0x00e7 }
            r5.k = r1     // Catch:{ all -> 0x00e7 }
            int r7 = r5.f4382a     // Catch:{ all -> 0x00e7 }
            r5.l = r7     // Catch:{ all -> 0x00e7 }
            int r7 = r5.f4382a     // Catch:{ all -> 0x00e7 }
            r5.i = r7     // Catch:{ all -> 0x00e7 }
            r5.f4382a = r6     // Catch:{ all -> 0x00e7 }
            monitor-exit(r5)
            return
        L_0x00da:
    ...
    public final synchronized long c(long r9, boolean r11) {
        /*
            ...
            long[] r0 = r8.f4387f     // Catch:{ all -> 0x005e }
        ...
        L_0x0023:
            ...
            long[] r5 = r8.f4387f     // Catch:{ all -> 0x005e }
            r6 = r5[r0]     // Catch:{ all -> 0x005e }
            int r5 = (r6 > r9 ? 1 : (r6 == r9 ? 0 : -1))
            if (r5 > 0) goto L_0x0040
            int[] r5 = r8.f4386e     // Catch:{ all -> 0x005e }
        ...
        L_0x0038:
            int r0 = r0 + 1
            int r5 = r8.f4382a     // Catch:{ all -> 0x005e }
            int r0 = r0 % r5
            int r11 = r11 + 1
            goto L_0x0023
        L_0x0040:
        ...
        L_0x0044:
            ...
            int r9 = r9 + r4
            int r10 = r8.f4382a     // Catch:{ all -> 0x005e }
            int r9 = r9 % r10
            ...
            long[] r10 = r8.f4384c     // Catch:{ all -> 0x005e }
    ...
    public final synchronized long l() {
        ...
        int i2 = ((this.k + this.i) - 1) % this.f4382a;
        this.k = (this.k + this.i) % this.f4382a;
        this.j += this.i;
        this.i = 0;
        return this.f4384c[i2] + ((long) this.f4385d[i2]);
    }
}
