...
public final class zzcbk implements zzccs {
    ...
    private final zzccv f6788b;

    /* renamed from: c  reason: collision with root package name */
    private final JSONObject f6789c;

    /* renamed from: d  reason: collision with root package name */
    private final zzcgr f6790d;

    /* renamed from: e  reason: collision with root package name */
    private final zzcck f6791e;

    /* renamed from: f  reason: collision with root package name */
    private final zzeg f6792f;
    ...
    private final void p(View view, JSONObject jSONObject, JSONObject jSONObject2, JSONObject jSONObject3, JSONObject jSONObject4, String str, JSONObject jSONObject5, JSONObject jSONObject6, boolean z, boolean z2) {
        ...
        try {
            ...
            jSONObject7.put("ad", this.f6789c);
            ...
            boolean z3 = false;
            jSONObject7.put("has_custom_click_handler", this.f6788b.i(this.f6791e.e()) != null);
            jSONObject7.put("provided_signals", jSONObject6);
            JSONObject jSONObject8 = new JSONObject();
            jSONObject8.put("asset_id", str);
            jSONObject8.put("template", this.f6791e.A());
            jSONObject8.put("view_aware_api_used", z);
            jSONObject8.put("custom_mute_requested", this.k.i != null && this.k.i.h);
            jSONObject8.put("custom_mute_enabled", !this.f6791e.j().isEmpty() && this.f6791e.D() != null);
            if (this.m.c() != null && this.f6789c.optBoolean("custom_one_point_five_click_enabled", false)) {
            ...
            if (this.f6788b.i(this.f6791e.e()) != null) {
                z3 = true;
            }
            ...
            zzbbj.a(this.f6790d.i("google.afma.nativeAds.handleClick", jSONObject7), "Error during performing handleClick");
    ...
    private final boolean q(JSONObject jSONObject, JSONObject jSONObject2, JSONObject jSONObject3, JSONObject jSONObject4, String str, JSONObject jSONObject5, boolean z) {
        ...
        try {
            ...
            jSONObject6.put("ad", this.f6789c);
            ...
            jSONObject6.put("screen", zzbae.j(this.f6787a));
            this.f6790d.d("/logScionEvent", new ug(this));
            this.f6790d.d("/nativeImpression", new wg(this));
            zzbbj.a(this.f6790d.i("google.afma.nativeAds.handleImpression", jSONObject6), "Error during performing handleImpression");
            boolean z2 = this.q;
            if (z2 || this.i.z == null) {
                return true;
            }
            this.q = z2 | zzq.zzlg().c(this.f6787a, this.j.f6131b, this.i.z.toString(), this.k.f8168f);
            return true;
        } catch (JSONException e2) {
    ...
    private final boolean r() {
        return this.f6789c.optBoolean("allow_custom_click_gesture", false);
    }
    ...
    private final boolean u(String str) {
        JSONObject optJSONObject = this.f6789c.optJSONObject("allow_pub_event_reporting");
    ...
    private final String v(View view) {
        try {
            JSONObject optJSONObject = this.f6789c.optJSONObject("tracking_urls_and_actions");
            if (optJSONObject == null) {
                optJSONObject = new JSONObject();
            }
            return this.f6792f.h().zza(this.f6787a, optJSONObject.optString("click_string"), view);
        } catch (Exception e2) {
    ...
    private final String w(View view) {
        ...
        try {
            return this.f6792f.h().zza(this.f6787a, view, (Activity) null);
    ...
    public final void J() {
        if (this.f6789c.optBoolean("custom_one_point_five_click_enabled", false)) {
            this.m.a();
        }
    }
    ...
    public final void W(zzxt zzxt) {
        try {
            if (!this.s) {
                if (zzxt != null || this.f6791e.D() == null) {
                    this.s = true;
                    this.p.e(zzxt.E0());
                    g();
                    return;
    ...
    public final void a(View view, Map<String, WeakReference<View>> map, Map<String, WeakReference<View>> map2, View.OnTouchListener onTouchListener, View.OnClickListener onClickListener) {
        ...
        this.l.B(this);
        boolean k2 = zzbae.k(this.j.f6133d);
        if (map != null) {
    ...
    public final void e() {
        ...
        try {
            ...
            jSONObject.put("ad", this.f6789c);
            zzbbj.a(this.f6790d.i("google.afma.nativeAds.handleDownloadedImpression", jSONObject), "Error during performing handleDownloadedImpression");
        } catch (JSONException e2) {
            zzbba.c("", e2);
        }
    }
    ...
    public final void i(View view, View view2, Map<String, WeakReference<View>> map, Map<String, WeakReference<View>> map2, boolean z) {
        ...
        JSONObject e2 = zzbae.e(this.f6787a, map, map2, view2);
        JSONObject d2 = zzbae.d(this.f6787a, view2);
        JSONObject l2 = zzbae.l(view2);
        JSONObject i2 = zzbae.i(this.f6787a, view2);
        View view4 = view;
        String t2 = t(view, map);
        p(view, d2, e2, l2, i2, t2, zzbae.f(t2, this.f6787a, this.v, this.u), (JSONObject) null, z, false);
    }

    public final void j(View view, Map<String, WeakReference<View>> map, Map<String, WeakReference<View>> map2) {
        q(zzbae.d(this.f6787a, view), zzbae.e(this.f6787a, map, map2, view), zzbae.l(view), zzbae.i(this.f6787a, view), w(view), (JSONObject) null, zzbae.g(this.i));
    }
    ...
    public final void k(View view, Map<String, WeakReference<View>> map, Map<String, WeakReference<View>> map2, boolean z) {
        ...
        if (!this.t) {
            ...
            JSONObject e2 = zzbae.e(this.f6787a, map, map2, view);
            JSONObject d2 = zzbae.d(this.f6787a, view);
            JSONObject l2 = zzbae.l(view);
            JSONObject i2 = zzbae.i(this.f6787a, view);
            String t2 = t((View) null, map);
            p(view, d2, e2, l2, i2, t2, zzbae.f(t2, this.f6787a, this.v, this.u), (JSONObject) null, z, true);
        }
    }
    ...
    public final void m(Bundle bundle) {
        if (bundle == null) {
            ...
            this.f6792f.h().zza((int) bundle.getFloat("x"), (int) bundle.getFloat("y"), i2);
        }
    }
