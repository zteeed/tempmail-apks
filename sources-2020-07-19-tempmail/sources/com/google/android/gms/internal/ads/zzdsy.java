...
public final class zzdsy<E> extends mz<E> {
    ...
    public final /* synthetic */ zzdst b(Object obj) {
        zzdsh.b(obj);
        if (this.f8371d != null) {
            int A = zzdsz.A(this.f4434b);
            Object[] objArr = this.f8371d;
            if (A <= objArr.length) {
    ...
    zzdsy(int i) {
        super(i);
        this.f8371d = new Object[zzdsz.A(i)];
    }
}
