...
final class g60 implements j90 {
    ...
    public final <K, V> void E(int i, d70<K, V> d70, Map<K, V> map) throws IOException {
        for (Map.Entry next : map.entrySet()) {
            this.f3854a.b(i, 2);
            this.f3854a.b0(zzehd.a(d70, next.getKey(), next.getValue()));
            zzehd.b(this.f3854a, d70, next.getKey(), next.getValue());
        }
    }

    public final void F(int i, String str) throws IOException {
        this.f3854a.x0(i, str);
    }
    ...
    public final void N(int i, Object obj, z70 z70) throws IOException {
        zzefl zzefl = this.f3854a;
        zzefl.b(i, 3);
        z70.d((zzehl) obj, zzefl.f8547a);
        zzefl.b(i, 4);
    }
    ...
    public final void b(int i, List<Boolean> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            this.f3854a.b0(i3);
            while (i2 < list.size()) {
                this.f3854a.G(list.get(i2).booleanValue());
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            this.f3854a.p0(i, list.get(i2).booleanValue());
            i2++;
        }
    }
    ...
    public final void c(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            this.f3854a.b0(i3);
            while (i2 < list.size()) {
                this.f3854a.a0(list.get(i2).intValue());
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            this.f3854a.k(i, list.get(i2).intValue());
            i2++;
        }
    }
    ...
    public final void j(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            this.f3854a.b0(i3);
            while (i2 < list.size()) {
                this.f3854a.P(list.get(i2).longValue());
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            this.f3854a.o0(i, list.get(i2).longValue());
            i2++;
        }
    }
    ...
    public final void k(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            this.f3854a.b0(i3);
            while (i2 < list.size()) {
                this.f3854a.R(list.get(i2).longValue());
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            this.f3854a.v0(i, list.get(i2).longValue());
            i2++;
        }
    }
    ...
    public final void l(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            this.f3854a.b0(i3);
            while (i2 < list.size()) {
                this.f3854a.d0(list.get(i2).intValue());
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            this.f3854a.n(i, list.get(i2).intValue());
            i2++;
        }
    }
    ...
    public final void n(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            this.f3854a.b0(i3);
            while (i2 < list.size()) {
                this.f3854a.b0(list.get(i2).intValue());
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            this.f3854a.l(i, list.get(i2).intValue());
            i2++;
        }
    }
    ...
    public final void s(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            this.f3854a.b0(i3);
            while (i2 < list.size()) {
                this.f3854a.Q(list.get(i2).longValue());
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            this.f3854a.u0(i, list.get(i2).longValue());
            i2++;
        }
    }
    ...
    public final void u(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            this.f3854a.b0(i3);
            while (i2 < list.size()) {
                this.f3854a.c0(list.get(i2).intValue());
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            this.f3854a.m(i, list.get(i2).intValue());
            i2++;
        }
    }
    ...
    public final void v(int i, List<Double> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            this.f3854a.b0(i3);
            while (i2 < list.size()) {
                this.f3854a.A(list.get(i2).doubleValue());
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            this.f3854a.B(i, list.get(i2).doubleValue());
            i2++;
        }
    }
    ...
    public final void x(int i, List<Float> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            this.f3854a.b0(i3);
            while (i2 < list.size()) {
                this.f3854a.O(list.get(i2).floatValue());
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            this.f3854a.f(i, list.get(i2).floatValue());
            i2++;
        }
    }
        ...
        if (list instanceof zzegw) {
            ...
            while (i2 < list.size()) {
                ...
                if (I instanceof String) {
                    this.f3854a.x0(i, (String) I);
                } else {
                    this.f3854a.g(i, (zzeer) I);
                }
                i2++;
            }
            return;
    ...
    public final void z(int i, Object obj) throws IOException {
        if (obj instanceof zzeer) {
            this.f3854a.C(i, (zzeer) obj);
        } else {
            this.f3854a.h(i, (zzehl) obj);
        }
    }
}
