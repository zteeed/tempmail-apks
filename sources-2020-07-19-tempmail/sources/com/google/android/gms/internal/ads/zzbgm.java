...
public final class zzbgm<WebViewT extends zzbgq & zzbgy & zzbha> {
    ...
    private final zzbgn f6239a;

    /* renamed from: b  reason: collision with root package name */
    private final WebViewT f6240b;

    private zzbgm(WebViewT webviewt, zzbgn zzbgn) {
        this.f6239a = zzbgn;
        this.f6240b = webviewt;
    }
    ...
    public final String getClickSignals(String str) {
        ...
        if (h == null) {
            ...
            return "";
        } else if (this.f6240b.getContext() != null) {
            return h.zza(this.f6240b.getContext(), str, ((zzbha) this.f6240b).getView(), this.f6240b.b());
        } else {
