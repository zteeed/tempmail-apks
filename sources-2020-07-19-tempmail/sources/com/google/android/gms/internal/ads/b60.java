...
final class b60 extends zzefc {
    ...
    private final InputStream f3425e;
    ...
    private b60(InputStream inputStream, int i2) {
        ...
        this.f3425e = inputStream;
        this.f3426f = new byte[i2];
        this.g = 0;
        this.i = 0;
        this.k = 0;
    }
    ...
    private final byte[] I(int i2, boolean z) throws IOException {
        ...
        System.arraycopy(this.f3426f, i3, bArr, 0, i5);
        for (byte[] next : N) {
                ...
                while (i9 < i2) {
                    try {
                        ...
                        if (i10 >= 0 && skip <= j2) {
                            ...
                            String valueOf = String.valueOf(this.f3425e.getClass());
    ...
    private final void K(int i2) throws IOException {
        ...
        if (i2 > (this.f8543c - this.k) - this.i) {
            throw zzegl.g();
        }
        throw zzegl.a();
    }
    ...
    private final boolean L(int i2) throws IOException {
        do {
            ...
            if (i4 > i5) {
                ...
                InputStream inputStream = this.f3425e;
                byte[] bArr2 = this.f3426f;
                int i8 = this.g;
                int read = inputStream.read(bArr2, i8, Math.min(bArr2.length - i8, (this.f8543c - this.k) - i8));
                if (read == 0 || read < -1 || read > this.f3426f.length) {
                    String valueOf = String.valueOf(this.f3425e.getClass());
        ...
        if (i2 >= 0) {
            ...
            if (i5 - this.f8543c <= 0) {
                ...
                if (i5 <= i6) {
                    int i7 = this.g - i4;
                    int i8 = i2 - i7;
                    if (i8 >= 4096 && i8 > this.f3425e.available()) {
                        return null;
                    }
                    byte[] bArr = new byte[i2];
                    System.arraycopy(this.f3426f, this.i, bArr, 0, i7);
                    this.k += this.g;
                    this.i = 0;
                    this.g = 0;
                    while (i7 < i2) {
                        int read = this.f3425e.read(bArr, i7, i2 - i7);
                        if (read != -1) {
                            this.k += read;
                            i7 += read;
                        } else {
    ...
    private final List<byte[]> N(int i2) throws IOException {
        ...
        while (i2 > 0) {
            ...
            int i3 = 0;
            while (i3 < min) {
                int read = this.f3425e.read(bArr, i3, min - i3);
                if (read != -1) {
                    this.k += read;
                    i3 += read;
                } else {
    ...
    public final String c() throws IOException {
        ...
        if (C > 0 && C <= this.g - this.i) {
            String str = new String(this.f3426f, this.i, C, zzegd.f8575a);
            this.i += C;
            return str;
        } else if (C == 0) {
            return "";
            ...
            if (C > this.g) {
                return new String(I(C, false), zzegd.f8575a);
            }
            K(C);
            String str2 = new String(this.f3426f, this.i, C, zzegd.f8575a);
            this.i += C;
            return str2;
        }
    }
    ...
    public final zzeer m() throws IOException {
        ...
        int i3 = this.i;
        if (C <= i2 - i3 && C > 0) {
            zzeer P = zzeer.P(this.f3426f, i3, C);
            this.i += C;
            return P;
        } else if (C == 0) {
            return zzeer.f8533c;
            ...
            System.arraycopy(this.f3426f, i4, bArr, 0, i6);
            for (byte[] next : N) {
