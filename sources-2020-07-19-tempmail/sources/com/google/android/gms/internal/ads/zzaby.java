...
public final class zzaby<T> extends zzabx<T> {
    ...
    protected zzaby(java.lang.String r1, T r2, java.lang.Integer r3) {
        /*
            r0 = this;
            r0.<init>(r1, r2, r3)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzaby.<init>(java.lang.String, java.lang.Object, int):void");
    }

    public static zzabx<Boolean> d(String str, boolean z) {
        return new zzaby(str, Boolean.TRUE, r.f4761a);
    }
