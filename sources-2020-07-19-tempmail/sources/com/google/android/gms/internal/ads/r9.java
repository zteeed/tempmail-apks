...
final class r9 extends WebView implements ViewTreeObserver.OnGlobalLayoutListener, DownloadListener, zzbfn {
    ...
    private final zzbhd f4798b;

    /* renamed from: c  reason: collision with root package name */
    private final zzeg f4799c;

    /* renamed from: d  reason: collision with root package name */
    private final zzbbd f4800d;

    /* renamed from: e  reason: collision with root package name */
    private final zzi f4801e;

    /* renamed from: f  reason: collision with root package name */
    private final zza f4802f;
    ...
    private r9(zzbhd zzbhd, zzbhg zzbhg, String str, boolean z2, boolean z3, zzeg zzeg, zzbbd zzbbd, zzabi zzabi, zzi zzi, zza zza, zztm zztm, zzso zzso, boolean z4) {
        ...
        zzq.zzkw().k(zzbhd, zzbbd.f6131b, settings);
        ...
        this.N = new zzban(this.f4798b.b(), this, this, (ViewTreeObserver.OnScrollChangedListener) null);
        N0();
    ...
    public final void J() {
        ...
        hashMap.put("version", this.f4800d.f6131b);
        z("onshow", hashMap);
    }
    ...
    public final void b0(Context context) {
        this.f4798b.setBaseContext(context);
        this.N.c(this.f4798b.b());
    }
    ...
    public final synchronized void onMeasure(int r8, int r9) {
        ...
        L_0x011e:
            ...
            int r2 = r2.f6251c     // Catch:{ all -> 0x01fe }
            r3 = 1
            if (r2 > r0) goto L_0x012e
            com.google.android.gms.internal.ads.zzbhg r2 = r7.p     // Catch:{ all -> 0x01fe }
            int r2 = r2.f6250b     // Catch:{ all -> 0x01fe }
        ...
        L_0x012f:
            ...
            int r4 = r4.f6251c     // Catch:{ all -> 0x01fe }
            ...
            com.google.android.gms.internal.ads.zzbhg r0 = r7.p     // Catch:{ all -> 0x01fe }
            int r0 = r0.f6250b     // Catch:{ all -> 0x01fe }
            float r0 = (float) r0     // Catch:{ all -> 0x01fe }
        ...
        L_0x0167:
            ...
            int r2 = (int) r2     // Catch:{ all -> 0x01fe }
            com.google.android.gms.internal.ads.zzbhg r4 = r7.p     // Catch:{ all -> 0x01fe }
            int r4 = r4.f6250b     // Catch:{ all -> 0x01fe }
            float r4 = (float) r4     // Catch:{ all -> 0x01fe }
            float r5 = r7.h     // Catch:{ all -> 0x01fe }
            float r4 = r4 / r5
        ...
        L_0x01c4:
            ...
            com.google.android.gms.internal.ads.zzto$zza$zza r9 = com.google.android.gms.internal.ads.zzto.zza.C0085zza.BANNER_SIZE_INVALID     // Catch:{ all -> 0x01fe }
        ...
        L_0x01df:
            ...
            com.google.android.gms.internal.ads.zztm r8 = r7.U     // Catch:{ all -> 0x01fe }
            com.google.android.gms.internal.ads.zzto$zza$zza r9 = com.google.android.gms.internal.ads.zzto.zza.C0085zza.BANNER_SIZE_VALID     // Catch:{ all -> 0x01fe }
            r8.a(r9)     // Catch:{ all -> 0x01fe }
            r7.l = r3     // Catch:{ all -> 0x01fe }
        L_0x01ec:
            com.google.android.gms.internal.ads.zzbhg r8 = r7.p     // Catch:{ all -> 0x01fe }
            int r8 = r8.f6251c     // Catch:{ all -> 0x01fe }
            com.google.android.gms.internal.ads.zzbhg r9 = r7.p     // Catch:{ all -> 0x01fe }
            int r9 = r9.f6250b     // Catch:{ all -> 0x01fe }
            r7.setMeasuredDimension(r8, r9)     // Catch:{ all -> 0x01fe }
        L_0x01f7:
            monitor-exit(r7)
            return
    ...
    public final boolean w(boolean z2, int i2) {
        ...
        this.U.a(zzto.zza.C0085zza.ANDROID_WEBVIEW_CRASH);
        return true;
    }
