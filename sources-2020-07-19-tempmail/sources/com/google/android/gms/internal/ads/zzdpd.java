...
public final class zzdpd {
    ...
    private final zzbbe f8280b;

    /* renamed from: c  reason: collision with root package name */
    private final zzcts f8281c;
    ...
    public final void b(zzdkw zzdkw, zzdkk zzdkk, List<String> list, zzatg zzatg) {
        ...
        try {
            ...
            zzdkv zzdkv = this.h;
            String str = "";
            String f2 = zzdkv == null ? str : f(zzdkv.f8159a);
            zzdkv zzdkv2 = this.h;
            if (zzdkv2 != null) {
                str = f(zzdkv2.f8160b);
            }
            for (String d2 : list) {
                arrayList.add(zzawn.d(d(d(d(d(d(d(d2, "@gw_rwd_userid@", Uri.encode(f2)), "@gw_rwd_custom_data@", Uri.encode(str)), "@gw_tmstmp@", Long.toString(a2)), "@gw_rwd_itm@", Uri.encode(type)), "@gw_rwd_amt@", num), "@gw_sdkver@", this.f8282d), this.g, zzdkk.N));
            }
            h(arrayList);
    ...
    public final void c(zzdkw zzdkw, zzdkk zzdkk, boolean z, String str, String str2, List<String> list) {
        ...
        String str3 = z ? "1" : "0";
        for (String d2 : list) {
            String d3 = d(d(d(d2, "@gw_adlocid@", zzdkw.f8161a.f8149a.f8168f), "@gw_adnetrefresh@", str3), "@gw_sdkver@", this.f8282d);
            if (zzdkk != null) {
                d3 = zzawn.d(d(d(d(d3, "@gw_qdata@", zzdkk.v), "@gw_adnetid@", zzdkk.u), "@gw_allocid@", zzdkk.t), this.g, zzdkk.N);
            }
            String d4 = d(d(d(d3, "@gw_adnetstatus@", this.f8281c.e()), "@gw_seqnum@", this.f8283e), "@gw_sessid@", this.f8284f);
    ...
    public final void e(String str) {
        this.f8279a.execute(new fy(this, str));
    }
