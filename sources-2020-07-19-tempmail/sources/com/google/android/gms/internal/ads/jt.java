...
final class jt implements zzdec<zzdef> {
    ...
    public final zzdvf<zzdef> b() {
        return this.f4162a.f(new it(this));
    }

    /* access modifiers changed from: package-private */
    public final /* synthetic */ zzdef d() throws Exception {
        boolean z;
        PackageManager packageManager = this.f4163b.getPackageManager();
        ...
        boolean a2 = DeviceProperties.a(this.f4163b);
        boolean b2 = DeviceProperties.b(this.f4163b);
        ...
        String c2 = c(this.f4163b, packageManager);
        String e2 = e(this.f4163b);
