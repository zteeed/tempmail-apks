...
public final class zzccd extends zzbpb {
    ...
    public final synchronized void A(zzcee zzcee) {
        this.j.f(zzcee.w5(), zzcee.l5());
        if (zzcee.P() != null) {
            zzcee.P().setClickable(false);
            zzcee.P().removeAllViews();
        }
        if (zzcee.a1() != null) {
            zzcee.a1().e(this.u);
        }
    ...
    public final /* synthetic */ void B(boolean z2) {
        this.j.k(this.s.w5(), this.s.l5(), this.s.L5(), z2);
    }
    ...
    public final synchronized void n(zzcee zzcee) {
        ...
        this.s = zzcee;
        this.k.b(zzcee);
        this.j.a(zzcee.w5(), zzcee.L5(), zzcee.s6(), zzcee, zzcee);
                    ...
                    if (A != 3) {
                        if (A != 6) {
                            if (A != 7) {
                                ...
                                this.m.e().O3(this.q.get());
                            }
                        } else if (this.m.c() != null) {
                            E("Google", true);
                            this.m.c().y0(this.p.get());
                        }
                    } else if (this.m.h(this.i.e()) != null) {
                        if (this.i.F() != null) {
                            E("Google", true);
                        }
                        this.m.h(this.i.e()).p1(this.r.get());
                    }
                } else if (this.m.b() != null) {
                    E("Google", true);
                    this.m.b().O1(this.o.get());
                }
            } else if (this.m.a() != null) {
                E("Google", true);
                this.m.a().R4(this.n.get());
            }
