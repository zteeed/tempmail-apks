...
public final class zzdas implements zzdec<zzdap> {
    ...
    public final /* synthetic */ zzdap a() throws Exception {
        double d2;
        Intent registerReceiver = this.f7800b.registerReceiver((BroadcastReceiver) null, new IntentFilter("android.intent.action.BATTERY_CHANGED"));
        boolean z = false;
    ...
    public final zzdvf<zzdap> b() {
        return this.f7799a.f(new xr(this));
    }
}
