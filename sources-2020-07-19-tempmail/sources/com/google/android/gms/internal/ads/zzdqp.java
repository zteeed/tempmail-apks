...
public final class zzdqp {
    ...
    private final String a() {
        ...
        try {
            ...
            zzdpm zzdpm = this.f8318b;
            if (zzdpm != null) {
                zzdpm.b(2024, 0, e2);
            }
        } catch (IllegalAccessException e3) {
            zzdpm zzdpm2 = this.f8318b;
            if (zzdpm2 != null) {
                zzdpm2.b(2024, 0, e3);
            }
        }
    ...
    private final zzgo b() {
        ...
        File file = new File(new File(this.f8317a.getApplicationInfo().dataDir), "lib");
        if (!file.exists()) {
    ...
    private final void d(byte[] bArr) {
        if (this.f8318b != null) {
            ...
            this.f8318b.i(4007, sb.toString());
        }
    }
