...
public final class zzeco implements zzdwc {
    ...
    private static final ThreadLocal<Cipher> f8496b = new w40();

    /* renamed from: a  reason: collision with root package name */
    private final SecretKey f8497a;

    public zzeco(byte[] bArr) throws GeneralSecurityException {
        zzedv.a(bArr.length);
        this.f8497a = new SecretKeySpec(bArr, "AES");
    }
    ...
    public final byte[] a(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        if (bArr.length <= 2147483619) {
            ...
            f8496b.get().init(1, this.f8497a, b(c2, 0, c2.length));
            if (!(bArr2 == null || bArr2.length == 0)) {
                f8496b.get().updateAAD(bArr2);
            }
            int doFinal = f8496b.get().doFinal(bArr, 0, bArr.length, bArr3, 12);
