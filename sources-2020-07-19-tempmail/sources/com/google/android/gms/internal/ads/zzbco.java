...
public final class zzbco extends FrameLayout implements zzbcj {
    ...
    private final zzbdb f6152b;

    /* renamed from: c  reason: collision with root package name */
    private final FrameLayout f6153c;

    /* renamed from: d  reason: collision with root package name */
    private final zzabi f6154d;

    /* renamed from: e  reason: collision with root package name */
    private final r7 f6155e;
    ...
    private final void I() {
        if (this.f6152b.b() != null && this.i && !this.j) {
            this.f6152b.b().getWindow().clearFlags(128);
            this.i = false;
        }
    }
    ...
    public final void v(String str, String... strArr) {
        ...
        this.f6152b.z("onVideoEvent", hashMap);
    }
    ...
    public final void F() {
        ...
        if (zzbcm != null) {
            ...
            this.f6153c.addView(textView, new FrameLayout.LayoutParams(-2, -2, 17));
            this.f6153c.bringChildToFront(textView);
        }
    }
    ...
    public final void b() {
        if (this.r && this.p != null && !H()) {
            ...
            this.q.invalidate();
            this.f6153c.addView(this.q, new FrameLayout.LayoutParams(-1, -1));
            this.f6153c.bringChildToFront(this.q);
        }
        this.f6155e.a();
        this.m = this.l;
    ...
    public final void g() {
        if (this.f6152b.b() != null && !this.i) {
            boolean z = (this.f6152b.b().getWindow().getAttributes().flags & 128) != 0;
            this.j = z;
            if (!z) {
                this.f6152b.b().getWindow().addFlags(128);
                this.i = true;
            }
        }
        this.h = true;
    ...
    public final void u(int i2, int i3, int i4, int i5) {
        if (i4 != 0 && i5 != 0) {
            ...
            this.f6153c.setLayoutParams(layoutParams);
            requestLayout();
        }
    }
