...
final class e3<T> implements p3<T> {
    ...
    public final T a() {
        return this.f9389a.e().m();
    }

    public final int b(T t) {
        f4<?, ?> f4Var = this.f9390b;
        int r = f4Var.r(f4Var.k(t)) + 0;
        return this.f9391c ? r + this.f9392d.b(t).s() : r;
    }

    public final int c(T t) {
        int hashCode = this.f9390b.k(t).hashCode();
        return this.f9391c ? (hashCode * 53) + this.f9392d.b(t).hashCode() : hashCode;
    }

    public final void d(T t, m3 m3Var, zzfb zzfb) throws IOException {
        boolean z;
        f4<?, ?> f4Var = this.f9390b;
        b2<?> b2Var = this.f9392d;
        Object o = f4Var.o(t);
        c2<?> i = b2Var.i(t);
        do {
            try {
                ...
                if (b2 == 11) {
                    ...
                    while (m3Var.a() != Integer.MAX_VALUE) {
                        ...
                        if (b3 == 16) {
                            i2 = m3Var.k();
                            obj = b2Var.c(zzfb, this.f9389a, i2);
                        } else if (b3 == 26) {
                            if (obj == null) {
                                zzeg = m3Var.f();
                            } else {
                    ...
                    Object c2 = b2Var.c(zzfb, this.f9389a, b2 >>> 3);
                    if (c2 == null) {
                        z = f4Var.j(o, m3Var);
                        continue;
                    } else {
    ...
    public final boolean g(T t, T t2) {
        if (!this.f9390b.k(t).equals(this.f9390b.k(t2))) {
            return false;
        }
        if (this.f9391c) {
            return this.f9392d.b(t).equals(this.f9392d.b(t2));
        }
        return true;
    }

    public final void h(T t, T t2) {
        r3.o(this.f9390b, t, t2);
        if (this.f9391c) {
            r3.m(this.f9392d, t, t2);
        }
    }

    public final void i(T t, w4 w4Var) throws IOException {
        Iterator<Map.Entry<?, Object>> p = this.f9392d.b(t).p();
        while (p.hasNext()) {
    ...
    public final void j(T r10, byte[] r11, int r12, int r13, com.google.android.gms.internal.measurement.h1 r14) throws java.io.IOException {
        ...
        L_0x0018:
            ...
            com.google.android.gms.internal.measurement.b2<?> r12 = r9.f9392d
            com.google.android.gms.internal.measurement.zzfb r0 = r14.f9410d
            com.google.android.gms.internal.measurement.zzgw r3 = r9.f9389a
            int r5 = r2 >>> 3
        ...
        L_0x0065:
            ...
            java.lang.Object r2 = r14.f9409c
        ...
        L_0x007b:
            ...
            int r4 = com.google.android.gms.internal.measurement.i1.i(r11, r4, r14)
            int r12 = r14.f9407a
            com.google.android.gms.internal.measurement.b2<?> r0 = r9.f9392d
            com.google.android.gms.internal.measurement.zzfb r5 = r14.f9410d
            com.google.android.gms.internal.measurement.zzgw r6 = r9.f9389a
