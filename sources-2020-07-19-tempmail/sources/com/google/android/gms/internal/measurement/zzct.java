...
public final class zzct {
    ...
    private static volatile zzdi<Boolean> f9589a = zzdi.d();

    /* renamed from: b  reason: collision with root package name */
    private static final Object f9590b = new Object();
    ...
    public static boolean b(Context context, Uri uri) {
        ...
        if (!"com.google.android.gms.phenotype".equals(authority)) {
            ...
            return f9589a.c().booleanValue();
        } else {
            synchronized (f9590b) {
                if (f9589a.b()) {
                    boolean booleanValue = f9589a.c().booleanValue();
                    return booleanValue;
                }
                if (!"com.google.android.gms".equals(context.getPackageName())) {
                    ...
                    if (resolveContentProvider == null || !"com.google.android.gms".equals(resolveContentProvider.packageName)) {
                        ...
                        f9589a = zzdi.a(Boolean.valueOf(z2));
                        return f9589a.c().booleanValue();
                    }
                }
                z = true;
