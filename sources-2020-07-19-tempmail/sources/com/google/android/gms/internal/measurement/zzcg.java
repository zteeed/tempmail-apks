...
public class zzcg {
    ...
    public static final Uri f9574a = Uri.parse("content://com.google.android.gsf.gservices");

    /* renamed from: b  reason: collision with root package name */
    private static final Uri f9575b = Uri.parse("content://com.google.android.gsf.gservices/prefix");

    /* renamed from: c  reason: collision with root package name */
    public static final Pattern f9576c = Pattern.compile("^(1|true|t|on|yes|y)$", 2);

    /* renamed from: d  reason: collision with root package name */
    public static final Pattern f9577d = Pattern.compile("^(0|false|f|off|no|n)$", 2);
    /* access modifiers changed from: private */

    /* renamed from: e  reason: collision with root package name */
    public static final AtomicBoolean f9578e = new AtomicBoolean();

    /* renamed from: f  reason: collision with root package name */
    private static HashMap<String, String> f9579f;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:35:0x00ad, code lost:
        r10 = r10.query(f9574a, (java.lang.String[]) null, (java.lang.String) null, new java.lang.String[]{r11}, (java.lang.String) null);
     */
    ...
    public static java.lang.String a(android.content.ContentResolver r10, java.lang.String r11, java.lang.String r12) {
        /*
            ...
            monitor-enter(r12)
            java.util.HashMap<java.lang.String, java.lang.String> r0 = f9579f     // Catch:{ all -> 0x00f2 }
            r1 = 1
            r2 = 0
            r3 = 0
            if (r0 != 0) goto L_0x002a
            java.util.concurrent.atomic.AtomicBoolean r0 = f9578e     // Catch:{ all -> 0x00f2 }
            r0.set(r2)     // Catch:{ all -> 0x00f2 }
            java.util.HashMap r0 = new java.util.HashMap     // Catch:{ all -> 0x00f2 }
            r0.<init>()     // Catch:{ all -> 0x00f2 }
            f9579f = r0     // Catch:{ all -> 0x00f2 }
            java.lang.Object r0 = new java.lang.Object     // Catch:{ all -> 0x00f2 }
            r0.<init>()     // Catch:{ all -> 0x00f2 }
            k = r0     // Catch:{ all -> 0x00f2 }
            l = r2     // Catch:{ all -> 0x00f2 }
            android.net.Uri r0 = f9574a     // Catch:{ all -> 0x00f2 }
        ...
        L_0x0054:
            ...
            java.util.HashMap<java.lang.String, java.lang.String> r4 = f9579f     // Catch:{ all -> 0x00f2 }
            boolean r4 = r4.containsKey(r11)     // Catch:{ all -> 0x00f2 }
            if (r4 == 0) goto L_0x006b
            java.util.HashMap<java.lang.String, java.lang.String> r10 = f9579f     // Catch:{ all -> 0x00f2 }
        ...
        L_0x0085:
            ...
            java.util.HashMap<java.lang.String, java.lang.String> r2 = f9579f     // Catch:{ all -> 0x00f2 }
    ...
    private static Map<String, String> b(ContentResolver contentResolver, String... strArr) {
        Cursor query = contentResolver.query(f9575b, (String[]) null, (String) null, strArr, (String) null);
