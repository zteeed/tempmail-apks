...
final class u1 implements m3 {
    ...
    private final <T> T U(p3<T> p3Var, zzfb zzfb) throws IOException {
        int t = this.f9498a.t();
        zzes zzes = this.f9498a;
        if (zzes.f9611a < zzes.f9612b) {
            int h = zzes.h(t);
            T a2 = p3Var.a();
            this.f9498a.f9611a++;
    ...
    public final void C(List<Boolean> list) throws IOException {
        ...
        if (list instanceof j1) {
            ...
            if (i == 0) {
                ...
                int A = this.f9498a.A() + this.f9498a.t();
                do {
                    j1Var.h(this.f9498a.p());
                } while (this.f9498a.A() < A);
                X(A);
            } else {
                throw zzfw.f();
            }
            ...
            if (i2 == 0) {
                do {
                    list.add(Boolean.valueOf(this.f9498a.p()));
                    if (!this.f9498a.z()) {
                        a2 = this.f9498a.a();
                    } else {
                        return;
                ...
                int A2 = this.f9498a.A() + this.f9498a.t();
                do {
                    list.add(Boolean.valueOf(this.f9498a.p()));
                } while (this.f9498a.A() < A2);
                X(A2);
            } else {
                throw zzfw.f();
            }
    ...
    public final void E(List<Integer> list) throws IOException {
        ...
        if (list instanceof k2) {
            ...
            if (i == 2) {
                int t = this.f9498a.t();
                V(t);
                int A = this.f9498a.A() + t;
                do {
                    k2Var.j(this.f9498a.o());
                } while (this.f9498a.A() < A);
            } else if (i == 5) {
                do {
                    k2Var.j(this.f9498a.o());
            ...
            int i2 = this.f9499b & 7;
            if (i2 == 2) {
                int t2 = this.f9498a.t();
                V(t2);
                int A2 = this.f9498a.A() + t2;
                do {
                    list.add(Integer.valueOf(this.f9498a.o()));
                } while (this.f9498a.A() < A2);
            } else if (i2 == 5) {
                do {
                    list.add(Integer.valueOf(this.f9498a.o()));
    ...
    public final <T> void F(List<T> list, p3<T> p3Var, zzfb zzfb) throws IOException {
        ...
        if ((i & 7) == 3) {
            do {
                ...
                if (!this.f9498a.z() && this.f9501d == 0) {
                    a2 = this.f9498a.a();
                } else {
                    return;
                }
    ...
    public final void I(List<Double> list) throws IOException {
        ...
        if (list instanceof z1) {
            ...
            if (i2 == 1) {
                do {
                    list.add(Double.valueOf(this.f9498a.e()));
                    if (!this.f9498a.z()) {
                        a2 = this.f9498a.a();
                    } else {
                        return;
    ...
    public final void L(List<Long> list) throws IOException {
        ...
        if (list instanceof r2) {
            ...
            if (i2 == 0) {
                do {
                    list.add(Long.valueOf(this.f9498a.i()));
                    if (!this.f9498a.z()) {
                        a2 = this.f9498a.a();
                    } else {
                        return;
    ...
    public final <K, V> void M(java.util.Map<K, V> r8, com.google.android.gms.internal.measurement.w2<K, V> r9, com.google.android.gms.internal.measurement.zzfb r10) throws java.io.IOException {
        /*
            ...
            r0 = 2
            r7.R(r0)
            com.google.android.gms.internal.measurement.zzes r1 = r7.f9498a
            int r1 = r1.t()
            com.google.android.gms.internal.measurement.zzes r2 = r7.f9498a
            int r1 = r2.h(r1)
            K r2 = r9.f9517b
            V r3 = r9.f9519d
        L_0x0014:
            ...
            com.google.android.gms.internal.measurement.zzes r5 = r7.f9498a     // Catch:{ all -> 0x0064 }
        ...
        L_0x0039:
            com.google.android.gms.internal.measurement.zziu r4 = r9.f9518c     // Catch:{ zzfz -> 0x004e }
            V r5 = r9.f9519d     // Catch:{ zzfz -> 0x004e }
            java.lang.Class r5 = r5.getClass()     // Catch:{ zzfz -> 0x004e }
            java.lang.Object r3 = r7.Q(r4, r5, r10)     // Catch:{ zzfz -> 0x004e }
            goto L_0x0014
        L_0x0046:
            com.google.android.gms.internal.measurement.zziu r4 = r9.f9516a     // Catch:{ zzfz -> 0x004e }
            r5 = 0
        ...
        L_0x005b:
            ...
            com.google.android.gms.internal.measurement.zzes r8 = r7.f9498a
            r8.j(r1)
            return
        L_0x0064:
            r8 = move-exception
            com.google.android.gms.internal.measurement.zzes r9 = r7.f9498a
            r9.j(r1)
            throw r8
        */
    ...
    public final void N(List<Float> list) throws IOException {
        ...
        if (list instanceof g2) {
            ...
            if (i2 == 2) {
                ...
                int A2 = this.f9498a.A() + t2;
                do {
                    list.add(Float.valueOf(this.f9498a.g()));
                } while (this.f9498a.A() < A2);
            } else if (i2 == 5) {
                do {
                    list.add(Float.valueOf(this.f9498a.g()));
    ...
    public final void O(List<Long> list) throws IOException {
        ...
        if (list instanceof r2) {
            ...
            if (i2 == 0) {
                do {
                    list.add(Long.valueOf(this.f9498a.l()));
                    if (!this.f9498a.z()) {
                        a2 = this.f9498a.a();
                    } else {
                        return;
    ...
    public final boolean c() throws IOException {
        int i;
        if (this.f9498a.z() || (i = this.f9499b) == this.f9500c) {
            return false;
        }
        return this.f9498a.f(i);
    }
    ...
    public final void c0(List<Integer> list) throws IOException {
        ...
        if (list instanceof k2) {
            ...
            if (i2 == 0) {
                do {
                    list.add(Integer.valueOf(this.f9498a.m()));
                    if (!this.f9498a.z()) {
                        a2 = this.f9498a.a();
                    } else {
                        return;
    ...
    public final void i(List<Integer> list) throws IOException {
        ...
        if (list instanceof k2) {
            ...
            if (i2 == 0) {
                do {
                    list.add(Integer.valueOf(this.f9498a.x()));
                    if (!this.f9498a.z()) {
                        a2 = this.f9498a.a();
                    } else {
                        return;
    ...
    public final void m(List<Long> list) throws IOException {
        ...
        if (list instanceof r2) {
            ...
            if (i2 == 1) {
                do {
                    list.add(Long.valueOf(this.f9498a.w()));
                    if (!this.f9498a.z()) {
                        a2 = this.f9498a.a();
                    } else {
                        return;
    ...
    public final void q(List<Long> list) throws IOException {
        ...
        if (list instanceof r2) {
            ...
            if (i2 == 1) {
                do {
                    list.add(Long.valueOf(this.f9498a.n()));
                    if (!this.f9498a.z()) {
                        a2 = this.f9498a.a();
                    } else {
                        return;
    ...
    public final void s(List<Long> list) throws IOException {
        ...
        if (list instanceof r2) {
            ...
            if (i2 == 0) {
                do {
                    list.add(Long.valueOf(this.f9498a.y()));
                    if (!this.f9498a.z()) {
                        a2 = this.f9498a.a();
                    } else {
                        return;
    ...
    public final void t(List<Integer> list) throws IOException {
        ...
        if (list instanceof k2) {
            ...
            if (i2 == 0) {
                do {
                    list.add(Integer.valueOf(this.f9498a.t()));
                    if (!this.f9498a.z()) {
                        a2 = this.f9498a.a();
                    } else {
                        return;
    ...
    public final void w(List<Integer> list) throws IOException {
        ...
        if (list instanceof k2) {
            ...
            if (i2 == 2) {
                ...
                int A2 = this.f9498a.A() + t2;
                do {
                    list.add(Integer.valueOf(this.f9498a.v()));
                } while (this.f9498a.A() < A2);
            } else if (i2 == 5) {
                do {
                    list.add(Integer.valueOf(this.f9498a.v()));
    ...
    public final void z(List<Integer> list) throws IOException {
        ...
        if (list instanceof k2) {
            ...
            if (i2 == 0) {
                do {
                    list.add(Integer.valueOf(this.f9498a.u()));
                    if (!this.f9498a.z()) {
                        a2 = this.f9498a.a();
                    } else {
                        return;
