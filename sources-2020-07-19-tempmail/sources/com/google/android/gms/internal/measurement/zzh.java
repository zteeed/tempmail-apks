...
public final class zzh {
    ...
    private static final Method f9653b = c();

    /* renamed from: c  reason: collision with root package name */
    private static final Method f9654c = d();

    /* renamed from: a  reason: collision with root package name */
    private final JobScheduler f9655a;

    private zzh(JobScheduler jobScheduler) {
        this.f9655a = jobScheduler;
    }

    private final int a(JobInfo jobInfo, String str, int i, String str2) {
        Method method = f9653b;
        if (method != null) {
            try {
                return ((Integer) method.invoke(this.f9655a, new Object[]{jobInfo, str, Integer.valueOf(i), str2})).intValue();
            } catch (IllegalAccessException | InvocationTargetException e2) {
                Log.e(str2, "error calling scheduleAsPackage", e2);
            }
        }
        return this.f9655a.schedule(jobInfo);
    }

    public static int b(Context context, JobInfo jobInfo, String str, String str2) {
        JobScheduler jobScheduler = (JobScheduler) context.getSystemService("jobscheduler");
        if (f9653b == null || context.checkSelfPermission("android.permission.UPDATE_DEVICE_STATS") != 0) {
