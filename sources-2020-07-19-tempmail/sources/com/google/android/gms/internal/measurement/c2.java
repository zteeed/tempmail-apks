...
final class c2<T extends zzfg<T>> {
    ...
    private static final c2 f9369d = new c2(true);

    /* renamed from: a  reason: collision with root package name */
    final q3<T, Object> f9370a;
    ...
    private static void h(com.google.android.gms.internal.measurement.zziu r2, java.lang.Object r3) {
        /*
            ...
            int[] r0 = com.google.android.gms.internal.measurement.e2.f9387a
    ...
    private final void m(Map.Entry<T, Object> entry) {
        ...
        if (value instanceof zzgb) {
            ...
            this.f9370a.put(zzfg, d2);
        } else if (zzfg.c() == zzjb.MESSAGE) {
            Object d3 = d(zzfg);
            if (d3 == null) {
                this.f9370a.put(zzfg, e(value));
                return;
            }
    ...
    public final /* synthetic */ Object clone() throws CloneNotSupportedException {
        c2 c2Var = new c2();
        for (int i = 0; i < this.f9370a.j(); i++) {
            Map.Entry<T, Object> h = this.f9370a.h(i);
            c2Var.l((zzfg) h.getKey(), h.getValue());
        }
        for (Map.Entry next : this.f9370a.m()) {
            c2Var.l((zzfg) next.getKey(), next.getValue());
        }
        c2Var.f9372c = this.f9372c;
        return c2Var;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return this.f9370a.equals(((c2) obj).f9370a);
    }

    public final void g(c2<T> c2Var) {
        for (int i = 0; i < c2Var.f9370a.j(); i++) {
            m(c2Var.f9370a.h(i));
        }
        for (Map.Entry<T, Object> m : c2Var.f9370a.m()) {
            m(m);
        }
    }
    ...
    public final Iterator<Map.Entry<T, Object>> p() {
        if (this.f9372c) {
            return new m2(this.f9370a.entrySet().iterator());
        }
        return this.f9370a.entrySet().iterator();
    }

    /* access modifiers changed from: package-private */
    public final Iterator<Map.Entry<T, Object>> q() {
        if (this.f9372c) {
            return new m2(this.f9370a.o().iterator());
        }
        return this.f9370a.o().iterator();
    }

    public final boolean r() {
        for (int i = 0; i < this.f9370a.j(); i++) {
            if (!i(this.f9370a.h(i))) {
                return false;
            }
        }
        for (Map.Entry<T, Object> i2 : this.f9370a.m()) {
            if (!i(i2)) {
                return false;
            }
        }
    ...
    public final int s() {
        int i = 0;
        for (int i2 = 0; i2 < this.f9370a.j(); i2++) {
            i += n(this.f9370a.h(i2));
        }
        for (Map.Entry<T, Object> n : this.f9370a.m()) {
            i += n(n);
        }
        return i;
    }
