...
public final class zzjr implements zzjo {
    ...
    private static final zzcv<Long> f9691a;

    /* renamed from: b  reason: collision with root package name */
    private static final zzcv<Long> f9692b;

    /* renamed from: c  reason: collision with root package name */
    private static final zzcv<String> f9693c;

    /* renamed from: d  reason: collision with root package name */
    private static final zzcv<String> f9694d;

    /* renamed from: e  reason: collision with root package name */
    private static final zzcv<Long> f9695e;

    /* renamed from: f  reason: collision with root package name */
    private static final zzcv<Long> f9696f;
    private static final zzcv<Long> g;
    ...
    static {
        ...
        f9691a = zzdb.b("measurement.ad_id_cache_time", 10000);
        f9692b = zzdb.b("measurement.config.cache_time", 86400000);
        zzdb.c("measurement.log_tag", "FA");
        f9693c = zzdb.c("measurement.config.url_authority", "app-measurement.com");
        f9694d = zzdb.c("measurement.config.url_scheme", "https");
        f9695e = zzdb.b("measurement.upload.debug_upload_interval", 1000);
        f9696f = zzdb.b("measurement.lifetimevalue.max_currency_tracked", 4);
    ...
    public final long a() {
        return f9691a.n().longValue();
    }

    public final long b() {
        return f9692b.n().longValue();
    }
