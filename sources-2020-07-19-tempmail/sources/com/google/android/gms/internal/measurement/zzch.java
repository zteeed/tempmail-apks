...
public final class zzch implements l0 {
    ...
    private final ContentResolver f9580a;

    /* renamed from: b  reason: collision with root package name */
    private final Uri f9581b;

    /* renamed from: c  reason: collision with root package name */
    private final ContentObserver f9582c = new j0(this, (Handler) null);

    /* renamed from: d  reason: collision with root package name */
    private final Object f9583d = new Object();

    /* renamed from: e  reason: collision with root package name */
    private volatile Map<String, String> f9584e;

    /* renamed from: f  reason: collision with root package name */
    private final List<zzcm> f9585f = new ArrayList();

    private zzch(ContentResolver contentResolver, Uri uri) {
        this.f9580a = contentResolver;
        this.f9581b = uri;
        contentResolver.registerContentObserver(uri, false, this.f9582c);
    }
    ...
    static synchronized void d() {
        synchronized (zzch.class) {
            for (zzch next : g.values()) {
                next.f9580a.unregisterContentObserver(next.f9582c);
            }
            g.clear();
        }
    }
    ...
    public final Map<String, String> b() {
        Map<String, String> map = this.f9584e;
        if (map == null) {
    ...
    public final /* synthetic */ Map e() {
        Map map;
        Cursor query = this.f9580a.query(this.f9581b, h, (String) null, (String[]) null, (String) null);
        if (query == null) {
            return Collections.emptyMap();
        }
        try {
