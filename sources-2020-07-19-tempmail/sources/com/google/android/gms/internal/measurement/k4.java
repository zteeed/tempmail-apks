...
final class k4 {
    ...
    private static final Logger f9442a = Logger.getLogger(k4.class.getName());

    /* renamed from: b  reason: collision with root package name */
    private static final Unsafe f9443b = t();

    /* renamed from: c  reason: collision with root package name */
    private static final Class<?> f9444c = f1.c();

    /* renamed from: d  reason: collision with root package name */
    private static final boolean f9445d = B(Long.TYPE);

    /* renamed from: e  reason: collision with root package name */
    private static final boolean f9446e = B(Integer.TYPE);

    /* renamed from: f  reason: collision with root package name */
    private static final c f9447f;
    ...
    static abstract class c {
        ...
        public final void e(Object obj, long j, int i) {
            this.f9448a.putInt(obj, j, i);
        }

        public final void f(Object obj, long j, long j2) {
            this.f9448a.putLong(obj, j, j2);
        }
        ...
        public final int k(Object obj, long j) {
            return this.f9448a.getInt(obj, j);
        }

        public final long l(Object obj, long j) {
            return this.f9448a.getLong(obj, j);
        }
    }
    ...
    static final class d extends c {
        ...
        public final byte a(Object obj, long j) {
            return this.f9448a.getByte(obj, j);
        }

        public final void b(Object obj, long j, byte b2) {
            this.f9448a.putByte(obj, j, b2);
        }

        public final void c(Object obj, long j, double d2) {
            this.f9448a.putDouble(obj, j, d2);
        }

        public final void d(Object obj, long j, float f2) {
            this.f9448a.putFloat(obj, j, f2);
        }

        public final void g(Object obj, long j, boolean z) {
            this.f9448a.putBoolean(obj, j, z);
        }

        public final boolean h(Object obj, long j) {
            return this.f9448a.getBoolean(obj, j);
        }

        public final float i(Object obj, long j) {
            return this.f9448a.getFloat(obj, j);
        }

        public final double j(Object obj, long j) {
            return this.f9448a.getDouble(obj, j);
        }
    }
    ...
    static {
        ...
        s(cls);
        Field G = G();
        if (!(G == null || (cVar = f9447f) == null)) {
            cVar.f9448a.objectFieldOffset(G);
        }
    }
    ...
    static Object F(Object obj, long j2) {
        return f9447f.f9448a.getObject(obj, j2);
    }
    ...
    static byte a(byte[] bArr, long j2) {
        return f9447f.a(bArr, i + j2);
    }

    static int b(Object obj, long j2) {
        return f9447f.k(obj, j2);
    }

    static <T> T c(Class<T> cls) {
        try {
            return f9443b.allocateInstance(cls);
    ...
    static void j(Object obj, long j2, Object obj2) {
        f9447f.f9448a.putObject(obj, j2, obj2);
    }
    ...
    private static int n(Class<?> cls) {
        if (h) {
            return f9447f.f9448a.arrayBaseOffset(cls);
        }
        return -1;
    }

    static long o(Object obj, long j2) {
        return f9447f.l(obj, j2);
    }
    ...
    private static int s(Class<?> cls) {
        if (h) {
            return f9447f.f9448a.arrayIndexScale(cls);
        }
        return -1;
    }
    ...
    static boolean w(Object obj, long j2) {
        return f9447f.h(obj, j2);
    }

    static float x(Object obj, long j2) {
        return f9447f.i(obj, j2);
    }
