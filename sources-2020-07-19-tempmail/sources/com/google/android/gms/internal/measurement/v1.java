...
final class v1 extends zzes {
    ...
    private final void I() {
        int i2 = this.f9509e + this.f9510f;
        this.f9509e = i2;
        int i3 = i2 - this.h;
        int i4 = this.j;
        if (i3 > i4) {
    ...
    public final String q() throws IOException {
        int E = E();
        if (E > 0 && E <= this.f9509e - this.g) {
            String str = new String(this.f9508d, this.g, E, zzfr.f9640a);
            this.g += E;
            return str;
        } else if (E == 0) {
            return "";
    ...
    public final String r() throws IOException {
        ...
        if (E > 0) {
            ...
            int i3 = this.g;
            if (E <= i2 - i3) {
                String k = m4.k(this.f9508d, i3, E);
                this.g += E;
                return k;
            }
        }
    ...
    public final zzeg s() throws IOException {
        ...
        if (E > 0) {
            ...
            int i3 = this.g;
            if (E <= i2 - i3) {
                zzeg q = zzeg.q(this.f9508d, i3, E);
                this.g += E;
                return q;
            }
        }
        ...
        if (E > 0) {
            ...
            if (E <= i4 - i5) {
                int i6 = E + i5;
                this.g = i6;
                bArr = Arrays.copyOfRange(this.f9508d, i5, i6);
                return zzeg.m(bArr);
            }
        }
        if (E > 0) {
