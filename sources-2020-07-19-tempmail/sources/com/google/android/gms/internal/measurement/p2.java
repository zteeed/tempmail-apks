...
final class p2 extends o2 {
    ...
    private static final Class<?> f9472c = Collections.unmodifiableList(Collections.emptyList()).getClass();
    ...
    public final void e(Object obj, long j) {
        ...
        if (list instanceof zzgh) {
            obj2 = ((zzgh) list).e();
        } else if (!f9472c.isAssignableFrom(list.getClass())) {
