...
public abstract class zzfo<MessageType extends zzfo<MessageType, BuilderType>, BuilderType extends zza<MessageType, BuilderType>> extends zzdw<MessageType, BuilderType> {
    ...
    public static abstract class zza<MessageType extends zzfo<MessageType, BuilderType>, BuilderType extends zza<MessageType, BuilderType>> extends zzdv<MessageType, BuilderType> {
        ...
        private final MessageType f9631b;

        /* renamed from: c  reason: collision with root package name */
        protected MessageType f9632c;

        /* renamed from: d  reason: collision with root package name */
        protected boolean f9633d = false;

        protected zza(MessageType messagetype) {
            this.f9631b = messagetype;
            this.f9632c = (zzfo) messagetype.r(zzf.f9637d, (Object) null, (Object) null);
        }
        ...
        private final BuilderType t(zzes zzes, zzfb zzfb) throws IOException {
            ...
            try {
                l3.a().c(this.f9632c).d(this.f9632c, u1.P(zzes), zzfb);
                return this;
        ...
        private final BuilderType w(byte[] bArr, int i, int i2, zzfb zzfb) throws zzfw {
            ...
            try {
                l3.a().c(this.f9632c).j(this.f9632c, bArr, 0, i2 + 0, new h1(zzfb));
                return this;
            } catch (zzfw e2) {
                throw e2;
        ...
        public /* synthetic */ Object clone() throws CloneNotSupportedException {
            zza zza = (zza) this.f9631b.r(zzf.f9638e, (Object) null, (Object) null);
            zza.r((zzfo) m());
            return zza;
        }

        public final boolean f() {
            return zzfo.v(this.f9632c, false);
        }
        ...
        public final BuilderType r(MessageType messagetype) {
            ...
            s(this.f9632c, messagetype);
            return this;
        }

        /* access modifiers changed from: protected */
        public void x() {
            MessageType messagetype = (zzfo) this.f9632c.r(zzf.f9637d, (Object) null, (Object) null);
            s(messagetype, this.f9632c);
            this.f9632c = messagetype;
        }
        ...
        public MessageType m() {
            ...
            MessageType messagetype = this.f9632c;
    ...
    public static final class zzf {
        ...
        public static final int f9638e = 5;

        /* renamed from: f  reason: collision with root package name */
        public static final int f9639f = 6;
    ...
    static <T extends zzfo<?, ?>> T n(Class<T> cls) {
        ...
        if (t == null) {
            t = (zzfo) ((zzfo) k4.c(cls)).r(zzf.f9639f, (Object) null, (Object) null);
            if (t != null) {
                zzd.put(cls, t);
            } else {
    ...
    protected static final <T extends zzfo<T, ?>> boolean v(T t, boolean z) {
        byte byteValue = ((Byte) t.r(zzf.f9634a, (Object) null, (Object) null)).byteValue();
        if (byteValue == 1) {
            return true;
        }
        if (byteValue == 0) {
        ...
        if (z) {
            t.r(zzf.f9635b, e2 ? t : null, (Object) null);
        }
        return e2;
    }
    ...
    public final /* synthetic */ zzgw b() {
        return (zzfo) r(zzf.f9639f, (Object) null, (Object) null);
    }

    public final /* synthetic */ zzgz c() {
        zza zza2 = (zza) r(zzf.f9638e, (Object) null, (Object) null);
        zza2.r(this);
        return zza2;
    }

    public final /* synthetic */ zzgz e() {
        return (zza) r(zzf.f9638e, (Object) null, (Object) null);
    }
    ...
    public final BuilderType x() {
        BuilderType buildertype = (zza) r(zzf.f9638e, (Object) null, (Object) null);
        buildertype.r(this);
        return buildertype;
    }
}
