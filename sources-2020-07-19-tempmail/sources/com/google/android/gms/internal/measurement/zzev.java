...
public abstract class zzev extends zzed {
    ...
    private static final Logger f9614b = Logger.getLogger(zzev.class.getName());
    /* access modifiers changed from: private */

    /* renamed from: c  reason: collision with root package name */
    public static final boolean f9615c = k4.m();
    ...
    static class a extends zzev {
        ...
        private final void G0(byte[] bArr, int i, int i2) throws IOException {
            try {
                System.arraycopy(bArr, i, this.f9617d, this.f9619f, i2);
                this.f9619f += i2;
            } catch (IndexOutOfBoundsException e2) {
                throw new zzb(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.f9619f), Integer.valueOf(this.f9618e), Integer.valueOf(i2)}), e2);
            }
        }

        public final void O(int i) throws IOException {
            if (!zzev.f9615c || f1.b() || b() < 5) {
                while ((i & -128) != 0) {
                ...
                try {
                    ...
                    throw new zzb(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.f9619f), Integer.valueOf(this.f9618e), 1}), e2);
                }
            } else if ((i & -128) == 0) {
                byte[] bArr3 = this.f9617d;
                int i4 = this.f9619f;
                this.f9619f = i4 + 1;
                k4.l(bArr3, (long) i4, (byte) i);
            } else {
                byte[] bArr4 = this.f9617d;
                int i5 = this.f9619f;
                this.f9619f = i5 + 1;
                k4.l(bArr4, (long) i5, (byte) (i | 128));
                int i6 = i >>> 7;
                if ((i6 & -128) == 0) {
                    byte[] bArr5 = this.f9617d;
                    int i7 = this.f9619f;
                    this.f9619f = i7 + 1;
                    k4.l(bArr5, (long) i7, (byte) i6);
                    return;
                }
                byte[] bArr6 = this.f9617d;
                int i8 = this.f9619f;
                this.f9619f = i8 + 1;
                k4.l(bArr6, (long) i8, (byte) (i6 | 128));
                int i9 = i6 >>> 7;
                if ((i9 & -128) == 0) {
                    byte[] bArr7 = this.f9617d;
                    int i10 = this.f9619f;
                    this.f9619f = i10 + 1;
                    k4.l(bArr7, (long) i10, (byte) i9);
                    return;
                }
                byte[] bArr8 = this.f9617d;
                int i11 = this.f9619f;
                this.f9619f = i11 + 1;
                k4.l(bArr8, (long) i11, (byte) (i9 | 128));
                int i12 = i9 >>> 7;
                if ((i12 & -128) == 0) {
                    byte[] bArr9 = this.f9617d;
                    int i13 = this.f9619f;
                    this.f9619f = i13 + 1;
                    k4.l(bArr9, (long) i13, (byte) i12);
                    return;
                }
                byte[] bArr10 = this.f9617d;
                int i14 = this.f9619f;
                this.f9619f = i14 + 1;
                k4.l(bArr10, (long) i14, (byte) (i12 | 128));
                byte[] bArr11 = this.f9617d;
                int i15 = this.f9619f;
                this.f9619f = i15 + 1;
        ...
        public final int b() {
            return this.f9618e - this.f9619f;
        }
        ...
        public final void w(String str) throws IOException {
            ...
            try {
                ...
                if (p02 == p0) {
                    int i2 = i + p02;
                    this.f9619f = i2;
                    int e2 = m4.e(str, this.f9617d, i2, b());
                    this.f9619f = i;
                    O((e2 - i) - p02);
                    this.f9619f = e2;
                    return;
                ...
                O(m4.d(str));
                this.f9619f = m4.e(str, this.f9617d, this.f9619f, b());
            } catch (q4 e3) {
                this.f9619f = i;
                x(str, e3);
    ...
    public static int K(String str) {
        ...
        try {
            ...
            i = str.getBytes(zzfr.f9640a).length;
        }
        return p0(i) + i;
    }
    ...
    public final void x(String str, q4 q4Var) throws IOException {
        f9614b.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", q4Var);
        byte[] bytes = str.getBytes(zzfr.f9640a);
        try {
            O(bytes.length);
