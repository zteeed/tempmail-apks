...
public final class zah extends AbstractSafeParcelable {
    ...
    private final ResolveAccountRequest f10551c;

    @SafeParcelable.Constructor
    zah(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) ResolveAccountRequest resolveAccountRequest) {
        this.f10550b = i;
        this.f10551c = resolveAccountRequest;
    }

    public final void writeToParcel(Parcel parcel, int i) {
        int a2 = SafeParcelWriter.a(parcel);
        SafeParcelWriter.l(parcel, 1, this.f10550b);
        SafeParcelWriter.r(parcel, 2, this.f10551c, i, false);
