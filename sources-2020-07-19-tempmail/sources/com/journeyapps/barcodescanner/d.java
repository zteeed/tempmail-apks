...
public class d {
    ...
    public DecoratedBarcodeView f12164b;
    ...
    private com.google.zxing.s.a.e f12168f;
    /* access modifiers changed from: private */
    ...
    public d(Activity activity, DecoratedBarcodeView decoratedBarcodeView) {
        ...
        this.f12164b = decoratedBarcodeView;
        decoratedBarcodeView.getBarcodeView().i(this.k);
        this.h = new Handler();
        this.f12168f = new com.google.zxing.s.a.e(activity, new c());
    ...
    private String k(c cVar) {
        if (this.f12166d) {
            Bitmap b2 = cVar.b();
            try {
                File createTempFile = File.createTempFile("barcodeimage", ".jpg", this.f12163a.getCacheDir());
    ...
    @TargetApi(23)
    private void s() {
        if (androidx.core.content.a.a(this.f12163a, "android.permission.CAMERA") == 0) {
            this.f12164b.i();
        } else if (!this.l) {
            androidx.core.app.a.o(this.f12163a, new String[]{"android.permission.CAMERA"}, n);
            this.l = true;
        }
    }
    ...
    public void g() {
        if (this.f12164b.getBarcodeView().s()) {
            j();
        } else {
            this.i = true;
        }
    ...
    public void h() {
        this.f12164b.c(this.j);
    }

    /* access modifiers changed from: protected */
    public void i() {
        if (!this.f12163a.isFinishing() && !this.f12167e && !this.i) {
            AlertDialog.Builder builder = new AlertDialog.Builder(this.f12163a);
            builder.setTitle(this.f12163a.getString(j.zxing_app_name));
            builder.setMessage(this.f12163a.getString(j.zxing_msg_camera_framework_bug));
    ...
    public void l(Intent intent, Bundle bundle) {
        this.f12163a.getWindow().addFlags(128);
        if (bundle != null) {
            this.f12165c = bundle.getInt("SAVED_ORIENTATION_LOCK", -1);
        }
        if (intent != null) {
    ...
    public void m() {
        if (this.f12165c == -1) {
            int rotation = this.f12163a.getWindowManager().getDefaultDisplay().getRotation();
            int i2 = this.f12163a.getResources().getConfiguration().orientation;
            int i3 = 0;
            if (i2 == 2) {
        ...
        this.f12163a.setRequestedOrientation(this.f12165c);
    }
    ...
    public void r(Bundle bundle) {
        bundle.putInt("SAVED_ORIENTATION_LOCK", this.f12165c);
    }

    /* access modifiers changed from: protected */
    public void u(c cVar) {
        this.f12163a.setResult(-1, t(cVar, k(cVar)));
        g();
    }
    ...
    public void v() {
        ...
        this.f12163a.setResult(0, intent);
        g();
    }
}
