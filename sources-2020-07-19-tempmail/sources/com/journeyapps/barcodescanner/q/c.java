...
public final class c {
    ...
    private Camera f12230a;

    /* renamed from: b  reason: collision with root package name */
    private Camera.CameraInfo f12231b;

    /* renamed from: c  reason: collision with root package name */
    private a f12232c;

    /* renamed from: d  reason: collision with root package name */
    private com.google.zxing.s.a.a f12233d;
    ...
    private final class a implements Camera.PreviewCallback {
        ...
        public void onPreviewFrame(byte[] bArr, Camera camera) {
            ...
            if (nVar == null || kVar == null) {
                ...
                try {
                    byte[] bArr2 = bArr;
                    kVar.b(new o(bArr2, nVar.f12198b, nVar.f12199c, camera.getParameters().getPreviewFormat(), c.this.e()));
    ...
    private int b() {
        ...
        Camera.CameraInfo cameraInfo = this.f12231b;
    ...
    private Camera.Parameters f() {
        Camera.Parameters parameters = this.f12230a.getParameters();
        String str = this.f12235f;
        if (str == null) {
            this.f12235f = parameters.flatten();
        } else {
    ...
    private void m(int i2) {
        this.f12230a.setDisplayOrientation(i2);
    }
    ...
    private void o(boolean z) {
        ...
        if (h2.size() == 0) {
            ...
            n a2 = this.h.a(h2, i());
            this.i = a2;
            f2.setPreviewSize(a2.f12198b, a2.f12199c);
        }
    ...
    private void q() {
        ...
        Camera.Size previewSize = this.f12230a.getParameters().getPreviewSize();
        if (previewSize == null) {
            this.j = this.i;
        } else {
        ...
        if (this.f12230a != null) {
            try {
                if (z != j()) {
                    ...
                    this.f12230a.setParameters(parameters);
                    if (this.f12232c != null) {
                        this.f12232c.i();
                    }
                }
    ...
    public void t() {
        ...
        if (camera != null && !this.f12234e) {
            camera.startPreview();
            this.f12234e = true;
            this.f12232c = new a(this.f12230a, this.g);
    ...
    public void u() {
        ...
        com.google.zxing.s.a.a aVar2 = this.f12233d;
        if (aVar2 != null) {
            aVar2.d();
            this.f12233d = null;
        }
