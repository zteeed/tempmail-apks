...
public class w {
    ...
    public static final String f12590a = "w";
    ...
    public static void C(Context context, String str, String str2) {
        ...
        if (str2 != null) {
            String str3 = b.f12596c + " - " + str2;
            intent.putExtra("android.intent.extra.SUBJECT", str3);
            m.b(f12590a, "subject " + str3);
        }
        ...
        m.b(f12590a, "feedback " + context.getString(R.string.feedback_body, new Object[]{Locale.getDefault().getLanguage(), Build.MODEL, typeName, str4, f(context)}));
    ...
    public static File n() {
        File file = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), b.f12596c);
        file.mkdirs();
        return file;
    }
