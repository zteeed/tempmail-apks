...
public class ApplicationClass extends Application {
    ...
    public static final String f12265c = ApplicationClass.class.getSimpleName();

    /* renamed from: b  reason: collision with root package name */
    boolean f12266b = false;
    ...
    class a implements h {
        ...
        public void a(Map<String, String> map) {
            m.b(ApplicationClass.f12265c, "onInstallConversionDataLoaded ");
            for (Map.Entry next : map.entrySet()) {
                String a2 = ApplicationClass.f12265c;
                m.b(a2, "onInstallConversionDataLoaded entry " + ((String) next.getKey()) + " value " + ((String) next.getValue()));
            }
        }

        public void b(Map<String, String> map) {
            m.b(ApplicationClass.f12265c, "onAppOpenAttribution");
            for (Map.Entry next : map.entrySet()) {
                String a2 = ApplicationClass.f12265c;
                m.b(a2, "onInstallConversionDataLoaded entry " + ((String) next.getKey()) + " value " + ((String) next.getValue()));
            }
