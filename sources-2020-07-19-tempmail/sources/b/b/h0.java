...
final class h0 {
    ...
    private JSONObject f2016c;

    /* renamed from: d  reason: collision with root package name */
    private JSONArray f2017d;
    ...
    private synchronized void i(String str, String str2, String str3, String str4) {
        try {
            this.f2016c.put("sdk_version", str);
            if (str2 != null && str2.length() > 0) {
                this.f2016c.put("devkey", str2);
            }
            if (str3 != null && str3.length() > 0) {
                this.f2016c.put("originalAppsFlyerId", str3);
            }
            if (str4 != null && str4.length() > 0) {
                this.f2016c.put("uid", str4);
            }
        } catch (Throwable unused) {
        }
    }
    ...
    private synchronized void l(String str, String str2, String str3, String str4) {
        ...
        if (str2 != null && str2.length() > 0) {
            this.f2016c.put("app_version", str2);
        }
        if (str3 != null && str3.length() > 0) {
            this.f2016c.put("channel", str3);
        }
        if (str4 != null && str4.length() > 0) {
            this.f2016c.put("preInstall", str4);
        }
    }
    ...
    private synchronized void o(java.lang.String r11, android.content.pm.PackageManager r12) {
        ...
        L_0x0065:
            ...
            org.json.JSONObject r12 = r10.f2016c     // Catch:{ all -> 0x0081 }
            java.lang.String r12 = r12.toString()     // Catch:{ all -> 0x0081 }
            r0.n(r11, r12)     // Catch:{ all -> 0x0081 }
        L_0x0070:
            org.json.JSONObject r11 = r10.f2016c     // Catch:{ JSONException -> 0x007b }
    ...
    private synchronized void p(String str, String str2, String str3, String str4, String str5, String str6) {
        try {
            this.f2016c.put("brand", str);
            this.f2016c.put("model", str2);
            this.f2016c.put("platform", "Android");
            this.f2016c.put("platform_version", str3);
            if (str4 != null && str4.length() > 0) {
                this.f2016c.put("advertiserId", str4);
            }
            if (str5 != null && str5.length() > 0) {
                this.f2016c.put("imei", str5);
            }
            if (str6 != null && str6.length() > 0) {
                this.f2016c.put("android_id", str6);
            }
        } catch (Throwable unused) {
        }
    }
    ...
    private synchronized void s(java.lang.String r12, java.lang.String r13, java.lang.String... r14) {
        /*
            r11 = this;
            monitor-enter(r11)
            boolean r0 = r11.f2015b     // Catch:{ all -> 0x00b5 }
            r1 = 1
            r2 = 0
            if (r0 == 0) goto L_0x0011
            boolean r0 = r11.f2014a     // Catch:{ all -> 0x00b5 }
            if (r0 != 0) goto L_0x000f
            boolean r0 = r11.f2019f     // Catch:{ all -> 0x00b5 }
            if (r0 == 0) goto L_0x0011
        L_0x000f:
            r0 = 1
            goto L_0x0012
        ...
        L_0x0012:
            ...
            int r0 = r11.f2018e     // Catch:{ all -> 0x00b5 }
        ...
        L_0x00a0:
            org.json.JSONArray r13 = r11.f2017d     // Catch:{ all -> 0x00b1 }
            r13.put(r12)     // Catch:{ all -> 0x00b1 }
            int r13 = r11.f2018e     // Catch:{ all -> 0x00b1 }
            byte[] r12 = r12.getBytes()     // Catch:{ all -> 0x00b1 }
            int r12 = r12.length     // Catch:{ all -> 0x00b1 }
            int r13 = r13 + r12
            r11.f2018e = r13     // Catch:{ all -> 0x00b1 }
            monitor-exit(r11)
            return
        L_0x00b1:
            monitor-exit(r11)
    ...
    private synchronized java.lang.String t() {
        /*
            r3 = this;
            monitor-enter(r3)
            org.json.JSONObject r0 = r3.f2016c     // Catch:{ JSONException -> 0x0017, all -> 0x0014 }
            java.lang.String r1 = "data"
            org.json.JSONArray r2 = r3.f2017d     // Catch:{ JSONException -> 0x0017, all -> 0x0014 }
