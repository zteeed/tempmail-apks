...
final class p {
    ...
    private static String e(int i, int i2, char c2) {
        ...
        while (true) {
            ...
            f2058d = i6 % 128;
            int i7 = i6 % 2;
            cArr[i5] = (char) ((int) ((((long) f2055a[i + i5]) ^ (((long) i5) * f2056b)) ^ ((long) c2)));
            i5++;
        }
    }
    ...
    static class a extends HashMap<String, Object> {
        ...
        /* renamed from: b  reason: collision with root package name */
        private final Map<String, Object> f2062b;
        ...
        private String b() {
            ...
            int i;
            try {
                String obj = this.f2062b.get(e(0, 12, 0).intern()).toString();
                String obj2 = this.f2062b.get(e(77, 15, 0).intern()).toString();
            ...
            try {
                Intent registerReceiver = this.f2063c.registerReceiver((BroadcastReceiver) null, new IntentFilter(e(164, 37, 10560).intern()));
                int i2 = -2700;
                if (registerReceiver != null) {
                    i2 = registerReceiver.getIntExtra(e(201, 11, 0).intern(), -2700);
                }
                if (!(this.f2063c.getApplicationInfo().nativeLibraryDir.contains(e(212, 3, 0).intern()))) {
                    int i3 = g + 53;
                    f2061f = i3 % 128;
                    int i4 = i3 % 2;
                } else {
                    ...
                    if ((i5 % 2 != 0 ? 'N' : 29) != 'N') {
                        i = 1;
                        int size = ((SensorManager) this.f2063c.getSystemService(e(215, 6, 33174).intern())).getSensorList(-1).size();
                ...
                i = 0;
                int size2 = ((SensorManager) this.f2063c.getSystemService(e(215, 6, 33174).intern())).getSensorList(-1).size();
        ...
        private String c() {
            ...
            try {
                ...
                String obj = this.f2062b.get(e(0, 12, 0).intern()).toString();
                String obj2 = this.f2062b.get(e(12, 5, 18067).intern()).toString();
        ...
        private static String e(int i, int i2, char c2) {
            ...
            while (true) {
                ...
                f2061f = i6 % 128;
                int i7 = i6 % 2;
                cArr[i3] = (char) ((int) ((((long) f2059d[i + i3]) ^ (((long) i3) * f2060e)) ^ ((long) c2)));
                i3++;
            }
        }
        ...
        static class C0059a {
            ...
            private boolean b(long r9, java.lang.String r11) {
                /*
                    r8 = this;
                    java.lang.Object r0 = r8.f2064a
                    monitor-enter(r0)
                    r1 = 0
                    if (r11 == 0) goto L_0x0027
                    java.lang.String r2 = r8.f2066c     // Catch:{ all -> 0x0024 }
                    boolean r2 = r11.equals(r2)     // Catch:{ all -> 0x0024 }
                    if (r2 != 0) goto L_0x0027
                    long r2 = r8.f2065b     // Catch:{ all -> 0x0024 }
                    long r2 = r9 - r2
                ...
                L_0x001c:
                    if (r2 == 0) goto L_0x0027
                    r8.f2065b = r9     // Catch:{ all -> 0x0024 }
                    r8.f2066c = r11     // Catch:{ all -> 0x0024 }
            ...
            public final boolean e(C0059a aVar) {
                return b(aVar.f2065b, aVar.f2066c);
            }
