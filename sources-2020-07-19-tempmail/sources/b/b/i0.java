...
final class i0 extends n {
    ...
    private static List<String> f2045e = Arrays.asList(new String[]{"onelink.me", "onelnk.com", "app.aflink.com"});
    ...
    public final void b() {
        this.f2046c.a("Can't get one link data");
    }
    ...
    public final void d(String str) {
        try {
            ...
            this.f2046c.b(hashMap);
        } catch (JSONException e2) {
            this.f2046c.a("Can't parse one link data");
    ...
    public final boolean g() {
        return !TextUtils.isEmpty(this.f2054b) && !TextUtils.isEmpty(this.f2047d);
    }
}
