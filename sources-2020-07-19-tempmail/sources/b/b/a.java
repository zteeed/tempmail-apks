...
public class a {
    ...
    static final int f1963b = ((int) TimeUnit.MILLISECONDS.toMillis(1500));

    /* renamed from: c  reason: collision with root package name */
    static volatile boolean f1964c;

    /* renamed from: d  reason: collision with root package name */
    static String[] f1965d;

    /* renamed from: e  reason: collision with root package name */
    private static a f1966e = null;

    /* renamed from: f  reason: collision with root package name */
    private static Uri f1967f = null;
    private static Uri g = null;

    /* renamed from: a  reason: collision with root package name */
    protected int f1968a = -1;

    /* renamed from: b.b.a$a  reason: collision with other inner class name */
    class C0057a implements Runnable {

        /* renamed from: b  reason: collision with root package name */
        private /* synthetic */ Uri f1969b;

        /* renamed from: c  reason: collision with root package name */
        private /* synthetic */ Map f1970c;

        /* renamed from: d  reason: collision with root package name */
        private /* synthetic */ Context f1971d;
        ...
        public final void run() {
            ...
            try {
                ...
                sb.append(this.f1969b.toString());
                e.e(sb.toString());
                HttpURLConnection httpURLConnection = (HttpURLConnection) new URL(this.f1969b.toString()).openConnection();
                httpURLConnection.setInstanceFollowRedirects(false);
                httpURLConnection.setReadTimeout(a.f1963b);
                httpURLConnection.setConnectTimeout(a.f1963b);
            ...
            synchronized (this.f1970c) {
                this.f1970c.put("af_deeplink_r", hashMap);
                this.f1970c.put("af_deeplink", this.f1969b.toString());
            }
            a.f1964c = false;
            if (uri == null) {
                uri = this.f1969b;
            }
            i.e().f(this.f1971d, this.f1970c, uri);
        }
    }
    ...
    public void c(Intent intent, Context context, Map<String, Object> map) {
        ...
        if (data != null) {
            ...
            if (intent.hasExtra("appsflyer_click_ts") && !a2) {
                ...
                if (this.f1968a != j.b().c("lastActivityHash", 0)) {
                    d(context, map, data);
                    j.b().l("lastActivityHash", this.f1968a);
                    return;
                }
                StringBuilder sb3 = new StringBuilder("skipping re-use of previously consumed deep link: ");
                sb3.append(data.toString());
                sb3.append(" w/hC: ");
                sb3.append(String.valueOf(this.f1968a));
                e.c(sb3.toString());
            }
        } else {
            Uri uri2 = g;
