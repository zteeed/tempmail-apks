...
public class b0 implements c, com.google.android.datatransport.runtime.synchronization.a {
    ...
    private static final b.c.a.b.b f2211f = b.c.a.b.b.b("proto");

    /* renamed from: b  reason: collision with root package name */
    private final h0 f2212b;

    /* renamed from: c  reason: collision with root package name */
    private final b.c.a.b.i.x.a f2213c;

    /* renamed from: d  reason: collision with root package name */
    private final b.c.a.b.i.x.a f2214d;
    ...
    static /* synthetic */ Long G(b0 b0Var, m mVar, h hVar, SQLiteDatabase sQLiteDatabase) {
        ...
        for (Map.Entry next : hVar.i().entrySet()) {
            ...
            contentValues3.put(AnalyticsConnectorReceiver.EVENT_NAME_KEY, (String) next.getKey());
    ...
    private List<i> K(SQLiteDatabase sQLiteDatabase, m mVar) {
        ...
        S(sQLiteDatabase2.query("events", new String[]{"_id", "transport_name", "timestamp_ms", "uptime_ms", "payload_encoding", "payload", "code", "inline"}, "context_id = ?", new String[]{h.toString()}, (String) null, (String) null, (String) null, String.valueOf(this.f2215e.d())), n.a(this, arrayList, mVar));
        return arrayList;
    }
    ...
    private Map<Long, Set<c>> L(SQLiteDatabase sQLiteDatabase, List<i> list) {
        ...
        sb.append(')');
        S(sQLiteDatabase.query("event_metadata", new String[]{"event_id", AnalyticsConnectorReceiver.EVENT_NAME_KEY, "value"}, sb.toString(), (String[]) null, (String) null, (String) null, (String) null), p.a(hashMap));
        return hashMap;
    }
    ...
    private <T> T P(d<T> dVar, b<Throwable, T> bVar) {
        long a2 = this.f2214d.a();
        while (true) {
            try {
                return dVar.a();
            } catch (SQLiteDatabaseLockedException e2) {
                if (this.f2214d.a() >= ((long) this.f2215e.b()) + a2) {
    ...
    public int c() {
        return ((Integer) k(m.a(this.f2213c.a() - this.f2215e.c()))).intValue();
    }
