...
public class a extends c {
    ...
    public a(Context context, Drawable drawable, float f2, float f3, float f4) {
        ...
        this.f2309f = (float) Math.round(f2);
        this.f2308e = new RectF();
        Paint paint2 = new Paint(this.f2306c);
        this.f2307d = paint2;
    ...
    private void c(Rect rect) {
        float f2 = this.h;
        float f3 = 1.5f * f2;
        this.f2308e.set(((float) rect.left) + f2, ((float) rect.top) + f3, ((float) rect.right) - f2, ((float) rect.bottom) - f3);
        Drawable a2 = a();
    ...
    private void d() {
        ...
        this.g.moveTo(-this.f2309f, 0.0f);
        ...
        float f4 = -rectF2.top;
        if (f4 > 0.0f) {
            float f5 = this.f2309f / f4;
            Paint paint = this.f2306c;
        ...
        this.f2307d.setShader(new LinearGradient(0.0f, rectF.top, 0.0f, rectF2.top, new int[]{this.l, this.m, this.n}, new float[]{0.0f, 0.5f, 1.0f}, Shader.TileMode.CLAMP));
        this.f2307d.setAntiAlias(false);
    }
    ...
    private void g(Canvas canvas) {
        ...
        canvas2.rotate(this.p, this.f2308e.centerX(), this.f2308e.centerY());
        float f6 = this.f2309f;
        float f7 = (-f6) - this.i;
        float f8 = f6 * 2.0f;
        boolean z = this.f2308e.width() - f8 > 0.0f;
        boolean z2 = this.f2308e.height() - f8 > 0.0f;
        float f9 = this.j;
        ...
        canvas2.drawPath(this.g, this.f2306c);
        if (z) {
            ...
            i2 = save;
            f3 = f11;
            canvas.drawRect(0.0f, f7, this.f2308e.width() - f8, -this.f2309f, this.f2307d);
        } else {
            i3 = save2;
            f2 = f12;
            i2 = save;
        ...
        if (z) {
            ...
            f4 = f3;
            f5 = f13;
            canvas.drawRect(0.0f, f7, this.f2308e.width() - f8, (-this.f2309f) + this.i, this.f2307d);
        } else {
            f4 = f3;
            f5 = f13;
        }
        ...
        if (z2) {
            ...
            canvas.drawRect(0.0f, f7, this.f2308e.height() - f8, -this.f2309f, this.f2307d);
        }
        canvas2.restoreToCount(save4);
        int save5 = canvas.save();
        RectF rectF4 = this.f2308e;
    ...
    public boolean getPadding(Rect rect) {
        int ceil = (int) Math.ceil((double) f(this.h, this.f2309f, this.o));
        int ceil2 = (int) Math.ceil((double) e(this.h, this.f2309f, this.o));
    ...
    public void setAlpha(int i2) {
        super.setAlpha(i2);
        this.f2306c.setAlpha(i2);
        this.f2307d.setAlpha(i2);
    }
}
