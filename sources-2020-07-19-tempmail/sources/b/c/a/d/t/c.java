...
public class c extends Drawable implements b {
    ...
    private final Paint f2310b = new Paint();

    /* renamed from: c  reason: collision with root package name */
    private final Matrix[] f2311c = new Matrix[4];

    /* renamed from: d  reason: collision with root package name */
    private final Matrix[] f2312d = new Matrix[4];

    /* renamed from: e  reason: collision with root package name */
    private final d[] f2313e = new d[4];
    ...
    public c(e eVar) {
        ...
        for (int i2 = 0; i2 < 4; i2++) {
            this.f2311c[i2] = new Matrix();
            this.f2312d[i2] = new Matrix();
            this.f2313e[i2] = new d();
        }
    }
    ...
    private void c(int i2, Path path) {
        float[] fArr = this.l;
        d[] dVarArr = this.f2313e;
        fArr[0] = dVarArr[i2].f2315a;
        fArr[1] = dVarArr[i2].f2316b;
        this.f2311c[i2].mapPoints(fArr);
        if (i2 == 0) {
            float[] fArr2 = this.l;
        ...
        this.f2313e[i2].b(this.f2311c[i2], path);
    }
    ...
    private void d(int i2, Path path) {
        ...
        float[] fArr = this.l;
        d[] dVarArr = this.f2313e;
        fArr[0] = dVarArr[i2].f2317c;
        fArr[1] = dVarArr[i2].f2318d;
        this.f2311c[i2].mapPoints(fArr);
        float[] fArr2 = this.m;
        d[] dVarArr2 = this.f2313e;
        fArr2[0] = dVarArr2[i3].f2315a;
        fArr2[1] = dVarArr2[i3].f2316b;
        this.f2311c[i3].mapPoints(fArr2);
        float[] fArr3 = this.l;
        float f2 = fArr3[0];
        float[] fArr4 = this.m;
        this.i.d(0.0f, 0.0f);
        g(i2).a((float) Math.hypot((double) (f2 - fArr4[0]), (double) (fArr3[1] - fArr4[1])), this.q, this.i);
        this.i.b(this.f2312d[i2], path);
    }
    ...
    private void m(int i2, int i3, int i4) {
        e(i2, i3, i4, this.h);
        f(i2).a(a(i2, i3, i4), this.q, this.f2313e[i2]);
        this.f2311c[i2].reset();
        Matrix matrix = this.f2311c[i2];
        PointF pointF = this.h;
        matrix.setTranslate(pointF.x, pointF.y);
        this.f2311c[i2].preRotate((float) Math.toDegrees((double) (b(((i2 - 1) + 4) % 4, i3, i4) + 1.5707964f)));
    }
    ...
    private void n(int i2, int i3, int i4) {
        ...
        this.f2311c[i2].mapPoints(fArr);
        float b2 = b(i2, i3, i4);
        this.f2312d[i2].reset();
        Matrix matrix = this.f2312d[i2];
        float[] fArr2 = this.l;
        matrix.setTranslate(fArr2[0], fArr2[1]);
        this.f2312d[i2].preRotate((float) Math.toDegrees((double) b2));
    }
    ...
    public void draw(Canvas canvas) {
        this.f2310b.setColorFilter(this.y);
        int alpha = this.f2310b.getAlpha();
        this.f2310b.setAlpha(l(alpha, this.u));
        this.f2310b.setStrokeWidth(this.w);
        this.f2310b.setStyle(this.x);
        int i2 = this.s;
        if (i2 > 0 && this.o) {
            this.f2310b.setShadowLayer((float) this.t, 0.0f, (float) i2, this.r);
        }
        if (this.n != null) {
            i(canvas.getWidth(), canvas.getHeight(), this.g);
            canvas.drawPath(this.g, this.f2310b);
        } else {
            canvas.drawRect(0.0f, 0.0f, (float) canvas.getWidth(), (float) canvas.getHeight(), this.f2310b);
        }
        this.f2310b.setAlpha(alpha);
    }
