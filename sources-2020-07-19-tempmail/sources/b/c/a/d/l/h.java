...
public class h {
    ...
    private final g<String, i> f2278a = new g<>();
    ...
    public boolean equals(Object obj) {
        ...
        return this.f2278a.equals(((h) obj).f2278a);
    }
    ...
    public boolean g(String str) {
        return this.f2278a.get(str) != null;
    }

    public void h(String str, i iVar) {
        this.f2278a.put(str, iVar);
    }
    ...
    public String toString() {
        return 10 + h.class.getName() + '{' + Integer.toHexString(System.identityHashCode(this)) + " timings: " + this.f2278a + "}\n";
    }
}
