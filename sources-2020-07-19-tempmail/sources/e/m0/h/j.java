    ...
    private g0 b(i0 i0Var, @Nullable k0 k0Var) throws IOException {
        ...
        if (i0Var != null) {
            ...
            if (d2 == 307 || d2 == 308) {
                ...
                return this.f14137a.c().a(k0Var, i0Var);
            } else {
                if (d2 != 503) {
                    if (d2 == 407) {
                        if (k0Var != null) {
                            ...
                            proxy = this.f14137a.D();
                        }
                        if (proxy.type() == Proxy.Type.HTTP) {
                            return this.f14137a.E().a(k0Var, i0Var);
                        }
            ...
            if (!this.f14137a.o() || (f2 = i0Var.f("Location")) == null || (D = i0Var.q().i().D(f2)) == null) {
                return null;
            }
            if (!D.E().equals(i0Var.q().i().E()) && !this.f14137a.p()) {
                return null;
            }
            g0.a g = i0Var.q().g();
            if (f.b(f3)) {
