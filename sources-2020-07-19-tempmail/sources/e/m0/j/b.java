...
class b extends f {
    ...
    private final Method f14162d;

    /* renamed from: e  reason: collision with root package name */
    private final Method f14163e;

    /* renamed from: f  reason: collision with root package name */
    private final Method f14164f;
    private final Method g;
    private final C0163b h = C0163b.b();
    ...
    static final class a extends e.m0.l.c {
        ...
        public List<Certificate> a(List<Certificate> list, String str) throws SSLPeerUnverifiedException {
            try {
                return (List) this.f14166b.invoke(this.f14165a, new Object[]{(X509Certificate[]) list.toArray(new X509Certificate[list.size()]), "RSA", str});
    ...
    static final class C0163b {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final Method f14167a;

        /* renamed from: b  reason: collision with root package name */
        private final Method f14168b;

        /* renamed from: c  reason: collision with root package name */
        private final Method f14169c;

        C0163b(Method method, Method method2, Method method3) {
            this.f14167a = method;
            this.f14168b = method2;
            this.f14169c = method3;
        }
        ...
        static C0163b b() {
            ...
            return new C0163b(method3, method, method2);
        }
        ...
        public Object a(String str) {
            ...
            if (method != null) {
                try {
                    ...
                    this.f14168b.invoke(invoke, new Object[]{str});
                    return invoke;
                } catch (Exception unused) {
                }
            }
        ...
        public boolean c(Object obj) {
            ...
            try {
                this.f14169c.invoke(obj, new Object[0]);
                return true;
            } catch (Exception unused) {
                return false;
            }
    ...
    static final class c implements e {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final X509TrustManager f14170a;

        /* renamed from: b  reason: collision with root package name */
        private final Method f14171b;

        c(X509TrustManager x509TrustManager, Method method) {
            this.f14171b = method;
            this.f14170a = x509TrustManager;
        }

        public X509Certificate a(X509Certificate x509Certificate) {
            try {
                TrustAnchor trustAnchor = (TrustAnchor) this.f14171b.invoke(this.f14170a, new Object[]{x509Certificate});
                if (trustAnchor != null) {
        ...
        public boolean equals(Object obj) {
            ...
            c cVar = (c) obj;
            if (!this.f14170a.equals(cVar.f14170a) || !this.f14171b.equals(cVar.f14171b)) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return this.f14170a.hashCode() + (this.f14171b.hashCode() * 31);
        }
    }
    ...
    b(Class<?> cls, Class<?> cls2, Method method, Method method2, Method method3, Method method4) {
        this.f14161c = cls2;
        this.f14162d = method;
        this.f14163e = method2;
        this.f14164f = method3;
        this.g = method4;
    }
    ...
    public void g(SSLSocket sSLSocket, String str, List<e0> list) {
        if (this.f14161c.isInstance(sSLSocket)) {
            if (str != null) {
                try {
                    this.f14162d.invoke(sSLSocket, new Object[]{Boolean.TRUE});
                    this.f14163e.invoke(sSLSocket, new Object[]{str});
    ...
    public String l(SSLSocket sSLSocket) {
        ...
        try {
            byte[] bArr = (byte[]) this.f14164f.invoke(sSLSocket, new Object[0]);
            if (bArr != null) {
