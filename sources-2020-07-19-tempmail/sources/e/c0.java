...
public final class c0 extends h0 {
    ...
    public static final b0 f13984e = b0.c("multipart/mixed");

    /* renamed from: f  reason: collision with root package name */
    public static final b0 f13985f = b0.c("multipart/form-data");
    private static final byte[] g = {58, 32};
    private static final byte[] h = {13, 10};
    private static final byte[] i = {45, 45};

    /* renamed from: a  reason: collision with root package name */
    private final ByteString f13986a;

    /* renamed from: b  reason: collision with root package name */
    private final b0 f13987b;

    /* renamed from: c  reason: collision with root package name */
    private final List<b> f13988c;

    /* renamed from: d  reason: collision with root package name */
    private long f13989d = -1;

    /* compiled from: MultipartBody */
    public static final class a {

        /* renamed from: a  reason: collision with root package name */
        private final ByteString f13990a;

        /* renamed from: b  reason: collision with root package name */
        private b0 f13991b;

        /* renamed from: c  reason: collision with root package name */
        private final List<b> f13992c;
        ...
        public c0 e() {
            if (!this.f13992c.isEmpty()) {
                return new c0(this.f13990a, this.f13991b, this.f13992c);
            }
        ...
        public a(String str) {
            this.f13991b = c0.f13984e;
            this.f13992c = new ArrayList();
            this.f13990a = ByteString.encodeUtf8(str);
        }
    }
    ...
    c0(ByteString byteString, b0 b0Var, List<b> list) {
        this.f13986a = byteString;
        this.f13987b = b0.c(b0Var + "; boundary=" + byteString.utf8());
        this.f13988c = e.s(list);
    }
    ...
    private long b(@javax.annotation.Nullable okio.BufferedSink r13, boolean r14) throws java.io.IOException {
        ...
        L_0x0009:
            r0 = 0
        L_0x000a:
            java.util.List<e.c0$b> r1 = r12.f13988c
            int r1 = r1.size()
            r2 = 0
            r3 = 0
            r5 = 0
        L_0x0014:
            ...
            java.util.List<e.c0$b> r6 = r12.f13988c
            ...
            byte[] r8 = i
            r13.write((byte[]) r8)
            okio.ByteString r8 = r12.f13986a
        ...
        L_0x00a6:
            byte[] r1 = i
            r13.write((byte[]) r1)
            okio.ByteString r1 = r12.f13986a
