...
public final class z {
    ...
    private final List<String> f14226f;
    @Nullable
    ...
    public static final class a {
        ...
        private void m() {
            List<String> list = this.f14232f;
            if (!list.remove(list.size() - 1).isEmpty() || this.f14232f.isEmpty()) {
                this.f14232f.add("");
                return;
            }
            List<String> list2 = this.f14232f;
        ...
        private void r(java.lang.String r11, int r12, int r13) {
            ...
            L_0x0003:
                ...
                goto L_0x001e
            L_0x0013:
                java.util.List<java.lang.String> r0 = r10.f14232f
                int r1 = r0.size()
                int r1 = r1 - r3
                r0.set(r1, r2)
                goto L_0x0029
        ...
        public a j(@Nullable z zVar, String str) {
            ...
            char c2 = '?';
            char c3 = '#';
            if (u >= 2 || zVar2 == null || !zVar2.f14221a.equals(this.f14227a)) {
                int i2 = F + u;
                boolean z = false;
                boolean z2 = false;
                while (true) {
                    ...
                    if (charAt == 65535 || charAt == c3 || charAt == '/' || charAt == '\\' || charAt == c2) {
                        ...
                        if (charAt == '@') {
                            if (!z) {
                                ...
                                if (z2) {
                                    a2 = this.f14228b + str3 + a2;
                                }
                                this.f14228b = a2;
                                if (i5 != i) {
                                    this.f14229c = z.a(str, i5 + 1, i, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, (Charset) null);
                                    z = true;
                                }
                                z2 = true;
                            } else {
                                i = n;
                                this.f14229c += "%40" + z.a(str, i2, i, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, (Charset) null);
                            }
                            i2 = i + 1;
                        }
                        c2 = '?';
                ...
                this.f14228b = zVar.k();
                this.f14229c = zVar.g();
                this.f14230d = zVar2.f14224d;
                this.f14231e = zVar2.f14225e;
                this.f14232f.clear();
                this.f14232f.addAll(zVar.i());
        ...
        public a l(String str) {
            if (str != null) {
                this.f14229c = z.b(str, " \"':;<=>@[]^`{}|/\\?#", false, false, false, true);
                return this;
            }
        ...
        /* access modifiers changed from: package-private */
        public a q() {
            int size = this.f14232f.size();
            for (int i = 0; i < size; i++) {
                this.f14232f.set(i, z.b(this.f14232f.get(i), "[]", true, true, false, true));
            }
        ...
        public String toString() {
            ...
            if (!this.f14228b.isEmpty() || !this.f14229c.isEmpty()) {
            ...
            if (!(this.f14231e == -1 && this.f14227a == null)) {
                int e2 = e();
                String str3 = this.f14227a;
        ...
        public a v(String str) {
            if (str != null) {
                this.f14228b = z.b(str, " \"':;<=>@[]^`{}|/\\?#", false, false, false, true);
                return this;
            }
    ...
    z(a aVar) {
        this.f14221a = aVar.f14227a;
        this.f14222b = v(aVar.f14228b, false);
        this.f14223c = v(aVar.f14229c, false);
        this.f14224d = aVar.f14230d;
        this.f14225e = aVar.e();
        this.f14226f = w(aVar.f14232f, false);
    ...
    public String g() {
        ...
        return this.i.substring(this.i.indexOf(58, this.f14221a.length() + 3) + 1, indexOf);
    }

    public String h() {
        int indexOf = this.i.indexOf(47, this.f14221a.length() + 3);
        String str = this.i;
    ...
    public String k() {
        ...
        int length = this.f14221a.length() + 3;
        String str = this.i;
    ...
    public boolean n() {
        return this.f14221a.equals("https");
    }

    public a p() {
        a aVar = new a();
        aVar.f14227a = this.f14221a;
        aVar.f14228b = k();
        aVar.f14229c = g();
        aVar.f14230d = this.f14224d;
        aVar.f14231e = this.f14225e != e(this.f14221a) ? this.f14225e : -1;
        aVar.f14232f.clear();
        aVar.f14232f.addAll(i());
        aVar.f(j());
        aVar.h = f();
        return aVar;
    }
