...
public final class m {
    ...
    static final Comparator<String> f14093b = b.f13977b;

    /* renamed from: c  reason: collision with root package name */
    private static final Map<String, m> f14094c = new LinkedHashMap();

    /* renamed from: d  reason: collision with root package name */
    public static final m f14095d = c("SSL_RSA_WITH_3DES_EDE_CBC_SHA", 10);

    /* renamed from: e  reason: collision with root package name */
    public static final m f14096e = c("TLS_RSA_WITH_AES_128_CBC_SHA", 47);

    /* renamed from: f  reason: collision with root package name */
    public static final m f14097f = c("TLS_RSA_WITH_AES_256_CBC_SHA", 53);
    ...
    public static synchronized m a(String str) {
        ...
        synchronized (m.class) {
            mVar = f14094c.get(str);
            if (mVar == null) {
                mVar = f14094c.get(e(str));
                if (mVar == null) {
                    mVar = new m(str);
                }
                f14094c.put(str, mVar);
            }
        }
        return mVar;
    }
