...
public class i {
    ...
    private static final char[] f14608a = {',', ';'};

    /* renamed from: b  reason: collision with root package name */
    private static final HashMap<String, String> f14609b = new HashMap<>();
    ...
    static /* synthetic */ class a {
        ...
        static {
            /*
                org.jsoup.d.i$b[] r0 = org.jsoup.d.i.b.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                f14610a = r0
                org.jsoup.d.i$b r1 = org.jsoup.d.i.b.ascii     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = f14610a     // Catch:{ NoSuchFieldError -> 0x001d }
                org.jsoup.d.i$b r1 = org.jsoup.d.i.b.utf     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.jsoup.d.i.a.<clinit>():void");
        }
    }
    ...
    public enum c {
        ...
        public int q(String str) {
            int binarySearch = Arrays.binarySearch(this.f14616b, str);
            if (binarySearch >= 0) {
                return this.f14617c[binarySearch];
            }
            return -1;
        }
        ...
        public String r(int i2) {
            int binarySearch = Arrays.binarySearch(this.f14618d, i2);
            if (binarySearch < 0) {
                return "";
            }
            String[] strArr = this.f14619e;
            if (binarySearch < strArr.length - 1) {
                int i3 = binarySearch + 1;
                if (this.f14618d[i3] == i2) {
                    return strArr[i3];
                }
            }
            return this.f14619e[binarySearch];
        }
    }
    ...
    static void e(Appendable appendable, String str, f.a aVar, boolean z, boolean z2, boolean z3) throws IOException {
        c f2 = aVar.f();
        ...
        while (i < length) {
            ...
            if (z2) {
                if (org.jsoup.b.b.g(codePointAt)) {
                    if ((!z3 || z4) && !z5) {
                        appendable.append(' ');
                        z5 = true;
                    }
    ...
    public static void h(c cVar, String str, int i) {
        int i2;
        String[] unused = cVar.f14616b = new String[i];
        int[] unused2 = cVar.f14617c = new int[i];
        int[] unused3 = cVar.f14618d = new int[i];
        String[] unused4 = cVar.f14619e = new String[i];
        org.jsoup.e.a aVar = new org.jsoup.e.a(str);
        boolean z = false;
        int i3 = 0;
        while (!aVar.r()) {
            String k = aVar.k('=');
            aVar.a();
            int parseInt = Integer.parseInt(aVar.m(f14608a), 36);
            char q = aVar.q();
            aVar.a();
            if (q == ',') {
            ...
            aVar.a();
            cVar.f14616b[i3] = k;
            cVar.f14617c[i3] = parseInt;
            cVar.f14618d[parseInt2] = parseInt;
            cVar.f14619e[parseInt2] = k;
            if (i2 != -1) {
                f14609b.put(k, new String(new int[]{parseInt, i2}, 0, 2));
            }
            i3++;
        }
        if (i3 == i) {
        ...
        org.jsoup.b.c.e(z, "Unexpected count of entities loaded");
    }
}
