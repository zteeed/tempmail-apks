...
public class b extends l {
    ...
    private boolean J(String[] strArr, String[] strArr2, String[] strArr3) {
        ...
        while (size >= i) {
            String C2 = this.f14690d.get(size).C();
    ...
    private void k(String... strArr) {
        int size = this.f14690d.size() - 1;
        while (size >= 0) {
            h hVar = this.f14690d.get(size);
            if (!org.jsoup.b.b.b(hVar.C(), strArr) && !hVar.C().equals("html")) {
                this.f14690d.remove(size);
                size--;
            } else {
                return;
            }
    ...
    public boolean H(String str) {
        for (int size = this.f14690d.size() - 1; size >= 0; size--) {
            String C2 = this.f14690d.get(size).C();
            if (C2.equals(str)) {
                return true;
            }
    ...
    public h P(i.h hVar) {
        h k2 = h.k(hVar.A(), this.h);
        h hVar2 = new h(k2, this.f14691e, hVar.j);
        T(hVar2);
        if (hVar.z()) {
            if (!k2.f()) {
                k2.j();
            } else if (!k2.d()) {
                this.f14688b.q("Tag cannot be self closing; not a void tag");
            }
        }
        return hVar2;
    }
    ...
    public j Q(i.h hVar, boolean z2) {
        j jVar = new j(h.k(hVar.A(), this.h), this.f14691e, hVar.j);
        x0(jVar);
        T(jVar);
        if (z2) {
            this.f14690d.add(jVar);
        }
        return jVar;
    }
    ...
    public void U(h hVar, h hVar2) {
        int lastIndexOf = this.f14690d.lastIndexOf(hVar);
        c.d(lastIndexOf != -1);
        this.f14690d.add(lastIndexOf + 1, hVar2);
    }

    /* access modifiers changed from: package-private */
    public h V(String str) {
        h hVar = new h(h.k(str, this.h), this.f14691e);
        M(hVar);
        return hVar;
    }
    ...
    /* access modifiers changed from: package-private */
    public h i0() {
        return this.f14690d.remove(this.f14690d.size() - 1);
    }
    ...
    public void j0(String str) {
        int size = this.f14690d.size() - 1;
        while (size >= 0 && !this.f14690d.get(size).C().equals(str)) {
            this.f14690d.remove(size);
            size--;
        }
    }
    ...
    public void k0(String str) {
        ...
        while (size >= 0) {
            this.f14690d.remove(size);
            if (!this.f14690d.get(size).C().equals(str)) {
                size--;
            } else {
                return;
            }
    ...
    public void l0(String... strArr) {
        ...
        while (size >= 0) {
            this.f14690d.remove(size);
            if (!org.jsoup.b.b.c(this.f14690d.get(size).C(), strArr)) {
                size--;
            } else {
                return;
            }
    ...
    public void p(c cVar) {
        if (this.g.c()) {
            this.g.add(new d(this.f14687a.F(), "Unexpected token [%s] when in state [%s]", this.f14692f.o(), cVar));
        }
    }
    ...
    public String toString() {
        return "TreeBuilder{currentToken=" + this.f14692f + ", state=" + this.k + ", currentElement=" + a() + '}';
    }
