...
enum c {
    ...
    InHead {
        ...
        public boolean r(i iVar, b bVar) {
            ...
            int i = p.f14638a[iVar.f14658a.ordinal()];
            if (i == 1) {
                bVar.O(iVar.b());
            } else if (i == 2) {
                bVar.p(this);
    ...
    InBody {
        ...
        public boolean r(i iVar, b bVar) {
            ...
            i iVar2 = iVar;
            b bVar2 = bVar;
            int i = p.f14638a[iVar2.f14658a.ordinal()];
            boolean z = true;
            if (i == 1) {
                bVar2.O(iVar.b());
            } else if (i == 2) {
                ...
                if (D.equals("a")) {
                    ...
                    bVar2.P(e2);
                    bVar2.q(false);
                } else if (org.jsoup.b.b.c(D, y.f14640b)) {
                    if (bVar2.C("p")) {
                        bVar2.e("p");
                    }
                    bVar2.L(e2);
                    ...
                    while (true) {
                        ...
                        if (!hVar2.C().equals("li")) {
                            if (bVar2.b0(hVar2) && !org.jsoup.b.b.c(hVar2.C(), y.f14643e)) {
                                break;
                            }
                            size--;
                        } else {
                ...
                } else if (org.jsoup.b.b.c(D, y.f14639a)) {
                    ...
                    if (D.equals("body")) {
                        ...
                        bVar2.L(e2);
                        bVar2.B0(c.InFrameset);
                    } else if (org.jsoup.b.b.c(D, y.f14641c)) {
                        if (bVar2.C("p")) {
                            bVar2.e("p");
                        }
                        if (org.jsoup.b.b.c(bVar.a().C(), y.f14641c)) {
                            bVar2.p(this);
                            bVar.i0();
                        }
                        bVar2.L(e2);
                    } else if (org.jsoup.b.b.c(D, y.f14642d)) {
                        if (bVar2.C("p")) {
                            bVar2.e("p");
                        }
                        bVar2.L(e2);
                        ...
                        bVar2.Q(e2, true);
                        return true;
                    } else if (org.jsoup.b.b.c(D, y.f14644f)) {
                        bVar2.q(false);
                        ...
                        while (true) {
                            ...
                            if (!org.jsoup.b.b.c(hVar6.C(), y.f14644f)) {
                                if (bVar2.b0(hVar6) && !org.jsoup.b.b.c(hVar6.C(), y.f14643e)) {
                                    break;
                                }
                                size2--;
                            } else {
                        ...
                        if (bVar.w().t0() != f.b.quirks && bVar2.C("p")) {
                            bVar2.e("p");
                        }
                        bVar2.L(e2);
                        bVar2.q(false);
                        ...
                        bVar3.Y(AnalyticsConnectorReceiver.EVENT_NAME_KEY, "isindex");
                        bVar2.g("input", bVar3);
                        bVar2.e("label");
                        bVar2.f("hr");
                        bVar2.e("form");
                ...
                if (org.jsoup.b.b.c(D2, y.p)) {
                        ...
                        if (!bVar2.g0(u)) {
                            ...
                            for (int i5 = 0; i5 < 3; i5++) {
                                ...
                                if (!bVar2.Z(hVar8)) {
                                    ...
                                    org.jsoup.d.h hVar10 = new org.jsoup.d.h(h.k(hVar8.C(), f.f14649d), bVar.v());
                    ...
                    if (D2.equals("li")) {
                        ...
                        bVar2.k0(D2);
                    } else if (org.jsoup.b.b.c(D2, y.f14644f)) {
                        if (!bVar2.E(D2)) {
                            bVar2.p(this);
                            return false;
                        }
                        ...
                        bVar2.k0(D2);
                    } else if (org.jsoup.b.b.c(D2, y.f14641c)) {
                        if (!bVar2.G(y.f14641c)) {
                            bVar2.p(this);
                            return false;
                        }
                        bVar2.t(D2);
                        ...
                        if (org.jsoup.b.b.c(D2, y.h)) {
                            if (!bVar2.E(AnalyticsConnectorReceiver.EVENT_NAME_KEY)) {
                                if (!bVar2.E(D2)) {
                                    bVar2.p(this);
                                    return false;
                                }
    ...
    InTableText {
        /* access modifiers changed from: package-private */
        public boolean r(i iVar, b bVar) {
            if (p.f14638a[iVar.f14658a.ordinal()] != 5) {
                if (bVar.A().size() > 0) {
    ...
    InColumnGroup {
        ...
        public boolean r(org.jsoup.e.i r9, org.jsoup.e.b r10) {
            /*
                ...
                return r1
            L_0x000f:
                int[] r0 = org.jsoup.e.c.p.f14638a
                org.jsoup.e.i$j r2 = r9.f14658a
                int r2 = r2.ordinal()
                r0 = r0[r2]
            ...
            L_0x0043:
                ...
                java.lang.String r0 = r0.f14667c
            ...
            L_0x00ba:
                return r1
            */
            throw new UnsupportedOperationException("Method not decompiled: org.jsoup.e.c.C0167c.r(org.jsoup.e.i, org.jsoup.e.b):boolean");
        }
    },
    InTableBody {
        private boolean t(i iVar, b bVar) {
    ...
    InSelect {
        ...
        /* access modifiers changed from: package-private */
        public boolean r(i iVar, b bVar) {
            switch (p.f14638a[iVar.f14658a.ordinal()]) {
                case 1:
                    bVar.O(iVar.b());
                    break;
                case 2:
    ...
    static /* synthetic */ class p {
        ...
        static final /* synthetic */ int[] f14638a = null;
    ...
    static final class y {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final String[] f14639a = null;

        /* renamed from: b  reason: collision with root package name */
        static final String[] f14640b = null;

        /* renamed from: c  reason: collision with root package name */
        static final String[] f14641c = null;

        /* renamed from: d  reason: collision with root package name */
        static final String[] f14642d = null;

        /* renamed from: e  reason: collision with root package name */
        static final String[] f14643e = null;

        /* renamed from: f  reason: collision with root package name */
        static final String[] f14644f = null;
        ...
        static {
            f14639a = new String[]{"base", "basefont", "bgsound", "command", "link", "meta", "noframes", "script", "style", "title"};
            f14640b = new String[]{"address", "article", "aside", "blockquote", "center", "details", "dir", "div", "dl", "fieldset", "figcaption", "figure", "footer", "header", "hgroup", "menu", "nav", "ol", "p", "section", "summary", "ul"};
            f14641c = new String[]{"h1", "h2", "h3", "h4", "h5", "h6"};
            f14642d = new String[]{"listing", "pre"};
            f14643e = new String[]{"address", "div", "p"};
            f14644f = new String[]{"dd", "dt"};
            g = new String[]{"b", "big", "code", "em", "font", com.tempmail.utils.i.f12574a, "s", "small", "strike", "strong", "tt", "u"};
            h = new String[]{"applet", "marquee", "object"};
            i = new String[]{"area", "br", "embed", "img", "keygen", "wbr"};
            j = new String[]{"param", "source", "track"};
            k = new String[]{"action", AnalyticsConnectorReceiver.EVENT_NAME_KEY, "prompt"};
            ...
            p = new String[]{"a", "b", "big", "code", "em", "font", com.tempmail.utils.i.f12574a, "nobr", "s", "small", "strike", "strong", "tt", "u"};
