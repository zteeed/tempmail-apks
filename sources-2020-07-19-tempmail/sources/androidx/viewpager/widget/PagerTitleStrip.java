...
public class PagerTitleStrip extends ViewGroup {
    ...
    private class a extends DataSetObserver implements ViewPager.j, ViewPager.i {
        ...
        public void d(int i) {
            if (this.f1925a == 0) {
                ...
                pagerTitleStrip.b(pagerTitleStrip.f1920b.getCurrentItem(), PagerTitleStrip.this.f1920b.getAdapter());
                float f2 = PagerTitleStrip.this.g;
                if (f2 < 0.0f) {
                    f2 = 0.0f;
                }
                PagerTitleStrip pagerTitleStrip2 = PagerTitleStrip.this;
                pagerTitleStrip2.c(pagerTitleStrip2.f1920b.getCurrentItem(), f2, true);
            }
        }
    ...
    private static class b extends SingleLineTransformationMethod {
        ...
        public CharSequence getTransformation(CharSequence charSequence, View view) {
            ...
            if (transformation != null) {
                return transformation.toString().toUpperCase(this.f1927b);
            }
            return null;
        }
    }
    ...
    public void b(int i2, a aVar) {
        ...
        this.f1921c.setText((i2 < 1 || aVar == null) ? null : aVar.g(i2 - 1));
        this.f1922d.setText((aVar == null || i2 >= e2) ? null : aVar.g(i2));
        int i3 = i2 + 1;
        if (i3 < e2 && aVar != null) {
            charSequence = aVar.g(i3);
        }
        this.f1923e.setText(charSequence);
        ...
        this.f1921c.measure(makeMeasureSpec, makeMeasureSpec2);
        this.f1922d.measure(makeMeasureSpec, makeMeasureSpec2);
        this.f1923e.measure(makeMeasureSpec, makeMeasureSpec2);
        this.f1924f = i2;
        if (!this.k) {
            c(i2, this.g, false);
        }
    ...
    public void c(int i2, float f2, boolean z) {
        ...
        float f3 = f2;
        if (i7 != this.f1924f) {
            b(i7, this.f1920b.getAdapter());
        } else if (!z && f3 == this.g) {
            return;
        }
        this.k = true;
        int measuredWidth = this.f1921c.getMeasuredWidth();
        int measuredWidth2 = this.f1922d.getMeasuredWidth();
        int measuredWidth3 = this.f1923e.getMeasuredWidth();
        ...
        int baseline = this.f1921c.getBaseline();
        int baseline2 = this.f1922d.getBaseline();
        int baseline3 = this.f1923e.getBaseline();
        int max = Math.max(Math.max(baseline, baseline2), baseline3);
        int i13 = max - baseline;
        int i14 = max - baseline2;
        int i15 = max - baseline3;
        int i16 = measuredWidth3;
        int max2 = Math.max(Math.max(this.f1921c.getMeasuredHeight() + i13, this.f1922d.getMeasuredHeight() + i14), this.f1923e.getMeasuredHeight() + i15);
        int i17 = this.i & 112;
        if (i17 == 16) {
            ...
            TextView textView2 = this.f1921c;
        ...
        TextView textView32 = this.f1923e;
    ...
    public void onDetachedFromWindow() {
        ...
        if (viewPager != null) {
            ...
            this.f1920b.P((ViewPager.j) null);
            this.f1920b.I(this.l);
            this.f1920b = null;
        }
    }
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (View.MeasureSpec.getMode(i2) == 1073741824) {
            ...
            this.f1921c.measure(childMeasureSpec2, childMeasureSpec);
            this.f1922d.measure(childMeasureSpec2, childMeasureSpec);
            this.f1923e.measure(childMeasureSpec2, childMeasureSpec);
            if (View.MeasureSpec.getMode(i3) == 1073741824) {
                i4 = View.MeasureSpec.getSize(i3);
            } else {
                i4 = Math.max(getMinHeight(), this.f1922d.getMeasuredHeight() + paddingTop);
            }
            setMeasuredDimension(size, View.resolveSizeAndState(i4, i3, this.f1922d.getMeasuredState() << 16));
            return;
        }
    ...
    public void setNonPrimaryAlpha(float f2) {
        ...
        this.f1921c.setTextColor(i3);
        this.f1923e.setTextColor(i3);
    }

    public void setTextColor(int i2) {
        this.o = i2;
        this.f1922d.setTextColor(i2);
    ...
    public void setTextSize(int i2, float f2) {
        this.f1921c.setTextSize(i2, f2);
        this.f1922d.setTextSize(i2, f2);
        this.f1923e.setTextSize(i2, f2);
    }
    ...
    public PagerTitleStrip(Context context, AttributeSet attributeSet) {
        ...
        this.f1922d = textView2;
        addView(textView2);
        TextView textView3 = new TextView(context);
        this.f1923e = textView3;
        addView(textView3);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, p);
        boolean z = false;
        int resourceId = obtainStyledAttributes.getResourceId(0, 0);
        if (resourceId != 0) {
            i.o(this.f1921c, resourceId);
            i.o(this.f1922d, resourceId);
            i.o(this.f1923e, resourceId);
        }
        ...
        if (obtainStyledAttributes.hasValue(2)) {
            ...
            this.f1921c.setTextColor(color);
            this.f1922d.setTextColor(color);
            this.f1923e.setTextColor(color);
        }
        this.i = obtainStyledAttributes.getInteger(3, 80);
        obtainStyledAttributes.recycle();
        this.o = this.f1922d.getTextColors().getDefaultColor();
        setNonPrimaryAlpha(0.6f);
        this.f1921c.setEllipsize(TextUtils.TruncateAt.END);
        this.f1922d.setEllipsize(TextUtils.TruncateAt.END);
        this.f1923e.setEllipsize(TextUtils.TruncateAt.END);
        if (resourceId != 0) {
        ...
        if (z) {
            setSingleLineAllCaps(this.f1921c);
            setSingleLineAllCaps(this.f1922d);
            setSingleLineAllCaps(this.f1923e);
        } else {
            this.f1921c.setSingleLine();
            this.f1922d.setSingleLine();
            this.f1923e.setSingleLine();
        }
