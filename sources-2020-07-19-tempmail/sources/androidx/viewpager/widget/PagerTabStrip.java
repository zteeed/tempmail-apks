...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ViewPager viewPager = PagerTabStrip.this.f1920b;
    ...
    public void c(int i, float f2, boolean z2) {
        ...
        int left = this.f1922d.getLeft() - this.w;
        int right = this.f1922d.getRight() + this.w;
        int i2 = height - this.s;
        rect.set(left, i2, right, height);
        super.c(i, f2, z2);
        this.z = (int) (Math.abs(f2 - 0.5f) * 2.0f * 255.0f);
        rect.union(this.f1922d.getLeft() - this.w, i2, this.f1922d.getRight() + this.w, height);
        invalidate(rect);
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        } else if (x2 < ((float) (this.f1922d.getLeft() - this.w))) {
            ViewPager viewPager = this.f1920b;
            viewPager.setCurrentItem(viewPager.getCurrentItem() - 1);
        } else if (x2 > ((float) (this.f1922d.getRight() + this.w))) {
            ViewPager viewPager2 = this.f1920b;
