...
public abstract class a {
    ...
    private final DataSetObservable f1952a = new DataSetObservable();
    ...
    public void l(DataSetObserver dataSetObserver) {
        this.f1952a.registerObserver(dataSetObserver);
    }
    ...
    public void t(DataSetObserver dataSetObserver) {
        this.f1952a.unregisterObserver(dataSetObserver);
    }
}
