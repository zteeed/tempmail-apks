...
public class SlidingPaneLayout extends ViewGroup {
    ...
    private Drawable f1862d;

    /* renamed from: e  reason: collision with root package name */
    private Drawable f1863e;
    ...
    static class SavedState extends AbsSavedState {
        ...
        public void writeToParcel(Parcel parcel, int i) {
            ...
            parcel.writeInt(this.f1865d ? 1 : 0);
        }

        SavedState(Parcel parcel, ClassLoader classLoader) {
            super(parcel, classLoader);
            this.f1865d = parcel.readInt() != 0;
        }
    }
    ...
    class a extends a.h.k.a {
        ...
        /* renamed from: d  reason: collision with root package name */
        private final Rect f1866d = new Rect();

        a() {
        }

        private void n(a.h.k.c0.d dVar, a.h.k.c0.d dVar2) {
            Rect rect = this.f1866d;
            dVar2.k(rect);
            dVar.U(rect);
            dVar2.l(rect);
            dVar.V(rect);
    ...
    private class b implements Runnable {
        ...
        public void run() {
            if (this.f1868b.getParent() == SlidingPaneLayout.this) {
                this.f1868b.setLayerType(0, (Paint) null);
                SlidingPaneLayout.this.g(this.f1868b);
            }
    ...
    private class c extends c.C0019c {
        ...
        public boolean m(View view, int i) {
            ...
            return ((d) view.getLayoutParams()).f1873b;
        }
    }
    ...
    private void c(View view, float f2, int i2) {
        ...
        if (f2 > 0.0f && i2 != 0) {
            ...
            if (dVar.f1875d == null) {
                dVar.f1875d = new Paint();
            }
            dVar.f1875d.setColorFilter(new PorterDuffColorFilter(i3, PorterDuff.Mode.SRC_OVER));
            if (view.getLayerType() != 2) {
                view.setLayerType(2, dVar.f1875d);
            }
            g(view);
        } else if (view.getLayerType() != 0) {
            Paint paint = dVar.f1875d;
            if (paint != null) {
    ...
    public void draw(Canvas canvas) {
        ...
        super.draw(canvas);
        if (i()) {
            drawable = this.f1863e;
        } else {
            drawable = this.f1862d;
        }
    ...
    public boolean drawChild(Canvas canvas, View view, long j2) {
        ...
        if (this.g && !dVar.f1873b && this.h != null) {
    ...
    public void g(View view) {
        ...
        if (i2 >= 17) {
            t.k0(view, ((d) view.getLayoutParams()).f1875d);
            return;
        }
        if (i2 >= 16) {
            if (!this.x) {
        ...
        t.U(this, view.getLeft(), view.getTop(), view.getRight(), view.getBottom());
    }
    ...
    public boolean h(View view) {
        ...
        d dVar = (d) view.getLayoutParams();
        if (!this.g || !dVar.f1874c || this.i <= 0.0f) {
            return false;
        }
        return true;
    }
    ...
    public void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        for (int i13 = 0; i13 < childCount; i13++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (dVar.f1873b) {
                    ...
                    int min = (Math.min(paddingRight, i14 - this.f1864f) - i12) - (dVar.leftMargin + dVar.rightMargin);
                    this.k = min;
                    int i15 = i10 ? dVar.rightMargin : dVar.leftMargin;
                    dVar.f1874c = ((i12 + i15) + min) + (measuredWidth / 2) > i14;
        ...
        if (this.s) {
            if (this.g) {
                ...
                if (((d) this.h.getLayoutParams()).f1874c) {
                    c(this.h, this.i, this.f1860b);
                }
            } else {
                for (int i17 = 0; i17 < childCount; i17++) {
                    c(getChildAt(i17), 0.0f, this.f1860b);
                }
            }
            r(this.h);
        }
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (z2 || f3 > 0.0f) {
            int i21 = paddingLeft - this.f1864f;
            int i22 = 0;
            while (i22 < childCount) {
                ...
                if (childAt2.getVisibility() != i6) {
                    ...
                    if (childAt2.getVisibility() != i6) {
                        boolean z4 = dVar2.width == 0 && dVar2.f1872a > 0.0f;
                        if (z4) {
                            i8 = 0;
                        } else {
                        ...
                        if (!z2 || childAt2 == this.h) {
                            if (dVar2.f1872a > 0.0f) {
                                ...
                                if (z2) {
                                    ...
                                    i7 = i21;
                                    childAt2.measure(View.MeasureSpec.makeMeasureSpec(i8 + ((int) ((dVar2.f1872a * ((float) Math.max(0, i16))) / f3)), 1073741824), i9);
                                    i22++;
                                    i21 = i7;
                                    i6 = 8;
                                }
                            }
                        } else if (dVar2.width < 0 && (i8 > i21 || dVar2.f1872a > 0.0f)) {
                            if (z4) {
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (savedState.f1865d) {
            m();
        } else {
            a();
        }
        this.r = savedState.f1865d;
    }

    /* access modifiers changed from: protected */
    public Parcelable onSaveInstanceState() {
        SavedState savedState = new SavedState(super.onSaveInstanceState());
        savedState.f1865d = k() ? j() : this.r;
        return savedState;
    }
    ...
    public void setShadowDrawableLeft(Drawable drawable) {
        this.f1862d = drawable;
    }

    public void setShadowDrawableRight(Drawable drawable) {
        this.f1863e = drawable;
    }
    ...
    public static class d extends ViewGroup.MarginLayoutParams {
        ...
        /* renamed from: e  reason: collision with root package name */
        private static final int[] f1871e = {16843137};

        /* renamed from: a  reason: collision with root package name */
        public float f1872a = 0.0f;
        ...
        public d(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, f1871e);
            this.f1872a = obtainStyledAttributes.getFloat(0, 0.0f);
    ...
    public SlidingPaneLayout(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.f1860b = -858993460;
        this.s = true;
        this.t = new Rect();
        this.u = new ArrayList<>();
        float f2 = context.getResources().getDisplayMetrics().density;
        this.f1864f = (int) ((32.0f * f2) + 0.5f);
