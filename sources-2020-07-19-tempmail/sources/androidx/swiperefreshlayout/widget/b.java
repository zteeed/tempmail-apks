...
public class b extends Drawable implements Animatable {
    ...
    private static final Interpolator i = new a.k.a.a.b();
    ...
    private Resources f1898d;

    /* renamed from: e  reason: collision with root package name */
    private Animator f1899e;
    ...
    class a implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            b.this.n(floatValue, this.f1901a);
            b.this.b(floatValue, this.f1901a, false);
    ...
    /* compiled from: CircularProgressDrawable */
    class C0052b implements Animator.AnimatorListener {
        ...
        public void onAnimationRepeat(Animator animator) {
            b.this.b(1.0f, this.f1903a, true);
            this.f1903a.A();
            this.f1903a.l();
            b bVar = b.this;
            if (bVar.g) {
    ...
    private static class c {
        ...
        /* renamed from: a  reason: collision with root package name */
        final RectF f1905a = new RectF();

        /* renamed from: b  reason: collision with root package name */
        final Paint f1906b = new Paint();

        /* renamed from: c  reason: collision with root package name */
        final Paint f1907c = new Paint();

        /* renamed from: d  reason: collision with root package name */
        final Paint f1908d = new Paint();
        ...
        c() {
            this.f1906b.setStrokeCap(Paint.Cap.SQUARE);
            this.f1906b.setAntiAlias(true);
            this.f1906b.setStyle(Paint.Style.STROKE);
            this.f1907c.setStyle(Paint.Style.FILL);
            this.f1907c.setAntiAlias(true);
            this.f1908d.setColor(0);
        }
        ...
        public void a(Canvas canvas, Rect rect) {
            ...
            float f4 = this.f1909e;
            float f5 = this.g;
            float f6 = (f4 + f5) * 360.0f;
            float f7 = ((this.f1910f + f5) * 360.0f) - f6;
            this.f1906b.setColor(this.u);
            this.f1906b.setAlpha(this.t);
            float f8 = this.h / 2.0f;
            rectF.inset(f8, f8);
            canvas.drawCircle(rectF.centerX(), rectF.centerY(), rectF.width() / 2.0f, this.f1908d);
            float f9 = -f8;
            rectF.inset(f9, f9);
            canvas.drawArc(rectF, f6, f7, false, this.f1906b);
        ...
        public void b(Canvas canvas, float f2, float f3, RectF rectF) {
            if (this.n) {
                ...
                this.o.close();
                this.f1907c.setColor(this.u);
                this.f1907c.setAlpha(this.t);
                canvas.save();
                canvas.rotate(f2 + f3, rectF.centerX(), rectF.centerY());
                canvas.drawPath(this.o, this.f1907c);
                canvas.restore();
            }
        }
        ...
        public void s(ColorFilter colorFilter) {
            this.f1906b.setColorFilter(colorFilter);
        }
        ...
        public void z(float f2) {
            this.h = f2;
            this.f1906b.setStrokeWidth(f2);
        }
    }

    public b(Context context) {
        h.b(context);
        this.f1898d = context.getResources();
        c cVar = new c();
        this.f1896b = cVar;
        cVar.u(j);
        k(2.5f);
    ...
    private void i(float f2, float f3, float f4, float f5) {
        c cVar = this.f1896b;
        float f6 = this.f1898d.getDisplayMetrics().density;
        cVar.z(f3 * f6);
        cVar.q(f2 * f6);
        cVar.t(0);
        cVar.o(f4 * f6, f5 * f6);
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.save();
        canvas.rotate(this.f1897c, bounds.exactCenterX(), bounds.exactCenterY());
        this.f1896b.a(canvas, bounds);
        canvas.restore();
    }
    ...
    public void start() {
        this.f1899e.cancel();
        this.f1896b.A();
        if (this.f1896b.d() != this.f1896b.g()) {
            this.g = true;
            this.f1899e.setDuration(666);
            this.f1899e.start();
            return;
        }
        this.f1896b.t(0);
        this.f1896b.m();
        this.f1899e.setDuration(1332);
        this.f1899e.start();
    }
