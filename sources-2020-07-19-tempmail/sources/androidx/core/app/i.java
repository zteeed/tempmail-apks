...
class i {
    ...
    private static Field f1298b;

    /* renamed from: c  reason: collision with root package name */
    private static boolean f1299c;
        ...
        synchronized (f1297a) {
            ...
            try {
                if (f1298b == null) {
                    ...
                    f1298b = declaredField;
                }
                Bundle bundle = (Bundle) f1298b.get(notification);
                if (bundle == null) {
                    bundle = new Bundle();
                    f1298b.set(notification, bundle);
                }
                return bundle;
