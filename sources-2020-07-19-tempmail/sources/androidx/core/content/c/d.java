...
final class d {
    ...
    static Shader b(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws IOException, XmlPullParserException {
        ...
        if (name.equals("gradient")) {
            ...
            if (g == 1) {
                ...
                if (f9 > 0.0f) {
                    int[] iArr = a2.f1323a;
                    return new RadialGradient(f10, f7, f9, iArr, a2.f1324b, d(g2));
                }
                throw new XmlPullParserException("<gradient> tag requires 'gradientRadius' attribute with radial type");
            } else if (g != 2) {
                return new LinearGradient(f2, f3, f4, f5, a2.f1323a, a2.f1324b, d(g2));
            } else {
                return new SweepGradient(f8, f7, a2.f1323a, a2.f1324b);
            }
        } else {
    ...
    static final class a {
        ...
        a(List<Integer> list, List<Float> list2) {
            int size = list.size();
            this.f1323a = new int[size];
            this.f1324b = new float[size];
            for (int i = 0; i < size; i++) {
                this.f1323a[i] = list.get(i).intValue();
                this.f1324b[i] = list2.get(i).floatValue();
            }
        }

        a(int i, int i2) {
            this.f1323a = new int[]{i, i2};
            this.f1324b = new float[]{0.0f, 1.0f};
        }

        a(int i, int i2, int i3) {
            this.f1323a = new int[]{i, i2, i3};
            this.f1324b = new float[]{0.0f, 0.5f, 1.0f};
        }
    }
}
