...
public class NestedScrollView extends FrameLayout implements n, j {
    ...
    private final Rect f1356c;

    /* renamed from: d  reason: collision with root package name */
    private OverScroller f1357d;

    /* renamed from: e  reason: collision with root package name */
    private EdgeEffect f1358e;

    /* renamed from: f  reason: collision with root package name */
    private EdgeEffect f1359f;
    private int g;
    private boolean h;
    private boolean i;
    private View j;
    ...
    static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            return "HorizontalScrollView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " scrollPosition=" + this.f1360b + "}";
        }
    ...
    private boolean C(View view, int i2, int i3) {
        view.getDrawingRect(this.f1356c);
        offsetDescendantRectToMyCoords(view, this.f1356c);
        return this.f1356c.bottom + i2 >= getScrollY() && this.f1356c.top - i2 <= getScrollY() + i3;
    }
    ...
    private void p() {
        ...
        H();
        a(0);
        EdgeEffect edgeEffect = this.f1358e;
        if (edgeEffect != null) {
            edgeEffect.onRelease();
            this.f1359f.onRelease();
        }
    }
    ...
    private void q() {
        if (getOverScrollMode() == 2) {
            ...
            Context context = getContext();
            this.f1358e = new EdgeEffect(context);
            this.f1359f = new EdgeEffect(context);
        }
    }
    ...
    private void y() {
        this.f1357d = new OverScroller(getContext());
        setFocusable(true);
    ...
    public boolean F(int r13, int r14, int r15, int r16, int r17, int r18, int r19, int r20, boolean r21) {
        ...
        L_0x005f:
            ...
            android.widget.OverScroller r7 = r0.f1357d
            r8 = 0
            r9 = 0
            r10 = 0
    ...
    public boolean G(int i2) {
        ...
        int height = getHeight();
        if (z2) {
            this.f1356c.top = getScrollY() + height;
    ...
    public final void M(int i2, int i3) {
        if (getChildCount() != 0) {
            if (AnimationUtils.currentAnimationTimeMillis() - this.f1355b > 250) {
                View childAt = getChildAt(0);
                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) childAt.getLayoutParams();
                int height = childAt.getHeight() + layoutParams.topMargin + layoutParams.bottomMargin;
                int height2 = (getHeight() - getPaddingTop()) - getPaddingBottom();
                int scrollY = getScrollY();
                OverScroller overScroller = this.f1357d;
                int scrollX = getScrollX();
                overScroller.startScroll(scrollX, scrollY, 0, Math.max(0, Math.min(i3 + scrollY, Math.max(0, height - height2))) - scrollY);
                I(false);
            } else {
                if (!this.f1357d.isFinished()) {
                    b();
                }
                scrollBy(i2, i3);
            }
            this.f1355b = AnimationUtils.currentAnimationTimeMillis();
        }
    }
    ...
    public boolean c(int i2) {
        ...
        if (findNextFocus == null || !C(findNextFocus, maxScrollAmount, getHeight())) {
            ...
            findNextFocus.getDrawingRect(this.f1356c);
            offsetDescendantRectToMyCoords(findNextFocus, this.f1356c);
            o(f(this.f1356c));
    ...
    public void computeScroll() {
        if (!this.f1357d.isFinished()) {
            this.f1357d.computeScrollOffset();
            int currY = this.f1357d.getCurrY();
            int i2 = currY - this.v;
            this.v = currY;
            int[] iArr = this.t;
            boolean z2 = true;
            ...
            if (i3 != 0) {
                ...
                if (z2) {
                    q();
                    if (i3 < 0) {
                        if (this.f1358e.isFinished()) {
                            this.f1358e.onAbsorb((int) this.f1357d.getCurrVelocity());
                        }
                    } else if (this.f1359f.isFinished()) {
                        this.f1359f.onAbsorb((int) this.f1357d.getCurrVelocity());
                    }
                }
                b();
            }
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.f1358e != null) {
            ...
            if (!this.f1358e.isFinished()) {
                ...
                this.f1358e.setSize(width, height);
                if (this.f1358e.draw(canvas)) {
                    t.T(this);
                }
                canvas.restoreToCount(save);
            }
            if (!this.f1359f.isFinished()) {
                ...
                this.f1359f.setSize(width2, height2);
                if (this.f1359f.draw(canvas)) {
                    t.T(this);
                }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (i2 != 0) {
            ...
            this.r = -1;
            H();
            if (this.f1357d.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange())) {
                t.T(this);
            }
            a(0);
        } else {
    ...
    public void onLayout(boolean z2, int i2, int i3, int i4, int i5) {
        ...
        if (!this.i) {
            if (this.w != null) {
                scrollTo(getScrollX(), this.w.f1360b);
                this.w = null;
            }
            if (getChildCount() > 0) {
                View childAt = getChildAt(0);
    ...
    public void onSizeChanged(int i2, int i3, int i4, int i5) {
        ...
        if (findFocus != null && this != findFocus && C(findFocus, 0, i5)) {
            findFocus.getDrawingRect(this.f1356c);
            offsetDescendantRectToMyCoords(findFocus, this.f1356c);
            o(f(this.f1356c));
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked == 1) {
                ...
                } else if (this.f1357d.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange())) {
                    t.T(this);
                }
                this.r = -1;
                p();
                ...
                if (findPointerIndex == -1) {
                    ...
                    if (this.k) {
                        ...
                        if (z2) {
                            ...
                            int i8 = scrollY + i7;
                            if (i8 < 0) {
                                d.a(this.f1358e, ((float) i7) / ((float) getHeight()), motionEvent2.getX(findPointerIndex) / ((float) getWidth()));
                                if (!this.f1359f.isFinished()) {
                                    this.f1359f.onRelease();
                                }
                            } else if (i8 > i5) {
                                d.a(this.f1359f, ((float) i7) / ((float) getHeight()), 1.0f - (motionEvent2.getX(findPointerIndex) / ((float) getWidth())));
                                if (!this.f1358e.isFinished()) {
                                    this.f1358e.onRelease();
                                }
                            }
                            EdgeEffect edgeEffect = this.f1358e;
                            if (edgeEffect != null && (!edgeEffect.isFinished() || !this.f1359f.isFinished())) {
                                t.T(this);
                            }
                        }
                    }
                ...
                if (this.k && getChildCount() > 0 && this.f1357d.springBack(getScrollX(), getScrollY(), 0, 0, 0, getScrollRange())) {
                    t.T(this);
                }
                this.r = -1;
                p();
            ...
            boolean z3 = !this.f1357d.isFinished();
            this.k = z3;
    ...
    public void t(int i2) {
        if (getChildCount() > 0) {
            this.f1357d.fling(getScrollX(), getScrollY(), 0, i2, 0, 0, Integer.MIN_VALUE, Integer.MAX_VALUE, 0, 0);
            I(true);
        }
    }
    ...
    public boolean u(int i2) {
        ...
        if (z2 && (childCount = getChildCount()) > 0) {
            View childAt = getChildAt(childCount - 1);
            this.f1356c.bottom = childAt.getBottom() + ((FrameLayout.LayoutParams) childAt.getLayoutParams()).bottomMargin + getPaddingBottom();
            Rect rect2 = this.f1356c;
