...
public final class i {
    ...
    private static class a implements ActionMode.Callback {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final ActionMode.Callback f1384a;

        /* renamed from: b  reason: collision with root package name */
        private final TextView f1385b;

        /* renamed from: c  reason: collision with root package name */
        private Class f1386c;

        /* renamed from: d  reason: collision with root package name */
        private Method f1387d;
        ...
        private void f(Menu menu) {
            Method method;
            Context context = this.f1385b.getContext();
            ...
            if (!this.f1389f) {
                ...
                try {
                    ...
                    this.f1386c = cls;
                    this.f1387d = cls.getDeclaredMethod("removeItemAt", new Class[]{Integer.TYPE});
                    this.f1388e = true;
            ...
            try {
                if (!this.f1388e || !this.f1386c.isInstance(menu)) {
                ...
                for (int i = 0; i < c2.size(); i++) {
                    ...
                    menu.add(0, 0, i + 100, resolveInfo.loadLabel(packageManager)).setIntent(b(resolveInfo, this.f1385b)).setShowAsAction(1);
                }
        ...
        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            return this.f1384a.onActionItemClicked(actionMode, menuItem);
        }

        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            return this.f1384a.onCreateActionMode(actionMode, menu);
        }

        public void onDestroyActionMode(ActionMode actionMode) {
            this.f1384a.onDestroyActionMode(actionMode);
        }

        public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
            f(menu);
            return this.f1384a.onPrepareActionMode(actionMode, menu);
        }
    }
