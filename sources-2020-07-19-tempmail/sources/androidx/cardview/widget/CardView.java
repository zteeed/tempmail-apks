...
public class CardView extends FrameLayout {
    ...
    class a implements d {
        ...
        public void a(int i, int i2, int i3, int i4) {
            ...
            Rect rect = cardView.f1188f;
            CardView.super.setPadding(i + rect.left, i2 + rect.top, i3 + rect.right, i4 + rect.bottom);
        }

        public void b(int i, int i2) {
            CardView cardView = CardView.this;
            if (i > cardView.f1186d) {
                CardView.super.setMinimumWidth(i);
            }
            CardView cardView2 = CardView.this;
            if (i2 > cardView2.f1187e) {
    ...
    public int getContentPaddingBottom() {
        return this.f1188f.bottom;
    }

    public int getContentPaddingLeft() {
        return this.f1188f.left;
    }

    public int getContentPaddingRight() {
        return this.f1188f.right;
    }

    public int getContentPaddingTop() {
        return this.f1188f.top;
    }
    ...
    public CardView(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.f1184b = obtainStyledAttributes.getBoolean(e.CardView_cardUseCompatPadding, false);
        this.f1185c = obtainStyledAttributes.getBoolean(e.CardView_cardPreventCornerOverlap, true);
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(e.CardView_contentPadding, 0);
        this.f1188f.left = obtainStyledAttributes.getDimensionPixelSize(e.CardView_contentPaddingLeft, dimensionPixelSize);
        this.f1188f.top = obtainStyledAttributes.getDimensionPixelSize(e.CardView_contentPaddingTop, dimensionPixelSize);
        this.f1188f.right = obtainStyledAttributes.getDimensionPixelSize(e.CardView_contentPaddingRight, dimensionPixelSize);
        this.f1188f.bottom = obtainStyledAttributes.getDimensionPixelSize(e.CardView_contentPaddingBottom, dimensionPixelSize);
        float f2 = dimension2 > dimension3 ? dimension2 : dimension3;
        this.f1186d = obtainStyledAttributes.getDimensionPixelSize(e.CardView_android_minWidth, 0);
        this.f1187e = obtainStyledAttributes.getDimensionPixelSize(e.CardView_android_minHeight, 0);
