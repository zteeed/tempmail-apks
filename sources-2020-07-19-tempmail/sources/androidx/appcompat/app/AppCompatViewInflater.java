...
public class AppCompatViewInflater {
    ...
    private static class a implements View.OnClickListener {
        ...
        private void a(Context context, String str) {
            ...
            while (context != null) {
                try {
                    if (!context.isRestricted() && (method = context.getClass().getMethod(this.f696c, new Class[]{View.class})) != null) {
                        this.f697d = method;
                        this.f698e = context;
                        return;
                    }
            ...
            int id = this.f695b.getId();
            if (id == -1) {
                str2 = "";
            } else {
                str2 = " with id '" + this.f695b.getContext().getResources().getResourceEntryName(id) + "'";
            }
            throw new IllegalStateException("Could not find method " + this.f696c + "(View) in a parent or ancestor Context for android:onClick " + "attribute defined on view " + this.f695b.getClass() + str2);
        }

        public void onClick(View view) {
            if (this.f697d == null) {
                a(this.f695b.getContext(), this.f696c);
            }
            try {
                this.f697d.invoke(this.f698e, new Object[]{view});
    ...
    private void checkOnClickListener(View view, AttributeSet attributeSet) {
        ...
        if (Build.VERSION.SDK_INT < 15 || t.D(view)) {
