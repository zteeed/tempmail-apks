...
public class o {
    ...
    public static final Rect f1140a = new Rect();

    /* renamed from: b  reason: collision with root package name */
    private static Class<?> f1141b;

    static {
        if (Build.VERSION.SDK_INT >= 18) {
            try {
                f1141b = Class.forName("android.graphics.Insets");
    ...
    private static void c(Drawable drawable) {
        ...
        if (state == null || state.length == 0) {
            drawable.setState(w.f1172e);
        } else {
            drawable.setState(w.f1173f);
        }
    ...
    public static Rect d(Drawable drawable) {
        if (f1141b != null) {
            try {
                ...
                if (invoke != null) {
                    Rect rect = new Rect();
                    for (Field field : f1141b.getFields()) {
