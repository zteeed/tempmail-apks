...
class p extends ListView {
    ...
    private final Rect f1142b = new Rect();
    ...
    private void c(Canvas canvas) {
        Drawable selector;
        if (!this.f1142b.isEmpty() && (selector = getSelector()) != null) {
            selector.setBounds(this.f1142b);
            selector.draw(canvas);
        }
    }

    private void f(int i2, View view) {
        Rect rect = this.f1142b;
        rect.set(view.getLeft(), view.getTop(), view.getRight(), view.getBottom());
        rect.left -= this.f1143c;
        rect.top -= this.f1144d;
        rect.right += this.f1145e;
        rect.bottom += this.f1146f;
        try {
    ...
    public void setSelector(Drawable drawable) {
        ...
        this.f1143c = rect.left;
        this.f1144d = rect.top;
        this.f1145e = rect.right;
        this.f1146f = rect.bottom;
    }
}
