...
public final class f {
    ...
    private WeakHashMap<Context, h<ColorStateList>> f1101a;

    /* renamed from: b  reason: collision with root package name */
    private a.e.a<String, d> f1102b;

    /* renamed from: c  reason: collision with root package name */
    private h<String> f1103c;

    /* renamed from: d  reason: collision with root package name */
    private final WeakHashMap<Context, a.e.d<WeakReference<Drawable.ConstantState>>> f1104d = new WeakHashMap<>(0);

    /* renamed from: e  reason: collision with root package name */
    private TypedValue f1105e;
    ...
    private static class b implements d {
        ...
        public Drawable a(Context context, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
            try {
                return a.q.a.a.b.a(context, context.getResources(), xmlPullParser, attributeSet, theme);
            } catch (Exception e2) {
    ...
    private static class e implements d {
        ...
        public Drawable a(Context context, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) {
            try {
                return a.q.a.a.h.c(context.getResources(), xmlPullParser, attributeSet, theme);
            } catch (Exception e2) {
    ...
    static void C(Drawable drawable, z zVar, int[] iArr) {
        if (!o.a(drawable) || drawable.mutate() == drawable) {
            if (zVar.f1181d || zVar.f1180c) {
                drawable.setColorFilter(m(zVar.f1181d ? zVar.f1178a : null, zVar.f1180c ? zVar.f1179b : g, iArr));
            } else {
    ...
    private void a(String str, d dVar) {
        if (this.f1102b == null) {
            this.f1102b = new a.e.a<>();
        }
        this.f1102b.put(str, dVar);
    }
    ...
    private synchronized boolean b(Context context, long j2, Drawable drawable) {
        ...
        a.e.d dVar = this.f1104d.get(context);
        if (dVar == null) {
            dVar = new a.e.d();
            this.f1104d.put(context, dVar);
        }
    ...
    private void c(Context context, int i2, ColorStateList colorStateList) {
        ...
        h hVar = this.f1101a.get(context);
        if (hVar == null) {
            hVar = new h();
            this.f1101a.put(context, hVar);
        }
    ...
    private ColorStateList g(Context context, int i2) {
        ...
        return new ColorStateList(new int[][]{w.f1169b, w.f1171d, w.f1170c, w.f1173f}, new int[]{a2, a.h.e.a.b(b2, i2), a.h.e.a.b(b2, i2), i2});
    }
    ...
    private Drawable k(Context context, int i2) {
        if (this.f1105e == null) {
            this.f1105e = new TypedValue();
        }
        TypedValue typedValue = this.f1105e;
    ...
    private synchronized android.graphics.drawable.Drawable o(android.content.Context r4, long r5) {
        /*
            r3 = this;
            monitor-enter(r3)
            java.util.WeakHashMap<android.content.Context, a.e.d<java.lang.ref.WeakReference<android.graphics.drawable.Drawable$ConstantState>>> r0 = r3.f1104d     // Catch:{ all -> 0x002d }
    ...
    private ColorStateList t(Context context, int i2) {
        h hVar;
        WeakHashMap<Context, h<ColorStateList>> weakHashMap = this.f1101a;
    ...
    private static boolean w(Drawable drawable) {
        return (drawable instanceof a.q.a.a.h) || "android.graphics.drawable.VectorDrawable".equals(drawable.getClass().getName());
    }
    ...
    private android.graphics.drawable.Drawable x(android.content.Context r11, int r12) {
        /*
            r10 = this;
            a.e.a<java.lang.String, androidx.appcompat.widget.f$d> r0 = r10.f1102b
            r1 = 0
            if (r0 == 0) goto L_0x00b2
            boolean r0 = r0.isEmpty()
            if (r0 != 0) goto L_0x00b2
            a.e.h<java.lang.String> r0 = r10.f1103c
            ...
            a.e.a<java.lang.String, androidx.appcompat.widget.f$d> r3 = r10.f1102b
        ...
        L_0x0028:
            ...
            r10.f1103c = r0
        L_0x002f:
            android.util.TypedValue r0 = r10.f1105e
        ...
        L_0x0071:
            ...
            a.e.h<java.lang.String> r8 = r10.f1103c     // Catch:{ Exception -> 0x00a2 }
            r8.b(r12, r3)     // Catch:{ Exception -> 0x00a2 }
            a.e.a<java.lang.String, androidx.appcompat.widget.f$d> r8 = r10.f1102b     // Catch:{ Exception -> 0x00a2 }
        ...
        L_0x00aa:
            ...
            a.e.h<java.lang.String> r11 = r10.f1103c
            r11.b(r12, r2)
        L_0x00b1:
            return r6
        L_0x00b2:
