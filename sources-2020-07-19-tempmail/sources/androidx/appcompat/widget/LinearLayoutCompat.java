...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public int getBaseline() {
        ...
        if (childCount > i3) {
            ...
            if (baseline != -1) {
                int i4 = this.f978d;
                if (this.f979e == 1 && (i2 = this.f980f & 112) != 48) {
                    if (i2 == 16) {
    ...
    public void u(int r25, int r26, int r27, int r28) {
        /*
            ...
            boolean r12 = r6.f976b
            int[] r13 = r6.j
            int[] r14 = r6.k
            int r1 = a.h.k.t.t(r24)
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.f977c = u.k(j.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
    ...
    public static class a extends ViewGroup.MarginLayoutParams {
        ...
        public a(Context context, AttributeSet attributeSet) {
            ...
            this.f981a = obtainStyledAttributes.getFloat(j.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.f982b = obtainStyledAttributes.getInt(j.LinearLayoutCompat_Layout_android_layout_gravity, -1);
