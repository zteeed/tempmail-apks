    ...
    private void M(int i, int i2) {
        ...
        while (i13 < childCount) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                int L = L(childAt, i11, cVar.f908c ? 1 : i9, childMeasureSpec, paddingTop);
                i15 = Math.max(i15, L);
                if (cVar.f911f) {
                    i16++;
                }
        ...
        if (z3) {
            for (int i35 = 0; i35 < childCount; i35++) {
                ...
                if (cVar5.h) {
                    childAt4.measure(View.MeasureSpec.makeMeasureSpec((cVar5.f909d * i11) + cVar5.f910e, 1073741824), childMeasureSpec);
                }
            }
        }
    ...
    public void onLayout(boolean z2, int i, int i2, int i3, int i4) {
        ...
        if (b2) {
            ...
            for (int i16 = 0; i16 < childCount; i16++) {
                ...
                if (childAt3.getVisibility() != 8 && !cVar2.f908c) {
        ...
        for (int i19 = 0; i19 < childCount; i19++) {
            ...
            if (childAt4.getVisibility() != 8 && !cVar3.f908c) {
