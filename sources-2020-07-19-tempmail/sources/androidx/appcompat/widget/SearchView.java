...
public class SearchView extends LinearLayoutCompat implements a.a.n.c {
    ...
    static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            return "SearchView.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " isIconified=" + this.f1011d + "}";
        }
        ...
        public SavedState(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f1011d = ((Boolean) parcel.readValue((ClassLoader) null)).booleanValue();
        }
    }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public boolean enoughToFilter() {
            return this.f1012e <= 0 || super.enoughToFilter();
        }
        ...
        public void onWindowFocusChanged(boolean z) {
            ...
            if (z && this.f1013f.hasFocus() && getVisibility() == 0) {
                this.g = true;
    ...
    private static class k {
        ...
        private Method f1025a;

        /* renamed from: b  reason: collision with root package name */
        private Method f1026b;

        /* renamed from: c  reason: collision with root package name */
        private Method f1027c;

        k() {
            try {
                Method declaredMethod = AutoCompleteTextView.class.getDeclaredMethod("doBeforeTextChanged", new Class[0]);
                this.f1025a = declaredMethod;
                declaredMethod.setAccessible(true);
            } catch (NoSuchMethodException unused) {
            }
            try {
                Method declaredMethod2 = AutoCompleteTextView.class.getDeclaredMethod("doAfterTextChanged", new Class[0]);
                this.f1026b = declaredMethod2;
    ...
    private static class o extends TouchDelegate {
        ...
        /* renamed from: b  reason: collision with root package name */
        private final Rect f1029b = new Rect();

        /* renamed from: c  reason: collision with root package name */
        private final Rect f1030c = new Rect();

        /* renamed from: d  reason: collision with root package name */
        private final Rect f1031d = new Rect();
        ...
        public o(Rect rect, Rect rect2, View view) {
            super(rect, view);
            this.f1032e = ViewConfiguration.get(view.getContext()).getScaledTouchSlop();
            a(rect, rect2);
            this.f1028a = view;
        }

        public void a(Rect rect, Rect rect2) {
            this.f1029b.set(rect);
            this.f1031d.set(rect);
            Rect rect3 = this.f1031d;
            int i = this.f1032e;
            rect3.inset(-i, -i);
            this.f1030c.set(rect2);
        }
        ...
        public boolean onTouchEvent(android.view.MotionEvent r8) {
            /*
                ...
                goto L_0x003d
            L_0x001b:
                boolean r2 = r7.f1033f
                r7.f1033f = r5
                goto L_0x002f
            L_0x0020:
                boolean r2 = r7.f1033f
                if (r2 == 0) goto L_0x002f
                android.graphics.Rect r6 = r7.f1031d
            ...
            L_0x0030:
                ...
                goto L_0x003f
            L_0x0032:
                android.graphics.Rect r2 = r7.f1029b
            ...
            L_0x003f:
                ...
                android.graphics.Rect r2 = r7.f1030c
                boolean r2 = r2.contains(r0, r1)
                if (r2 != 0) goto L_0x005f
                android.view.View r0 = r7.f1028a
                int r0 = r0.getWidth()
                int r0 = r0 / r3
                float r0 = (float) r0
                android.view.View r1 = r7.f1028a
                int r1 = r1.getHeight()
                int r1 = r1 / r3
                float r1 = (float) r1
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i2) {
        ...
        t.b0(this.s, u2.g(a.a.j.SearchView_queryBackground));
        t.b0(this.t, u2.g(a.a.j.SearchView_submitBackground));
