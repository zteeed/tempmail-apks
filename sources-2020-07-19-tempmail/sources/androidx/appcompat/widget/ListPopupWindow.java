...
public class ListPopupWindow implements s {
    ...
    class a implements AdapterView.OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView<?> adapterView, View view, int i, long j) {
            p pVar;
            if (i != -1 && (pVar = ListPopupWindow.this.f985d) != null) {
    ...
    private class f implements Runnable {
        ...
        public void run() {
            p pVar = ListPopupWindow.this.f985d;
            if (pVar != null && t.H(pVar) && ListPopupWindow.this.f985d.getCount() > ListPopupWindow.this.f985d.getChildCount()) {
                int childCount = ListPopupWindow.this.f985d.getChildCount();
                ListPopupWindow listPopupWindow = ListPopupWindow.this;
    ...
    private int e() {
        /*
            r12 = this;
            androidx.appcompat.widget.p r0 = r12.f985d
            r1 = -2147483648(0xffffffff80000000, float:-0.0)
            r2 = -1
            r3 = 1
            r4 = 0
            if (r0 != 0) goto L_0x00b8
            android.content.Context r0 = r12.f983b
            boolean r5 = r12.E
            r5 = r5 ^ r3
            ...
            r5.setSelector(r6)
        L_0x001b:
            androidx.appcompat.widget.p r5 = r12.f985d
            android.widget.ListAdapter r6 = r12.f984c
            r5.setAdapter(r6)
            androidx.appcompat.widget.p r5 = r12.f985d
            ...
            androidx.appcompat.widget.p r6 = r12.f985d
        ...
        L_0x0116:
            ...
            goto L_0x0155
        L_0x0124:
            android.content.Context r2 = r12.f983b
        ...
        L_0x0155:
            ...
            androidx.appcompat.widget.p r2 = r12.f985d
            int r2 = r2.getPaddingTop()
            androidx.appcompat.widget.p r3 = r12.f985d
    ...
    public void q(ListAdapter listAdapter) {
        ...
        if (dataSetObserver == null) {
            ...
            ListAdapter listAdapter2 = this.f984c;
            if (listAdapter2 != null) {
                listAdapter2.unregisterDataSetObserver(dataSetObserver);
            }
        }
        this.f984c = listAdapter;
        if (listAdapter != null) {
            listAdapter.registerDataSetObserver(this.s);
        }
        p pVar = this.f985d;
        if (pVar != null) {
            pVar.setAdapter(this.f984c);
        }
    }
    ...
    public void show() {
        ...
        if (!this.F.isShowing()) {
            ...
            this.f985d.setSelection(-1);
            if (!this.E || this.f985d.isInTouchMode()) {
                f();
            }
            if (!this.E) {
                this.B.post(this.A);
            ...
            if (i5 == -1) {
                ...
                if (n2) {
                    this.F.setWidth(this.f987f == -1 ? -1 : 0);
                    this.F.setHeight(0);
                } else {
                    this.F.setWidth(this.f987f == -1 ? -1 : 0);
                    this.F.setHeight(-1);
    ...
    public void u(int i2) {
        ...
        if (background != null) {
            ...
            Rect rect = this.C;
            this.f987f = rect.left + rect.right + i2;
            return;
        }
        H(i2);
    }
