...
public class ActionMenuItemView extends AppCompatTextView implements p.a, View.OnClickListener, ActionMenuView.a {
    ...
    private class a extends r {
        ...
        public boolean c() {
            ...
            if (bVar == null || !bVar.a(actionMenuItemView.f798e) || (b2 = b()) == null || !b2.b()) {
                return false;
            }
            return true;
        }
    ...
    private void h() {
        ...
        boolean z = true;
        boolean z2 = !TextUtils.isEmpty(this.f799f);
        if (this.g != null && (!this.f798e.B() || (!this.k && !this.l))) {
            z = false;
        }
        boolean z3 = z2 & z;
        CharSequence charSequence2 = null;
        setText(z3 ? this.f799f : null);
        CharSequence contentDescription = this.f798e.getContentDescription();
        if (TextUtils.isEmpty(contentDescription)) {
            if (z3) {
                charSequence = null;
            } else {
                charSequence = this.f798e.getTitle();
            }
            setContentDescription(charSequence);
        } else {
            setContentDescription(contentDescription);
        }
        CharSequence tooltipText = this.f798e.getTooltipText();
        if (TextUtils.isEmpty(tooltipText)) {
            if (!z3) {
                charSequence2 = this.f798e.getTitle();
            }
    ...
    public boolean b() {
        return f() && this.f798e.getIcon() == null;
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        r rVar;
        if (!this.f798e.hasSubMenu() || (rVar = this.i) == null || !rVar.onTouch(this, motionEvent)) {
