...
final class e extends m implements o, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    class a implements ViewTreeObserver.OnGlobalLayoutListener {
        ...
        public void onGlobalLayout() {
            if (e.this.b() && e.this.j.size() > 0 && !e.this.j.get(0).f834a.o()) {
                View view = e.this.q;
    ...
    class c implements s {
        ...
        class a implements Runnable {
            ...
            final /* synthetic */ d f830b;

            /* renamed from: c  reason: collision with root package name */
            final /* synthetic */ MenuItem f831c;

            /* renamed from: d  reason: collision with root package name */
            final /* synthetic */ h f832d;
            ...
            public void run() {
                ...
                if (this.f831c.isEnabled() && this.f831c.hasSubMenu()) {
                    this.f832d.N(this.f831c, 4);
                }
            }
        }
        ...
        public void a(h hVar, MenuItem menuItem) {
            ...
            while (true) {
                if (i >= size) {
                    i = -1;
                    break;
                } else if (hVar == e.this.j.get(i).f835b) {
                    break;
                } else {
                    i++;
                }
    ...
    public e(Context context, View view, int i2, int i3, boolean z2) {
        ...
        this.f824d = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(a.a.d.abc_config_prefDialogWidth));
        this.h = new Handler();
    }

    private MenuPopupWindow B() {
        MenuPopupWindow menuPopupWindow = new MenuPopupWindow(this.f823c, (AttributeSet) null, this.f825e, this.f826f);
    ...
    private void H(h hVar) {
        ...
        int i3;
        int i4;
        LayoutInflater from = LayoutInflater.from(this.f823c);
        ...
        int q2 = m.q(gVar, (ViewGroup) null, this.f823c, this.f824d);
    ...
    public void a(h hVar, boolean z2) {
        ...
        if (C2 >= 0) {
            int i2 = C2 + 1;
            if (i2 < this.j.size()) {
                this.j.get(i2).f835b.e(false);
            }
            d remove = this.j.remove(C2);
            remove.f835b.Q(this);
            if (this.B) {
                remove.f834a.J((Object) null);
                remove.f834a.s(0);
            }
            remove.f834a.dismiss();
            int size = this.j.size();
            if (size > 0) {
                this.r = this.j.get(size - 1).f836c;
            } else {
                this.r = F();
            }
            if (size == 0) {
                ...
                this.j.get(0).f835b.e(false);
            }
        }
    }

    public boolean b() {
        return this.j.size() > 0 && this.j.get(0).f834a.b();
    }

    public void c(h hVar) {
        hVar.c(this, this.f823c);
        if (b()) {
            H(hVar);
        } else {
            this.i.add(hVar);
    ...
    public void r(View view) {
        if (this.p != view) {
            this.p = view;
            this.o = a.h.k.d.b(this.n, t.t(view));
        }
    }
    ...
    public void u(int i2) {
        if (this.n != i2) {
            this.n = i2;
            this.o = a.h.k.d.b(i2, t.t(this.p));
        }
    }
