...
class g {
    ...
    private void c(List<a.b> list, int i, a.b bVar, int i2, a.b bVar2) {
        int i3 = bVar.f1764d < bVar2.f1762b ? -1 : 0;
        if (bVar.f1762b < bVar2.f1762b) {
            i3++;
        }
        int i4 = bVar2.f1762b;
        int i5 = bVar.f1762b;
        if (i4 <= i5) {
            bVar.f1762b = i5 + bVar2.f1764d;
        }
        int i6 = bVar2.f1762b;
        int i7 = bVar.f1764d;
        if (i6 <= i7) {
            bVar.f1764d = i7 + bVar2.f1764d;
        }
        bVar2.f1762b += i3;
        list.set(i, bVar2);
        list.set(i2, bVar);
    ...
    public void e(java.util.List<androidx.recyclerview.widget.a.b> r10, int r11, androidx.recyclerview.widget.a.b r12, int r13, androidx.recyclerview.widget.a.b r14) {
        ...
        L_0x002f:
            ...
            r10.remove(r13)
            androidx.recyclerview.widget.g$a r10 = r9.f1840a
            r10.a(r14)
        L_0x0047:
            return
        L_0x0048:
        ...
        L_0x0053:
            ...
            int r4 = r4 + r7
            int r4 = r4 - r1
            androidx.recyclerview.widget.g$a r7 = r9.f1840a
            int r1 = r1 + r3
    ...
    public void f(java.util.List<androidx.recyclerview.widget.a.b> r9, int r10, androidx.recyclerview.widget.a.b r11, int r12, androidx.recyclerview.widget.a.b r13) {
        ...
        L_0x000d:
            ...
            int r5 = r5 - r4
            r13.f1764d = r5
            androidx.recyclerview.widget.g$a r0 = r8.f1840a
            int r1 = r11.f1762b
            java.lang.Object r5 = r13.f1763c
        ...
        L_0x002b:
            ...
            int r5 = r5 + r6
            int r5 = r5 - r1
            androidx.recyclerview.widget.g$a r3 = r8.f1840a
            int r1 = r1 + r4
            java.lang.Object r4 = r13.f1763c
        ...
        L_0x004c:
            r9.remove(r10)
            androidx.recyclerview.widget.g$a r11 = r8.f1840a
            r11.a(r13)
        L_0x0054:
