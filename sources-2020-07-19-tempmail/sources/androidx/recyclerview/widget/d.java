...
class d extends RecyclerView.n implements RecyclerView.r {
    ...
    final StateListDrawable f1811c;

    /* renamed from: d  reason: collision with root package name */
    final Drawable f1812d;
    ...
    private class C0050d implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            d.this.f1811c.setAlpha(floatValue);
            d.this.f1812d.setAlpha(floatValue);
            d.this.v();
        }
    }
    ...
    d(RecyclerView recyclerView, StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2, int i2, int i3, int i4) {
        this.f1811c = stateListDrawable;
        this.f1812d = drawable;
        this.g = stateListDrawable2;
        this.h = drawable2;
        this.f1813e = Math.max(i2, stateListDrawable.getIntrinsicWidth());
        this.f1814f = Math.max(i2, drawable.getIntrinsicWidth());
        this.i = Math.max(i2, stateListDrawable2.getIntrinsicWidth());
        this.j = Math.max(i2, drawable2.getIntrinsicWidth());
        this.f1809a = i3;
        this.f1810b = i4;
        this.f1811c.setAlpha(255);
        this.f1812d.setAlpha(255);
    ...
    private void n(Canvas canvas) {
        ...
        int i6 = this.k;
        int i7 = i5 - (i6 / 2);
        this.f1811c.setBounds(0, 0, i3, i6);
        this.f1812d.setBounds(0, 0, this.f1814f, this.r);
        if (s()) {
            this.f1812d.draw(canvas);
            canvas.translate((float) this.f1813e, (float) i7);
            canvas.scale(-1.0f, 1.0f);
            this.f1811c.draw(canvas);
            canvas.scale(1.0f, 1.0f);
            canvas.translate((float) (-this.f1813e), (float) (-i7));
            return;
        }
    ...
    public void B(int i2, int i3) {
        ...
        int i4 = this.r;
        this.t = computeVerticalScrollRange - i4 > 0 && i4 >= this.f1809a;
        int computeHorizontalScrollRange = this.s.computeHorizontalScrollRange();
        int i5 = this.q;
        boolean z2 = computeHorizontalScrollRange - i5 > 0 && i5 >= this.f1809a;
        this.u = z2;
        if (this.t || z2) {
            if (this.t) {
                float f2 = (float) i4;
    ...
    public boolean u(float f2, float f3) {
        if (!s() ? f2 >= ((float) (this.q - this.f1813e)) : f2 <= ((float) (this.f1813e / 2))) {
            int i2 = this.l;
            int i3 = this.k;
