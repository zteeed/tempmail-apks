...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager {
    ...
    public static class SavedState implements Parcelable {
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            if (this.f1737d > 0) {
                parcel.writeIntArray(this.f1738e);
            }
        ...
        public SavedState(SavedState savedState) {
            this.f1737d = savedState.f1737d;
            this.f1735b = savedState.f1735b;
            this.f1736c = savedState.f1736c;
            this.f1738e = savedState.f1738e;
            this.f1739f = savedState.f1739f;
            this.g = savedState.g;
            this.i = savedState.i;
            this.j = savedState.j;
            this.k = savedState.k;
    ...
    class b {
        ...
        public void b(int i) {
            if (this.f1743c) {
                this.f1742b = StaggeredGridLayoutManager.this.u.i() - i;
            } else {
                this.f1742b = StaggeredGridLayoutManager.this.u.m() + i;
            }
        }
        ...
        public void d(d[] dVarArr) {
            ...
            if (iArr == null || iArr.length < length) {
                this.f1746f = new int[StaggeredGridLayoutManager.this.t.length];
            }
            for (int i = 0; i < length; i++) {
                this.f1746f[i] = dVarArr[i].p(Integer.MIN_VALUE);
            }
        }
    }
    ...
    class d {
        ...
        /* renamed from: a  reason: collision with root package name */
        ArrayList<View> f1749a = new ArrayList<>();

        /* renamed from: b  reason: collision with root package name */
        int f1750b = Integer.MIN_VALUE;

        /* renamed from: c  reason: collision with root package name */
        int f1751c = Integer.MIN_VALUE;
        ...
        public void c() {
            ...
            ArrayList<View> arrayList = this.f1749a;
            View view = arrayList.get(arrayList.size() - 1);
            c n = n(view);
            this.f1751c = StaggeredGridLayoutManager.this.u.d(view);
            if (n.f1748f && (f2 = StaggeredGridLayoutManager.this.E.f(n.a())) != null && f2.f1732c == 1) {
                this.f1751c += f2.a(this.f1753e);
            }
        }
        ...
        public void d() {
            LazySpanLookup.FullSpanItem f2;
            View view = this.f1749a.get(0);
            c n = n(view);
            this.f1750b = StaggeredGridLayoutManager.this.u.g(view);
            if (n.f1748f && (f2 = StaggeredGridLayoutManager.this.E.f(n.a())) != null && f2.f1732c == -1) {
                this.f1750b -= f2.a(this.f1753e);
            }
        }
        ...
        public int f() {
            if (StaggeredGridLayoutManager.this.z) {
                return i(this.f1749a.size() - 1, -1, true);
            }
            return i(0, this.f1749a.size(), true);
        }
        ...
        public View m(int i, int i2) {
            ...
            if (i2 != -1) {
                ...
                while (size >= 0) {
                    View view2 = this.f1749a.get(size);
        ...
        public void s() {
            ...
            View remove = this.f1749a.remove(size - 1);
            c n = n(remove);
            n.f1747e = null;
            if (n.c() || n.b()) {
                this.f1752d -= StaggeredGridLayoutManager.this.u.e(remove);
            }
            if (size == 1) {
                this.f1750b = Integer.MIN_VALUE;
            }
        ...
        /* access modifiers changed from: package-private */
        public void t() {
            View remove = this.f1749a.remove(0);
            c n = n(remove);
            n.f1747e = null;
            if (this.f1749a.size() == 0) {
                this.f1751c = Integer.MIN_VALUE;
    ...
    private void H1(b bVar) {
        ...
        int i2 = savedState.f1737d;
        if (i2 > 0) {
            if (i2 == this.s) {
                for (int i3 = 0; i3 < this.s; i3++) {
                    this.t[i3].e();
                    SavedState savedState2 = this.I;
                    int i4 = savedState2.f1738e[i3];
                ...
                savedState3.f1735b = savedState3.f1736c;
            }
        }
        ...
        int i5 = savedState5.f1735b;
        if (i5 != -1) {
            this.C = i5;
            bVar.f1743c = savedState5.j;
        } else {
            bVar.f1743c = this.A;
        }
        SavedState savedState6 = this.I;
        if (savedState6.f1739f > 1) {
            LazySpanLookup lazySpanLookup = this.E;
            lazySpanLookup.f1729a = savedState6.g;
            lazySpanLookup.f1730b = savedState6.h;
        }
    }
    ...
    private boolean N1(d dVar) {
        if (this.A) {
            if (dVar.k() < this.u.i()) {
                ArrayList<View> arrayList = dVar.f1749a;
                return !dVar.n(arrayList.get(arrayList.size() - 1)).f1748f;
            }
        } else if (dVar.o() > this.u.m()) {
            return !dVar.n(dVar.f1749a.get(0)).f1748f;
        }
        return false;
    }
    ...
    private LazySpanLookup.FullSpanItem S1(int i) {
        ...
        fullSpanItem.f1733d = new int[this.s];
        for (int i2 = 0; i2 < this.s; i2++) {
            fullSpanItem.f1733d[i2] = i - this.t[i2].l(i);
        }
        return fullSpanItem;
    }
    ...
    private LazySpanLookup.FullSpanItem T1(int i) {
        ...
        fullSpanItem.f1733d = new int[this.s];
        for (int i2 = 0; i2 < this.s; i2++) {
            fullSpanItem.f1733d[i2] = this.t[i2].p(i) - i;
        }
        return fullSpanItem;
    }
    ...
    private int V1(RecyclerView.u uVar, f fVar, RecyclerView.y yVar) {
        ...
        if (this.y.i) {
            i = fVar2.f1838e == 1 ? Integer.MAX_VALUE : Integer.MIN_VALUE;
        } else {
            if (fVar2.f1838e == 1) {
                i12 = fVar2.g + fVar2.f1835b;
            } else {
                i12 = fVar2.f1839f - fVar2.f1835b;
            }
            i = i12;
        }
        E2(fVar2.f1838e, i);
        ...
        while (fVar.a(yVar) && (this.y.i || !this.B.isEmpty())) {
            ...
            boolean z4 = g == -1;
            if (z4) {
                dVar = cVar.f1748f ? this.t[r9] : j2(fVar2);
                this.E.n(a2, dVar);
            } else {
                dVar = this.t[g];
            }
            ...
            if (!n2() || this.w != 1) {
                if (cVar.f1748f) {
                    ...
                    i8 = (dVar2.f1753e * this.x) + this.v.m();
                }
                i7 = i8;
                i6 = this.v.e(b2) + i8;
            } else {
                if (cVar.f1748f) {
                    ...
                    i9 = this.v.i() - (((this.s - 1) - dVar2.f1753e) * this.x);
                }
                i6 = i9;
                i7 = i9 - this.v.e(b2);
            }
        ...
        if (i3 > 0) {
            return Math.min(fVar2.f1835b, i3);
        }
        return 0;
    }
    ...
    private void u2(RecyclerView.u uVar, f fVar) {
        ...
        if (fVar.f1834a && !fVar.i) {
            if (fVar.f1835b == 0) {
            ...
            } else if (fVar.f1838e == -1) {
                int i3 = fVar.f1839f;
                int g2 = i3 - g2(i3);
                if (g2 < 0) {
                    i2 = fVar.g;
                } else {
                    i2 = fVar.g - Math.min(g2, fVar.f1835b);
                }
                v2(uVar, i2);
            } else {
                ...
                if (h2 < 0) {
                    ...
                    i = Math.min(h2, fVar.f1835b) + fVar.f1839f;
                }
                w2(uVar, i);
            }
        }
    ...
    private void v2(RecyclerView.u uVar, int i) {
        ...
        while (I2 >= 0) {
            ...
            if (this.u.g(H2) >= i && this.u.q(H2) >= i) {
                ...
                } else if (cVar.f1747e.f1749a.size() != 1) {
                    cVar.f1747e.s();
                } else {
                    return;
                }
    ...
    public boolean G2(RecyclerView.y yVar, b bVar) {
        ...
        if (!yVar.e() && (i = this.C) != -1) {
            if (i < 0 || i >= yVar.b()) {
                ...
                SavedState savedState = this.I;
                if (savedState == null || savedState.f1735b == -1 || savedState.f1737d < 1) {
                    View B2 = B(this.C);
                    if (B2 != null) {
                        if (this.A) {
                            i2 = e2();
                        ...
                        if (this.D != Integer.MIN_VALUE) {
                            if (bVar.f1743c) {
                                bVar.f1742b = (this.u.i() - this.D) - this.u.d(B2);
                            } else {
                                bVar.f1742b = (this.u.m() + this.D) - this.u.g(B2);
                            }
                            return true;
    ...
    public View H0(View view, int i, RecyclerView.u uVar, RecyclerView.y yVar) {
        ...
        A2(R1);
        f fVar = this.y;
        fVar.f1836c = fVar.f1837d + i2;
        fVar.f1835b = (int) (((float) this.u.n()) * 0.33333334f);
        f fVar2 = this.y;
        fVar2.h = true;
        fVar2.f1834a = false;
        V1(uVar, fVar2, yVar);
    ...
    public boolean M1() {
        ...
        if (i2 == 0 && l2() != null) {
            ...
            LazySpanLookup.FullSpanItem e3 = this.E.e(i2, e2.f1731b, i3 * -1, true);
            if (e3 == null) {
                this.E.d(e2.f1731b);
            } else {
                this.E.d(e3.f1731b + 1);
            }
            r1();
            q1();
            return true;
    ...
    public void N0(RecyclerView.u uVar, RecyclerView.y yVar, View view, a.h.k.c0.d dVar) {
        ...
        if (this.w == 0) {
            dVar.c0(d.c.a(cVar.e(), cVar.f1748f ? this.s : 1, -1, -1, cVar.f1748f, false));
        } else {
            dVar.c0(d.c.a(-1, -1, cVar.e(), cVar.f1748f ? this.s : 1, cVar.f1748f, false));
        }
    }
    ...
    public Parcelable b1() {
        ...
        savedState.k = this.H;
        LazySpanLookup lazySpanLookup = this.E;
        if (lazySpanLookup == null || (iArr = lazySpanLookup.f1729a) == null) {
            savedState.f1739f = 0;
        } else {
            savedState.g = iArr;
            savedState.f1739f = iArr.length;
            savedState.h = lazySpanLookup.f1730b;
        }
        if (I() > 0) {
            if (this.G) {
                i = e2();
            ...
            savedState.f1735b = i;
            savedState.f1736c = Z1();
            int i4 = this.s;
            savedState.f1737d = i4;
            savedState.f1738e = new int[i4];
    ...
    public android.view.View l2() {
        ...
        L_0x002e:
            ...
            androidx.recyclerview.widget.StaggeredGridLayoutManager$d r9 = r8.f1747e
            int r9 = r9.f1753e
        ...
        L_0x008b:
            ...
            androidx.recyclerview.widget.StaggeredGridLayoutManager$d r8 = r8.f1747e
            int r8 = r8.f1753e
            androidx.recyclerview.widget.StaggeredGridLayoutManager$d r9 = r9.f1747e
            int r9 = r9.f1753e
            int r8 = r8 - r9
    ...
    public void n(int i, int i2, RecyclerView.y yVar, RecyclerView.LayoutManager.c cVar) {
        ...
        if (I() != 0 && i != 0) {
            ...
            for (int i8 = 0; i8 < i5 && this.y.a(yVar); i8++) {
                cVar.a(this.y.f1836c, this.O[i8]);
                f fVar2 = this.y;
                fVar2.f1836c += fVar2.f1837d;
            }
        }
    }
    ...
    public void s2(int i, RecyclerView.y yVar) {
        ...
        A2(i2);
        f fVar = this.y;
        fVar.f1836c = i3 + fVar.f1837d;
        fVar.f1835b = Math.abs(i);
    }
    ...
    static class LazySpanLookup {
        ...
        private int i(int i) {
            ...
            while (true) {
                if (i2 >= size) {
                    i2 = -1;
                    break;
                } else if (this.f1730b.get(i2).f1731b >= i) {
                    break;
                } else {
                    i2++;
                }
            ...
            return this.f1730b.get(i2).f1731b;
        }

        private void l(int i, int i2) {
            List<FullSpanItem> list = this.f1730b;
            if (list != null) {
                for (int size = list.size() - 1; size >= 0; size--) {
                    FullSpanItem fullSpanItem = this.f1730b.get(size);
                    int i3 = fullSpanItem.f1731b;
                    if (i3 >= i) {
                        fullSpanItem.f1731b = i3 + i2;
                    }
                }
            }
        }
        ...
        private void m(int i, int i2) {
            ...
            if (list != null) {
                ...
                for (int size = list.size() - 1; size >= 0; size--) {
                    FullSpanItem fullSpanItem = this.f1730b.get(size);
                    int i4 = fullSpanItem.f1731b;
                    if (i4 >= i) {
                        if (i4 < i3) {
                            this.f1730b.remove(size);
                        } else {
                            fullSpanItem.f1731b = i4 - i2;
                        }
                    }
                }
            }
        ...
        public void a(FullSpanItem fullSpanItem) {
            ...
            for (int i = 0; i < size; i++) {
                FullSpanItem fullSpanItem2 = this.f1730b.get(i);
                if (fullSpanItem2.f1731b == fullSpanItem.f1731b) {
                    this.f1730b.remove(i);
                }
                if (fullSpanItem2.f1731b >= fullSpanItem.f1731b) {
                    this.f1730b.add(i, fullSpanItem);
                    return;
                }
            }
            this.f1730b.add(fullSpanItem);
        }
        ...
        public int d(int i) {
            ...
            if (list != null) {
                for (int size = list.size() - 1; size >= 0; size--) {
                    if (this.f1730b.get(size).f1731b >= i) {
                        this.f1730b.remove(size);
                    }
                }
            }
        ...
        public FullSpanItem e(int i, int i2, int i3, boolean z) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                FullSpanItem fullSpanItem = this.f1730b.get(i4);
                int i5 = fullSpanItem.f1731b;
                if (i5 >= i2) {
                    return null;
                }
                if (i5 >= i && (i3 == 0 || fullSpanItem.f1732c == i3 || (z && fullSpanItem.f1734e))) {
                    return fullSpanItem;
                }
            }
            return null;
        ...
        public int h(int i) {
            ...
            int i3 = i2 + 1;
            Arrays.fill(this.f1729a, i, i3, -1);
            return i3;
        }
        ...
        public void n(int i, d dVar) {
            c(i);
            this.f1729a[i] = dVar.f1753e;
        }

        /* access modifiers changed from: package-private */
        public int o(int i) {
            int length = this.f1729a.length;
            while (length <= i) {
                length *= 2;
            }
            return length;
        ...
        static class FullSpanItem implements Parcelable {
            ...
            FullSpanItem(Parcel parcel) {
                ...
                this.f1734e = parcel.readInt() != 1 ? false : true;
                int readInt = parcel.readInt();
                if (readInt > 0) {
                    int[] iArr = new int[readInt];
                    this.f1733d = iArr;
            ...
            public String toString() {
                return "FullSpanItem{mPosition=" + this.f1731b + ", mGapDir=" + this.f1732c + ", mHasUnwantedGapAfter=" + this.f1734e + ", mGapPerSpan=" + Arrays.toString(this.f1733d) + '}';
            }

            public void writeToParcel(Parcel parcel, int i) {
                parcel.writeInt(this.f1731b);
                parcel.writeInt(this.f1732c);
                parcel.writeInt(this.f1734e ? 1 : 0);
                int[] iArr = this.f1733d;
