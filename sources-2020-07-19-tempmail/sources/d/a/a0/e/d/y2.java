...
public final class y2 {
    ...
    public static final class a<T> extends AtomicInteger implements d.a.a0.c.b<T>, Runnable {
        ...
        public void run() {
            if (get() == 0 && compareAndSet(0, 2)) {
                this.f13708b.onNext(this.f13709c);
                if (get() == 2) {
                    lazySet(3);
                    this.f13708b.onComplete();
                }
            }
        }
    }
    ...
    static final class b<T, R> extends l<R> {
        ...
        /* renamed from: c  reason: collision with root package name */
        final n<? super T, ? extends q<? extends R>> f13711c;
        ...
        public void subscribeActual(s<? super R> sVar) {
            try {
                Object apply = this.f13711c.apply(this.f13710b);
