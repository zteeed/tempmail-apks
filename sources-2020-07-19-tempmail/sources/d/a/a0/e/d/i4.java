...
public final class i4<T, B> extends a<T, l<T>> {
    ...
    final Callable<? extends q<B>> f13106c;
    ...
    static final class b<T, B> extends AtomicInteger implements s<T>, d.a.y.b, Runnable {
        ...
        final s<? super l<T>> f13110b;

        /* renamed from: c  reason: collision with root package name */
        final int f13111c;

        /* renamed from: d  reason: collision with root package name */
        final AtomicReference<a<T, B>> f13112d = new AtomicReference<>();

        /* renamed from: e  reason: collision with root package name */
        final AtomicInteger f13113e = new AtomicInteger(1);

        /* renamed from: f  reason: collision with root package name */
        final d.a.a0.f.a<Object> f13114f = new d.a.a0.f.a<>();
        ...
        public void a() {
            d.a.y.b andSet = this.f13112d.getAndSet(m);
        ...
        public void b() {
            if (getAndIncrement() == 0) {
                s<? super l<T>> sVar = this.f13110b;
                d.a.a0.f.a<Object> aVar = this.f13114f;
                d.a.a0.j.c cVar = this.g;
                int i2 = 1;
                while (this.f13113e.get() != 0) {
                    d<T> dVar = this.l;
                    boolean z = this.k;
                    if (!z || cVar.get() == null) {
                        ...
                        if (z && z2) {
                            ...
                            if (!this.h.get()) {
                                d<T> g2 = d.g(this.f13111c, this);
                                this.l = g2;
                                this.f13113e.getAndIncrement();
                                try {
                                    Object call = this.i.call();
                                    d.a.a0.b.b.e(call, "The other Callable returned a null ObservableSource");
                                    q qVar = (q) call;
                                    a aVar2 = new a(this);
                                    if (this.f13112d.compareAndSet((Object) null, aVar2)) {
        ...
        public void dispose() {
            if (this.h.compareAndSet(false, true)) {
                a();
                if (this.f13113e.decrementAndGet() == 0) {
                    this.j.dispose();
                }
            }
        }
        ...
        public void e(a<T, B> aVar) {
            this.f13112d.compareAndSet(aVar, (Object) null);
            this.f13114f.offer(n);
            b();
        }
    ...
    public void subscribeActual(s<? super l<T>> sVar) {
        this.f12780b.subscribe(new b(sVar, this.f13107d, this.f13106c));
    }
}
