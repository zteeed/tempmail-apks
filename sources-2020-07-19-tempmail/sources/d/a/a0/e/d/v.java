...
public final class v<T, R> extends a<T, R> {
    ...
    final n<? super T, ? extends q<? extends R>> f13582c;
    ...
    static final class a<T, R> extends AtomicInteger implements s<T>, b, d.a.a0.d.n<R> {
        ...
        final s<? super R> f13586b;

        /* renamed from: c  reason: collision with root package name */
        final n<? super T, ? extends q<? extends R>> f13587c;
                    ...
                    while (true) {
                        if (i3 == this.f13588d) {
                            ...
                            try {
                                ...
                                Object apply = this.f13587c.apply(poll);
                                d.a.a0.b.b.e(apply, "The mapper returned a null ObservableSource");
                                q qVar = (q) apply;
                                m mVar = new m(this, this.f13589e);
        ...
        public void onSubscribe(b bVar) {
            if (d.a.a0.a.c.p(this.j, bVar)) {
                ...
                this.i = new d.a.a0.f.c(this.f13589e);
                this.f13586b.onSubscribe(this);
            }
        }
    }
    ...
    public void subscribeActual(s<? super R> sVar) {
        this.f12780b.subscribe(new a(sVar, this.f13582c, this.f13584e, this.f13585f, this.f13583d));
    }
}
