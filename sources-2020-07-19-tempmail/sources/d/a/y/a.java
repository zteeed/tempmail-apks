...
public final class a implements b, b {
    ...
    public boolean c(d.a.y.b r3) {
        /*
            ...
            d.a.a0.b.b.e(r3, r0)
            boolean r0 = r2.f13971c
            r1 = 0
            if (r0 == 0) goto L_0x000b
            return r1
        L_0x000b:
            monitor-enter(r2)
            boolean r0 = r2.f13971c     // Catch:{ all -> 0x0022 }
            if (r0 == 0) goto L_0x0012
            monitor-exit(r2)     // Catch:{ all -> 0x0022 }
            return r1
        L_0x0012:
            d.a.a0.j.o<d.a.y.b> r0 = r2.f13970b     // Catch:{ all -> 0x0022 }
    ...
    public int g() {
        ...
        L_0x0006:
            monitor-enter(r2)
            boolean r0 = r2.f13971c     // Catch:{ all -> 0x0017 }
            if (r0 == 0) goto L_0x000d
            monitor-exit(r2)     // Catch:{ all -> 0x0017 }
            return r1
        L_0x000d:
            d.a.a0.j.o<d.a.y.b> r0 = r2.f13970b     // Catch:{ all -> 0x0017 }
