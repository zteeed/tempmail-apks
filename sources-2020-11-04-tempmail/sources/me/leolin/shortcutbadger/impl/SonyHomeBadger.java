...
public class SonyHomeBadger implements me.leolin.shortcutbadger.a {
    ...
    private final Uri f14802a = Uri.parse("content://com.sonymobile.home.resourceprovider/badge");

    /* renamed from: b  reason: collision with root package name */
    private AsyncQueryHandler f14803b;
        ...
        if (i >= 0) {
            ...
            if (Looper.myLooper() == Looper.getMainLooper()) {
                if (this.f14803b == null) {
                    this.f14803b = new a(this, context.getApplicationContext().getContentResolver());
                }
                f(c2);
                return;
            }
    ...
    private void f(ContentValues contentValues) {
        this.f14803b.startInsert(0, (Object) null, this.f14802a, contentValues);
    }

    private void g(Context context, ContentValues contentValues) {
        context.getApplicationContext().getContentResolver().insert(this.f14802a, contentValues);
    }
