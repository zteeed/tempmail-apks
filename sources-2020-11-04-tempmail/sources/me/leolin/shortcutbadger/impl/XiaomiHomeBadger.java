...
public class XiaomiHomeBadger implements a {
    ...
    private void c(Context context, int i) throws ShortcutBadgeException {
        if (this.f14804a == null) {
            ...
            this.f14804a = context.getPackageManager().resolveActivity(intent, 65536);
        }
        if (this.f14804a != null) {
            NotificationManager notificationManager = (NotificationManager) context.getSystemService("notification");
            Notification build = new Notification.Builder(context).setContentTitle("").setContentText("").setSmallIcon(this.f14804a.getIconResource()).build();
            try {
