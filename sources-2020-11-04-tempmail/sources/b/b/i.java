...
public class i implements t {
    ...
    private long f2118a = -1;

    /* renamed from: b  reason: collision with root package name */
    private long f2119b = -1;

    /* renamed from: c  reason: collision with root package name */
    private long f2120c = TimeUnit.SECONDS.toMillis(5);

    /* renamed from: d  reason: collision with root package name */
    private u f2121d = null;
    /* access modifiers changed from: private */

    /* renamed from: e  reason: collision with root package name */
    public Map<String, String> f2122e;
    /* access modifiers changed from: private */
    ...
    class a implements i0.a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private /* synthetic */ Map f2124a;

        /* renamed from: b  reason: collision with root package name */
        private /* synthetic */ WeakReference f2125b;

        a(i iVar, Map map, WeakReference weakReference) {
            this.f2124a = map;
            this.f2125b = weakReference;
        }

        private void c(Map<String, String> map) {
            if (this.f2125b.get() != null) {
                i.X((Context) this.f2125b.get(), "deeplinkAttribution", new JSONObject(map).toString());
            }
        }
        ...
        public final void b(Map<String, String> map) {
            for (String next : map.keySet()) {
                this.f2124a.put(next, map.get(next));
            }
            c(this.f2124a);
            i.y(this.f2124a);
        }
    ...
    class c implements Runnable {
        ...
        /* renamed from: b  reason: collision with root package name */
        private final Intent f2126b;

        /* renamed from: c  reason: collision with root package name */
        private final String f2127c;

        /* renamed from: d  reason: collision with root package name */
        private WeakReference<Context> f2128d;
        ...
        public final void run() {
            i.n0(i.this, this.f2128d.get(), this.f2129e, this.f2130f, this.g, this.h, this.i, this.j, this.f2126b, this.f2127c);
        }
    ...
    class d implements Runnable {
        ...
        /* renamed from: c  reason: collision with root package name */
        private WeakReference<Context> f2132c;

        /* renamed from: d  reason: collision with root package name */
        private Map<String, Object> f2133d;
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:33:0x0085, code lost:
            b.b.s.a.d().a(new b.b.s.b(r9.f2131b, r0, "4.9.0"), r9.f2132c.get());
        ...
        public final void run() {
            ...
            L_0x0009:
                ...
                if (r1 == 0) goto L_0x0028
                java.util.Map<java.lang.String, java.lang.Object> r1 = r9.f2133d
                java.lang.String r2 = "rfr"
                b.b.i r3 = b.b.i.this
                java.util.Map r3 = r3.f2122e
                r1.put(r2, r3)
            L_0x0028:
                java.util.Map<java.lang.String, java.lang.Object> r1 = r9.f2133d
                b.b.p$a r2 = new b.b.p$a
                java.util.Map<java.lang.String, java.lang.Object> r3 = r9.f2133d
                java.lang.ref.WeakReference<android.content.Context> r4 = r9.f2132c
                java.lang.Object r4 = r4.get()
                android.content.Context r4 = (android.content.Context) r4
                r2.<init>(r3, r4)
                r1.putAll(r2)
                java.util.Map<java.lang.String, java.lang.Object> r1 = r9.f2133d     // Catch:{ IOException -> 0x006f, all -> 0x0066 }
                ...
                java.util.Map<java.lang.String, java.lang.Object> r2 = r9.f2133d     // Catch:{ all -> 0x0063 }
                ...
                java.lang.String r3 = r9.f2131b     // Catch:{ IOException -> 0x006f, all -> 0x0066 }
                java.lang.ref.WeakReference<android.content.Context> r6 = r9.f2132c     // Catch:{ IOException -> 0x006f, all -> 0x0066 }
                r7 = 0
                boolean r8 = r9.f2134e     // Catch:{ IOException -> 0x006f, all -> 0x0066 }
                r4 = r0
            ...
            L_0x006f:
                ...
                java.lang.ref.WeakReference<android.content.Context> r2 = r9.f2132c
                if (r2 == 0) goto L_0x00a4
                java.lang.String r2 = r9.f2131b
                java.lang.String r3 = "&isCachedRequest=true&timeincache="
                boolean r2 = r2.contains(r3)
                if (r2 != 0) goto L_0x00a4
                b.b.s.a r2 = b.b.s.a.d()
                b.b.s.b r3 = new b.b.s.b
                java.lang.String r4 = r9.f2131b
                java.lang.String r5 = "4.9.0"
                r3.<init>(r4, r0, r5)
                java.lang.ref.WeakReference<android.content.Context> r0 = r9.f2132c
        ...
        private d(String str, Map<String, Object> map, Context context, boolean z, int i) {
            ...
            this.f2131b = str;
            this.f2133d = map;
            this.f2132c = new WeakReference<>(context);
            this.f2134e = z;
            this.f2135f = i;
        }
    }
    ...
    class e implements Runnable {
        ...
        /* renamed from: b  reason: collision with root package name */
        private WeakReference<Context> f2136b = null;

        public e(Context context) {
            this.f2136b = new WeakReference<>(context);
        }
        ...
        public final void run() {
            if (!i.this.f2123f) {
                ...
                if (this.f2136b != null) {
                    boolean unused2 = i.this.f2123f = true;
                    try {
                        String s = j.b().g("AppsFlyerKey");
                        synchronized (this.f2136b) {
                            for (b.b.s.b next : b.b.s.a.d().c(this.f2136b.get())) {
                                ...
                                try {
                                    ...
                                    i.o0(iVar, sb2.toString(), next.b(), s, this.f2136b, next.a(), false);
                                } catch (Exception e2) {
                        ...
                        try {
                            ...
                            boolean unused3 = i.this.f2123f = false;
                            throw th;
                        }
                    }
                    boolean unused4 = i.this.f2123f = false;
                    i.this.h.shutdown();
    ...
    abstract class f implements Runnable {
        ...
        /* renamed from: b  reason: collision with root package name */
        WeakReference<Context> f2138b = null;

        /* renamed from: c  reason: collision with root package name */
        private String f2139c;

        /* renamed from: d  reason: collision with root package name */
        private ScheduledExecutorService f2140d;

        /* renamed from: e  reason: collision with root package name */
        private AtomicInteger f2141e = new AtomicInteger(0);

        f(Context context, String str, ScheduledExecutorService scheduledExecutorService) {
            this.f2138b = new WeakReference<>(context);
            this.f2139c = str;
            if (scheduledExecutorService == null) {
                this.f2140d = b.a().f();
            } else {
                this.f2140d = scheduledExecutorService;
            }
        }
        ...
        public void run() {
            /*
                ...
                java.lang.String r1 = r13.f2139c
            ...
            L_0x000e:
                ...
                return
            L_0x0017:
                java.util.concurrent.atomic.AtomicInteger r1 = r13.f2141e
                r1.incrementAndGet()
                r1 = 0
                r2 = 0
                java.lang.ref.WeakReference<android.content.Context> r3 = r13.f2138b     // Catch:{ all -> 0x0212 }
                java.lang.Object r3 = r3.get()     // Catch:{ all -> 0x0212 }
                android.content.Context r3 = (android.content.Context) r3     // Catch:{ all -> 0x0212 }
                if (r3 != 0) goto L_0x002e
                java.util.concurrent.atomic.AtomicInteger r0 = r13.f2141e
                r0.decrementAndGet()
                return
            L_0x002e:
            ...
            L_0x006b:
                ...
                r9.append(r6)     // Catch:{ all -> 0x0212 }
                java.lang.String r6 = r13.f2139c     // Catch:{ all -> 0x0212 }
                r9.append(r6)     // Catch:{ all -> 0x0212 }
            ...
            L_0x01a5:
                ...
                java.util.concurrent.atomic.AtomicInteger r0 = r13.f2141e     // Catch:{ all -> 0x020f }
            ...
            L_0x0220:
                ...
                r1.disconnect()
            L_0x0231:
                java.util.concurrent.ScheduledExecutorService r0 = r13.f2140d
                r0.shutdown()
                return
            L_0x0237:
                r0 = move-exception
                java.util.concurrent.atomic.AtomicInteger r2 = r13.f2141e
                r2.decrementAndGet()
    ...
    class g extends f {
        ...
        public final void a(Map<String, String> map) {
            ...
            i.F.a(map);
            i.c0(this.f2138b.get(), "appsflyerConversionDataRequestRetries", 0);
        }
        ...
        public final void c(String str, int i) {
            i.F.d(str);
            if (i >= 400 && i < 500) {
                i.c0(this.f2138b.get(), "appsflyerConversionDataRequestRetries", i.M(this.f2138b.get()).getInt("appsflyerConversionDataRequestRetries", 0) + 1);
            }
        }
    }
        ...
        while (true) {
            ...
            if (i3 < length) {
                ...
                if (!linkedHashMap.containsKey(substring)) {
                    if (substring.equals(com.tempmail.m.c.f12927e)) {
                        str2 = "campaign";
    ...
    private void d0(Context context, String str, String str2, String str3, String str4, Intent intent, String str5) {
        ...
        if (z3) {
            ...
            this.f2118a = System.currentTimeMillis();
        }
    ...
    private void g0(java.net.URL r21, java.lang.String r22, java.lang.String r23, java.lang.ref.WeakReference<android.content.Context> r24, java.lang.String r25, boolean r26) throws java.io.IOException {
        ...
        L_0x001d:
            ...
            r1.f2119b = r14     // Catch:{ all -> 0x00b3 }
        ...
        L_0x011d:
            ...
            boolean r0 = r1.f2123f     // Catch:{ all -> 0x023e }
            if (r0 != 0) goto L_0x015d
    ...
    static /* synthetic */ void n0(i iVar, Context context, String str, String str2, String str3, String str4, boolean z2, boolean z3, Intent intent, String str5) {
        ...
        if (z5 && K(context)) {
            Map<String, String> map = iVar2.f2122e;
    ...
    static /* synthetic */ boolean q0(i iVar) {
        Map<String, String> map = iVar.f2122e;
    ...
    private boolean z() {
        if (this.f2118a > 0) {
            long currentTimeMillis = System.currentTimeMillis() - this.f2118a;
            ...
            if (currentTimeMillis < this.f2120c && !j()) {
                e.c(String.format(Locale.US, "Last Launch attempt: %s;\nLast successful Launch event: %s;\nThis launch is blocked: %s ms < %s ms", new Object[]{format, format2, Long.valueOf(currentTimeMillis), Long.valueOf(this.f2120c)}));
                return true;
            } else if (!j()) {
    ...
    public final java.util.Map<java.lang.String, java.lang.Object> R(android.content.Context r28, java.lang.String r29, java.lang.String r30, java.lang.String r31, java.lang.String r32, boolean r33, android.content.SharedPreferences r34, boolean r35, android.content.Intent r36, java.lang.String r37) {
        ...
        L_0x09d9:
            ...
            b.b.q r4 = b.b.q.a.f2165a     // Catch:{ all -> 0x0bb4 }
        ...
        L_0x0a57:
            b.b.r r4 = b.b.r.a.f2167a     // Catch:{ all -> 0x0bb4 }
    ...
    public final void x(Context context, String str, Map<String, Object> map) {
        ...
        if (context instanceof Activity) {
            ...
            a.b().f2066a = System.identityHashCode(activity);
            try {
