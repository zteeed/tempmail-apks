...
final class w implements SensorEventListener {
    ...
    private final float[][] f2185d = new float[2][];

    /* renamed from: e  reason: collision with root package name */
    private final long[] f2186e = new long[2];
    ...
    private w(int i, String str, String str2) {
        ...
        str2 = str2 == null ? "" : str2;
        this.f2184c = str2;
        this.f2187f = ((((i + 31) * 31) + this.f2183b.hashCode()) * 31) + str2.hashCode();
    }
    ...
    private boolean e(int i, String str, String str2) {
        return this.f2182a == i && this.f2183b.equals(str) && this.f2184c.equals(str2);
    }
    ...
    private Map<String, Object> h() {
        ...
        hashMap.put("sT", Integer.valueOf(this.f2182a));
        hashMap.put("sN", this.f2183b);
        hashMap.put("sV", this.f2184c);
        float[] fArr = this.f2185d[0];
        if (fArr != null) {
            hashMap.put("sVS", d(fArr));
        }
        float[] fArr2 = this.f2185d[1];
        if (fArr2 != null) {
    ...
    public final boolean equals(Object obj) {
        ...
        w wVar = (w) obj;
        return e(wVar.f2182a, wVar.f2183b, wVar.f2184c);
    }
        ...
        if (sensorEvent != null && sensorEvent.values != null) {
            ...
            if ((sensor == null || sensor.getName() == null || sensor.getVendor() == null) ? false : true) {
                ...
                if (e(type, name, vendor)) {
                    ...
                    float[][] fArr2 = this.f2185d;
                    float[] fArr3 = fArr2[0];
                    if (fArr3 == null) {
                        fArr2[0] = Arrays.copyOf(fArr, fArr.length);
                        this.f2186e[0] = currentTimeMillis;
                        return;
                    }
                    float[] fArr4 = fArr2[1];
                    if (fArr4 == null) {
                        float[] copyOf = Arrays.copyOf(fArr, fArr.length);
                        this.f2185d[1] = copyOf;
                        this.f2186e[1] = currentTimeMillis;
                        ...
                        if (c2 > this.g) {
                            this.f2185d[1] = Arrays.copyOf(fArr, fArr.length);
                            this.f2186e[1] = currentTimeMillis;
                            this.g = c2;
                        }
                    }
