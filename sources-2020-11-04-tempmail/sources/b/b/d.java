...
class d {
    ...
    private void c(String str) {
        ...
        try {
            ...
            synchronized (this.f2088a) {
                if (!this.f2089b.containsAlias(str)) {
                    if (Build.VERSION.SDK_INT >= 23) {
                        ...
                        algorithmParameterSpec = new KeyPairGeneratorSpec.Builder(this.f2090c).setAlias(str).setSubject(new X500Principal("CN=AndroidSDK, O=AppsFlyer")).setSerialNumber(BigInteger.ONE).setStartDate(instance.getTime()).setEndDate(instance2.getTime()).build();
                    }
    ...
    final void a() {
        /*
            ...
            java.lang.Object r1 = r4.f2088a
            monitor-enter(r1)
            int r2 = r4.f2092e     // Catch:{ all -> 0x004b }
            int r2 = r2 + 1
            r4.f2092e = r2     // Catch:{ all -> 0x004b }
            ...
            java.lang.Object r2 = r4.f2088a     // Catch:{ KeyStoreException -> 0x0027 }
            monitor-enter(r2)     // Catch:{ KeyStoreException -> 0x0027 }
            java.security.KeyStore r3 = r4.f2089b     // Catch:{ all -> 0x0024 }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x005b, code lost:
        r7.f2091d = r3[1].trim();
        r7.f2092e = java.lang.Integer.parseInt(r1[1].trim());
     */
    ...
    public final boolean d() {
        /*
            r7 = this;
            java.lang.Object r0 = r7.f2088a
            monitor-enter(r0)
            java.security.KeyStore r1 = r7.f2089b     // Catch:{ all -> 0x0091 }
            r2 = 1
            r3 = 0
            if (r1 == 0) goto L_0x008e
            java.security.KeyStore r1 = r7.f2089b     // Catch:{ all -> 0x0072 }
