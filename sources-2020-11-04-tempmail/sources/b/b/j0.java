...
final class j0 {
    ...
    static class a extends AsyncTask<Void, Void, String> {
        ...
        private final WeakReference<Context> f2150a;

        /* renamed from: b  reason: collision with root package name */
        private String f2151b;

        a(WeakReference<Context> weakReference) {
            this.f2150a = weakReference;
        }

        private String a() {
            try {
                if (this.f2151b != null) {
                    return j0.a(this.f2150a, this.f2151b);
                }
                return null;
            } catch (Throwable th) {
        ...
        public final /* synthetic */ void onPostExecute(Object obj) {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                if (g == null) {
                    j0.e(this.f2150a.get(), aVar);
                    return;
                }
                p.a.C0059a c2 = p.a.C0059a.c(g);
                if (c2.e(aVar)) {
                    j0.e(this.f2150a.get(), c2);
                }
            }
        }
        ...
        public final void onPreExecute() {
            super.onPreExecute();
            this.f2151b = j.b().g("gcmProjectNumber");
        }
    }
