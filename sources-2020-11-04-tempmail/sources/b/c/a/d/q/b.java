...
public class b {
    ...
    public final ColorStateList f2389b;

    /* renamed from: c  reason: collision with root package name */
    public final ColorStateList f2390c;

    /* renamed from: d  reason: collision with root package name */
    public final ColorStateList f2391d;
    ...
    class a extends f.a {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ TextPaint f2394a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ f.a f2395b;

        a(TextPaint textPaint, f.a aVar) {
            this.f2394a = textPaint;
            this.f2395b = aVar;
        }
        ...
        public void d(Typeface typeface) {
            b bVar = b.this;
            Typeface unused = bVar.n = Typeface.create(typeface, bVar.f2392e);
            b.this.i(this.f2394a, typeface);
            boolean unused2 = b.this.m = true;
            this.f2395b.d(typeface);
        }
    }

    public b(Context context, int i2) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(i2, k.TextAppearance);
        this.f2388a = obtainStyledAttributes.getDimension(k.TextAppearance_android_textSize, 0.0f);
        this.f2389b = a.a(context, obtainStyledAttributes, k.TextAppearance_android_textColor);
        this.f2390c = a.a(context, obtainStyledAttributes, k.TextAppearance_android_textColorHint);
        this.f2391d = a.a(context, obtainStyledAttributes, k.TextAppearance_android_textColorLink);
        this.f2392e = obtainStyledAttributes.getInt(k.TextAppearance_android_textStyle, 0);
        this.f2393f = obtainStyledAttributes.getInt(k.TextAppearance_android_typeface, 1);
    ...
    public void d() {
        if (this.n == null) {
            this.n = Typeface.create(this.g, this.f2392e);
        }
        if (this.n == null) {
            int i2 = this.f2393f;
            if (i2 == 1) {
            ...
            if (typeface != null) {
                this.n = Typeface.create(typeface, this.f2392e);
            }
        }
    }
    ...
    public Typeface e(Context context) {
        ...
        if (!context.isRestricted()) {
            try {
                ...
                this.n = b2;
                if (b2 != null) {
                    this.n = Typeface.create(b2, this.f2392e);
                }
    ...
    public void g(Context context, TextPaint textPaint, f.a aVar) {
        ...
        ColorStateList colorStateList = this.f2389b;
    ...
    public void i(TextPaint textPaint, Typeface typeface) {
        ...
        int i2 = (~typeface.getStyle()) & this.f2392e;
        textPaint.setFakeBoldText((i2 & 1) != 0);
        textPaint.setTextSkewX((i2 & 2) != 0 ? -0.25f : 0.0f);
        textPaint.setTextSize(this.f2388a);
    }
}
