...
final class f0 implements j {
    ...
    final class a extends d {
        ...
        /* renamed from: c  reason: collision with root package name */
        private final k f14586c;

        /* renamed from: d  reason: collision with root package name */
        private volatile AtomicInteger f14587d = new AtomicInteger(0);
        ...
        public void k() {
            ...
            L_0x002b:
                ...
                e.k r2 = r5.f14586c     // Catch:{ all -> 0x0053 }
            ...
            L_0x0058:
                ...
                goto L_0x0018
            L_0x007a:
                e.k r1 = r5.f14586c     // Catch:{ all -> 0x0053 }
                e.f0 r2 = e.f0.this     // Catch:{ all -> 0x0053 }
        ...
        public void m(ExecutorService executorService) {
            try {
                ...
                f0.this.f14582c.l(interruptedIOException);
                this.f14586c.onFailure(f0.this, interruptedIOException);
                f0.this.f14581b.k().f(this);
            } catch (Throwable th) {
                f0.this.f14581b.k().f(this);
                throw th;
            }
    ...
    static f0 e(d0 d0Var, g0 g0Var, boolean z) {
        ...
        f0Var.f14582c = new j(d0Var, f0Var);
        return f0Var;
    }

    /* renamed from: c */
    public f0 clone() {
        return e(this.f14581b, this.f14583d, this.f14584e);
    }
    ...
    public e.i0 d() throws java.io.IOException {
        ...
        L_0x004b:
            ...
            boolean r2 = r11.f14584e
            r0.<init>(r2)
            r1.add(r0)
            e.m0.h.g r10 = new e.m0.h.g
            okhttp3.internal.connection.j r2 = r11.f14582c
            r3 = 0
            r4 = 0
            e.g0 r5 = r11.f14583d
            e.d0 r0 = r11.f14581b
            ...
            r0 = 0
            r1 = 0
            e.g0 r2 = r11.f14583d     // Catch:{ IOException -> 0x0097, all -> 0x0095 }
            e.i0 r2 = r10.d(r2)     // Catch:{ IOException -> 0x0097, all -> 0x0095 }
            okhttp3.internal.connection.j r3 = r11.f14582c     // Catch:{ IOException -> 0x0097, all -> 0x0095 }
            boolean r3 = r3.i()     // Catch:{ IOException -> 0x0097, all -> 0x0095 }
            if (r3 != 0) goto L_0x008a
            okhttp3.internal.connection.j r0 = r11.f14582c
            r0.l(r1)
            return r2
        L_0x008a:
        ...
        L_0x0097:
            r0 = move-exception
            r2 = 1
            okhttp3.internal.connection.j r3 = r11.f14582c     // Catch:{ all -> 0x00a0 }
    ...
    public i0 execute() throws IOException {
        ...
        this.f14582c.b();
        try {
            this.f14581b.k().b(this);
            return d();
        } finally {
            this.f14581b.k().g(this);
        }
    }

    /* access modifiers changed from: package-private */
    public String f() {
        return this.f14583d.i().C();
    }
    ...
    public String g() {
        ...
        sb.append(this.f14584e ? "web socket" : "call");
        sb.append(" to ");
        sb.append(f());
        return sb.toString();
    }
