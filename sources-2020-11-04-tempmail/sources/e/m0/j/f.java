...
public class f {
    ...
    private static final f f14744a = i();

    /* renamed from: b  reason: collision with root package name */
    private static final Logger f14745b = Logger.getLogger(d0.class.getName());
    ...
    public Object m(String str) {
        if (f14745b.isLoggable(Level.FINE)) {
    ...
    public void p(int i, String str, @Nullable Throwable th) {
        f14745b.log(i == 5 ? Level.WARNING : Level.INFO, str, th);
    }
