...
final class e extends f {
    ...
    final Method f14742c;

    /* renamed from: d  reason: collision with root package name */
    final Method f14743d;

    e(Method method, Method method2) {
        this.f14742c = method;
        this.f14743d = method2;
    }
    ...
    public void g(SSLSocket sSLSocket, String str, List<e0> list) {
        try {
            ...
            this.f14742c.invoke(sSLParameters, new Object[]{b2.toArray(new String[b2.size()])});
    ...
    public String l(SSLSocket sSLSocket) {
        try {
            String str = (String) this.f14743d.invoke(sSLSocket, new Object[0]);
