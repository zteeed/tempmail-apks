...
public final class e {
    ...
    public static final byte[] f14667a = new byte[0];

    /* renamed from: b  reason: collision with root package name */
    public static final String[] f14668b = new String[0];

    /* renamed from: c  reason: collision with root package name */
    public static final y f14669c = y.g(new String[0]);

    /* renamed from: d  reason: collision with root package name */
    public static final j0 f14670d = j0.create((b0) null, f14667a);

    /* renamed from: e  reason: collision with root package name */
    private static final Options f14671e = Options.of(ByteString.decodeHex("efbbbf"), ByteString.decodeHex("feff"), ByteString.decodeHex("fffe"), ByteString.decodeHex("0000ffff"), ByteString.decodeHex("ffff0000"));

    /* renamed from: f  reason: collision with root package name */
    private static final Charset f14672f = Charset.forName("UTF-32BE");
    private static final Charset g = Charset.forName("UTF-32LE");
    public static final TimeZone h = TimeZone.getTimeZone("GMT");
    public static final Comparator<String> i = a.f14662b;
    private static final Method j;
    private static final Pattern k = Pattern.compile("([0-9a-fA-F]*:[0-9a-fA-F:.]*)|([\\d.]+)");

    static {
        Method method = null;
        h0.create((b0) null, f14667a);
        try {
    ...
    public static y J(List<b> list) {
        y.a aVar = new y.a();
        for (b next : list) {
            c.f14665a.b(aVar, next.f14875a.utf8(), next.f14876b.utf8());
        }
        return aVar.f();
    }
    ...
    public static Charset b(BufferedSource bufferedSource, Charset charset) throws IOException {
        int select = bufferedSource.select(f14671e);
        if (select == -1) {
            return charset;
        }
        if (select == 0) {
