...
public final class q {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        q qVar = (q) obj;
        if (qVar.f14760a.equals(this.f14760a) && qVar.f14761b.equals(this.f14761b) && qVar.f14763d.equals(this.f14763d) && qVar.f14764e.equals(this.f14764e) && qVar.f14762c == this.f14762c && qVar.f14765f == this.f14765f && qVar.g == this.g && qVar.h == this.h && qVar.i == this.i) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((((((((((((((((527 + this.f14760a.hashCode()) * 31) + this.f14761b.hashCode()) * 31) + this.f14763d.hashCode()) * 31) + this.f14764e.hashCode()) * 31) + ((int) (j2 ^ (j2 >>> 32)))) * 31) + (this.f14765f ^ true ? 1 : 0)) * 31) + (this.g ^ true ? 1 : 0)) * 31) + (this.h ^ true ? 1 : 0)) * 31) + (this.i ^ true ? 1 : 0);
    }
    ...
    public String j(boolean z) {
        ...
        if (this.h) {
            if (this.f14762c == Long.MIN_VALUE) {
                sb.append("; max-age=0");
            } else {
                sb.append("; expires=");
                sb.append(d.a(new Date(this.f14762c)));
            }
        }
        if (!this.i) {
            sb.append("; domain=");
