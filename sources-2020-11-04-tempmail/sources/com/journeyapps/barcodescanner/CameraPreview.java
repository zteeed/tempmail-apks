...
public class CameraPreview extends ViewGroup {
    ...
    private com.journeyapps.barcodescanner.q.b f12685b;

    /* renamed from: c  reason: collision with root package name */
    private WindowManager f12686c;
    /* access modifiers changed from: private */

    /* renamed from: d  reason: collision with root package name */
    public Handler f12687d;

    /* renamed from: e  reason: collision with root package name */
    private boolean f12688e = false;

    /* renamed from: f  reason: collision with root package name */
    private SurfaceView f12689f;
    ...
    class d implements l {
        ...
        public void a(int i) {
            CameraPreview.this.f12687d.postDelayed(new a(), 250);
        }
    }
    ...
    public void C() {
        ...
        if (nVar != null && this.o != null && (rect = this.p) != null) {
            if (this.f12689f == null || !nVar.equals(new n(rect.width(), this.p.height()))) {
            ...
            B(new com.journeyapps.barcodescanner.q.e(this.f12689f.getHolder()));
        }
    }
    ...
    private int getDisplayRotation() {
        return this.f12686c.getDefaultDisplay().getRotation();
    }
    ...
    private void j() {
        ...
        int i2 = nVar.f12747b;
        int i3 = nVar.f12748c;
        int i4 = nVar2.f12747b;
        int i5 = nVar2.f12748c;
        this.p = hVar.d(nVar);
    ...
    private void m(n nVar) {
        this.n = nVar;
        com.journeyapps.barcodescanner.q.b bVar = this.f12685b;
        if (bVar != null && bVar.l() == null) {
            h hVar = new h(getDisplayRotation(), nVar);
            this.l = hVar;
            hVar.e(getPreviewScalingStrategy());
            this.f12685b.s(this.l);
            this.f12685b.k();
            boolean z2 = this.w;
            if (z2) {
                this.f12685b.v(z2);
    ...
    private void p(Context context, AttributeSet attributeSet, int i2, int i3) {
        ...
        q(attributeSet);
        this.f12686c = (WindowManager) context.getSystemService("window");
        this.f12687d = new Handler(this.y);
        this.i = new m();
    }
    ...
    public Rect k(Rect rect, Rect rect2) {
        ...
        if (this.t != null) {
            rect3.inset(Math.max(0, (rect3.width() - this.t.f12747b) / 2), Math.max(0, (rect3.height() - this.t.f12748c) / 2));
            return rect3;
        }
    ...
    public Matrix l(n nVar, n nVar2) {
        float f2;
        float f3 = ((float) nVar.f12747b) / ((float) nVar.f12748c);
        float f4 = ((float) nVar2.f12747b) / ((float) nVar2.f12748c);
        float f5 = 1.0f;
        if (f3 < f4) {
            f5 = f4 / f3;
            f2 = 1.0f;
    ...
    public void onLayout(boolean z2, int i2, int i3, int i4, int i5) {
        m(new n(i4 - i2, i5 - i3));
        SurfaceView surfaceView = this.f12689f;
        if (surfaceView != null) {
            Rect rect = this.p;
            if (rect == null) {
    ...
    public void q(AttributeSet attributeSet) {
        ...
        this.f12688e = obtainStyledAttributes.getBoolean(k.zxing_camera_preview_zxing_use_texture_view, true);
    ...
    public void u() {
        ...
        if (bVar != null) {
            ...
            this.f12687d.sendEmptyMessage(g.zxing_camera_closed);
        }
        if (this.q == null && (surfaceView = this.f12689f) != null) {
