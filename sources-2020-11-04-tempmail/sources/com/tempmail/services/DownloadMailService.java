...
public class DownloadMailService extends d {
    ...
    class a extends com.tempmail.l.c<GetMailSourceWrapper> {
        ...
        public void onNext(GetMailSourceWrapper getMailSourceWrapper) {
            ...
            if (getMailSourceWrapper.getError() == null) {
                ...
                if (message != null) {
                    ...
                    q.e(downloadMailService2, e2, downloadMailService2.getString(R.string.app_name), u.a(DownloadMailService.this, R.string.message_mail_downloaded_new, com.tempmail.utils.y.b.f13138c));
                } else {
                    q.d(DownloadMailService.this, com.tempmail.utils.y.b.f13140e.intValue(), DownloadMailService.this.getString(R.string.app_name), DownloadMailService.this.getString(R.string.message_mail_downloaded_error));
                }
            } else {
                q.d(DownloadMailService.this, com.tempmail.utils.y.b.f13140e.intValue(), DownloadMailService.this.getString(R.string.app_name), DownloadMailService.this.getString(R.string.message_mail_downloaded_error));
            }
    ...
    class b extends com.tempmail.l.c<List<String>> {

        /* renamed from: f  reason: collision with root package name */
        final /* synthetic */ double f13001f;
        ...
        public void onNext(List<String> list) {
            ...
            if (list == null || list.size() <= 0) {
                ...
                File h2 = DownloadMailService.this.h(this.g + "_" + SimpleDateFormat.getDateTimeInstance().format(new Date(Long.valueOf((long) (this.f13001f * 1000.0d)).longValue())) + ".eml", list.get(0));
                DownloadMailService downloadMailService = DownloadMailService.this;
    ...
    public void d(String str) {
        ...
        this.f13024e.b((d.a.y.b) com.tempmail.l.b.c(this, false).d(new GetMailSourceBody(s.L(this), str)).subscribeOn(d.a.e0.a.b()).observeOn(d.a.x.b.a.a()).subscribeWith(new a(true, this)));
    }

    public void e(String str, String str2, double d2) {
        Toast.makeText(this, R.string.message_downloading_started, 1).show();
        this.f13024e.b((d.a.y.b) com.tempmail.l.b.f(this).i(str).subscribeOn(d.a.e0.a.b()).observeOn(d.a.x.b.a.a()).subscribeWith(new b(true, this, d2, str2)));
    }

    public void f() {
        c();
        q.d(this, com.tempmail.utils.y.b.f13140e.intValue(), getString(R.string.app_name), getString(R.string.message_network_error_message));
    }

    public void g() {
        c();
        q.d(this, com.tempmail.utils.y.b.f13140e.intValue(), getString(R.string.app_name), getString(R.string.message_mail_downloaded_error));
    }
