...
public class q {
    ...
    public static final Uri f13131a = RingtoneManager.getDefaultUri(2);

    /* renamed from: b  reason: collision with root package name */
    private static final String f13132b = q.class.getSimpleName();
    ...
    public static void b(Context context, long j, String str) {
        ...
        if (h > 0) {
            ...
            m.b(f13132b, new Date(j2).toString());
            c cVar = new c(context);
            long j3 = j;
            cVar.c(true, j2, c.f13107c, j3);
            cVar.c(true, j, c.f13108d, j3);
        }
    }
    ...
    public static void e(Context context, Uri uri, String str, String str2) {
        ...
        j.c(intent);
        dVar.i(j.l(0, 134217728));
        ((NotificationManager) context.getSystemService("notification")).notify(b.f13140e.intValue(), dVar.b());
    }

    public static void f(Context context) {
        if (s.x(context).booleanValue()) {
    ...
    public static void g(Context context, String str) {
        ...
        j.c(intent);
        dVar.i(j.l(0, 134217728));
        ((NotificationManager) context.getSystemService("notification")).notify(b.f13139d.intValue(), dVar.b());
    }
