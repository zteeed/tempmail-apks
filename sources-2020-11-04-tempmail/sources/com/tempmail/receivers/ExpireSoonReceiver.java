...
public class ExpireSoonReceiver extends BroadcastReceiver {
    ...
    public static final String f12986a = ExpireSoonReceiver.class.getSimpleName();

    public void onReceive(Context context, Intent intent) {
        m.b(f12986a, "onReceive");
        if (intent != null) {
            String action = intent.getAction();
            String str = f12986a;
            m.b(str, "action " + action);
            if (action.equals(c.f13107c)) {
            ...
            } else if (action.equals(c.f13108d)) {
