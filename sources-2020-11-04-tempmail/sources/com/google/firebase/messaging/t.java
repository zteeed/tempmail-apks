...
final class t implements Closeable {
    ...
    private final URL f11982b;

    /* renamed from: c  reason: collision with root package name */
    private Task<Bitmap> f11983c;

    /* renamed from: d  reason: collision with root package name */
    private volatile InputStream f11984d;
    ...
    private final byte[] f() throws IOException {
        URLConnection openConnection = this.f11982b.openConnection();
        if (openConnection.getContentLength() <= 1048576) {
            InputStream inputStream = openConnection.getInputStream();
            try {
                this.f11984d = inputStream;
    ...
    public final void d(Executor executor) {
        this.f11983c = Tasks.c(executor, new v(this));
    }
    ...
    public final Bitmap e() throws IOException {
        ...
        if (decodeByteArray != null) {
            if (Log.isLoggable("FirebaseMessaging", 3)) {
                String valueOf2 = String.valueOf(this.f11982b);
        ...
        String valueOf3 = String.valueOf(this.f11982b);
