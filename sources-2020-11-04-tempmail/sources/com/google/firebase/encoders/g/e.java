...
final class e implements c, com.google.firebase.encoders.e {
    ...
    private e f11670a = null;

    /* renamed from: b  reason: collision with root package name */
    private boolean f11671b = true;

    /* renamed from: c  reason: collision with root package name */
    private final JsonWriter f11672c;

    /* renamed from: d  reason: collision with root package name */
    private final Map<Class<?>, b<?>> f11673d;

    /* renamed from: e  reason: collision with root package name */
    private final Map<Class<?>, d<?>> f11674e;

    /* renamed from: f  reason: collision with root package name */
    private final b<Object> f11675f;
    private final boolean g;

    e(Writer writer, Map<Class<?>, b<?>> map, Map<Class<?>, d<?>> map2, b<Object> bVar, boolean z) {
        this.f11672c = new JsonWriter(writer);
        this.f11673d = map;
        this.f11674e = map2;
        this.f11675f = bVar;
        this.g = z;
    ...
    private e t(String str, Object obj) throws IOException, EncodingException {
        v();
        this.f11672c.name(str);
        if (obj == null) {
            this.f11672c.nullValue();
            return this;
        }
        i(obj, false);
        return this;
    ...
    private void v() throws IOException {
        if (this.f11671b) {
            ...
            if (eVar != null) {
                eVar.v();
                this.f11670a.f11671b = false;
                this.f11670a = null;
                this.f11672c.endObject();
                return;
            }
            return;
        }
    ...
    public e g(int i) throws IOException {
        v();
        this.f11672c.value((long) i);
        return this;
    }

    public e h(long j) throws IOException {
        v();
        this.f11672c.value(j);
        return this;
    }
    ...
    public e i(Object obj, boolean z) throws IOException {
        ...
        if (z && q(obj)) {
            ...
            this.f11672c.beginArray();
            if (obj instanceof int[]) {
                int[] iArr = (int[]) obj;
                int length = iArr.length;
                while (i < length) {
                    this.f11672c.value((long) iArr[i]);
                    i++;
                }
            ...
            b bVar = this.f11673d.get(obj.getClass());
            if (bVar != null) {
                s(bVar, obj, z);
                return this;
            }
            d dVar = this.f11674e.get(obj.getClass());
            if (dVar != null) {
    ...
    public e p(byte[] bArr) throws IOException {
        ...
        if (bArr == null) {
            ...
            this.f11672c.value(Base64.encodeToString(bArr, 2));
        }
        return this;
    }
