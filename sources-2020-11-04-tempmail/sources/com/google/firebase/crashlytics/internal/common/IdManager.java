...
public class IdManager implements InstallIdProvider {
    ...
    private final a firebaseInstallId;
    ...
    public synchronized String getCrashlyticsInstallId() {
        ...
        String h = this.firebaseInstallId.h();
        ...
        if (string == null) {
            ...
            if (string2 == null) {
                this.crashlyticsInstallId = createAndStoreIid(h, sharedPrefs);
            } else {
                this.crashlyticsInstallId = string2;
                migrateLegacyId(string2, h, sharedPrefs, legacySharedPrefs);
            }
            return this.crashlyticsInstallId;
        }
        if (string.equals(h)) {
