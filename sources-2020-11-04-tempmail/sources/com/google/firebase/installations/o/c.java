...
public class c {
    ...
    private static final Pattern f11896d = Pattern.compile("[0-9]+s");

    /* renamed from: e  reason: collision with root package name */
    private static final Charset f11897e = Charset.forName("UTF-8");

    /* renamed from: a  reason: collision with root package name */
    private final Context f11898a;

    /* renamed from: b  reason: collision with root package name */
    private final h f11899b;

    /* renamed from: c  reason: collision with root package name */
    private final com.google.firebase.g.c f11900c;
    ...
    private String f() {
        try {
            byte[] a2 = AndroidUtilsLight.a(this.f11898a, this.f11898a.getPackageName());
            if (a2 != null) {
                return Hex.b(a2, false);
            }
            Log.e("ContentValues", "Could not get fingerprint hash for package: " + this.f11898a.getPackageName());
            return null;
        } catch (PackageManager.NameNotFoundException e2) {
            Log.e("ContentValues", "No such package: " + this.f11898a.getPackageName(), e2);
            return null;
        }
    }
    ...
    private HttpURLConnection j(URL url, String str) throws IOException {
        ...
        httpURLConnection.addRequestProperty("X-Android-Package", this.f11898a.getPackageName());
        com.google.firebase.g.c cVar = this.f11900c;
        if (!(cVar == null || this.f11899b == null || (a2 = cVar.a("fire-installations-id")) == c.a.NONE)) {
            httpURLConnection.addRequestProperty("x-firebase-client", this.f11899b.a());
    ...
    static long k(String str) {
        Preconditions.b(f11896d.matcher(str).matches(), "Invalid Expiration Timestamp.");
    ...
    private d l(HttpURLConnection httpURLConnection) throws IOException {
        ...
        JsonReader jsonReader = new JsonReader(new InputStreamReader(inputStream, f11897e));
        e.a a2 = e.a();
        d.a a3 = d.a();
    ...
    private static java.lang.String m(java.net.HttpURLConnection r7) {
        ...
        L_0x0008:
            ...
            java.nio.charset.Charset r4 = f11897e
            r3.<init>(r0, r4)
            r2.<init>(r3)
        ...
        L_0x0052:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.installations.o.c.m(java.net.HttpURLConnection):java.lang.String");
    }
