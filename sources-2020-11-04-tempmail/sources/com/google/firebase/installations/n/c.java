...
public class c {
    ...
    private final File f11873a;

    /* renamed from: b  reason: collision with root package name */
    private final com.google.firebase.c f11874b;
    ...
    public c(com.google.firebase.c cVar) {
        ...
        this.f11873a = new File(filesDir, "PersistedInstallation." + cVar.k() + ".json");
        this.f11874b = cVar;
    }
    ...
    private org.json.JSONObject b() {
        /*
            ...
            java.io.File r4 = r6.f11873a     // Catch:{ IOException | JSONException -> 0x002d }
        ...
        L_0x002d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.installations.n.c.b():org.json.JSONObject");
    }
    ...
    public d a(d dVar) {
        try {
            ...
            File createTempFile = File.createTempFile("PersistedInstallation", "tmp", this.f11874b.g().getFilesDir());
            FileOutputStream fileOutputStream = new FileOutputStream(createTempFile);
            fileOutputStream.write(jSONObject.toString().getBytes("UTF-8"));
            fileOutputStream.close();
            if (createTempFile.renameTo(this.f11873a)) {
                return dVar;
            }
