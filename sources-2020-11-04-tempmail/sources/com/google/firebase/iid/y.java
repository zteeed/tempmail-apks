...
public final class y {
    ...
    private Boolean f11812b = null;

    /* renamed from: c  reason: collision with root package name */
    private Boolean f11813c = null;

    /* renamed from: d  reason: collision with root package name */
    private final Queue<Intent> f11814d = new ArrayDeque();
                ...
                if (context.getPackageName().equals(serviceInfo.packageName)) {
                    if (serviceInfo.name != null) {
                        if (serviceInfo.name.startsWith(".")) {
                            ...
                            this.f11811a = valueOf2.length() != 0 ? valueOf.concat(valueOf2) : new String(valueOf);
                        } else {
                            this.f11811a = serviceInfo.name;
                        }
                        return this.f11811a;
                    }
                }
    ...
    public final boolean c(Context context) {
        if (this.f11812b == null) {
            this.f11812b = Boolean.valueOf(context.checkCallingOrSelfPermission("android.permission.WAKE_LOCK") == 0);
        }
        if (!this.f11812b.booleanValue() && Log.isLoggable("FirebaseInstanceId", 3)) {
            Log.d("FirebaseInstanceId", "Missing Permission: android.permission.WAKE_LOCK this should normally be included by the manifest merger, but may needed to be manually added to your manifest");
        }
        return this.f11812b.booleanValue();
    }

    public final Intent e() {
        return this.f11814d.poll();
    }

    /* access modifiers changed from: package-private */
    public final boolean f(Context context) {
        if (this.f11813c == null) {
            this.f11813c = Boolean.valueOf(context.checkCallingOrSelfPermission("android.permission.ACCESS_NETWORK_STATE") == 0);
        }
        if (!this.f11812b.booleanValue() && Log.isLoggable("FirebaseInstanceId", 3)) {
            Log.d("FirebaseInstanceId", "Missing Permission: android.permission.ACCESS_NETWORK_STATE this should normally be included by the manifest merger, but may needed to be manually added to your manifest");
        }
        return this.f11813c.booleanValue();
    }
}
