...
public class ConfigFetchHttpClient {
    ...
    private JSONObject b(String str, String str2, Map<String, String> map) throws FirebaseRemoteConfigClientException {
        ...
        if (str != null) {
            ...
            hashMap.put("appId", this.f12013b);
            Locale locale = this.f12012a.getResources().getConfiguration().locale;
            ...
            try {
                PackageInfo packageInfo = this.f12012a.getPackageManager().getPackageInfo(this.f12012a.getPackageName(), 0);
                if (packageInfo != null) {
                    hashMap.put("appVersion", packageInfo.versionName);
                }
            } catch (PackageManager.NameNotFoundException unused) {
            }
            hashMap.put("packageName", this.f12012a.getPackageName());
    ...
    private String h() {
        try {
            byte[] a2 = AndroidUtilsLight.a(this.f12012a, this.f12012a.getPackageName());
            if (a2 != null) {
                return Hex.b(a2, false);
            }
            Log.e("FirebaseRemoteConfig", "Could not get fingerprint hash for package: " + this.f12012a.getPackageName());
            return null;
        } catch (PackageManager.NameNotFoundException e2) {
            Log.e("FirebaseRemoteConfig", "No such package: " + this.f12012a.getPackageName(), e2);
            return null;
        }
    }

    private void i(HttpURLConnection httpURLConnection) {
        httpURLConnection.setRequestProperty("X-Goog-Api-Key", this.f12014c);
        httpURLConnection.setRequestProperty("X-Android-Package", this.f12012a.getPackageName());
    ...
    private void l(HttpURLConnection httpURLConnection, String str, Map<String, String> map) {
        ...
        httpURLConnection.setConnectTimeout((int) TimeUnit.SECONDS.toMillis(this.f12017f));
    ...
    public HttpURLConnection c() throws FirebaseRemoteConfigException {
        try {
            return (HttpURLConnection) new URL(g(this.f12015d, this.f12016e)).openConnection();
