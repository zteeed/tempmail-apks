...
public class n {
    ...
    private static final Map<String, n> f12066c = new HashMap();
    ...
    public static synchronized n c(Context context, String str) {
        ...
        synchronized (n.class) {
            if (!f12066c.containsKey(str)) {
                f12066c.put(str, new n(context, str));
            }
            nVar = f12066c.get(str);
        }
        return nVar;
    }

    public synchronized Void a() {
        this.f12067a.deleteFile(this.f12068b);
        return null;
    }
    ...
    public synchronized com.google.firebase.remoteconfig.internal.f d() throws java.io.IOException {
        /*
            ...
            monitor-enter(r6)
            r0 = 0
            android.content.Context r1 = r6.f12067a     // Catch:{ FileNotFoundException | JSONException -> 0x0037, all -> 0x002d }
            java.lang.String r2 = r6.f12068b     // Catch:{ FileNotFoundException | JSONException -> 0x0037, all -> 0x002d }
    ...
    public synchronized Void e(f fVar) throws IOException {
        FileOutputStream openFileOutput = this.f12067a.openFileOutput(this.f12068b, 0);
        try {
