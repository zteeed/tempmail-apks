...
public final class e extends a {
    ...
    private final GoogleApi<Api.ApiOptions.NoOptions> f11647a;

    /* renamed from: b  reason: collision with root package name */
    private final com.google.firebase.analytics.a.a f11648b;
    ...
    public final Task<b> a(Intent intent) {
        Task<TResult> c2 = this.f11647a.c(new j(this.f11648b, intent.getDataString()));
