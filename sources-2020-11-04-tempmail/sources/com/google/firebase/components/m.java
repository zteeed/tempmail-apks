...
class m {
    ...
    private static class b {
        ...
        private final Set<b> f11614b = new HashSet();

        /* renamed from: c  reason: collision with root package name */
        private final Set<b> f11615c = new HashSet();
    ...
    private static class c {
        ...
        public boolean equals(Object obj) {
            ...
            c cVar = (c) obj;
            if (!cVar.f11616a.equals(this.f11616a) || cVar.f11617b != this.f11617b) {
                return false;
            }
            return true;
        }
        ...
        public int hashCode() {
            return ((this.f11616a.hashCode() ^ 1000003) * 1000003) ^ Boolean.valueOf(this.f11617b).hashCode();
        }
