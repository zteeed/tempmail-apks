...
class p implements d, c {
    ...
    private final Map<Class<?>, ConcurrentHashMap<b<Object>, Executor>> f11623a = new HashMap();

    /* renamed from: b  reason: collision with root package name */
    private Queue<a<?>> f11624b = new ArrayDeque();
    ...
    public synchronized <T> void b(Class<T> cls, Executor executor, b<? super T> bVar) {
        ...
        r.b(bVar);
        r.b(executor);
        if (!this.f11623a.containsKey(cls)) {
            this.f11623a.put(cls, new ConcurrentHashMap());
        }
        this.f11623a.get(cls).put(bVar, executor);
    }
    ...
    public void f(com.google.firebase.f.a<?> r4) {
        /*
            ...
            monitor-enter(r3)
            java.util.Queue<com.google.firebase.f.a<?>> r0 = r3.f11624b     // Catch:{ all -> 0x0033 }
