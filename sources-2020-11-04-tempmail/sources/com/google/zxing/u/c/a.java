...
final class a {
    ...
    a(b bVar) throws FormatException {
        ...
        b a2 = a(bVar);
        this.f12360a = a2;
        this.f12361b = new b(a2.n(), this.f12360a.j());
    }

    private b a(b bVar) {
        int f2 = this.f12362c.f();
        int e2 = this.f12362c.e();
        if (bVar.j() == f2) {
            int c2 = this.f12362c.c();
            int b2 = this.f12362c.b();
            int i = f2 / c2;
            int i2 = e2 / b2;
    ...
    public byte[] c() throws FormatException {
        byte[] bArr = new byte[this.f12362c.g()];
        int j = this.f12360a.j();
        int n = this.f12360a.n();
        int i = 0;
        boolean z = false;
        int i2 = 0;
        boolean z2 = false;
        ...
        while (true) {
            if (i3 == j && i == 0 && !z) {
                ...
                if (i3 == i4 && i == 0 && (n & 3) != 0 && !z2) {
                    ...
                    do {
                        if (i3 < j && i >= 0 && !this.f12361b.f(i, i3)) {
                    ...
                    int i6 = i + 3;
                    do {
                        if (i5 >= 0 && i6 < n && !this.f12361b.f(i6, i5)) {
