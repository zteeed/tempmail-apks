...
public final class l {
    ...
    private static final String f12350a;

    /* renamed from: b  reason: collision with root package name */
    private static final boolean f12351b;

    static {
        String name = Charset.defaultCharset().name();
        f12350a = name;
        f12351b = "SJIS".equalsIgnoreCase(name) || "EUC_JP".equalsIgnoreCase(f12350a);
    }
