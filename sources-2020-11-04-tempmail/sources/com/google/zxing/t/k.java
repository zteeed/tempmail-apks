...
public final class k {
    ...
    private final float f12344a;

    /* renamed from: b  reason: collision with root package name */
    private final float f12345b;
    ...
    public k a() {
        float f2 = this.f12348e;
        float f3 = this.i;
        float f4 = this.f12349f;
        float f5 = this.h;
        float f6 = (f2 * f3) - (f4 * f5);
        float f7 = this.g;
        float f8 = this.f12347d;
        float f9 = (f4 * f7) - (f8 * f3);
        float f10 = (f8 * f5) - (f2 * f7);
        float f11 = this.f12346c;
        float f12 = this.f12345b;
        float f13 = (f11 * f5) - (f12 * f3);
        float f14 = this.f12344a;
    ...
    public k e(k kVar) {
        k kVar2 = kVar;
        float f2 = this.f12344a;
        float f3 = kVar2.f12344a;
        float f4 = this.f12347d;
        float f5 = kVar2.f12345b;
        float f6 = this.g;
        float f7 = kVar2.f12346c;
        float f8 = (f2 * f3) + (f4 * f5) + (f6 * f7);
        float f9 = kVar2.f12347d;
        float f10 = kVar2.f12348e;
        float f11 = kVar2.f12349f;
        float f12 = (f2 * f9) + (f4 * f10) + (f6 * f11);
        float f13 = kVar2.g;
        float f14 = kVar2.h;
        float f15 = kVar2.i;
        float f16 = (f2 * f13) + (f4 * f14) + (f6 * f15);
        float f17 = this.f12345b;
        float f18 = f16;
        float f19 = this.f12348e;
        float f20 = f12;
        float f21 = this.h;
        float f22 = (f17 * f3) + (f19 * f5) + (f21 * f7);
        float f23 = (f21 * f15) + (f17 * f13) + (f19 * f14);
        float f24 = this.f12346c;
        float f25 = this.f12349f;
    ...
    public void f(float[] fArr) {
        ...
        float f2 = this.f12344a;
        float f3 = this.f12345b;
        float f4 = this.f12346c;
        float f5 = this.f12347d;
        float f6 = this.f12348e;
        float f7 = this.f12349f;
        float f8 = this.g;
        float f9 = this.h;
        float f10 = this.i;
