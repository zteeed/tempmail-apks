...
public class h extends b {
    ...
    private static final byte[] f12339d = new byte[0];

    /* renamed from: b  reason: collision with root package name */
    private byte[] f12340b = f12339d;

    /* renamed from: c  reason: collision with root package name */
    private final int[] f12341c = new int[32];
    ...
    private void h(int i) {
        if (this.f12340b.length < i) {
            this.f12340b = new byte[i];
        }
    ...
    public b b() throws NotFoundException {
        ...
        for (int i = 1; i < 5; i++) {
            byte[] c2 = e2.c((a2 * i) / 5, this.f12340b);
            int i2 = (d2 << 2) / 5;
