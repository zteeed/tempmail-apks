...
public abstract class i {
    ...
    private static i f12342a = new f();
    ...
    protected static void a(com.google.zxing.t.b r9, float[] r10) throws com.google.zxing.NotFoundException {
        /*
            int r0 = r9.n()
            int r9 = r9.j()
            r1 = 0
        ...
        L_0x0085:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.t.i.a(com.google.zxing.t.b, float[]):void");
    }
    ...
    public abstract b c(b bVar, int i, int i2, float f2, float f3, float f4, float f5, float f6, float f7, float f8, float f9, float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17) throws NotFoundException;

    public abstract b d(b bVar, int i, int i2, k kVar) throws NotFoundException;
}
