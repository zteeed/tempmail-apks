...
final class f {
    ...
    static String a(CharSequence charSequence, int i) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            while (i3 > 0) {
                cArr[i3] = (char) ((cArr[i3 - 1] + (929 - ((f12596a[i][i3] * charAt) % 929))) % 929);
                i3--;
            }
            cArr[0] = (char) ((929 - ((charAt * f12596a[i][0]) % 929)) % 929);
        }
