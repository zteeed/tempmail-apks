...
class g {
    ...
    private final d[] f12556b;

    g(c cVar) {
        this.f12555a = new c(cVar);
        this.f12556b = new d[((cVar.e() - cVar.g()) + 1)];
    }
    ...
    public final d c(int i) {
        ...
        for (int i2 = 1; i2 < 5; i2++) {
            int e2 = e(i) - i2;
            if (e2 >= 0 && (dVar2 = this.f12556b[e2]) != null) {
                return dVar2;
            }
            int e3 = e(i) + i2;
            d[] dVarArr = this.f12556b;
    ...
    public final int e(int i) {
        return i - this.f12555a.g();
    }

    /* access modifiers changed from: package-private */
    public final void f(int i, d dVar) {
        this.f12556b[e(i)] = dVar;
    }
    ...
    public java.lang.String toString() {
        /*
            ...
            r0.<init>()
            com.google.zxing.x.e.d[] r1 = r11.f12556b     // Catch:{ all -> 0x0054 }
