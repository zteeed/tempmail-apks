...
public final class d {
    ...
    private static final String f12306a = "d";
                ...
                if (extras.containsKey(name)) {
                    if (dVar.f().equals(Void.class)) {
                        ...
                        if (dVar.f().isInstance(obj)) {
                            ...
                            Log.w(f12306a, "Ignoring hint " + dVar + " because it is not assignable from " + obj);
                        }
                    }
                }
            }
        }
        Log.i(f12306a, "Hints from the Intent: " + enumMap);
        return enumMap;
    }
}
