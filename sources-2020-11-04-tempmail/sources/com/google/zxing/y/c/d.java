...
final class d {
    ...
    private static final char[] f12616a = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ $%*+-./:".toCharArray();
    ...
    static e a(byte[] bArr, j jVar, f fVar, Map<com.google.zxing.d, ?> map) throws FormatException {
        ...
        while (true) {
            try {
                ...
                h hVar2 = f2;
                switch (a.f12617a[hVar2.ordinal()]) {
                    case 5:
                        break;
                    case 6:
                    case 7:
                    ...
                    default:
                        ...
                        int i4 = a.f12617a[hVar2.ordinal()];
                        if (i4 != i) {
                            if (i4 != 2) {
                                if (i4 == 3) {
                                    hVar = hVar2;
