...
final class a {
    ...
    private int a(int i, int i2, int i3) {
        return this.f12608d ? this.f12605a.f(i2, i) : this.f12605a.f(i, i2) ? (i3 << 1) | 1 : i3 << 1;
    }

    /* access modifiers changed from: package-private */
    public void b() {
        int i = 0;
        while (i < this.f12605a.n()) {
            int i2 = i + 1;
            for (int i3 = i2; i3 < this.f12605a.j(); i3++) {
                if (this.f12605a.f(i, i3) != this.f12605a.f(i3, i)) {
                    this.f12605a.e(i3, i);
                    this.f12605a.e(i, i3);
                }
            }
    ...
    public byte[] c() throws FormatException {
        ...
        int j = this.f12605a.j();
        cVar.g(this.f12605a, j);
        b a2 = e2.a();
    ...
    public void f() {
        if (this.f12607c != null) {
            c.values()[this.f12607c.c()].g(this.f12605a, this.f12605a.j());
        }
    }
