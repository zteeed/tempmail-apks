...
final class b {
    ...
    private final com.google.zxing.t.b f12644a;

    /* renamed from: b  reason: collision with root package name */
    private final List<a> f12645b = new ArrayList(5);
    ...
    private float b(int i2, int i3, int i4, int i5) {
        com.google.zxing.t.b bVar = this.f12644a;
        int j = bVar.j();
        int[] iArr = this.h;
        iArr[0] = 0;
        iArr[1] = 0;
    ...
    private a e(int[] iArr, int i2, int i3) {
        ...
        for (a next : this.f12645b) {
            if (next.f(f2, b2, a2)) {
                return next.g(b2, a2, f2);
            }
        }
        a aVar = new a(a2, b2, f2);
        this.f12645b.add(aVar);
        p pVar = this.i;
        if (pVar == null) {
            return null;
        }
    ...
    public a c() throws NotFoundException {
        ...
        int i2 = this.f12646c;
        int i3 = this.f12649f;
        int i4 = this.f12648e + i2;
        int i5 = this.f12647d + (i3 / 2);
        int[] iArr = new int[3];
        for (int i6 = 0; i6 < i3; i6++) {
            ...
            iArr[2] = 0;
            int i8 = i2;
            while (i8 < i4 && !this.f12644a.f(i8, i7)) {
                i8++;
            }
            int i9 = 0;
            while (i8 < i4) {
                if (!this.f12644a.f(i8, i7)) {
                    if (i9 == 1) {
                        i9++;
                    }
                    iArr[i9] = iArr[i9] + 1;
