...
public class e {
    ...
    private final com.google.zxing.t.b f12654a;

    /* renamed from: b  reason: collision with root package name */
    private final List<d> f12655b = new ArrayList();

    /* renamed from: c  reason: collision with root package name */
    private boolean f12656c;

    /* renamed from: d  reason: collision with root package name */
    private final int[] f12657d = new int[5];

    /* renamed from: e  reason: collision with root package name */
    private final p f12658e;
    ...
    private static final class b implements Serializable, Comparator<d> {
        ...
        public int compare(d dVar, d dVar2) {
            ...
            return compare == 0 ? Float.compare(Math.abs(dVar.i() - this.f12659b), Math.abs(dVar2.i() - this.f12659b)) : compare;
        }
    ...
    private static final class c implements Serializable, Comparator<d> {
        ...
        /* renamed from: a */
        public int compare(d dVar, d dVar2) {
            return Float.compare(Math.abs(dVar2.i() - this.f12660b), Math.abs(dVar.i() - this.f12660b));
        }
    ...
    private boolean c(int i, int i2) {
        ...
        int[] j = j();
        int i6 = 0;
        while (i >= i6 && i2 >= i6 && this.f12654a.f(i2 - i6, i - i6)) {
            j[2] = j[2] + 1;
            i6++;
        }
        if (j[2] == 0) {
        ...
        int j2 = this.f12654a.j();
        int n = this.f12654a.n();
        int i7 = 1;
        while (true) {
            int i8 = i + i7;
            if (i8 < j2 && (i5 = i2 + i7) < n && this.f12654a.f(i5, i8)) {
                j[2] = j[2] + 1;
                i7++;
            }
        }
        while (true) {
            int i9 = i + i7;
            if (i9 < j2 && (i4 = i2 + i7) < n && !this.f12654a.f(i4, i9)) {
                j[3] = j[3] + 1;
                i7++;
            }
        }
        ...
        while (true) {
            int i10 = i + i7;
            if (i10 < j2 && (i3 = i2 + i7) < n && this.f12654a.f(i3, i10)) {
                j[4] = j[4] + 1;
                i7++;
            }
        }
    ...
    private float d(int i, int i2, int i3, int i4) {
        com.google.zxing.t.b bVar = this.f12654a;
        int n = bVar.n();
        int[] j = j();
        int i5 = i;
    ...
    private d[] m() throws NotFoundException {
        ...
        if (size >= 3) {
            ...
            if (size > 3) {
                ...
                Collections.sort(this.f12655b, new c(f6));
                float max = Math.max(0.2f * f6, sqrt);
                int i3 = 0;
                while (i3 < this.f12655b.size() && this.f12655b.size() > 3) {
                    if (Math.abs(this.f12655b.get(i3).i() - f6) > max) {
                        this.f12655b.remove(i3);
                        i3--;
                    }
                    i3++;
                }
            }
            if (this.f12655b.size() > 3) {
                for (d i4 : this.f12655b) {
                    f2 += i4.i();
                }
                Collections.sort(this.f12655b, new b(f2 / ((float) this.f12655b.size())));
                List<d> list = this.f12655b;
                list.subList(3, list.size()).clear();
            }
            return new d[]{this.f12655b.get(0), this.f12655b.get(1), this.f12655b.get(2)};
        }
    ...
    public final boolean k(int[] iArr, int i, int i2) {
        ...
        if (!Float.isNaN(e2)) {
            ...
            if (!Float.isNaN(d2) && c(i4, (int) d2)) {
                ...
                int i5 = 0;
                while (true) {
                    if (i5 >= this.f12655b.size()) {
                        break;
                    }
                    d dVar = this.f12655b.get(i5);
                    if (dVar.f(f2, e2, d2)) {
                        this.f12655b.set(i5, dVar.g(e2, d2, f2));
                        z = true;
                        break;
                    }
                    i5++;
