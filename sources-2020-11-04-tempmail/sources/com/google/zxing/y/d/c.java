...
public class c {
    ...
    private float j(int i, int i2, int i3, int i4) {
        ...
        if (i6 < 0) {
            ...
            i6 = 0;
        } else if (i6 >= this.f12650a.n()) {
            f2 = ((float) ((this.f12650a.n() - 1) - i)) / ((float) (i6 - i));
            i6 = this.f12650a.n() - 1;
        } else {
            f2 = 1.0f;
        }
        ...
        if (i8 < 0) {
            f3 = f4 / ((float) (i2 - i8));
        } else if (i8 >= this.f12650a.j()) {
            f3 = ((float) ((this.f12650a.j() - 1) - i2)) / ((float) (i8 - i2));
            i7 = this.f12650a.j() - 1;
        } else {
            i7 = i8;
            f3 = 1.0f;
    ...
    public final g e(Map<d, ?> map) throws NotFoundException, FormatException {
        ...
        this.f12651b = pVar;
        return g(new e(this.f12650a, pVar).f(map));
    }
    ...
    public final a f(float f2, int i, int i2, float f3) throws NotFoundException {
        ...
        int min = Math.min(this.f12650a.n() - 1, i + i3) - max;
        float f4 = 3.0f * f2;
        if (((float) min) >= f4) {
            int max2 = Math.max(0, i2 - i3);
            int min2 = Math.min(this.f12650a.j() - 1, i2 + i3) - max2;
            if (((float) min2) >= f4) {
                return new b(this.f12650a, max, max2, min, min2, f2, this.f12651b).c();
            }
            throw NotFoundException.a();
        }
        throw NotFoundException.a();
    ...
    public final g g(f fVar) throws NotFoundException, FormatException {
        ...
        if (a3 >= 1.0f) {
            ...
            b h = h(this.f12650a, d(b2, c2, a2, aVar, c3), c3);
            if (aVar == null) {
