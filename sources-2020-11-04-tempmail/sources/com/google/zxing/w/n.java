...
public final class n extends r {
    ...
    private static final int[] f12496b = {6, 8, 10, 12, 14};

    /* renamed from: c  reason: collision with root package name */
    private static final int[] f12497c = {1, 1, 1, 1};

    /* renamed from: d  reason: collision with root package name */
    private static final int[][] f12498d = {new int[]{1, 1, 2}, new int[]{1, 1, 3}};

    /* renamed from: e  reason: collision with root package name */
    private static final int[][] f12499e = {new int[]{1, 1, 2, 2, 1}, new int[]{2, 1, 1, 1, 2}, new int[]{1, 2, 1, 1, 2}, new int[]{2, 2, 1, 1, 1}, new int[]{1, 1, 2, 1, 2}, new int[]{2, 1, 2, 1, 1}, new int[]{1, 2, 2, 1, 1}, new int[]{1, 1, 1, 2, 2}, new int[]{2, 1, 1, 2, 1}, new int[]{1, 2, 1, 2, 1}, new int[]{1, 1, 3, 3, 1}, new int[]{3, 1, 1, 1, 3}, new int[]{1, 3, 1, 1, 3}, new int[]{3, 3, 1, 1, 1}, new int[]{1, 1, 3, 1, 3}, new int[]{3, 1, 3, 1, 1}, new int[]{1, 3, 3, 1, 1}, new int[]{1, 1, 1, 3, 3}, new int[]{3, 1, 1, 3, 1}, new int[]{1, 3, 1, 3, 1}};

    /* renamed from: a  reason: collision with root package name */
    private int f12500a = -1;

    private static int i(int[] iArr) throws NotFoundException {
        int length = f12499e.length;
        float f2 = 0.38f;
        int i = -1;
        for (int i2 = 0; i2 < length; i2++) {
            float f3 = r.f(iArr, f12499e[i2], 0.5f);
            if (f3 < f2) {
                i = i2;
                f2 = f3;
            } else if (f3 == f2) {
    ...
    private int[] l(a aVar) throws NotFoundException {
        int[] m = m(aVar, n(aVar), f12497c);
        this.f12500a = (m[1] - m[0]) / 4;
        o(aVar, m[0]);
        return m;
    }
