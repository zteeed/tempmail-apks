    ...
    public boolean[] c(String str) {
        ...
        if (length <= 80) {
            ...
            for (int i = 0; i < length; i++) {
                h(g.f12490d["0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%abcd*".indexOf(str.charAt(i))], iArr);
                f2 += f(zArr, f2, iArr);
            }
            int g = g(str, 20);
            h(g.f12490d[g], iArr);
            int f3 = f2 + f(zArr, f2, iArr);
            h(g.f12490d[g(str + "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%abcd*".charAt(g), 15)], iArr);
