...
public final class g extends r {
    ...
    private static final char[] f12489c = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ-. $/+%abcd*".toCharArray();

    /* renamed from: d  reason: collision with root package name */
    static final int[] f12490d;

    /* renamed from: e  reason: collision with root package name */
    private static final int f12491e;

    /* renamed from: a  reason: collision with root package name */
    private final StringBuilder f12492a = new StringBuilder(20);

    /* renamed from: b  reason: collision with root package name */
    private final int[] f12493b = new int[6];
    ...
    private static void j(CharSequence charSequence, int i, int i2) throws ChecksumException {
        ...
        if (charSequence.charAt(i) != f12489c[i3 % 47]) {
    ...
    private int[] l(a aVar) throws NotFoundException {
        int n = aVar.n();
        int k = aVar.k(0);
        Arrays.fill(this.f12493b, 0);
        int[] iArr = this.f12493b;
