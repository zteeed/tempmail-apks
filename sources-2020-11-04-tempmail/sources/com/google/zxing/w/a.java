...
public final class a extends r {
    ...
    static final char[] f12422d = "0123456789-$:/.+ABCD".toCharArray();

    /* renamed from: e  reason: collision with root package name */
    static final int[] f12423e = {3, 6, 9, 96, 18, 66, 33, 36, 48, 72, 12, 24, 69, 81, 84, 21, 26, 41, 11, 14};

    /* renamed from: f  reason: collision with root package name */
    private static final char[] f12424f = {'A', 'B', 'C', 'D'};

    /* renamed from: a  reason: collision with root package name */
    private final StringBuilder f12425a = new StringBuilder(20);

    /* renamed from: b  reason: collision with root package name */
    private int[] f12426b = new int[80];
    ...
    private int k() throws NotFoundException {
        for (int i = 1; i < this.f12427c; i += 2) {
            int m = m(i);
            if (m != -1 && i(f12424f, f12422d[m])) {
                int i2 = 0;
                for (int i3 = i; i3 < i + 7; i3++) {
                    i2 += this.f12426b[i3];
                }
                if (i == 1 || this.f12426b[i - 1] >= i2 / 2) {
                    return i;
                }
            }
        }
    ...
    private void n(int i) throws NotFoundException {
        int[] iArr = {0, 0, 0, 0};
        int[] iArr2 = {0, 0, 0, 0};
        int length = this.f12425a.length() - 1;
        int i2 = 0;
        int i3 = i;
        int i4 = 0;
        while (true) {
            int i5 = f12423e[this.f12425a.charAt(i4)];
            for (int i6 = 6; i6 >= 0; i6--) {
                int i7 = (i6 & 1) + ((i5 & 1) << 1);
                iArr[i7] = iArr[i7] + this.f12426b[i3 + i6];
                iArr2[i7] = iArr2[i7] + 1;
                i5 >>= 1;
            }
            if (i4 >= length) {
        ...
        loop3:
        while (true) {
            int i10 = f12423e[this.f12425a.charAt(i2)];
            int i11 = 6;
            while (i11 >= 0) {
                int i12 = (i11 & 1) + ((i10 & 1) << 1);
                float f2 = (float) this.f12426b[i + i11];
    ...
    public com.google.zxing.m d(int r11, com.google.zxing.t.a r12, java.util.Map<com.google.zxing.d, ?> r13) throws com.google.zxing.NotFoundException {
        /*
            ...
            r10.l(r12)
            int r12 = r10.k()
            java.lang.StringBuilder r0 = r10.f12425a
            r0.setLength(r1)
            r0 = r12
        L_0x0013:
            int r2 = r10.m(r0)
            ...
            java.lang.StringBuilder r4 = r10.f12425a
            char r5 = (char) r2
            r4.append(r5)
            int r0 = r0 + 8
            java.lang.StringBuilder r4 = r10.f12425a
        ...
        L_0x005d:
            ...
            r0 = 0
        L_0x0061:
            java.lang.StringBuilder r2 = r10.f12425a
            int r2 = r2.length()
        ...
        L_0x00ad:
            java.lang.StringBuilder r13 = r10.f12425a
            int r0 = r13.length()
            int r0 = r0 - r5
            r13.deleteCharAt(r0)
            java.lang.StringBuilder r13 = r10.f12425a
