...
final class w {
    ...
    private static final int[] f12509c = {24, 20, 18, 17, 12, 6, 3, 10, 9, 5};

    /* renamed from: a  reason: collision with root package name */
    private final int[] f12510a = new int[4];

    /* renamed from: b  reason: collision with root package name */
    private final StringBuilder f12511b = new StringBuilder();

    w() {
    }

    private int a(a aVar, int[] iArr, StringBuilder sb) throws NotFoundException {
        int[] iArr2 = this.f12510a;
        iArr2[0] = 0;
        iArr2[1] = 0;
        iArr2[2] = 0;
        iArr2[3] = 0;
