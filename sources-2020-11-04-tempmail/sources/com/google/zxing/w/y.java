...
public abstract class y extends r {
    ...
    static final int[] f12515d = {1, 1, 1};

    /* renamed from: e  reason: collision with root package name */
    static final int[] f12516e = {1, 1, 1, 1, 1};

    /* renamed from: f  reason: collision with root package name */
    static final int[] f12517f = {1, 1, 1, 1, 1, 1};
    static final int[][] g;
    static final int[][] h;

    /* renamed from: a  reason: collision with root package name */
    private final StringBuilder f12518a = new StringBuilder(20);

    /* renamed from: b  reason: collision with root package name */
    private final x f12519b = new x();

    /* renamed from: c  reason: collision with root package name */
    private final m f12520c = new m();
    ...
    static int[] q(a aVar) throws NotFoundException {
        int[] iArr = new int[f12515d.length];
        int[] iArr2 = null;
        boolean z = false;
        int i = 0;
        while (!z) {
            Arrays.fill(iArr, 0, f12515d.length, 0);
            iArr2 = p(aVar, i, false, f12515d, iArr);
            int i2 = iArr2[0];
            int i3 = iArr2[1];
            int i4 = i2 - (i3 - i2);
            if (i4 >= 0) {
    ...
    public m n(int i, a aVar, int[] iArr, Map<d, ?> map) throws NotFoundException, ChecksumException, FormatException {
        ...
        if (sb2.length() < 8) {
            ...
            try {
                m a2 = this.f12519b.a(i, aVar, l[1]);
            ...
            if ((r == com.google.zxing.a.EAN_13 || r == com.google.zxing.a.UPC_A) && (c2 = this.f12520c.c(sb2)) != null) {
