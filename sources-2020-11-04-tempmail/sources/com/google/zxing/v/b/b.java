...
final class b {
    ...
    private static String h(byte[] bArr) {
        return String.valueOf(new char[]{f12420a[0].charAt(d(bArr, new byte[]{39, 40, 41, 42, 31, 32})), f12420a[0].charAt(d(bArr, new byte[]{33, 34, 35, 36, 25, 26})), f12420a[0].charAt(d(bArr, new byte[]{27, 28, 29, 30, 19, 20})), f12420a[0].charAt(d(bArr, new byte[]{21, 22, 23, 24, 13, 14})), f12420a[0].charAt(d(bArr, new byte[]{15, 16, 17, 18, 7, 8})), f12420a[0].charAt(d(bArr, new byte[]{9, 10, 11, 12, 1, 2}))});
    }
