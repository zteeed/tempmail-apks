...
final class h<FieldDescriptorType extends b<FieldDescriptorType>> {
    ...
    private final r<FieldDescriptorType, Object> f12121a = r.o(16);
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0078:
                int[] r9 = f12125b     // Catch:{ NoSuchFieldError -> 0x0084 }
            ...
            L_0x0084:
                int[] r9 = f12125b     // Catch:{ NoSuchFieldError -> 0x0090 }
            ...
            L_0x0090:
                int[] r9 = f12125b     // Catch:{ NoSuchFieldError -> 0x009c }
            ...
            L_0x009c:
                int[] r9 = f12125b     // Catch:{ NoSuchFieldError -> 0x00a8 }
            ...
            L_0x00a8:
                int[] r9 = f12125b     // Catch:{ NoSuchFieldError -> 0x00b4 }
            ...
            L_0x00b4:
                int[] r9 = f12125b     // Catch:{ NoSuchFieldError -> 0x00c0 }
            ...
            L_0x00c0:
                int[] r9 = f12125b     // Catch:{ NoSuchFieldError -> 0x00cc }
            ...
            L_0x00cc:
                int[] r9 = f12125b     // Catch:{ NoSuchFieldError -> 0x00d8 }
            ...
            L_0x00e9:
                int[] r1 = f12124a     // Catch:{ NoSuchFieldError -> 0x00f3 }
            ...
            L_0x00f3:
                int[] r0 = f12124a     // Catch:{ NoSuchFieldError -> 0x00fd }
            ...
            L_0x00fd:
                int[] r0 = f12124a     // Catch:{ NoSuchFieldError -> 0x0107 }
            ...
            L_0x0107:
                int[] r0 = f12124a     // Catch:{ NoSuchFieldError -> 0x0111 }
            ...
            L_0x0111:
                int[] r0 = f12124a     // Catch:{ NoSuchFieldError -> 0x011b }
            ...
            L_0x011b:
                int[] r0 = f12124a     // Catch:{ NoSuchFieldError -> 0x0125 }
            ...
            L_0x0125:
                int[] r0 = f12124a     // Catch:{ NoSuchFieldError -> 0x012f }
            ...
            L_0x012f:
                int[] r0 = f12124a     // Catch:{ NoSuchFieldError -> 0x0139 }
    ...
    private void h(Map.Entry<FieldDescriptorType, Object> entry) {
        ...
        if (bVar.l()) {
            ...
            this.f12121a.put(bVar, c2);
        } else if (bVar.P() == w.c.MESSAGE) {
            Object c3 = c(bVar);
            if (c3 == null) {
                this.f12121a.put(bVar, b(value));
                return;
            }
            this.f12121a.put(bVar, bVar.y(((m) c3).c(), (m) value).h());
        } else {
            this.f12121a.put(bVar, b(value));
        }
    }
    ...
    private static void k(com.google.protobuf.w.b r2, java.lang.Object r3) {
        /*
            ...
            int[] r0 = com.google.protobuf.h.a.f12124a
    ...
    public h<FieldDescriptorType> clone() {
        ...
        for (int i2 = 0; i2 < this.f12121a.i(); i2++) {
            Map.Entry<FieldDescriptorType, Object> h = this.f12121a.h(i2);
            i.j((b) h.getKey(), h.getValue());
        }
        for (Map.Entry next : this.f12121a.k()) {
            i.j((b) next.getKey(), next.getValue());
        }
        i.f12123c = this.f12123c;
        return i;
    }

    public Object c(FieldDescriptorType fielddescriptortype) {
        Object obj = this.f12121a.get(fielddescriptortype);
    ...
    public Iterator<Map.Entry<FieldDescriptorType, Object>> e() {
        if (this.f12123c) {
            return new k.c(this.f12121a.entrySet().iterator());
        }
        return this.f12121a.entrySet().iterator();
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f12121a.equals(((h) obj).f12121a);
    }
    ...
    public void g(h<FieldDescriptorType> hVar) {
        for (int i = 0; i < hVar.f12121a.i(); i++) {
            h(hVar.f12121a.h(i));
        }
        for (Map.Entry<FieldDescriptorType, Object> h : hVar.f12121a.k()) {
            h(h);
        }
    }
    ...
    public void j(FieldDescriptorType fielddescriptortype, Object obj) {
        ...
        this.f12121a.put(fielddescriptortype, obj);
    }
