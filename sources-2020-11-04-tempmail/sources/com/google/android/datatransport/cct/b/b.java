...
public final class b implements com.google.firebase.encoders.f.a {
    ...
    public static final com.google.firebase.encoders.f.a f2641a = new b();

    private static final class a implements com.google.firebase.encoders.b<a> {

        /* renamed from: a  reason: collision with root package name */
        static final a f2642a = new a();
    ...
    private static final class C0067b implements com.google.firebase.encoders.b<j> {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final C0067b f2643a = new C0067b();
    ...
    public void configure(com.google.firebase.encoders.f.b<?> bVar) {
        bVar.a(j.class, C0067b.f2643a);
        bVar.a(d.class, C0067b.f2643a);
        bVar.a(m.class, e.f2646a);
        bVar.a(g.class, e.f2646a);
        bVar.a(k.class, c.f2644a);
        bVar.a(e.class, c.f2644a);
        bVar.a(a.class, a.f2642a);
        bVar.a(c.class, a.f2642a);
        bVar.a(l.class, d.f2645a);
        bVar.a(f.class, d.f2645a);
        bVar.a(o.class, f.f2647a);
        bVar.a(i.class, f.f2647a);
    }
}
