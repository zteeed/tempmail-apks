...
public class e implements s {
    ...
    public void a(m mVar, int i) {
        ComponentName componentName = new ComponentName(this.f2766a, JobInfoSchedulerService.class);
        JobScheduler jobScheduler = (JobScheduler) this.f2766a.getSystemService("jobscheduler");
        int b2 = b(mVar);
        if (c(jobScheduler, b2, i)) {
            a.a("JobInfoScheduler", "Upload for context %s is already scheduled. Returning...", mVar);
            return;
        }
        long C = this.f2767b.C(mVar);
        g gVar = this.f2768c;
        ...
        a.b("JobInfoScheduler", "Scheduling upload for context %s with jobId=%d in %dms(Backend next call timestamp %d). Attempt %d", mVar, Integer.valueOf(b2), Long.valueOf(this.f2768c.f(mVar.d(), C, i)), Long.valueOf(C), Integer.valueOf(i));
    ...
    public int b(m mVar) {
        ...
        adler32.update(this.f2766a.getPackageName().getBytes(Charset.forName("UTF-8")));
