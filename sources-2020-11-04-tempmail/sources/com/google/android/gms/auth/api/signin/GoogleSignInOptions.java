...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Api.ApiOptions.Optional, ReflectedParcelable {
    ...
    private final ArrayList<Scope> f2820c;
    @SafeParcelable.Field

    /* renamed from: d  reason: collision with root package name */
    private Account f2821d;
    @SafeParcelable.Field
    ...
    public static final class Builder {
        ...
        private Set<Scope> f2824a = new HashSet();
        ...
        /* renamed from: f  reason: collision with root package name */
        private Account f2829f;
        private String g;
        private Map<Integer, GoogleSignInOptionsExtensionParcelable> h = new HashMap();

        public final GoogleSignInOptions a() {
            if (this.f2824a.contains(GoogleSignInOptions.n) && this.f2824a.contains(GoogleSignInOptions.m)) {
                this.f2824a.remove(GoogleSignInOptions.m);
            }
            if (this.f2827d && (this.f2829f == null || !this.f2824a.isEmpty())) {
                b();
            }
            return new GoogleSignInOptions(3, new ArrayList(this.f2824a), this.f2829f, this.f2827d, this.f2825b, this.f2826c, this.f2828e, this.g, this.h, (a) null);
        }

        public final Builder b() {
            this.f2824a.add(GoogleSignInOptions.l);
            return this;
        }

        public final Builder c() {
            this.f2824a.add(GoogleSignInOptions.k);
            return this;
        }

        public final Builder d(Scope scope, Scope... scopeArr) {
            this.f2824a.add(scope);
            this.f2824a.addAll(Arrays.asList(scopeArr));
            return this;
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x004a, code lost:
        if (r3.f2821d.equals(r4.a0()) != false) goto L_0x004c;
     */
    ...
    public boolean equals(java.lang.Object r4) {
        ...
        L_0x0004:
            ...
            goto L_0x0085
        L_0x0018:
            java.util.ArrayList<com.google.android.gms.common.api.Scope> r1 = r3.f2820c     // Catch:{ ClassCastException -> 0x0085 }
            int r1 = r1.size()     // Catch:{ ClassCastException -> 0x0085 }
            ...
            goto L_0x0085
        L_0x0035:
            android.accounts.Account r1 = r3.f2821d     // Catch:{ ClassCastException -> 0x0085 }
            if (r1 != 0) goto L_0x0040
            android.accounts.Account r1 = r4.a0()     // Catch:{ ClassCastException -> 0x0085 }
            if (r1 != 0) goto L_0x0085
            goto L_0x004c
        L_0x0040:
            android.accounts.Account r1 = r3.f2821d     // Catch:{ ClassCastException -> 0x0085 }
            android.accounts.Account r2 = r4.a0()     // Catch:{ ClassCastException -> 0x0085 }
        ...
        L_0x006b:
            ...
            if (r1 != r2) goto L_0x0085
            boolean r1 = r3.f2822e     // Catch:{ ClassCastException -> 0x0085 }
            boolean r2 = r4.G()     // Catch:{ ClassCastException -> 0x0085 }
            if (r1 != r2) goto L_0x0085
            boolean r1 = r3.f2823f     // Catch:{ ClassCastException -> 0x0085 }
    ...
    public int hashCode() {
        ...
        ArrayList<Scope> arrayList2 = this.f2820c;
        ...
        hashAccumulator.a(this.f2821d);
        hashAccumulator.a(this.h);
        hashAccumulator.c(this.g);
        hashAccumulator.c(this.f2822e);
        hashAccumulator.c(this.f2823f);
    ...
    public ArrayList<Scope> v() {
        return new ArrayList<>(this.f2820c);
    }

    public void writeToParcel(Parcel parcel, int i2) {
        int a2 = SafeParcelWriter.a(parcel);
        SafeParcelWriter.l(parcel, 1, this.f2819b);
