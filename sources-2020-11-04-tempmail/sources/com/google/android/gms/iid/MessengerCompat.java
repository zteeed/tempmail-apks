...
public class MessengerCompat implements ReflectedParcelable {
    ...
    private final IBinder a() {
        Messenger messenger = this.f3447b;
        return messenger != null ? messenger.getBinder() : this.f3448c.asBinder();
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        if (messenger != null) {
            ...
            parcel.writeStrongBinder(this.f3448c.asBinder());
        }
    }
}
