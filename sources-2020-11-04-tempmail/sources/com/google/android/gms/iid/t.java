...
final /* synthetic */ class t implements Runnable {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x0066, code lost:
        r3 = com.google.android.gms.iid.zzr.a(r0.f3470f);
        r4 = r0.f3466b;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:20:0x00a1, code lost:
        if (r1.f3476a == null) goto L_0x00aa;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x00ac, code lost:
        if (r1.f3477b == null) goto L_0x00b5;
     */
    ...
    public final void run() {
        /*
            r8 = this;
            com.google.android.gms.iid.p r0 = r8.f3473b
        L_0x0002:
            monitor-enter(r0)
            int r1 = r0.f3465a     // Catch:{ all -> 0x00c7 }
            r2 = 2
            if (r1 == r2) goto L_0x000a
            monitor-exit(r0)     // Catch:{ all -> 0x00c7 }
            return
        L_0x000a:
            java.util.Queue<com.google.android.gms.iid.w<?>> r1 = r0.f3468d     // Catch:{ all -> 0x00c7 }
        ...
        L_0x0017:
            ...
            android.util.SparseArray<com.google.android.gms.iid.w<?>> r3 = r0.f3469e     // Catch:{ all -> 0x00c7 }
            int r4 = r1.f3478a     // Catch:{ all -> 0x00c7 }
            r3.put(r4, r1)     // Catch:{ all -> 0x00c7 }
            com.google.android.gms.iid.zzr r3 = r0.f3470f     // Catch:{ all -> 0x00c7 }
            java.util.concurrent.ScheduledExecutorService r3 = r3.f3507b     // Catch:{ all -> 0x00c7 }
        ...
        L_0x0066:
            com.google.android.gms.iid.zzr r3 = r0.f3470f
            android.content.Context r3 = r3.f3506a
            android.os.Messenger r4 = r0.f3466b
            ...
            android.os.Bundle r1 = r1.f3481d
            r4.putBundle(r3, r1)
            r5.setData(r4)
            com.google.android.gms.iid.v r1 = r0.f3467c     // Catch:{ RemoteException -> 0x00bd }
            android.os.Messenger r3 = r1.f3476a     // Catch:{ RemoteException -> 0x00bd }
            if (r3 == 0) goto L_0x00aa
            android.os.Messenger r1 = r1.f3476a     // Catch:{ RemoteException -> 0x00bd }
            r1.send(r5)     // Catch:{ RemoteException -> 0x00bd }
            goto L_0x0002
        L_0x00aa:
            com.google.android.gms.iid.MessengerCompat r3 = r1.f3477b     // Catch:{ RemoteException -> 0x00bd }
            if (r3 == 0) goto L_0x00b5
            com.google.android.gms.iid.MessengerCompat r1 = r1.f3477b     // Catch:{ RemoteException -> 0x00bd }
