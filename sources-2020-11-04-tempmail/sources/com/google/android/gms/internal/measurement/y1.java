...
final class y1 implements w4 {
    ...
    public final <K, V> void E(int i, w2<K, V> w2Var, Map<K, V> map) throws IOException {
        for (Map.Entry next : map.entrySet()) {
            this.f9709a.m(i, 2);
            this.f9709a.O(zzgo.a(w2Var, next.getKey(), next.getValue()));
            zzgo.b(this.f9709a, w2Var, next.getKey(), next.getValue());
        }
    }
    ...
    public final void H(int i, Object obj, p3 p3Var) throws IOException {
        zzev zzev = this.f9709a;
        zzev.m(i, 3);
        p3Var.i((zzgw) obj, zzev.f9799a);
        zzev.m(i, 4);
    }
    ...
    public final void N(int i, Object obj, p3 p3Var) throws IOException {
        this.f9709a.q(i, (zzgw) obj, p3Var);
    }
    ...
    public final void b(int i, List<Boolean> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            this.f9709a.O(i3);
            while (i2 < list.size()) {
                this.f9709a.y(list.get(i2).booleanValue());
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            this.f9709a.s(i, list.get(i2).booleanValue());
            i2++;
        }
    }
    ...
    public final void c(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            this.f9709a.O(i3);
            while (i2 < list.size()) {
                this.f9709a.j(list.get(i2).intValue());
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            this.f9709a.P(i, list.get(i2).intValue());
            i2++;
        }
    }
    ...
    public final void i(int i, Object obj) throws IOException {
        if (obj instanceof zzeg) {
            this.f9709a.R(i, (zzeg) obj);
        } else {
            this.f9709a.p(i, (zzgw) obj);
        }
    }
    ...
    public final void j(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            this.f9709a.O(i3);
            while (i2 < list.size()) {
                this.f9709a.t(list.get(i2).longValue());
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            this.f9709a.n(i, list.get(i2).longValue());
            i2++;
        }
    }
    ...
    public final void k(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            this.f9709a.O(i3);
            while (i2 < list.size()) {
                this.f9709a.a0(list.get(i2).longValue());
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            this.f9709a.Z(i, list.get(i2).longValue());
            i2++;
        }
    }
    ...
    public final void l(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            this.f9709a.O(i3);
            while (i2 < list.size()) {
                this.f9709a.f0(list.get(i2).intValue());
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            this.f9709a.k0(i, list.get(i2).intValue());
            i2++;
        }
    }
    ...
    public final void n(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            this.f9709a.O(i3);
            while (i2 < list.size()) {
                this.f9709a.O(list.get(i2).intValue());
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            this.f9709a.Y(i, list.get(i2).intValue());
            i2++;
        }
    }
    ...
    public final void s(int i, List<Long> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            this.f9709a.O(i3);
            while (i2 < list.size()) {
                this.f9709a.S(list.get(i2).longValue());
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            this.f9709a.Q(i, list.get(i2).longValue());
            i2++;
        }
    }
    ...
    public final void u(int i, List<Integer> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            this.f9709a.O(i3);
            while (i2 < list.size()) {
                this.f9709a.X(list.get(i2).intValue());
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            this.f9709a.g0(i, list.get(i2).intValue());
            i2++;
        }
    }
    ...
    public final void v(int i, List<Double> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            this.f9709a.O(i3);
            while (i2 < list.size()) {
                this.f9709a.h(list.get(i2).doubleValue());
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            this.f9709a.k(i, list.get(i2).doubleValue());
            i2++;
        }
    }
    ...
    public final void x(int i, List<Float> list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            this.f9709a.O(i3);
            while (i2 < list.size()) {
                this.f9709a.i(list.get(i2).floatValue());
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            this.f9709a.l(i, list.get(i2).floatValue());
            i2++;
        }
    }
        ...
        if (list instanceof zzgh) {
            ...
            while (i2 < list.size()) {
                ...
                if (g instanceof String) {
                    this.f9709a.r(i, (String) g);
                } else {
                    this.f9709a.o(i, (zzeg) g);
                }
                i2++;
            }
            return;
