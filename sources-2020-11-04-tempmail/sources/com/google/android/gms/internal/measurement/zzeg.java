...
public abstract class zzeg implements Serializable, Iterable<Byte> {
    ...
    public static final zzeg f9791c = new s1(zzfr.f9824b);

    /* renamed from: d  reason: collision with root package name */
    private static final o1 f9792d = (f1.b() ? new r1((k1) null) : new n1((k1) null));
    ...
    public static zzeg l(String str) {
        return new s1(str.getBytes(zzfr.f9823a));
    }
    ...
    public static zzeg q(byte[] bArr, int i, int i2) {
        ...
        return new s1(f9792d.a(bArr, i, i2));
    }
