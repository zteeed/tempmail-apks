...
public class zzag {
    ...
    protected final Clock f9731b;

    /* renamed from: c  reason: collision with root package name */
    private final ExecutorService f9732c;

    /* renamed from: d  reason: collision with root package name */
    private final AppMeasurementSdk f9733d;
    /* access modifiers changed from: private */

    /* renamed from: e  reason: collision with root package name */
    public List<Pair<zzha, c>> f9734e;
    ...
    abstract class a implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                zzag.this.p(e2, false, this.f9738d);
                b();
            }
        }

        a(boolean z) {
            this.f9736b = zzag.this.f9731b.a();
            this.f9737c = zzag.this.f9731b.b();
            this.f9738d = z;
        }
    }
    ...
    static class c extends zzaa {
        ...
        public final int a() {
            return System.identityHashCode(this.f9741b);
        }

        public final void u4(String str, String str2, Bundle bundle, long j) {
            this.f9741b.a(str, str2, bundle, j);
        }
    }
    ...
    private zzag(Context context, String str, String str2, String str3, Bundle bundle) {
        ...
        this.f9731b = DefaultClock.d();
        this.f9732c = zzi.a().a(new f(this), zzr.f10005a);
        this.f9733d = new AppMeasurementSdk(this);
        boolean z = false;
        if (!(!O(context) || W())) {
            this.h = null;
            this.g = true;
            Log.w(this.f9730a, "Disabling data collection. Found google_app_id in strings.xml but Google Analytics for Firebase is missing. Remove this value or add Google Analytics for Firebase to resume data collection.");
            return;
        }
        if (!I(str2, str3)) {
            this.h = "fa";
            if (str2 == null || str3 == null) {
                if ((str2 == null) ^ (str3 == null ? true : z)) {
                    Log.w(this.f9730a, "Specified origin or custom app id is null. Both parameters will be ignored.");
                }
            } else {
                Log.v(this.f9730a, "Deferring to Google Analytics for Firebase for event data collection. https://goo.gl/J1sWQy");
            }
        } else {
            this.h = str2;
        }
        ...
        if (application == null) {
            Log.w(this.f9730a, "Unable to register lifecycle notifications. Application null.");
        } else {
    ...
    public final void p(Exception exc, boolean z, boolean z2) {
        this.g |= z;
        if (z) {
            Log.w(this.f9730a, "Data collection startup failed. No data will be collected.", exc);
            return;
        }
        if (z2) {
            i(5, "Error with data collection. Data lost.", exc, (Object) null, (Object) null);
        }
        Log.w(this.f9730a, "Error with data collection. Data lost.", exc);
    }
    ...
    public final int K(String str) {
        ...
        Integer num = (Integer) zzt.B(zzt.V(10000), Integer.class);
        if (num == null) {
            return 25;
        }
        return num.intValue();
    ...
    public final long N() {
        zzt zzt = new zzt();
        l(new j(this, zzt));
        Long l2 = (Long) zzt.B(zzt.V(500), Long.class);
        if (l2 != null) {
            return l2.longValue();
        }
        long nextLong = new Random(System.nanoTime() ^ this.f9731b.a()).nextLong();
        int i2 = this.f9735f + 1;
        this.f9735f = i2;
    ...
    public final List<Bundle> z(String str, String str2) {
        ...
        List<Bundle> list = (List) zzt.B(zzt.V(5000), List.class);
