...
final class m4 {
    ...
    private static final o4 f9641a;
    ...
    static int e(CharSequence charSequence, byte[] bArr, int i, int i2) {
        return f9641a.b(charSequence, bArr, i, i2);
    }

    public static boolean f(byte[] bArr) {
        return f9641a.d(bArr, 0, bArr.length);
    }

    public static boolean g(byte[] bArr, int i, int i2) {
        return f9641a.d(bArr, i, i2);
    }
