...
public final class zzby {
    ...
    public static final class zza extends zzfo<zza, C0090zza> implements zzgy {
        ...
        public static final class C0090zza extends zzfo.zza<zza, C0090zza> implements zzgy {
            ...
            public final C0090zza C(String str) {
                if (this.f9816d) {
                    x();
                    this.f9816d = false;
                }
                ((zza) this.f9815c).F(str);
                return this;
            }

            public final String D() {
                return ((zza) this.f9815c).D();
            }

            public final boolean E() {
                return ((zza) this.f9815c).G();
            }

            public final boolean F() {
                return ((zza) this.f9815c).H();
            }

            public final boolean H() {
                return ((zza) this.f9815c).I();
            }

            public final int I() {
                return ((zza) this.f9815c).J();
            }

            /* synthetic */ C0090zza(f0 f0Var) {
                this();
            }
        }
        ...
        public final Object r(int i, Object obj, Object obj2) {
            switch (f0.f9577a[i - 1]) {
                case 1:
                    return new zza();
                case 2:
                    return new C0090zza((f0) null);
                case 3:
    ...
    public static final class zzb extends zzfo<zzb, zza> implements zzgy {
        ...
        public static final class zza extends zzfo.zza<zzb, zza> implements zzgy {
            ...
            public final zza E(int i, zza.C0090zza zza) {
                if (this.f9816d) {
                    x();
                    this.f9816d = false;
                }
                ((zzb) this.f9815c).E(i, (zza) ((zzfo) zza.q()));
                return this;
            }

            public final List<zzbt.zza> F() {
                return Collections.unmodifiableList(((zzb) this.f9815c).O());
            }
