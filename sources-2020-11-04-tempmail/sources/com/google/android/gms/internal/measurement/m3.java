...
interface m3 {
    ...
    @Deprecated
    <T> T D(p3<T> p3Var, zzfb zzfb) throws IOException;

    void E(List<Integer> list) throws IOException;

    @Deprecated
    <T> void F(List<T> list, p3<T> p3Var, zzfb zzfb) throws IOException;

    <T> T G(p3<T> p3Var, zzfb zzfb) throws IOException;
    ...
    <T> void K(List<T> list, p3<T> p3Var, zzfb zzfb) throws IOException;

    void L(List<Long> list) throws IOException;

    <K, V> void M(Map<K, V> map, w2<K, V> w2Var, zzfb zzfb) throws IOException;
