...
public class zzci {
    ...
    private static UserManager f9769a;

    /* renamed from: b  reason: collision with root package name */
    private static volatile boolean f9770b = (!a());
    ...
    private static boolean c(Context context) {
        ...
        while (true) {
            ...
            if (f9769a == null) {
                f9769a = (UserManager) context.getSystemService(UserManager.class);
            }
            UserManager userManager = f9769a;
            if (userManager == null) {
                return true;
            }
            try {
    ...
    private static boolean d(android.content.Context r3) {
        ...
        L_0x0006:
            ...
            monitor-enter(r0)
            boolean r2 = f9770b     // Catch:{ all -> 0x0019 }
