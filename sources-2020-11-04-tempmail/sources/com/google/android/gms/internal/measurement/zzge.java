...
public final class zzge extends g1<String> implements zzgh, RandomAccess {
    ...
    private static final zzge f9830d;

    /* renamed from: c  reason: collision with root package name */
    private final List<Object> f9831c;
    ...
    public final void S(zzeg zzeg) {
        c();
        this.f9831c.add(zzeg);
        this.modCount++;
    }

    public final /* synthetic */ void add(int i, Object obj) {
        c();
        this.f9831c.add(i, (String) obj);
        this.modCount++;
    }
    ...
    public final List<?> d() {
        return Collections.unmodifiableList(this.f9831c);
    }
    ...
    public final Object g(int i) {
        return this.f9831c.get(i);
    }

    public final /* synthetic */ Object get(int i) {
        Object obj = this.f9831c.get(i);
        if (obj instanceof String) {
            return (String) obj;
        }
        if (obj instanceof zzeg) {
    ...
    public final /* synthetic */ Object set(int i, Object obj) {
        c();
        return h(this.f9831c.set(i, (String) obj));
    }
    ...
    public final boolean addAll(int i, Collection<? extends String> collection) {
        ...
        boolean addAll = this.f9831c.addAll(i, collection);
        this.modCount++;
        return addAll;
    }
    ...
    public final /* synthetic */ Object remove(int i) {
        c();
        Object remove = this.f9831c.remove(i);
        this.modCount++;
        return h(remove);
    }
