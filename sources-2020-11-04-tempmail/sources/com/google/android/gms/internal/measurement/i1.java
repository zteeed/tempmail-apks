...
final class i1 {
    static int a(int i, byte[] bArr, int i2, int i3, h1 h1Var) throws zzfw {
        if ((i >>> 3) != 0) {
            ...
            if (i4 == 2) {
                return i(bArr, i2, h1Var) + h1Var.f9590a;
            }
            if (i4 == 3) {
                int i5 = (i & -8) | 4;
                int i6 = 0;
    ...
    static int c(int i, byte[] bArr, int i2, int i3, zzig zzig, h1 h1Var) throws zzfw {
        if ((i >>> 3) != 0) {
            ...
            if (i4 == 0) {
                ...
                zzig.c(i, Long.valueOf(h1Var.f9591b));
                return k;
            } else if (i4 == 1) {
    ...
    static int n(byte[] bArr, int i, h1 h1Var) throws zzfw {
        ...
        if (i3 < 0) {
            ...
            h1Var.f9592c = new String(bArr, i2, i3, zzfr.f9823a);
            return i2 + i3;
        }
    }
    ...
    static int q(byte[] bArr, int i, h1 h1Var) throws zzfw {
        ...
        if (i3 < 0) {
            ...
            h1Var.f9592c = zzeg.f9791c;
            return i2;
        } else {
            h1Var.f9592c = zzeg.q(bArr, i2, i3);
            return i2 + i3;
        }
    }
}
