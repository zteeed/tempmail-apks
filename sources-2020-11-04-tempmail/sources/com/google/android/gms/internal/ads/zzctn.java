...
public abstract class zzctn<AdT> implements zzcqt<AdT> {
    ...
    public final zzdvf<AdT> a(zzdkw zzdkw, zzdkk zzdkk) {
        ...
        zzve zzve = zzdla.f8349d;
        zzve zzve2 = r5;
        zzve zzve3 = new zzve(zzve.f9366b, zzve.f9367c, d3, zzve.f9369e, zzve.f9370f, zzve.g, zzve.h, zzve.i, zzve.j, zzve.k, zzve.l, zzve.m, d2, zzve.o, zzve.p, zzve.q, zzve.r, zzve.s, zzve.t, zzve.u, zzve.v, zzve.w);
        zzdlc.A(zzve2);
        zzdla e2 = zzdlc.e();
        Bundle bundle = new Bundle();
        zzdkw zzdkw2 = zzdkw;
        zzdkm zzdkm = zzdkw2.f8345b.f8340b;
        Bundle bundle2 = new Bundle();
        bundle2.putStringArrayList("nofill_urls", new ArrayList(zzdkm.f8320a));
        bundle2.putInt("refresh_interval", zzdkm.f8322c);
        bundle2.putString("gws_query_id", zzdkm.f8321b);
        bundle.putBundle("parent_common_config", bundle2);
        String str = zzdkw2.f8344a.f8332a.f8351f;
        Bundle bundle3 = new Bundle();
        bundle3.putString("initial_ad_unit_id", str);
        zzdkk zzdkk3 = zzdkk;
        bundle3.putString("allocation_id", zzdkk3.t);
        bundle3.putStringArrayList("click_urls", new ArrayList(zzdkk3.f8316c));
        bundle3.putStringArrayList("imp_urls", new ArrayList(zzdkk3.f8317d));
        ...
        if (zzdkk3.l != null) {
            ...
            bundle4.putInt("rb_amount", zzdkk3.l.f6145c);
            bundle4.putString("rb_type", zzdkk3.l.f6144b);
