...
final class d60 implements t70 {
    ...
    private final Object b(zzejq zzejq, Class<?> cls, zzefo zzefo) throws IOException {
        switch (c60.f3702a[zzejq.ordinal()]) {
            case 1:
    ...
    private final <T> T d(z70<T> z70, zzefo zzefo) throws IOException {
        int n = this.f3789a.n();
        zzefc zzefc = this.f3789a;
        if (zzefc.f8724a < zzefc.f8725b) {
            int y = zzefc.y(n);
            T g = z70.g();
            this.f3789a.f8724a++;
            z70.j(g, this, zzefo);
    ...
    private final <T> T e(z70<T> z70, zzefo zzefo) throws IOException {
        int i = this.f3791c;
        this.f3791c = ((this.f3790b >>> 3) << 3) | 4;
        try {
            T g = z70.g();
            z70.j(g, this, zzefo);
            z70.b(g);
            if (this.f3790b == this.f3791c) {
                return g;
            }
            throw zzegl.h();
        } finally {
    ...
    public final void A(List<Integer> list) throws IOException {
        ...
        if (list instanceof r60) {
            ...
            if (i == 0) {
                ...
                int u = this.f3789a.u() + this.f3789a.n();
                do {
                    r60.L(this.f3789a.r());
                } while (this.f3789a.u() < u);
                j(u);
            } else {
                throw zzegl.f();
            }
        } else {
            int i2 = this.f3790b & 7;
            if (i2 == 0) {
                do {
                    list.add(Integer.valueOf(this.f3789a.r()));
                    if (!this.f3789a.t()) {
                        e2 = this.f3789a.e();
                    } else {
                        return;
                ...
                int u2 = this.f3789a.u() + this.f3789a.n();
                do {
                    list.add(Integer.valueOf(this.f3789a.r()));
                } while (this.f3789a.u() < u2);
                j(u2);
            } else {
                throw zzegl.f();
            }
    ...
    public final <T> void C(List<T> list, z70<T> z70, zzefo zzefo) throws IOException {
        ...
        if ((i & 7) == 2) {
            do {
                ...
                if (!this.f3789a.t() && this.f3792d == 0) {
                    e2 = this.f3789a.e();
                } else {
                    return;
                }
    ...
    public final void D(List<Long> list) throws IOException {
        ...
        if (list instanceof y60) {
            ...
            if (i2 == 1) {
                do {
                    list.add(Long.valueOf(this.f3789a.q()));
                    if (!this.f3789a.t()) {
                        e2 = this.f3789a.e();
                    } else {
                        return;
                ...
                int n2 = this.f3789a.n();
                g(n2);
                int u2 = this.f3789a.u() + n2;
                do {
                    list.add(Long.valueOf(this.f3789a.q()));
                } while (this.f3789a.u() < u2);
            } else {
    ...
    public final void E(List<Integer> list) throws IOException {
        ...
        if (list instanceof r60) {
            ...
            if (i2 == 2) {
                ...
                int u2 = this.f3789a.u() + n2;
                do {
                    list.add(Integer.valueOf(this.f3789a.p()));
                } while (this.f3789a.u() < u2);
            } else if (i2 == 5) {
                do {
                    list.add(Integer.valueOf(this.f3789a.p()));
    ...
    public final void K(List<Boolean> list) throws IOException {
        ...
        if (list instanceof p50) {
            ...
            if (i2 == 0) {
                do {
                    list.add(Boolean.valueOf(this.f3789a.k()));
                    if (!this.f3789a.t()) {
                        e2 = this.f3789a.e();
                    } else {
                        return;
    ...
    public final void P(List<Long> list) throws IOException {
        ...
        if (list instanceof y60) {
            ...
            if (i2 == 0) {
                do {
                    list.add(Long.valueOf(this.f3789a.s()));
                    if (!this.f3789a.t()) {
                        e2 = this.f3789a.e();
                    } else {
                        return;
    ...
    public final <K, V> void T(java.util.Map<K, V> r8, com.google.android.gms.internal.ads.d70<K, V> r9, com.google.android.gms.internal.ads.zzefo r10) throws java.io.IOException {
        /*
            ...
            r0 = 2
            r7.f(r0)
            com.google.android.gms.internal.ads.zzefc r1 = r7.f3789a
            int r1 = r1.n()
            com.google.android.gms.internal.ads.zzefc r2 = r7.f3789a
            int r1 = r2.y(r1)
            K r2 = r9.f3797b
            V r3 = r9.f3799d
        L_0x0014:
            ...
            com.google.android.gms.internal.ads.zzefc r5 = r7.f3789a     // Catch:{ all -> 0x0064 }
        ...
        L_0x0039:
            com.google.android.gms.internal.ads.zzejq r4 = r9.f3798c     // Catch:{ zzego -> 0x004e }
            V r5 = r9.f3799d     // Catch:{ zzego -> 0x004e }
            java.lang.Class r5 = r5.getClass()     // Catch:{ zzego -> 0x004e }
            java.lang.Object r3 = r7.b(r4, r5, r10)     // Catch:{ zzego -> 0x004e }
            goto L_0x0014
        L_0x0046:
            com.google.android.gms.internal.ads.zzejq r4 = r9.f3796a     // Catch:{ zzego -> 0x004e }
            r5 = 0
        ...
        L_0x005b:
            ...
            com.google.android.gms.internal.ads.zzefc r8 = r7.f3789a
            r8.z(r1)
            return
        L_0x0064:
            r8 = move-exception
            com.google.android.gms.internal.ads.zzefc r9 = r7.f3789a
            r9.z(r1)
            throw r8
        */
    ...
    public final int X() throws IOException {
        ...
        if (i != 0) {
            ...
            this.f3790b = this.f3789a.e();
        }
        int i2 = this.f3790b;
        if (i2 == 0 || i2 == this.f3791c) {
    ...
    public final void c0(List<Integer> list) throws IOException {
        ...
        if (list instanceof r60) {
            ...
            if (i2 == 0) {
                do {
                    list.add(Integer.valueOf(this.f3789a.o()));
                    if (!this.f3789a.t()) {
                        e2 = this.f3789a.e();
                    } else {
                        return;
    ...
    public final int d0() throws IOException {
        f(0);
        return this.f3789a.r();
    }

    public final boolean e0() throws IOException {
        int i;
        if (this.f3789a.t() || (i = this.f3790b) == this.f3791c) {
            return false;
        }
        return this.f3789a.x(i);
    }
    ...
    public final void h0(List<Integer> list) throws IOException {
        ...
        if (list instanceof r60) {
            ...
            if (i2 == 0) {
                do {
                    list.add(Integer.valueOf(this.f3789a.n()));
                    if (!this.f3789a.t()) {
                        e2 = this.f3789a.e();
                    } else {
                        return;
    ...
    public final void i(List<Long> list) throws IOException {
        ...
        if (list instanceof y60) {
            ...
            if (i2 == 1) {
                do {
                    list.add(Long.valueOf(this.f3789a.i()));
                    if (!this.f3789a.t()) {
                        e2 = this.f3789a.e();
                    } else {
                        return;
    ...
    public final void m(List<Integer> list) throws IOException {
        ...
        if (list instanceof r60) {
            ...
            if (i2 == 0) {
                do {
                    list.add(Integer.valueOf(this.f3789a.h()));
                    if (!this.f3789a.t()) {
                        e2 = this.f3789a.e();
                    } else {
                        return;
    ...
    public final void s(List<Integer> list) throws IOException {
        ...
        if (list instanceof r60) {
            ...
            if (i2 == 2) {
                ...
                int u2 = this.f3789a.u() + n2;
                do {
                    list.add(Integer.valueOf(this.f3789a.j()));
                } while (this.f3789a.u() < u2);
            } else if (i2 == 5) {
                do {
                    list.add(Integer.valueOf(this.f3789a.j()));
    ...
    public final void t(List<Float> list) throws IOException {
        ...
        if (list instanceof p60) {
            ...
            if (i2 == 2) {
                ...
                int u2 = this.f3789a.u() + n2;
                do {
                    list.add(Float.valueOf(this.f3789a.b()));
                } while (this.f3789a.u() < u2);
            } else if (i2 == 5) {
                do {
                    list.add(Float.valueOf(this.f3789a.b()));
    ...
    public final void v(List<Double> list) throws IOException {
        ...
        if (list instanceof f60) {
            ...
            if (i2 == 1) {
                do {
                    list.add(Double.valueOf(this.f3789a.a()));
                    if (!this.f3789a.t()) {
                        e2 = this.f3789a.e();
                    } else {
                        return;
    ...
    public final void w(List<Long> list) throws IOException {
        ...
        if (list instanceof y60) {
            ...
            if (i2 == 0) {
                do {
                    list.add(Long.valueOf(this.f3789a.g()));
                    if (!this.f3789a.t()) {
                        e2 = this.f3789a.e();
                    } else {
                        return;
    ...
    public final void z(List<Long> list) throws IOException {
        ...
        if (list instanceof y60) {
            ...
            if (i2 == 0) {
                do {
                    list.add(Long.valueOf(this.f3789a.f()));
                    if (!this.f3789a.t()) {
                        e2 = this.f3789a.e();
                    } else {
                        return;
