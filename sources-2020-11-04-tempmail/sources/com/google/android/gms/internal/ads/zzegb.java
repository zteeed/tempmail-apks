...
public abstract class zzegb<MessageType extends zzegb<MessageType, BuilderType>, BuilderType extends zzb<MessageType, BuilderType>> extends zzeeh<MessageType, BuilderType> {
    ...
    public static abstract class zzb<MessageType extends zzegb<MessageType, BuilderType>, BuilderType extends zzb<MessageType, BuilderType>> extends zzeeg<MessageType, BuilderType> {
        ...
        private final MessageType f8749b;

        /* renamed from: c  reason: collision with root package name */
        protected MessageType f8750c;

        /* renamed from: d  reason: collision with root package name */
        protected boolean f8751d = false;

        protected zzb(MessageType messagetype) {
            this.f8749b = messagetype;
            this.f8750c = (zzegb) messagetype.t(zze.f8755d, (Object) null, (Object) null);
        }
        ...
        private final BuilderType p(byte[] bArr, int i, int i2, zzefo zzefo) throws zzegl {
            ...
            try {
                s70.b().a(this.f8750c).e(this.f8750c, bArr, 0, i2 + 0, new n50(zzefo));
                return this;
            } catch (zzegl e2) {
                throw e2;
        ...
        public /* synthetic */ Object clone() throws CloneNotSupportedException {
            zzb zzb = (zzb) this.f8749b.t(zze.f8756e, (Object) null, (Object) null);
            zzb.o((zzegb) K());
            return zzb;
        }
        ...
        public final boolean isInitialized() {
            return zzegb.y(this.f8750c, false);
        }
        ...
        public final BuilderType o(MessageType messagetype) {
            ...
            n(this.f8750c, messagetype);
            return this;
        }

        /* access modifiers changed from: protected */
        public void r() {
            MessageType messagetype = (zzegb) this.f8750c.t(zze.f8755d, (Object) null, (Object) null);
            n(messagetype, this.f8750c);
            this.f8750c = messagetype;
        }
        ...
        public MessageType K() {
            ...
            MessageType messagetype = this.f8750c;
    ...
    public static final class zze {
        ...
        public static final int f8752a = 1;

        /* renamed from: b  reason: collision with root package name */
        public static final int f8753b = 2;

        /* renamed from: c  reason: collision with root package name */
        public static final int f8754c = 3;

        /* renamed from: d  reason: collision with root package name */
        public static final int f8755d = 4;

        /* renamed from: e  reason: collision with root package name */
        public static final int f8756e = 5;

        /* renamed from: f  reason: collision with root package name */
        public static final int f8757f = 6;
    ...
    static <T extends zzegb<?, ?>> T F(Class<T> cls) {
        ...
        if (t == null) {
            t = (zzegb) ((zzegb) v80.x(cls)).t(zze.f8757f, (Object) null, (Object) null);
            if (t != null) {
                zziei.put(cls, t);
            } else {
    ...
    private static <T extends zzegb<T, ?>> T n(T t, zzefc zzefc, zzefo zzefo) throws zzegl {
        T t2 = (zzegb) t.t(zze.f8755d, (Object) null, (Object) null);
        try {
            z70 a2 = s70.b().a(t2);
    ...
    protected static final <T extends zzegb<T, ?>> boolean y(T t, boolean z) {
        byte byteValue = ((Byte) t.t(zze.f8752a, (Object) null, (Object) null)).byteValue();
        if (byteValue == 1) {
            return true;
        }
        if (byteValue == 0) {
        ...
        if (z) {
            t.t(zze.f8753b, h ? t : null, (Object) null);
        }
        return h;
    }
    ...
    public final <MessageType extends zzegb<MessageType, BuilderType>, BuilderType extends zzb<MessageType, BuilderType>> BuilderType A() {
        return (zzb) t(zze.f8756e, (Object) null, (Object) null);
    }

    public final BuilderType B() {
        BuilderType buildertype = (zzb) t(zze.f8756e, (Object) null, (Object) null);
        buildertype.o(this);
        return buildertype;
    }

    public final /* synthetic */ zzeho b() {
        zzb zzb2 = (zzb) t(zze.f8756e, (Object) null, (Object) null);
        zzb2.o(this);
        return zzb2;
    }
    ...
    public final /* synthetic */ zzehl d() {
        return (zzegb) t(zze.f8757f, (Object) null, (Object) null);
    }
