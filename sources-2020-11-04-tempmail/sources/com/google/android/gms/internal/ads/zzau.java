...
public class zzau implements zzx {
    ...
    private static final boolean f6141c = zzaq.f6038b;

    /* renamed from: a  reason: collision with root package name */
    private final zzar f6142a;

    /* renamed from: b  reason: collision with root package name */
    private final zzat f6143b;

    public zzau(zzar zzar) {
        this(zzar, new zzat(CodedOutputStream.DEFAULT_BUFFER_SIZE));
    }

    private static void b(String str, zzaa<?> zzaa, zzao zzao) throws zzao {
        zzan K = zzaa.K();
        int J = zzaa.J();
        try {
            K.a(zzao);
            zzaa.u(String.format("%s-retry [timeout=%s]", new Object[]{str, Integer.valueOf(J)}));
        } catch (zzao e2) {
            zzaa.u(String.format("%s-timeout-giveup [timeout=%s]", new Object[]{str, Integer.valueOf(J)}));
            throw e2;
        }
    }

    private final byte[] c(InputStream inputStream, int i) throws IOException, zzam {
        zzbi zzbi = new zzbi(this.f6143b, i);
        byte[] bArr = null;
        if (inputStream != null) {
            try {
                bArr = this.f6143b.b(1024);
                while (true) {
                ...
                if (inputStream != null) {
                    try {
                        ...
                        zzaq.c("Error occurred when closing InputStream", new Object[0]);
                    }
                }
                this.f6143b.a(bArr);
                zzbi.close();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:103:0x020b, code lost:
        r2 = java.lang.String.valueOf(r22.h());
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:109:0x022b, code lost:
        b("socket", r2, new com.google.android.gms.internal.ads.zzap());
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:78:0x0199, code lost:
        r0 = r8.c();
        com.google.android.gms.internal.ads.zzaq.b("Unexpected response code %d for %s", java.lang.Integer.valueOf(r0), r22.h());
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:98:0x01ec, code lost:
        b("auth", r2, new com.google.android.gms.internal.ads.zzl(r11));
     */
    /* JADX WARNING: Code restructure failed: missing block: B:99:0x01f8, code lost:
        b("network", r2, new com.google.android.gms.internal.ads.zzz());
     */
    ...
    public com.google.android.gms.internal.ads.zzy a(com.google.android.gms.internal.ads.zzaa<?> r22) throws com.google.android.gms.internal.ads.zzao {
        /*
            r21 = this;
            r1 = r21
            r2 = r22
        ...
        L_0x0008:
            ...
            r7 = 2
            r9 = 0
            com.google.android.gms.internal.ads.zzn r0 = r22.G()     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x0192 }
        ...
        L_0x001a:
            ...
            java.lang.String r11 = r0.f9067b     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x0192 }
            if (r11 == 0) goto L_0x002a
            java.lang.String r11 = "If-None-Match"
            java.lang.String r12 = r0.f9067b     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x0192 }
            r10.put(r11, r12)     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x0192 }
        L_0x002a:
            long r11 = r0.f9069d     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x0192 }
            r13 = 0
            int r15 = (r11 > r13 ? 1 : (r11 == r13 ? 0 : -1))
            if (r15 <= 0) goto L_0x003d
            java.lang.String r11 = "If-Modified-Since"
            long r12 = r0.f9069d     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x0192 }
            java.lang.String r0 = com.google.android.gms.internal.ads.zzbc.b(r12)     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x0192 }
            r10.put(r11, r0)     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x0192 }
        L_0x003d:
            r0 = r10
        L_0x003e:
            com.google.android.gms.internal.ads.zzar r10 = r1.f6142a     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x0192 }
            com.google.android.gms.internal.ads.zzbb r10 = r10.a(r2, r0)     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x0192 }
            int r12 = r10.c()     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x018d }
            java.util.List r5 = r10.d()     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x018d }
            r0 = 304(0x130, float:4.26E-43)
            if (r12 != r0) goto L_0x0116
            com.google.android.gms.internal.ads.zzn r0 = r22.G()     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x018d }
            ...
            r13 = r0
            r19 = r5
            r13.<init>((int) r14, (byte[]) r15, (boolean) r16, (long) r17, (java.util.List<com.google.android.gms.internal.ads.zzu>) r19)     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x018d }
            return r0
        L_0x006a:
        ...
        L_0x007b:
            ...
            java.lang.String r13 = r13.a()     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x018d }
        ...
        L_0x008f:
            ...
            java.util.List<com.google.android.gms.internal.ads.zzu> r13 = r0.h     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x018d }
        ...
        L_0x00a6:
            ...
            java.lang.String r15 = r14.a()     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x018d }
            ...
            goto L_0x00a6
        L_0x00c0:
            java.util.Map<java.lang.String, java.lang.String> r13 = r0.g     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x018d }
            boolean r13 = r13.isEmpty()     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x018d }
            if (r13 != 0) goto L_0x00ff
            java.util.Map<java.lang.String, java.lang.String> r13 = r0.g     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x018d }
        ...
        L_0x00ff:
            ...
            byte[] r0 = r0.f9066a     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x018d }
            r17 = 1
            ...
            r16 = r0
            r20 = r12
            r14.<init>((int) r15, (byte[]) r16, (boolean) r17, (long) r18, (java.util.List<com.google.android.gms.internal.ads.zzu>) r20)     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x018d }
            return r8
        L_0x0116:
            java.io.InputStream r0 = r10.a()     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x018d }
            if (r0 == 0) goto L_0x0125
            int r8 = r10.b()     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x018d }
            byte[] r0 = r1.c(r0, r8)     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x018d }
            goto L_0x0127
        L_0x0125:
        ...
        L_0x0127:
            ...
            long r13 = r13 - r3
            boolean r0 = f6141c     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x0187 }
        ...
        L_0x014e:
            ...
            r13 = 4
            com.google.android.gms.internal.ads.zzan r14 = r22.K()     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x0187 }
            int r14 = r14.c()     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x0187 }
            ...
            r11[r13] = r14     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x0187 }
            com.google.android.gms.internal.ads.zzaq.a(r0, r11)     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x0187 }
        L_0x0169:
            ...
            r13 = r8
            r17 = r5
            r11.<init>((int) r12, (byte[]) r13, (boolean) r14, (long) r15, (java.util.List<com.google.android.gms.internal.ads.zzu>) r17)     // Catch:{ SocketTimeoutException -> 0x022b, MalformedURLException -> 0x020a, IOException -> 0x0187 }
            return r0
        L_0x0181:
        ...
        L_0x0197:
            ...
            com.google.android.gms.internal.ads.zzaq.b(r6, r5)
