...
final class w60 extends v60 {
    ...
    private static final Class<?> f5373c = Collections.unmodifiableList(Collections.emptyList()).getClass();
    ...
    public final void c(Object obj, long j) {
        ...
        if (list instanceof zzegw) {
            obj2 = ((zzegw) list).H();
        } else if (!f5373c.isAssignableFrom(list.getClass())) {
