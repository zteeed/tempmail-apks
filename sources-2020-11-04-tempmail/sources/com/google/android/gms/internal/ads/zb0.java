...
final class zb0 {
    ...
    private final zzpi f5635a = new zzpi(8);
    ...
    private final long b(zzjw zzjw) throws IOException, InterruptedException {
        int i = 0;
        zzjw.a(this.f5635a.f9163a, 0, 1);
        byte b2 = this.f5635a.f9163a[0] & 255;
        if (b2 == 0) {
        ...
        int i4 = b2 & (~i2);
        zzjw.a(this.f5635a.f9163a, 1, i3);
        while (i < i3) {
            i++;
            i4 = (this.f5635a.f9163a[i] & 255) + (i4 << 8);
        }
        this.f5636b += i3 + 1;
        return (long) i4;
    }
    ...
    public final boolean a(com.google.android.gms.internal.ads.zzjw r18) throws java.io.IOException, java.lang.InterruptedException {
        ...
        L_0x0016:
            int r5 = (int) r4
            com.google.android.gms.internal.ads.zzpi r4 = r0.f5635a
            byte[] r4 = r4.f9163a
            r6 = 0
            r7 = 4
            r1.a(r4, r6, r7)
        ...
        L_0x0028:
            ...
            return r6
        L_0x0038:
            com.google.android.gms.internal.ads.zzpi r7 = r0.f5635a
            byte[] r7 = r7.f9163a
            r1.a(r7, r6, r4)
            r4 = 8
            long r9 = r9 << r4
