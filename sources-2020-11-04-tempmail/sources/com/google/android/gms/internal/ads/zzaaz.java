...
public final class zzaaz {
    ...
    private Map<String, String> f5726b;

    /* renamed from: c  reason: collision with root package name */
    private Context f5727c = null;
    ...
    public zzaaz(Context context, String str) {
        ...
        this.f5727c = context;
        this.f5728d = str;
        this.f5725a = zzace.f5758b.a();
        LinkedHashMap linkedHashMap = new LinkedHashMap();
        this.f5726b = linkedHashMap;
        linkedHashMap.put("s", "gmob_sdk");
        this.f5726b.put("v", "3");
        this.f5726b.put("os", Build.VERSION.RELEASE);
        this.f5726b.put("api_v", Build.VERSION.SDK);
        ...
        map2.put("app", str2);
        Map<String, String> map3 = this.f5726b;
        zzq.zzkw();
        map3.put("is_lite_sdk", zzaye.H(context) ? "1" : "0");
        Future<zzasr> b2 = zzq.zzlh().b(this.f5727c);
        try {
            this.f5726b.put("network_coarse", Integer.toString(b2.get().j));
            this.f5726b.put("network_fine", Integer.toString(b2.get().k));
        } catch (Exception e2) {
