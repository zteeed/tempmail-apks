...
public final class zzarl implements zzarp {
    ...
    private static final Object f6071f = new Object();
    @VisibleForTesting
    ...
    private final WeakHashMap<Thread, Boolean> f6074c;

    /* renamed from: d  reason: collision with root package name */
    private final ExecutorService f6075d;

    /* renamed from: e  reason: collision with root package name */
    private final zzbbd f6076e;
    ...
    private final Uri.Builder c(String str, String str2, String str3, int i) {
        ...
        String str4;
        try {
            z = Wrappers.a(this.f6073b).g();
        } catch (Throwable th) {
            zzbba.c("Error fetching instant app info", th);
            z = false;
        }
        try {
            str4 = this.f6073b.getPackageName();
        ...
        return appendQueryParameter.appendQueryParameter("device", str6).appendQueryParameter("js", this.f6076e.f6314b).appendQueryParameter("appid", str4).appendQueryParameter("exceptiontype", str).appendQueryParameter("stacktrace", str2).appendQueryParameter("eids", TextUtils.join(",", zzaav.d())).appendQueryParameter("exceptionkey", str3).appendQueryParameter("cl", "312401170").appendQueryParameter("rc", "dev").appendQueryParameter("session_id", zzwg.f()).appendQueryParameter("sampling_rate", Integer.toString(i)).appendQueryParameter("pb_tm", String.valueOf(zzacq.f5790c.a()));
    }

    public static zzarp f(Context context, zzbbd zzbbd) {
        synchronized (f6071f) {
            if (h == null) {
                if (zzacq.f5792e.a().booleanValue()) {
                    if (!((Boolean) zzwg.e().c(zzaav.J3)).booleanValue()) {
                        zzarl zzarl = new zzarl(context, zzbbd);
                        Thread thread = Looper.getMainLooper().getThread();
                        if (thread != null) {
                            synchronized (zzarl.f6072a) {
                                zzarl.f6074c.put(thread, Boolean.TRUE);
                            }
        ...
        if (zzbaq.s(th) != null) {
            ...
            if (z) {
                ...
                while (i < size) {
                    ...
                    i++;
                    this.f6075d.execute(new q3(new zzbbe(), (String) obj));
                }
            }
        }
    }
    ...
    private zzarl(Context context, zzbbd zzbbd) {
        ...
        this.f6074c = new WeakHashMap<>();
        this.f6075d = zzdrn.a().a(zzdrs.f8538a);
        this.f6073b = context.getApplicationContext() != null ? context.getApplicationContext() : context;
        this.f6076e = zzbbd;
    }
}
