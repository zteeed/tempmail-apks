...
final class w6 extends y6 implements ViewTreeObserver.OnScrollChangedListener {
    ...
    private final WeakReference<ViewTreeObserver.OnScrollChangedListener> f5372c;

    public w6(View view, ViewTreeObserver.OnScrollChangedListener onScrollChangedListener) {
        super(view);
        this.f5372c = new WeakReference<>(onScrollChangedListener);
    }
    ...
    public final void onScrollChanged() {
        ViewTreeObserver.OnScrollChangedListener onScrollChangedListener = (ViewTreeObserver.OnScrollChangedListener) this.f5372c.get();
