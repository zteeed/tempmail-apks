...
public abstract class zzdog<E> {
    ...
    public static final zzdvf<?> f8433d = zzdux.g(null);
    /* access modifiers changed from: private */

    /* renamed from: a  reason: collision with root package name */
    public final zzdvi f8434a;
    /* access modifiers changed from: private */

    /* renamed from: b  reason: collision with root package name */
    public final ScheduledExecutorService f8435b;
    /* access modifiers changed from: private */

    /* renamed from: c  reason: collision with root package name */
    public final zzdos<E> f8436c;

    public zzdog(zzdvi zzdvi, ScheduledExecutorService scheduledExecutorService, zzdos<E> zzdos) {
        this.f8434a = zzdvi;
        this.f8435b = scheduledExecutorService;
        this.f8436c = zzdos;
    }
