...
public final class zzrc {
    ...
    private final zzrr f9233e;

    /* renamed from: f  reason: collision with root package name */
    private final zzry f9234f;
    ...
    public zzrc(int i2, int i3, int i4, int i5, int i6, int i7, int i8, boolean z) {
        ...
        this.f9231c = i4;
        this.f9232d = z;
        this.f9233e = new zzrr(i5);
        this.f9234f = new zzry(i6, i7, i8);
    }
    ...
    private final void f(String str, boolean z, float f2, float f3, float f4, float f5) {
        if (str != null && str.length() >= this.f9231c) {
            synchronized (this.g) {
                this.h.add(str);
                this.k += str.length();
                if (z) {
    ...
    private final int g(int i2, int i3) {
        ...
        return (i2 * this.f9229a) + (i3 * this.f9230b);
    }
    ...
    public final void p() {
        synchronized (this.g) {
            ...
            if (g2 > this.n) {
                this.n = g2;
                if (!zzq.zzla().r().w()) {
                    this.o = this.f9233e.a(this.h);
                    this.p = this.f9233e.a(this.i);
                }
                if (!zzq.zzla().r().q()) {
                    this.q = this.f9234f.a(this.i, this.j);
                }
            }
        }
    }
