...
public final class zzamn {
    ...
    public final List<String> f5974a;
    ...
    public zzamn(JSONObject jSONObject) throws JSONException {
        ...
        this.f5974a = Collections.unmodifiableList(arrayList);
        ...
        this.f5975b = optJSONObject2 != null ? optJSONObject2.toString() : null;
        ...
        this.f5976c = jSONObject.optString("response_type", (String) null);
