...
public final class zzbao {
    ...
    private static Map<String, List<Map<String, Object>>> f6295a = new HashMap();

    /* renamed from: b  reason: collision with root package name */
    private static List<MediaCodecInfo> f6296b;

    /* renamed from: c  reason: collision with root package name */
    private static final Object f6297c = new Object();
    ...
    public static List<Map<String, Object>> b(String str) {
        synchronized (f6297c) {
            if (f6295a.containsKey(str)) {
                List<Map<String, Object>> list = f6295a.get(str);
                return list;
            }
            try {
                synchronized (f6297c) {
                    if (f6296b == null) {
                        if (Build.VERSION.SDK_INT >= 21) {
                            f6296b = Arrays.asList(new MediaCodecList(0).getCodecInfos());
                        } else {
                            int codecCount = MediaCodecList.getCodecCount();
                            f6296b = new ArrayList(codecCount);
                            for (int i = 0; i < codecCount; i++) {
                                f6296b.add(MediaCodecList.getCodecInfoAt(i));
                            }
                        }
                    }
                }
                ArrayList arrayList = new ArrayList();
                for (MediaCodecInfo next : f6296b) {
