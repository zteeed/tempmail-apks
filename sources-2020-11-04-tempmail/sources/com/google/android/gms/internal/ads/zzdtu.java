...
public class zzdtu<V> extends zzdwa implements zzdvf<V> {
    ...
    public static final boolean f8558e;

    /* renamed from: f  reason: collision with root package name */
    private static final Logger f8559f = Logger.getLogger(zzdtu.class.getName());
    /* access modifiers changed from: private */
    ...
    public volatile Object f8560b;
    /* access modifiers changed from: private */
    @NullableDecl

    /* renamed from: c  reason: collision with root package name */
    public volatile e f8561c;
    /* access modifiers changed from: private */
    @NullableDecl

    /* renamed from: d  reason: collision with root package name */
    public volatile l f8562d;
    ...
    static final class c {
        ...
        /* renamed from: b  reason: collision with root package name */
        static final c f8563b = new c(new a("Failure occurred while trying to finish a future."));

        /* renamed from: a  reason: collision with root package name */
        final Throwable f8564a;
    ...
    static final class d {
        ...
        /* renamed from: c  reason: collision with root package name */
        static final d f8565c;

        /* renamed from: d  reason: collision with root package name */
        static final d f8566d;
        ...
        static {
            ...
            f8566d = new d(false, (Throwable) null);
            f8565c = new d(true, (Throwable) null);
        }
    ...
    static final class e {
        ...
        /* renamed from: d  reason: collision with root package name */
        static final e f8569d = new e((Runnable) null, (Executor) null);

        /* renamed from: a  reason: collision with root package name */
        final Runnable f8570a;

        /* renamed from: b  reason: collision with root package name */
        final Executor f8571b;
        @NullableDecl
    ...
    static final class f<V> implements Runnable {
        ...
        /* renamed from: b  reason: collision with root package name */
        final zzdtu<V> f8573b;

        /* renamed from: c  reason: collision with root package name */
        final zzdvf<? extends V> f8574c;
        ...
        public final void run() {
            if (this.f8573b.f8560b == this) {
                if (zzdtu.g.e(this.f8573b, this, zzdtu.c(this.f8574c))) {
                    zzdtu.q(this.f8573b);
                }
            }
        }
    ...
    static final class g extends b {
        ...
        /* renamed from: a  reason: collision with root package name */
        final AtomicReferenceFieldUpdater<l, Thread> f8575a;

        /* renamed from: b  reason: collision with root package name */
        final AtomicReferenceFieldUpdater<l, l> f8576b;

        /* renamed from: c  reason: collision with root package name */
        final AtomicReferenceFieldUpdater<zzdtu, l> f8577c;

        /* renamed from: d  reason: collision with root package name */
        final AtomicReferenceFieldUpdater<zzdtu, e> f8578d;

        /* renamed from: e  reason: collision with root package name */
        final AtomicReferenceFieldUpdater<zzdtu, Object> f8579e;
        ...
        g(AtomicReferenceFieldUpdater<l, Thread> atomicReferenceFieldUpdater, AtomicReferenceFieldUpdater<l, l> atomicReferenceFieldUpdater2, AtomicReferenceFieldUpdater<zzdtu, l> atomicReferenceFieldUpdater3, AtomicReferenceFieldUpdater<zzdtu, e> atomicReferenceFieldUpdater4, AtomicReferenceFieldUpdater<zzdtu, Object> atomicReferenceFieldUpdater5) {
            super();
            this.f8575a = atomicReferenceFieldUpdater;
            this.f8576b = atomicReferenceFieldUpdater2;
            this.f8577c = atomicReferenceFieldUpdater3;
            this.f8578d = atomicReferenceFieldUpdater4;
            this.f8579e = atomicReferenceFieldUpdater5;
        }

        /* access modifiers changed from: package-private */
        public final void a(l lVar, l lVar2) {
            this.f8576b.lazySet(lVar, lVar2);
        }

        /* access modifiers changed from: package-private */
        public final void b(l lVar, Thread thread) {
            this.f8575a.lazySet(lVar, thread);
        }

        /* access modifiers changed from: package-private */
        public final boolean c(zzdtu<?> zzdtu, e eVar, e eVar2) {
            return this.f8578d.compareAndSet(zzdtu, eVar, eVar2);
        }

        /* access modifiers changed from: package-private */
        public final boolean d(zzdtu<?> zzdtu, l lVar, l lVar2) {
            return this.f8577c.compareAndSet(zzdtu, lVar, lVar2);
        }

        /* access modifiers changed from: package-private */
        public final boolean e(zzdtu<?> zzdtu, Object obj, Object obj2) {
            return this.f8579e.compareAndSet(zzdtu, obj, obj2);
        }
    }
    ...
    static final class i extends b {
        ...
        public final boolean c(zzdtu<?> zzdtu, e eVar, e eVar2) {
            synchronized (zzdtu) {
                if (zzdtu.f8561c != eVar) {
                    return false;
                }
                e unused = zzdtu.f8561c = eVar2;
                return true;
            }
        }
        ...
        public final boolean d(zzdtu<?> zzdtu, l lVar, l lVar2) {
            synchronized (zzdtu) {
                if (zzdtu.f8562d != lVar) {
                    return false;
                }
                l unused = zzdtu.f8562d = lVar2;
                return true;
            }
        }
        ...
        public final boolean e(zzdtu<?> zzdtu, Object obj, Object obj2) {
            synchronized (zzdtu) {
                ...
                Object unused = zzdtu.f8560b = obj2;
                return true;
            }
        }
    }
    ...
    static final class j extends b {
        ...
        /* renamed from: a  reason: collision with root package name */
        static final Unsafe f8580a;

        /* renamed from: b  reason: collision with root package name */
        static final long f8581b;

        /* renamed from: c  reason: collision with root package name */
        static final long f8582c;

        /* renamed from: d  reason: collision with root package name */
        static final long f8583d;

        /* renamed from: e  reason: collision with root package name */
        static final long f8584e;

        /* renamed from: f  reason: collision with root package name */
        static final long f8585f;
        ...
        static {
            ...
            L_0x0012:
                ...
                f8582c = r3     // Catch:{ Exception -> 0x0053 }
                java.lang.String r3 = "c"
                java.lang.reflect.Field r3 = r2.getDeclaredField(r3)     // Catch:{ Exception -> 0x0053 }
                long r3 = r1.objectFieldOffset(r3)     // Catch:{ Exception -> 0x0053 }
                f8581b = r3     // Catch:{ Exception -> 0x0053 }
                ...
                f8585f = r2     // Catch:{ Exception -> 0x0053 }
                f8580a = r1     // Catch:{ Exception -> 0x0053 }
                return
            L_0x0053:
                r0 = move-exception
        ...
        /* access modifiers changed from: package-private */
        public final void a(l lVar, l lVar2) {
            f8580a.putObject(lVar, f8585f, lVar2);
        }

        /* access modifiers changed from: package-private */
        public final void b(l lVar, Thread thread) {
            f8580a.putObject(lVar, f8584e, thread);
        }

        /* access modifiers changed from: package-private */
        public final boolean c(zzdtu<?> zzdtu, e eVar, e eVar2) {
            return f8580a.compareAndSwapObject(zzdtu, f8581b, eVar, eVar2);
        }

        /* access modifiers changed from: package-private */
        public final boolean d(zzdtu<?> zzdtu, l lVar, l lVar2) {
            return f8580a.compareAndSwapObject(zzdtu, f8582c, lVar, lVar2);
        }

        /* access modifiers changed from: package-private */
        public final boolean e(zzdtu<?> zzdtu, Object obj, Object obj2) {
            return f8580a.compareAndSwapObject(zzdtu, f8583d, obj, obj2);
        }
    }
    ...
    static final class l {
        ...
        /* renamed from: c  reason: collision with root package name */
        static final l f8586c = new l(false);
        @NullableDecl

        /* renamed from: a  reason: collision with root package name */
        volatile Thread f8587a;
        @NullableDecl
    ...
    static {
        ...
        g = bVar;
        if (th != null) {
            f8559f.logp(Level.SEVERE, "com.google.common.util.concurrent.AbstractFuture", "<clinit>", "UnsafeAtomicHelper is broken!", th2);
            f8559f.logp(Level.SEVERE, "com.google.common.util.concurrent.AbstractFuture", "<clinit>", "SafeAtomicHelper is broken!", th);
        }
    }
    ...
    public static Object c(zzdvf<?> zzdvf) {
        ...
        if (zzdvf instanceof h) {
            ...
            if (dVar.f8568b != null) {
                return new d(false, dVar.f8568b);
            }
            return d.f8566d;
    ...
    private final void p(l lVar) {
        ...
        while (true) {
            ...
            if (lVar2 != l.f8586c) {
                l lVar3 = null;
                while (lVar2 != null) {
                    l lVar4 = lVar2.f8588b;
                    if (lVar2.f8587a != null) {
                        lVar3 = lVar2;
                    } else if (lVar3 != null) {
                        lVar3.f8588b = lVar4;
                        if (lVar3.f8587a == null) {
                        }
    ...
    public static void q(zzdtu<?> zzdtu) {
        ...
        zzdtu<?> zzdtu3 = zzdtu;
        while (true) {
            l lVar = zzdtu3.f8562d;
            if (g.d(zzdtu3, lVar, l.f8586c)) {
                while (lVar != null) {
                    Thread thread = lVar.f8587a;
                    if (thread != null) {
                        lVar.f8587a = null;
                ...
                do {
                    eVar = zzdtu3.f8561c;
                } while (!g.c(zzdtu3, eVar, e.f8569d));
                while (true) {
                    eVar2 = eVar3;
                    eVar3 = eVar;
                    if (eVar3 == null) {
                ...
                while (eVar2 != null) {
                    eVar3 = eVar2.f8572c;
                    Runnable runnable = eVar2.f8570a;
                    if (runnable instanceof f) {
                        f fVar = (f) runnable;
                        zzdtu<V> zzdtu4 = fVar.f8573b;
                        if (zzdtu4.f8560b == fVar) {
                            if (g.e(zzdtu4, fVar, c(fVar.f8574c))) {
                                zzdtu2 = zzdtu4;
                            }
                        } else {
                            continue;
    ...
    private static V u(Object obj) throws ExecutionException {
        if (obj instanceof d) {
            Throwable th = ((d) obj).f8568b;
            CancellationException cancellationException = new CancellationException("Task was cancelled.");
            cancellationException.initCause(th);
            throw cancellationException;
        } else if (obj instanceof c) {
            throw new ExecutionException(((c) obj).f8564a);
        } else if (obj == h) {
            return null;
        } else {
            return obj;
    ...
    public boolean cancel(boolean r8) {
        ...
        L_0x001f:
            ...
            com.google.android.gms.internal.ads.zzdtu$d r3 = com.google.android.gms.internal.ads.zzdtu.d.f8565c
            goto L_0x0026
        L_0x0024:
            com.google.android.gms.internal.ads.zzdtu$d r3 = com.google.android.gms.internal.ads.zzdtu.d.f8566d
        L_0x0026:
            r5 = 0
            r4 = r7
        L_0x0028:
        ...
        L_0x0035:
            ...
            com.google.android.gms.internal.ads.zzdvf<? extends V> r0 = r0.f8574c
    ...
    public void f(Runnable runnable, Executor executor) {
        ...
        if (isDone() || (eVar = this.f8561c) == e.f8569d) {
            r(runnable, executor);
        }
    ...
    public V get(long j2, TimeUnit timeUnit) throws InterruptedException, TimeoutException, ExecutionException {
        ...
        if (!Thread.interrupted()) {
            ...
            if (nanos >= 1000) {
                ...
                return u(this.f8560b);
            }
            while (nanos > 0) {
                Object obj3 = this.f8560b;
    ...
    public boolean isCancelled() {
        return this.f8560b instanceof d;
    }
    ...
    public final boolean l() {
        Object obj = this.f8560b;
        return (obj instanceof d) && ((d) obj).f8567a;
    }
