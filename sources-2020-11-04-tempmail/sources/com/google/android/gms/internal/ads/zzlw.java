...
public final class zzlw {
    ...
    private static final zzlt f9036a = zzlt.f("OMX.google.raw.decoder");

    /* renamed from: b  reason: collision with root package name */
    private static final Pattern f9037b = Pattern.compile("^\\D?(\\d+)$");

    /* renamed from: c  reason: collision with root package name */
    private static final HashMap<a, List<zzlt>> f9038c = new HashMap<>();

    /* renamed from: d  reason: collision with root package name */
    private static final SparseIntArray f9039d;

    /* renamed from: e  reason: collision with root package name */
    private static final SparseIntArray f9040e;

    /* renamed from: f  reason: collision with root package name */
    private static final Map<String, Integer> f9041f;
    ...
    static final class a {
        ...
        public final boolean equals(Object obj) {
            ...
            if (obj != null && obj.getClass() == a.class) {
                a aVar = (a) obj;
                return TextUtils.equals(this.f9042a, aVar.f9042a) && this.f9043b == aVar.f9043b;
            }
        }

        public final int hashCode() {
            String str = this.f9042a;
            return (((str == null ? 0 : str.hashCode()) + 31) * 31) + (this.f9043b ? 1231 : 1237);
        }
    }

    static {
        SparseIntArray sparseIntArray = new SparseIntArray();
        f9039d = sparseIntArray;
        sparseIntArray.put(66, 1);
        f9039d.put(77, 2);
        f9039d.put(88, 4);
        f9039d.put(100, 8);
        SparseIntArray sparseIntArray2 = new SparseIntArray();
        f9040e = sparseIntArray2;
        ...
        f9040e.put(22, 128);
        f9040e.put(30, 256);
        f9040e.put(31, AdRequest.MAX_CONTENT_URL_LENGTH);
        f9040e.put(32, 1024);
        f9040e.put(40, 2048);
        f9040e.put(41, CodedOutputStream.DEFAULT_BUFFER_SIZE);
        f9040e.put(42, 8192);
        f9040e.put(50, 16384);
        f9040e.put(51, 32768);
        f9040e.put(52, 65536);
        ...
        f9041f.put("L90", 64);
        f9041f.put("L93", 256);
        f9041f.put("L120", 1024);
        f9041f.put("L123", Integer.valueOf(CodedOutputStream.DEFAULT_BUFFER_SIZE));
        f9041f.put("L150", 16384);
        f9041f.put("L153", 65536);
        f9041f.put("L156", 262144);
        f9041f.put("L180", 1048576);
        f9041f.put("L183", 4194304);
        f9041f.put("L186", 16777216);
        f9041f.put("H30", 2);
        f9041f.put("H60", 8);
        f9041f.put("H63", 32);
        f9041f.put("H90", 128);
        f9041f.put("H93", Integer.valueOf(AdRequest.MAX_CONTENT_URL_LENGTH));
        f9041f.put("H120", 2048);
        f9041f.put("H123", 8192);
        f9041f.put("H150", 32768);
        f9041f.put("H153", 131072);
        f9041f.put("H156", 524288);
        f9041f.put("H180", 2097152);
        f9041f.put("H183", 8388608);
        f9041f.put("H186", 33554432);
    }
    ...
    private static Pair<Integer, Integer> a(String str, String[] strArr) {
        ...
        try {
            ...
            Integer valueOf4 = Integer.valueOf(f9039d.get(num2.intValue()));
            if (valueOf4 == null) {
            ...
            Integer valueOf6 = Integer.valueOf(f9040e.get(num.intValue()));
            if (valueOf6 != null) {
    ...
    private static java.util.List<com.google.android.gms.internal.ads.zzlt> b(com.google.android.gms.internal.ads.zzlw.a r17, com.google.android.gms.internal.ads.vc0 r18) throws com.google.android.gms.internal.ads.zzma {
        /*
            ...
            java.lang.String r4 = r1.f9042a     // Catch:{ Exception -> 0x02ae }
        ...
        L_0x0014:
            ...
            goto L_0x01af
        L_0x0030:
            int r0 = com.google.android.gms.internal.ads.zzpo.f9178a     // Catch:{ Exception -> 0x02ae }
            r13 = 21
        ...
        L_0x0078:
            ...
            java.lang.String r13 = com.google.android.gms.internal.ads.zzpo.f9179b     // Catch:{ Exception -> 0x02ae }
        ...
        L_0x0090:
            ...
            java.lang.String r14 = com.google.android.gms.internal.ads.zzpo.f9179b     // Catch:{ Exception -> 0x02ae }
            ...
            boolean r0 = r0.equals(r14)     // Catch:{ Exception -> 0x02ae }
            if (r0 != 0) goto L_0x01af
            java.lang.String r0 = com.google.android.gms.internal.ads.zzpo.f9179b     // Catch:{ Exception -> 0x02ae }
        ...
        L_0x014d:
            ...
            java.lang.String r15 = com.google.android.gms.internal.ads.zzpo.f9180c     // Catch:{ Exception -> 0x02ae }
        ...
        L_0x01b8:
            ...
            int r2 = com.google.android.gms.internal.ads.zzpo.f9178a     // Catch:{ Exception -> 0x022e }
            r16 = r5
            r5 = 22
            if (r2 > r5) goto L_0x01fa
            java.lang.String r2 = com.google.android.gms.internal.ads.zzpo.f9181d     // Catch:{ Exception -> 0x01f8 }
        ...
        L_0x01fb:
            ...
            boolean r5 = r1.f9043b     // Catch:{ Exception -> 0x01f8 }
        ...
        L_0x0231:
            r5 = 1
        L_0x0232:
            int r2 = com.google.android.gms.internal.ads.zzpo.f9178a     // Catch:{ Exception -> 0x02ae }
            r7 = 23
    ...
    public static android.util.Pair<java.lang.Integer, java.lang.Integer> d(java.lang.String r9) {
        ...
        L_0x006b:
            ...
            return r0
        L_0x006f:
            java.util.regex.Pattern r2 = f9037b
            r3 = r1[r8]
        ...
        L_0x00ab:
            java.util.Map<java.lang.String, java.lang.Integer> r9 = f9041f
            r1 = r1[r6]
    ...
    private static synchronized List<zzlt> e(String str, boolean z) throws zzma {
        synchronized (zzlw.class) {
            a aVar = new a(str, z);
            List<zzlt> list = f9038c.get(aVar);
            if (list != null) {
                return list;
            }
            List<zzlt> b2 = b(aVar, zzpo.f9178a >= 21 ? new wc0(z) : new xc0());
            if (z && b2.isEmpty() && 21 <= zzpo.f9178a && zzpo.f9178a <= 23) {
                b2 = b(aVar, new xc0());
                if (!b2.isEmpty()) {
                    String str2 = b2.get(0).f9029a;
            ...
            f9038c.put(aVar, unmodifiableList);
    ...
    public static int g() throws zzma {
        if (g == -1) {
            ...
            if (c2 != null) {
                ...
                i = Math.max(i2, zzpo.f9178a >= 21 ? 345600 : 172800);
            }
            g = i;
        }
        return g;
