...
final class sa0 {
    ...
    public sa0(zzhv[] zzhvArr, zzhy[] zzhyArr, long j2, zzoe zzoe, zzhu zzhu, zznb zznb, Object obj, int i2, int i3, boolean z, long j3) {
        ...
        this.i = z;
        this.h = j3;
        this.f5072d = new zznk[zzhvArr.length];
        this.f5073e = new boolean[zzhvArr.length];
        this.f5069a = zznb.a(i3, zzhu.d());
    }

    public final void a() {
        try {
            this.r.e(this.f5069a);
    ...
    public final long b(long j2, boolean z, boolean[] zArr) {
        ...
        long d2 = this.f5069a.d(zzof.b(), this.f5073e, this.f5072d, zArr, j2);
        this.s = this.m;
        this.k = false;
        int i3 = 0;
        while (true) {
            zznk[] zznkArr = this.f5072d;
            if (i3 < zznkArr.length) {
                ...
                this.q.e(this.n, this.m.f9117a, zzof);
                return d2;
            }
        }
    }
    ...
    public final long e() {
        return this.f5074f - this.h;
    }

    public final boolean f() {
        if (this.j) {
            return !this.k || this.f5069a.n() == Long.MIN_VALUE;
        }
        return false;
    }
    ...
    public final boolean g() throws com.google.android.gms.internal.ads.zzhb {
        /*
            ...
            com.google.android.gms.internal.ads.zzmz r2 = r6.f5069a
        ...
        L_0x0016:
            r4 = 0
        L_0x0017:
            com.google.android.gms.internal.ads.zzof r5 = r0.f9118b
            int r5 = r5.f9114a
