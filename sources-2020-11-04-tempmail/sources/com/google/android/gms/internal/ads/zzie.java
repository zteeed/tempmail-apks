...
public final class zzie {
    ...
    private static final int[] f8940a = {1, 2, 3, 6};

    /* renamed from: b  reason: collision with root package name */
    private static final int[] f8941b = {48000, 44100, 32000};

    /* renamed from: c  reason: collision with root package name */
    private static final int[] f8942c = {2, 1, 2, 3, 3, 4, 4, 5};

    public static zzhq a(zzpi zzpi, String str, String str2, zzjl zzjl) {
        int i = f8941b[(zzpi.g() & 192) >> 6];
        int g = zzpi.g();
        int i2 = f8942c[(g & 56) >> 3];
        if ((g & 4) != 0) {
            i2++;
        }
    ...
    public static int d(ByteBuffer byteBuffer) {
        ...
        if (((byteBuffer.get(byteBuffer.position() + 4) & 192) >> 6) != 3) {
            i = f8940a[(byteBuffer.get(byteBuffer.position() + 4) & 48) >> 4];
        }
        return i * 256;
    }
}
