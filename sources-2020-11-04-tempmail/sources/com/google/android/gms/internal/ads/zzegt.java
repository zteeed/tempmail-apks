...
public final class zzegt extends m50<String> implements zzegw, RandomAccess {
    ...
    private static final zzegt f8765d;

    /* renamed from: c  reason: collision with root package name */
    private final List<Object> f8766c;
    ...
    public final List<?> E() {
        return Collections.unmodifiableList(this.f8766c);
    }
    ...
    public final Object I(int i) {
        return this.f8766c.get(i);
    }

    public final /* synthetic */ void add(int i, Object obj) {
        c();
        this.f8766c.add(i, (String) obj);
        this.modCount++;
    }
    ...
    public final /* synthetic */ Object set(int i, Object obj) {
        c();
        return h(this.f8766c.set(i, (String) obj));
    }
    ...
    public final boolean addAll(int i, Collection<? extends String> collection) {
        ...
        boolean addAll = this.f8766c.addAll(i, collection);
        this.modCount++;
        return addAll;
    }
    ...
    public final /* synthetic */ Object remove(int i) {
        c();
        Object remove = this.f8766c.remove(i);
        this.modCount++;
        return h(remove);
    }
