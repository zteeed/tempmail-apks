...
public abstract class zzefl extends zzeeo {
    ...
    private static final Logger f8728b = Logger.getLogger(zzefl.class.getName());
    /* access modifiers changed from: private */

    /* renamed from: c  reason: collision with root package name */
    public static final boolean f8729c = v80.m();
    ...
    static class a extends zzefl {
        ...
        private final void G0(byte[] bArr, int i, int i2) throws IOException {
            try {
                System.arraycopy(bArr, i, this.f8731d, this.f8733f, i2);
                this.f8733f += i2;
            } catch (IndexOutOfBoundsException e2) {
                throw new zza(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.f8733f), Integer.valueOf(this.f8732e), Integer.valueOf(i2)}), e2);
            }
        }
        ...
        public final int D() {
            return this.f8732e - this.f8733f;
        }
        ...
        public final void N(byte b2) throws IOException {
            try {
                ...
                throw new zza(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.f8733f), Integer.valueOf(this.f8732e), 1}), e2);
            }
        }

        public final void P(long j) throws IOException {
            if (!zzefl.f8729c || D() < 10) {
                while ((j & -128) != 0) {
                    byte[] bArr = this.f8731d;
                    int i = this.f8733f;
                    this.f8733f = i + 1;
        ...
        public final void R(long j) throws IOException {
            try {
                ...
                byte[] bArr5 = this.f8731d;
                int i6 = i5 + 1;
                this.f8733f = i6;
                bArr5[i5] = (byte) ((int) (j >> 32));
                byte[] bArr6 = this.f8731d;
                int i7 = i6 + 1;
                this.f8733f = i7;
                bArr6[i6] = (byte) ((int) (j >> 40));
                byte[] bArr7 = this.f8731d;
                int i8 = i7 + 1;
                this.f8733f = i8;
                bArr7[i7] = (byte) ((int) (j >> 48));
                byte[] bArr8 = this.f8731d;
                this.f8733f = i8 + 1;
        ...
        public final void b0(int i) throws IOException {
            if (!zzefl.f8729c || l50.a() || D() < 5) {
                ...
                int i12 = i9 >>> 7;
                if ((i12 & -128) == 0) {
                    byte[] bArr9 = this.f8731d;
                    int i13 = this.f8733f;
                    this.f8733f = i13 + 1;
                    v80.h(bArr9, (long) i13, (byte) i12);
                    return;
                }
                byte[] bArr10 = this.f8731d;
                int i14 = this.f8733f;
                this.f8733f = i14 + 1;
                v80.h(bArr10, (long) i14, (byte) (i12 | 128));
                byte[] bArr11 = this.f8731d;
                int i15 = this.f8733f;
                this.f8733f = i15 + 1;
        ...
        public final void q0(String str) throws IOException {
            ...
            try {
                ...
                if (g02 == g0) {
                    int i2 = i + g02;
                    this.f8733f = i2;
                    int b2 = y80.b(str, this.f8731d, i2, D());
                    this.f8733f = i;
                    b0((b2 - i) - g02);
                    this.f8733f = b2;
                    return;
                ...
                b0(y80.a(str));
                this.f8733f = y80.b(str, this.f8731d, this.f8733f, D());
            } catch (b90 e2) {
                this.f8733f = i;
                j(str, e2);
    ...
    public static int r0(String str) {
        ...
        try {
            ...
            i = str.getBytes(zzegd.f8758a).length;
        }
        return g0(i) + i;
    }
    ...
    public final void j(String str, b90 b90) throws IOException {
        f8728b.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", b90);
        byte[] bytes = str.getBytes(zzegd.f8758a);
        try {
            b0(bytes.length);
