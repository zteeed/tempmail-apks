...
final class tz<K, V> extends zzdsw<K, V> {
    ...
    private final transient Object f5202e;

    /* renamed from: f  reason: collision with root package name */
    private final transient Object[] f5203f;
    ...
    public final zzdsz<Map.Entry<K, V>> b() {
        return new sz(this, this.f5203f, 0, this.g);
    }

    /* access modifiers changed from: package-private */
    public final zzdsz<K> c() {
        return new uz(this, new xz(this.f5203f, 0, this.g));
    }

    /* access modifiers changed from: package-private */
    public final zzdsr<V> d() {
        return new xz(this.f5203f, 1, this.g);
    }
