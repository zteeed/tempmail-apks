...
public final class zzaay {
    ...
    private BlockingQueue<zzabi> f5719a = new ArrayBlockingQueue(100);
    @VisibleForTesting

    /* renamed from: b  reason: collision with root package name */
    private LinkedHashMap<String, String> f5720b = new LinkedHashMap<>();
    @VisibleForTesting

    /* renamed from: c  reason: collision with root package name */
    private Map<String, zzabc> f5721c = new HashMap();
    @VisibleForTesting
    ...
    private final void c(java.util.Map<java.lang.String, java.lang.String> r5, java.lang.String r6) {
        ...
        L_0x00a1:
            ...
            android.content.Context r6 = r4.f5723e
            java.lang.String r0 = r4.f5724f
    ...
    public final void b(Context context, String str, String str2, Map<String, String> map) {
        ...
        atomicBoolean.set(zzach.f5770c.a().booleanValue());
        ...
        for (Map.Entry next : map.entrySet()) {
            this.f5720b.put((String) next.getKey(), (String) next.getValue());
        }
        zzbbf.f6320a.execute(new m(this));
        this.f5721c.put("action", zzabc.f5730b);
        this.f5721c.put("ad_format", zzabc.f5730b);
        this.f5721c.put("e", zzabc.f5731c);
    }

    public final boolean d(zzabi zzabi) {
        return this.f5719a.offer(zzabi);
    }

    public final zzabc e(String str) {
        zzabc zzabc = this.f5721c.get(str);
        if (zzabc != null) {
            return zzabc;
        }
        return zzabc.f5729a;
    ...
    public final void f(String str) {
        if (!this.g.contains(str)) {
            ...
            linkedHashMap.put("sdkVersion", this.f5724f);
            linkedHashMap.put("ue", str);
            c(a(this.f5720b, linkedHashMap), "");
        }
    }
    ...
    public final /* synthetic */ void g() {
        while (true) {
            try {
                zzabi take = this.f5719a.take();
                String e2 = take.e();
                if (!TextUtils.isEmpty(e2)) {
                    c(a(this.f5720b, take.f()), e2);
                }
