...
final class z50 extends zzefc {
    ...
    public final String c() throws IOException {
        int C = C();
        if (C > 0 && C <= this.f5619f - this.h) {
            String str = new String(this.f5618e, this.h, C, zzegd.f8758a);
            this.h += C;
            return str;
        } else if (C == 0) {
            return "";
    ...
    public final String l() throws IOException {
        ...
        if (C > 0) {
            ...
            int i3 = this.h;
            if (C <= i2 - i3) {
                String l = y80.l(this.f5618e, i3, C);
                this.h += C;
                return l;
            }
        }
    ...
    public final zzeer m() throws IOException {
        ...
        if (C > 0) {
            ...
            int i3 = this.h;
            if (C <= i2 - i3) {
                zzeer P = zzeer.P(this.f5618e, i3, C);
                this.h += C;
                return P;
            }
        }
        ...
        if (C > 0) {
            ...
            if (C <= i4 - i5) {
                int i6 = C + i5;
                this.h = i6;
                bArr = Arrays.copyOfRange(this.f5618e, i5, i6);
                return zzeer.V(bArr);
            }
        }
        if (C > 0) {
