...
final class o50 {
    static int a(int i, byte[] bArr, int i2, int i3, n50 n50) throws zzegl {
        if ((i >>> 3) != 0) {
            ...
            if (i4 == 2) {
                return h(bArr, i2, n50) + n50.f4632a;
            }
            if (i4 == 3) {
                int i5 = (i & -8) | 4;
                int i6 = 0;
    ...
    static int c(int i, byte[] bArr, int i2, int i3, zzejc zzejc, n50 n50) throws zzegl {
        if ((i >>> 3) != 0) {
            ...
            if (i4 == 0) {
                int j = j(bArr, i2, n50);
                zzejc.k(i, Long.valueOf(n50.f4633b));
                return j;
            } else if (i4 == 1) {
    ...
    static int k(byte[] bArr, int i, n50 n50) throws zzegl {
        ...
        if (i2 < 0) {
            ...
            n50.f4634c = new String(bArr, h, i2, zzegd.f8758a);
            return h + i2;
        }
    }
    ...
    static int m(byte[] bArr, int i, n50 n50) throws zzegl {
        ...
        if (i2 < 0) {
            ...
            n50.f4634c = zzeer.f8716c;
            return h;
        } else {
            n50.f4634c = zzeer.P(bArr, h, i2);
            return h + i2;
        }
    }
