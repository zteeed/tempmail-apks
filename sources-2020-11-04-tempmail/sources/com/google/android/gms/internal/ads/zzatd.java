...
public final class zzatd extends ContextWrapper {
    ...
    private WeakReference<Activity> f6128b = new WeakReference<>((Object) null);
    ...
    private final synchronized android.content.Intent d(android.content.Intent r3) {
        /*
            r2 = this;
            monitor-enter(r2)
            android.content.Context r0 = r2.f6127a     // Catch:{ all -> 0x0039 }
            ...
            android.content.Context r1 = r2.f6127a     // Catch:{ all -> 0x0039 }
    ...
    private final synchronized void e(Intent intent) {
        Activity activity = (Activity) this.f6128b.get();
        if (activity == null) {
    ...
    public final synchronized void a(String str) throws PackageManager.NameNotFoundException {
        this.f6127a = super.createPackageContext(str, 0);
    }
    ...
    public final synchronized ApplicationInfo getApplicationInfo() {
        if (this.f6127a != null) {
            return this.f6127a.getApplicationInfo();
        }
    ...
    public final synchronized String getPackageName() {
        if (this.f6127a != null) {
            return this.f6127a.getPackageName();
        }
    ...
    public final synchronized String getPackageResourcePath() {
        if (this.f6127a != null) {
            return this.f6127a.getPackageResourcePath();
        }
