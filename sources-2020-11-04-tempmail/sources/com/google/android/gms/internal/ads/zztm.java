...
public final class zztm {
    ...
    private final zztr f9292a;
    @GuardedBy("this")

    /* renamed from: b  reason: collision with root package name */
    private final zzty.zzi.zza f9293b;

    /* renamed from: c  reason: collision with root package name */
    private final boolean f9294c;

    public zztm(zztr zztr) {
        this.f9293b = zzty.zzi.c0();
        this.f9292a = zztr;
        this.f9294c = ((Boolean) zzwg.e().c(zzaav.i2)).booleanValue();
    }

    private final synchronized void c(zzto.zza.C0084zza zza) {
        zzty.zzi.zza zza2 = this.f9293b;
        zza2.L();
        zza2.D(g());
        zztv a2 = this.f9292a.a(((zzty.zzi) ((zzegb) this.f9293b.O())).g());
        a2.b(zza.i());
        a2.c();
    ...
    private final synchronized void d(zzto.zza.C0084zza zza) {
    ...
    private final synchronized String e(zzto.zza.C0084zza zza) {
        return String.format("id=%s,timestamp=%s,event=%s,data=%s\n", new Object[]{this.f9293b.F(), Long.valueOf(zzq.zzld().b()), Integer.valueOf(zza.i()), Base64.encodeToString(((zzty.zzi) ((zzegb) this.f9293b.O())).g(), 3)});
    }
    ...
    public final synchronized void a(zzto.zza.C0084zza zza) {
        if (this.f9294c) {
