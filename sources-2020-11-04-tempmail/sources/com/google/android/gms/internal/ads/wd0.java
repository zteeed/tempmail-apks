...
final class wd0 extends HandlerThread implements SurfaceTexture.OnFrameAvailableListener, Handler.Callback {
    ...
    private final int[] f5410b = new int[1];

    /* renamed from: c  reason: collision with root package name */
    private Handler f5411c;

    /* renamed from: d  reason: collision with root package name */
    private SurfaceTexture f5412d;

    /* renamed from: e  reason: collision with root package name */
    private Error f5413e;

    /* renamed from: f  reason: collision with root package name */
    private RuntimeException f5414f;
    private zzpv g;
    ...
    public final void a() {
        this.f5411c.sendEmptyMessage(3);
    }

    public final zzpv b(boolean z) {
        boolean z2;
        start();
        this.f5411c = new Handler(getLooper(), this);
        synchronized (this) {
            z2 = false;
            this.f5411c.obtainMessage(1, z ? 1 : 0, 0).sendToTarget();
            while (this.g == null && this.f5414f == null && this.f5413e == null) {
                try {
                    wait();
        ...
        RuntimeException runtimeException = this.f5414f;
        if (runtimeException == null) {
            Error error = this.f5413e;
            if (error == null) {
                return this.g;
            }
            throw error;
    ...
    public final boolean handleMessage(Message message) {
        ...
        if (i == 1) {
            try {
                ...
                GLES20.glGenTextures(1, this.f5410b, 0);
                SurfaceTexture surfaceTexture = new SurfaceTexture(this.f5410b[0]);
                this.f5412d = surfaceTexture;
                surfaceTexture.setOnFrameAvailableListener(this);
                this.g = new zzpv(this, this.f5412d, z);
                synchronized (this) {
                    notify();
                }
            ...
            try {
                ...
                this.g = null;
                this.f5412d = null;
                GLES20.glDeleteTextures(1, this.f5410b, 0);
                quit();
            } catch (Throwable th2) {
                try {
    ...
    public final void onFrameAvailable(SurfaceTexture surfaceTexture) {
        this.f5411c.sendEmptyMessage(2);
    }
}
