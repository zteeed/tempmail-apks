...
public abstract class zzdv implements zzdw {
    ...
    protected MotionEvent f8597b;

    /* renamed from: c  reason: collision with root package name */
    protected LinkedList<MotionEvent> f8598c = new LinkedList<>();

    /* renamed from: d  reason: collision with root package name */
    protected long f8599d = 0;

    /* renamed from: e  reason: collision with root package name */
    protected long f8600e = 0;
    ...
    private final void f() {
        ...
        if (this.f8598c.size() > 0) {
            ...
            MotionEvent motionEvent = this.f8597b;
            if (motionEvent != null) {
                motionEvent.recycle();
            }
        }
    ...
    /* access modifiers changed from: protected */
    public abstract zzcf.zza.C0073zza b(Context context, zzby.zza zza);

    /* access modifiers changed from: protected */
    public abstract zzcf.zza.C0073zza d(Context context, View view, Activity activity);

    /* access modifiers changed from: protected */
    public abstract zzfd e(MotionEvent motionEvent) throws zzeu;

    /* access modifiers changed from: protected */
    public abstract zzcf.zza.C0073zza g(Context context, View view, Activity activity);

    public String zza(Context context, View view, Activity activity) {
        return c(context, (String) null, zzcw.f7808e, view, activity, (byte[]) null);
    }
    ...
    public String zzb(Context context) {
        ...
        return c(context, (String) null, zzcw.f7807d, (View) null, (Activity) null, (byte[]) null);
    }
    ...
    public String zza(Context context, String str, View view, Activity activity) {
        return c(context, str, zzcw.f7809f, view, activity, (byte[]) null);
    }
    ...
    public void zza(MotionEvent motionEvent) {
        ...
        if (action2 == 0) {
            ...
            this.f8597b = obtain;
            this.f8598c.add(obtain);
            if (this.f8598c.size() > 6) {
                this.f8598c.remove().recycle();
            }
            this.f8601f++;
            this.h = a(new Throwable().getStackTrace());
        } else if (action2 == 2) {
            this.f8600e += (long) (motionEvent.getHistorySize() + 1);
            try {
                zzfd e2 = e(motionEvent);
                if ((e2 == null || e2.f8863e == null || e2.h == null) ? false : true) {
                    this.i += e2.f8863e.longValue() + e2.h.longValue();
                }
                if (!(this.t == null || e2 == null || e2.f8864f == null || e2.i == null)) {
                    z = true;
                }
                if (z) {
                    this.j += e2.f8864f.longValue() + e2.i.longValue();
                }
            } catch (zzeu unused) {
            }
        } else if (action2 == 3) {
    ...
    public void zza(int i2, int i3, int i4) {
        ...
        if (displayMetrics != null) {
            ...
            this.f8597b = MotionEvent.obtain(0, (long) i4, 1, ((float) i2) * f2, ((float) i3) * f2, 0.0f, 0.0f, 0, 0.0f, 0.0f, 0, 0);
        } else {
            this.f8597b = null;
        }
        this.s = false;
