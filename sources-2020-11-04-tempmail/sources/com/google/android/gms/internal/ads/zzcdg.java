...
public final class zzcdg {
    ...
    private final zzaxx f7060a;

    /* renamed from: b  reason: collision with root package name */
    private final zzdla f7061b;

    /* renamed from: c  reason: collision with root package name */
    private final zzcco f7062c;

    /* renamed from: d  reason: collision with root package name */
    private final zzcck f7063d;

    /* renamed from: e  reason: collision with root package name */
    private final zzcdo f7064e;

    /* renamed from: f  reason: collision with root package name */
    private final zzcdw f7065f;
    ...
    public static boolean e(zzcee zzcee, String[] strArr) {
        Map<String, WeakReference<View>> k6 = zzcee.k6();
        if (k6 == null) {
            return false;
        }
    ...
    public final /* synthetic */ void f(ViewGroup viewGroup) {
        ...
        if (this.f7063d.E() == null) {
            return;
        }
        if (2 == this.f7063d.A() || 1 == this.f7063d.A()) {
            this.f7060a.f(this.f7061b.f8351f, String.valueOf(this.f7063d.A()), z);
        } else if (6 == this.f7063d.A()) {
            this.f7060a.f(this.f7061b.f8351f, "2", z);
            this.f7060a.f(this.f7061b.f8351f, "1", z);
        }
    }

    public final void g(zzcee zzcee) {
        if (zzcee != null && this.f7064e != null && zzcee.V() != null && this.f7062c.c()) {
            try {
                zzcee.V().addView(this.f7064e.c());
            } catch (zzbfz e2) {
    ...
    public final void h(zzcee zzcee) {
        if (zzcee != null) {
            Context context = zzcee.S5().getContext();
            if (zzbae.g(this.f7062c.f7023a)) {
                if (!(context instanceof Activity)) {
                    zzbba.f("Activity context is needed for policy validator.");
                } else if (this.f7065f != null && zzcee.V() != null) {
                    try {
                        WindowManager windowManager = (WindowManager) context.getSystemService("window");
                        windowManager.addView(this.f7065f.a(this.f7062c.f7023a, zzcee.V(), windowManager), zzbae.n());
                    } catch (zzbfz e2) {
                        zzaxv.l("web view can not be obtained", e2);
                    }
                }
    ...
    public final /* synthetic */ void i(com.google.android.gms.internal.ads.zzcee r10) {
        /*
            r9 = this;
            com.google.android.gms.internal.ads.zzcco r0 = r9.f7062c
            boolean r0 = r0.e()
            r1 = 0
            r2 = 1
        ...
        L_0x003c:
            r0 = 0
        L_0x003d:
            android.view.View r4 = r10.S5()
            android.content.Context r4 = r4.getContext()
            android.widget.RelativeLayout$LayoutParams r6 = new android.widget.RelativeLayout$LayoutParams
            r7 = -2
            r6.<init>(r7, r7)
            com.google.android.gms.internal.ads.zzcck r7 = r9.f7063d
            android.view.View r7 = r7.B()
            if (r7 == 0) goto L_0x0069
            com.google.android.gms.internal.ads.zzcck r4 = r9.f7063d
        ...
        L_0x00b8:
            ...
            r0.addView(r4)
            android.widget.FrameLayout r5 = r10.V()
        ...
        L_0x00f6:
            ...
            com.google.android.gms.internal.ads.zzcck r0 = r9.f7063d
        ...
        L_0x012e:
            ...
            com.google.android.gms.dynamic.IObjectWrapper r1 = r1.Z2()     // Catch:{ RemoteException -> 0x014f }
            goto L_0x0161
        L_0x014f:
            ...
            return
        L_0x0155:
            com.google.android.gms.internal.ads.zzcck r1 = r9.f7063d
            com.google.android.gms.internal.ads.zzadt r1 = r1.C()
            if (r1 == 0) goto L_0x01ae
            com.google.android.gms.dynamic.IObjectWrapper r1 = r1.E2()     // Catch:{ RemoteException -> 0x01a9 }
        L_0x0161:
            if (r1 == 0) goto L_0x01ae
            java.lang.Object r1 = com.google.android.gms.dynamic.ObjectWrapper.V(r1)
            ...
            com.google.android.gms.dynamic.IObjectWrapper r3 = r10.d2()
        L_0x0179:
            ...
            goto L_0x0198
        L_0x018e:
            java.lang.Object r10 = com.google.android.gms.dynamic.ObjectWrapper.V(r3)
