...
final class l60<T extends zzefw<T>> {
    ...
    private static final l60 f4449d = new l60(true);

    /* renamed from: a  reason: collision with root package name */
    final e80<T, Object> f4450a;
    ...
    static void g(zzefl zzefl, zzejq zzejq, int i, Object obj) throws IOException {
        ...
        zzefl.b(i, zzejq.g());
        switch (k60.f4367b[zzejq.ordinal()]) {
            case 1:
    ...
    private static void j(com.google.android.gms.internal.ads.zzejq r2, java.lang.Object r3) {
        /*
            ...
            int[] r0 = com.google.android.gms.internal.ads.k60.f4366a
    ...
    private final void r(Map.Entry<T, Object> entry) {
        ...
        if (value instanceof zzegq) {
            ...
            this.f4450a.put(zzefw, f2);
        } else if (zzefw.C() == zzejt.MESSAGE) {
            Object f3 = f(zzefw);
            if (f3 == null) {
                this.f4450a.put(zzefw, k(value));
                return;
            }
    ...
    public final Iterator<Map.Entry<T, Object>> a() {
        if (this.f4452c) {
            return new t60(this.f4450a.j().iterator());
        }
        return this.f4450a.j().iterator();
    }
    ...
    public final boolean c() {
        for (int i = 0; i < this.f4450a.h(); i++) {
            if (!n(this.f4450a.p(i))) {
                return false;
            }
        }
        for (Map.Entry<T, Object> n : this.f4450a.i()) {
            if (!n(n)) {
                return false;
            }
        }
    ...
    public final /* synthetic */ Object clone() throws CloneNotSupportedException {
        l60 l60 = new l60();
        for (int i = 0; i < this.f4450a.h(); i++) {
            Map.Entry<T, Object> p = this.f4450a.p(i);
            l60.i((zzefw) p.getKey(), p.getValue());
        }
        for (Map.Entry next : this.f4450a.i()) {
            l60.i((zzefw) next.getKey(), next.getValue());
        }
        l60.f4452c = this.f4452c;
        return l60;
    }

    public final Iterator<Map.Entry<T, Object>> d() {
        if (this.f4452c) {
            return new t60(this.f4450a.entrySet().iterator());
        }
        return this.f4450a.entrySet().iterator();
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return this.f4450a.equals(((l60) obj).f4450a);
    }

    public final void h(l60<T> l60) {
        for (int i = 0; i < l60.f4450a.h(); i++) {
            r(l60.f4450a.p(i));
        }
        for (Map.Entry<T, Object> r : l60.f4450a.i()) {
            r(r);
        }
    }
    ...
    public final int q() {
        int i = 0;
        for (int i2 = 0; i2 < this.f4450a.h(); i2++) {
            i += s(this.f4450a.p(i2));
        }
        for (Map.Entry<T, Object> s : this.f4450a.i()) {
            i += s(s);
        }
        return i;
    }
