...
class x50 extends v50 {
    ...
    public final int J(int i, int i2, int i3) {
        int Y = Y() + i2;
        return y80.e(i, this.f5466e, Y, i3 + Y);
    }

    /* access modifiers changed from: protected */
    public final int M(int i, int i2, int i3) {
        return zzegd.c(i, this.f5466e, Y() + i2, i3);
    }
    ...
    public final zzeer W(int i, int i2) {
        ...
        return new s50(this.f5466e, Y() + i, O);
    }
    ...
    public final String i(Charset charset) {
        return new String(this.f5466e, Y(), size(), charset);
    }

    /* access modifiers changed from: package-private */
    public final void j(zzeeo zzeeo) throws IOException {
        zzeeo.a(this.f5466e, Y(), size());
    }

    /* access modifiers changed from: protected */
    public void q(byte[] bArr, int i, int i2, int i3) {
        System.arraycopy(this.f5466e, i, bArr, i2, i3);
    }
    ...
    public final boolean v() {
        int Y = Y();
        return y80.j(this.f5466e, Y, size() + Y);
    }

    public final zzefc w() {
        return zzefc.d(this.f5466e, Y(), size(), true);
    }
}
