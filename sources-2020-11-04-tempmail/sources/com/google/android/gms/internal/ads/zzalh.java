...
public final class zzalh implements zzajp, zzale {
    ...
    private final zzalf f5948b;

    /* renamed from: c  reason: collision with root package name */
    private final HashSet<AbstractMap.SimpleEntry<String, zzahc<? super zzalf>>> f5949c = new HashSet<>();
    ...
    public final void P() {
        Iterator<AbstractMap.SimpleEntry<String, zzahc<? super zzalf>>> it = this.f5949c.iterator();
        while (it.hasNext()) {
            ...
            this.f5948b.n((String) next.getKey(), (zzahc) next.getValue());
        }
        this.f5949c.clear();
    }
    ...
    public final void c(String str, zzahc<? super zzalf> zzahc) {
        this.f5948b.c(str, zzahc);
        this.f5949c.add(new AbstractMap.SimpleEntry(str, zzahc));
    }
    ...
    public final void n(String str, zzahc<? super zzalf> zzahc) {
        this.f5948b.n(str, zzahc);
        this.f5949c.remove(new AbstractMap.SimpleEntry(str, zzahc));
    }
