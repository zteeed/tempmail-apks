...
final class w70 extends zzeer {
    ...
    static zzeer X(zzeer zzeer, zzeer zzeer2) {
        ...
        if (zzeer instanceof w70) {
            ...
            if (w70.g.size() + zzeer2.size() < 128) {
                return new w70(w70.f5376f, Z(w70.g, zzeer2));
            } else if (w70.f5376f.z() > w70.g.z() && w70.z() > zzeer2.z()) {
                return new w70(w70.f5376f, new w70(w70.g, zzeer2));
            }
        }
    ...
    public final boolean A() {
        return this.f5375e >= b0(this.i);
    }

    public final byte C(int i2) {
        zzeer.m(i2, this.f5375e);
        return F(i2);
    }
    ...
    public final int J(int i2, int i3, int i4) {
        ...
        int i6 = this.h;
        if (i5 <= i6) {
            return this.f5376f.J(i2, i3, i4);
        }
        if (i3 >= i6) {
            return this.g.J(i2, i3 - i6, i4);
        }
        int i7 = i6 - i3;
        return this.g.J(this.f5376f.J(i2, i3, i7), 0, i4 - i7);
    }
    ...
    public final int M(int i2, int i3, int i4) {
        ...
        int i6 = this.h;
        if (i5 <= i6) {
            return this.f5376f.M(i2, i3, i4);
        }
        if (i3 >= i6) {
            return this.g.M(i2, i3 - i6, i4);
        }
        int i7 = i6 - i3;
        return this.g.M(this.f5376f.M(i2, i3, i7), 0, i4 - i7);
    }

    public final zzeer W(int i2, int i3) {
        int O = zzeer.O(i2, i3, this.f5375e);
        if (O == 0) {
            return zzeer.f8716c;
        }
        if (O == this.f5375e) {
        ...
        int i4 = this.h;
        if (i3 <= i4) {
            return this.f5376f.W(i2, i3);
        }
        if (i2 >= i4) {
            return this.g.W(i2 - i4, i3 - i4);
        }
        zzeer zzeer = this.f5376f;
    ...
    public final void q(byte[] bArr, int i2, int i3, int i4) {
        ...
        int i6 = this.h;
        if (i5 <= i6) {
            this.f5376f.q(bArr, i2, i3, i4);
        } else if (i2 >= i6) {
            this.g.q(bArr, i2 - i6, i3, i4);
        } else {
            int i7 = i6 - i2;
            this.f5376f.q(bArr, i2, i3, i7);
    ...
    public final boolean v() {
        int J = this.f5376f.J(0, 0, this.h);
        zzeer zzeer = this.g;
