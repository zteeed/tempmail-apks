...
public final class zzczr implements zzdec<zzczp> {
    ...
    private final zzdvi f7937b;

    /* renamed from: c  reason: collision with root package name */
    private final zzcix f7938c;
    ...
    public final /* synthetic */ zzczp a() throws Exception {
        ...
        for (String str : asList) {
            try {
                bundle.putBundle(str, c(this.f7938c.d(str, new JSONObject())));
            } catch (zzdlg unused) {
            }
        }
    ...
    public final zzdvf<zzczp> b() {
        if (new BigInteger(this.f7936a).equals(BigInteger.ONE)) {
            if (!zzdsi.b((String) zzwg.e().c(zzaav.I0))) {
                return this.f7937b.f(new mr(this));
            }
        }
