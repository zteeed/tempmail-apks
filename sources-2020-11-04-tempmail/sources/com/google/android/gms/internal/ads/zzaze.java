...
public final class zzaze {
        ...
        synchronized (this.f6247a) {
            if (TextUtils.isEmpty(this.f6248b)) {
                ...
                if (TextUtils.isEmpty(o0)) {
                    zzq.zzkw();
                    this.f6248b = zzaye.q0();
                    zzq.zzkw();
                    zzaye.N(context, "debug_signals_id.txt", this.f6248b);
                }
            }
            str = this.f6248b;
        }
    ...
    private final boolean h(Context context, String str, String str2) {
        ...
        try {
            ...
            this.f6251e = jSONObject.optString("status");
            synchronized (this.f6247a) {
                this.f6249c = optString;
            }
            return true;
