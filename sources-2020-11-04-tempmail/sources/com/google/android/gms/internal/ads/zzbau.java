...
public final class zzbau {
    ...
    private static Object f6304b = new Object();

    /* renamed from: c  reason: collision with root package name */
    private static boolean f6305c = false;

    /* renamed from: d  reason: collision with root package name */
    private static boolean f6306d = false;

    /* renamed from: e  reason: collision with root package name */
    private static Clock f6307e = DefaultClock.d();

    /* renamed from: f  reason: collision with root package name */
    private static final Set<String> f6308f = new HashSet(Arrays.asList(new String[0]));

    /* renamed from: a  reason: collision with root package name */
    private final List<String> f6309a;
    ...
    private final void e(String str, n6 n6Var) {
        ...
        try {
            jsonWriter.beginObject();
            jsonWriter.name("timestamp").value(f6307e.a());
            jsonWriter.name("event").value(str);
            jsonWriter.name("components").beginArray();
            for (String value : this.f6309a) {
    ...
    public static boolean o(Context context) {
        if (Build.VERSION.SDK_INT < 17 || !zzacg.f5766a.a().booleanValue()) {
            return false;
        }
        try {
