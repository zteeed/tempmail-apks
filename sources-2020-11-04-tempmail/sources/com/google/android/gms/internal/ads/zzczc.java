...
public final class zzczc implements zzddz<Bundle> {
    ...
    public final /* synthetic */ void a(Object obj) {
        ...
        zzdla zzdla = this.f7913a;
        zzve zzve = zzdla.f8349d;
        bundle.putString("slotname", zzdla.f8351f);
        boolean z = true;
        int i = fr.f4013a[this.f7913a.n.f8326a - 1];
        if (i == 1) {
            bundle.putBoolean("is_new_rewarded", true);
        } else if (i == 2) {
            bundle.putBoolean("is_rewarded_interstitial", true);
        }
        zzdlf.f(bundle, "cust_age", new SimpleDateFormat("yyyyMMdd", Locale.US).format(new Date(zzve.f9367c)), zzve.f9367c != -1);
        zzdlf.b(bundle, "extras", zzve.f9368d);
        zzdlf.d(bundle, "cust_gender", Integer.valueOf(zzve.f9369e), zzve.f9369e != -1);
        zzdlf.g(bundle, "kw", zzve.f9370f);
        zzdlf.d(bundle, "tag_for_child_directed_treatment", Integer.valueOf(zzve.h), zzve.h != -1);
        boolean z2 = zzve.g;
        if (z2) {
            bundle.putBoolean("test_request", z2);
        }
        zzdlf.d(bundle, "d_imp_hdr", 1, zzve.f9366b >= 2 && zzve.i);
        String str = zzve.j;
        zzdlf.f(bundle, "ppid", str, zzve.f9366b >= 2 && !TextUtils.isEmpty(str));
        ...
        zzdlf.c(bundle, "is_designed_for_families", Boolean.valueOf(zzve.s), zzve.f9366b >= 7);
        if (zzve.f9366b >= 8) {
