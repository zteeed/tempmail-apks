...
public final class zzpz extends zzls {
    ...
    private static int a0(java.lang.String r7, int r8, int r9) {
        ...
        L_0x005e:
            ...
            goto L_0x0080
        L_0x0061:
            java.lang.String r7 = com.google.android.gms.internal.ads.zzpo.f9181d
    ...
    private final void j0() {
        MediaCodec V2;
        this.h0 = false;
        if (zzpo.f9178a >= 23 && this.w0 && (V2 = V()) != null) {
    ...
    public final int I(zzlu zzlu, zzhq zzhq) throws zzma {
        ...
        if (zzjl != null) {
            z = false;
            for (int i4 = 0; i4 < zzjl.f8972d; i4++) {
                z |= zzjl.a(i4).f8977f;
            }
        } else {
            z = false;
    ...
    public final void L(zzlt zzlt, MediaCodec mediaCodec, zzhq zzhq, MediaCrypto mediaCrypto) throws zzma {
        ...
        if (zzhqArr.length == 1) {
            ...
            for (zzhq zzhq3 : zzhqArr) {
                if (d0(zzlt2.f9030b, zzhq2, zzhq3)) {
        ...
        o.setInteger("max-width", zzqb.f9201a);
        o.setInteger("max-height", zzqb.f9202b);
        int i15 = zzqb.f9203c;
        if (i15 != -1) {
        ...
        if (this.e0 == null) {
            zzpb.e(p0(zzlt2.f9032d));
            if (this.f0 == null) {
                this.f0 = zzpv.a(this.V, zzlt2.f9032d);
            }
            this.e0 = this.f0;
        }
    ...
    public final boolean O(MediaCodec mediaCodec, boolean z, zzhq zzhq, zzhq zzhq2) {
        ...
        int i = zzhq2.k;
        zzqb zzqb = this.d0;
        return i <= zzqb.f9201a && zzhq2.l <= zzqb.f9202b && zzhq2.h <= zzqb.f9203c;
    }

    /* access modifiers changed from: protected */
    public final boolean P(zzlt zzlt) {
        return this.e0 != null || p0(zzlt.f9032d);
    }
        ...
        if (i == 1) {
            ...
            if (surface == null) {
                ...
                if (surface2 != null) {
                    ...
                    zzlt W2 = W();
                    if (W2 != null && p0(W2.f9032d)) {
                        surface = zzpv.a(this.V, W2.f9032d);
                        this.f0 = surface;
                    }
                }
            }
            if (this.e0 != surface) {
                ...
                if (c2 == 1 || c2 == 2) {
                    MediaCodec V2 = V();
                    if (zzpo.f9178a < 23 || V2 == null || surface == null) {
                        X();
                        U();
                    } else {
    ...
    private zzpz(Context context, zzlu zzlu, long j, zzjq<zzjs> zzjq, boolean z, Handler handler, zzqf zzqf, int i) {
        ...
        if (zzpo.f9178a <= 22 && "foster".equals(zzpo.f9179b) && "NVIDIA".equals(zzpo.f9180c)) {
            z2 = true;
        }
        this.a0 = z2;
        this.b0 = new long[10];
