...
public final class zzasm extends AbstractSafeParcelable {
    ...
    public final Bundle f6092b;
    @SafeParcelable.Field

    /* renamed from: c  reason: collision with root package name */
    public final zzbbd f6093c;
    @SafeParcelable.Field

    /* renamed from: d  reason: collision with root package name */
    public final ApplicationInfo f6094d;
    @SafeParcelable.Field
    ...
    public final List<String> f6096f;
    @SafeParcelable.Field
    ...
    public final void writeToParcel(Parcel parcel, int i2) {
        ...
        SafeParcelWriter.e(parcel, 1, this.f6092b, false);
        SafeParcelWriter.r(parcel, 2, this.f6093c, i2, false);
        SafeParcelWriter.r(parcel, 3, this.f6094d, i2, false);
        SafeParcelWriter.t(parcel, 4, this.f6095e, false);
        SafeParcelWriter.v(parcel, 5, this.f6096f, false);
