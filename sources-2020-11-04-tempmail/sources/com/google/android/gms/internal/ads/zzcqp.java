...
public final class zzcqp {
    ...
    private zzcpz f7561c;

    /* renamed from: d  reason: collision with root package name */
    private zzbbd f7562d;
    ...
    public final /* synthetic */ Void b(SQLiteDatabase sQLiteDatabase) throws Exception {
        ...
        X.w(this.f7560b.getPackageName());
        X.x(Build.MODEL);
        int i = 0;
        ...
        this.f7559a.b(new hn(zzo));
        zzty.zzu.zza P = zzty.zzu.P();
        P.w(this.f7562d.f6315c);
        P.x(this.f7562d.f6316d);
        if (!this.f7562d.f6317e) {
            i = 2;
        }
        P.y(i);
        this.f7559a.b(new gn((zzty.zzu) ((zzegb) P.O())));
        this.f7559a.a(zzto.zza.C0084zza.OFFLINE_UPLOAD);
