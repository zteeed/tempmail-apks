...
public final class zzdrb {
    ...
    private final File f8512b;

    /* renamed from: c  reason: collision with root package name */
    private final SharedPreferences f8513c;

    /* renamed from: d  reason: collision with root package name */
    private final zzgo f8514d;

    public zzdrb(Context context, zzgo zzgo) {
        this.f8513c = context.getSharedPreferences("pcvmspf", 0);
    ...
    private final File c() {
        File file = new File(this.f8511a, Integer.toString(this.f8514d.i()));
        if (!file.exists()) {
            file.mkdir();
        }
        return file;
    ...
    private final zzgr g(int i) {
        String str;
        if (i == zzdrk.f8529a) {
            str = this.f8513c.getString(e(), (String) null);
        } else {
            str = i == zzdrk.f8530b ? this.f8513c.getString(d(), (String) null) : null;
        }
    ...
    public final boolean b(com.google.android.gms.internal.ads.zzgq r9, com.google.android.gms.internal.ads.zzdrh r10) {
        ...
        L_0x00c0:
            ...
            int r10 = com.google.android.gms.internal.ads.zzdrk.f8529a
            com.google.android.gms.internal.ads.zzgr r10 = r8.g(r10)
            android.content.SharedPreferences r0 = r8.f8513c
        ...
        L_0x013f:
            ...
            r9.add(r10)
        L_0x0153:
            int r10 = com.google.android.gms.internal.ads.zzdrk.f8530b
            com.google.android.gms.internal.ads.zzgr r10 = r8.g(r10)
