...
public final class zzbez extends zzbes {
    ...
    public zzbez(zzbdb zzbdb) {
        super(zzbdb);
        File cacheDir = this.f6398b.getCacheDir();
        if (cacheDir == null) {
        ...
        this.f6401e = file;
        if (!file.isDirectory() && !this.f6401e.mkdirs()) {
            String valueOf = String.valueOf(this.f6401e.getAbsolutePath());
            ...
            this.f6401e = null;
        } else if (!this.f6401e.setReadable(true, false) || !this.f6401e.setExecutable(true, false)) {
            String valueOf2 = String.valueOf(this.f6401e.getAbsolutePath());
    ...
    private final File y(File file) {
        return new File(this.f6401e, String.valueOf(file.getName()).concat(".done"));
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:166:0x03ad, code lost:
        if (r8.f6402f != false) goto L_0x0412;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:173:0x03bf, code lost:
        r24 = r10;
        r10 = com.google.android.gms.internal.ads.zzbaq.f6298b;
        r1 = r1;
        r25 = r2;
        r26 = r3;
        r27 = r4;
    ...
    public final boolean v(java.lang.String r31) {
        ...
        L_0x0392:
            ...
            if (r24 > 0) goto L_0x0422
            r20 = r1
            boolean r1 = r8.f6402f     // Catch:{ IOException -> 0x0466, RuntimeException -> 0x0464 }
            ...
            android.os.Handler r1 = com.google.android.gms.internal.ads.zzbaq.f6298b     // Catch:{ IOException -> 0x0466, RuntimeException -> 0x0464 }
            r22 = r15
