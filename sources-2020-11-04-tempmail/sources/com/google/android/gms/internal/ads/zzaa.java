...
public abstract class zzaa<T> implements Comparable<zzaa<T>> {
    ...
    public zzaa(int i2, String str, zzai zzai) {
        Uri parse;
        String host;
        this.f5691b = zzaq.a.f6040c ? new zzaq.a() : null;
        this.f5695f = new Object();
        this.j = true;
        int i3 = 0;
        this.k = false;
        this.m = null;
    ...
    public final void B(String str) {
        ...
        if (zzaq.a.f6040c) {
            ...
            this.f5691b.a(str, id);
            this.f5691b.b(toString());
        }
    }
    ...
    public String toString() {
        String valueOf = String.valueOf(Integer.toHexString(this.f5694e));
    ...
    public final void u(String str) {
        if (zzaq.a.f6040c) {
            this.f5691b.a(str, Thread.currentThread().getId());
        }
    }
