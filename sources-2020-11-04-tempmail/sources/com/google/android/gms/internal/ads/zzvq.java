...
public final class zzvq {
    ...
    private final AdSize[] f9389a;

    /* renamed from: b  reason: collision with root package name */
    private final String f9390b;

    public zzvq(Context context, AttributeSet attributeSet) {
        ...
        if (z && !z2) {
            this.f9389a = b(string);
        } else if (!z && z2) {
            this.f9389a = b(string2);
        } else if (z) {
