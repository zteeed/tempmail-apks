...
public final class zzavq extends AbstractSafeParcelable {
    ...
    public final List<String> f6178f;
    @SafeParcelable.Field
    ...
    public final void writeToParcel(Parcel parcel, int i2) {
        ...
        SafeParcelWriter.t(parcel, 2, this.f6174b, false);
        SafeParcelWriter.t(parcel, 3, this.f6175c, false);
        SafeParcelWriter.c(parcel, 4, this.f6176d);
        SafeParcelWriter.c(parcel, 5, this.f6177e);
        SafeParcelWriter.v(parcel, 6, this.f6178f, false);
