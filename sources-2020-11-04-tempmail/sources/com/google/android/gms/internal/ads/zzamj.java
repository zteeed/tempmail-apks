...
public final class zzamj {
    ...
    private static zzamj f5971b;

    /* renamed from: a  reason: collision with root package name */
    private AtomicBoolean f5972a = new AtomicBoolean(false);
    ...
    private static void a(Context context, AppMeasurementSdk appMeasurementSdk) {
        try {
            ((zzbia) zzbaz.a(context, "com.google.android.gms.ads.measurement.DynamiteMeasurementManager", q2.f4862a)).P5(ObjectWrapper.h0(context), new zzamg(appMeasurementSdk));
    ...
    public final Thread b(Context context, String str) {
        if (!this.f5972a.compareAndSet(false, true)) {
            return null;
        }
