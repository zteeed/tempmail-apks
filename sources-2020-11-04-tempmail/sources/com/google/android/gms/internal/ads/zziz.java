...
public final class zziz extends zzls implements zzpf {
    ...
    public final int I(zzlu zzlu, zzhq zzhq) throws zzma {
        ...
        if (zzpo.f9178a < 21 || (((i = zzhq.t) == -1 || a2.d(i)) && ((i2 = zzhq.s) == -1 || a2.e(i2)))) {
            z = true;
        }
        if (!z) {
            i4 = 2;
    ...
    public final void L(zzlt zzlt, MediaCodec mediaCodec, zzhq zzhq, MediaCrypto mediaCrypto) {
        this.Y = zzpo.f9178a < 24 && "OMX.SEC.aac.dec".equals(zzlt.f9029a) && "samsung".equals(zzpo.f9180c) && (zzpo.f9179b.startsWith("zeroflte") || zzpo.f9179b.startsWith("herolte") || zzpo.f9179b.startsWith("heroqlte"));
        if (this.X) {
