...
public final class zzaye {
    ...
    private AtomicReference<Pattern> f6233a = new AtomicReference<>((Object) null);

    /* renamed from: b  reason: collision with root package name */
    private AtomicReference<Pattern> f6234b = new AtomicReference<>((Object) null);
    ...
    public static Map<String, String> d0(Uri uri) {
        if (!zzach.f5769b.a().booleanValue()) {
            if (uri == null) {
                return null;
            }
            HashMap hashMap = new HashMap();
    ...
    public final boolean X(String str) {
        return t(str, this.f6233a, (String) zzwg.e().c(zzaav.S));
    }

    public final boolean Y(String str) {
        return t(str, this.f6234b, (String) zzwg.e().c(zzaav.T));
    }
    ...
    public final zzdvf<Map<String, String>> c0(Uri uri) {
        return zzdux.j(zzdux.g(null), new h5(this, uri), zzbbf.f6320a);
    }
    ...
    public final java.lang.String m0(android.content.Context r5, java.lang.String r6) {
        /*
            r4 = this;
            java.lang.Object r0 = r4.f6236d
            monitor-enter(r0)
            java.lang.String r1 = r4.f6237e     // Catch:{ all -> 0x00cd }
            if (r1 == 0) goto L_0x000b
            java.lang.String r5 = r4.f6237e     // Catch:{ all -> 0x00cd }
        ...
        L_0x0013:
            ...
            r4.f6237e = r1     // Catch:{ Exception -> 0x001d }
        L_0x001d:
            java.lang.String r1 = r4.f6237e     // Catch:{ all -> 0x00cd }
        ...
        L_0x003b:
            java.lang.String r1 = r4.f6237e     // Catch:{ all -> 0x00cd }
            if (r1 != 0) goto L_0x006b
            java.lang.Object r1 = r4.f6236d     // Catch:{ InterruptedException -> 0x0045 }
        ...
        L_0x006b:
            ...
            java.lang.String r5 = r4.f6237e     // Catch:{ Exception -> 0x00b3 }
            ...
            r4.f6237e = r5     // Catch:{ Exception -> 0x00b3 }
            goto L_0x00bd
        L_0x00b3:
            r5 = move-exception
