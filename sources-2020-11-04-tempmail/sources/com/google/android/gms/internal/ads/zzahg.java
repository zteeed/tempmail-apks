...
public final class zzahg<T extends zzbgq & zzbgp & zzbgt & zzbgy & zzbha> implements zzahc<T> {
    ...
    private final zzc f5880a;

    /* renamed from: b  reason: collision with root package name */
    private final zzapt f5881b;
    ...
    private static int e(Map<String, String> map) {
        ...
        if (p.g.equalsIgnoreCase(str)) {
            zzq.zzky();
            return 7;
        } else if ("l".equalsIgnoreCase(str)) {
            zzq.zzky();
            return 6;
        } else if (c.f12927e.equalsIgnoreCase(str)) {
            return zzq.zzky().q();
        } else {
            return -1;
        }
    ...
    public final /* synthetic */ void a(Object obj, Map map) {
        ...
        if (zzc != null && !zzc.zzjy()) {
            ...
            if (((Boolean) zzwg.e().c(zzaav.c4)).booleanValue()) {
                c(true);
                String str2 = (String) map.get(p.g);
                if (str2 == null) {
            ...
            ((zzbgt) zzbgq).k0(new zzd((String) map.get(i.f13118a), d2, (String) map.get("m"), (String) map.get(p.g), (String) map.get(c.f12927e), (String) map.get("f"), (String) map.get("e")));
        }
    }
}
