...
public final class zzeci implements zzdwp {
    ...
    private final SecretKey f8669a;
    ...
    public zzeci(byte[] bArr, int i) throws GeneralSecurityException {
        ...
        if (i < 10) {
            ...
            this.f8669a = new SecretKeySpec(bArr, "AES");
            this.f8670b = i;
            Cipher b2 = b();
            b2.init(1, this.f8669a);
            byte[] a2 = x40.a(b2.doFinal(new byte[16]));
            this.f8671c = a2;
            this.f8672d = x40.a(a2);
        } else {
    ...
    public final byte[] a(byte[] bArr) throws GeneralSecurityException {
        ...
        if ((max << 4) == bArr.length) {
            bArr2 = zzecp.b(bArr, (max - 1) << 4, this.f8671c, 0, 16);
        } else {
            byte[] copyOfRange = Arrays.copyOfRange(bArr, (max - 1) << 4, bArr.length);
            if (copyOfRange.length < 16) {
                byte[] copyOf = Arrays.copyOf(copyOfRange, 16);
                copyOf[copyOfRange.length] = Byte.MIN_VALUE;
                bArr2 = zzecp.d(copyOf, this.f8672d);
            } else {
        ...
        byte[] bArr4 = new byte[this.f8670b];
        System.arraycopy(b2.doFinal(d2), 0, bArr4, 0, this.f8670b);
        return bArr4;
    }
}
