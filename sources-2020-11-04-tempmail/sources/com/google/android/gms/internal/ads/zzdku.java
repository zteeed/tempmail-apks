...
public final class zzdku {
    ...
    public final List<zzdkk> f8339a;

    /* renamed from: b  reason: collision with root package name */
    public final zzdkm f8340b;

    /* renamed from: c  reason: collision with root package name */
    public final List<zzdkt> f8341c;
    ...
    private zzdku(JsonReader jsonReader) throws IllegalStateException, IOException, JSONException, NumberFormatException, AssertionError {
        ...
        this.f8339a = emptyList;
        this.f8340b = zzdkm == null ? new zzdkm(new JsonReader(new StringReader("{}"))) : zzdkm;
    }
