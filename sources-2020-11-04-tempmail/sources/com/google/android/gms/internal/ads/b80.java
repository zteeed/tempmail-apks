...
final class b80 {
    ...
    private static final Class<?> f3616a = y();

    /* renamed from: b  reason: collision with root package name */
    private static final r80<?, ?> f3617b = A(false);

    /* renamed from: c  reason: collision with root package name */
    private static final r80<?, ?> f3618c = A(true);

    /* renamed from: d  reason: collision with root package name */
    private static final r80<?, ?> f3619d = new t80();
    ...
    public static void O(Class<?> cls) {
        Class<?> cls2;
        if (!zzegb.class.isAssignableFrom(cls) && (cls2 = f3616a) != null && !cls2.isAssignableFrom(cls)) {
