...
public final class zzdwy {
    ...
    private static final Logger f8620a = Logger.getLogger(zzdwy.class.getName());

    /* renamed from: b  reason: collision with root package name */
    private static final ConcurrentMap<String, b> f8621b = new ConcurrentHashMap();

    /* renamed from: c  reason: collision with root package name */
    private static final ConcurrentMap<String, a> f8622c = new ConcurrentHashMap();

    /* renamed from: d  reason: collision with root package name */
    private static final ConcurrentMap<String, Boolean> f8623d = new ConcurrentHashMap();

    /* renamed from: e  reason: collision with root package name */
    private static final ConcurrentMap<String, zzdwb<?>> f8624e = new ConcurrentHashMap();

    /* renamed from: f  reason: collision with root package name */
    private static final ConcurrentMap<Class<?>, zzdwt<?>> f8625f = new ConcurrentHashMap();
    ...
    public static synchronized zzebf e(zzebi zzebi) throws GeneralSecurityException {
        ...
        synchronized (zzdwy.class) {
            zzdwi<?> s = s(zzebi.G());
            if (((Boolean) f8623d.get(zzebi.G())).booleanValue()) {
                d2 = s.d(zzebi.H());
            } else {
    ...
    public static <P> P f(zzdwr<P> zzdwr) throws GeneralSecurityException {
        zzdwt zzdwt = (zzdwt) f8625f.get(zzdwr.d());
        if (zzdwt != null) {
    ...
    public static synchronized <P> void j(zzdwi<P> zzdwi, boolean z) throws GeneralSecurityException {
        synchronized (zzdwy.class) {
            if (zzdwi != null) {
                ...
                if (!f8621b.containsKey(b2)) {
                    f8621b.put(b2, new r10(zzdwi));
                }
                f8623d.put(b2, Boolean.valueOf(z));
            } else {
    ...
    public static synchronized <KeyProtoT extends zzehl> void k(zzdwj<KeyProtoT> zzdwj, boolean z) throws GeneralSecurityException {
        synchronized (zzdwy.class) {
            ...
            if (!f8621b.containsKey(a2)) {
                f8621b.put(a2, d(zzdwj));
                f8622c.put(a2, o(zzdwj));
            }
            f8623d.put(a2, Boolean.TRUE);
        }
    }
    ...
    public static synchronized <P> void l(zzdwt<P> zzdwt) throws GeneralSecurityException {
        synchronized (zzdwy.class) {
            if (zzdwt != null) {
                Class<P> a2 = zzdwt.a();
                if (f8625f.containsKey(a2)) {
                    zzdwt zzdwt2 = (zzdwt) f8625f.get(a2);
                    if (!zzdwt.getClass().equals(zzdwt2.getClass())) {
                        Logger logger = f8620a;
    ...
    public static synchronized <KeyProtoT extends zzehl, PublicKeyProtoT extends zzehl> void m(zzdwv<KeyProtoT, PublicKeyProtoT> zzdwv, zzdwj<PublicKeyProtoT> zzdwj, boolean z) throws GeneralSecurityException {
        ...
        synchronized (zzdwy.class) {
            ...
            if (!a2.equals(a3)) {
                if (f8621b.containsKey(a2) && (f2 = ((b) f8621b.get(a2)).f()) != null) {
                ...
                if (!f8621b.containsKey(a2) || ((b) f8621b.get(a2)).f() == null) {
                    f8621b.put(a2, new s10(zzdwv, zzdwj));
                    f8622c.put(a2, o(zzdwv));
                }
                f8623d.put(a2, Boolean.TRUE);
                if (!f8621b.containsKey(a3)) {
                    f8621b.put(a3, d(zzdwj));
                }
                f8623d.put(a3, Boolean.FALSE);
            } else {
    ...
    private static synchronized void n(java.lang.String r8, java.lang.Class<?> r9, boolean r10) throws java.security.GeneralSecurityException {
        /*
            ...
            monitor-enter(r0)
            java.util.concurrent.ConcurrentMap<java.lang.String, com.google.android.gms.internal.ads.zzdwy$b> r1 = f8621b     // Catch:{ all -> 0x0093 }
        ...
        L_0x000d:
            ...
            java.util.logging.Logger r10 = f8620a     // Catch:{ all -> 0x0093 }
        ...
        L_0x0065:
            ...
            java.util.concurrent.ConcurrentMap<java.lang.String, java.lang.Boolean> r9 = f8623d     // Catch:{ all -> 0x0093 }
    ...
    private static synchronized b q(String str) throws GeneralSecurityException {
        b bVar;
        synchronized (zzdwy.class) {
            if (!f8621b.containsKey(str)) {
                String valueOf = String.valueOf(str);
                throw new GeneralSecurityException(valueOf.length() != 0 ? "No key manager found for key type ".concat(valueOf) : new String("No key manager found for key type "));
            }
            bVar = (b) f8621b.get(str);
        }
        return bVar;
    }
    ...
    public static zzdwb<?> r(String str) throws GeneralSecurityException {
        if (str != null) {
            zzdwb<?> zzdwb = (zzdwb) f8624e.get(str.toLowerCase());
            if (zzdwb != null) {
                return zzdwb;
            }
