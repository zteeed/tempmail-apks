...
final class y80 {
    ...
    private static final z80 f5547a;
    ...
    static int b(CharSequence charSequence, byte[] bArr, int i, int i2) {
        return f5547a.b(charSequence, bArr, i, i2);
    }
    ...
    static String l(byte[] bArr, int i, int i2) throws zzegl {
        return f5547a.d(bArr, i, i2);
    }

    public static boolean n(byte[] bArr) {
        return f5547a.c(bArr, 0, bArr.length);
    }
}
