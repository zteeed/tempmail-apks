...
public final class zzrf {
    ...
    private List<zzrc> f9240c = new LinkedList();

    public final boolean a(zzrc zzrc) {
        synchronized (this.f9238a) {
            if (this.f9240c.contains(zzrc)) {
                return true;
            }
            return false;
        }
    ...
    public final boolean b(zzrc zzrc) {
        synchronized (this.f9238a) {
            Iterator<zzrc> it = this.f9240c.iterator();
            while (it.hasNext()) {
                zzrc next = it.next();
                if (!zzq.zzla().r().w()) {
    ...
    public final com.google.android.gms.internal.ads.zzrc d(boolean r8) {
        /*
            r7 = this;
            java.lang.Object r0 = r7.f9238a
            monitor-enter(r0)
            java.util.List<com.google.android.gms.internal.ads.zzrc> r1 = r7.f9240c     // Catch:{ all -> 0x005a }
        ...
        L_0x003b:
            ...
            goto L_0x0026
        L_0x003e:
            java.util.List<com.google.android.gms.internal.ads.zzrc> r8 = r7.f9240c     // Catch:{ all -> 0x005a }
