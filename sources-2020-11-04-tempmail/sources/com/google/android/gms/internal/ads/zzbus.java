...
public final class zzbus extends zzbwv<zzbuw> {
    ...
    private final ScheduledExecutorService f6829c;

    /* renamed from: d  reason: collision with root package name */
    private final Clock f6830d;
    @GuardedBy("this")

    /* renamed from: e  reason: collision with root package name */
    private long f6831e = -1;
    @GuardedBy("this")

    /* renamed from: f  reason: collision with root package name */
    private long f6832f = -1;
    @GuardedBy("this")
    ...
    private final synchronized void G0(long j) {
        ...
        this.f6831e = this.f6830d.b() + j;
        this.h = this.f6829c.schedule(new fe(this), j, TimeUnit.MILLISECONDS);
    }
    ...
    public final synchronized void F0(int r7) {
        ...
        L_0x0005:
            ...
            long r2 = r6.f6832f     // Catch:{ all -> 0x0043 }
            r4 = 0
            ...
            goto L_0x0021
        L_0x001f:
            long r0 = r6.f6832f     // Catch:{ all -> 0x0043 }
        L_0x0021:
            r6.f6832f = r0     // Catch:{ all -> 0x0043 }
            monitor-exit(r6)
            return
        L_0x0025:
            com.google.android.gms.common.util.Clock r7 = r6.f6830d     // Catch:{ all -> 0x0043 }
            long r2 = r7.b()     // Catch:{ all -> 0x0043 }
            long r4 = r6.f6831e     // Catch:{ all -> 0x0043 }
            int r7 = (r2 > r4 ? 1 : (r2 == r4 ? 0 : -1))
            if (r7 > 0) goto L_0x003e
            long r2 = r6.f6831e     // Catch:{ all -> 0x0043 }
            com.google.android.gms.common.util.Clock r7 = r6.f6830d     // Catch:{ all -> 0x0043 }
    ...
    public final synchronized void onPause() {
        if (!this.g) {
            if (this.h == null || this.h.isCancelled()) {
                ...
                this.h.cancel(true);
                this.f6832f = this.f6831e - this.f6830d.b();
            }
            this.g = true;
        }
    }
    ...
    public final synchronized void onResume() {
        if (this.g) {
            if (this.f6832f > 0 && this.h.isCancelled()) {
                G0(this.f6832f);
            }
            this.g = false;
        }
