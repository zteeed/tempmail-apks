...
final class sz<K, V> extends zzdsz<Map.Entry<K, V>> {
    ...
    private final transient zzdsw<K, V> f5118d;
    /* access modifiers changed from: private */

    /* renamed from: e  reason: collision with root package name */
    public final transient Object[] f5119e;
    /* access modifiers changed from: private */

    /* renamed from: f  reason: collision with root package name */
    public final transient int f5120f;
    ...
    public final boolean contains(Object obj) {
        if (obj instanceof Map.Entry) {
            ...
            if (value == null || !value.equals(this.f5118d.get(key))) {
                return false;
            }
            return true;
        }
