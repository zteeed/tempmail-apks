...
public final class zzcey {
    ...
    private final zzcet f7129b;

    /* renamed from: c  reason: collision with root package name */
    private final zzeg f7130c;

    /* renamed from: d  reason: collision with root package name */
    private final zzbbd f7131d;

    /* renamed from: e  reason: collision with root package name */
    private final zza f7132e;

    /* renamed from: f  reason: collision with root package name */
    private final zztm f7133f;
    ...
    private static <T> zzdvf<T> b(zzdvf<T> zzdvf, T t) {
        return zzdux.k(zzdvf, Exception.class, new di((Object) null), zzbbf.f6325f);
    }
    ...
    private final zzdvf<List<zzadf>> c(JSONArray jSONArray, boolean z, boolean z2) {
        ...
        return zzdux.i(zzdux.m(arrayList), ai.f3565a, this.g);
    }
    ...
    private final zzdvf<zzadf> d(JSONObject jSONObject, boolean z) {
        ...
        return e(jSONObject.optBoolean("require"), zzdux.i(this.f7129b.d(optString, optDouble, optBoolean), new zh(optString, optDouble, optInt, optInt2), this.g), (Object) null);
    }

    private static <T> zzdvf<T> e(boolean z, zzdvf<T> zzdvf, T t) {
        if (z) {
            return zzdux.j(zzdvf, new gi(zzdvf), zzbbf.f6325f);
        }
    ...
    private static Integer j(JSONObject jSONObject, String str) {
        try {
            ...
            return Integer.valueOf(Color.rgb(jSONObject2.getInt("r"), jSONObject2.getInt(g.f13030e), jSONObject2.getInt("b")));
    ...
    public final /* synthetic */ zzada a(JSONObject jSONObject, List list) {
        ...
        return new zzada(optString, list, j2, j3, num, optInt3 + optInt2, this.h.f5821f, optBoolean);
    }

    /* access modifiers changed from: package-private */
    public final /* synthetic */ zzdvf f(String str, Object obj) throws Exception {
        zzq.zzkx();
        zzbfn a2 = zzbfv.a(this.f7128a, zzbhg.b(), "native-omid", false, false, this.f7130c, this.f7131d, (zzabi) null, (zzi) null, this.f7132e, this.f7133f, (zzso) null, false);
        zzbbo e2 = zzbbo.e(a2);
        a2.q().b(new fi(e2));
    ...
    public final zzdvf<zzadf> g(JSONObject jSONObject, String str) {
        return d(jSONObject.optJSONObject(str), this.h.f5818c);
    }

    public final zzdvf<List<zzadf>> h(JSONObject jSONObject, String str) {
        JSONArray optJSONArray = jSONObject.optJSONArray(str);
        zzadj zzadj = this.h;
        return c(optJSONArray, zzadj.f5818c, zzadj.f5820e);
    }
    ...
    public final zzdvf<zzbfn> n(JSONObject jSONObject) {
        ...
        return zzdux.j(g2, new ei(g2), zzbbf.f6325f);
    }
}
