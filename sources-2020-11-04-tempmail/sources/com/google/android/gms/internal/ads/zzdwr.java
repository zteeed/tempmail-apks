...
public final class zzdwr<P> {
    ...
    private static final Charset f8612d = Charset.forName("UTF-8");

    /* renamed from: a  reason: collision with root package name */
    private ConcurrentMap<String, List<zzdwu<P>>> f8613a = new ConcurrentHashMap();

    /* renamed from: b  reason: collision with root package name */
    private zzdwu<P> f8614b;

    /* renamed from: c  reason: collision with root package name */
    private final Class<P> f8615c;
    ...
    public final zzdwu<P> b(P p, zzebn.zzb zzb) throws GeneralSecurityException {
        ...
        if (zzb.G() == zzebg.ENABLED) {
            int i = p10.f4781a[zzb.H().ordinal()];
            if (i == 1 || i == 2) {
            ...
            arrayList.add(zzdwu);
            String str = new String(zzdwu.d(), f8612d);
            List list = (List) this.f8613a.put(str, Collections.unmodifiableList(arrayList));
            if (list != null) {
                ArrayList arrayList2 = new ArrayList();
                arrayList2.addAll(list);
                arrayList2.add(zzdwu);
                this.f8613a.put(str, Collections.unmodifiableList(arrayList2));
            }
            return zzdwu;
        }
    ...
    public final void c(zzdwu<P> zzdwu) {
        if (zzdwu == null) {
            ...
            List list = (List) this.f8613a.get(new String(zzdwu.d(), f8612d));
            if (list == null) {
