...
public final class zzbae {
    ...
    private static JSONObject b(Context context, Point point, Point point2) {
        ...
        try {
            jSONObject.put(x.f13134a, h(context, point2.x));
            jSONObject.put(y.f13082d, h(context, point2.y));
    ...
    private static JSONObject c(Context context, Rect rect) throws JSONException {
        ...
        jSONObject.put(x.f13134a, h(context, rect.left));
        jSONObject.put(y.f13082d, h(context, rect.top));
            ...
            while (it.hasNext()) {
                ...
                if (view2 != null) {
                    ...
                    try {
                        ...
                        jSONObject4.put(x.f13134a, h(context2, m2[0] - m[0]));
                        jSONObject4.put(y.f13082d, h(context2, m2[1] - m[1]));
                        ...
                        if (view2.getLocalVisibleRect(rect)) {
                            ...
                            jSONObject.put(x.f13134a, h(context2, m2[0] - m[0]));
                            jSONObject.put(y.f13082d, h(context2, m2[1] - m[1]));
