...
public final class zzdne<AdT extends zzbpb> {
    ...
    public zzdvq<zzdmw<AdT>> f8421c;
    @GuardedBy("this")

    /* renamed from: d  reason: collision with root package name */
    private zzdvf<zzdmw<AdT>> f8422d;
    /* access modifiers changed from: private */
    @GuardedBy("this")

    /* renamed from: e  reason: collision with root package name */
    public int f8423e = zzdmu.g;
    /* access modifiers changed from: private */

    /* renamed from: f  reason: collision with root package name */
    public final zzdml f8424f;
    /* access modifiers changed from: private */
    ...
    public zzdne(zzdml zzdml, zzdmi zzdmi, zzdnh<AdT> zzdnh) {
        ...
        this.f8419a.b(new hx(this));
    }

    private final boolean d() {
        zzdvf<zzdmw<AdT>> zzdvf = this.f8422d;
    ...
    public final void l(zzdnk zzdnk) {
        while (d()) {
            if (zzdnk != null || !this.h.isEmpty()) {
                ...
                if (zzdnk.b() == null || !this.f8424f.a(zzdnk.b())) {
                    zzdnk = null;
                } else {
                    this.f8420b = zzdnk.c();
                    this.f8421c = zzdvq.C();
                    zzdvf<zzdmw<AdT>> c2 = this.g.c(this.f8420b);
                    this.f8422d = c2;
    ...
    public final /* synthetic */ zzdvf i(zzdmw zzdmw) throws Exception {
        zzdvf g2;
        synchronized (this) {
            g2 = zzdux.g(new zzdni(zzdmw, this.f8420b));
        }
        return g2;
    }
    ...
    public final synchronized com.google.android.gms.internal.ads.zzdvf<com.google.android.gms.internal.ads.zzdni<AdT>> j(com.google.android.gms.internal.ads.zzdnk r4) {
        ...
        L_0x000a:
            ...
            r3.f8423e = r0     // Catch:{ all -> 0x0044 }
            com.google.android.gms.internal.ads.zzdnk r0 = r3.f8420b     // Catch:{ all -> 0x0044 }
        ...
        L_0x002d:
            ...
            r3.f8423e = r0     // Catch:{ all -> 0x0044 }
            com.google.android.gms.internal.ads.zzdvq<com.google.android.gms.internal.ads.zzdmw<AdT>> r0 = r3.f8421c     // Catch:{ all -> 0x0044 }
