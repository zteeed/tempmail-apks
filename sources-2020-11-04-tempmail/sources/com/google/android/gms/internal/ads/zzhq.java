...
public final class zzhq implements Parcelable {
    ...
    public final zzhq a(zzjl zzjl) {
        ...
        return new zzhq(str, this.f8919f, this.g, this.f8917d, this.f8916c, this.h, this.k, this.l, this.m, this.n, this.o, this.q, this.p, this.r, this.s, this.t, this.u, this.v, this.w, this.y, this.z, this.A, this.x, this.i, zzjl, this.f8918e);
    }

    public final zzhq b(zzme zzme) {
        String str = this.f8915b;
        return new zzhq(str, this.f8919f, this.g, this.f8917d, this.f8916c, this.h, this.k, this.l, this.m, this.n, this.o, this.q, this.p, this.r, this.s, this.t, this.u, this.v, this.w, this.y, this.z, this.A, this.x, this.i, this.j, zzme);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && zzhq.class == obj.getClass()) {
            zzhq zzhq = (zzhq) obj;
            if (this.f8916c == zzhq.f8916c && this.h == zzhq.h && this.k == zzhq.k && this.l == zzhq.l && this.m == zzhq.m && this.n == zzhq.n && this.o == zzhq.o && this.p == zzhq.p && this.s == zzhq.s && this.t == zzhq.t && this.u == zzhq.u && this.v == zzhq.v && this.w == zzhq.w && this.x == zzhq.x && this.y == zzhq.y && zzpo.g(this.f8915b, zzhq.f8915b) && zzpo.g(this.z, zzhq.z) && this.A == zzhq.A && zzpo.g(this.f8919f, zzhq.f8919f) && zzpo.g(this.g, zzhq.g) && zzpo.g(this.f8917d, zzhq.f8917d) && zzpo.g(this.j, zzhq.j) && zzpo.g(this.f8918e, zzhq.f8918e) && zzpo.g(this.r, zzhq.r) && Arrays.equals(this.q, zzhq.q) && this.i.size() == zzhq.i.size()) {
    ...
    public final int hashCode() {
        if (this.B == 0) {
            ...
            String str2 = this.f8919f;
            int hashCode2 = (hashCode + (str2 == null ? 0 : str2.hashCode())) * 31;
            String str3 = this.g;
            int hashCode3 = (hashCode2 + (str3 == null ? 0 : str3.hashCode())) * 31;
            String str4 = this.f8917d;
            int hashCode4 = (((((((((((hashCode3 + (str4 == null ? 0 : str4.hashCode())) * 31) + this.f8916c) * 31) + this.k) * 31) + this.l) * 31) + this.s) * 31) + this.t) * 31;
            String str5 = this.z;
            int hashCode5 = (((hashCode4 + (str5 == null ? 0 : str5.hashCode())) * 31) + this.A) * 31;
            zzjl zzjl = this.j;
            int hashCode6 = (hashCode5 + (zzjl == null ? 0 : zzjl.hashCode())) * 31;
            zzme zzme = this.f8918e;
            if (zzme != null) {
                i2 = zzme.hashCode();
            }
            this.B = hashCode6 + i2;
    ...
    public final zzhq l(int i2, int i3) {
        String str = this.f8915b;
        return new zzhq(str, this.f8919f, this.g, this.f8917d, this.f8916c, this.h, this.k, this.l, this.m, this.n, this.o, this.q, this.p, this.r, this.s, this.t, this.u, i2, i3, this.y, this.z, this.A, this.x, this.i, this.j, this.f8918e);
    }

    public final zzhq m(long j2) {
        return new zzhq(this.f8915b, this.f8919f, this.g, this.f8917d, this.f8916c, this.h, this.k, this.l, this.m, this.n, this.o, this.q, this.p, this.r, this.s, this.t, this.u, this.v, this.w, this.y, this.z, this.A, j2, this.i, this.j, this.f8918e);
    }
    ...
    public final MediaFormat o() {
        ...
        zzpt zzpt = this.r;
        if (zzpt != null) {
            k(mediaFormat, "color-transfer", zzpt.f9188d);
            k(mediaFormat, "color-standard", zzpt.f9186b);
            k(mediaFormat, "color-range", zzpt.f9187c);
            byte[] bArr = zzpt.f9189e;
            if (bArr != null) {
    ...
    public final zzhq p(int i2) {
        String str = this.f8915b;
        return new zzhq(str, this.f8919f, this.g, this.f8917d, this.f8916c, i2, this.k, this.l, this.m, this.n, this.o, this.q, this.p, this.r, this.s, this.t, this.u, this.v, this.w, this.y, this.z, this.A, this.x, this.i, this.j, this.f8918e);
    }
    ...
    zzhq(Parcel parcel) {
        ...
        this.f8918e = (zzme) parcel.readParcelable(zzme.class.getClassLoader());
    }
}
