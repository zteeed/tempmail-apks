...
public final class zzbaq {
    ...
    public static final Handler f6298b = new zzdrr(Looper.getMainLooper());

    /* renamed from: c  reason: collision with root package name */
    private static final String f6299c = AdView.class.getName();

    /* renamed from: d  reason: collision with root package name */
    private static final String f6300d = InterstitialAd.class.getName();

    /* renamed from: e  reason: collision with root package name */
    private static final String f6301e = PublisherAdView.class.getName();

    /* renamed from: f  reason: collision with root package name */
    private static final String f6302f = PublisherInterstitialAd.class.getName();
    private static final String g = SearchAdView.class.getName();
    private static final String h = AdLoader.class.getName();

    /* renamed from: a  reason: collision with root package name */
    private float f6303a = -1.0f;
    ...
    public static String c(StackTraceElement[] stackTraceElementArr, String str) {
        ...
        while (true) {
            ...
            if (!"loadAd".equalsIgnoreCase(stackTraceElement.getMethodName()) || (!f6299c.equalsIgnoreCase(className) && !f6300d.equalsIgnoreCase(className) && !f6301e.equalsIgnoreCase(className) && !f6302f.equalsIgnoreCase(className) && !g.equalsIgnoreCase(className) && !h.equalsIgnoreCase(className))) {
                i2 = i;
            }
        }
    ...
    private final void g(ViewGroup viewGroup, zzvh zzvh, String str, int i, int i2) {
        if (viewGroup.getChildCount() == 0) {
            ...
            int r = r(context, 3);
            frameLayout.addView(textView, new FrameLayout.LayoutParams(zzvh.g - r, zzvh.f9374d - r, 17));
            viewGroup.addView(frameLayout, zzvh.g, zzvh.f9374d);
        }
    }
    ...
    public static Throwable s(Throwable th) {
        if (zzacq.f5793f.a().booleanValue()) {
            return th;
        }
    ...
    public static boolean w(String str) {
        ...
        return str.startsWith(zzacq.f5791d.a());
    }
        ...
        if (this.f6303a < 0.0f) {
            synchronized (this) {
                if (this.f6303a < 0.0f) {
                    ...
                    defaultDisplay.getMetrics(displayMetrics);
                    this.f6303a = displayMetrics.density;
                }
            }
        }
        return Math.round(((float) i) / this.f6303a);
    }
}
