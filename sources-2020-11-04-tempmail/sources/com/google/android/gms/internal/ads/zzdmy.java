...
public final class zzdmy implements zzdmv {
    ...
    public zzdmy(zzve zzve, String str, int i, String str2, zzvo zzvo) {
        ...
        if (hashSet.contains("birthday")) {
            arrayList.add(Long.valueOf(zzve.f9367c));
        }
        if (hashSet.contains("extras")) {
            arrayList.add(a(zzve.f9368d));
        } else if (hashSet.contains("npa")) {
            arrayList.add(zzve.f9368d.getString("npa"));
        }
        if (hashSet.contains("gender")) {
            arrayList.add(Integer.valueOf(zzve.f9369e));
        }
        if (hashSet.contains("keywords")) {
            List<String> list = zzve.f9370f;
            if (list != null) {
        ...
        if (hashSet.contains("orientation")) {
            if (zzvo != null) {
                arrayList.add(Integer.valueOf(zzvo.f9382b));
            } else {
                arrayList.add((Object) null);
            }
        }
        this.f8415a = arrayList.toArray();
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return Arrays.equals(this.f8415a, ((zzdmy) obj).f8415a);
    }

    public final int hashCode() {
        return Arrays.hashCode(this.f8415a);
    }

    public final String toString() {
        int hashCode = hashCode();
        String arrays = Arrays.toString(this.f8415a);
