...
public abstract class zzdsw<K, V> implements Serializable, Map<K, V> {
    ...
    private transient zzdsz<Map.Entry<K, V>> f8551b;

    /* renamed from: c  reason: collision with root package name */
    private transient zzdsz<K> f8552c;

    /* renamed from: d  reason: collision with root package name */
    private transient zzdsr<V> f8553d;
    ...
    public /* synthetic */ Set entrySet() {
        zzdsz<Map.Entry<K, V>> zzdsz = this.f8551b;
        if (zzdsz != null) {
            return zzdsz;
        }
