...
public class AppMeasurement {
    ...
    private static volatile AppMeasurement f10078d;

    /* renamed from: a  reason: collision with root package name */
    private final zzfy f10079a;

    /* renamed from: b  reason: collision with root package name */
    private final zzia f10080b;
    ...
    public static class ConditionalUserProperty {
        ...
        ConditionalUserProperty(Bundle bundle) {
            ...
            this.mName = (String) zzgx.a(bundle, "name", cls2, null);
        ...
        if (f10078d == null) {
            synchronized (AppMeasurement.class) {
                if (f10078d == null) {
                    ...
                    if (b2 != null) {
                        f10078d = new AppMeasurement(b2);
                    } else {
                        f10078d = new AppMeasurement(zzfy.a(context, new zzae(0, 0, true, (String) null, (String) null, (String) null, (Bundle) null), (Long) null));
                    }
                }
            }
        }
    ...
    public void beginAdUnitExposure(String str) {
        if (this.f10081c) {
            ...
            this.f10079a.S().A(str, this.f10079a.n().b());
        }
    }
    ...
    public void clearConditionalUserProperty(String str, String str2, Bundle bundle) {
        if (this.f10081c) {
            this.f10080b.j(str, str2, bundle);
        } else {
            this.f10079a.F().u0(str, str2, bundle);
        }
    }
    ...
    public void clearConditionalUserPropertyAs(String str, String str2, String str3, Bundle bundle) {
        ...
        this.f10079a.F().W(str, str2, str3, bundle);
        throw null;
    }
    ...
    public void endAdUnitExposure(String str) {
        if (this.f10081c) {
            ...
            this.f10079a.S().E(str, this.f10079a.n().b());
        }
    }
    ...
    public List<ConditionalUserProperty> getConditionalUserProperties(String str, String str2) {
        ...
        int i;
        if (this.f10081c) {
            list = this.f10080b.i(str, str2);
        } else {
            list = this.f10079a.F().C(str, str2);
        }
        if (list == null) {
            i = 0;
        } else {
    ...
    public List<ConditionalUserProperty> getConditionalUserPropertiesAs(String str, String str2, String str3) {
        ...
        this.f10079a.F().D(str, str2, str3);
        throw null;
    }
    ...
    public Map<String, Object> getUserProperties(String str, String str2, boolean z) {
        if (this.f10081c) {
            return this.f10080b.f(str, str2, z);
        }
        return this.f10079a.F().F(str, str2, z);
    }
    ...
    public Map<String, Object> getUserPropertiesAs(String str, String str2, String str3, boolean z) {
        ...
        this.f10079a.F().E(str, str2, str3, z);
        throw null;
    }
    ...
    public void logEventInternal(String str, String str2, Bundle bundle) {
        if (this.f10081c) {
            this.f10080b.T(str, str2, bundle);
        } else {
            this.f10079a.F().R(str, str2, bundle);
        }
    }
    ...
    public void setConditionalUserProperty(ConditionalUserProperty conditionalUserProperty) {
        ...
        if (this.f10081c) {
            this.f10080b.E(conditionalUserProperty.a());
        } else {
            this.f10079a.F().G(conditionalUserProperty.a());
        }
    }
    ...
    public void setConditionalUserPropertyAs(ConditionalUserProperty conditionalUserProperty) {
        ...
        this.f10079a.F().m0(conditionalUserProperty.a());
        throw null;
    }
