...
final class n5 implements Application.ActivityLifecycleCallbacks {
    ...
    private final /* synthetic */ zzhc f10326b;
    ...
    public final void b(boolean r18, android.net.Uri r19, java.lang.String r20, java.lang.String r21) {
        /*
            ...
            r0 = r20
            r2 = r21
            com.google.android.gms.measurement.internal.zzhc r3 = r1.f10326b
            r3.c()
            com.google.android.gms.measurement.internal.zzhc r3 = r1.f10326b     // Catch:{ Exception -> 0x01d6 }
        ...
        L_0x009b:
            ...
            com.google.android.gms.measurement.internal.zzhc r14 = r1.f10326b     // Catch:{ Exception -> 0x01d6 }
            ...
            com.google.android.gms.measurement.internal.zzhc r6 = r1.f10326b     // Catch:{ Exception -> 0x01d6 }
        ...
        L_0x013f:
            ...
            com.google.android.gms.measurement.internal.zzhc r2 = r1.f10326b     // Catch:{ Exception -> 0x01d6 }
            ...
            goto L_0x018a
        L_0x017b:
            com.google.android.gms.measurement.internal.zzhc r0 = r1.f10326b     // Catch:{ Exception -> 0x01d6 }
        ...
        L_0x01d6:
            r0 = move-exception
            com.google.android.gms.measurement.internal.zzhc r2 = r1.f10326b
    ...
    public final void onActivityCreated(Activity activity, Bundle bundle) {
        try {
            this.f10326b.h().O().a("onActivityCreated");
            ...
            if (intent != null) {
                ...
                if (data != null) {
                    if (data.isHierarchical()) {
                        this.f10326b.j();
                        this.f10326b.g().z(new q5(this, bundle == null, data, zzkr.Z(intent) ? "gs" : "auto", data.getQueryParameter("referrer")));
                        this.f10326b.t().H(activity, bundle);
                        return;
                    }
                }
                this.f10326b.t().H(activity, bundle);
            ...
            this.f10326b.h().G().b("Throwable caught in onActivityCreated", e2);
        } finally {
            this.f10326b.t().H(activity, bundle);
        }
    }
    ...
    public final void onActivityDestroyed(Activity activity) {
        this.f10326b.t().W(activity);
    }

    public final void onActivityPaused(Activity activity) {
        this.f10326b.t().U(activity);
        zzjv v = this.f10326b.v();
    ...
    public final void onActivityResumed(Activity activity) {
        ...
        this.f10326b.t().G(activity);
    }

    public final void onActivitySaveInstanceState(Activity activity, Bundle bundle) {
        this.f10326b.t().V(activity, bundle);
    }
