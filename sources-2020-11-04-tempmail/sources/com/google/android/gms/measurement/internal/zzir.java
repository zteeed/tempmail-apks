...
public final class zzir extends x3 {
    ...
    private volatile Boolean f10676e;

    /* renamed from: f  reason: collision with root package name */
    private final f f10677f;
    private final j7 g;
    ...
    protected zzir(zzfy zzfy) {
        ...
        this.f10674c = new zzji(this);
        this.f10677f = new b6(this, zzfy);
    ...
    public final void f0() {
        c();
        this.g.a();
        this.f10677f.c(zzaq.J.a(null).longValue());
    }
    ...
    private final boolean g0() {
        /*
            ...
            r5.c()
            r5.y()
            java.lang.Boolean r0 = r5.f10676e
    ...
    public final void c0() {
        ...
        this.f10674c.a();
        try {
            ConnectionTracker.b().c(f(), this.f10674c);
