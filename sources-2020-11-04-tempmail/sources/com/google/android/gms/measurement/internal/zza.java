...
public final class zza extends t1 {
    ...
    private final Map<String, Long> f10544b = new a();

    /* renamed from: c  reason: collision with root package name */
    private final Map<String, Integer> f10545c = new a();
    ...
    public final void C(long j) {
        for (String put : this.f10544b.keySet()) {
            this.f10544b.put(put, Long.valueOf(j));
        }
    ...
    public final void F(String str, long j) {
        ...
        Integer num = this.f10545c.get(str);
        if (num != null) {
            this.f10545c.put(str, Integer.valueOf(num.intValue() + 1));
        } else if (this.f10545c.size() >= 100) {
            h().J().a("Too many ads visible");
        } else {
            this.f10545c.put(str, 1);
            this.f10544b.put(str, Long.valueOf(j));
        }
    }
    ...
    public final void G(String str, long j) {
        ...
        if (num != null) {
            ...
            if (intValue == 0) {
                this.f10545c.remove(str);
                Long l = this.f10544b.get(str);
                if (l == null) {
            ...
            this.f10545c.put(str, Integer.valueOf(intValue));
            return;
        }
    ...
    public final void w(long j) {
        zzij E = t().E(false);
        for (String next : this.f10544b.keySet()) {
            B(next, j - this.f10544b.get(next).longValue(), E);
        }
        if (!this.f10544b.isEmpty()) {
            x(j - this.f10546d, E);
        }
