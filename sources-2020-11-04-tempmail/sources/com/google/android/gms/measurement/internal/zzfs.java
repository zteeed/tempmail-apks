...
public final class zzfs extends m7 implements a {
    ...
    private final Map<String, Map<String, String>> f10629d = new a();

    /* renamed from: e  reason: collision with root package name */
    private final Map<String, Map<String, Boolean>> f10630e = new a();

    /* renamed from: f  reason: collision with root package name */
    private final Map<String, Map<String, Boolean>> f10631f = new a();
    ...
    private final void K(String str) {
        ...
        if (this.g.get(str) == null) {
            byte[] q0 = p().q0(str);
            if (q0 == null) {
                this.f10629d.put(str, (Object) null);
                this.f10630e.put(str, (Object) null);
                this.f10631f.put(str, (Object) null);
            ...
            y(str, zza);
            this.f10629d.put(str, x((zzby.zzb) ((zzfo) zza.q())));
    ...
    private final void y(String str, zzby.zzb.zza zza) {
        ...
        if (zza != null) {
            for (int i2 = 0; i2 < zza.C(); i2++) {
                zzby.zza.C0090zza zza2 = (zzby.zza.C0090zza) zza.D(i2).x();
        ...
        this.f10630e.put(str, aVar);
        this.f10631f.put(str, aVar2);
