...
final class t5 implements Runnable {
    ...
    private final URL f10437b;

    /* renamed from: c  reason: collision with root package name */
    private final r5 f10438c;

    /* renamed from: d  reason: collision with root package name */
    private final String f10439d;

    /* renamed from: e  reason: collision with root package name */
    private final Map<String, String> f10440e = null;

    /* renamed from: f  reason: collision with root package name */
    private final /* synthetic */ zzid f10441f;
    ...
    private final void b(int i, Exception exc, byte[] bArr, Map<String, List<String>> map) {
        this.f10441f.g().z(new s5(this, i, exc, bArr, map));
    }

    /* access modifiers changed from: package-private */
    public final /* synthetic */ void a(int i, Exception exc, byte[] bArr, Map map) {
        this.f10438c.a(this.f10439d, i, exc, bArr, map);
    }
    ...
    public final void run() {
        /*
            r7 = this;
            com.google.android.gms.measurement.internal.zzid r0 = r7.f10441f
            r0.b()
            r0 = 0
            r1 = 0
            com.google.android.gms.measurement.internal.zzid r2 = r7.f10441f     // Catch:{ IOException -> 0x006c, all -> 0x0060 }
            java.net.URL r3 = r7.f10437b     // Catch:{ IOException -> 0x006c, all -> 0x0060 }
            java.net.HttpURLConnection r2 = r2.u(r3)     // Catch:{ IOException -> 0x006c, all -> 0x0060 }
            java.util.Map<java.lang.String, java.lang.String> r3 = r7.f10440e     // Catch:{ IOException -> 0x005d, all -> 0x005a }
        ...
        L_0x0039:
            ...
            com.google.android.gms.measurement.internal.zzid r4 = r7.f10441f     // Catch:{ IOException -> 0x0055, all -> 0x0050 }
