...
public final class zzkf extends m7 {
    ...
    private final AlarmManager f10686d = ((AlarmManager) f().getSystemService("alarm"));

    /* renamed from: e  reason: collision with root package name */
    private final f f10687e;

    /* renamed from: f  reason: collision with root package name */
    private Integer f10688f;

    protected zzkf(zzkj zzkj) {
        super(zzkj);
        this.f10687e = new l7(this, zzkj.g0(), zzkj);
    }
    ...
    private final int y() {
        if (this.f10688f == null) {
            ...
            this.f10688f = Integer.valueOf((valueOf.length() != 0 ? "measurement".concat(valueOf) : new String("measurement")).hashCode());
        }
        return this.f10688f.intValue();
    }
    ...
    public final void v(long j) {
        ...
        long b2 = n().b() + j;
        if (j < Math.max(0, zzaq.x.a(null).longValue()) && !this.f10687e.d()) {
            this.f10687e.c(j);
        }
        m();
        if (Build.VERSION.SDK_INT >= 24) {
        ...
        this.f10686d.setInexactRepeating(2, b2, Math.max(zzaq.s.a(null).longValue(), j), z());
    }
