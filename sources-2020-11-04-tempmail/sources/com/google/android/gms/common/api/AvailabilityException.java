...
public class AvailabilityException extends Exception {
    ...
    private final a<zai<?>, ConnectionResult> f2871b;
    ...
    public ConnectionResult a(GoogleApi<? extends Api.ApiOptions> googleApi) {
        ...
        Preconditions.b(this.f2871b.get(j) != null, "The given API was not part of the availability request.");
        return this.f2871b.get(j);
    }
    ...
    public String getMessage() {
        ...
        boolean z = true;
        for (zai next : this.f2871b.keySet()) {
            ConnectionResult connectionResult = this.f2871b.get(next);
