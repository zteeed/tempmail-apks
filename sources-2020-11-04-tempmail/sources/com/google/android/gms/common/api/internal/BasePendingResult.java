...
public abstract class BasePendingResult<R extends Result> extends PendingResult<R> {
    ...
    private final CallbackHandler<R> f2910b = new CallbackHandler<>(Looper.getMainLooper());

    /* renamed from: c  reason: collision with root package name */
    private final WeakReference<GoogleApiClient> f2911c = new WeakReference<>((Object) null);

    /* renamed from: d  reason: collision with root package name */
    private final CountDownLatch f2912d = new CountDownLatch(1);

    /* renamed from: e  reason: collision with root package name */
    private final ArrayList<PendingResult.StatusListener> f2913e = new ArrayList<>();

    /* renamed from: f  reason: collision with root package name */
    private ResultCallback<? super R> f2914f;
    ...
    private final void k(R r) {
        this.h = r;
        this.m = null;
        this.f2912d.countDown();
        this.i = this.h.q();
        if (this.k) {
            this.f2914f = null;
        } else if (this.f2914f != null) {
            this.f2910b.removeMessages(2);
            this.f2910b.a(this.f2914f, e());
        } else if (this.h instanceof Releasable) {
            this.mResultGuardian = new a(this, (m0) null);
        }
        ArrayList<PendingResult.StatusListener> arrayList = this.f2913e;
    ...
    public final void c(PendingResult.StatusListener statusListener) {
        ...
        synchronized (this.f2909a) {
            if (g()) {
                ...
                this.f2913e.add(statusListener);
            }
        }
    }
    ...
    public final void i(com.google.android.gms.common.api.ResultCallback<? super R> r6) {
        /*
            r5 = this;
            java.lang.Object r0 = r5.f2909a
            monitor-enter(r0)
            if (r6 != 0) goto L_0x000a
            r6 = 0
            r5.f2914f = r6     // Catch:{ all -> 0x003f }
        ...
        L_0x002b:
            ...
            com.google.android.gms.common.api.internal.BasePendingResult$CallbackHandler<R> r1 = r5.f2910b     // Catch:{ all -> 0x003f }
    ...
    public final boolean p() {
        boolean f2;
        synchronized (this.f2909a) {
            if (((GoogleApiClient) this.f2911c.get()) == null || !this.o) {
                b();
            }
            f2 = f();
        }
