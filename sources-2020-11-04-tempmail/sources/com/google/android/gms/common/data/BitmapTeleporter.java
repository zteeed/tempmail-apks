...
public class BitmapTeleporter extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    private ParcelFileDescriptor f3112c;
    @SafeParcelable.Field
    ...
    BitmapTeleporter(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) ParcelFileDescriptor parcelFileDescriptor, @SafeParcelable.Param(id = 3) int i2) {
        this.f3111b = i;
        this.f3112c = parcelFileDescriptor;
        this.f3113d = i2;
    }
    ...
    private final FileOutputStream v() {
        File file = this.f3115f;
        if (file != null) {
            try {
                File createTempFile = File.createTempFile("teleporter", ".tmp", file);
                try {
                    FileOutputStream fileOutputStream = new FileOutputStream(createTempFile);
                    this.f3112c = ParcelFileDescriptor.open(createTempFile, 268435456);
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        SafeParcelWriter.l(parcel, 1, this.f3111b);
        SafeParcelWriter.r(parcel, 2, this.f3112c, i | 1, false);
        SafeParcelWriter.l(parcel, 3, this.f3113d);
