...
final class a {
    ...
    static final /* synthetic */ String b(boolean z, String str, c cVar) throws Exception {
        boolean z2 = true;
        if (z || !d(str, cVar, true, false).f3134a) {
            z2 = false;
        }
    ...
    static synchronized void c(android.content.Context r2) {
        /*
            ...
            monitor-enter(r0)
            android.content.Context r1 = f2866c     // Catch:{ all -> 0x001a }
            if (r1 != 0) goto L_0x0011
            if (r2 == 0) goto L_0x0018
            android.content.Context r2 = r2.getApplicationContext()     // Catch:{ all -> 0x001a }
            f2866c = r2     // Catch:{ all -> 0x001a }
            monitor-exit(r0)
            return
        L_0x0011:
    ...
    private static i d(String str, c cVar, boolean z, boolean z2) {
        try {
            if (f2864a == null) {
                Preconditions.k(f2866c);
                synchronized (f2865b) {
                    if (f2864a == null) {
                        f2864a = zzn.H(DynamiteModule.e(f2866c, DynamiteModule.k, "com.google.android.gms.googlecertificates").d("com.google.android.gms.common.GoogleCertificatesImpl"));
                    }
                }
            }
            Preconditions.k(f2866c);
            try {
                if (f2864a.M1(new zzk(str, cVar, z, z2), ObjectWrapper.h0(f2866c.getPackageManager()))) {
                    return i.f();
                }
