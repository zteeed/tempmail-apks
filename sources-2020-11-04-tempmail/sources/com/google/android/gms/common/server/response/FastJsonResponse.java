...
public abstract class FastJsonResponse {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        protected final int f3272e;
        @SafeParcelable.Field

        /* renamed from: f  reason: collision with root package name */
        protected final boolean f3273f;
        @SafeParcelable.Field
        ...
        public String toString() {
            ...
            c2.a("versionCode", Integer.valueOf(this.f3269b));
            c2.a("typeIn", Integer.valueOf(this.f3270c));
            c2.a("typeInArray", Boolean.valueOf(this.f3271d));
            c2.a("typeOut", Integer.valueOf(this.f3272e));
            c2.a("typeOutArray", Boolean.valueOf(this.f3273f));
        ...
        public void writeToParcel(Parcel parcel, int i2) {
            ...
            SafeParcelWriter.l(parcel, 1, this.f3269b);
            SafeParcelWriter.l(parcel, 2, this.f3270c);
            SafeParcelWriter.c(parcel, 3, this.f3271d);
            SafeParcelWriter.l(parcel, 4, this.f3272e);
            SafeParcelWriter.c(parcel, 5, this.f3273f);
