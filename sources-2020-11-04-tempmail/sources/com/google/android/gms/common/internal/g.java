...
final class g extends GmsClientSupervisor implements Handler.Callback {
    ...
    public final HashMap<GmsClientSupervisor.zza, h> f3233d = new HashMap<>();
    /* access modifiers changed from: private */
    ...
    g(Context context) {
        ...
        this.f3235f = new zze(context.getMainLooper(), this);
    ...
    public final boolean c(GmsClientSupervisor.zza zza, ServiceConnection serviceConnection, String str) {
        ...
        synchronized (this.f3233d) {
            h hVar = this.f3233d.get(zza);
            if (hVar == null) {
                hVar = new h(this, zza);
                hVar.e(serviceConnection, str);
                hVar.h(str);
                this.f3233d.put(zza, hVar);
            } else {
                this.f3235f.removeMessages(0, zza);
    ...
    public final void d(GmsClientSupervisor.zza zza, ServiceConnection serviceConnection, String str) {
        ...
        synchronized (this.f3233d) {
            ...
            if (hVar == null) {
                ...
                if (hVar.j()) {
                    this.f3235f.sendMessageDelayed(this.f3235f.obtainMessage(0, zza), this.h);
                }
            } else {
