...
public interface IAccountAccessor extends IInterface {
    ...
    public static abstract class Stub extends zzb implements IAccountAccessor {
        ...
        public static class zza extends com.google.android.gms.internal.common.zza implements IAccountAccessor {
            ...
            public final Account a0() throws RemoteException {
                Parcel H = H(2, B());
                Account account = (Account) zzc.b(H, Account.CREATOR);
                H.recycle();
                return account;
            }
        }
        ...
        public static IAccountAccessor H(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
    ...
    Account a0() throws RemoteException;
}
