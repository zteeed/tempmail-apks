...
public class WorkSourceUtil {
    ...
    private static final Method f3309a = l();

    /* renamed from: b  reason: collision with root package name */
    private static final Method f3310b = m();

    /* renamed from: c  reason: collision with root package name */
    private static final Method f3311c = n();

    /* renamed from: d  reason: collision with root package name */
    private static final Method f3312d = i();
    ...
    private static void g(WorkSource workSource, int i, String str) {
        if (f3310b != null) {
            ...
            try {
                f3310b.invoke(workSource, new Object[]{Integer.valueOf(i), str});
            } catch (Exception e2) {
                Log.wtf("WorkSourceUtil", "Unable to assign blame through WorkSource", e2);
            }
        } else {
