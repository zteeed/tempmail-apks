...
public class AdLoader {
    ...
    private final void zza(zzyq zzyq) {
        try {
            this.zzacr.x6(zzvf.b(this.zzvr, zzyq));
    ...
    public void loadAds(AdRequest adRequest, int i) {
        try {
            this.zzacr.d5(zzvf.b(this.zzvr, adRequest.zzdq()), i);
        } catch (RemoteException e2) {
    ...
    public static class Builder {
        ...
        public AdLoader build() {
            try {
                return new AdLoader(this.zzvr, this.zzacp.F5());
            } catch (RemoteException e2) {
        ...
        public Builder forAppInstallAd(NativeAppInstallAd.OnAppInstallAdLoadedListener onAppInstallAdLoadedListener) {
            try {
                this.zzacp.M4(new zzagd(onAppInstallAdLoadedListener));
            } catch (RemoteException e2) {
        ...
        public Builder forContentAd(NativeContentAd.OnContentAdLoadedListener onContentAdLoadedListener) {
            try {
                this.zzacp.U3(new zzagc(onContentAdLoadedListener));
            } catch (RemoteException e2) {
        ...
        public Builder forCustomTemplateAd(String str, NativeCustomTemplateAd.OnCustomTemplateAdLoadedListener onCustomTemplateAdLoadedListener, NativeCustomTemplateAd.OnCustomClickListener onCustomClickListener) {
            ...
            try {
                this.zzacp.y5(str, zzafz.e(), zzafz.f());
            } catch (RemoteException e2) {
        ...
        public Builder forPublisherAdView(OnPublisherAdViewLoadedListener onPublisherAdViewLoadedListener, AdSize... adSizeArr) {
            ...
            try {
                this.zzacp.n6(new zzagf(onPublisherAdViewLoadedListener), new zzvh(this.zzvr, adSizeArr));
            } catch (RemoteException e2) {
        ...
        public Builder forUnifiedNativeAd(UnifiedNativeAd.OnUnifiedNativeAdLoadedListener onUnifiedNativeAdLoadedListener) {
            try {
                this.zzacp.H3(new zzagh(onUnifiedNativeAdLoadedListener));
            } catch (RemoteException e2) {
        ...
        public Builder withAdListener(AdListener adListener) {
            try {
                this.zzacp.p1(new zzva(adListener));
            } catch (RemoteException e2) {
        ...
        public Builder withNativeAdOptions(NativeAdOptions nativeAdOptions) {
            try {
                this.zzacp.k4(new zzadj(nativeAdOptions));
            } catch (RemoteException e2) {
        ...
        public Builder withPublisherAdViewOptions(PublisherAdViewOptions publisherAdViewOptions) {
            try {
                this.zzacp.O1(publisherAdViewOptions);
            } catch (RemoteException e2) {
