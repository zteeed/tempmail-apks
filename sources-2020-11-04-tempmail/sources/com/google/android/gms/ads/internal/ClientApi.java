...
public class ClientApi extends zzxi {
    ...
    public final zzadx zza(IObjectWrapper iObjectWrapper, IObjectWrapper iObjectWrapper2) {
        return new zzcde((FrameLayout) ObjectWrapper.V(iObjectWrapper), (FrameLayout) ObjectWrapper.V(iObjectWrapper2), 201604000);
    }
    ...
    public final zzxm zza(IObjectWrapper iObjectWrapper, int i) {
        return zzbif.v((Context) ObjectWrapper.V(iObjectWrapper), i).k();
    }

    public final zzww zza(IObjectWrapper iObjectWrapper, zzvh zzvh, String str, int i) {
        return new zzl((Context) ObjectWrapper.V(iObjectWrapper), zzvh, str, new zzbbd(201604000, i, true, false));
    }

    public final zzawr zzb(IObjectWrapper iObjectWrapper, zzamr zzamr, int i) {
        return zzbif.b((Context) ObjectWrapper.V(iObjectWrapper), zzamr, i).t();
    }

    public final zzaea zza(IObjectWrapper iObjectWrapper, IObjectWrapper iObjectWrapper2, IObjectWrapper iObjectWrapper3) {
        return new zzcdf((View) ObjectWrapper.V(iObjectWrapper), (HashMap) ObjectWrapper.V(iObjectWrapper2), (HashMap) ObjectWrapper.V(iObjectWrapper3));
    }
}
