...
public final class NativeContentAdView extends NativeAdView {
    ...
    public final View getAdvertiserView() {
        return super.zzbm(NativeContentAd.ASSET_ADVERTISER);
    }

    public final View getBodyView() {
        return super.zzbm(NativeContentAd.ASSET_BODY);
    }

    public final View getCallToActionView() {
        return super.zzbm(NativeContentAd.ASSET_CALL_TO_ACTION);
    }

    public final View getHeadlineView() {
        return super.zzbm(NativeContentAd.ASSET_HEADLINE);
    }

    public final View getImageView() {
        return super.zzbm(NativeContentAd.ASSET_IMAGE);
    }

    public final View getLogoView() {
        return super.zzbm(NativeContentAd.ASSET_LOGO);
    }

    public final MediaView getMediaView() {
        View zzbm = super.zzbm(NativeContentAd.ASSET_MEDIA_VIDEO);
