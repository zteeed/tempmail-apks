...
public class DetectedActivity extends AbstractSafeParcelable {
    ...
    private static final int[] f10028d = {0, 1, 2, 3, 7, 8, 16, 17};
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && DetectedActivity.class == obj.getClass()) {
            ...
            return this.f10029b == detectedActivity.f10029b && this.f10030c == detectedActivity.f10030c;
        }
    }

    public int hashCode() {
        return Objects.b(Integer.valueOf(this.f10029b), Integer.valueOf(this.f10030c));
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        SafeParcelWriter.l(parcel, 1, this.f10029b);
        SafeParcelWriter.l(parcel, 2, this.f10030c);
