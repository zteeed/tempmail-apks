...
public abstract class zzv extends zzb implements zzu {
    ...
    public static zzu H(IBinder iBinder) {
        if (iBinder == null) {
            return null;
        }
    ...
    public final boolean B(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
        if (i == 1) {
            a5((LocationResult) zzc.a(parcel, LocationResult.CREATOR));
        } else if (i != 2) {
            return false;
        } else {
            N3((LocationAvailability) zzc.a(parcel, LocationAvailability.CREATOR));
        }
        return true;
    }
}
