...
public class GcmNetworkManager {
    ...
    private static GcmNetworkManager f3394c;
    ...
    private final Map<String, Map<String, Boolean>> f3396b = new a();
    ...
    public static GcmNetworkManager b(Context context) {
        ...
        synchronized (GcmNetworkManager.class) {
            if (f3394c == null) {
                f3394c = new GcmNetworkManager(context.getApplicationContext());
            }
            gcmNetworkManager = f3394c;
        }
    ...
    private final h g() {
        if (GoogleCloudMessaging.e(this.f3395a) >= 5000000) {
            return new g(this.f3395a);
        }
    ...
    private final boolean i(String str) {
        ...
        PackageManager packageManager = this.f3395a.getPackageManager();
        if (packageManager == null) {
            list = Collections.emptyList();
        } else {
            if (str != null) {
                intent = new Intent("com.google.android.gms.gcm.ACTION_TASK_READY").setClassName(this.f3395a, str);
            } else {
                intent = new Intent("com.google.android.gms.gcm.ACTION_TASK_READY").setPackage(this.f3395a.getPackageName());
            }
    ...
    public synchronized void c(com.google.android.gms.gcm.Task r5) {
        ...
        L_0x001e:
            ...
            java.util.Map<java.lang.String, java.util.Map<java.lang.String, java.lang.Boolean>> r1 = r4.f3396b     // Catch:{ all -> 0x0059 }
    ...
    public final synchronized boolean f(String str, String str2) {
        Map map;
        map = this.f3396b.get(str2);
        if (map == null) {
            map = new a();
            this.f3396b.put(str2, map);
        }
    ...
    public final synchronized void h(String str, String str2) {
        Map map = this.f3396b.get(str2);
        if (map != null) {
            if ((map.remove(str) != null) && map.isEmpty()) {
                this.f3396b.remove(str2);
            }
        }
    }
    ...
    public final synchronized boolean j(String str) {
        return this.f3396b.containsKey(str);
    }
