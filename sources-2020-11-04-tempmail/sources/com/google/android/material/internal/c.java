...
public final class c {
    ...
    private final Rect f11022d;

    /* renamed from: e  reason: collision with root package name */
    private final Rect f11023e;

    /* renamed from: f  reason: collision with root package name */
    private final RectF f11024f;
    private int g = 16;
    private int h = 16;
    ...
    public c(View view) {
        ...
        this.f11022d = new Rect();
        this.f11024f = new RectF();
    }

    private Typeface B(int i2) {
        TypedArray obtainStyledAttributes = this.f11019a.getContext().obtainStyledAttributes(i2, new int[]{16843692});
        try {
    ...
    private void b() {
        ...
        int i2 = b2 & 112;
        if (i2 == 48) {
            this.n = ((float) this.f11023e.top) - this.H.ascent();
        } else if (i2 != 80) {
            this.n = ((float) this.f11023e.centerY()) + (((this.H.descent() - this.H.ascent()) / 2.0f) - this.H.descent());
        } else {
            this.n = (float) this.f11023e.bottom;
        }
        int i3 = b2 & 8388615;
        if (i3 == 1) {
            this.p = ((float) this.f11023e.centerX()) - (measureText / 2.0f);
        } else if (i3 != 5) {
            this.p = (float) this.f11023e.left;
        } else {
            this.p = ((float) this.f11023e.right) - measureText;
        }
        g(this.i);
        ...
        int i4 = b3 & 112;
        if (i4 == 48) {
            this.m = ((float) this.f11022d.top) - this.H.ascent();
        } else if (i4 != 80) {
            this.m = ((float) this.f11022d.centerY()) + (((this.H.descent() - this.H.ascent()) / 2.0f) - this.H.descent());
        } else {
            this.m = (float) this.f11022d.bottom;
        }
        int i5 = b3 & 8388615;
        if (i5 == 1) {
            this.o = ((float) this.f11022d.centerX()) - (f3 / 2.0f);
        } else if (i5 != 5) {
            this.o = (float) this.f11022d.left;
        } else {
            this.o = ((float) this.f11022d.right) - f3;
        }
        h();
        Q(f2);
    }
    ...
    private boolean e(CharSequence charSequence) {
        boolean z2 = true;
        if (u.t(this.f11019a) != 1) {
            z2 = false;
        }
        return (z2 ? e.f343d : e.f342c).a(charSequence, 0, charSequence.length());
    }
    ...
    private void g(float f2) {
        ...
        boolean z3;
        if (this.v != null) {
            float width = (float) this.f11023e.width();
            float width2 = (float) this.f11022d.width();
            boolean z4 = true;
            if (x(f2, this.j)) {
                f3 = this.j;
                this.D = 1.0f;
    ...
    private void j() {
        if (this.z == null && !this.f11022d.isEmpty() && !TextUtils.isEmpty(this.w)) {
            f(0.0f);
    ...
    private void w(float f2) {
        this.f11024f.left = z((float) this.f11022d.left, (float) this.f11023e.left, f2, this.J);
        this.f11024f.top = z(this.m, this.n, f2, this.J);
        this.f11024f.right = z((float) this.f11022d.right, (float) this.f11023e.right, f2, this.J);
        this.f11024f.bottom = z((float) this.f11022d.bottom, (float) this.f11023e.bottom, f2, this.J);
    }
    ...
    public void A() {
        this.f11020b = this.f11023e.width() > 0 && this.f11023e.height() > 0 && this.f11022d.width() > 0 && this.f11022d.height() > 0;
    }

    public void C() {
        if (this.f11019a.getHeight() > 0 && this.f11019a.getWidth() > 0) {
            b();
            d();
        }
    }
    ...
    public void E(int i2, int i3, int i4, int i5) {
        if (!D(this.f11023e, i2, i3, i4, i5)) {
            this.f11023e.set(i2, i3, i4, i5);
            this.G = true;
            A();
        }
    }
    ...
    public void F(int i2) {
        b0 s2 = b0.s(this.f11019a.getContext(), i2, j.TextAppearance);
    ...
    public void J(int i2, int i3, int i4, int i5) {
        if (!D(this.f11022d, i2, i3, i4, i5)) {
            this.f11022d.set(i2, i3, i4, i5);
            this.G = true;
            A();
        }
    }
    ...
    public void k(RectF rectF) {
        ...
        rectF.bottom = ((float) this.f11023e.top) + n();
    }
