...
public class CollapsingToolbarLayout extends FrameLayout {
        ...
        public void a(AppBarLayout appBarLayout, int i) {
            ...
            for (int i2 = 0; i2 < childCount; i2++) {
                ...
                if (i3 == 1) {
                    ...
                    h.e(Math.round(((float) (-i)) * cVar.f10833b));
                }
            }
            ...
            CollapsingToolbarLayout.this.l.P(((float) Math.abs(i)) / ((float) ((CollapsingToolbarLayout.this.getHeight() - u.u(CollapsingToolbarLayout.this)) - e2)));
        }
    }
    ...
    private void a(int i2) {
        ...
        if (valueAnimator == null) {
            ...
            this.s.setInterpolator(i2 > this.q ? b.c.a.d.l.a.f2365c : b.c.a.d.l.a.f2366d);
    ...
    private void b() {
        ...
        L_0x0005:
            ...
            r6.f10828e = r1
        L_0x001f:
            androidx.appcompat.widget.Toolbar r1 = r6.f10827d
            r2 = 0
    ...
    private void l() {
        View view;
        if (!this.m && (view = this.f10829f) != null) {
            ViewParent parent = view.getParent();
            if (parent instanceof ViewGroup) {
                ((ViewGroup) parent).removeView(this.f10829f);
            }
        }
        if (this.m && this.f10827d != null) {
            if (this.f10829f == null) {
                this.f10829f = new View(getContext());
            }
            if (this.f10829f.getParent() == null) {
                this.f10827d.addView(this.f10829f, -1, -1);
            }
        }
    }
    ...
    public void draw(Canvas canvas) {
        ...
        super.draw(canvas);
        b();
        if (this.f10827d == null && (drawable = this.o) != null && this.q > 0) {
    ...
    public void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        if (c0Var != null) {
            ...
            for (int i6 = 0; i6 < childCount; i6++) {
                ...
                if (!u.q(childAt) && childAt.getTop() < e2) {
                    u.O(childAt, e2);
                }
            }
        }
        if (this.m && (view = this.f10829f) != null) {
            boolean z2 = true;
            boolean z3 = u.H(view) && this.f10829f.getVisibility() == 0;
            this.n = z3;
            if (z3) {
                if (u.t(this) != 1) {
                    z2 = false;
                ...
                int g2 = g(view2);
                com.google.android.material.internal.d.a(this, this.f10829f, this.k);
                this.l.E(this.k.left + (z2 ? this.f10827d.getTitleMarginEnd() : this.f10827d.getTitleMarginStart()), this.k.top + g2 + this.f10827d.getTitleMarginTop(), this.k.right + (z2 ? this.f10827d.getTitleMarginStart() : this.f10827d.getTitleMarginEnd()), (this.k.bottom + g2) - this.f10827d.getTitleMarginBottom());
        ...
        if (this.f10827d != null) {
            if (this.m && TextUtils.isEmpty(this.l.u())) {
                setTitle(this.f10827d.getTitle());
            }
            View view3 = this.f10828e;
            if (view3 == null || view3 == this) {
                setMinimumHeight(f(this.f10827d));
            } else {
    ...
    public void setScrimAlpha(int i2) {
        Toolbar toolbar;
        if (i2 != this.q) {
            if (!(this.o == null || (toolbar = this.f10827d) == null)) {
                u.T(toolbar);
            }
            this.q = i2;
            u.T(this);
    ...
    public void setScrimsShown(boolean z) {
        setScrimsShown(z, u.I(this) && !isInEditMode());
    }
    ...
    public void setStatusBarScrim(Drawable drawable) {
        ...
        if (drawable2 != drawable) {
            ...
            if (drawable3 != null) {
                ...
                androidx.core.graphics.drawable.a.m(this.p, u.t(this));
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.f10826c = h2.getResourceId(b.c.a.d.k.CollapsingToolbarLayout_toolbarId, -1);
        h2.recycle();
    ...
    public static class c extends FrameLayout.LayoutParams {
        ...
        public c(Context context, AttributeSet attributeSet) {
            ...
            this.f10832a = obtainStyledAttributes.getInt(b.c.a.d.k.CollapsingToolbarLayout_Layout_layout_collapseMode, 0);
