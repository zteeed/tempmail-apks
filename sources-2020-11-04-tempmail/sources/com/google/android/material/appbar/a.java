...
abstract class a<V extends View> extends c<V> {
    ...
    private class C0092a implements Runnable {
        ...
        private final CoordinatorLayout f10838b;

        /* renamed from: c  reason: collision with root package name */
        private final V f10839c;

        C0092a(CoordinatorLayout coordinatorLayout, V v) {
            this.f10838b = coordinatorLayout;
            this.f10839c = v;
        }

        public void run() {
            OverScroller overScroller;
            if (this.f10839c != null && (overScroller = a.this.f10836e) != null) {
                if (overScroller.computeScrollOffset()) {
                    a aVar = a.this;
                    aVar.O(this.f10838b, this.f10839c, aVar.f10836e.getCurrY());
                    u.V(this.f10839c, this);
                    return;
                }
                a.this.M(this.f10838b, this.f10839c);
            }
        }
    }
    ...
    public final boolean I(CoordinatorLayout coordinatorLayout, V v, int i2, int i3, float f2) {
        V v2 = v;
        Runnable runnable = this.f10835d;
        if (runnable != null) {
            v.removeCallbacks(runnable);
            this.f10835d = null;
        }
        if (this.f10836e == null) {
            this.f10836e = new OverScroller(v.getContext());
        }
        this.f10836e.fling(0, D(), 0, Math.round(f2), 0, 0, i2, i3);
        if (this.f10836e.computeScrollOffset()) {
            CoordinatorLayout coordinatorLayout2 = coordinatorLayout;
            C0092a aVar = new C0092a(coordinatorLayout, v);
            this.f10835d = aVar;
            u.V(v, aVar);
            return true;
        }
