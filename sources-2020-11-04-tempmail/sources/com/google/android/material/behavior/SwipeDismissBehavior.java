...
public class SwipeDismissBehavior<V extends View> extends CoordinatorLayout.c<V> {
    ...
    class a extends c.C0019c {
        ...
        public int a(View view, int i, int i2) {
            ...
            int i4;
            int width;
            boolean z = u.t(view) == 1;
            int i5 = SwipeDismissBehavior.this.f10862f;
            if (i5 != 0) {
                if (i5 != 1) {
                    i3 = this.f10863a - view.getWidth();
                    i4 = view.getWidth() + this.f10863a;
                } else if (z) {
                    i3 = this.f10863a;
                    width = view.getWidth();
                } else {
        ...
        public void j(int i) {
            b bVar = SwipeDismissBehavior.this.f10858b;
            if (bVar != null) {
                bVar.b(i);
            }
        }
        ...
        public void k(View view, int i, int i2, int i3, int i4) {
            float width = ((float) this.f10863a) + (((float) view.getWidth()) * SwipeDismissBehavior.this.h);
            float width2 = ((float) this.f10863a) + (((float) view.getWidth()) * SwipeDismissBehavior.this.i);
            float f2 = (float) i;
            if (f2 <= width) {
                view.setAlpha(1.0f);
            } else if (f2 >= width2) {
        ...
        public void l(View view, float f2, float f3) {
            ...
            if (SwipeDismissBehavior.this.f10857a.N(i, view.getTop())) {
                u.V(view, new c(view, z));
            } else if (z && (bVar = SwipeDismissBehavior.this.f10858b) != null) {
                bVar.a(view);
            }
        }

        public boolean m(View view, int i) {
            return this.f10864b == -1 && SwipeDismissBehavior.this.D(view);
        }
    }
    ...
    private class c implements Runnable {
        ...
        public void run() {
            b bVar;
            a.j.a.c cVar = SwipeDismissBehavior.this.f10857a;
            if (cVar != null && cVar.n(true)) {
                u.V(this.f10866b, this);
            } else if (this.f10867c && (bVar = SwipeDismissBehavior.this.f10858b) != null) {
                bVar.a(this.f10866b);
            }
        }
    }
    ...
    private void G(ViewGroup viewGroup) {
        ...
        if (this.f10857a == null) {
            if (this.f10861e) {
                cVar = a.j.a.c.o(viewGroup, this.f10860d, this.j);
            } else {
    ...
    public boolean k(CoordinatorLayout coordinatorLayout, V v, MotionEvent motionEvent) {
        ...
        G(coordinatorLayout);
        return this.f10857a.O(motionEvent);
    }
}
