...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    private final Rect f11170c = new Rect();

    /* renamed from: d  reason: collision with root package name */
    private final RectF f11171d = new RectF();

    /* renamed from: e  reason: collision with root package name */
    private final RectF f11172e = new RectF();

    /* renamed from: f  reason: collision with root package name */
    private final int[] f11173f = new int[2];
    ...
    class a extends AnimatorListenerAdapter {
        ...
        public void onAnimationStart(Animator animator) {
            if (this.f11174a) {
                ...
                this.f11176c.setAlpha(0.0f);
                this.f11176c.setVisibility(4);
            }
        }
    }
    ...
    class c extends AnimatorListenerAdapter {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ com.google.android.material.circularreveal.c f11178a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ Drawable f11179b;
        ...
        c(FabTransformationBehavior fabTransformationBehavior, com.google.android.material.circularreveal.c cVar, Drawable drawable) {
            this.f11178a = cVar;
            this.f11179b = drawable;
        }

        public void onAnimationEnd(Animator animator) {
            this.f11178a.setCircularRevealOverlayDrawable((Drawable) null);
        }

        public void onAnimationStart(Animator animator) {
            this.f11178a.setCircularRevealOverlayDrawable(this.f11179b);
        }
    }
    ...
    class d extends AnimatorListenerAdapter {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ com.google.android.material.circularreveal.c f11180a;
        ...
        public void onAnimationEnd(Animator animator) {
            c.e revealInfo = this.f11180a.getRevealInfo();
            revealInfo.f10967c = Float.MAX_VALUE;
            this.f11180a.setRevealInfo(revealInfo);
        }
    }
    ...
    private void K(View view, e eVar, i iVar, i iVar2, float f2, float f3, float f4, float f5, RectF rectF) {
        ...
        Rect rect = this.f11170c;
        view.getWindowVisibleDisplayFrame(rect);
        RectF rectF2 = this.f11171d;
        rectF2.set(rect);
    ...
    private void R(View view, View view2, boolean z, boolean z2, e eVar, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof ViewGroup) {
            if ((!(view2 instanceof com.google.android.material.circularreveal.c) || com.google.android.material.circularreveal.b.j != 0) && (J = J(view2)) != null) {
                if (z) {
                    if (!z2) {
                        b.c.a.d.l.d.f2369a.set(J, Float.valueOf(0.0f));
                    }
                    objectAnimator = ObjectAnimator.ofFloat(J, b.c.a.d.l.d.f2369a, new float[]{1.0f});
                } else {
                    objectAnimator = ObjectAnimator.ofFloat(J, b.c.a.d.l.d.f2369a, new float[]{0.0f});
                }
                eVar.f11181a.e("contentFade").a(objectAnimator);
    ...
    private void S(View view, View view2, boolean z, boolean z2, e eVar, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof com.google.android.material.circularreveal.c) {
            ...
            if (z) {
                ...
                objectAnimator = ObjectAnimator.ofInt(cVar, c.d.f10964a, new int[]{i});
            } else {
                objectAnimator = ObjectAnimator.ofInt(cVar, c.d.f10964a, new int[]{Z});
            }
            objectAnimator.setEvaluator(b.c.a.d.l.c.b());
            eVar.f11181a.e("color").a(objectAnimator);
            list.add(objectAnimator);
        }
    }
    ...
    private void T(View view, View view2, boolean z, boolean z2, e eVar, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        eVar.f11181a.e("elevation").a(objectAnimator);
        list.add(objectAnimator);
    }
    ...
    private void U(View view, View view2, boolean z, boolean z2, e eVar, float f2, float f3, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ...
        if (view4 instanceof com.google.android.material.circularreveal.c) {
            ...
            float L = L(view3, view4, eVar2.f11182b);
            float M = M(view3, view4, eVar2.f11182b);
            ((FloatingActionButton) view3).h(this.f11170c);
            float width = ((float) this.f11170c.width()) / 2.0f;
            i e2 = eVar2.f11181a.e("expansion");
            if (z) {
                if (!z2) {
                    cVar.setRevealInfo(new c.e(L, M, width));
                }
                if (z2) {
                    width = cVar.getRevealInfo().f10967c;
                }
                ...
                float f4 = cVar.getRevealInfo().f10967c;
        ...
        if ((view2 instanceof com.google.android.material.circularreveal.c) && (view instanceof ImageView)) {
            ...
            if (drawable != null) {
                ...
                if (z) {
                    ...
                    objectAnimator = ObjectAnimator.ofInt(drawable, b.c.a.d.l.e.f2370b, new int[]{0});
                } else {
                    objectAnimator = ObjectAnimator.ofInt(drawable, b.c.a.d.l.e.f2370b, new int[]{255});
                }
                objectAnimator.addUpdateListener(new b(this, view2));
                eVar.f11181a.e("iconFade").a(objectAnimator);
                list.add(objectAnimator);
    ...
    private void Y(View view, View view2, boolean z, boolean z2, e eVar, List<Animator> list, List<Animator.AnimatorListener> list2, RectF rectF) {
        ...
        float N = N(view3, view4, eVar2.f11182b);
        float O = O(view3, view4, eVar2.f11182b);
        if (N == 0.0f || O == 0.0f) {
            iVar2 = eVar2.f11181a.e("translationXLinear");
            iVar = eVar2.f11181a.e("translationYLinear");
        } else if ((!z || O >= 0.0f) && (z || i <= 0)) {
            iVar2 = eVar2.f11181a.e("translationXCurveDownwards");
            iVar = eVar2.f11181a.e("translationYCurveDownwards");
        } else {
            iVar2 = eVar2.f11181a.e("translationXCurveUpwards");
            iVar = eVar2.f11181a.e("translationYCurveUpwards");
        }
        i iVar3 = iVar2;
        i iVar4 = iVar;
        if (z) {
