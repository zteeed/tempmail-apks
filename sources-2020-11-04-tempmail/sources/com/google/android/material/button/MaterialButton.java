...
public class MaterialButton extends AppCompatButton {
    ...
    private PorterDuff.Mode f10924f;
    ...
    private void c() {
        ...
        if (drawable != null) {
            ...
            this.h = mutate;
            a.o(mutate, this.g);
            PorterDuff.Mode mode = this.f10924f;
            if (mode != null) {
                a.p(this.h, mode);
            }
            int i2 = this.i;
    ...
    public void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        if (Build.VERSION.SDK_INT == 21 && (bVar = this.f10922d) != null) {
            bVar.v(i5 - i3, i4 - i2);
        }
    }
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (this.h != null && this.k == 2) {
            ...
            int measuredWidth = (((((getMeasuredWidth() - measureText) - u.w(this)) - i4) - this.f10923e) - u.x(this)) / 2;
            if (a()) {
    ...
    public MaterialButton(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.f10923e = h2.getDimensionPixelSize(b.c.a.d.k.MaterialButton_iconPadding, 0);
        this.f10924f = l.b(h2.getInt(b.c.a.d.k.MaterialButton_iconTintMode, -1), PorterDuff.Mode.SRC_IN);
        ...
        bVar.k(h2);
        h2.recycle();
        setCompoundDrawablePadding(this.f10923e);
        c();
    }
}
