...
public class FloatingActionButton extends VisibilityAwareImageButton implements t, k, b.c.a.d.o.a {

    /* renamed from: c  reason: collision with root package name */
    private ColorStateList f10968c;

    /* renamed from: d  reason: collision with root package name */
    private PorterDuff.Mode f10969d;

    /* renamed from: e  reason: collision with root package name */
    private ColorStateList f10970e;

    /* renamed from: f  reason: collision with root package name */
    private PorterDuff.Mode f10971f;
    private int g;
    ...
    class a implements a.g {
        ...
        public void a() {
            this.f10975a.b(FloatingActionButton.this);
        }

        public void b() {
            this.f10975a.a(FloatingActionButton.this);
        }
    }
    ...
    private void n() {
        ...
        if (drawable != null) {
            ColorStateList colorStateList = this.f10970e;
            if (colorStateList == null) {
                androidx.core.graphics.drawable.a.c(drawable);
                return;
            }
            int colorForState = colorStateList.getColorForState(getDrawableState(), 0);
            PorterDuff.Mode mode = this.f10971f;
            if (mode == null) {
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        this.q.d(extendableSavedState.f11098d.get("expandableWidgetHelper"));
    }

    /* access modifiers changed from: protected */
    public Parcelable onSaveInstanceState() {
        ExtendableSavedState extendableSavedState = new ExtendableSavedState(super.onSaveInstanceState());
        extendableSavedState.f11098d.put("expandableWidgetHelper", this.q.e());
    ...
    public void setBackgroundTintList(ColorStateList colorStateList) {
        if (this.f10968c != colorStateList) {
            this.f10968c = colorStateList;
            getImpl().I(colorStateList);
        }
    }

    public void setBackgroundTintMode(PorterDuff.Mode mode) {
        if (this.f10969d != mode) {
            this.f10969d = mode;
            getImpl().J(mode);
        }
    }
    ...
    public void setSupportImageTintList(ColorStateList colorStateList) {
        if (this.f10970e != colorStateList) {
            this.f10970e = colorStateList;
            n();
        }
    }

    public void setSupportImageTintMode(PorterDuff.Mode mode) {
        if (this.f10971f != mode) {
            this.f10971f = mode;
            n();
        }
    }
    ...
    protected static class BaseBehavior<T extends FloatingActionButton> extends CoordinatorLayout.c<T> {
        ...
        private void F(CoordinatorLayout coordinatorLayout, FloatingActionButton floatingActionButton) {
            ...
            if (rect != null && rect.centerX() > 0 && rect.centerY() > 0) {
                ...
                if (i2 != 0) {
                    u.O(floatingActionButton, i2);
                }
                if (i != 0) {
                    u.N(floatingActionButton, i);
                }
            }
        }
        ...
        private boolean I(View view, FloatingActionButton floatingActionButton) {
            CoordinatorLayout.f fVar = (CoordinatorLayout.f) floatingActionButton.getLayoutParams();
            if (this.f10974c && fVar.e() == view.getId() && floatingActionButton.getUserSetVisibility() == 0) {
                return true;
            }
            return false;
        }
        ...
        private boolean J(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, FloatingActionButton floatingActionButton) {
            ...
            if (this.f10972a == null) {
                this.f10972a = new Rect();
            }
            Rect rect = this.f10972a;
            com.google.android.material.internal.d.a(coordinatorLayout, appBarLayout, rect);
            if (rect.bottom <= appBarLayout.getMinimumHeightForVisibleOverlappingContent()) {
                floatingActionButton.k(this.f10973b, false);
                return true;
            }
            floatingActionButton.r(this.f10973b, false);
            return true;
        }
        ...
        public BaseBehavior(Context context, AttributeSet attributeSet) {
            ...
            this.f10974c = obtainStyledAttributes.getBoolean(b.c.a.d.k.FloatingActionButton_Behavior_Layout_behavior_autoHide, true);
    ...
    public FloatingActionButton(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.f10968c = b.c.a.d.q.a.a(context, h2, b.c.a.d.k.FloatingActionButton_backgroundTint);
        this.f10969d = l.b(h2.getInt(b.c.a.d.k.FloatingActionButton_backgroundTintMode, -1), (PorterDuff.Mode) null);
        ...
        getImpl().H(this.f10968c, this.f10969d, this.h, this.g);
        getImpl().K(dimension);
