...
class a {
    static final TimeInterpolator B = b.c.a.d.l.a.f2365c;
    ...
    private b.c.a.d.l.h f10982e;

    /* renamed from: f  reason: collision with root package name */
    private b.c.a.d.l.h f10983f;
    ...
    class C0096a extends AnimatorListenerAdapter {
        ...
        public void onAnimationEnd(Animator animator) {
            ...
            aVar.f10979b = null;
            if (!this.f10984a) {
                aVar.u.b(this.f10985b ? 8 : 4, this.f10985b);
                g gVar = this.f10986c;
                if (gVar != null) {
                    gVar.b();
                }
        ...
        public void onAnimationStart(Animator animator) {
            a.this.u.b(0, this.f10985b);
            a aVar = a.this;
            aVar.f10978a = 1;
            aVar.f10979b = animator;
            this.f10984a = false;
        }
    }
    ...
    private abstract class i extends AnimatorListenerAdapter implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationEnd(Animator animator) {
            a.this.h.k(this.f10997c);
            this.f10995a = false;
        }

        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            if (!this.f10995a) {
                this.f10996b = a.this.h.h();
                this.f10997c = a();
                this.f10995a = true;
            }
            b.c.a.d.s.a aVar = a.this.h;
            float f2 = this.f10996b;
            aVar.k(f2 + ((this.f10997c - f2) * valueAnimator.getAnimatedFraction()));
        }

        /* synthetic */ i(a aVar, C0096a aVar2) {
            this();
        }
    }
    ...
    private boolean S() {
        return u.I(this.u) && !this.u.isInEditMode();
    }
    ...
    private b.c.a.d.l.h j() {
        if (this.f10983f == null) {
            this.f10983f = b.c.a.d.l.h.c(this.u.getContext(), b.c.a.d.a.design_fab_hide_motion_spec);
        }
        return this.f10983f;
    }
    ...
    private b.c.a.d.l.h k() {
        if (this.f10982e == null) {
            this.f10982e = b.c.a.d.l.h.c(this.u.getContext(), b.c.a.d.a.design_fab_show_motion_spec);
        }
        return this.f10982e;
    }
    ...
    public void T(g gVar, boolean z2) {
        if (!t()) {
            Animator animator = this.f10979b;
            if (animator != null) {
                animator.cancel();
            }
            if (S()) {
    ...
    public void r(g gVar, boolean z2) {
        if (!s()) {
            ...
            if (S()) {
                b.c.a.d.l.h hVar = this.f10981d;
                if (hVar == null) {
                    hVar = j();
                }
                AnimatorSet d2 = d(hVar, 0.0f, 0.0f, 0.0f);
                d2.addListener(new C0096a(z2, gVar));
                ArrayList<Animator.AnimatorListener> arrayList = this.t;
                if (arrayList != null) {
                    Iterator<Animator.AnimatorListener> it = arrayList.iterator();
                    while (it.hasNext()) {
