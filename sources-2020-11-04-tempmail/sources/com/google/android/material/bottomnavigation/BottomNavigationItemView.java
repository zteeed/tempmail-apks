...
public class BottomNavigationItemView extends FrameLayout implements p.a {
    ...
    private void a(float f2, float f3) {
        this.f10889c = f2 - f3;
        this.f10890d = (f3 * 1.0f) / f2;
        this.f10891e = (f2 * 1.0f) / f3;
    }
    ...
    public void setChecked(boolean z) {
        ...
        if (i2 != -1) {
            if (i2 == 0) {
                if (z) {
                    b(this.h, this.f10888b, 49);
                    c(this.j, 1.0f, 1.0f, 0);
                } else {
                    b(this.h, this.f10888b, 17);
                ...
                b(this.h, (int) (((float) this.f10888b) + this.f10889c), 49);
                c(this.j, 1.0f, 1.0f, 0);
            ...
            float f4 = this.f10890d;
            c(textView7, f4, f4, 4);
        } else {
            b(this.h, this.f10888b, 49);
            TextView textView8 = this.j;
            float f5 = this.f10891e;
            c(textView8, f5, f5, 4);
            c(this.i, 1.0f, 1.0f, 0);
        }
        refreshDrawableState();
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.f10888b = resources.getDimensionPixelSize(d.design_bottom_navigation_margin);
