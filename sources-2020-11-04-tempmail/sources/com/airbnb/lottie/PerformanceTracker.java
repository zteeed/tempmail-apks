...
public class PerformanceTracker {
    ...
    private final Comparator<d<String, Float>> floatComparator = new Comparator<d<String, Float>>() {
        public int compare(d<String, Float> dVar, d<String, Float> dVar2) {
            float floatValue = ((Float) dVar.f354b).floatValue();
            float floatValue2 = ((Float) dVar2.f354b).floatValue();
    ...
    public void logRenderTimes() {
        if (this.enabled) {
            ...
            for (int i = 0; i < sortedRenderTimes.size(); i++) {
                ...
                Log.d(L.TAG, String.format("\t\t%30s:%.2f", new Object[]{dVar.f353a, dVar.f354b}));
            }
        }
    }
