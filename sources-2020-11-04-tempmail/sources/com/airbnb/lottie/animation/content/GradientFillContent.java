...
public class GradientFillContent implements DrawingContent, BaseKeyframeAnimation.AnimationListener, KeyPathElementContent {
    ...
    private RadialGradient getRadialGradient() {
        ...
        float f2 = value.x;
        float f3 = value.y;
        float hypot = (float) Math.hypot((double) (value2.x - f2), (double) (value2.y - f3));
        RadialGradient radialGradient = new RadialGradient(f2, f3, hypot <= 0.0f ? 0.001f : hypot, applyDynamicColorsIfNeeded, positions, Shader.TileMode.CLAMP);
