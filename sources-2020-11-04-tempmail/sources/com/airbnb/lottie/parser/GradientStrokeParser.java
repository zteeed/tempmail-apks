...
class GradientStrokeParser {
    ...
    private static final JsonReader.Options GRADIENT_NAMES = JsonReader.Options.of(p.g, "k");
    private static JsonReader.Options NAMES = JsonReader.Options.of("nm", g.f13030e, "o", "t", "s", "e", "w", "lc", "lj", "ml", "hd", "d");
                ...
                case 11:
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        if (str2.equals("o")) {
                            ...
                            if (str2.equals("d") || str2.equals(g.f13030e)) {
