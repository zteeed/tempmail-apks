...
public final class c<T> implements e<T> {
    ...
    final AtomicLong f14340b = new AtomicLong();
    ...
    AtomicReferenceArray<Object> f14344f;
    final int g;
    ...
    public c(int i2) {
        ...
        this.f14344f = atomicReferenceArray;
        this.f14343e = i3;
        a(a2);
        this.h = atomicReferenceArray;
        this.g = i3;
        this.f14342d = (long) (i3 - 1);
        t(0);
    }

    private void a(int i2) {
        this.f14341c = Math.min(i2 / 4, j);
    }
    ...
    private void o(AtomicReferenceArray<Object> atomicReferenceArray, long j2, int i2, T t, long j3) {
        ...
        this.f14344f = atomicReferenceArray2;
        this.f14342d = (j3 + j2) - 1;
    ...
    public boolean m(T t, T t2) {
        AtomicReferenceArray<Object> atomicReferenceArray = this.f14344f;
        long j2 = j();
        int i2 = this.f14343e;
        long j3 = 2 + j2;
