...
public final class q1<TLeft, TRight, TLeftEnd, TRightEnd, R> extends a<TLeft, R> {
    ...
    final q<? extends TRight> f13977c;

    /* renamed from: d  reason: collision with root package name */
    final n<? super TLeft, ? extends q<TLeftEnd>> f13978d;

    /* renamed from: e  reason: collision with root package name */
    final n<? super TRight, ? extends q<TRightEnd>> f13979e;

    /* renamed from: f  reason: collision with root package name */
    final c<? super TLeft, ? super TRight, ? extends R> f13980f;
    ...
    static final class a<TLeft, TRight, TLeftEnd, TRightEnd, R> extends AtomicInteger implements b, j1.b {
        ...
        final s<? super R> f13981b;

        /* renamed from: c  reason: collision with root package name */
        final d.a.a0.f.c<Object> f13982c = new d.a.a0.f.c<>(l.bufferSize());

        /* renamed from: d  reason: collision with root package name */
        final d.a.y.a f13983d = new d.a.y.a();

        /* renamed from: e  reason: collision with root package name */
        final Map<Integer, TLeft> f13984e = new LinkedHashMap();

        /* renamed from: f  reason: collision with root package name */
        final Map<Integer, TRight> f13985f = new LinkedHashMap();
        ...
        public void g() {
            if (getAndIncrement() == 0) {
                d.a.a0.f.c<Object> cVar = this.f13982c;
                s<? super R> sVar = this.f13981b;
                int i2 = 1;
                while (!this.n) {
                    if (this.g.get() != null) {
                        cVar.clear();
                    ...
                    if (z && z2) {
                        ...
                        if (num == o) {
                            ...
                            try {
                                ...
                                for (TRight a2 : this.f13985f.values()) {
                                    try {
                            ...
                            try {
                                ...
                                for (TLeft a4 : this.f13984e.values()) {
                                    try {
                            ...
                            this.f13984e.remove(Integer.valueOf(cVar4.f13692d));
                            this.f13983d.a(cVar4);
                        } else {
                            j1.c cVar5 = (j1.c) poll;
                            this.f13985f.remove(Integer.valueOf(cVar5.f13692d));
                            this.f13983d.a(cVar5);
                        }
                    }
                }
                cVar.clear();
    ...
    public void subscribeActual(s<? super R> sVar) {
        a aVar = new a(sVar, this.f13978d, this.f13979e, this.f13980f);
        sVar.onSubscribe(aVar);
        j1.d dVar = new j1.d(aVar, true);
        aVar.f13983d.b(dVar);
        j1.d dVar2 = new j1.d(aVar, false);
        aVar.f13983d.b(dVar2);
        this.f13338b.subscribe(dVar);
        this.f13977c.subscribe(dVar2);
    }
}
