...
public enum m {
    ...
    static final class a implements Serializable {
        ...
        public String toString() {
            return "NotificationLite.Disposable[" + this.f14481b + "]";
        }
    }
    ...
    static final class b implements Serializable {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof b) {
                return d.a.a0.b.b.c(this.f14482b, ((b) obj).f14482b);
            }
            return false;
        }
        ...
        public String toString() {
            return "NotificationLite.Error[" + this.f14482b + "]";
        }
    }
    ...
    public static <T> boolean g(Object obj, s<? super T> sVar) {
        if (obj == COMPLETE) {
            ...
            sVar.onSubscribe(((a) obj).f14481b);
            return false;
        } else {
            sVar.onNext(obj);
            return false;
