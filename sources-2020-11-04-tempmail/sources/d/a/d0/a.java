...
public final class a {
    ...
    static volatile f<? super Throwable> f14507a;

    /* renamed from: b  reason: collision with root package name */
    static volatile n<? super Runnable, ? extends Runnable> f14508b;

    /* renamed from: c  reason: collision with root package name */
    static volatile n<? super Callable<t>, ? extends t> f14509c;

    /* renamed from: d  reason: collision with root package name */
    static volatile n<? super Callable<t>, ? extends t> f14510d;

    /* renamed from: e  reason: collision with root package name */
    static volatile n<? super Callable<t>, ? extends t> f14511e;

    /* renamed from: f  reason: collision with root package name */
    static volatile n<? super Callable<t>, ? extends t> f14512f;
    ...
    public static t e(Callable<t> callable) {
        ...
        n<? super Callable<t>, ? extends t> nVar = f14509c;
        if (nVar == null) {
            return d(callable);
        }
    ...
    public static t f(Callable<t> callable) {
        d.a.a0.b.b.e(callable, "Scheduler Callable can't be null");
        n<? super Callable<t>, ? extends t> nVar = f14511e;
        if (nVar == null) {
            return d(callable);
        }
        return c(nVar, callable);
    ...
    public static t g(Callable<t> callable) {
        d.a.a0.b.b.e(callable, "Scheduler Callable can't be null");
        n<? super Callable<t>, ? extends t> nVar = f14512f;
        if (nVar == null) {
            return d(callable);
        }
        return c(nVar, callable);
    ...
    public static t h(Callable<t> callable) {
        d.a.a0.b.b.e(callable, "Scheduler Callable can't be null");
        n<? super Callable<t>, ? extends t> nVar = f14510d;
        if (nVar == null) {
            return d(callable);
        }
        return c(nVar, callable);
    ...
    public static void s(Throwable th) {
        f<? super Throwable> fVar = f14507a;
        if (th == null) {
    ...
    public static Runnable u(Runnable runnable) {
        ...
        n<? super Runnable, ? extends Runnable> nVar = f14508b;
        if (nVar == null) {
            return runnable;
        }
