...
public class e<K, V> {
    ...
    private final LinkedHashMap<K, V> f119a;
    ...
    public e(int i) {
        if (i > 0) {
            this.f121c = i;
            this.f119a = new LinkedHashMap<>(0, 0.75f, true);
            return;
        }
    ...
    public final V d(K r5) {
        /*
            ...
            monitor-enter(r4)
            java.util.LinkedHashMap<K, V> r0 = r4.f119a     // Catch:{ all -> 0x0051 }
        ...
        L_0x0022:
            monitor-enter(r4)
            int r1 = r4.f123e     // Catch:{ all -> 0x004e }
            int r1 = r1 + 1
            r4.f123e = r1     // Catch:{ all -> 0x004e }
            java.util.LinkedHashMap<K, V> r1 = r4.f119a     // Catch:{ all -> 0x004e }
            java.lang.Object r1 = r1.put(r5, r0)     // Catch:{ all -> 0x004e }
            if (r1 == 0) goto L_0x0037
            java.util.LinkedHashMap<K, V> r2 = r4.f119a     // Catch:{ all -> 0x004e }
            r2.put(r5, r1)     // Catch:{ all -> 0x004e }
            goto L_0x0040
        L_0x0037:
            int r2 = r4.f120b     // Catch:{ all -> 0x004e }
            int r3 = r4.g(r5, r0)     // Catch:{ all -> 0x004e }
            int r2 = r2 + r3
            r4.f120b = r2     // Catch:{ all -> 0x004e }
        L_0x0040:
    ...
    public void i(int r5) {
        ...
        L_0x0000:
            monitor-enter(r4)
            int r0 = r4.f120b     // Catch:{ all -> 0x0071 }
            if (r0 < 0) goto L_0x0052
            java.util.LinkedHashMap<K, V> r0 = r4.f119a     // Catch:{ all -> 0x0071 }
        ...
        L_0x001e:
            ...
            java.util.LinkedHashMap<K, V> r2 = r4.f119a     // Catch:{ all -> 0x0071 }
            r2.remove(r1)     // Catch:{ all -> 0x0071 }
            int r2 = r4.f120b     // Catch:{ all -> 0x0071 }
            int r3 = r4.g(r1, r0)     // Catch:{ all -> 0x0071 }
            int r2 = r2 - r3
            r4.f120b = r2     // Catch:{ all -> 0x0071 }
            int r2 = r4.f124f     // Catch:{ all -> 0x0071 }
            r3 = 1
            int r2 = r2 + r3
            r4.f124f = r2     // Catch:{ all -> 0x0071 }
    ...
    public final synchronized String toString() {
        int i;
        i = this.g + this.h;
        return String.format(Locale.US, "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", new Object[]{Integer.valueOf(this.f121c), Integer.valueOf(this.g), Integer.valueOf(this.h), Integer.valueOf(i != 0 ? (this.g * 100) / i : 0)});
    }
}
