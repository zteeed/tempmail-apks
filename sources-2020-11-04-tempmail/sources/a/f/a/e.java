...
public class e {
    ...
    private HashMap<String, i> f165b;
        ...
        while (!z2) {
            ...
            if (b2 != null) {
                ...
                for (int i6 = 0; i6 < this.j; i6++) {
                    b bVar = this.f169f[i6];
                    if (bVar.f156a.g != i.a.UNRESTRICTED && !bVar.f160e && bVar.s(b2)) {
                        float f3 = bVar.f159d.f(b2);
                        if (f3 < 0.0f) {
                            float f4 = (-bVar.f157b) / f3;
                            if (f4 < f2) {
                                i5 = i6;
                                f2 = f4;
                            }
    ...
    private final void F(b bVar) {
        if (this.j > 0) {
            bVar.f159d.o(bVar, this.f169f);
            if (bVar.f159d.f150a == 0) {
                bVar.f160e = true;
            }
        }
    }
    ...
    private final void m(b bVar) {
        ...
        int i2 = this.j;
        if (bVarArr[i2] != null) {
            this.l.f161a.a(bVarArr[i2]);
        }
        b[] bVarArr2 = this.f169f;
        int i3 = this.j;
        bVarArr2[i3] = bVar;
        i iVar = bVar.f156a;
        iVar.f180c = i3;
    ...
    private void o() {
        for (int i2 = 0; i2 < this.j; i2++) {
            b bVar = this.f169f[i2];
            bVar.f156a.f182e = bVar.f157b;
        }
    }
    ...
    private int v(a aVar) throws Exception {
        ...
        while (true) {
            ...
            b[] bVarArr = this.f169f;
            if (bVarArr[i2].f156a.g != i.a.UNRESTRICTED && bVarArr[i2].f157b < 0.0f) {
                z = true;
                break;
            }
            i2++;
        ...
        while (!z2) {
            ...
            int i7 = 0;
            while (i4 < this.j) {
                b bVar = this.f169f[i4];
                if (bVar.f156a.g != i.a.UNRESTRICTED && !bVar.f160e && bVar.f157b < f2) {
                    int i8 = 1;
                    while (i8 < this.i) {
                        i iVar = this.l.f163c[i8];
                        float f4 = bVar.f159d.f(iVar);
                        if (f4 > f2) {
                            for (int i9 = 0; i9 < 7; i9++) {
                                float f5 = iVar.f183f[i9] / f4;
    ...
    private void z() {
        int i2 = this.f167d * 2;
        this.f167d = i2;
        this.f169f = (b[]) Arrays.copyOf(this.f169f, i2);
        c cVar = this.l;
        cVar.f163c = (i[]) Arrays.copyOf(cVar.f163c, this.f167d);
        int i3 = this.f167d;
    ...
    public void E() {
        ...
        cVar.f162b.c(this.m, this.n);
        this.n = 0;
        Arrays.fill(this.l.f163c, (Object) null);
        HashMap<String, i> hashMap = this.f165b;
        if (hashMap != null) {
            hashMap.clear();
        }
        this.f164a = 0;
    ...
    public void d(b bVar) {
        ...
        if (bVar != null) {
            ...
            boolean z = true;
            if (this.j + 1 >= this.k || this.i + 1 >= this.f168e) {
                z();
            }
            boolean z2 = false;
            if (!bVar.f160e) {
                ...
                if (!bVar.t()) {
                    ...
                    if (bVar.f(this)) {
                        ...
                        C(this.o, true);
                        if (q2.f180c == -1) {
                            if (bVar.f156a == q2 && (u = bVar.u(q2)) != null) {
                                f fVar2 = q;
                                if (fVar2 != null) {
                                    fVar2.j++;
                                }
    ...
    public void f(i iVar, int i2) {
        int i3 = iVar.f180c;
        if (i3 != -1) {
            b bVar = this.f169f[i3];
            if (bVar.f160e) {
                bVar.f157b = (float) i2;
            } else if (bVar.f159d.f150a == 0) {
                bVar.f160e = true;
                bVar.f157b = (float) i2;
            } else {
                b s = s();
    ...
    public i r(Object obj) {
        ...
        if (obj instanceof a.f.a.j.e) {
            ...
            int i2 = iVar.f179b;
            if (i2 == -1 || i2 > this.f164a || this.l.f163c[i2] == null) {
                if (iVar.f179b != -1) {
                    iVar.d();
                }
                int i3 = this.f164a + 1;
