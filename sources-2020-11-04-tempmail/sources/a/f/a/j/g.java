...
public class g extends p {
    ...
    public void K0() {
        ...
        L_0x00eb:
            ...
            java.lang.Object r7 = r7.get(r15)
            a.f.a.j.h r7 = (a.f.a.j.h) r7
            java.util.List<a.f.a.j.f> r7 = r7.f227a
            java.util.ArrayList r7 = (java.util.ArrayList) r7
            r1.k0 = r7
        L_0x00f9:
            r21.b1()
    ...
    public void Y0(int i, int i2) {
        m mVar;
        m mVar2;
        if (!(this.C[0] == f.b.WRAP_CONTENT || (mVar2 = this.f216c) == null)) {
            mVar2.h(i);
        }
        if (this.C[1] != f.b.WRAP_CONTENT && (mVar = this.f217d) != null) {
            mVar.h(i2);
        }
    }
