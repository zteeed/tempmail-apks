...
public class k {
    ...
    static boolean[] f234a = new boolean[3];
    ...
    static void a(int i, f fVar) {
        ...
        if (!(f2.h == 4 || f4.h == 4)) {
            if (fVar2.C[0] == f.b.FIXED || (z2 && fVar.C() == 8)) {
                if (fVar2.s.f198d == null && fVar2.u.f198d == null) {
                    f2.p(1);
                    f4.p(1);
                    if (z) {
                        f4.j(f2, 1, fVar.x());
                ...
                } else if (fVar2.s.f198d != null && fVar2.u.f198d == null) {
                    f2.p(1);
                    f4.p(1);
                    if (z) {
                        f4.j(f2, 1, fVar.x());
        ...
        if (f3.h != 4 && f5.h != 4) {
            if (fVar2.C[1] == f.b.FIXED || (z3 && fVar.C() == 8)) {
                if (fVar2.t.f198d == null && fVar2.v.f198d == null) {
                    f3.p(1);
                    f5.p(1);
                    if (z) {
                        f5.j(f3, 1, fVar.w());
                ...
                } else if (fVar2.t.f198d != null && fVar2.v.f198d == null) {
                    f3.p(1);
                    f5.p(1);
                    if (z) {
                        f5.j(f3, 1, fVar.w());
    ...
    static boolean b(a.f.a.j.g r24, a.f.a.e r25, int r26, int r27, a.f.a.j.d r28) {
        /*
            ...
            r1 = r26
            r2 = r28
            a.f.a.j.f r3 = r2.f189a
            a.f.a.j.f r4 = r2.f191c
            a.f.a.j.f r5 = r2.f190b
            a.f.a.j.f r6 = r2.f192d
            a.f.a.j.f r7 = r2.f193e
            float r8 = r2.k
            a.f.a.j.f r9 = r2.f194f
            a.f.a.j.f r2 = r2.g
            r9 = r24
            a.f.a.j.f$b[] r2 = r9.C
            r2 = r2[r1]
        ...
        L_0x00df:
            ...
            int r9 = r27 + 1
            r7 = r7[r9]
            a.f.a.j.e r7 = r7.f198d
            if (r7 == 0) goto L_0x0101
            a.f.a.j.f r7 = r7.f196b
            a.f.a.j.e[] r9 = r7.A
            r20 = r7
            r7 = r9[r27]
            a.f.a.j.e r7 = r7.f198d
        ...
        L_0x010a:
            ...
            r13 = r13[r19]
            a.f.a.j.l r13 = r13.f()
            a.f.a.j.l r7 = r9.f236d
            if (r7 == 0) goto L_0x0385
            r21 = r3
            a.f.a.j.l r3 = r13.f236d
        ...
        L_0x014f:
            ...
            float r0 = r0 + r3
        L_0x015b:
            a.f.a.j.l r3 = r9.f236d
            float r3 = r3.g
            a.f.a.j.l r6 = r13.f236d
            float r6 = r6.g
    ...
    static void e(f fVar, int i, int i2) {
        int i3 = i * 2;
        int i4 = i3 + 1;
        fVar.A[i3].f().f238f = fVar.u().s.f();
        fVar.A[i3].f().g = (float) i2;
        fVar.A[i3].f().f241b = 1;
        fVar.A[i4].f().f238f = fVar.A[i3].f();
