...
public class f {
    ...
    private boolean K(int i2) {
        int i3 = i2 * 2;
        e[] eVarArr = this.A;
        if (!(eVarArr[i3].f198d == null || eVarArr[i3].f198d.f198d == eVarArr[i3])) {
            int i4 = i3 + 1;
            return eVarArr[i4].f198d != null && eVarArr[i4].f198d.f198d == eVarArr[i4];
        }
    }
    ...
    private void e(a.f.a.e r24, boolean r25, a.f.a.i r26, a.f.a.i r27, a.f.a.j.f.b r28, boolean r29, a.f.a.j.e r30, a.f.a.j.e r31, int r32, int r33, int r34, int r35, float r36, boolean r37, boolean r38, int r39, int r40, int r41, float r42, boolean r43) {
        ...
        L_0x0290:
            ...
            r1 = r30
            a.f.a.j.e r2 = r1.f198d
            a.f.a.j.f r2 = r2.f196b
            boolean r2 = r2 instanceof a.f.a.j.b
            r3 = r31
            a.f.a.j.e r4 = r3.f198d
            a.f.a.j.f r4 = r4.f196b
    ...
    public boolean L() {
        if (this.s.f().f241b == 1 && this.u.f().f241b == 1 && this.t.f().f241b == 1 && this.v.f().f241b == 1) {
            return true;
        }
        return false;
    }
    ...
    public boolean M() {
        ...
        e eVar3 = this.u;
        e eVar4 = eVar3.f198d;
        return eVar4 != null && eVar4.f198d == eVar3;
    }
    ...
    public boolean O() {
        return this.f219f == 0 && this.G == 0.0f && this.k == 0 && this.l == 0 && this.C[1] == b.MATCH_CONSTRAINT;
    }

    public boolean P() {
        return this.f218e == 0 && this.G == 0.0f && this.h == 0 && this.i == 0 && this.C[0] == b.MATCH_CONSTRAINT;
    }
