...
public class b {
    ...
    public static boolean b(C0006b[] bVarArr, C0006b[] bVarArr2) {
        ...
        for (int i = 0; i < bVarArr.length; i++) {
            if (bVarArr[i].f254a != bVarArr2[i].f254a || bVarArr[i].f255b.length != bVarArr2[i].f255b.length) {
                return false;
            }
        }
        return true;
    ...
    public static void j(C0006b[] bVarArr, C0006b[] bVarArr2) {
        for (int i = 0; i < bVarArr2.length; i++) {
            bVarArr[i].f254a = bVarArr2[i].f254a;
            for (int i2 = 0; i2 < bVarArr2[i].f255b.length; i2++) {
                bVarArr[i].f255b[i2] = bVarArr2[i].f255b[i2];
            }
        }
    }
    ...
    public static class C0006b {
        ...
        public static void e(C0006b[] bVarArr, Path path) {
            ...
            char c2 = 'm';
            for (int i = 0; i < bVarArr.length; i++) {
                a(path, fArr, c2, bVarArr[i].f254a, bVarArr[i].f255b);
                c2 = bVarArr[i].f254a;
            }
        }
        ...
        public void d(C0006b bVar, C0006b bVar2, float f2) {
            ...
            int i = 0;
            while (true) {
                float[] fArr = bVar.f255b;
                if (i < fArr.length) {
                    this.f255b[i] = (fArr[i] * (1.0f - f2)) + (bVar2.f255b[i] * f2);
                    i++;
                } else {
                    return;
                }
        ...
        C0006b(C0006b bVar) {
            this.f254a = bVar.f254a;
            float[] fArr = bVar.f255b;
            this.f255b = b.c(fArr, 0, fArr.length);
        }
    }
}
