...
public class u {
    ...
    private static Field f412a;

    /* renamed from: b  reason: collision with root package name */
    private static boolean f413b;

    /* renamed from: c  reason: collision with root package name */
    private static Field f414c;

    /* renamed from: d  reason: collision with root package name */
    private static boolean f415d;

    /* renamed from: e  reason: collision with root package name */
    private static WeakHashMap<View, String> f416e;

    /* renamed from: f  reason: collision with root package name */
    private static WeakHashMap<View, y> f417f = null;
    ...
    static class a implements View.OnApplyWindowInsetsListener {
        ...
        public WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
            return (WindowInsets) c0.i(this.f418a.a(view, c0.j(windowInsets)));
        }
    }
    ...
    static class e implements ViewTreeObserver.OnGlobalLayoutListener, View.OnAttachStateChangeListener {
        ...
        /* renamed from: b  reason: collision with root package name */
        private WeakHashMap<View, Boolean> f419b = new WeakHashMap<>();
        ...
        private void a(View view, boolean z) {
            ...
            if (z != z2) {
                ...
                this.f419b.put(view, Boolean.valueOf(z2));
            }
        }
        ...
        public void onGlobalLayout() {
            for (Map.Entry next : this.f419b.entrySet()) {
    ...
    static abstract class f<T> {
        ...
        private boolean b() {
            return Build.VERSION.SDK_INT >= this.f422c;
        }
        ...
        public T d(View view) {
            ...
            T tag = view.getTag(this.f420a);
            if (this.f421b.isInstance(tag)) {
                return tag;
            }
            return null;
        }
    ...
    static class h {
        ...
        /* renamed from: d  reason: collision with root package name */
        private static final ArrayList<WeakReference<View>> f423d = new ArrayList<>();

        /* renamed from: a  reason: collision with root package name */
        private WeakHashMap<View, Boolean> f424a = null;

        /* renamed from: b  reason: collision with root package name */
        private SparseArray<WeakReference<View>> f425b = null;

        /* renamed from: c  reason: collision with root package name */
        private WeakReference<KeyEvent> f426c = null;
        ...
        private View c(View view, KeyEvent keyEvent) {
            WeakHashMap<View, Boolean> weakHashMap = this.f424a;
        ...
        private void g() {
            ...
            if (!f423d.isEmpty()) {
                synchronized (f423d) {
                    ...
                    for (int size = f423d.size() - 1; size >= 0; size--) {
                        View view = (View) f423d.get(size).get();
                        if (view == null) {
                            f423d.remove(size);
                        } else {
                            this.f424a.put(view, Boolean.TRUE);
                            for (ViewParent parent = view.getParent(); parent instanceof View; parent = parent.getParent()) {
                                this.f424a.put((View) parent, Boolean.TRUE);
                            }
                        }
                    }
                }
        ...
        public boolean f(KeyEvent keyEvent) {
            int indexOfKey;
            WeakReference<KeyEvent> weakReference = this.f426c;
            if (weakReference != null && weakReference.get() == keyEvent) {
                return false;
            }
            this.f426c = new WeakReference<>(keyEvent);
    ...
    public static void Q(View view, a.h.k.d0.d dVar) {
        view.onInitializeAccessibilityNodeInfo(dVar.A0());
    }
    ...
    public static y b(View view) {
        if (f417f == null) {
            f417f = new WeakHashMap<>();
        }
        y yVar = f417f.get(view);
        if (yVar != null) {
            return yVar;
        }
        y yVar2 = new y(view);
        f417f.put(view, yVar2);
        return yVar2;
    }
    ...
    public static void n0(View view, s sVar) {
    ...
    public static String z(View view) {
        ...
        WeakHashMap<View, String> weakHashMap = f416e;
        if (weakHashMap == null) {
            return null;
        }
