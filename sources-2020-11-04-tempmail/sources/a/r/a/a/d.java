...
public class d {
    ...
    /* compiled from: AnimatorInflaterCompat */
    private static class a implements TypeEvaluator<b.C0006b[]> {

        /* renamed from: a  reason: collision with root package name */
        private b.C0006b[] f620a;

        a() {
        }

        /* renamed from: a */
        public b.C0006b[] evaluate(float f2, b.C0006b[] bVarArr, b.C0006b[] bVarArr2) {
            if (b.b(bVarArr, bVarArr2)) {
                if (!b.b(this.f620a, bVarArr)) {
                    this.f620a = b.f(bVarArr);
                }
                for (int i = 0; i < bVarArr.length; i++) {
                    this.f620a[i].d(bVarArr[i], bVarArr2[i], f2);
                }
                return this.f620a;
            }
    ...
    private static android.animation.Animator b(android.content.Context r18, android.content.res.Resources r19, android.content.res.Resources.Theme r20, org.xmlpull.v1.XmlPullParser r21, android.util.AttributeSet r22, android.animation.AnimatorSet r23, int r24, float r25) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L_0x0106:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: a.r.a.a.d.b(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet, android.animation.AnimatorSet, int, float):android.animation.Animator");
    }
    ...
    private static android.animation.PropertyValuesHolder e(android.content.res.TypedArray r11, int r12, int r13, int r14, java.lang.String r15) {
        ...
        L_0x003c:
            ...
            a.h.e.b$b[] r13 = a.h.e.b.d(r12)
            a.h.e.b$b[] r14 = a.h.e.b.d(r11)
            if (r13 != 0) goto L_0x0054
            if (r14 == 0) goto L_0x0167
        L_0x0054:
            if (r13 == 0) goto L_0x0098
            a.r.a.a.d$a r0 = new a.r.a.a.d$a
            r0.<init>()
            if (r14 == 0) goto L_0x008d
            boolean r3 = a.h.e.b.b(r13, r14)
        ...
        L_0x0098:
            if (r14 == 0) goto L_0x0167
            a.r.a.a.d$a r11 = new a.r.a.a.d$a
            r11.<init>()
        ...
        L_0x0167:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: a.r.a.a.d.e(android.content.res.TypedArray, int, int, int, java.lang.String):android.animation.PropertyValuesHolder");
    }
    ...
    private static int g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray k = g.k(resources, theme, attributeSet, a.j);
        int i = 0;
        TypedValue l = g.l(k, xmlPullParser, "value", 0);
        if ((l != null) && h(l.type)) {
            i = 3;
        }
        k.recycle();
    ...
    public static Animator k(Context context, Resources resources, Resources.Theme theme, int i, float f2) throws Resources.NotFoundException {
    ...
    private static ValueAnimator l(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f2, XmlPullParser xmlPullParser) throws Resources.NotFoundException {
        TypedArray k = g.k(resources, theme, attributeSet, a.g);
        TypedArray k2 = g.k(resources, theme, attributeSet, a.k);
        if (valueAnimator == null) {
            valueAnimator = new ValueAnimator();
        }
        q(valueAnimator, k, k2, f2, xmlPullParser);
        int h = g.h(k, xmlPullParser, "interpolator", 0, 0);
        if (h > 0) {
    ...
    private static Keyframe m(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        Keyframe keyframe;
        TypedArray k = g.k(resources, theme, attributeSet, a.j);
        float f2 = g.f(k, xmlPullParser, "fraction", 3, -1.0f);
        TypedValue l = g.l(k, xmlPullParser, "value", 0);
        boolean z = l != null;
        if (i == 4) {
            i = (!z || !h(l.type)) ? 0 : 3;
        ...
        if (z) {
            if (i == 0) {
                keyframe = Keyframe.ofFloat(f2, g.f(k, xmlPullParser, "value", 0, 0.0f));
            } else if (i == 1 || i == 3) {
                keyframe = Keyframe.ofInt(f2, g.g(k, xmlPullParser, "value", 0, 0));
            } else {
                keyframe = null;
            }
        } else if (i == 0) {
        ...
        int h = g.h(k, xmlPullParser, "interpolator", 1, 0);
        if (h > 0) {
            keyframe.setInterpolator(c.b(context, h));
        }
        k.recycle();
        return keyframe;
    }
    ...
    private static android.animation.PropertyValuesHolder o(android.content.Context r9, android.content.res.Resources r10, android.content.res.Resources.Theme r11, org.xmlpull.v1.XmlPullParser r12, java.lang.String r13, int r14) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L_0x00dc:
            ...
            a.r.a.a.e r9 = a.r.a.a.e.a()
            r0.setEvaluator(r9)
        L_0x00e9:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: a.r.a.a.d.o(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, java.lang.String, int):android.animation.PropertyValuesHolder");
    }
    ...
    private static android.animation.PropertyValuesHolder[] p(android.content.Context r17, android.content.res.Resources r18, android.content.res.Resources.Theme r19, org.xmlpull.v1.XmlPullParser r20, android.util.AttributeSet r21) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L_0x0082:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: a.r.a.a.d.p(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet):android.animation.PropertyValuesHolder[]");
    }
    ...
    private static void q(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f2, XmlPullParser xmlPullParser) {
        long g = (long) g.g(typedArray, xmlPullParser, "duration", 1, 300);
        long g2 = (long) g.g(typedArray, xmlPullParser, "startOffset", 2, 0);
        int g3 = g.g(typedArray, xmlPullParser, "valueType", 7, 4);
    ...
    private static void r(ValueAnimator valueAnimator, TypedArray typedArray, int i, float f2, XmlPullParser xmlPullParser) {
        ...
        String i2 = g.i(typedArray, xmlPullParser, "pathData", 1);
        if (i2 != null) {
            String i3 = g.i(typedArray, xmlPullParser, "propertyXName", 2);
            String i4 = g.i(typedArray, xmlPullParser, "propertyYName", 3);
            if (i != 2) {
            }
            if (i3 == null && i4 == null) {
                throw new InflateException(typedArray.getPositionDescription() + " propertyXName or propertyYName is needed for PathData");
            }
            s(b.e(i2), objectAnimator, f2 * 0.5f, i3, i4);
            return;
        }
