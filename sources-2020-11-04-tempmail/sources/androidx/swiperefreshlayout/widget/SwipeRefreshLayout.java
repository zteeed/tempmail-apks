...
public class SwipeRefreshLayout extends ViewGroup implements o, k {
    ...
    class a implements Animation.AnimationListener {
        ...
        public void onAnimationEnd(Animation animation) {
            ...
            if (swipeRefreshLayout.f1978d) {
                swipeRefreshLayout.C.setAlpha(255);
                SwipeRefreshLayout.this.C.start();
                SwipeRefreshLayout swipeRefreshLayout2 = SwipeRefreshLayout.this;
                if (swipeRefreshLayout2.I && (jVar = swipeRefreshLayout2.f1977c) != null) {
                    jVar.a();
                }
    ...
    class d extends Animation {
        ...
        public void applyTransformation(float f2, Transformation transformation) {
            ...
            int i = this.f1984b;
            bVar.setAlpha((int) (((float) i) + (((float) (this.f1985c - i)) * f2)));
        }
    }
    ...
    private void p(float f2) {
        this.C.d(true);
        float min = Math.min(1.0f, Math.abs(f2 / this.f1980f));
        float max = (((float) Math.max(((double) min) - 0.4d, 0.0d)) * 5.0f) / 3.0f;
        float abs = Math.abs(f2) - this.f1980f;
        int i2 = this.B;
        if (i2 <= 0) {
        ...
        if (this.s) {
            setAnimationProgress(Math.min(1.0f, f2 / this.f1980f));
        }
        if (f2 < this.f1980f) {
    ...
    public boolean d() {
        i iVar = this.L;
        if (iVar != null) {
            return iVar.a(this, this.f1976b);
        }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (!isEnabled() || this.t || d() || this.f1978d || this.l) {
            return false;
        }
        if (actionMasked != 0) {
            if (actionMasked != 1) {
    ...
    public boolean onStartNestedScroll(View view, View view2, int i2) {
        return isEnabled() && !this.t && !this.f1978d && (i2 & 2) != 0;
    }
    ...
    public void requestDisallowInterceptTouchEvent(boolean z2) {
        if (Build.VERSION.SDK_INT >= 21 || !(this.f1976b instanceof AbsListView)) {
            View view = this.f1976b;
            if (view == null || u.J(view)) {
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        this.N = new f();
        this.O = new g();
        this.f1979e = ViewConfiguration.get(context).getScaledTouchSlop();
