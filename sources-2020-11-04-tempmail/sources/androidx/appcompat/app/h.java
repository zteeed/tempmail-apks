...
class h extends g implements h.a, LayoutInflater.Factory2 {
    ...
    final Window.Callback f749e;

    /* renamed from: f  reason: collision with root package name */
    final Window.Callback f750f;
    final f g;
    a h;
    MenuInflater i;
    ...
    static class a implements Thread.UncaughtExceptionHandler {
        ...
        final /* synthetic */ Thread.UncaughtExceptionHandler f751a;

        a(Thread.UncaughtExceptionHandler uncaughtExceptionHandler) {
            this.f751a = uncaughtExceptionHandler;
        }
        ...
        public void uncaughtException(Thread thread, Throwable th) {
            if (a(th)) {
                ...
                this.f751a.uncaughtException(thread, notFoundException);
                return;
            }
            this.f751a.uncaughtException(thread, th);
        }
    }
    ...
    class c implements q {
        ...
        public c0 a(View view, c0 c0Var) {
            ...
            int y0 = h.this.y0(e2);
            if (e2 != y0) {
                c0Var = c0Var.h(c0Var.c(), y0, c0Var.d(), c0Var.b());
            }
    ...
    private class C0033h implements b.C0032b {
        ...
        public Drawable d() {
            b0 t = b0.t(b(), (AttributeSet) null, new int[]{a.a.a.homeAsUpIndicator});
            Drawable g = t.g(0);
            t.v();
            return g;
        }
    ...
    class j implements b.a {
        ...
        public void a(a.a.n.b bVar) {
            ...
            h hVar = h.this;
            if (hVar.p != null) {
                hVar.f748d.getDecorView().removeCallbacks(h.this.q);
            }
            h hVar2 = h.this;
            if (hVar2.o != null) {
                hVar2.M();
        ...
        public boolean b(a.a.n.b bVar, Menu menu) {
            return this.f761a.b(bVar, menu);
        }

        public boolean c(a.a.n.b bVar, Menu menu) {
            return this.f761a.c(bVar, menu);
        }

        public boolean d(a.a.n.b bVar, MenuItem menuItem) {
            return this.f761a.d(bVar, menuItem);
        }
    }
    ...
    final class l {
        ...
        /* renamed from: c  reason: collision with root package name */
        private BroadcastReceiver f767c;

        /* renamed from: d  reason: collision with root package name */
        private IntentFilter f768d;
        ...
        public void a() {
            BroadcastReceiver broadcastReceiver = this.f767c;
            if (broadcastReceiver != null) {
                h.this.f747c.unregisterReceiver(broadcastReceiver);
                this.f767c = null;
            }
        }
        ...
        public void d() {
            ...
            if (this.f768d == null) {
                ...
                this.f768d = intentFilter;
                intentFilter.addAction("android.intent.action.TIME_SET");
                this.f768d.addAction("android.intent.action.TIMEZONE_CHANGED");
                this.f768d.addAction("android.intent.action.TIME_TICK");
            }
            h.this.f747c.registerReceiver(this.f767c, this.f768d);
        }
    }
    ...
    protected static final class n {
        ...
        public void d(Context context) {
            ...
            this.f772b = obtainStyledAttributes.getResourceId(a.a.j.AppCompatTheme_panelBackground, 0);
            this.f776f = obtainStyledAttributes.getResourceId(a.a.j.AppCompatTheme_android_windowAnimationStyle, 0);
    ...
    h(Context context, Window window, f fVar) {
        ...
        if (!(callback instanceof k)) {
            ...
            this.f750f = kVar;
            this.f748d.setCallback(kVar);
            b0 t2 = b0.t(context, (AttributeSet) null, U);
            Drawable h2 = t2.h(0);
            if (h2 != null) {
                this.f748d.setBackgroundDrawable(h2);
            }
            t2.v();
            return;
        }
    ...
    private void C() {
        ...
        View decorView = this.f748d.getDecorView();
        contentFrameLayout.setDecorPadding(decorView.getPaddingLeft(), decorView.getPaddingTop(), decorView.getPaddingRight(), decorView.getPaddingBottom());
        TypedArray obtainStyledAttributes = this.f747c.obtainStyledAttributes(a.a.j.AppCompatTheme);
    ...
    private ViewGroup H() {
        ...
        if (obtainStyledAttributes.hasValue(a.a.j.AppCompatTheme_windowActionBar)) {
            ...
            obtainStyledAttributes.recycle();
            this.f748d.getDecorView();
            LayoutInflater from = LayoutInflater.from(this.f747c);
            if (this.D) {
                if (this.B) {
                ...
                TypedValue typedValue = new TypedValue();
                this.f747c.getTheme().resolveAttribute(a.a.a.actionBarTheme, typedValue, true);
                if (typedValue.resourceId != 0) {
                    context = new a.a.n.d(this.f747c, typedValue.resourceId);
                } else {
                    context = this.f747c;
                }
            ...
            if (viewGroup != null) {
                ...
                ViewGroup viewGroup2 = (ViewGroup) this.f748d.findViewById(16908290);
                if (viewGroup2 != null) {
                ...
                this.f748d.setContentView(viewGroup);
    ...
    private void V() {
        ...
        if (this.z && this.h == null) {
            Window.Callback callback = this.f749e;
            if (callback instanceof Activity) {
                this.h = new n((Activity) this.f749e, this.A);
            } else if (callback instanceof Dialog) {
                this.h = new n((Dialog) this.f749e);
            }
            a aVar = this.h;
            if (aVar != null) {
                aVar.s(this.P);
    ...
    private void Z(int i2) {
        this.N = (1 << i2) | this.N;
        if (!this.M) {
            u.V(this.f748d.getDecorView(), this.O);
            this.M = true;
        }
    }
    ...
    private boolean h0(int r4, android.view.KeyEvent r5) {
        ...
        L_0x0006:
            ...
            boolean r4 = r4.b()
            if (r4 == 0) goto L_0x0043
            android.content.Context r4 = r3.f747c
    ...
    private void l0(n nVar, KeyEvent keyEvent) {
        ...
        if (!nVar.o && !this.I) {
            if (nVar.f771a == 0) {
                if ((this.f747c.getResources().getConfiguration().screenLayout & 15) == 4) {
                    return;
                }
            }
            Window.Callback U2 = U();
            if (U2 == null || U2.onMenuOpened(nVar.f771a, nVar.j)) {
                WindowManager windowManager = (WindowManager) this.f747c.getSystemService("window");
                if (windowManager != null && o0(nVar, keyEvent)) {
                    if (nVar.g == null || nVar.q) {
                        ...
                        if (W(nVar) && nVar.b()) {
                            ...
                            nVar.g.setBackgroundResource(nVar.f772b);
                        ...
                        if (!(view == null || (layoutParams = view.getLayoutParams()) == null || layoutParams.width != -1)) {
                            i2 = -1;
                            nVar.n = false;
                            WindowManager.LayoutParams layoutParams3 = new WindowManager.LayoutParams(i2, -2, nVar.f774d, nVar.f775e, 1002, 8519680, -3);
                            layoutParams3.gravity = nVar.f773c;
                            layoutParams3.windowAnimations = nVar.f776f;
                    ...
                    i2 = -2;
                    nVar.n = false;
                    WindowManager.LayoutParams layoutParams32 = new WindowManager.LayoutParams(i2, -2, nVar.f774d, nVar.f775e, 1002, 8519680, -3);
                    layoutParams32.gravity = nVar.f773c;
                    layoutParams32.windowAnimations = nVar.f776f;
    ...
    private boolean o0(n nVar, KeyEvent keyEvent) {
        ...
        Window.Callback U2 = U();
        if (U2 != null) {
            nVar.i = U2.onCreatePanelView(nVar.f771a);
        }
        int i2 = nVar.f771a;
        ...
        if (nVar.i == null && (!z2 || !(m0() instanceof k))) {
            if (nVar.j == null || nVar.r) {
                ...
                nVar.j.h0();
                if (!U2.onCreatePanelMenu(nVar.f771a, nVar.j)) {
    ...
    private void p0(androidx.appcompat.view.menu.h hVar, boolean z2) {
        androidx.appcompat.widget.m mVar = this.k;
        if (mVar == null || !mVar.b() || (ViewConfiguration.get(this.f747c).hasPermanentMenuKey() && !this.k.c())) {
            n S2 = S(0, true);
            S2.q = true;
            G(S2, false);
            l0(S2, (KeyEvent) null);
        ...
        if (this.k.a() && z2) {
            ...
            if (this.M && (this.N & 1) != 0) {
                this.f748d.getDecorView().removeCallbacks(this.O);
                this.O.run();
            }
            n S3 = S(0, true);
    ...
    private boolean t0() {
        if (this.K) {
            ...
            if (context instanceof Activity) {
                try {
                    if ((context.getPackageManager().getActivityInfo(new ComponentName(this.f747c, this.f747c.getClass()), 0).configChanges & AdRequest.MAX_CONTENT_URL_LENGTH) == 0) {
                        return true;
                    }
                    return false;
    ...
    public void A(Toolbar toolbar) {
        if (this.f749e instanceof Activity) {
            a k2 = k();
            if (!(k2 instanceof n)) {
                this.i = null;
                if (k2 != null) {
                ...
                if (toolbar != null) {
                    k kVar = new k(toolbar, ((Activity) this.f749e).getTitle(), this.f750f);
                    this.h = kVar;
                    this.f748d.setCallback(kVar.B());
                } else {
                    this.h = null;
                    this.f748d.setCallback(this.f750f);
                }
                m();
                return;
            }
    ...
    public void D(int i2, n nVar, Menu menu) {
        ...
        if ((nVar == null || nVar.o) && !this.I) {
            this.f749e.onPanelClosed(i2, menu);
        }
    }
    ...
    public void G(n nVar, boolean z2) {
        ViewGroup viewGroup;
        androidx.appcompat.widget.m mVar;
        if (!z2 || nVar.f771a != 0 || (mVar = this.k) == null || !mVar.a()) {
            WindowManager windowManager = (WindowManager) this.f747c.getSystemService("window");
            if (!(windowManager == null || !nVar.o || (viewGroup = nVar.g) == null)) {
                windowManager.removeView(viewGroup);
                if (z2) {
                    D(nVar.f771a, nVar, (Menu) null);
                }
            }
            nVar.m = false;
            nVar.n = false;
    ...
    public View I(View view, String str, Context context, AttributeSet attributeSet) {
        ...
        boolean z3 = false;
        if (this.S == null) {
            String string = this.f747c.obtainStyledAttributes(a.a.j.AppCompatTheme).getString(a.a.j.AppCompatTheme_viewInflaterClass);
    ...
    public void J() {
        ...
        if (this.p != null) {
            this.f748d.getDecorView().removeCallbacks(this.q);
            if (this.p.isShowing()) {
                try {
                    this.p.dismiss();
    ...
    public boolean K(KeyEvent keyEvent) {
        ...
        Window.Callback callback = this.f749e;
        boolean z2 = true;
        if (((callback instanceof e.a) || (callback instanceof i)) && (decorView = this.f748d.getDecorView()) != null && a.h.k.e.d(decorView, keyEvent)) {
            return true;
        }
        if (keyEvent.getKeyCode() == 82 && this.f749e.dispatchKeyEvent(keyEvent)) {
            return true;
        }
    ...
    public boolean a(androidx.appcompat.view.menu.h hVar, MenuItem menuItem) {
        ...
        return U2.onMenuItemSelected(P2.f771a, menuItem);
    }
    ...
    public int b0(int i2) {
        ...
        if (Build.VERSION.SDK_INT >= 23 && ((UiModeManager) this.f747c.getSystemService(UiModeManager.class)).getNightMode() == 0) {
            return -1;
        }
        N();
        return this.L.c();
    ...
    public <T extends View> T g(int i2) {
        O();
        return this.f748d.findViewById(i2);
    }
    ...
    public MenuInflater j() {
        if (this.i == null) {
            V();
            a aVar = this.h;
            this.i = new a.a.n.g(aVar != null ? aVar.j() : this.f747c);
        }
        return this.i;
    }
    ...
    public void n(Configuration configuration) {
        ...
        androidx.appcompat.widget.f.n().y(this.f747c);
        d();
    }
    ...
    public boolean v(int i2) {
        ...
        if (q0 == 1) {
            ...
            return this.f748d.requestFeature(q0);
        } else {
            w0();
            this.A = true;
            return true;
    ...
    public a.a.n.b v0(a.a.n.b.a r8) {
        ...
        L_0x0014:
            ...
            a.a.n.b r0 = r0.F(r8)     // Catch:{ AbstractMethodError -> 0x0022 }
            goto L_0x0023
        L_0x0022:
            r0 = r1
        L_0x0023:
        ...
        L_0x0029:
            ...
            r0.<init>()
            android.content.Context r4 = r7.f747c
            android.content.res.Resources$Theme r4 = r4.getTheme()
            int r5 = a.a.a.actionBarTheme
            r4.resolveAttribute(r5, r0, r3)
            int r5 = r0.resourceId
            if (r5 == 0) goto L_0x0068
            android.content.Context r5 = r7.f747c
            ...
            android.content.Context r6 = r7.f747c
        ...
        L_0x014f:
            ...
            android.view.Window r8 = r7.f748d
    ...
    public void w(int i2) {
        ...
        LayoutInflater.from(this.f747c).inflate(i2, viewGroup);
        this.f749e.onContentChanged();
    }
        ...
        if (actionBarContextView == null || !(actionBarContextView.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) {
            ...
            if (this.o.isShown()) {
                ...
                if (marginLayoutParams.topMargin != (rect2.top == 0 ? i2 : 0)) {
                    ...
                    View view = this.w;
                    if (view == null) {
                        View view2 = new View(this.f747c);
                        this.w = view2;
                        view2.setBackgroundColor(this.f747c.getResources().getColor(a.a.c.abc_input_method_navigation_guard));
    ...
    class k extends a.a.n.i {
        ...
        public final ActionMode a(ActionMode.Callback callback) {
            f.a aVar = new f.a(h.this.f747c, callback);
