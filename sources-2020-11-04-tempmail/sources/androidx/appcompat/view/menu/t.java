...
final class t extends m implements PopupWindow.OnDismissListener, AdapterView.OnItemClickListener, o, View.OnKeyListener {
    ...
    public t(Context context, h hVar, View view, int i2, int i3, boolean z) {
        ...
        this.f909d = hVar;
        this.f911f = z;
        this.f910e = new g(hVar, LayoutInflater.from(context), this.f911f, w);
        this.h = i2;
        this.i = i3;
        ...
        this.n = view;
        this.j = new MenuPopupWindow(this.f908c, (AttributeSet) null, this.h, this.i);
        hVar.c(this, context);
    }
    ...
    private boolean B() {
        ...
        this.j.v(this.u);
        if (!this.s) {
            this.t = m.g(this.f910e, (ViewGroup) null, this.f908c, this.g);
            this.s = true;
        }
        this.j.u(this.t);
        this.j.y(2);
        ...
        if (this.v && this.f909d.z() != null) {
            FrameLayout frameLayout = (FrameLayout) LayoutInflater.from(this.f908c).inflate(g.abc_popup_menu_header_item_layout, d2, false);
            TextView textView = (TextView) frameLayout.findViewById(16908310);
            if (textView != null) {
                textView.setText(this.f909d.z());
            }
    ...
    public boolean p(u uVar) {
        if (uVar.hasVisibleItems()) {
            n nVar = new n(this.f908c, uVar, this.o, this.f911f, this.h, this.i);
            nVar.j(this.p);
            nVar.g(m.z(uVar));
            nVar.i(this.m);
            this.m = null;
            ...
            int j2 = this.j.j();
            int l2 = this.j.l();
            if ((Gravity.getAbsoluteGravity(this.u, u.t(this.n)) & 7) == 5) {
                j2 += this.n.getWidth();
            }
            if (nVar.n(j2, l2)) {
                o.a aVar = this.p;
