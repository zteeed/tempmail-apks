...
public class h implements a.h.f.a.a {
    ...
    public h(Context context) {
        this.f876a = context;
        this.f877b = context.getResources();
    ...
    private void P(int i2, boolean z2) {
        if (i2 >= 0 && i2 < this.f881f.size()) {
            this.f881f.remove(i2);
            if (z2) {
                M(true);
            }
        }
    ...
    private void f0(boolean z2) {
        boolean z3 = true;
        if (!z2 || this.f877b.getConfiguration().keyboard == 1 || !v.e(ViewConfiguration.get(this.f876a), this.f876a)) {
            z3 = false;
        }
        this.f879d = z3;
    }
        ...
        if (sparseParcelableArray != null && !this.w.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                if (oVar == null) {
                    ...
                    int h2 = oVar.h();
                    if (h2 > 0 && (parcelable = (Parcelable) sparseParcelableArray.get(h2)) != null) {
                        oVar.o(parcelable);
                    }
                }
            }
        ...
        if (!this.w.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                if (oVar == null) {
                    ...
                    int h2 = oVar.h();
                    if (h2 > 0 && (q2 = oVar.q()) != null) {
                        sparseArray.put(h2, q2);
                    }
                }
            }
    ...
    public ArrayList<j> G() {
        ...
        this.g.clear();
        int size = this.f881f.size();
        for (int i2 = 0; i2 < size; i2++) {
            j jVar = this.f881f.get(i2);
            if (jVar.isVisible()) {
                this.g.add(jVar);
            }
        }
    ...
    public MenuItem a(int i2, int i3, int i4, CharSequence charSequence) {
        ...
        ArrayList<j> arrayList = this.f881f;
    ...
    public boolean hasVisibleItems() {
        ...
        int size = size();
        for (int i2 = 0; i2 < size; i2++) {
            if (this.f881f.get(i2).isVisible()) {
                return true;
            }
        }
        return false;
    ...
    public int o(int i2, int i3) {
        ...
        while (i3 < size) {
            if (this.f881f.get(i3).getGroupId() == i2) {
                return i3;
            }
            i3++;
        }
    ...
    public int q(int i2) {
        int size = size();
        for (int i3 = 0; i3 < size; i3++) {
            if (this.f881f.get(i3).getItemId() == i2) {
                return i3;
            }
        }
        return -1;
    ...
    public void removeGroup(int i2) {
        int n2 = n(i2);
        if (n2 >= 0) {
            int size = this.f881f.size() - n2;
            int i3 = 0;
            while (true) {
                int i4 = i3 + 1;
                if (i3 >= size || this.f881f.get(n2).getGroupId() != i2) {
                    M(true);
                } else {
                    P(n2, false);
                    i3 = i4;
    ...
    public MenuItem add(int i2) {
        return a(0, 0, 0, this.f877b.getString(i2));
    }

    public SubMenu addSubMenu(int i2) {
        return addSubMenu(0, 0, 0, (CharSequence) this.f877b.getString(i2));
    }
    ...
    public SubMenu addSubMenu(int i2, int i3, int i4, CharSequence charSequence) {
        ...
        u uVar = new u(this.f876a, this, jVar);
        jVar.x(uVar);
        return uVar;
    }

    public MenuItem add(int i2, int i3, int i4, int i5) {
        return a(i2, i3, i4, this.f877b.getString(i5));
    }

    public SubMenu addSubMenu(int i2, int i3, int i4, int i5) {
        return addSubMenu(i2, i3, i4, (CharSequence) this.f877b.getString(i5));
    }
}
