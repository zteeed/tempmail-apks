...
class f0 {
    ...
    private final WindowManager.LayoutParams f1137d = new WindowManager.LayoutParams();
    ...
    f0(Context context) {
        ...
        this.f1137d.setTitle(f0.class.getSimpleName());
        this.f1137d.packageName = this.f1134a.getPackageName();
        WindowManager.LayoutParams layoutParams = this.f1137d;
    ...
    private void a(View view, int i, int i2, boolean z, WindowManager.LayoutParams layoutParams) {
        ...
        int dimensionPixelOffset3 = this.f1134a.getResources().getDimensionPixelOffset(z ? d.tooltip_y_offset_touch : d.tooltip_y_offset_non_touch);
        View b2 = b(view);
        if (b2 == null) {
            Log.e("TooltipPopup", "Cannot find app view");
            return;
        }
        b2.getWindowVisibleDisplayFrame(this.f1138e);
        ...
        } else if (measuredHeight + i7 <= this.f1138e.height()) {
            layoutParams.y = i7;
        } else {
            layoutParams.y = i6;
        }
