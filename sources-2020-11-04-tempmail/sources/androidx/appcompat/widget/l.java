...
class l {
    ...
    private float f1163c = -1.0f;

    /* renamed from: d  reason: collision with root package name */
    private float f1164d = -1.0f;

    /* renamed from: e  reason: collision with root package name */
    private float f1165e = -1.0f;

    /* renamed from: f  reason: collision with root package name */
    private int[] f1166f = new int[0];
    ...
    private boolean u() {
        if (!y() || this.f1161a != 1) {
            ...
            if (!this.g || this.f1166f.length == 0) {
                float round = (float) Math.round(this.f1164d);
                int i2 = 1;
                while (Math.round(this.f1163c + round) <= Math.round(this.f1165e)) {
                    i2++;
                    round += this.f1163c;
                }
                int[] iArr = new int[i2];
                float f2 = this.f1164d;
    ...
    private boolean w() {
        ...
        if (z) {
            ...
            this.f1164d = (float) iArr[0];
            this.f1165e = (float) iArr[length - 1];
            this.f1163c = -1.0f;
        }
        return this.g;
    }
    ...
    /* access modifiers changed from: package-private */
    public int g() {
        return Math.round(this.f1165e);
    }

    /* access modifiers changed from: package-private */
    public int h() {
        return Math.round(this.f1164d);
    }

    /* access modifiers changed from: package-private */
    public int i() {
        return Math.round(this.f1163c);
    }
    ...
    public void o(AttributeSet attributeSet, int i2) {
        ...
        if (obtainStyledAttributes.hasValue(j.AppCompatTextView_autoSizeTextType)) {
            this.f1161a = obtainStyledAttributes.getInt(j.AppCompatTextView_autoSizeTextType, 0);
        }
