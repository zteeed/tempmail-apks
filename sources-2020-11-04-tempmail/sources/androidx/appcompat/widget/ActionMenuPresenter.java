...
class ActionMenuPresenter extends androidx.appcompat.view.menu.b implements b.a {
    ...
    private class c implements Runnable {
        ...
        public void run() {
            if (ActionMenuPresenter.this.f843d != null) {
                ActionMenuPresenter.this.f843d.d();
            }
            View view = (View) ActionMenuPresenter.this.i;
            if (!(view == null || view.getWindowToken() == null || !this.f931b.m())) {
                ActionMenuPresenter.this.z = this.f931b;
            }
    ...
    private class e extends n {
        ...
        public void e() {
            if (ActionMenuPresenter.this.f843d != null) {
                ActionMenuPresenter.this.f843d.close();
            }
    ...
    private class f implements o.a {
        ...
        public void a(h hVar, boolean z) {
            ...
            o.a g = ActionMenuPresenter.this.g();
            if (g != null) {
                g.a(hVar, z);
            }
        }
    ...
    public boolean N() {
        h hVar;
        if (!this.n || H() || (hVar = this.f843d) == null || this.i == null || this.B != null || hVar.B().isEmpty()) {
            return false;
        }
        c cVar = new c(new e(this.f842c, this.f843d, this.k, true));
        this.B = cVar;
    ...
    public boolean j() {
        ...
        h hVar = actionMenuPresenter.f843d;
        int i5 = 0;
        if (hVar != null) {
            arrayList = hVar.G();
            i = arrayList.size();
    ...
    public void o(Parcelable parcelable) {
        int i;
        MenuItem findItem;
        if ((parcelable instanceof SavedState) && (i = ((SavedState) parcelable).f929b) > 0 && (findItem = this.f843d.findItem(i)) != null) {
            p((u) findItem.getSubMenu());
        }
    }
    ...
    public boolean p(u uVar) {
        ...
        a aVar = new a(this.f842c, uVar, C2);
        this.A = aVar;
        aVar.g(z2);
        this.A.k();
        super.p(uVar);
