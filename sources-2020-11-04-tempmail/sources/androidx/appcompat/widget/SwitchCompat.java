...
public class SwitchCompat extends CompoundButton {
    ...
    private Drawable f1061b;

    /* renamed from: c  reason: collision with root package name */
    private ColorStateList f1062c;

    /* renamed from: d  reason: collision with root package name */
    private PorterDuff.Mode f1063d;
    ...
    private void b() {
        ...
        if (this.f1064e || this.f1065f) {
            Drawable mutate = this.f1061b.mutate();
            this.f1061b = mutate;
            if (this.f1064e) {
                androidx.core.graphics.drawable.a.o(mutate, this.f1062c);
            }
            if (this.f1065f) {
                androidx.core.graphics.drawable.a.p(this.f1061b, this.f1063d);
            }
            if (this.f1061b.isStateful()) {
                this.f1061b.setState(getDrawableState());
            }
        }
    }
    ...
    private int getThumbScrollRange() {
        ...
        Drawable drawable2 = this.f1061b;
        if (drawable2 != null) {
            rect = o.d(drawable2);
        } else {
            rect = o.f1167a;
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (drawable != null) {
            drawable.getPadding(rect);
            i5 = (this.f1061b.getIntrinsicWidth() - rect.left) - rect.right;
            i4 = this.f1061b.getIntrinsicHeight();
        } else {
            i5 = 0;
            i4 = 0;
        }
    ...
    public void setChecked(boolean z2) {
        super.setChecked(z2);
        boolean isChecked = isChecked();
        if (getWindowToken() == null || !u.I(this)) {
            d();
    ...
    public boolean verifyDrawable(Drawable drawable) {
        return super.verifyDrawable(drawable) || drawable == this.f1061b || drawable == this.g;
    }
