...
public abstract class r implements View.OnTouchListener, View.OnAttachStateChangeListener {
    ...
    private class a implements Runnable {
        ...
        public void run() {
            ViewParent parent = r.this.f1179e.getParent();
            if (parent != null) {
    ...
    public r(View view) {
        ...
        this.f1176b = (float) ViewConfiguration.get(view.getContext()).getScaledTouchSlop();
        int tapTimeout = ViewConfiguration.getTapTimeout();
        this.f1177c = tapTimeout;
        this.f1178d = (tapTimeout + ViewConfiguration.getLongPressTimeout()) / 2;
    }

    private void a() {
        Runnable runnable = this.g;
        if (runnable != null) {
            this.f1179e.removeCallbacks(runnable);
        }
        Runnable runnable2 = this.f1180f;
        if (runnable2 != null) {
            this.f1179e.removeCallbacks(runnable2);
        }
    }
    ...
    private boolean g(android.view.MotionEvent r6) {
        /*
            r5 = this;
            android.view.View r0 = r5.f1179e
        ...
        L_0x0041:
            ...
            r5.i = r6
            java.lang.Runnable r6 = r5.f1180f
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (z2) {
            ...
            if (z) {
                long uptimeMillis = SystemClock.uptimeMillis();
                MotionEvent obtain = MotionEvent.obtain(uptimeMillis, uptimeMillis, 3, 0.0f, 0.0f, 0);
                this.f1179e.onTouchEvent(obtain);
                obtain.recycle();
            }
        }
        this.h = z;
