...
class i {
    ...
    private static final int[] f1147c = {16843067, 16843068};

    /* renamed from: a  reason: collision with root package name */
    private final ProgressBar f1148a;
    ...
    public void c(AttributeSet attributeSet, int i) {
        b0 u = b0.u(this.f1148a.getContext(), attributeSet, f1147c, i, 0);
        Drawable h = u.h(0);
        if (h != null) {
            this.f1148a.setIndeterminateDrawable(e(h));
        }
        Drawable h2 = u.h(1);
        if (h2 != null) {
            this.f1148a.setProgressDrawable(d(h2, false));
        }
        u.v();
    }
}
