...
public class AppCompatSpinner extends Spinner implements t {
    ...
    private static class b implements ListAdapter, SpinnerAdapter {
        ...
        public boolean areAllItemsEnabled() {
            ListAdapter listAdapter = this.f984c;
            if (listAdapter != null) {
        ...
        public int getCount() {
            SpinnerAdapter spinnerAdapter = this.f983b;
    ...
    private class c extends ListPopupWindow {
        ...
        class a implements AdapterView.OnItemClickListener {
            ...
            /* renamed from: b  reason: collision with root package name */
            final /* synthetic */ AppCompatSpinner f985b;

            a(AppCompatSpinner appCompatSpinner) {
                this.f985b = appCompatSpinner;
            }
        ...
        class C0034c implements PopupWindow.OnDismissListener {
            ...
            /* renamed from: b  reason: collision with root package name */
            final /* synthetic */ ViewTreeObserver.OnGlobalLayoutListener f988b;

            C0034c(ViewTreeObserver.OnGlobalLayoutListener onGlobalLayoutListener) {
                this.f988b = onGlobalLayoutListener;
            }
        ...
        public boolean L(View view) {
            return u.H(view) && view.getGlobalVisibleRect(this.L);
        }
    ...
    public AppCompatSpinner(android.content.Context r8, android.util.AttributeSet r9, int r10, int r11, android.content.res.Resources.Theme r12) {
        ...
        L_0x003c:
            r7.f979c = r12
        L_0x003e:
            android.content.Context r12 = r7.f979c
            r3 = 1
        ...
        L_0x00c4:
            r0.v()
            r7.f982f = r3
            android.widget.SpinnerAdapter r8 = r7.f981e
            if (r8 == 0) goto L_0x00d2
            r7.setAdapter((android.widget.SpinnerAdapter) r8)
            r7.f981e = r2
        L_0x00d2:
            androidx.appcompat.widget.d r8 = r7.f978b
            r8.e(r9, r10)
            return
        */
