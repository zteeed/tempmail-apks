...
public class Toolbar extends ViewGroup {
    ...
    private ImageButton f1069e;

    /* renamed from: f  reason: collision with root package name */
    private ImageView f1070f;
    private Drawable g;
    ...
    private class d implements o {
            ...
            if (this.f1077c != null) {
                ...
                if (hVar != null) {
                    ...
                    while (true) {
                        if (i >= size) {
                            break;
                        } else if (this.f1076b.getItem(i) == this.f1077c) {
                            z2 = true;
                            break;
                        } else {
                            i++;
        ...
        public boolean l(h hVar, j jVar) {
            ...
            if (parent2 != toolbar3) {
                ...
                m.f726a = 8388611 | (toolbar4.o & 112);
                m.f1079b = 2;
        ...
        public void n(Context context, h hVar) {
            j jVar;
            h hVar2 = this.f1076b;
            if (!(hVar2 == null || (jVar = this.f1077c) == null)) {
                hVar2.f(jVar);
            }
            this.f1076b = hVar;
        }
    ...
    private void b(List<View> list, int i2) {
        boolean z2 = a.h.k.u.t(this) == 1;
        int childCount = getChildCount();
        int b2 = a.h.k.d.b(i2, a.h.k.u.t(this));
        list.clear();
        if (z2) {
            for (int i3 = childCount - 1; i3 >= 0; i3--) {
                View childAt = getChildAt(i3);
                e eVar = (e) childAt.getLayoutParams();
                if (eVar.f1079b == 0 && H(childAt) && p(eVar.f726a) == b2) {
                    list.add(childAt);
                }
            }
            return;
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            ...
            if (eVar2.f1079b == 0 && H(childAt2) && p(eVar2.f726a) == b2) {
                list.add(childAt2);
            }
        }
    }
    ...
    private void i() {
        if (this.f1070f == null) {
            this.f1070f = new AppCompatImageView(getContext());
        }
    }

    private void j() {
        k();
        if (this.f1066b.N() == null) {
            h hVar = (h) this.f1066b.getMenu();
            if (this.L == null) {
                this.L = new d();
            }
            this.f1066b.setExpandedActionViewsExclusive(true);
    ...
    private void k() {
        if (this.f1066b == null) {
            ...
            this.f1066b = actionMenuView;
            actionMenuView.setPopupTheme(this.l);
            this.f1066b.setOnMenuItemClickListener(this.I);
            this.f1066b.setMenuCallbacks(this.M, this.N);
            e m2 = generateDefaultLayoutParams();
            m2.f726a = 8388613 | (this.o & 112);
            this.f1066b.setLayoutParams(m2);
            c(this.f1066b, false);
        }
    }
    ...
    private void l() {
        if (this.f1069e == null) {
            this.f1069e = new AppCompatImageButton(getContext(), (AttributeSet) null, a.a.a.toolbarNavigationButtonStyle);
            e m2 = generateDefaultLayoutParams();
            m2.f726a = 8388611 | (this.o & 112);
            this.f1069e.setLayoutParams(m2);
        }
    }

    private int p(int i2) {
        int t2 = a.h.k.u.t(this);
    ...
    public void F() {
        for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
            ...
            if (!(((e) childAt.getLayoutParams()).f1079b == 2 || childAt == this.f1066b)) {
    ...
    public boolean I() {
        ActionMenuView actionMenuView = this.f1066b;
    ...
    public boolean d() {
        /*
            ...
            androidx.appcompat.widget.ActionMenuView r0 = r1.f1066b
            if (r0 == 0) goto L_0x0012
            boolean r0 = r0.K()
            if (r0 == 0) goto L_0x0012
            r0 = 1
    ...
    public void e() {
        d dVar = this.L;
        j jVar = dVar == null ? null : dVar.f1077c;
        if (jVar != null) {
    ...
    public int getCurrentContentInsetEnd() {
        /*
            r3 = this;
            androidx.appcompat.widget.ActionMenuView r0 = r3.f1066b
            r1 = 0
    ...
    public Drawable getLogo() {
        ImageView imageView = this.f1070f;
        if (imageView != null) {
    ...
    public Menu getMenu() {
        j();
        return this.f1066b.getMenu();
    }

    public CharSequence getNavigationContentDescription() {
        ImageButton imageButton = this.f1069e;
        if (imageButton != null) {
    ...
    public Drawable getOverflowIcon() {
        j();
        return this.f1066b.getOverflowIcon();
    }
    ...
    public void onLayout(boolean r20, int r21, int r22, int r23, int r24) {
        ...
        L_0x003a:
            r12 = 0
        L_0x003b:
            android.widget.ImageButton r13 = r0.f1069e
        ...
        L_0x006e:
            androidx.appcompat.widget.ActionMenuView r15 = r0.f1066b
            boolean r15 = r0.H(r15)
        ...
        L_0x00c2:
            android.widget.ImageView r13 = r0.f1070f
            boolean r13 = r0.H(r13)
        ...
        L_0x00d3:
            ...
            int r2 = r0.A(r13, r2, r11, r12)
        L_0x00d9:
            android.widget.TextView r13 = r0.f1067c
            boolean r13 = r0.H(r13)
            android.widget.TextView r14 = r0.f1068d
            boolean r14 = r0.H(r14)
            if (r13 == 0) goto L_0x0100
            android.widget.TextView r15 = r0.f1067c
            android.view.ViewGroup$LayoutParams r15 = r15.getLayoutParams()
            androidx.appcompat.widget.Toolbar$e r15 = (androidx.appcompat.widget.Toolbar.e) r15
            int r3 = r15.topMargin
            r23 = r7
            android.widget.TextView r7 = r0.f1067c
        ...
        L_0x012b:
            ...
            android.widget.TextView r4 = r0.f1067c
            goto L_0x0132
        L_0x0130:
            android.widget.TextView r4 = r0.f1068d
        L_0x0132:
        ...
        L_0x014f:
            ...
            android.widget.TextView r15 = r0.f1068d
            int r15 = r15.getMeasuredWidth()
        ...
        L_0x01bd:
            ...
            android.widget.TextView r1 = r0.f1067c
            android.view.ViewGroup$LayoutParams r1 = r1.getLayoutParams()
            androidx.appcompat.widget.Toolbar$e r1 = (androidx.appcompat.widget.Toolbar.e) r1
            android.widget.TextView r2 = r0.f1067c
            int r2 = r2.getMeasuredWidth()
            int r2 = r10 - r2
            android.widget.TextView r3 = r0.f1067c
        ...
        L_0x01f5:
            ...
            android.widget.TextView r1 = r0.f1068d
            android.view.ViewGroup$LayoutParams r1 = r1.getLayoutParams()
            androidx.appcompat.widget.Toolbar$e r1 = (androidx.appcompat.widget.Toolbar.e) r1
            int r3 = r1.topMargin
            int r8 = r8 + r3
            android.widget.TextView r3 = r0.f1068d
            int r3 = r3.getMeasuredWidth()
            int r3 = r10 - r3
            android.widget.TextView r4 = r0.f1068d
            int r4 = r4.getMeasuredHeight()
            int r4 = r4 + r8
            android.widget.TextView r5 = r0.f1068d
        ...
        L_0x0231:
            ...
            int r4 = r4 + r2
            android.widget.TextView r5 = r0.f1067c
            int r5 = r5.getMeasuredHeight()
            int r5 = r5 + r8
            android.widget.TextView r6 = r0.f1067c
        ...
        L_0x0267:
            ...
            int r5 = r5 + r2
            android.widget.TextView r6 = r0.f1068d
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (H(this.f1069e)) {
            D(this.f1069e, i2, 0, i3, 0, this.p);
            i6 = this.f1069e.getMeasuredWidth() + s(this.f1069e);
            i5 = Math.max(0, this.f1069e.getMeasuredHeight() + t(this.f1069e));
            i4 = View.combineMeasuredStates(0, this.f1069e.getMeasuredState());
        } else {
            i6 = 0;
            i5 = 0;
            i4 = 0;
        ...
        if (H(this.f1066b)) {
            D(this.f1066b, i2, max, i3, 0, this.p);
            i7 = this.f1066b.getMeasuredWidth() + s(this.f1066b);
            i5 = Math.max(i5, this.f1066b.getMeasuredHeight() + t(this.f1066b));
            i4 = View.combineMeasuredStates(i4, this.f1066b.getMeasuredState());
        } else {
            i7 = 0;
        }
        ...
        if (H(this.f1070f)) {
            max2 += C(this.f1070f, i2, max2, i3, 0, iArr);
            i5 = Math.max(i5, this.f1070f.getMeasuredHeight() + t(this.f1070f));
            i4 = View.combineMeasuredStates(i4, this.f1070f.getMeasuredState());
        }
        int childCount = getChildCount();
        for (int i12 = 0; i12 < childCount; i12++) {
            View childAt = getChildAt(i12);
            if (((e) childAt.getLayoutParams()).f1079b == 0 && H(childAt)) {
        ...
        if (H(this.f1067c)) {
            C(this.f1067c, i2, max2 + i14, i3, i13, iArr);
            int measuredWidth = this.f1067c.getMeasuredWidth() + s(this.f1067c);
            i8 = this.f1067c.getMeasuredHeight() + t(this.f1067c);
            i10 = View.combineMeasuredStates(i4, this.f1067c.getMeasuredState());
            i9 = measuredWidth;
        } else {
            i10 = i4;
            i9 = 0;
        ...
        if (H(this.f1068d)) {
            int i15 = i8 + i13;
            i9 = Math.max(i9, C(this.f1068d, i2, max2 + i14, i3, i15, iArr));
            i8 += this.f1068d.getMeasuredHeight() + t(this.f1068d);
            i10 = View.combineMeasuredStates(i10, this.f1068d.getMeasuredState());
        } else {
            int i16 = i10;
        }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        d dVar = this.L;
        if (!(dVar == null || (jVar = dVar.f1077c) == null)) {
            savedState.f1071d = jVar.getItemId();
        }
        savedState.f1072e = z();
        return savedState;
    }
        ...
        if (hVar != null || this.f1066b != null) {
            ...
            if (N2 != hVar) {
                ...
                if (hVar != null) {
                    ...
                    actionMenuPresenter.n(this.k, (h) null);
                    this.L.n(this.k, (h) null);
                    actionMenuPresenter.i(true);
                    this.L.i(true);
                }
                this.f1066b.setPopupTheme(this.l);
                this.f1066b.setPresenter(actionMenuPresenter);
    ...
    public void setNavigationOnClickListener(View.OnClickListener onClickListener) {
        l();
        this.f1069e.setOnClickListener(onClickListener);
    }
    ...
    public void setOverflowIcon(Drawable drawable) {
        j();
        this.f1066b.setOverflowIcon(drawable);
    }
    ...
    public boolean v() {
        d dVar = this.L;
        return (dVar == null || dVar.f1077c == null) ? false : true;
    }
    ...
    public void setLogo(Drawable drawable) {
        if (drawable != null) {
            ...
            if (imageView != null && x(imageView)) {
                removeView(this.f1070f);
                this.F.remove(this.f1070f);
            }
        }
        ImageView imageView2 = this.f1070f;
        if (imageView2 != null) {
    ...
    public void setNavigationIcon(Drawable drawable) {
        if (drawable != null) {
            ...
            if (imageButton != null && x(imageButton)) {
                removeView(this.f1069e);
                this.F.remove(this.f1069e);
            }
        }
        ImageButton imageButton2 = this.f1069e;
    ...
    public void setSubtitle(CharSequence charSequence) {
        if (!TextUtils.isEmpty(charSequence)) {
            if (this.f1068d == null) {
                ...
                this.f1068d = appCompatTextView;
                appCompatTextView.setSingleLine();
                this.f1068d.setEllipsize(TextUtils.TruncateAt.END);
                int i2 = this.n;
                if (i2 != 0) {
                    this.f1068d.setTextAppearance(context, i2);
                }
                int i3 = this.B;
                if (i3 != 0) {
                    this.f1068d.setTextColor(i3);
                }
            }
            if (!x(this.f1068d)) {
                c(this.f1068d, true);
            ...
            if (textView != null && x(textView)) {
                removeView(this.f1068d);
                this.F.remove(this.f1068d);
            }
        }
        TextView textView2 = this.f1068d;
        if (textView2 != null) {
    ...
    public void setTitle(CharSequence charSequence) {
        if (!TextUtils.isEmpty(charSequence)) {
            if (this.f1067c == null) {
                Context context = getContext();
                AppCompatTextView appCompatTextView = new AppCompatTextView(context);
                this.f1067c = appCompatTextView;
                appCompatTextView.setSingleLine();
                this.f1067c.setEllipsize(TextUtils.TruncateAt.END);
                int i2 = this.m;
                if (i2 != 0) {
                    this.f1067c.setTextAppearance(context, i2);
                }
                int i3 = this.A;
                if (i3 != 0) {
                    this.f1067c.setTextColor(i3);
                }
            }
            if (!x(this.f1067c)) {
                c(this.f1067c, true);
            ...
            if (textView != null && x(textView)) {
                ...
                this.F.remove(this.f1067c);
            }
        }
        TextView textView2 = this.f1067c;
        if (textView2 != null) {
            textView2.setText(charSequence);
        }
        this.y = charSequence;
