...
class k {
    ...
    class a extends f.a {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ WeakReference f1159a;

        a(WeakReference weakReference) {
            this.f1159a = weakReference;
        }
        ...
        public void d(Typeface typeface) {
            k.this.l(this.f1159a, typeface);
        }
    }

    k(TextView textView) {
        this.f1153a = textView;
        this.h = new l(this.f1153a);
    }

    private void a(Drawable drawable, z zVar) {
        if (drawable != null && zVar != null) {
            f.C(drawable, zVar, this.f1153a.getDrawableState());
        }
    }
    ...
    private void u(Context context, b0 b0Var) {
        ...
        if (b0Var.r(j.TextAppearance_android_fontFamily) || b0Var.r(j.TextAppearance_fontFamily)) {
            ...
            if (!context.isRestricted()) {
                try {
                    Typeface j2 = b0Var.j(i2, this.i, new a(new WeakReference(this.f1153a)));
                    this.j = j2;
                    if (j2 == null) {
                        z = true;
                    }
    ...
    public void b() {
        if (!(this.f1154b == null && this.f1155c == null && this.f1156d == null && this.f1157e == null)) {
            ...
            a(compoundDrawables[0], this.f1154b);
            a(compoundDrawables[1], this.f1155c);
            a(compoundDrawables[2], this.f1156d);
            a(compoundDrawables[3], this.f1157e);
        }
        if (Build.VERSION.SDK_INT < 17) {
            return;
        }
        if (this.f1158f != null || this.g != null) {
            Drawable[] compoundDrawablesRelative = this.f1153a.getCompoundDrawablesRelative();
            a(compoundDrawablesRelative[0], this.f1158f);
    ...
    public void k(AttributeSet attributeSet, int i2) {
        ...
        int i3 = i2;
        Context context = this.f1153a.getContext();
        f n = f.n();
        ...
        if (u.r(j.AppCompatTextHelper_android_drawableLeft)) {
            this.f1154b = d(context, n, u.n(j.AppCompatTextHelper_android_drawableLeft, 0));
        }
        if (u.r(j.AppCompatTextHelper_android_drawableTop)) {
            this.f1155c = d(context, n, u.n(j.AppCompatTextHelper_android_drawableTop, 0));
        }
        if (u.r(j.AppCompatTextHelper_android_drawableRight)) {
            this.f1156d = d(context, n, u.n(j.AppCompatTextHelper_android_drawableRight, 0));
        }
        if (u.r(j.AppCompatTextHelper_android_drawableBottom)) {
            this.f1157e = d(context, n, u.n(j.AppCompatTextHelper_android_drawableBottom, 0));
        }
        if (Build.VERSION.SDK_INT >= 17) {
            if (u.r(j.AppCompatTextHelper_android_drawableStart)) {
                this.f1158f = d(context, n, u.n(j.AppCompatTextHelper_android_drawableStart, 0));
            }
        ...
        u.v();
        boolean z3 = this.f1153a.getTransformationMethod() instanceof PasswordTransformationMethod;
        boolean z4 = true;
        ...
        if (colorStateList3 != null) {
            this.f1153a.setTextColor(colorStateList3);
        }
        if (colorStateList != null) {
            this.f1153a.setHintTextColor(colorStateList);
        }
        if (colorStateList2 != null) {
            this.f1153a.setLinkTextColor(colorStateList2);
        }
        if (!z3 && z4) {
            o(z2);
        }
        ...
        if (typeface != null) {
            this.f1153a.setTypeface(typeface, this.i);
        }
        this.h.o(attributeSet2, i3);
        if (b.f1404a && this.h.k() != 0) {
            int[] j2 = this.h.j();
            if (j2.length > 0) {
                if (((float) this.f1153a.getAutoSizeStepGranularity()) != -1.0f) {
                    this.f1153a.setAutoSizeTextTypeUniformWithConfiguration(this.h.h(), this.h.g(), this.h.i(), 0);
                } else {
                    this.f1153a.setAutoSizeTextTypeUniformWithPresetSizes(j2, 0);
                }
            }
        }
