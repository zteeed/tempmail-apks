...
class v extends c implements View.OnClickListener {
    ...
    private static final class a {
        ...
        public a(View view) {
            this.f1190a = (TextView) view.findViewById(16908308);
            this.f1191b = (TextView) view.findViewById(16908309);
            this.f1192c = (ImageView) view.findViewById(16908295);
            this.f1193d = (ImageView) view.findViewById(16908296);
            this.f1194e = (ImageView) view.findViewById(f.edit_query);
        }
    }
    ...
    public v(Context context, SearchView searchView, SearchableInfo searchableInfo, WeakHashMap<String, Drawable.ConstantState> weakHashMap) {
        ...
        SearchManager searchManager = (SearchManager) this.f441e.getSystemService("search");
        this.m = searchView;
    ...
    private CharSequence l(CharSequence charSequence) {
        if (this.t == null) {
            ...
            this.f441e.getTheme().resolveAttribute(a.a.a.textColorSearchUrl, typedValue, true);
            this.t = this.f441e.getResources().getColorStateList(typedValue.resourceId);
        }
    ...
    private Drawable m(ComponentName componentName) {
        PackageManager packageManager = this.f441e.getPackageManager();
        try {
    ...
    private Drawable p(Cursor cursor) {
        ...
        return this.f441e.getPackageManager().getDefaultActivityIcon();
    }
    ...
    private android.graphics.drawable.Drawable q(android.net.Uri r7) {
        ...
        L_0x0085:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.v.q(android.net.Uri):android.graphics.drawable.Drawable");
    }
    ...
    private Drawable s(String str) {
        ...
        try {
            ...
            Drawable f2 = androidx.core.content.a.f(this.o, parseInt);
            A(str2, f2);
            return f2;
    ...
    public void e(View view, Context context, Cursor cursor) {
        ...
        if (aVar.f1191b != null) {
            ...
            if (TextUtils.isEmpty(charSequence)) {
                TextView textView = aVar.f1190a;
                if (textView != null) {
                    textView.setSingleLine(false);
                    aVar.f1190a.setMaxLines(2);
                }
            } else {
                TextView textView2 = aVar.f1190a;
                if (textView2 != null) {
                    textView2.setSingleLine(true);
                    aVar.f1190a.setMaxLines(1);
                }
            }
            z(aVar.f1191b, charSequence);
        }
        ImageView imageView = aVar.f1192c;
        if (imageView != null) {
            y(imageView, t(cursor), 4);
        }
        ImageView imageView2 = aVar.f1193d;
        if (imageView2 != null) {
        ...
        if (i3 == 2 || (i3 == 1 && (i2 & 1) != 0)) {
            ...
            aVar.f1194e.setTag(aVar.f1190a.getText());
            aVar.f1194e.setOnClickListener(this);
            return;
        }
    ...
    public View getDropDownView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            View g = g(this.f441e, this.f440d, viewGroup);
            if (g != null) {
                ((a) g.getTag()).f1190a.setText(e2.toString());
            }
            return g;
        }
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            Log.w("SuggestionsAdapter", "Search suggestions cursor threw exception.", e2);
            View h = h(this.f441e, this.f440d, viewGroup);
            if (h != null) {
                ((a) h.getTag()).f1190a.setText(e2.toString());
            }
            return h;
        }
    }
    ...
    public View h(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        h.setTag(new a(h));
        ((ImageView) h.findViewById(f.edit_query)).setImageResource(this.q);
        return h;
    }
    ...
    public Drawable r(Uri uri) throws FileNotFoundException {
        ...
        if (!TextUtils.isEmpty(authority)) {
            try {
                Resources resourcesForApplication = this.f441e.getPackageManager().getResourcesForApplication(authority);
    ...
    public Cursor v(SearchableInfo searchableInfo, String str, int i) {
        ...
        return this.f441e.getContentResolver().query(fragment.build(), (String[]) null, suggestSelection, strArr2, (String) null);
    }
