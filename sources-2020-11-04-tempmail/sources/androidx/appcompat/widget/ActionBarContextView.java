...
public class ActionBarContextView extends a {
    ...
    public void h(b bVar) {
        ...
        this.f1088e = actionMenuPresenter2;
        actionMenuPresenter2.M(true);
        ViewGroup.LayoutParams layoutParams = new ViewGroup.LayoutParams(-2, -1);
        hVar.c(this.f1088e, this.f1086c);
        ActionMenuView actionMenuView = (ActionMenuView) this.f1088e.s(this);
        this.f1087d = actionMenuView;
        u.b0(actionMenuView, (Drawable) null);
        addView(this.f1087d, layoutParams);
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        ActionMenuView actionMenuView = this.f1087d;
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (View.MeasureSpec.getMode(i) != 1073741824) {
            ...
            if (actionMenuView != null && actionMenuView.getParent() == this) {
                paddingLeft = c(this.f1087d, paddingLeft, makeMeasureSpec, 0);
            }
            LinearLayout linearLayout = this.n;
