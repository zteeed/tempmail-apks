...
public class g extends c {
    ...
    private Set<Class<? extends c>> f1439a = new HashSet();

    /* renamed from: b  reason: collision with root package name */
    private List<c> f1440b = new CopyOnWriteArrayList();

    /* renamed from: c  reason: collision with root package name */
    private List<String> f1441c = new CopyOnWriteArrayList();

    private boolean e() {
        boolean z = false;
        for (String next : this.f1441c) {
            try {
                Class<?> cls = Class.forName(next);
                if (c.class.isAssignableFrom(cls)) {
                    d((c) cls.newInstance());
                    this.f1441c.remove(next);
                    z = true;
                }
    ...
    public void d(c cVar) {
        if (this.f1439a.add(cVar.getClass())) {
