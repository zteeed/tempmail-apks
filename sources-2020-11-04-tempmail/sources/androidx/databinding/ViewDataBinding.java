...
public abstract class ViewDataBinding extends a {
    ...
    private b<Object, ViewDataBinding, Void> f1427e;
    ...
    static class OnStartListener implements j {
        ...
        /* renamed from: a  reason: collision with root package name */
        final WeakReference<ViewDataBinding> f1429a;

        @r(g.a.ON_START)
        public void onStart() {
            ViewDataBinding viewDataBinding = (ViewDataBinding) this.f1429a.get();
    ...
    static class a implements View.OnAttachStateChangeListener {
        ...
        public void onViewAttachedToWindow(View view) {
            ViewDataBinding.m(view).f1423a.run();
    ...
    class b implements Runnable {
        ...
        public void run() {
            synchronized (this) {
                boolean unused = ViewDataBinding.this.f1424b = false;
            }
            ViewDataBinding.u();
            if (Build.VERSION.SDK_INT < 19 || ViewDataBinding.this.f1426d.isAttachedToWindow()) {
                ViewDataBinding.this.j();
                return;
            }
            ViewDataBinding.this.f1426d.removeOnAttachStateChangeListener(ViewDataBinding.p);
            ViewDataBinding.this.f1426d.addOnAttachStateChangeListener(ViewDataBinding.p);
        }
    }
    ...
    class c implements Choreographer.FrameCallback {
        ...
        public void doFrame(long j) {
            ViewDataBinding.this.f1423a.run();
        }
    }
    ...
    protected static class d {
        ...
        public d(int i) {
            ...
            this.f1433b = new int[i][];
            this.f1434c = new int[i][];
        }

        public void a(int i, String[] strArr, int[] iArr, int[] iArr2) {
            this.f1432a[i] = strArr;
            this.f1433b[i] = iArr;
            this.f1434c[i] = iArr2;
        }
    }
    ...
    private void h() {
        if (this.f1428f) {
            ...
            this.f1428f = true;
            this.f1425c = false;
            b<Object, ViewDataBinding, Void> bVar = this.f1427e;
            if (bVar == null) {
                if (0 == 0) {
                    g();
                    b<Object, ViewDataBinding, Void> bVar2 = this.f1427e;
                    if (bVar2 != null) {
                        bVar2.b(this, 3, null);
                        throw null;
                    }
    ...
    public void v() {
        ...
        L_0x001d:
            monitor-enter(r2)
            boolean r0 = r2.f1424b     // Catch:{ all -> 0x003c }
            if (r0 == 0) goto L_0x0024
            monitor-exit(r2)     // Catch:{ all -> 0x003c }
            return
        L_0x0024:
            r0 = 1
            r2.f1424b = r0     // Catch:{ all -> 0x003c }
            monitor-exit(r2)     // Catch:{ all -> 0x003c }
            boolean r0 = n
        ...
        L_0x0034:
            ...
            java.lang.Runnable r1 = r2.f1423a
            r0.post(r1)
        L_0x003b:
            return
        L_0x003c:
