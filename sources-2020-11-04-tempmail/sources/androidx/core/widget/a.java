...
public abstract class a implements View.OnTouchListener {
    ...
    final C0043a f1392b = new C0043a();

    /* renamed from: c  reason: collision with root package name */
    private final Interpolator f1393c = new AccelerateInterpolator();

    /* renamed from: d  reason: collision with root package name */
    final View f1394d;

    /* renamed from: e  reason: collision with root package name */
    private Runnable f1395e;

    /* renamed from: f  reason: collision with root package name */
    private float[] f1396f = {0.0f, 0.0f};
    ...
    private static class C0043a {
        ...
        /* renamed from: e  reason: collision with root package name */
        private long f1401e = Long.MIN_VALUE;

        /* renamed from: f  reason: collision with root package name */
        private long f1402f = 0;
        private int g = 0;
        private int h = 0;
        private long i = -1;
        private float j;
        ...
        private float e(long j2) {
            ...
            long j3 = this.i;
            if (j3 < 0 || j2 < j3) {
                return a.e(((float) (j2 - this.f1401e)) / ((float) this.f1397a), 0.0f, 1.0f) * 0.5f;
            }
            long j4 = j2 - j3;
            float f2 = this.j;
        ...
        public void a() {
            if (this.f1402f != 0) {
                ...
                this.f1402f = currentAnimationTimeMillis;
                float f2 = ((float) (currentAnimationTimeMillis - this.f1402f)) * g2;
                this.g = (int) (this.f1399c * f2);
                this.h = (int) (f2 * this.f1400d);
                return;
            }
        ...
        public int d() {
            float f2 = this.f1399c;
            return (int) (f2 / Math.abs(f2));
        }

        public int f() {
            float f2 = this.f1400d;
            return (int) (f2 / Math.abs(f2));
        }
        ...
        public void i() {
            long currentAnimationTimeMillis = AnimationUtils.currentAnimationTimeMillis();
            this.k = a.f((int) (currentAnimationTimeMillis - this.f1401e), 0, this.f1398b);
        ...
        public void m() {
            long currentAnimationTimeMillis = AnimationUtils.currentAnimationTimeMillis();
            this.f1401e = currentAnimationTimeMillis;
            this.i = -1;
            this.f1402f = currentAnimationTimeMillis;
            this.j = 0.5f;
            this.g = 0;
    ...
    private float d(int i2, float f2, float f3, float f4) {
        float h2 = h(this.f1396f[i2], f3, this.g[i2], f2);
    ...
    private float h(float f2, float f3, float f4, float f5) {
        ...
        if (g2 < 0.0f) {
            f6 = -this.f1393c.getInterpolation(-g2);
        } else if (g2 <= 0.0f) {
            return 0.0f;
        } else {
            f6 = this.f1393c.getInterpolation(g2);
    ...
    private void v() {
        ...
        if (this.m || (i2 = this.i) <= 0) {
            ...
            u.W(this.f1394d, this.f1395e, (long) i2);
        }
        this.m = true;
    }
    ...
    public void c() {
        ...
        this.f1394d.onTouchEvent(obtain);
        obtain.recycle();
    }
    ...
    public boolean onTouch(android.view.View r6, android.view.MotionEvent r7) {
        ...
        L_0x001e:
            ...
            int r3 = r6.getWidth()
            float r3 = (float) r3
            android.view.View r4 = r5.f1394d
            int r4 = r4.getWidth()
            float r4 = (float) r4
            ...
            int r6 = r6.getHeight()
            float r6 = (float) r6
            android.view.View r3 = r5.f1394d
            int r3 = r3.getHeight()
            float r3 = (float) r3
            float r6 = r5.d(r2, r7, r6, r3)
            androidx.core.widget.a$a r7 = r5.f1392b
            r7.l(r0, r6)
            boolean r6 = r5.p
