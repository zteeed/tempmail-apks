...
public final class b {
    ...
    private final Shader f1337a;

    /* renamed from: b  reason: collision with root package name */
    private final ColorStateList f1338b;
    ...
    public boolean i() {
        /*
            r1 = this;
            android.graphics.Shader r0 = r1.f1337a
            if (r0 != 0) goto L_0x0010
            android.content.res.ColorStateList r0 = r1.f1338b
            if (r0 == 0) goto L_0x0010
    ...
    public boolean j(int[] iArr) {
        if (i()) {
            ColorStateList colorStateList = this.f1338b;
            int colorForState = colorStateList.getColorForState(iArr, colorStateList.getDefaultColor());
            if (colorForState != this.f1339c) {
                this.f1339c = colorForState;
                return true;
            }
        }
        return false;
