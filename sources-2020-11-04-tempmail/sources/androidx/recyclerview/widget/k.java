...
public abstract class k extends RecyclerView.l {
    ...
    public boolean a(RecyclerView.b0 b0Var, RecyclerView.l.c cVar, RecyclerView.l.c cVar2) {
        if (cVar == null || (cVar.f1786a == cVar2.f1786a && cVar.f1787b == cVar2.f1787b)) {
            return w(b0Var);
        }
        return y(b0Var, cVar.f1786a, cVar.f1787b, cVar2.f1786a, cVar2.f1787b);
    }
    ...
    public boolean c(RecyclerView.b0 b0Var, RecyclerView.l.c cVar, RecyclerView.l.c cVar2) {
        ...
        int left = cVar2 == null ? view.getLeft() : cVar2.f1786a;
        int top = cVar2 == null ? view.getTop() : cVar2.f1787b;
    ...
    public boolean d(RecyclerView.b0 b0Var, RecyclerView.l.c cVar, RecyclerView.l.c cVar2) {
        if (cVar.f1786a == cVar2.f1786a && cVar.f1787b == cVar2.f1787b) {
            E(b0Var);
            return false;
        }
        return y(b0Var, cVar.f1786a, cVar.f1787b, cVar2.f1786a, cVar2.f1787b);
