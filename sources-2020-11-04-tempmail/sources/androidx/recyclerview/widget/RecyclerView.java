...
public class RecyclerView extends ViewGroup implements a.h.k.j {
    ...
    public static abstract class LayoutManager {
        ...
        /* renamed from: c  reason: collision with root package name */
        private final l.b f1755c = new a();

        /* renamed from: d  reason: collision with root package name */
        private final l.b f1756d = new b();

        /* renamed from: e  reason: collision with root package name */
        l f1757e = new l(this.f1755c);

        /* renamed from: f  reason: collision with root package name */
        l f1758f = new l(this.f1756d);
        x g;
        boolean h = false;
        boolean i = false;
        boolean j = false;
        ...
        private void e(View view, int i2, boolean z) {
            ...
            if (f0.K() || f0.v()) {
                ...
                this.f1753a.c(view, i2, view.getLayoutParams(), false);
            } else if (view.getParent() == this.f1754b) {
                int m2 = this.f1753a.m(view);
                if (i2 == -1) {
                    i2 = this.f1753a.g();
                }
                if (m2 == -1) {
                    throw new IllegalStateException("Added View has RecyclerView as parent but view is not a real child. Unfiltered index:" + this.f1754b.indexOfChild(view) + this.f1754b.R());
                } else if (m2 != i2) {
                    this.f1754b.n.z0(m2, i2);
                }
            } else {
                this.f1753a.a(view, i2, false);
                oVar.f1791c = true;
                x xVar = this.g;
                if (xVar != null && xVar.c()) {
                    this.g.e(view);
        ...
        public static Properties g0(Context context, AttributeSet attributeSet, int i2, int i3) {
            ...
            properties.orientation = obtainStyledAttributes.getInt(a.p.b.RecyclerView_android_orientation, 1);
            properties.spanCount = obtainStyledAttributes.getInt(a.p.b.RecyclerView_spanCount, 1);
            properties.reverseLayout = obtainStyledAttributes.getBoolean(a.p.b.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = obtainStyledAttributes.getBoolean(a.p.b.RecyclerView_stackFromEnd, false);
        ...
        public View A(View view) {
            ...
            if (recyclerView == null || (T = recyclerView.T(view)) == null || this.f1753a.n(T)) {
                return null;
            }
            return T;
        }
        ...
        public void A1(RecyclerView recyclerView) {
            if (recyclerView == null) {
                ...
                this.f1754b = recyclerView;
                this.f1753a = recyclerView.f1752f;
        ...
        public View B(int i2) {
            ...
            for (int i3 = 0; i3 < I; i3++) {
                ...
                if (f0 != null && f0.m() == i2 && !f0.I() && (this.f1754b.i0.e() || !f0.u())) {
                    return H;
                }
            }
            return null;
        ...
        public int G(View view) {
            return ((o) view.getLayoutParams()).f1790b.bottom;
        }
        ...
        public void I0(AccessibilityEvent accessibilityEvent) {
            RecyclerView recyclerView = this.f1754b;
            J0(recyclerView.f1749c, recyclerView.i0, accessibilityEvent);
        }
        ...
        public void J0(u uVar, y yVar, AccessibilityEvent accessibilityEvent) {
            ...
            if (recyclerView != null && accessibilityEvent != null) {
                boolean z = true;
                if (!recyclerView.canScrollVertically(1) && !this.f1754b.canScrollVertically(-1) && !this.f1754b.canScrollHorizontally(-1) && !this.f1754b.canScrollHorizontally(1)) {
                    z = false;
                }
                accessibilityEvent.setScrollable(z);
                g gVar = this.f1754b.m;
                if (gVar != null) {
        ...
        /* access modifiers changed from: package-private */
        public void K0(a.h.k.d0.d dVar) {
            RecyclerView recyclerView = this.f1754b;
            L0(recyclerView.f1749c, recyclerView.i0, dVar);
        }
        ...
        public void L0(u uVar, y yVar, a.h.k.d0.d dVar) {
            if (this.f1754b.canScrollVertically(-1) || this.f1754b.canScrollHorizontally(-1)) {
                dVar.a(8192);
                dVar.t0(true);
            }
            if (this.f1754b.canScrollVertically(1) || this.f1754b.canScrollHorizontally(1)) {
        ...
        public int M(u uVar, y yVar) {
            ...
            return this.f1754b.m.c();
        }

        /* access modifiers changed from: package-private */
        public void M0(View view, a.h.k.d0.d dVar) {
            b0 f0 = RecyclerView.f0(view);
            if (f0 != null && !f0.u() && !this.f1753a.n(f0.f1769a)) {
                RecyclerView recyclerView = this.f1754b;
                N0(recyclerView.f1749c, recyclerView.i0, view, dVar);
            }
        }
        ...
        public void N0(u uVar, y yVar, View view, a.h.k.d0.d dVar) {
        ...
        public int Q(View view) {
            Rect rect = ((o) view.getLayoutParams()).f1790b;
        ...
        public View U() {
            View focusedChild;
            RecyclerView recyclerView = this.f1754b;
            if (recyclerView == null || (focusedChild = recyclerView.getFocusedChild()) == null || this.f1753a.n(focusedChild)) {
                return null;
            }
            return focusedChild;
        }
        ...
        public int Y(View view) {
            return ((o) view.getLayoutParams()).f1790b.left;
        }
        ...
        public boolean d1(int i2, Bundle bundle) {
            RecyclerView recyclerView = this.f1754b;
            return e1(recyclerView.f1749c, recyclerView.i0, i2, bundle);
        }
        ...
        public boolean e1(androidx.recyclerview.widget.RecyclerView.u r2, androidx.recyclerview.widget.RecyclerView.y r3, int r4, android.os.Bundle r5) {
            /*
                r1 = this;
                androidx.recyclerview.widget.RecyclerView r2 = r1.f1754b
                r3 = 0
            ...
            L_0x0029:
                r2 = 0
            L_0x002a:
                androidx.recyclerview.widget.RecyclerView r5 = r1.f1754b
            ...
            L_0x0057:
                r2 = 0
            L_0x0058:
                androidx.recyclerview.widget.RecyclerView r4 = r1.f1754b
            ...
            L_0x006e:
                ...
                return r3
            L_0x0073:
                androidx.recyclerview.widget.RecyclerView r3 = r1.f1754b
                r3.j1(r4, r2)
                return r0
            */
        ...
        public boolean f1(View view, int i2, Bundle bundle) {
            RecyclerView recyclerView = this.f1754b;
            return g1(recyclerView.f1749c, recyclerView.i0, view, i2, bundle);
        }
        ...
        public void h(View view, int i2, o oVar) {
            ...
            this.f1753a.c(view, i2, oVar, f0.u());
        }

        public int h0(View view) {
            return ((o) view.getLayoutParams()).f1790b.right;
        }
        ...
        public void i1(u uVar) {
            ...
            for (int i2 = j2 - 1; i2 >= 0; i2--) {
                ...
                if (!f0.I()) {
                    f0.F(false);
                    if (f0.w()) {
                        this.f1754b.removeDetachedView(n2, false);
                    }
                    l lVar = this.f1754b.N;
                    if (lVar != null) {
                        lVar.j(f0);
                    }
                    f0.F(true);
        ...
        public int k0(View view) {
            return ((o) view.getLayoutParams()).f1790b.top;
        }
        ...
        public void l0(View view, boolean z, Rect rect) {
            Matrix matrix;
            if (z) {
                Rect rect2 = ((o) view.getLayoutParams()).f1790b;
                rect.set(-rect2.left, -rect2.top, view.getWidth() + rect2.right, view.getHeight() + rect2.bottom);
            } else {
                rect.set(0, 0, view.getWidth(), view.getHeight());
            }
            if (!(this.f1754b == null || (matrix = view.getMatrix()) == null || matrix.isIdentity())) {
                RectF rectF = this.f1754b.l;
                rectF.set(rect);
        ...
        public boolean w0(View view, boolean z, boolean z2) {
            boolean z3 = this.f1757e.b(view, 24579) && this.f1758f.b(view, 24579);
            return z ? z3 : !z3;
        }
        ...
        public void x1(int i2, int i3) {
            this.f1754b.setMeasuredDimension(i2, i3);
        }
        ...
        public void z0(int i2, int i3) {
            ...
            throw new IllegalArgumentException("Cannot move a child from non-existing index:" + i2 + this.f1754b.toString());
        }
        ...
        public void z1(int i2, int i3) {
            ...
            this.f1754b.j.set(i6, i7, i4, i5);
            y1(this.f1754b.j, i2, i3);
        }
    }
    ...
    class a0 implements Runnable {
        ...
        /* renamed from: e  reason: collision with root package name */
        Interpolator f1766e = RecyclerView.J0;
        ...
        a0() {
            this.f1765d = new OverScroller(RecyclerView.this.getContext(), RecyclerView.J0);
        }
        ...
        public void e(int i, int i2) {
            ...
            this.f1764c = 0;
            this.f1763b = 0;
            this.f1765d.fling(0, 0, i, i2, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE);
            f();
        }
        ...
        public void f() {
            ...
            a.h.k.u.V(RecyclerView.this, this);
        }

        public void g(int i, int i2, int i3, Interpolator interpolator) {
            if (this.f1766e != interpolator) {
                this.f1766e = interpolator;
                this.f1765d = new OverScroller(RecyclerView.this.getContext(), interpolator);
            }
            RecyclerView.this.setScrollState(2);
            this.f1764c = 0;
            this.f1763b = 0;
            this.f1765d.startScroll(0, 0, i, i2, i3);
            if (Build.VERSION.SDK_INT < 23) {
                this.f1765d.computeScrollOffset();
            }
            f();
        }
        ...
        public void run() {
            ...
            L_0x000c:
                ...
                androidx.recyclerview.widget.RecyclerView r1 = androidx.recyclerview.widget.RecyclerView.this
                r1.v()
                android.widget.OverScroller r1 = r0.f1765d
    ...
    public static abstract class b0 {
        ...
        /* renamed from: b  reason: collision with root package name */
        WeakReference<RecyclerView> f1770b;
        ...
        /* access modifiers changed from: package-private */
        public boolean h() {
            return (this.j & 16) == 0 && a.h.k.u.F(this.f1769a);
        }
        ...
        public String toString() {
            StringBuilder sb = new StringBuilder("ViewHolder{" + Integer.toHexString(hashCode()) + " position=" + this.f1771c + " id=" + this.f1773e + ", oldPos=" + this.f1772d + ", pLpos:" + this.g);
            if (v()) {
                sb.append(" scrap ");
        ...
        public void z(int i2, boolean z) {
            ...
            this.f1771c += i2;
            if (this.f1769a.getLayoutParams() != null) {
                ((o) this.f1769a.getLayoutParams()).f1791c = true;
            }
        }
    }
    ...
    class d implements m.b {
        ...
        public void a(b0 b0Var) {
            RecyclerView recyclerView = RecyclerView.this;
            recyclerView.n.j1(b0Var.f1769a, recyclerView.f1749c);
        }
        ...
        public void c(b0 b0Var, l.c cVar, l.c cVar2) {
            RecyclerView.this.f1749c.J(b0Var);
    ...
    class f implements a.C0047a {
        ...
        public b0 e(int i) {
            ...
            if (a0 != null && !RecyclerView.this.f1752f.n(a0.f1769a)) {
                return a0;
            }
            return null;
        }
        ...
        public void i(a.b bVar) {
            ...
            if (i == 1) {
                RecyclerView recyclerView = RecyclerView.this;
                recyclerView.n.P0(recyclerView, bVar.f1845b, bVar.f1847d);
            } else if (i == 2) {
                RecyclerView recyclerView2 = RecyclerView.this;
                recyclerView2.n.S0(recyclerView2, bVar.f1845b, bVar.f1847d);
            } else if (i == 4) {
                RecyclerView recyclerView3 = RecyclerView.this;
                recyclerView3.n.U0(recyclerView3, bVar.f1845b, bVar.f1847d, bVar.f1846c);
            } else if (i == 8) {
                RecyclerView recyclerView4 = RecyclerView.this;
                recyclerView4.n.R0(recyclerView4, bVar.f1845b, bVar.f1847d, 1);
            }
        }
    }
    ...
    public static abstract class g<VH extends b0> {
        ...
        public final void a(VH vh, int i) {
            ...
            l(vh, i, vh.o());
            vh.d();
            ViewGroup.LayoutParams layoutParams = vh.f1769a.getLayoutParams();
            if (layoutParams instanceof o) {
                ((o) layoutParams).f1791c = true;
            }
        ...
        public void s(i iVar) {
            this.f1778a.registerObserver(iVar);
        }

        public void t(i iVar) {
            this.f1778a.unregisterObserver(iVar);
        }
    }
    ...
    public static abstract class l {
        ...
        /* renamed from: a  reason: collision with root package name */
        private b f1780a = null;

        /* renamed from: b  reason: collision with root package name */
        private ArrayList<a> f1781b = new ArrayList<>();

        /* renamed from: c  reason: collision with root package name */
        private long f1782c = 120;

        /* renamed from: d  reason: collision with root package name */
        private long f1783d = 120;

        /* renamed from: e  reason: collision with root package name */
        private long f1784e = 250;

        /* renamed from: f  reason: collision with root package name */
        private long f1785f = 250;
    ...
    private class m implements l.b {
        ...
        public void a(b0 b0Var) {
            ...
            b0Var.i = null;
            if (!b0Var.H() && !RecyclerView.this.U0(b0Var.f1769a) && b0Var.w()) {
                RecyclerView.this.removeDetachedView(b0Var.f1769a, false);
            }
        }
    }
    ...
    public static class t {
        ...
        /* renamed from: a  reason: collision with root package name */
        SparseArray<a> f1793a = new SparseArray<>();
        ...
        static class a {
            ...
            /* renamed from: a  reason: collision with root package name */
            final ArrayList<b0> f1795a = new ArrayList<>();
        ...
        private a g(int i) {
            a aVar = this.f1793a.get(i);
            if (aVar != null) {
                return aVar;
            }
            a aVar2 = new a();
            this.f1793a.put(i, aVar2);
            return aVar2;
        }
        ...
        public void b() {
            for (int i = 0; i < this.f1793a.size(); i++) {
                this.f1793a.valueAt(i).f1795a.clear();
            }
        }
        ...
        public void d(int i, long j) {
            a g = g(i);
            g.f1798d = j(g.f1798d, j);
        }

        /* access modifiers changed from: package-private */
        public void e(int i, long j) {
            a g = g(i);
            g.f1797c = j(g.f1797c, j);
        }

        public b0 f(int i) {
            a aVar = this.f1793a.get(i);
            if (aVar == null || aVar.f1795a.isEmpty()) {
                return null;
            }
            ArrayList<b0> arrayList = aVar.f1795a;
        ...
        public void i(b0 b0Var) {
            int l = b0Var.l();
            ArrayList<b0> arrayList = g(l).f1795a;
            if (this.f1793a.get(l).f1796b > arrayList.size()) {
                b0Var.C();
                arrayList.add(b0Var);
            }
        }
    ...
    public final class u {
        ...
        /* renamed from: a  reason: collision with root package name */
        final ArrayList<b0> f1799a = new ArrayList<>();

        /* renamed from: b  reason: collision with root package name */
        ArrayList<b0> f1800b = null;

        /* renamed from: c  reason: collision with root package name */
        final ArrayList<b0> f1801c = new ArrayList<>();

        /* renamed from: d  reason: collision with root package name */
        private final List<b0> f1802d = Collections.unmodifiableList(this.f1799a);

        /* renamed from: e  reason: collision with root package name */
        private int f1803e = 2;
        ...
        private void b(b0 b0Var) {
            if (RecyclerView.this.t0()) {
                ...
                if (!a.h.k.u.C(view)) {
                    b0Var.b(16384);
                    a.h.k.u.Z(view, RecyclerView.this.p0.n());
                }
            }
        }
        ...
        public void A(int i2) {
            a(this.f1801c.get(i2), true);
            this.f1801c.remove(i2);
        }
        ...
        public void C(b0 b0Var) {
            ...
            boolean z2 = false;
            boolean z3 = true;
            if (b0Var.v() || b0Var.f1769a.getParent() != null) {
                StringBuilder sb = new StringBuilder();
                sb.append("Scrapped or attached views may not be recycled. isScrap:");
                sb.append(b0Var.v());
                sb.append(" isAttached:");
                if (b0Var.f1769a.getParent() != null) {
                    z2 = true;
                }
                sb.append(z2);
                ...
                if ((gVar != null && h2 && gVar.o(b0Var)) || b0Var.t()) {
                    if (this.f1804f <= 0 || b0Var.p(526)) {
                        z = false;
                    } else {
                        int size = this.f1801c.size();
                        if (size >= this.f1804f && size > 0) {
                            A(0);
                            size--;
                        }
                        if (RecyclerView.F0 && size > 0 && !RecyclerView.this.h0.d(b0Var.f1771c)) {
                            int i2 = size - 1;
                            while (i2 >= 0) {
                                if (!RecyclerView.this.h0.d(this.f1801c.get(i2).f1771c)) {
                                    break;
                                }
                                i2--;
                            }
        ...
        public androidx.recyclerview.widget.RecyclerView.b0 I(int r17, boolean r18, long r19) {
            ...
            L_0x0029:
                ...
                androidx.recyclerview.widget.RecyclerView r5 = androidx.recyclerview.widget.RecyclerView.this
                android.view.View r9 = r1.f1769a
            ...
            L_0x005d:
                ...
                androidx.recyclerview.widget.RecyclerView r5 = androidx.recyclerview.widget.RecyclerView.this
                androidx.recyclerview.widget.a r5 = r5.f1751e
                int r5 = r5.m(r3)
            ...
            L_0x0120:
                ...
                android.view.View r5 = r2.f1769a
            ...
            L_0x01e8:
                androidx.recyclerview.widget.RecyclerView r0 = androidx.recyclerview.widget.RecyclerView.this
                androidx.recyclerview.widget.a r0 = r0.f1751e
                int r2 = r0.m(r3)
                r0 = r16
                r1 = r9
                r3 = r17
            ...
            L_0x01fb:
                android.view.View r1 = r9.f1769a
                ...
                android.view.View r2 = r9.f1769a
        ...
        public void J(b0 b0Var) {
            if (b0Var.o) {
                this.f1800b.remove(b0Var);
            } else {
                this.f1799a.remove(b0Var);
            }
            b0Var.n = null;
            b0Var.o = false;
            b0Var.e();
        ...
        public void K() {
            ...
            this.f1804f = this.f1803e + (layoutManager != null ? layoutManager.m : 0);
            for (int size = this.f1801c.size() - 1; size >= 0 && this.f1801c.size() > this.f1804f; size--) {
                A(size);
            }
        }
        ...
        public boolean L(b0 b0Var) {
            ...
            } else if (!RecyclerView.this.i0.e() && RecyclerView.this.m.e(b0Var.f1771c) != b0Var.l()) {
                return false;
            } else {
                if (!RecyclerView.this.m.f() || b0Var.k() == RecyclerView.this.m.d(b0Var.f1771c)) {
                    return true;
                }
                return false;
            }
        ...
        public void M(int i2, int i3) {
            int i4;
            int i5 = i3 + i2;
            for (int size = this.f1801c.size() - 1; size >= 0; size--) {
                b0 b0Var = this.f1801c.get(size);
                if (b0Var != null && (i4 = b0Var.f1771c) >= i2 && i4 < i5) {
                    b0Var.b(2);
                    A(size);
                }
            }
        ...
        public void a(b0 b0Var, boolean z) {
            ...
            if (b0Var.p(16384)) {
                b0Var.E(0, 16384);
                a.h.k.u.Z(b0Var.f1769a, (a.h.k.a) null);
            }
            if (z) {
                g(b0Var);
            }
        ...
        public void d() {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                this.f1801c.get(i2).c();
            }
            int size2 = this.f1799a.size();
            for (int i3 = 0; i3 < size2; i3++) {
                this.f1799a.get(i3).c();
            }
            ArrayList<b0> arrayList = this.f1800b;
            if (arrayList != null) {
                int size3 = arrayList.size();
                for (int i4 = 0; i4 < size3; i4++) {
                    this.f1800b.get(i4).c();
                }
            }
        }
        ...
        public int f(int i2) {
            if (i2 < 0 || i2 >= RecyclerView.this.i0.b()) {
                ...
                return RecyclerView.this.f1751e.m(i2);
            }
        }
        ...
        public b0 h(int i2) {
            ...
            if (!(arrayList == null || (size = arrayList.size()) == 0)) {
                ...
                if (RecyclerView.this.m.f() && (m = RecyclerView.this.f1751e.m(i2)) > 0 && m < RecyclerView.this.m.c()) {
                    long d2 = RecyclerView.this.m.d(m);
                    while (i3 < size) {
                        b0 b0Var2 = this.f1800b.get(i3);
        ...
        public b0 l(long j, int i2, boolean z) {
            for (int size = this.f1799a.size() - 1; size >= 0; size--) {
                b0 b0Var = this.f1799a.get(size);
                if (b0Var.k() == j && !b0Var.K()) {
                    if (i2 == b0Var.l()) {
                        ...
                        this.f1799a.remove(size);
                        RecyclerView.this.removeDetachedView(b0Var.f1769a, false);
                        y(b0Var.f1769a);
                    }
                }
            }
            int size2 = this.f1801c.size();
            while (true) {
                size2--;
                if (size2 < 0) {
                    return null;
                }
                b0 b0Var2 = this.f1801c.get(size2);
                if (b0Var2.k() == j) {
                    if (i2 == b0Var2.l()) {
                        if (!z) {
                            this.f1801c.remove(size2);
                        }
                        return b0Var2;
                    } else if (!z) {
                        A(size2);
        ...
        public b0 m(int i2, boolean z) {
            ...
            if (z || (e2 = RecyclerView.this.f1752f.e(i2)) == null) {
                int size2 = this.f1801c.size();
                while (i3 < size2) {
                    b0 b0Var2 = this.f1801c.get(i3);
                    if (b0Var2.s() || b0Var2.m() != i2) {
                        i3++;
                    } else {
                        if (!z) {
                            this.f1801c.remove(i3);
                        }
                        return b0Var2;
                    }
                }
            ...
            RecyclerView.this.f1752f.s(e2);
            int m = RecyclerView.this.f1752f.m(e2);
            if (m != -1) {
                RecyclerView.this.f1752f.d(m);
                D(e2);
                f0.b(8224);
                return f0;
            }
        ...
        public View n(int i2) {
            return this.f1799a.get(i2).f1769a;
        }
        ...
        public View p(int i2, boolean z) {
            return I(i2, z, Long.MAX_VALUE).f1769a;
        }
        ...
        public void s() {
            int size = this.f1801c.size();
            for (int i2 = 0; i2 < size; i2++) {
                o oVar = (o) this.f1801c.get(i2).f1769a.getLayoutParams();
                if (oVar != null) {
                    oVar.f1791c = true;
                }
            }
        ...
        public void u(int i2, int i3) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                b0 b0Var = this.f1801c.get(i4);
                if (b0Var != null && b0Var.f1771c >= i2) {
                    b0Var.z(i3, true);
                }
            }
        }
        ...
        public void v(int i2, int i3) {
            ...
            for (int i8 = 0; i8 < size; i8++) {
                b0 b0Var = this.f1801c.get(i8);
                if (b0Var != null && (i7 = b0Var.f1771c) >= i5 && i7 <= i4) {
                    if (i7 == i2) {
                        b0Var.z(i3 - i2, false);
                    } else {
                        b0Var.z(i6, false);
    ...
    private class w extends i {
        ...
        public void c(int i, int i2, Object obj) {
            RecyclerView.this.p((String) null);
            if (RecyclerView.this.f1751e.r(i, i2, obj)) {
                e();
            }
        }
        ...
        public void d(int i, int i2) {
            RecyclerView.this.p((String) null);
            if (RecyclerView.this.f1751e.s(i, i2)) {
                e();
            }
        }
        ...
        public void e() {
            if (RecyclerView.E0) {
                ...
                if (recyclerView.t && recyclerView.s) {
                    a.h.k.u.V(recyclerView, recyclerView.i);
                    return;
                }
            }
            RecyclerView recyclerView2 = RecyclerView.this;
    ...
    public static class y {
        ...
        /* renamed from: b  reason: collision with root package name */
        private SparseArray<Object> f1807b;
        ...
        public void a(int i2) {
            if ((this.f1810e & i2) == 0) {
                throw new IllegalStateException("Layout state should be one of " + Integer.toBinaryString(i2) + " but it is " + Integer.toBinaryString(this.f1810e));
            }
        }

        public int b() {
            return this.h ? this.f1808c - this.f1809d : this.f1811f;
        }
        ...
        public String toString() {
            return "State{mTargetPosition=" + this.f1806a + ", mData=" + this.f1807b + ", mItemCount=" + this.f1811f + ", mIsMeasuring=" + this.j + ", mPreviousLayoutItemCount=" + this.f1808c + ", mDeletedInvisibleItemCountSincePreviousLayout=" + this.f1809d + ", mStructureChanged=" + this.g + ", mInPreLayout=" + this.h + ", mRunSimpleAnimations=" + this.k + ", mRunPredictiveAnimations=" + this.l + '}';
        }
    }
    ...
    private void D() {
        ...
        y yVar2 = this.i0;
        yVar2.h = yVar2.l;
        yVar2.f1811f = this.m.c();
        V(this.r0);
        if (this.i0.k) {
            int g2 = this.f1752f.g();
            for (int i2 = 0; i2 < g2; i2++) {
                b0 f02 = f0(this.f1752f.f(i2));
        ...
        if (this.i0.l) {
            ...
            boolean z3 = yVar3.g;
            yVar3.g = false;
            this.n.V0(this.f1749c, yVar3);
            this.i0.g = z3;
            for (int i3 = 0; i3 < this.f1752f.g(); i3++) {
                b0 f03 = f0(this.f1752f.f(i3));
    ...
    private void E() {
        ...
        this.i0.a(6);
        this.f1751e.j();
        this.i0.f1811f = this.m.c();
        y yVar = this.i0;
        yVar.f1809d = 0;
        yVar.h = false;
        this.n.V0(this.f1749c, yVar);
        y yVar2 = this.i0;
        yVar2.g = false;
        this.f1750d = null;
    ...
    private void F() {
        ...
        yVar.f1810e = 1;
        if (yVar.k) {
            for (int g2 = this.f1752f.g() - 1; g2 >= 0; g2--) {
                b0 f02 = f0(this.f1752f.f(g2));
                if (!f02.I()) {
                    long d02 = d0(f02);
        ...
        this.n.i1(this.f1749c);
        y yVar2 = this.i0;
        yVar2.f1808c = yVar2.f1811f;
        this.E = false;
        this.F = false;
        yVar2.k = false;
        yVar2.l = false;
        this.n.h = false;
        ArrayList<b0> arrayList = this.f1749c.f1800b;
        if (arrayList != null) {
            arrayList.clear();
        }
            ...
            if (getDescendantFocusability() != 131072 || !isFocused()) {
                if (!isFocused()) {
                    ...
                    if (!H0 || (focusedChild.getParent() != null && focusedChild.hasFocus())) {
                        if (!this.f1752f.n(focusedChild)) {
                            return;
                        }
                    } else if (this.f1752f.g() == 0) {
                        requestFocus();
                        return;
                    }
                }
                ...
                if (Z != null && !this.f1752f.n(Z.f1769a) && Z.f1769a.hasFocusable()) {
                    view = Z.f1769a;
                } else if (this.f1752f.g() > 0) {
                    view = X();
                }
    ...
    private View X() {
        ...
        while (i3 < b2) {
            ...
            if (Y2 == null) {
                break;
            } else if (Y2.f1769a.hasFocusable()) {
                return Y2.f1769a;
            } else {
                i3++;
            }
    ...
    static b0 f0(View view) {
        ...
        return ((o) view.getLayoutParams()).f1789a;
    }

    static void g0(View view, Rect rect) {
        o oVar = (o) view.getLayoutParams();
        Rect rect2 = oVar.f1790b;
    ...
    private void h(b0 b0Var) {
        ...
        this.f1749c.J(e0(view));
        if (b0Var.w()) {
            this.f1752f.c(view, -1, view.getLayoutParams(), true);
        } else if (!z2) {
            this.f1752f.b(view, true);
        } else {
            this.f1752f.k(view);
        }
    }
    ...
    static void s(b0 b0Var) {
        WeakReference<RecyclerView> weakReference = b0Var.f1770b;
        if (weakReference != null) {
            View view = (View) weakReference.get();
            while (view != null) {
                if (view != b0Var.f1769a) {
    ...
    public void A0(int i2, int i3) {
        int j2 = this.f1752f.j();
        for (int i4 = 0; i4 < j2; i4++) {
            b0 f02 = f0(this.f1752f.i(i4));
            if (f02 != null && !f02.I() && f02.f1771c >= i2) {
                f02.z(i3, false);
                this.i0.g = true;
            }
        }
    ...
    public void B0(int i2, int i3) {
        ...
        for (int i8 = 0; i8 < j2; i8++) {
            b0 f02 = f0(this.f1752f.i(i8));
            if (f02 != null && (i7 = f02.f1771c) >= i5 && i7 <= i4) {
                if (i7 == i2) {
                    f02.z(i3 - i2, false);
                } else {
                    f02.z(i6, false);
    ...
    public void C() {
        if (this.m == null) {
            ...
            if (yVar.f1810e == 1) {
                ...
                this.n.v1(this);
                E();
            } else if (!this.f1751e.q() && this.n.m0() == getWidth() && this.n.V() == getHeight()) {
                this.n.v1(this);
            } else {
                this.n.v1(this);
                E();
    ...
    public void M() {
        ...
        for (int size = this.x0.size() - 1; size >= 0; size--) {
            ...
            if (b0Var.f1769a.getParent() == this && !b0Var.I() && (i2 = b0Var.q) != -1) {
                a.h.k.u.i0(b0Var.f1769a, i2);
                b0Var.q = -1;
            }
        }
        this.x0.clear();
    ...
    public final void S(y yVar) {
        if (getScrollState() == 2) {
            OverScroller overScroller = this.f0.f1765d;
    ...
    public b0 Y(int i2) {
        ...
        for (int i3 = 0; i3 < j2; i3++) {
            b0 f02 = f0(this.f1752f.i(i3));
            if (f02 != null && !f02.u() && c0(f02) == i2) {
                if (!this.f1752f.n(f02.f1769a)) {
                    return f02;
                }
                b0Var = f02;
            }
    ...
    public b0 Z(long j2) {
        ...
        b0 b0Var = null;
        if (gVar != null && gVar.f()) {
            int j3 = this.f1752f.j();
            for (int i2 = 0; i2 < j3; i2++) {
                b0 f02 = f0(this.f1752f.i(i2));
    ...
    public int c0(b0 b0Var) {
        ...
        return this.f1751e.e(b0Var.f1771c);
    }
    ...
    public long d0(b0 b0Var) {
        return this.m.f() ? b0Var.k() : (long) b0Var.f1771c;
    }
    ...
    public void f1(int i2, int i3, int[] iArr) {
        ...
        S(this.i0);
        int t1 = i2 != 0 ? this.n.t1(i2, this.f1749c, this.i0) : 0;
        int u1 = i3 != 0 ? this.n.u1(i3, this.f1749c, this.i0) : 0;
        androidx.core.os.b.b();
        Y0();
        G0();
        n1(false);
    ...
    public View focusSearch(View view, int i2) {
        ...
        if (!z4 || !(i2 == 2 || i2 == 1)) {
            ...
            if (findNextFocus != null || !z4) {
                ...
                l1();
                view2 = this.n.H0(view, i2, this.f1749c, this.i0);
                n1(false);
            }
        } else {
            if (this.n.k()) {
            ...
            if (z2) {
                ...
                l1();
                this.n.H0(view, i2, this.f1749c, this.i0);
                n1(false);
            }
    ...
    public boolean i1(AccessibilityEvent accessibilityEvent) {
        ...
        int a2 = accessibilityEvent != null ? a.h.k.d0.b.a(accessibilityEvent) : 0;
        if (a2 != 0) {
            i2 = a2;
        }
        this.A |= i2;
    ...
    public boolean m0() {
        return !this.v || this.E || this.f1751e.p();
    }
    ...
    public void onDetachedFromWindow() {
        ...
        LayoutManager layoutManager = this.n;
        if (layoutManager != null) {
            layoutManager.z(this, this.f1749c);
        }
        this.x0.clear();
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (layoutManager.q0()) {
            int mode = View.MeasureSpec.getMode(i2);
            int mode2 = View.MeasureSpec.getMode(i3);
            this.n.X0(this.f1749c, this.i0, i2, i3);
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        this.f1750d = savedState;
        super.onRestoreInstanceState(savedState.a());
        LayoutManager layoutManager = this.n;
        if (layoutManager != null && (parcelable2 = this.f1750d.f1761d) != null) {
    ...
    public Parcelable onSaveInstanceState() {
        ...
        SavedState savedState2 = this.f1750d;
        if (savedState2 != null) {
            savedState.b(savedState2);
        } else {
            LayoutManager layoutManager = this.n;
            if (layoutManager != null) {
                savedState.f1761d = layoutManager.b1();
            } else {
                savedState.f1761d = null;
            }
        }
        return savedState;
    }
    ...
    public void q1(int i2, int i3, Object obj) {
        ...
        for (int i6 = 0; i6 < j2; i6++) {
            View i7 = this.f1752f.i(i6);
            b0 f02 = f0(i7);
            if (f02 != null && !f02.I() && (i4 = f02.f1771c) >= i2 && i4 < i5) {
                f02.b(2);
                f02.a(obj);
                ((o) i7.getLayoutParams()).f1791c = true;
            }
        }
        this.f1749c.M(i2, i3);
    }
    ...
    public void r0(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new d(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(a.p.a.fastscroll_default_thickness), resources.getDimensionPixelSize(a.p.a.fastscroll_minimum_range), resources.getDimensionPixelOffset(a.p.a.fastscroll_margin));
    }
    ...
    public void setLayoutManager(LayoutManager layoutManager) {
        if (layoutManager != this.n) {
            ...
            if (this.n != null) {
                ...
                this.n.h1(this.f1749c);
                this.n.i1(this.f1749c);
                this.f1749c.c();
                if (this.s) {
                    this.n.z(this, this.f1749c);
                }
            ...
            if (layoutManager != null) {
                if (layoutManager.f1754b == null) {
                    layoutManager.A1(this);
                    if (this.s) {
                        this.n.y(this);
                    }
                } else {
                    throw new IllegalArgumentException("LayoutManager " + layoutManager + " is already attached to a RecyclerView:" + layoutManager.f1754b.R());
                }
            }
            this.f1749c.K();
            requestLayout();
    ...
    public void v() {
        if (!this.v || this.E) {
            ...
            C();
            androidx.core.os.b.b();
        } else if (this.f1751e.p()) {
            if (this.f1751e.o(4) && !this.f1751e.o(11)) {
    ...
    public void w0() {
        int j2 = this.f1752f.j();
        for (int i2 = 0; i2 < j2; i2++) {
            ((o) this.f1752f.i(i2).getLayoutParams()).f1791c = true;
        }
        this.f1749c.s();
    }
    ...
    public void x(int i2, int i3) {
        setMeasuredDimension(LayoutManager.m(i2, getPaddingLeft() + getPaddingRight(), a.h.k.u.v(this)), LayoutManager.m(i3, getPaddingTop() + getPaddingBottom(), a.h.k.u.u(this)));
    }
    ...
    public void y0(int i2) {
        ...
        for (int i3 = 0; i3 < g2; i3++) {
            this.f1752f.f(i3).offsetLeftAndRight(i2);
        }
    }
    ...
    public void z0(int i2) {
        int g2 = this.f1752f.g();
        for (int i3 = 0; i3 < g2; i3++) {
            this.f1752f.f(i3).offsetTopAndBottom(i2);
        }
    }
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.V = viewConfiguration.getScaledTouchSlop();
        this.c0 = a.h.k.v.b(viewConfiguration, context);
        this.d0 = a.h.k.v.d(viewConfiguration, context);
        ...
        if (attributeSet != null) {
            ...
            boolean z3 = obtainStyledAttributes2.getBoolean(a.p.b.RecyclerView_fastScrollEnabled, false);
            this.u = z3;
            if (z3) {
                r0((StateListDrawable) obtainStyledAttributes2.getDrawable(a.p.b.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes2.getDrawable(a.p.b.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes2.getDrawable(a.p.b.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes2.getDrawable(a.p.b.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        SavedState(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f1761d = parcel.readParcelable(classLoader == null ? LayoutManager.class.getClassLoader() : classLoader);
        }

        /* access modifiers changed from: package-private */
        public void b(SavedState savedState) {
            this.f1761d = savedState.f1761d;
        }

        public void writeToParcel(Parcel parcel, int i) {
            super.writeToParcel(parcel, i);
            parcel.writeParcelable(this.f1761d, 0);
        }
    ...
    public static class o extends ViewGroup.MarginLayoutParams {
        ...
        /* renamed from: b  reason: collision with root package name */
        final Rect f1790b = new Rect();

        /* renamed from: c  reason: collision with root package name */
        boolean f1791c = true;

        /* renamed from: d  reason: collision with root package name */
        boolean f1792d = false;
