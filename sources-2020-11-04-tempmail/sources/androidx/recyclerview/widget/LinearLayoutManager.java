...
public class LinearLayoutManager extends RecyclerView.LayoutManager {
    ...
    public static class SavedState implements Parcelable {
        ...
        SavedState(Parcel parcel) {
            ...
            this.f1732d = parcel.readInt() != 1 ? false : true;
        }

        public SavedState(SavedState savedState) {
            this.f1730b = savedState.f1730b;
            this.f1731c = savedState.f1731c;
            this.f1732d = savedState.f1732d;
        }
    }
    ...
    static class a {
        ...
        public void b(View view, int i) {
            if (this.f1736d) {
                this.f1735c = this.f1733a.d(view) + this.f1733a.o();
            } else {
                this.f1735c = this.f1733a.g(view);
            }
            this.f1734b = i;
        }
        ...
        public void c(View view, int i) {
            ...
            this.f1734b = i;
            if (this.f1736d) {
                int i2 = (this.f1733a.i() - o) - this.f1733a.d(view);
                this.f1735c = this.f1733a.i() - i2;
                if (i2 > 0) {
                    int e2 = this.f1735c - this.f1733a.e(view);
                    int m = this.f1733a.m();
                    int min = e2 - (m + Math.min(this.f1733a.g(view) - m, 0));
                    if (min < 0) {
                        this.f1735c += Math.min(i2, -min);
                        return;
                    }
                    return;
                }
            ...
            int g = this.f1733a.g(view);
            int m2 = g - this.f1733a.m();
            this.f1735c = g;
            if (m2 > 0) {
                int i3 = (this.f1733a.i() - Math.min(0, (this.f1733a.i() - o) - this.f1733a.d(view))) - (g + this.f1733a.e(view));
                if (i3 < 0) {
                    this.f1735c -= Math.min(m2, -i3);
                }
            }
        }
        ...
        public String toString() {
            return "AnchorInfo{mPosition=" + this.f1734b + ", mCoordinate=" + this.f1735c + ", mLayoutFromEnd=" + this.f1736d + ", mValid=" + this.f1737e + '}';
        }
    }
    ...
    static class c {
        ...
        private View e() {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                View view = this.k.get(i2).f1769a;
                RecyclerView.o oVar = (RecyclerView.o) view.getLayoutParams();
                if (!oVar.c() && this.f1745d == oVar.a()) {
                    b(view);
                    return view;
                }
            }
        ...
        public void b(View view) {
            ...
            if (f2 == null) {
                ...
                this.f1745d = ((RecyclerView.o) f2.getLayoutParams()).a();
            }
        }
        ...
        public View f(View view) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                View view3 = this.k.get(i3).f1769a;
                RecyclerView.o oVar = (RecyclerView.o) view3.getLayoutParams();
                if (view3 != view && !oVar.c() && (a2 = (oVar.a() - this.f1745d) * this.f1746e) >= 0 && a2 < i2) {
                    view2 = view3;
                    if (a2 == 0) {
                        break;
                    }
    ...
    private void A2(int i, int i2, boolean z2, RecyclerView.y yVar) {
        ...
        if (i == 1) {
            ...
            int f0 = f0(f2);
            c cVar4 = this.t;
            cVar3.f1745d = f0 + cVar4.f1746e;
            cVar4.f1743b = this.u.d(f2);
            ...
            int f02 = f0(g2);
            c cVar7 = this.t;
            cVar6.f1745d = f02 + cVar7.f1746e;
            cVar7.f1743b = this.u.g(g2);
    ...
    private void B2(int i, int i2) {
        this.t.f1744c = this.u.i() - i2;
        this.t.f1746e = this.x ? -1 : 1;
        c cVar = this.t;
        cVar.f1745d = i;
        cVar.f1747f = 1;
        cVar.f1743b = i2;
    ...
    private void C2(a aVar) {
        B2(aVar.f1734b, aVar.f1735c);
    }

    private void D2(int i, int i2) {
        this.t.f1744c = i2 - this.u.m();
        c cVar = this.t;
        cVar.f1745d = i;
        cVar.f1746e = this.x ? 1 : -1;
        c cVar2 = this.t;
        cVar2.f1747f = -1;
        cVar2.f1743b = i2;
        ...
        if (yVar.g() && I() != 0 && !yVar.e() && F1()) {
            ...
            for (int i5 = 0; i5 < size; i5++) {
                ...
                if (!b0Var.u()) {
                    ...
                    if (c2 == 65535) {
                        i3 += this.u.e(b0Var.f1769a);
                    } else {
                        i4 += this.u.e(b0Var.f1769a);
                    }
                }
            }
            this.t.k = k;
        ...
        if (!yVar.e() && (i = this.A) != -1) {
            if (i < 0 || i >= yVar.b()) {
                ...
                if (savedState != null && savedState.a()) {
                    boolean z3 = this.D.f1732d;
                    aVar.f1736d = z3;
                    if (z3) {
                        aVar.f1735c = this.u.i() - this.D.f1731c;
                    } else {
                        aVar.f1735c = this.u.m() + this.D.f1731c;
                    }
                    return true;
                    ...
                    if (B2 == null) {
                        ...
                        aVar.f1735c = this.u.m();
                        aVar.f1736d = false;
                        return true;
                    } else if (this.u.i() - this.u.d(B2) < 0) {
                        aVar.f1735c = this.u.i();
                        aVar.f1736d = true;
                        return true;
                    } else {
                        if (aVar.f1736d) {
                    ...
                    aVar.f1736d = z4;
                    if (z4) {
                        aVar.f1735c = this.u.i() - this.B;
                    } else {
                        aVar.f1735c = this.u.m() + this.B;
                    }
                    return true;
                }
            }
    ...
    public int N1(RecyclerView.u uVar, c cVar, RecyclerView.y yVar, boolean z2) {
        ...
        while (true) {
            ...
            if (!bVar.f1739b) {
                cVar.f1743b += bVar.f1738a * cVar.f1747f;
                if (!bVar.f1740c || this.t.k != null || !yVar.e()) {
                    int i4 = cVar.f1744c;
                    int i5 = bVar.f1738a;
                    cVar.f1744c = i4 - i5;
                    i3 -= i5;
    ...
    public void V0(RecyclerView.u uVar, RecyclerView.y yVar) {
        ...
        SavedState savedState = this.D;
        if (savedState != null && savedState.a()) {
            this.A = this.D.f1730b;
        }
        M1();
        this.t.f1742a = false;
        s2();
        View U = U();
        if (!this.E.f1737e || this.A != -1 || this.D != null) {
            this.E.e();
            a aVar = this.E;
            aVar.f1736d = this.x ^ this.y;
            z2(uVar, yVar, aVar);
            this.E.f1737e = true;
        ...
        if (!this.E.f1736d ? !this.x : this.x) {
            i10 = 1;
        }
        ...
        if (aVar2.f1736d) {
            ...
            c cVar2 = this.t;
            i3 = cVar2.f1743b;
            int i12 = cVar2.f1745d;
            int i13 = cVar2.f1744c;
            if (i13 > 0) {
                j += i13;
            }
            C2(this.E);
            c cVar3 = this.t;
            cVar3.h = j;
            cVar3.f1745d += cVar3.f1746e;
            N1(uVar, cVar3, yVar, false);
            c cVar4 = this.t;
            i2 = cVar4.f1743b;
            int i14 = cVar4.f1744c;
            if (i14 > 0) {
                D2(i12, i3);
                c cVar5 = this.t;
                cVar5.h = i14;
            ...
            c cVar7 = this.t;
            i2 = cVar7.f1743b;
            int i15 = cVar7.f1745d;
            int i16 = cVar7.f1744c;
            if (i16 > 0) {
                m += i16;
            }
            E2(this.E);
            c cVar8 = this.t;
            cVar8.h = m;
            cVar8.f1745d += cVar8.f1746e;
            N1(uVar, cVar8, yVar, false);
            c cVar9 = this.t;
            i3 = cVar9.f1743b;
            int i17 = cVar9.f1744c;
            if (i17 > 0) {
                B2(i15, i2);
                c cVar10 = this.t;
                cVar10.h = i17;
    ...
    public View W1(int i, int i2) {
        ...
        if (this.s == 0) {
            return this.f1757e.a(i, i2, i4, i3);
        }
        return this.f1758f.a(i, i2, i4, i3);
    }
    ...
    public Parcelable b1() {
        ...
        if (I() > 0) {
            ...
            savedState.f1732d = z2;
            if (z2) {
                View f2 = f2();
                savedState.f1731c = this.u.i() - this.u.d(f2);
                savedState.f1730b = f0(f2);
            } else {
                View g2 = g2();
                savedState.f1730b = f0(g2);
                savedState.f1731c = this.u.g(g2) - this.u.m();
            }
        } else {
            savedState.b();
        }
    ...
    public void o(int i, RecyclerView.LayoutManager.c cVar) {
        ...
        if (savedState == null || !savedState.a()) {
            ...
            z2 = savedState2.f1732d;
            i2 = savedState2.f1730b;
        }
        if (!z2) {
            i3 = 1;
        }
