...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    public static abstract class c {
        ...
        final SparseIntArray f1728a = new SparseIntArray();
        ...
        public int a(int i, int i2) {
            ...
            int i3 = this.f1728a.get(i, -1);
            if (i3 != -1) {
                return i3;
            }
            int c2 = c(i, i2);
            this.f1728a.put(i, c2);
            return c2;
        }
    ...
    private void K2(RecyclerView.u uVar, RecyclerView.y yVar, LinearLayoutManager.a aVar, int i) {
        boolean z = i == 1;
        int O2 = O2(uVar, yVar, aVar.f1734b);
        if (z) {
            while (O2 > 0) {
                int i2 = aVar.f1734b;
                if (i2 > 0) {
    ...
    private void R2(View view, int i, boolean z) {
        ...
        int i3;
        b bVar = (b) view.getLayoutParams();
        Rect rect = bVar.f1790b;
        int i4 = rect.top + rect.bottom + bVar.topMargin + bVar.bottomMargin;
        int i5 = rect.left + rect.right + bVar.leftMargin + bVar.rightMargin;
        int M2 = M2(bVar.f1726e, bVar.f1727f);
        if (this.s == 1) {
    ...
    public void k2(RecyclerView.u uVar, RecyclerView.y yVar, LinearLayoutManager.c cVar, LinearLayoutManager.b bVar) {
        ...
        boolean z3 = cVar2.f1746e == 1;
        int i12 = this.I;
        if (!z3) {
            i12 = O2(uVar2, yVar2, cVar2.f1745d) + P2(uVar2, yVar2, cVar2.f1745d);
        }
        int i13 = 0;
        int i14 = 0;
        while (i14 < this.I && cVar2.c(yVar2) && i12 > 0) {
            int i15 = cVar2.f1745d;
        ...
        for (int i18 = 0; i18 < i16; i18++) {
            ...
            float f3 = (((float) this.u.f(view)) * 1.0f) / ((float) ((b) view.getLayoutParams()).f1727f);
            if (f3 > f2) {
                f2 = f3;
            }
        }
        ...
        for (int i20 = 0; i20 < i16; i20++) {
            ...
            if (this.u.e(view3) != i17) {
                ...
                int M2 = M2(bVar3.f1726e, bVar3.f1727f);
                if (this.s == 1) {
        ...
        if (this.s != 1) {
            if (cVar2.f1747f == -1) {
                int i24 = cVar2.f1743b;
                i3 = i24 - i17;
                i2 = i24;
            } else {
                int i25 = cVar2.f1743b;
                i2 = i25 + i17;
                i3 = i25;
            }
            i4 = 0;
            i = 0;
        } else if (cVar2.f1747f == -1) {
            int i26 = cVar2.f1743b;
            int i27 = i26 - i17;
            i3 = 0;
            i2 = 0;
            int i28 = i26;
        ...
        while (i23 < i16) {
            ...
            if (this.s == 1) {
                if (j2()) {
                    int c0 = c0() + this.J[this.I - bVar4.f1726e];
                    i8 = i4;
                    i6 = c0;
                    i7 = c0 - this.u.f(view4);
                } else {
                    int c02 = c0() + this.J[bVar4.f1726e];
                    i8 = i4;
                    i7 = c02;
            ...
            bVar2.f1741d |= view4.hasFocusable();
            i23++;
            i4 = i8;
            i3 = i7;
            i2 = i6;
