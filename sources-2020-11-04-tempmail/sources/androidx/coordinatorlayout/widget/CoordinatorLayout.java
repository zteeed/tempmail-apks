...
public class CoordinatorLayout extends ViewGroup implements m {
    ...
    private final List<View> f1262b;

    /* renamed from: c  reason: collision with root package name */
    private final a<View> f1263c;

    /* renamed from: d  reason: collision with root package name */
    private final List<View> f1264d;

    /* renamed from: e  reason: collision with root package name */
    private final List<View> f1265e;
    ...
    class a implements q {
        ...
        public c0 a(View view, c0 c0Var) {
            CoordinatorLayout.this.a0(c0Var);
            return c0Var;
        }
    }
    ...
    private void G(View view, int i2) {
        ...
        if (this.o != null && u.q(this) && !u.q(view)) {
            e2.left += this.o.c();
            e2.top += this.o.e();
            e2.right -= this.o.d();
            e2.bottom -= this.o.b();
        ...
        Rect e3 = e();
        a.h.k.d.a(W(fVar.f1272c), view.getMeasuredWidth(), view.getMeasuredHeight(), e2, e3, i2);
    ...
    private void I(View view, int i2, int i3) {
        f fVar = (f) view.getLayoutParams();
        int b2 = a.h.k.d.b(X(fVar.f1272c), i3);
        int i4 = b2 & 7;
        int i5 = b2 & 112;
        int width = getWidth();
    ...
    private void Q() {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            f C = C(childAt);
            C.d(this, childAt);
            this.f1263c.b(childAt);
            for (int i3 = 0; i3 < childCount; i3++) {
                if (i3 != i2) {
                    View childAt2 = getChildAt(i3);
                    if (C.b(this, childAt, childAt2)) {
                        if (!this.f1263c.d(childAt2)) {
                            this.f1263c.b(childAt2);
                        }
                        this.f1263c.a(childAt2, childAt);
                    }
                }
            }
        }
        this.f1262b.addAll(this.f1263c.i());
        Collections.reverse(this.f1262b);
    }
    ...
    private c0 o(c0 c0Var) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            View childAt = getChildAt(i2);
            if (u.q(childAt) && (f2 = ((f) childAt.getLayoutParams()).f()) != null) {
    ...
    private void z(View view, int i2, Rect rect, Rect rect2, f fVar, int i3, int i4) {
        int i5;
        int i6;
        int b2 = a.h.k.d.b(V(fVar.f1272c), i2);
        int b3 = a.h.k.d.b(W(fVar.f1273d), i2);
        int i7 = b2 & 7;
        int i8 = b2 & 112;
        int i9 = b3 & 7;
        int i10 = b3 & 112;
    ...
    public final void L(int i2) {
        ...
        Rect e4 = e();
        for (int i4 = 0; i4 < size; i4++) {
            View view = this.f1262b.get(i4);
            f fVar = (f) view.getLayoutParams();
            if (i3 != 0 || view.getVisibility() != 8) {
                for (int i5 = 0; i5 < i4; i5++) {
                    if (fVar.l == this.f1262b.get(i5)) {
                        K(view, t2);
                    }
                }
                u(view, true, e3);
    ...
    public final c0 a0(c0 c0Var) {
        if (!a.h.j.c.a(this.o, c0Var)) {
            this.o = c0Var;
            boolean z = true;
            boolean z2 = c0Var != null && c0Var.e() > 0;
            this.p = z2;
    ...
    public boolean drawChild(Canvas canvas, View view, long j2) {
        ...
        if (cVar != null) {
            ...
            if (d2 > 0.0f) {
                ...
                this.g.setColor(fVar.f1270a.c(this, view));
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (fVar.j(i4) && (f2 = fVar.f()) != null) {
                    int[] iArr2 = this.f1266f;
                    iArr2[1] = 0;
                    iArr2[0] = 0;
                    f2.q(this, childAt, view, i2, i3, iArr2, i4);
                    int[] iArr3 = this.f1266f;
                    if (i2 > 0) {
    ...
    public void onMeasure(int r31, int r32) {
        ...
        L_0x004b:
            r19 = 0
        L_0x004d:
            java.util.List<android.view.View> r2 = r7.f1262b
            int r6 = r2.size()
            r5 = r0
            r4 = r1
            r2 = 0
        ...
        L_0x0057:
            ...
            java.util.List<android.view.View> r0 = r7.f1262b
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        SparseArray<Parcelable> sparseArray = savedState.f1267d;
        int childCount = getChildCount();
        for (int i2 = 0; i2 < childCount; i2++) {
            View childAt = getChildAt(i2);
    ...
    public void setStatusBarBackground(Drawable drawable) {
        ...
        if (drawable2 != drawable) {
            ...
            if (drawable3 != null) {
                ...
                androidx.core.graphics.drawable.a.m(this.q, u.t(this));
    ...
    public List<View> v(View view) {
        List<View> h2 = this.f1263c.h(view);
        this.f1265e.clear();
        if (h2 != null) {
            this.f1265e.addAll(h2);
        }
        return this.f1265e;
    }
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f1267d = new SparseArray<>(readInt);
            for (int i = 0; i < readInt; i++) {
                this.f1267d.append(iArr[i], readParcelableArray[i]);
            }
        }
        ...
        public void writeToParcel(Parcel parcel, int i) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                iArr[i2] = this.f1267d.keyAt(i2);
                parcelableArr[i2] = this.f1267d.valueAt(i2);
            }
    ...
    public static class f extends ViewGroup.MarginLayoutParams {
        ...
        private void n(View view, CoordinatorLayout coordinatorLayout) {
            View findViewById = coordinatorLayout.findViewById(this.f1275f);
            this.k = findViewById;
            if (findViewById != null) {
                ...
                throw new IllegalStateException("Could not find CoordinatorLayout descendant view with id " + coordinatorLayout.getResources().getResourceName(this.f1275f) + " to anchor view " + view);
            }
        }
        ...
        /* access modifiers changed from: package-private */
        public boolean a() {
            return this.k == null && this.f1275f != -1;
        }
        ...
        public boolean b(androidx.coordinatorlayout.widget.CoordinatorLayout r2, android.view.View r3, android.view.View r4) {
            /*
                ...
                androidx.coordinatorlayout.widget.CoordinatorLayout$c r0 = r1.f1270a
        ...
        f(Context context, AttributeSet attributeSet) {
            ...
            this.f1272c = obtainStyledAttributes.getInteger(a.g.c.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.f1275f = obtainStyledAttributes.getResourceId(a.g.c.CoordinatorLayout_Layout_layout_anchor, -1);
            this.f1273d = obtainStyledAttributes.getInteger(a.g.c.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.f1274e = obtainStyledAttributes.getInteger(a.g.c.CoordinatorLayout_Layout_layout_keyline, -1);
            ...
            this.f1271b = hasValue;
            if (hasValue) {
                this.f1270a = CoordinatorLayout.O(context, attributeSet, obtainStyledAttributes.getString(a.g.c.CoordinatorLayout_Layout_layout_behavior));
            }
