...
public abstract class VersionedParcel {
    ...
    protected final a<String, Method> f2012a;

    /* renamed from: b  reason: collision with root package name */
    protected final a<String, Method> f2013b;

    /* renamed from: c  reason: collision with root package name */
    protected final a<String, Class> f2014c;
    ...
    private Class c(Class<? extends b> cls) throws ClassNotFoundException {
        Class cls2 = this.f2014c.get(cls.getName());
        if (cls2 != null) {
            return cls2;
        }
        Class<?> cls3 = Class.forName(String.format("%s.%sParcelizer", new Object[]{cls.getPackage().getName(), cls.getSimpleName()}), false, cls.getClassLoader());
        this.f2014c.put(cls.getName(), cls3);
        return cls3;
    }
    ...
    private Method e(Class cls) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
        ...
        this.f2013b.put(cls.getName(), declaredMethod);
        return declaredMethod;
    }
