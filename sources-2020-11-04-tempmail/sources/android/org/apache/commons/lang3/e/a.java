...
public class a {
    ...
    public a c(double d2, double d3) {
        ...
        this.f657a = Double.compare(d2, d3);
        return this;
    }
    ...
    public a d(float f2, float f3) {
        ...
        this.f657a = Float.compare(f2, f3);
        return this;
    }
    ...
    public a h(Object obj, Object obj2, Comparator<?> comparator) {
        ...
        if (obj == null) {
            ...
            if (obj.getClass().isArray()) {
                ...
                this.f657a = ((Comparable) obj).compareTo(obj2);
            } else {
                this.f657a = comparator.compare(obj, obj2);
            }
            return this;
        }
    }
    ...
    public a i(short s, short s2) {
        ...
        this.f657a = s < s2 ? -1 : s > s2 ? 1 : 0;
        return this;
    }

    public a j(boolean z, boolean z2) {
        if (this.f657a != 0 || z == z2) {
            return this;
        }
        if (!z) {
            this.f657a = -1;
    ...
    public a k(byte[] bArr, byte[] bArr2) {
        ...
        if (bArr == null) {
            ...
            for (int i2 = 0; i2 < bArr.length && this.f657a == 0; i2++) {
                a(bArr[i2], bArr2[i2]);
            }
            return this;
        }
    ...
    public a l(char[] cArr, char[] cArr2) {
        ...
        if (cArr == null) {
            ...
            for (int i2 = 0; i2 < cArr.length && this.f657a == 0; i2++) {
                b(cArr[i2], cArr2[i2]);
            }
            return this;
        }
    ...
    public a m(double[] dArr, double[] dArr2) {
        ...
        if (dArr == null) {
            ...
            for (int i2 = 0; i2 < dArr.length && this.f657a == 0; i2++) {
                c(dArr[i2], dArr2[i2]);
            }
            return this;
        }
    ...
    public a n(float[] fArr, float[] fArr2) {
        ...
        if (fArr == null) {
            ...
            for (int i2 = 0; i2 < fArr.length && this.f657a == 0; i2++) {
                d(fArr[i2], fArr2[i2]);
            }
            return this;
        }
    ...
    public a o(int[] iArr, int[] iArr2) {
        ...
        if (iArr == null) {
            ...
            for (int i2 = 0; i2 < iArr.length && this.f657a == 0; i2++) {
                e(iArr[i2], iArr2[i2]);
            }
            return this;
        }
    ...
    public a p(long[] jArr, long[] jArr2) {
        ...
        if (jArr == null) {
            ...
            for (int i2 = 0; i2 < jArr.length && this.f657a == 0; i2++) {
                f(jArr[i2], jArr2[i2]);
            }
            return this;
        }
    ...
    public a q(Object[] objArr, Object[] objArr2, Comparator<?> comparator) {
        if (this.f657a != 0 || objArr == objArr2) {
            return this;
        }
        int i = -1;
        if (objArr == null) {
            ...
            for (int i2 = 0; i2 < objArr.length && this.f657a == 0; i2++) {
    ...
    public a r(short[] sArr, short[] sArr2) {
        ...
        if (sArr == null) {
            ...
            for (int i2 = 0; i2 < sArr.length && this.f657a == 0; i2++) {
                i(sArr[i2], sArr2[i2]);
            }
            return this;
        }
    ...
    public a s(boolean[] zArr, boolean[] zArr2) {
        ...
        if (zArr == null) {
            ...
            for (int i2 = 0; i2 < zArr.length && this.f657a == 0; i2++) {
                j(zArr[i2], zArr2[i2]);
            }
            return this;
        }
