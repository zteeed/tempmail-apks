...
public final class PublicSuffixDatabase {
    ...
    private static final byte[] f14990e = {42};

    /* renamed from: f  reason: collision with root package name */
    private static final String[] f14991f = new String[0];
    private static final String[] g = {"*"};
    private static final PublicSuffixDatabase h = new PublicSuffixDatabase();

    /* renamed from: a  reason: collision with root package name */
    private final AtomicBoolean f14992a = new AtomicBoolean(false);

    /* renamed from: b  reason: collision with root package name */
    private final CountDownLatch f14993b = new CountDownLatch(1);
    ...
    private String[] b(String[] strArr) {
        ...
        String[] strArr3;
        int i = 0;
        if (this.f14992a.get() || !this.f14992a.compareAndSet(false, true)) {
            try {
                this.f14993b.await();
        ...
        if (str3 != null) {
            while (true) {
                ...
                String a2 = a(this.f14995d, bArr, i);
                if (a2 != null) {
                    str = a2;
                    break;
                }
    ...
    private void e() throws java.io.IOException {
        ...
        L_0x002f:
            monitor-enter(r3)
            r3.f14994c = r1     // Catch:{ all -> 0x003b }
            r3.f14995d = r2     // Catch:{ all -> 0x003b }
            monitor-exit(r3)     // Catch:{ all -> 0x003b }
            java.util.concurrent.CountDownLatch r0 = r3.f14993b
            r0.countDown()
            return
        L_0x003b:
            r0 = move-exception
