...
final class RequestFactory {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            ...
            if (annotation instanceof Url) {
                ...
                if (this.isMultipart) {
                    ...
                    if (!value5.isEmpty()) {
                        y g = y.g("Content-Disposition", "form-data; name=\"" + value5 + "\"", "Content-Transfer-Encoding", part.encoding());
                        if (Iterable.class.isAssignableFrom(rawType8)) {
                            if (type instanceof ParameterizedType) {
                                ...
                                if (!cls2.isAssignableFrom(Utils.getRawType(parameterUpperBound4))) {
                                    return new ParameterHandler.Part(this.method, i, g, this.retrofit.requestBodyConverter(parameterUpperBound4, annotationArr, this.methodAnnotations)).iterable();
                                }
                            ...
                            if (!cls2.isAssignableFrom(boxIfPrimitive)) {
                                return new ParameterHandler.Part(this.method, i, g, this.retrofit.requestBodyConverter(boxIfPrimitive, annotationArr, this.methodAnnotations)).array();
                            }
                            throw Utils.parameterError(this.method, i, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                        } else if (!cls2.isAssignableFrom(rawType8)) {
                            return new ParameterHandler.Part(this.method, i, g, this.retrofit.requestBodyConverter(type, annotationArr, this.methodAnnotations));
                        } else {
                            throw Utils.parameterError(this.method, i, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                        }
    ...
    /* access modifiers changed from: package-private */
    public g0 create(Object[] objArr) throws IOException {
        ParameterHandler<?>[] parameterHandlerArr = this.parameterHandlers;
        ...
        if (length == parameterHandlerArr.length) {
            ...
            g0.a aVar = requestBuilder.get();
            aVar.g(Invocation.class, new Invocation(this.method, arrayList));
            return aVar.a();
        }
