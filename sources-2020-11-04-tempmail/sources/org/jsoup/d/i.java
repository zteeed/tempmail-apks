...
public class i {
    ...
    private static final char[] f15177a = {',', ';'};

    /* renamed from: b  reason: collision with root package name */
    private static final HashMap<String, String> f15178b = new HashMap<>();
    ...
    public enum c {
        ...
        public int q(String str) {
            int binarySearch = Arrays.binarySearch(this.f15185b, str);
            if (binarySearch >= 0) {
                return this.f15186c[binarySearch];
            }
            return -1;
        }
        ...
        public String r(int i2) {
            int binarySearch = Arrays.binarySearch(this.f15187d, i2);
            if (binarySearch < 0) {
                return "";
            }
            ...
            if (binarySearch < strArr.length - 1) {
                ...
                if (this.f15187d[i3] == i2) {
                    return strArr[i3];
                }
            }
            return this.f15188e[binarySearch];
        }
    }
    ...
    public static void h(c cVar, String str, int i) {
        int i2;
        String[] unused = cVar.f15185b = new String[i];
        int[] unused2 = cVar.f15186c = new int[i];
        int[] unused3 = cVar.f15187d = new int[i];
        String[] unused4 = cVar.f15188e = new String[i];
        ...
        while (!aVar.r()) {
            String k = aVar.k('=');
            aVar.a();
            int parseInt = Integer.parseInt(aVar.m(f15177a), 36);
            char q = aVar.q();
            aVar.a();
            if (q == ',') {
            ...
            aVar.a();
            cVar.f15185b[i3] = k;
            cVar.f15186c[i3] = parseInt;
            cVar.f15187d[parseInt2] = parseInt;
            cVar.f15188e[parseInt2] = k;
            if (i2 != -1) {
                f15178b.put(k, new String(new int[]{parseInt, i2}, 0, 2));
            }
            i3++;
        }
        if (i3 == i) {
