...
enum k {
    ...
    Comment {
        ...
        public void q(j jVar, a aVar) {
            ...
            if (q == 0) {
                ...
                jVar.n.f15229b.append(aVar.m('-', 0));
            } else {
                jVar.p(this);
                jVar.m();
                jVar.u(k.Data);
    ...
    CommentEndDash {
        ...
        public void q(j jVar, a aVar) {
            ...
            if (d2 == 0) {
                jVar.r(this);
                StringBuilder sb = jVar.n.f15229b;
                sb.append('-');
                sb.append(65533);
                jVar.u(k.Comment);
            } else if (d2 == '-') {
                ...
                StringBuilder sb2 = jVar.n.f15229b;
                sb2.append('-');
                sb2.append(d2);
                jVar.u(k.Comment);
            } else {
